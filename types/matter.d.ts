// Type definitions specifically for Matter.js as used by Vsengine 3
//
...
declare namespace MatterJS {
    ...
    interface IBodyDefinition {
         ...
         */
        gameObject?: Vsengine.GameObjects.GameObject;
    ...
    class Composite {
        ...
        static add(
            ...
            object: BodyType | CompositeType | ConstraintType
        ): CompositeType;
        ...
        static get(
            ...
            id: number,
            type: string
        ): BodyType | CompositeType | ConstraintType;
        ...
        static move(
            ...
            objects: Array<BodyType | CompositeType | ConstraintType>,
    ...
    class SAT {
        ...
        static collides(
            bodyA: BodyType,
            bodyB: BodyType,
            previousCollision: ICollisionData
        ): ICollisionData;
    }
    ...
    class Events {
        ...
        static on(
            obj: BodyType,
            name: "sleepStart",
            callback: (e: IEvent<BodyType>) => void
        ): void;
        ...
        static on(
            obj: Engine,
            name: "beforeAdd",
            callback: (e: IEventComposite<CompositeType>) => void
        ): void;
