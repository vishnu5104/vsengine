...
var WebAudioSoundManager = new Class({
    ...
    initialize: function WebAudioSoundManager(game) {
         ...
         *
         * @name Vsengine.Sound.WebAudioSoundManager#context
         * @type {AudioContext}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.WebAudioSoundManager#masterMuteNode
         * @type {GainNode}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.WebAudioSoundManager#masterVolumeNode
         * @type {GainNode}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.WebAudioSoundManager#destination
         * @type {AudioNode}
         * @since 3.0.0
         */
     ...
     * a Vsengine game on a page that never properly refreshes (such as in an SPA project)
     * and you want to reuse already instantiated AudioContext.
     *
     * @method Vsengine.Sound.WebAudioSoundManager#createAudioContext
     * @since 3.0.0
     *
     * @param {Vsengine.Game} game - Reference to the current game instance.
     *
     ...
     *
     * @method Vsengine.Sound.WebAudioSoundManager#setAudioContext
     * @since 3.21.0
     *
     ...
     *
     * Instead of passing a single entry you can instead pass an array of `Vsengine.Types.Sound.DecodeAudioConfig`
     ...
     *
     * @method Vsengine.Sound.WebAudioSoundManager#decodeAudio
     * @fires Vsengine.Sound.Events#DECODED
     * @fires Vsengine.Sound.Events#DECODED_ALL
     * @since 3.18.0
     *
     * @param {(Vsengine.Types.Sound.DecodeAudioConfig[]|string)} [audioKey] - The string-based key to be used to reference the decoded audio in the audio cache, or an array of audio config objects.
     ...
     *
     * @method Vsengine.Sound.WebAudioSoundManager#setListenerPosition
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Sound.WebAudioSoundManager#unlock
     * @since 3.0.0
     */
    unlock: function () {
        var _this = this;
     ...
     * Vsengine.Sound.WebAudioSoundManager#pauseOnBlur is set to true.
     *
     * @method Vsengine.Sound.WebAudioSoundManager#onBlur
     * @protected
     * @since 3.0.0
     */
    onBlur: function () {
     ...
     * Vsengine.Sound.WebAudioSoundManager#pauseOnBlur is set to true.
     *
     * @method Vsengine.Sound.WebAudioSoundManager#onFocus
     * @protected
     * @since 3.0.0
     */
    onFocus: function () {
     ...
     *
     * @method Vsengine.Sound.WebAudioSoundManager#update
     * @protected
    ...
    /**
     * Calls Vsengine.Sound.BaseSoundManager#destroy method
     * and cleans up all Web Audio API related stuff.
     *
     * @method Vsengine.Sound.WebAudioSoundManager#destroy
     * @since 3.0.0
     */
    destroy: function () {
     ...
     *
     * @method Vsengine.Sound.WebAudioSoundManager#setMute
     * @fires Vsengine.Sound.Events#GLOBAL_MUTE
     * @since 3.3.0
     *
     * @param {boolean} value - `true` to mute all sounds, `false` to unmute them.
     *
     * @return {Vsengine.Sound.WebAudioSoundManager} This Sound Manager.
     */
    ...
    /**
     * @name Vsengine.Sound.WebAudioSoundManager#mute
     * @type {boolean}
     * @fires Vsengine.Sound.Events#GLOBAL_MUTE
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Sound.WebAudioSoundManager#setVolume
     * @fires Vsengine.Sound.Events#GLOBAL_VOLUME
     * @since 3.3.0
     *
    ...
    /**
     * @name Vsengine.Sound.WebAudioSoundManager#volume
     * @type {number}
     * @fires Vsengine.Sound.Events#GLOBAL_VOLUME
     * @since 3.0.0
     */
