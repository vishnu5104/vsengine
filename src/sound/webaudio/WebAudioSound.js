 ...
 *
 * @class WebAudioSound
 * @extends Vsengine.Sound.BaseSound
 * @memberof Vsengine.Sound
 * @constructor
 * @since 3.0.0
 *
 * @param {Vsengine.Sound.WebAudioSoundManager} manager - Reference to the WebAudio Sound Manager that owns this Sound instance.
...
var WebAudioSound = new Class({
    ...
    initialize: function WebAudioSound(manager, key, config) {
         ...
         *
         * @name Vsengine.Sound.WebAudioSound#audioBuffer
         * @type {AudioBuffer}
         * @since 3.0.0
         */
         ...
         * audio data stored in Vsengine.Sound.WebAudioSound#audioBuffer.
         *
         * @name Vsengine.Sound.WebAudioSound#source
         ...
         *
         * @name Vsengine.Sound.WebAudioSound#loopSource
         * @type {AudioBufferSourceNode}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.WebAudioSound#muteNode
         * @type {GainNode}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.WebAudioSound#volumeNode
         * @type {GainNode}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.WebAudioSound#pannerNode
         ...
         *
         * @name Vsengine.Sound.WebAudioSound#spatialNode
         * @type {PannerNode}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Sound.WebAudioSound#spatialSource
         ...
         *
         * @name Vsengine.Sound.WebAudioSound#playTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         * Based on `BaseAudioContext.currentTime` value.
         *
         * @name Vsengine.Sound.WebAudioSound#startTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         * Based on `BaseAudioContext.currentTime` value.
         *
         * @name Vsengine.Sound.WebAudioSound#loopTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.WebAudioSound#rateUpdates
         * @type {array}
         * @default []
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.WebAudioSound#hasEnded
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.0.0
         ...
         * so its state can be updated accordingly.
         *
         * @name Vsengine.Sound.WebAudioSound#hasLooped
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.0.0
     ...
     *
     * @method Vsengine.Sound.WebAudioSound#play
     * @fires Vsengine.Sound.Events#PLAY
     * @since 3.0.0
     *
     * @param {(string|Vsengine.Types.Sound.SoundConfig)} [markerName=''] - If you want to play a marker then provide the marker name here. Alternatively, this parameter can be a SoundConfig object.
     * @param {Vsengine.Types.Sound.SoundConfig} [config] - Optional sound config object to be applied to this marker or entire sound if no marker name is provided. It gets memorized for future plays of current section of the sound.
     *
     ...
     * Pauses the sound.
     *
     * @method Vsengine.Sound.WebAudioSound#pause
     * @fires Vsengine.Sound.Events#PAUSE
     * @since 3.0.0
     *
     ...
     * Resumes the sound.
     *
     * @method Vsengine.Sound.WebAudioSound#resume
     * @fires Vsengine.Sound.Events#RESUME
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Sound.WebAudioSound#stop
     * @fires Vsengine.Sound.Events#STOP
     * @since 3.0.0
     *
     ...
     * Used internally.
     *
     * @method Vsengine.Sound.WebAudioSound#createAndStartBufferSource
     * @private
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Sound.WebAudioSound#createAndStartLoopBufferSource
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Sound.WebAudioSound#createBufferSource
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Sound.WebAudioSound#stopAndRemoveBufferSource
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Sound.WebAudioSound#stopAndRemoveLoopBufferSource
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Sound.WebAudioSound#applyConfig
     * @since 3.0.0
     */
    applyConfig: function () {
        ...
        if (source && this.manager.context.createPanner) {
            ...
            node.panningModel = GetFastValue(
                source,
                "panningModel",
                "equalpower"
            );
            node.distanceModel = GetFastValue(
                source,
                "distanceModel",
                "inverse"
            );
     ...
     * the spatial sound.
     *
     * @name Vsengine.Sound.WebAudioSound#x
     * @type {number}
     * @since 3.60.0
     */
    x: {
     ...
     * the spatial sound.
     *
     * @name Vsengine.Sound.WebAudioSound#y
     * @type {number}
     * @since 3.60.0
     */
    y: {
     ...
     *
     * @method Vsengine.Sound.WebAudioSound#update
     * @fires Vsengine.Sound.Events#COMPLETE
     * @fires Vsengine.Sound.Events#LOOPED
     * @since 3.0.0
     */
    update: function () {
    ...
    /**
     * Calls Vsengine.Sound.BaseSound#destroy method
     * and cleans up all Web Audio API related stuff.
     *
     * @method Vsengine.Sound.WebAudioSound#destroy
     * @since 3.0.0
     */
    destroy: function () {
     ...
     *
     * @method Vsengine.Sound.WebAudioSound#calculateRate
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Sound.WebAudioSound#getCurrentTime
     * @since 3.0.0
     */
    getCurrentTime: function () {
        ...
        for (var i = 0; i < this.rateUpdates.length; i++) {
            ...
            currentTime +=
                (nextTime - this.rateUpdates[i].time) *
                this.rateUpdates[i].rate;
        }
     ...
     *
     * @method Vsengine.Sound.WebAudioSound#getLoopTime
     * @since 3.0.0
     */
    getLoopTime: function () {
        ...
        for (var i = 0; i < this.rateUpdates.length - 1; i++) {
            lastRateUpdateCurrentTime +=
                (this.rateUpdates[i + 1].time - this.rateUpdates[i].time) *
                this.rateUpdates[i].rate;
        }
     ...
     *
     * @name Vsengine.Sound.WebAudioSound#rate
     * @type {number}
     * @default 1
     * @fires Vsengine.Sound.Events#RATE
     * @since 3.0.0
     */
    rate: {
        get: function () {
     ...
     * and 2.0 doubles the audios playback speed.
     *
     * @method Vsengine.Sound.WebAudioSound#setRate
     * @fires Vsengine.Sound.Events#RATE
     * @since 3.3.0
     *
     ...
     *
     * @name Vsengine.Sound.WebAudioSound#detune
     * @type {number}
     * @default 0
     * @fires Vsengine.Sound.Events#DETUNE
     * @since 3.0.0
     */
    detune: {
        get: function () {
     ...
     * The range of the value is -1200 to 1200, but we recommend setting it to [50](https://en.wikipedia.org/wiki/50_Cent).
     *
     * @method Vsengine.Sound.WebAudioSound#setDetune
     * @fires Vsengine.Sound.Events#DETUNE
     * @since 3.3.0
     *
     ...
     *
     * @name Vsengine.Sound.WebAudioSound#mute
     * @type {boolean}
     * @default false
     * @fires Vsengine.Sound.Events#MUTE
     * @since 3.0.0
     */
    mute: {
        get: function () {
     ...
     *
     * @method Vsengine.Sound.WebAudioSound#setMute
     * @fires Vsengine.Sound.Events#MUTE
     * @since 3.4.0
     *
     ...
     *
     * @name Vsengine.Sound.WebAudioSound#volume
     * @type {number}
     * @default 1
     * @fires Vsengine.Sound.Events#VOLUME
     * @since 3.0.0
     */
    volume: {
        get: function () {
     ...
     *
     * @method Vsengine.Sound.WebAudioSound#setVolume
     * @fires Vsengine.Sound.Events#VOLUME
     * @since 3.4.0
     *
     ...
     *
     * @name Vsengine.Sound.WebAudioSound#seek
     * @type {number}
     * @fires Vsengine.Sound.Events#SEEK
     * @since 3.0.0
     */
    seek: {
        get: function () {
     ...
     *
     * @method Vsengine.Sound.WebAudioSound#setSeek
     * @fires Vsengine.Sound.Events#SEEK
     * @since 3.4.0
     *
     ...
     *
     * @name Vsengine.Sound.WebAudioSound#loop
     * @type {boolean}
     * @default false
     * @fires Vsengine.Sound.Events#LOOP
     * @since 3.0.0
     */
    loop: {
        get: function () {
     ...
     *
     * @method Vsengine.Sound.WebAudioSound#setLoop
     * @fires Vsengine.Sound.Events#LOOP
     * @since 3.4.0
     *
     ...
     *
     * @name Vsengine.Sound.WebAudioSound#pan
     * @type {number}
     * @default 0
     * @fires Vsengine.Sound.Events#PAN
     * @since 3.50.0
     */
    pan: {
        get: function () {
     ...
     *
     * @method Vsengine.Sound.WebAudioSound#setPan
     * @fires Vsengine.Sound.Events#PAN
     * @since 3.50.0
     *
