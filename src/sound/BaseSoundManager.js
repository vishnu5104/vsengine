 ...
 *
 * @see Vsengine.Sound.HTML5AudioSoundManager
 * @see Vsengine.Sound.NoAudioSoundManager
 * @see Vsengine.Sound.WebAudioSoundManager
 */
var BaseSoundManager = new Class({
    ...
    initialize: function BaseSoundManager(game) {
         ...
         *
         * @name Vsengine.Sound.BaseSoundManager#game
         * @type {Vsengine.Game}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.BaseSoundManager#jsonCache
         ...
         *
         * @name Vsengine.Sound.BaseSoundManager#sounds
         * @type {Vsengine.Sound.BaseSound[]}
         * @default []
         * @private
         * @since 3.0.0
         */
         ...
         * Global mute setting.
         *
         * @name Vsengine.Sound.BaseSoundManager#mute
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.BaseSoundManager#volume
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.BaseSoundManager#pauseOnBlur
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.BaseSoundManager#_rate
         * @type {number}
         * @private
         * @default 1
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Sound.BaseSoundManager#_detune
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Sound.BaseSoundManager#locked
         * @type {boolean}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.BaseSoundManager#unlocked
         * @type {boolean}
         * @default false
         * @private
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Sound.BaseSoundManager#gameLostFocus
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Sound.BaseSoundManager#listenerPosition
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#add
     * @override
     * @since 3.0.0
     *
     ...
     *
     * @return {Vsengine.Sound.BaseSound} The new sound instance.
     */
    add: NOOP,
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#addAudioSprite
     * @since 3.0.0
     *
     * @param {string} key - Asset key for the sound.
     * @param {Vsengine.Types.Sound.SoundConfig} [config] - An optional config object containing default sound settings.
     *
     * @return {(Vsengine.Sound.NoAudioSound|Vsengine.Sound.HTML5AudioSound|Vsengine.Sound.WebAudioSound)} The new audio sprite sound instance.
     */
    addAudioSprite: function (key, config) {
        ...
        for (var markerName in sound.spritemap) {
            ...
            markerConfig.loop = marker.hasOwnProperty("loop")
                ? marker.loop
                : false;
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#get
     * @since 3.23.0
     *
     ...
     * will be returned.
     *
     * @method Vsengine.Sound.BaseSoundManager#getAll
     * @since 3.23.0
     *
     * @generic {Vsengine.Sound.BaseSound} T
     * @genericUse {T[]} - [$return]
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#getAllPlaying
     * @since 3.60.0
     *
     * @generic {Vsengine.Sound.BaseSound} T
     * @genericUse {T[]} - [$return]
     *
     * @return {Vsengine.Sound.BaseSound[]} - All currently playing sounds, or an empty array.
     */
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#play
     * @listens Vsengine.Sound.Events#COMPLETE
     * @since 3.0.0
     *
     * @param {string} key - Asset key for the sound.
     ...
     * This lets you play a new sound on the fly without the need to keep a reference to it.
     *
     * @method Vsengine.Sound.BaseSoundManager#playAudioSprite
     * @listens Vsengine.Sound.Events#COMPLETE
     * @since 3.0.0
     *
     * @param {string} key - Asset key for the sound.
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#remove
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#removeAll
     * @since 3.23.0
     */
    removeAll: function () {
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#removeByKey
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#pauseAll
     * @fires Vsengine.Sound.Events#PAUSE_ALL
     * @since 3.0.0
     */
    pauseAll: function () {
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#resumeAll
     * @fires Vsengine.Sound.Events#RESUME_ALL
     * @since 3.0.0
     */
    resumeAll: function () {
        this.forEachActiveSound(function (sound) {
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#setListenerPosition
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#stopAll
     * @fires Vsengine.Sound.Events#STOP_ALL
     * @since 3.0.0
     */
    stopAll: function () {
        this.forEachActiveSound(function (sound) {
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#stopByKey
     * @since 3.23.0
     *
     * @param {string} key - Sound asset key.
     *
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#isPlaying
     * @since 3.85.0
     *
     * @param {?string} key - Sound asset key.
     *
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#unlock
     * @override
     * @protected
     * @since 3.0.0
     */
     ...
     * Vsengine.Sound.BaseSoundManager#pauseOnBlur is set to true.
     *
     * @method Vsengine.Sound.BaseSoundManager#onBlur
     * @override
     * @protected
     * @since 3.0.0
     */
     ...
     * Vsengine.Sound.BaseSoundManager#pauseOnBlur is set to true.
     *
     * @method Vsengine.Sound.BaseSoundManager#onFocus
     * @override
     * @protected
     * @since 3.0.0
     */
    ...
    /**
     * Internal handler for Vsengine.Core.Events#BLUR.
     *
     * @method Vsengine.Sound.BaseSoundManager#onGameBlur
     * @private
     * @since 3.23.0
     */
    onGameBlur: function () {
    ...
    /**
     * Internal handler for Vsengine.Core.Events#FOCUS.
     *
     * @method Vsengine.Sound.BaseSoundManager#onGameFocus
     * @private
     * @since 3.23.0
     */
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#update
     * @protected
     * @fires Vsengine.Sound.Events#UNLOCKED
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#destroy
     * @since 3.0.0
     */
    destroy: function () {
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#forEachActiveSound
     * @private
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#setRate
     * @fires Vsengine.Sound.Events#GLOBAL_RATE
     * @since 3.3.0
     *
     ...
     *
     * @name Vsengine.Sound.BaseSoundManager#rate
     * @type {number}
     * @default 1
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Sound.BaseSoundManager#setDetune
     * @fires Vsengine.Sound.Events#GLOBAL_DETUNE
     * @since 3.3.0
     *
     ...
     * The range of the value is -1200 to 1200, but we recommend setting it to [50](https://en.wikipedia.org/wiki/50_Cent).
     *
     * @name Vsengine.Sound.BaseSoundManager#detune
     * @type {number}
     * @default 0
     * @since 3.0.0
     */
