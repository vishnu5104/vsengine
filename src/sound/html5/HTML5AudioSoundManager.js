...
var HTML5AudioSoundManager = new Class({
    ...
    initialize: function HTML5AudioSoundManager(game) {
         ...
         * for succeeding playback or if succeeding Vsengine.Sound.HTML5AudioSound#play
         * call should be ignored.
         *
         * @name Vsengine.Sound.HTML5AudioSoundManager#override
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.HTML5AudioSoundManager#audioPlayDelay
         * @type {number}
         * @default 0.1
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.HTML5AudioSoundManager#loopEndOffset
         * @type {number}
         * @default 0.05
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.HTML5AudioSoundManager#onBlurPausedSounds
         * @type {Vsengine.Sound.HTML5AudioSound[]}
         * @private
         * @default []
         * @since 3.0.0
         */
         ...
         * Array of object types: { sound: Vsengine.Sound.HTML5AudioSound, name: string, value?: * }
         *
         * @name Vsengine.Sound.HTML5AudioSoundManager#lockedActionsQueue
         * @type {array}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.HTML5AudioSoundManager#_mute
         * @type {boolean}
         * @private
         * @default false
         * @since 3.0.0
         ...
         * for HTML5 Audio sound manager implementation.
         *
         * @name Vsengine.Sound.HTML5AudioSoundManager#_volume
         * @type {boolean}
         * @private
         * @default 1
         * @since 3.0.0
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSoundManager#unlock
     * @since 3.0.0
     */
    unlock: function () {
        this.locked = false;
            ...
            function () {
                ...
                while (this.lockedActionsQueue.length) {
                    ...
                    if (lockedAction.sound[lockedAction.prop].apply) {
                        lockedAction.sound[lockedAction.prop].apply(
                            lockedAction.sound,
                            lockedAction.value || []
                        );
                    } else {
                        lockedAction.sound[lockedAction.prop] =
                            lockedAction.value;
                    }
                }
            },
     ...
     * Vsengine.Sound.HTML5AudioSoundManager#pauseOnBlur is set to true.
     *
     * @method Vsengine.Sound.HTML5AudioSoundManager#onBlur
     * @protected
     * @since 3.0.0
     */
    onBlur: function () {
     ...
     * Vsengine.Sound.HTML5AudioSoundManager#pauseOnBlur is set to true.
     *
     * @method Vsengine.Sound.HTML5AudioSoundManager#onFocus
     * @protected
     * @since 3.0.0
     */
    onFocus: function () {
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSoundManager#destroy
     * @since 3.0.0
     */
    destroy: function () {
    ...
    /**
     * Method used internally by Vsengine.Sound.HTML5AudioSound class methods and property setters
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSoundManager#isLocked
     * @protected
     * @since 3.0.0
     *
     * @param {Vsengine.Sound.HTML5AudioSound} sound - Sound object on which to perform queued action.
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSoundManager#setMute
     * @fires Vsengine.Sound.Events#GLOBAL_MUTE
     * @since 3.3.0
     *
     * @param {boolean} value - `true` to mute all sounds, `false` to unmute them.
     *
     * @return {Vsengine.Sound.HTML5AudioSoundManager} This Sound Manager.
     */
    ...
    /**
     * @name Vsengine.Sound.HTML5AudioSoundManager#mute
     * @type {boolean}
     * @fires Vsengine.Sound.Events#GLOBAL_MUTE
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSoundManager#setVolume
    ...
    /**
     * @name Vsengine.Sound.HTML5AudioSoundManager#volume
     * @type {number}
     * @fires Vsengine.Sound.Events#GLOBAL_VOLUME
     * @since 3.0.0
     */
