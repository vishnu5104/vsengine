 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Sound.HTML5AudioSoundManager} manager - Reference to the current sound manager instance.
...
var HTML5AudioSound = new Class({
    ...
    initialize: function HTML5AudioSound(manager, key, config) {
         ...
         *
         * @name Vsengine.Sound.HTML5AudioSound#tags
         ...
         *
         * @name Vsengine.Sound.HTML5AudioSound#audio
         * @type {HTMLAudioElement}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.HTML5AudioSound#startTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Sound.HTML5AudioSound#previousTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSound#play
     ...
     * Pauses the sound.
     *
     * @method Vsengine.Sound.HTML5AudioSound#pause
     ...
     * Resumes the sound.
     *
     * @method Vsengine.Sound.HTML5AudioSound#resume
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSound#stop
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSound#pickAndPlayAudioTag
     * @since 3.0.0
     *
     ...
     * does nothing.
     *
     * @method Vsengine.Sound.HTML5AudioSound#pickAudioTag
     * @since 3.0.0
     *
     * @return {boolean} Whether the sound was assigned an audio tag successfully.
     */
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSound#playCatchPromise
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSound#stopAndReleaseAudioTag
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSound#reset
     * @since 3.0.0
     */
    reset: function () {
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSound#onBlur
     * @since 3.0.0
     */
    onBlur: function () {
     ...
     * Vsengine.Sound.HTML5AudioSoundManager#pauseOnBlur is set to true.
     *
     * @method Vsengine.Sound.HTML5AudioSound#onFocus
     * @since 3.0.0
     */
    onFocus: function () {
        this.isPlaying = true;
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSound#update
    ...
    update: function (time) {
        ...
        if (this.startTime > 0) {
            if (this.startTime < time - this.manager.audioPlayDelay) {
                this.audio.currentTime +=
                    Math.max(0, time - this.startTime) / 1000;
                this.startTime = 0;
        ...
        if (this.currentConfig.loop) {
            if (currentTime >= endTime - this.manager.loopEndOffset) {
                this.audio.currentTime =
                    startTime + Math.max(0, currentTime - endTime);
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSound#destroy
     * @since 3.0.0
     */
    destroy: function () {
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSound#updateMute
     * @since 3.0.0
     */
    updateMute: function () {
        if (this.audio) {
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSound#updateVolume
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSound#calculateRate
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Sound.HTML5AudioSound#mute
     * @type {boolean}
     * @default false
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSound#setMute
     * @fires Vsengine.Sound.Events#MUTE
     * @since 3.4.0
     *
     ...
     *
     * @name Vsengine.Sound.HTML5AudioSound#volume
     * @type {number}
     * @default 1
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSound#setVolume
     * @fires Vsengine.Sound.Events#VOLUME
     * @since 3.4.0
     *
     ...
     *
     * @name Vsengine.Sound.HTML5AudioSound#rate
     * @type {number}
     * @default 1
     ...
     * and 2.0 doubles the audios playback speed.
     *
     * @method Vsengine.Sound.HTML5AudioSound#setRate
     * @fires Vsengine.Sound.Events#RATE
     * @since 3.3.0
     *
     ...
     *
     * @name Vsengine.Sound.HTML5AudioSound#detune
     * @type {number}
     * @default 0
     ...
     * The range of the value is -1200 to 1200, but we recommend setting it to [50](https://en.wikipedia.org/wiki/50_Cent).
     *
     * @method Vsengine.Sound.HTML5AudioSound#setDetune
     * @fires Vsengine.Sound.Events#DETUNE
     * @since 3.3.0
     *
     ...
     *
     * @name Vsengine.Sound.HTML5AudioSound#seek
     * @type {number}
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSound#setSeek
     * @fires Vsengine.Sound.Events#SEEK
     * @since 3.4.0
     *
     ...
     *
     * @name Vsengine.Sound.HTML5AudioSound#loop
     * @type {boolean}
     * @default false
     ...
     *
     * @method Vsengine.Sound.HTML5AudioSound#setLoop
     * @fires Vsengine.Sound.Events#LOOP
     * @since 3.4.0
     *
     * @param {boolean} value - `true` to loop this sound, `false` to not loop it.
     *
     * @return {Vsengine.Sound.HTML5AudioSound} This Sound instance.
     */
     ...
     *
     * @name Vsengine.Sound.HTML5AudioSound#pan
     * @type {number}
     * @default 0
     ...
     * Has no audible effect on HTML5 Audio Sound, but still generates the PAN Event.
     *
     * @method Vsengine.Sound.HTML5AudioSound#setPan
     * @fires Vsengine.Sound.Events#PAN
     * @since 3.50.0
     *
