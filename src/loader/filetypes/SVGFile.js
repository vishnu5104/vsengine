 ...
 *
 * These are created when you use the Vsengine.Loader.LoaderPlugin#svg method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see Vsengine.Loader.LoaderPlugin#svg.
 *
 * @class SVGFile
 ...
 * @param {(string|Vsengine.Types.Loader.FileTypes.SVGFileConfig)} key - The key to use for this file, or a file configuration object.
 ...
 * @param {Vsengine.Types.Loader.FileTypes.SVGSizeConfig} [svgConfig] - The svg size configuration object.
...
var SVGFile = new Class({
     ...
     *
     * @method Vsengine.Loader.FileTypes.SVGFile#onProcess
     * @since 3.7.0
     */
    onProcess: function () {
        ...
        this.data.onerror = function () {
            ...
            if (!retry) {
                ...
                _this.data.src =
                    "data:image/svg+xml," + encodeURIComponent(svg.join(""));
            } else {
     ...
     *
     * @method Vsengine.Loader.FileTypes.SVGFile#addToCache
     * @since 3.7.0
     */
    addToCache: function () {
 ...
 * ```
 *
 * See the documentation for `Vsengine.Types.Loader.FileTypes.SVGFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the SVG File type has been built into Vsengine.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method Vsengine.Loader.LoaderPlugin#svg
 * @fires Vsengine.Loader.Events#ADD
 * @since 3.0.0
 *
 * @param {(string|Vsengine.Types.Loader.FileTypes.SVGFileConfig|Vsengine.Types.Loader.FileTypes.SVGFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
 * @param {string} [url] - The absolute or relative URL to load this file from. If undefined or `null` it will be set to `<key>.svg`, i.e. if `key` was "alien" then the URL will be "alien.svg".
 * @param {Vsengine.Types.Loader.FileTypes.SVGSizeConfig} [svgConfig] - The svg size configuration object.
