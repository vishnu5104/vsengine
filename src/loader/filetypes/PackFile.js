 ...
 *
 * These are created when you use the Vsengine.Loader.LoaderPlugin#pack method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see Vsengine.Loader.LoaderPlugin#pack.
 *
 * @class PackFile
 ...
 * @param {(string|Vsengine.Types.Loader.FileTypes.PackFileConfig)} key - The key to use for this file, or a file configuration object.
...
var PackFile = new Class({
     ...
     *
     * @method Vsengine.Loader.FileTypes.PackFile#onProcess
     * @since 3.7.0
     */
    onProcess: function () {
 ...
 *
 * The pack file can contain an entry for any type of file that Vsengine can load. The object structures exactly
 ...
 * ```
 *
 * See the documentation for `Vsengine.Types.Loader.FileTypes.PackFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the Pack File type has been built into Vsengine.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method Vsengine.Loader.LoaderPlugin#pack
 * @fires Vsengine.Loader.Events#ADD
 * @since 3.7.0
 *
 * @param {(string|Vsengine.Types.Loader.FileTypes.PackFileConfig|Vsengine.Types.Loader.FileTypes.PackFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
