 ...
 *
 * These are created when you use the Vsengine.Loader.LoaderPlugin#video method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see Vsengine.Loader.LoaderPlugin#video.
 *
 * @class VideoFile
 ...
 * @param {(string|Vsengine.Types.Loader.FileTypes.VideoFileConfig)} key - The key to use for this file, or a file configuration object.
...
var VideoFile = new Class({
    ...
    initialize: function VideoFile(loader, key, url, noAudio) {
     ...
     *
     * @method Vsengine.Loader.FileTypes.VideoFile#onProcess
     * @since 3.20.0
     */
    onProcess: function () {
        this.data = {
     ...
     *
     * @method Vsengine.Loader.FileTypes.VideoFile#load
     * @since 3.20.0
     */
    load: function () {
 ...
 * ```
 *
 * See the documentation for `Vsengine.Types.Loader.FileTypes.VideoFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the Video File type has been built into Vsengine.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method Vsengine.Loader.LoaderPlugin#video
 * @fires Vsengine.Loader.Events#ADD
 * @since 3.20.0
 *
 * @param {(string|Vsengine.Types.Loader.FileTypes.VideoFileConfig|Vsengine.Types.Loader.FileTypes.VideoFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
 * @param {(string|string[]|Vsengine.Types.Loader.FileTypes.VideoFileURLConfig|Vsengine.Types.Loader.FileTypes.VideoFileURLConfig[])} [urls] - The absolute or relative URL to load the video files from.
 * @param {boolean} [noAudio=false] - Does the video have an audio track? If not you can enable auto-playing on it.
 *
