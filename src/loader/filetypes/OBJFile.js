 ...
 *
 * These are created when you use the Vsengine.Loader.LoaderPlugin#obj method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see Vsengine.Loader.LoaderPlugin#obj.
 *
 * @class OBJFile
 ...
 * @param {(string|Vsengine.Types.Loader.FileTypes.OBJFileConfig)} key - The key to use for this file, or a file configuration object.
 ...
 * @param {Vsengine.Types.Loader.XHRSettingsObject} [xhrSettings] - Extra XHR Settings specifically for these files.
 */
var OBJFile = new Class({
    Extends: MultiFile,

    initialize: function OBJFile(
        loader,
        key,
        objURL,
        matURL,
     ...
     *
     * @method Vsengine.Loader.FileTypes.OBJFile#addToCache
     * @since 3.50.0
     */
    addToCache: function () {
 ...
 * ```
 *
 * See the documentation for `Vsengine.Types.Loader.FileTypes.OBJFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the OBJ File type has been built into Vsengine.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method Vsengine.Loader.LoaderPlugin#obj
 * @fires Vsengine.Loader.Events#ADD
 * @since 3.50.0
 *
 * @param {(string|Vsengine.Types.Loader.FileTypes.OBJFileConfig|Vsengine.Types.Loader.FileTypes.OBJFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
 * @param {string} [objURL] - The absolute or relative URL to load the obj file from. If undefined or `null` it will be set to `<key>.obj`, i.e. if `key` was "alien" then the URL will be "alien.obj".
...
FileTypesManager.register(
    "obj",
    function (key, objURL, matURL, flipUVs, xhrSettings) {
        var multifile;
