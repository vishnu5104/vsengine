 ...
 *
 * These are created when you use the Vsengine.Loader.LoaderPlugin#tilemapTiledJSON method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see Vsengine.Loader.LoaderPlugin#tilemapTiledJSON.
 *
 * @class TilemapJSONFile
 * @extends Vsengine.Loader.FileTypes.JSONFile
 ...
 * @param {(string|Vsengine.Types.Loader.FileTypes.TilemapJSONFileConfig)} key - The key to use for this file, or a file configuration object.
...
var TilemapJSONFile = new Class({
     ...
     *
     * @method Vsengine.Loader.FileTypes.TilemapJSONFile#addToCache
     * @since 3.7.0
     */
    addToCache: function () {
 ...
 * ```
 *
 * See the documentation for `Vsengine.Types.Loader.FileTypes.TilemapJSONFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the Tilemap JSON File type has been built into Vsengine.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method Vsengine.Loader.LoaderPlugin#tilemapTiledJSON
 * @fires Vsengine.Loader.Events#ADD
 * @since 3.0.0
 *
 * @param {(string|Vsengine.Types.Loader.FileTypes.TilemapJSONFileConfig|Vsengine.Types.Loader.FileTypes.TilemapJSONFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
 * @param {object|string} [url] - The absolute or relative URL to load this file from. If undefined or `null` it will be set to `<key>.json`, i.e. if `key` was "alien" then the URL will be "alien.json". Or, a well formed JSON object.
