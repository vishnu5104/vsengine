 ...
 *
 * These are created when you use the Vsengine.Loader.LoaderPlugin#scripts method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see Vsengine.Loader.LoaderPlugin#scripts.
 *
 ...
 * @param {(string|Vsengine.Types.Loader.FileTypes.MultiScriptFileConfig)} key - The key to use for this file, or a file configuration object.
 ...
 * @param {Vsengine.Types.Loader.XHRSettingsObject} [xhrSettings] - An XHR Settings configuration object for the script files. Used in replacement of the Loaders default XHR Settings.
 */
var MultiScriptFile = new Class({
     ...
     *
     * @method Vsengine.Loader.FileTypes.MultiScriptFile#addToCache
     * @since 3.17.0
     */
    addToCache: function () {
 ...
 * ```
 *
 * See the documentation for `Vsengine.Types.Loader.FileTypes.MultiScriptFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the MultiScript File type has been built into Vsengine.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method Vsengine.Loader.LoaderPlugin#scripts
 * @fires Vsengine.Loader.Events#ADD
 * @since 3.17.0
 *
 * @param {(string|Vsengine.Types.Loader.FileTypes.MultiScriptFileConfig|Vsengine.Types.Loader.FileTypes.MultiScriptFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
 * @param {string[]} [url] - An array of absolute or relative URLs to load the script files from. They are processed in the order given in the array.
