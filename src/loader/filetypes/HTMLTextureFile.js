 ...
 *
 * These are created when you use the Vsengine.Loader.LoaderPlugin#htmlTexture method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see Vsengine.Loader.LoaderPlugin#htmlTexture.
 *
 ...
 * @param {(string|Vsengine.Types.Loader.FileTypes.HTMLTextureFileConfig)} key - The key to use for this file, or a file configuration object.
...
var HTMLTextureFile = new Class({
    ...
    initialize: function HTMLTextureFile(
        loader,
        key,
        url,
        width,
     ...
     *
     * @method Vsengine.Loader.FileTypes.HTMLTextureFile#onProcess
     * @since 3.7.0
     */
    onProcess: function () {
     ...
     *
     * @method Vsengine.Loader.FileTypes.HTMLTextureFile#addToCache
     * @since 3.7.0
     */
    addToCache: function () {
 ...
 * ```
 *
 * See the documentation for `Vsengine.Types.Loader.FileTypes.HTMLTextureFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the HTMLTextureFile File type has been built into Vsengine.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method Vsengine.Loader.LoaderPlugin#htmlTexture
 * @fires Vsengine.Loader.Events#ADD
 * @since 3.12.0
 *
 * @param {(string|Vsengine.Types.Loader.FileTypes.HTMLTextureFileConfig|Vsengine.Types.Loader.FileTypes.HTMLTextureFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
...
FileTypesManager.register(
    "htmlTexture",
    function (key, url, width, height, xhrSettings) {
        if (Array.isArray(key)) {
            ...
            this.addFile(
                new HTMLTextureFile(this, key, url, width, height, xhrSettings)
            );
        }
