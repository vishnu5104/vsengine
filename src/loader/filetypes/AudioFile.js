 ...
 *
 * These are created when you use the Vsengine.Loader.LoaderPlugin#audio method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see Vsengine.Loader.LoaderPlugin#audio.
 *
 * @class AudioFile
 ...
 * @param {(string|Vsengine.Types.Loader.FileTypes.AudioFileConfig)} key - The key to use for this file, or a file configuration object.
 * @param {Vsengine.Types.Loader.FileTypes.AudioFileURLConfig} [urlConfig] - The absolute or relative URL to load this file from in a config object.
...
var AudioFile = new Class({
     ...
     *
     * @method Vsengine.Loader.FileTypes.AudioFile#onProcess
     * @since 3.0.0
     */
    onProcess: function () {
        ...
        this.config.context.decodeAudioData(
            ...
            function (e) {
                ...
                console.error(
                    "Error decoding audio: " + _this.key + " - ",
                    e ? e.message : null
                );
 ...
 * ```
 *
 * See the documentation for `Vsengine.Types.Loader.FileTypes.AudioFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the Audio File type has been built into Vsengine.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method Vsengine.Loader.LoaderPlugin#audio
 * @fires Vsengine.Loader.Events#ADD
 * @since 3.0.0
 *
 * @param {(string|Vsengine.Types.Loader.FileTypes.AudioFileConfig|Vsengine.Types.Loader.FileTypes.AudioFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
 * @param {(string|string[]|Vsengine.Types.Loader.FileTypes.AudioFileURLConfig|Vsengine.Types.Loader.FileTypes.AudioFileURLConfig[])} [urls] - The absolute or relative URL to load the audio files from.
