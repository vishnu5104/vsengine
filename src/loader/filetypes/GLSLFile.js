 ...
 *
 * These are created when you use the Vsengine.Loader.LoaderPlugin#glsl method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see Vsengine.Loader.LoaderPlugin#glsl.
 *
 * @class GLSLFile
 ...
 * @param {(string|Vsengine.Types.Loader.FileTypes.GLSLFileConfig)} key - The key to use for this file, or a file configuration object.
...
var GLSLFile = new Class({
     ...
     *
     * @method Vsengine.Loader.FileTypes.GLSLFile#onProcess
     * @since 3.7.0
     */
    onProcess: function () {
     ...
     *
     * @method Vsengine.Loader.FileTypes.GLSLFile#addToCache
     * @since 3.17.0
     */
    addToCache: function () {
        ...
        if (block) {
            while (block) {
                ...
                if (this.cache.has(key)) {
                    ...
                    this.cache.add(
                        key,
                        new Shader(key, shaderSrc, "", uniforms)
                    );
                } else {
                    this.cache.add(
                        key,
     ...
     *
     * @method Vsengine.Loader.FileTypes.GLSLFile#getShaderName
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.Loader.FileTypes.GLSLFile#getShaderType
     * @since 3.17.0
     *
     * @param {string[]} headerSource - The header data.
     *
     ...
     *
     * @method Vsengine.Loader.FileTypes.GLSLFile#getShaderUniforms
     * @since 3.17.0
     *
     * @param {string[]} headerSource - The header data.
     *
     ...
     *
     * @method Vsengine.Loader.FileTypes.GLSLFile#extractBlock
     * @private
     * @since 3.17.0
     *
 ...
 * In Vsengine 3 GLSL files are just plain Text files at the current moment in time.
 *
 ...
 * ```
 *
 * See the documentation for `Vsengine.Types.Loader.FileTypes.GLSLFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the GLSL File type has been built into Vsengine.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method Vsengine.Loader.LoaderPlugin#glsl
 * @fires Vsengine.Loader.Events#ADD
 * @since 3.0.0
 *
 * @param {(string|Vsengine.Types.Loader.FileTypes.GLSLFileConfig|Vsengine.Types.Loader.FileTypes.GLSLFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
