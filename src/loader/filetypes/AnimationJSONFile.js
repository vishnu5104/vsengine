 ...
 *
 * These are created when you use the Vsengine.Loader.LoaderPlugin#animation method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see Vsengine.Loader.LoaderPlugin#animation.
 *
 ...
 * @param {(string|Vsengine.Types.Loader.FileTypes.JSONFileConfig)} key - The key to use for this file, or a file configuration object.
...
var AnimationJSONFile = new Class({
     ...
     *
     * @method Vsengine.Loader.FileTypes.AnimationJSONFile#onProcess
     * @since 3.7.0
     */
    onProcess: function () {
     ...
     *
     * @method Vsengine.Loader.FileTypes.AnimationJSONFile#onLoadComplete
     * @since 3.7.0
     */
 ...
 * ```
 *
 * See the documentation for `Vsengine.Types.Loader.FileTypes.JSONFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the JSON File type has been built into Vsengine.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method Vsengine.Loader.LoaderPlugin#animation
...
FileTypesManager.register(
    ...
    function (key, url, dataKey, xhrSettings) {
        ...
        if (Array.isArray(key)) {
            ...
            this.addFile(
                new AnimationJSONFile(this, key, url, xhrSettings, dataKey)
            );
        }
