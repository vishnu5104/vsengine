 ...
 *
 * These are created when you use the Vsengine.Loader.LoaderPlugin#sceneFile method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see Vsengine.Loader.LoaderPlugin#sceneFile.
 *
 * @class SceneFile
 ...
 * @param {(string|Vsengine.Types.Loader.FileTypes.SceneFileConfig)} key - The key to use for this file, or a file configuration object.
...
var SceneFile = new Class({
     ...
     *
     * @method Vsengine.Loader.FileTypes.SceneFile#onProcess
     * @since 3.16.0
     */
    onProcess: function () {
     ...
     *
     * @method Vsengine.Loader.FileTypes.SceneFile#addToCache
     * @since 3.16.0
     */
    addToCache: function () {
        var code = this.data.concat(
            "(function(){\n" +
                "return new " +
                this.key +
                "();\n" +
 ...
 *
 * ```javascript
 * class ExternalScene extends Vsengine.Scene {
 *
 *     constructor ()
 *     {
 *         super('myScene');
 ...
 * ```
 *
 * See the documentation for `Vsengine.Types.Loader.FileTypes.SceneFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the Scene File type has been built into Vsengine.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method Vsengine.Loader.LoaderPlugin#sceneFile
 * @fires Vsengine.Loader.Events#ADD
 * @since 3.16.0
 *
 * @param {(string|Vsengine.Types.Loader.FileTypes.SceneFileConfig|Vsengine.Types.Loader.FileTypes.SceneFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
 * @param {string} [url] - The absolute or relative URL to load this file from. If undefined or `null` it will be set to `<key>.js`, i.e. if `key` was "alien" then the URL will be "alien.js".
