 ...
 *
 * You can also listen for the generic completion of files. See the [FILE_COMPLETE]{@linkcode Vsengine.Loader.Events#event:FILE_COMPLETE} event.
 *
 * @event Vsengine.Loader.Events#FILE_KEY_COMPLETE
 * @type {string}
 * @since 3.0.0
 *
