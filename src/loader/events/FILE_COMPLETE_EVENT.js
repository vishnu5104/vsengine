 ...
 *
 * You can also listen for the completion of a specific file. See the [FILE_KEY_COMPLETE]{@linkcode Vsengine.Loader.Events#event:FILE_KEY_COMPLETE} event.
 *
 * @event Vsengine.Loader.Events#FILE_COMPLETE
 * @type {string}
 * @since 3.0.0
 *
 * @param {string} key - The key of the file that just loaded and finished processing.
 * @param {string} type - The [file type]{@link Vsengine.Loader.File#type} of the file that just loaded, i.e. `image`.
