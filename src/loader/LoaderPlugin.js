 ...
 * @memberof Vsengine.Loader
 * @constructor
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - The Scene which owns this Loader instance.
 */
var LoaderPlugin = new Class({
    ...
    initialize: function LoaderPlugin(scene) {
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#scene
         * @type {Vsengine.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#systems
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#cacheManager
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#textureManager
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#sceneManager
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#prefix
         * @type {string}
         * @default ''
         * @since 3.7.0
         */
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#path
         * @type {string}
         * @default ''
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#baseURL
         * @type {string}
         * @default ''
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#maxParallelDownloads
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#xhr
         * @type {Vsengine.Types.Loader.XHRSettingsObject}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#crossOrigin
         * @type {string}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#imageLoadType
         * @type {string}
         * @since 3.60.0
         */
         ...
         *
         * This is populated by the `Vsengine.Core.Config#loaderLocalScheme` game configuration setting and defaults to
         * `[ 'file://', 'capacitor://' ]`. Additional local schemes can be added to this array as needed.
         *
         * @name Vsengine.Loader.LoaderPlugin#localSchemes
         * @type {string[]}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#totalToLoad
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#progress
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#list
         * @type {Vsengine.Structs.Set.<Vsengine.Loader.File>}
         * @since 3.0.0
         */
         ...
         * By the end of the load process this Set will be empty.
         *
         * @name Vsengine.Loader.LoaderPlugin#inflight
         * @type {Vsengine.Structs.Set.<Vsengine.Loader.File>}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#queue
         * @type {Vsengine.Structs.Set.<Vsengine.Loader.File>}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#_deleteQueue
         * @type {Vsengine.Structs.Set.<Vsengine.Loader.File>}
         * @private
         * @since 3.7.0
         */
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#totalFailed
         * @type {number}
         * @default 0
         * @since 3.7.0
         */
         ...
         * This value is reset when you call `Loader.start`.
         *
         * @name Vsengine.Loader.LoaderPlugin#totalComplete
         * @type {number}
         * @default 0
         * @since 3.7.0
         */
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#state
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Loader.LoaderPlugin#multiKeyIndex
         * @type {number}
         * @private
         * @since 3.20.0
         */
         ...
         * is changed.
         *
         * @name Vsengine.Loader.LoaderPlugin#maxRetries
         * @type {number}
         * @default 2
         * @since 3.85.0
         */
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#boot
     * @private
     * @since 3.5.1
     */
    boot: function () {
     ...
     * Do not invoke it directly.
     *
     * @method Vsengine.Loader.LoaderPlugin#pluginStart
     * @private
     * @since 3.5.1
     */
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#setBaseURL
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#setPath
     * @since 3.0.0
     *
     ...
     * file _already_ in the load queue. To reset it, call this method with no arguments.
     *
     * @method Vsengine.Loader.LoaderPlugin#setPrefix
     * @since 3.7.0
     *
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#setCORS
     * @since 3.0.0
     *
     ...
     *
     * The file must be an instance of `Vsengine.Loader.File`, or a class that extends it. The Loader will check that the key
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#addFile
     * @fires Vsengine.Loader.Events#ADD
     * @since 3.0.0
     *
     * @param {(Vsengine.Loader.File|Vsengine.Loader.File[])} file - The file, or array of files, to be added to the load queue.
     */
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#keyExists
     * @since 3.7.0
     *
     * @param {Vsengine.Loader.File} file - The file to check the key of.
     *
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#addPack
     * @since 3.7.0
     *
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#removePack
     * @since 3.85.0
     *
            ...
            if (Array.isArray(files)) {
                for (var i = 0; i < files.length; i++) {
                    ...
                    if (type === "spine") {
                        ...
                        var spineTexture =
                            cacheManager.custom.spineTextures.get(fileKey);
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#isLoading
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#isReady
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#start
     * @fires Vsengine.Loader.Events#START
     * @since 3.0.0
     */
    start: function () {
        if (!this.isReady()) {
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#updateProgress
     * @fires Vsengine.Loader.Events#PROGRESS
     * @since 3.0.0
     */
     ...
     * Called automatically during the load process.
     *
     * @method Vsengine.Loader.LoaderPlugin#update
     * @since 3.10.0
     */
    update: function () {
        if (
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#checkLoadQueue
     * @private
     * @since 3.7.0
     */
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#nextFile
     * @fires Vsengine.Loader.Events#FILE_LOAD
     * @fires Vsengine.Loader.Events#FILE_LOAD_ERROR
     * @since 3.0.0
     *
     * @param {Vsengine.Loader.File} file - The File that just finished loading, or errored during load.
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#fileProcessComplete
     * @since 3.7.0
     *
     * @param {Vsengine.Loader.File} file - The file that has finished processing.
     */
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#loadComplete
     * @fires Vsengine.Loader.Events#COMPLETE
     * @fires Vsengine.Loader.Events#POST_PROCESS
     * @since 3.7.0
     */
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#flagForRemoval
     * @since 3.7.0
     *
     * @param {Vsengine.Loader.File} file - The File to be queued for deletion when the Loader completes.
     */
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#saveJSON
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#save
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#reset
     * @since 3.0.0
     */
    reset: function () {
        this.list.clear();
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#shutdown
     * @private
     * @since 3.0.0
     */
    shutdown: function () {
     ...
     *
     * @method Vsengine.Loader.LoaderPlugin#destroy
     * @private
     * @since 3.0.0
     */
    destroy: function () {
