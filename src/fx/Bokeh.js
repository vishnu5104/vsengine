...
var Bokeh = new Class({
    ...
    initialize: function Bokeh(
         ...
         *
         * @name Vsengine.FX.Bokeh#contrast
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.FX.Bokeh#isTiltShift
         * @type {boolean}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.FX.Bokeh#strength
         * @type {number}
         * @since 3.60.0
         */
