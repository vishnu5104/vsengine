...
var Circle = new Class({
    ...
    initialize: function Circle(
         ...
         *
         * @name Vsengine.FX.Circle#feather
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.FX.Circle#thickness
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.FX.Circle#glcolor
         * @type {number[]}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.FX.Circle#glcolor2
         * @type {number[]}
         * @since 3.60.0
         */
     ...
     *
     * @name Vsengine.FX.Circle#backgroundColor
     * @type {number}
     * @since 3.60.0
     */
    backgroundColor: {
     ...
     *
     * @name Vsengine.FX.Circle#backgroundAlpha
     * @type {number}
     * @since 3.70.0
     */
    backgroundAlpha: {
