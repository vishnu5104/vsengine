...
var Displacement = new Class({
    ...
    initialize: function Displacement(gameObject, texture, x, y) {
         ...
         *
         * @name Vsengine.FX.Displacement#x
         * @type {number}
         * @since 3.60.0
         */
        this.x = x;
         ...
         *
         * @name Vsengine.FX.Displacement#y
         * @type {number}
         * @since 3.60.0
         */
        this.y = y;
         ...
         *
         * @name Vsengine.FX.Displacement#glTexture
     ...
     *
     * @method Vsengine.FX.Displacement#setTexture
     * @since 3.60.0
     *
     * @param {string} [texture='__WHITE'] - The unique string-based key of the texture to use for displacement, which must exist in the Texture Manager.
     *
    ...
    setTexture: function (texture) {
        var phaserTexture =
            this.gameObject.scene.sys.textures.getFrame(texture);
