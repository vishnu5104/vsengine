...
var Controller = new Class({
    initialize: function Controller(type, gameObject) {
         ...
         *
         * @name Vsengine.FX.Controller#type
         * @type {number}
         * @since 3.60.0
         */
        this.type = type;
         ...
         *
         * @name Vsengine.FX.Controller#gameObject
         ...
         *
         * @name Vsengine.FX.Controller#active
         * @type {boolean}
         * @since 3.60.0
         */
        this.active = true;
     ...
     *
     * @method Vsengine.FX.Controller#setActive
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.FX.Controller#destroy
     * @since 3.60.0
     */
    destroy: function () {
