...
var Shadow = new Class({
    ...
    initialize: function Shadow(
         ...
         *
         * @name Vsengine.FX.Shadow#glcolor
         * @type {number[]}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.FX.Shadow#samples
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.FX.Shadow#intensity
         * @type {number}
         * @since 3.60.0
         */
