...
var Bloom = new Class({
    ...
    initialize: function Bloom(
         ...
         *
         * @name Vsengine.FX.Bloom#offsetX
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.FX.Bloom#offsetY
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.FX.Bloom#blurStrength
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.FX.Bloom#strength
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.FX.Bloom#glcolor
         * @type {number[]}
         * @since 3.60.0
         */
        this.glcolor = [1, 1, 1];
