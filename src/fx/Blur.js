...
var Blur = new Class({
    ...
    initialize: function Blur(
         ...
         *
         * @name Vsengine.FX.Blur#strength
         * @type {number}
         * @since 3.60.0
         */
