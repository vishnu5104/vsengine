...
var Glow = new Class({
    ...
    initialize: function Glow(
         ...
         *
         * @name Vsengine.FX.Glow#outerStrength
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.FX.Glow#innerStrength
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.FX.Glow#knockout
         * @type {number}
         * @since 3.60.0
         */
