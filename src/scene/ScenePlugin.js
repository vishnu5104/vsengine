 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - The Scene that this ScenePlugin belongs to.
 */
var ScenePlugin = new Class({
    initialize: function ScenePlugin(scene) {
         ...
         *
         * @name Vsengine.Scenes.ScenePlugin#scene
         * @type {Vsengine.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name Vsengine.Scenes.ScenePlugin#systems
         ...
         *
         * @name Vsengine.Scenes.ScenePlugin#settings
         ...
         *
         * @name Vsengine.Scenes.ScenePlugin#key
         * @type {string}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Scenes.ScenePlugin#manager
         ...
         *
         * @name Vsengine.Scenes.ScenePlugin#transitionProgress
         * @type {number}
         * @since 3.5.0
         */
         ...
         *
         * @name Vsengine.Scenes.ScenePlugin#_elapsed
         * @type {number}
         * @private
         * @since 3.5.0
         */
         ...
         * Transition elapsed timer.
         *
         * @name Vsengine.Scenes.ScenePlugin#_target
         * @type {?Vsengine.Scene}
         * @private
         * @since 3.5.0
         */
         ...
         * Transition duration.
         *
         * @name Vsengine.Scenes.ScenePlugin#_duration
         * @type {number}
         * @private
         * @since 3.5.0
         */
         ...
         * Transition callback.
         *
         * @name Vsengine.Scenes.ScenePlugin#_onUpdate
         * @type {function}
         * @private
         * @since 3.5.0
         */
         ...
         *
         * @name Vsengine.Scenes.ScenePlugin#_onUpdateScope
         * @type {object}
         * @private
         * @since 3.5.0
         */
         ...
         *
         * @name Vsengine.Scenes.ScenePlugin#_willSleep
         * @type {boolean}
         * @private
         * @since 3.5.0
         */
         ...
         *
         * @name Vsengine.Scenes.ScenePlugin#_willRemove
         * @type {boolean}
         * @private
         * @since 3.5.0
         */
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#boot
     * @private
     * @since 3.0.0
     */
    boot: function () {
     ...
     * Do not invoke it directly.
     *
     * @method Vsengine.Scenes.ScenePlugin#pluginStart
     * @private
     * @since 3.5.0
     */
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#start
     * @since 3.0.0
     *
     ...
     * This will happen at the next Scene Manager update, not immediately.
     *
     * @method Vsengine.Scenes.ScenePlugin#restart
     * @since 3.4.0
     *
     * @param {object} [data] - The Scene data. If no value is given it will not overwrite any previous data that may exist.
     *
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#transition
     * @fires Vsengine.Scenes.Events#TRANSITION_OUT
     * @since 3.5.0
     *
     * @param {Vsengine.Types.Scenes.SceneTransitionConfig} config - The transition configuration object.
     *
    ...
    transition: function (config) {
        ...
        if (callback) {
            ...
            this._onUpdateScope = GetFastValue(
                config,
                "onUpdateScope",
                this.scene
            );
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#checkValidTransition
     * @private
     * @since 3.5.0
     *
     * @param {Vsengine.Scene} target - The Scene to test against.
     *
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#step
     * @private
     * @since 3.5.0
     *
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#transitionComplete
     * @private
     * @fires Vsengine.Scenes.Events#TRANSITION_COMPLETE
     * @since 3.5.0
     */
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#add
     * @since 3.0.0
     *
     ...
     * This will happen at the next Scene Manager update, not immediately.
     *
     * @method Vsengine.Scenes.ScenePlugin#launch
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|Vsengine.Scene)} key - The Scene to launch.
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#run
     * @since 3.10.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     * This will happen at the next Scene Manager update, not immediately.
     *
     * @method Vsengine.Scenes.ScenePlugin#pause
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     * This will happen at the next Scene Manager update, not immediately.
     *
     * @method Vsengine.Scenes.ScenePlugin#resume
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     * This will happen at the next Scene Manager update, not immediately.
     *
     * @method Vsengine.Scenes.ScenePlugin#sleep
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     * This will happen at the next Scene Manager update, not immediately.
     *
     * @method Vsengine.Scenes.ScenePlugin#wake
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     * This will happen at the next Scene Manager update, not immediately.
     *
     * @method Vsengine.Scenes.ScenePlugin#switch
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#stop
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#setActive
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     * @param {(string|Vsengine.Scene)} [key] - The Scene to set the active state of.
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#setVisible
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     * @param {(string|Vsengine.Scene)} [key] - The Scene to set the visible state for.
     *
     * @return {this} This Scene Plugin instance.
     */
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#isSleeping
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#isActive
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#isPaused
     * @since 3.17.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#isVisible
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#swapPosition
     * @since 3.2.0
     *
     * @generic {Vsengine.Scene} T
     ...
     * @param {(string|Vsengine.Scene)} [keyB] - The second Scene to swap. If none is given it defaults to this Scene.
     *
     * @return {this} This Scene Plugin instance.
     */
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#moveAbove
     * @since 3.2.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [keyA,keyB]
     *
     * @param {(string|Vsengine.Scene)} keyA - The Scene that Scene B will be moved to be above.
     * @param {(string|Vsengine.Scene)} [keyB] - The Scene to be moved. If none is given it defaults to this Scene.
     *
     * @return {this} This Scene Plugin instance.
     */
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#moveBelow
     * @since 3.2.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [keyA,keyB]
     *
     * @param {(string|Vsengine.Scene)} keyA - The Scene that Scene B will be moved to be below.
     * @param {(string|Vsengine.Scene)} [keyB] - The Scene to be moved. If none is given it defaults to this Scene.
     *
     * @return {this} This Scene Plugin instance.
     */
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#remove
     * @since 3.2.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|Vsengine.Scene)} [key] - The Scene to be removed.
     *
     * @return {this} This Scene Plugin instance.
     */
    remove: function (key) {
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#moveUp
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#moveDown
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#bringToTop
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#sendToBack
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     * @genericUse {(T|string)} - [key]
     *
     * @method Vsengine.Scenes.ScenePlugin#get
     * @since 3.0.0
     *
     * @param {(string|Vsengine.Scene)} key - The Scene to retrieve.
     *
     * @return {Vsengine.Scene} The Scene.
     */
    get: function (key) {
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#getStatus
     * @since 3.60.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|Vsengine.Scene)} key - The Scene to get the status from.
     *
     * @return {number} The Scene status. This maps to the `Vsengine.Scene` constants, such as `Vsengine.Scene.LOADING`.
     */
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#getIndex
     * @since 3.7.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|Vsengine.Scene)} [key] - The Scene to get the index of.
     *
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#shutdown
     * @private
     * @since 3.0.0
     */
    shutdown: function () {
     ...
     *
     * @method Vsengine.Scenes.ScenePlugin#destroy
     * @private
     * @since 3.0.0
     */
    destroy: function () {
