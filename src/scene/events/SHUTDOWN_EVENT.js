 ...
 * currently active. Use the [DESTROY]{@linkcode Vsengine.Scenes.Events#event:DESTROY} event to completely clear resources.
 *
 * @event Vsengine.Scenes.Events#SHUTDOWN
 * @type {string}
 * @since 3.0.0
 *
