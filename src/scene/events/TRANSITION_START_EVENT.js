 ...
 *
 * If the Target Scene was sleeping then the [TRANSITION_WAKE]{@linkcode Vsengine.Scenes.Events#event:TRANSITION_WAKE} event is
 ...
 *
 * @event Vsengine.Scenes.Events#TRANSITION_START
 * @type {string}
 * @since 3.5.0
 *
