 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Game} game - The Vsengine.Game instance this Scene Manager belongs to.
...
var SceneManager = new Class({
    initialize: function SceneManager(game, sceneConfig) {
         ...
         *
         * @name Vsengine.Scenes.SceneManager#game
         * @type {Vsengine.Game}
         * @since 3.0.0
         */
        this.game = game;
         ...
         *
         * @name Vsengine.Scenes.SceneManager#keys
         * @type {Record<string, Vsengine.Scene>}
         * @since 3.0.0
         */
        this.keys = {};
         ...
         *
         * @name Vsengine.Scenes.SceneManager#scenes
         * @type {Vsengine.Scene[]}
         * @since 3.0.0
         */
        this.scenes = [];
         ...
         *
         * @name Vsengine.Scenes.SceneManager#_pending
         * @type {array}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Scenes.SceneManager#_start
         * @type {array}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Scenes.SceneManager#_queue
         * @type {array}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Scenes.SceneManager#_data
         * @type {object}
         * @private
         * @since 3.4.0
         */
         ...
         *
         * @name Vsengine.Scenes.SceneManager#isProcessing
         * @type {boolean}
         * @default false
         * @readonly
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Scenes.SceneManager#isBooted
         * @type {boolean}
         * @default false
         * @readonly
         * @since 3.4.0
         ...
         *
         * @name Vsengine.Scenes.SceneManager#customViewports
         * @type {number}
         * @default 0
         * @since 3.12.0
         */
         ...
         * being tied to one.
         *
         * @name Vsengine.Scenes.SceneManager#systemScene
         * @type {Vsengine.Scene}
         * @since 3.60.0
         */
        this.systemScene;
     ...
     *
     * @method Vsengine.Scenes.SceneManager#bootQueue
     * @private
     * @fires Vsengine.Core.Events#SYSTEM_READY
     * @since 3.2.0
     */
    bootQueue: function () {
        if (this.isBooted) {
        ...
        this.systemScene = this.createSceneFromInstance(
            "__SYSTEM",
            new Scene()
        );
     ...
     *
     * @method Vsengine.Scenes.SceneManager#processQueue
     * @since 3.0.0
     */
     ...
     *
     * * A `Vsengine.Scene` object, or an object that extends it.
     * * A plain JavaScript object
     * * A JavaScript ES6 Class that extends `Vsengine.Scene`
     * * A JavaScript ES5 prototype based Class
     * * A JavaScript function
     *
     * If a function is given then a new Scene will be created by calling it.
     *
     * @method Vsengine.Scenes.SceneManager#add
     * @since 3.0.0
     *
     * @param {string} key - A unique key used to reference the Scene, i.e. `MainMenu` or `Level1`.
     * @param {(Vsengine.Types.Scenes.SceneType)} sceneConfig - The config for the Scene
     ...
     *
     * @return {?Vsengine.Scene} The added Scene, if it was added immediately, otherwise `null`.
     */
     ...
     *
     * @method Vsengine.Scenes.SceneManager#remove
     * @since 3.2.0
     *
     * @param {string} key - A unique key used to reference the Scene, i.e. `MainMenu` or `Level1`.
     *
     ...
     *
     * @method Vsengine.Scenes.SceneManager#bootScene
     * @private
     * @fires Vsengine.Scenes.Events#TRANSITION_INIT
     * @since 3.0.0
     *
     * @param {Vsengine.Scene} scene - The Scene to boot.
     */
     ...
     *
     * @method Vsengine.Scenes.SceneManager#loadComplete
     * @private
     * @since 3.0.0
     *
     * @param {Vsengine.Loader.LoaderPlugin} loader - The loader that has completed loading.
     */
     ...
     *
     * @method Vsengine.Scenes.SceneManager#payloadComplete
     * @private
     * @since 3.0.0
     *
     * @param {Vsengine.Loader.LoaderPlugin} loader - The loader that has completed loading its Scene's payload.
     */
     ...
     * Updates the Scenes.
     *
     * @method Vsengine.Scenes.SceneManager#update
     * @since 3.0.0
     *
     ...
     * Renders the Scenes.
     *
     * @method Vsengine.Scenes.SceneManager#render
     * @since 3.0.0
     *
     * @param {(Vsengine.Renderer.Canvas.CanvasRenderer|Vsengine.Renderer.WebGL.WebGLRenderer)} renderer - The renderer to use.
     */
    ...
    /**
     * Calls the given Scene's {@link Vsengine.Scene#create} method and updates its status.
     *
     * @method Vsengine.Scenes.SceneManager#create
     * @private
     * @fires Vsengine.Scenes.Events#CREATE
     * @fires Vsengine.Scenes.Events#TRANSITION_INIT
     * @since 3.0.0
     *
     * @param {Vsengine.Scene} scene - The Scene to create.
     */
     ...
     *
     * @method Vsengine.Scenes.SceneManager#createSceneFromFunction
     * @private
     * @since 3.0.0
     *
     ...
     *
     * @return {Vsengine.Scene} The created Scene.
     */
     ...
     *
     * @method Vsengine.Scenes.SceneManager#createSceneFromInstance
     * @private
     * @since 3.0.0
     *
     * @param {string} key - The key of the Scene.
     * @param {Vsengine.Scene} newScene - The Scene instance.
     *
     * @return {Vsengine.Scene} The created Scene.
     */
     ...
     *
     * @method Vsengine.Scenes.SceneManager#createSceneFromObject
     * @private
     * @since 3.0.0
     *
     * @param {string} key - The key of the Scene.
     * @param {(string|Vsengine.Types.Scenes.SettingsConfig|Vsengine.Types.Scenes.CreateSceneFromObjectConfig)} sceneConfig - The Scene config.
     *
     * @return {Vsengine.Scene} The created Scene.
     */
     ...
     *
     * @method Vsengine.Scenes.SceneManager#getKey
     * @private
     * @since 3.0.0
     *
     * @param {string} key - The key to check in the Scene config.
     * @param {(Vsengine.Scene|Vsengine.Types.Scenes.SettingsConfig|function)} sceneConfig - The Scene config.
     *
     ...
     *
     * @method Vsengine.Scenes.SceneManager#getScenes
     * @since 3.16.0
     *
     * @generic {Vsengine.Scene[]} T - [$return]
     *
     ...
     *
     * @return {Vsengine.Scene[]} An array containing all of the Scenes in the Scene Manager.
     */
     ...
     *
     * @method Vsengine.Scenes.SceneManager#getScene
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|Vsengine.Scene)} key - The key of the Scene to retrieve.
     *
     * @return {?Vsengine.Scene} The Scene, or `null` if no matching Scene was found.
     */
     ...
     *
     * @method Vsengine.Scenes.SceneManager#isActive
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|Vsengine.Scene)} key - The Scene to check.
     *
     ...
     *
     * @method Vsengine.Scenes.SceneManager#isPaused
     * @since 3.17.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method Vsengine.Scenes.SceneManager#isVisible
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method Vsengine.Scenes.SceneManager#isSleeping
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method Vsengine.Scenes.SceneManager#pause
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|Vsengine.Scene)} key - The Scene to pause.
     ...
     *
     * @method Vsengine.Scenes.SceneManager#resume
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|Vsengine.Scene)} key - The Scene to resume.
     ...
     *
     * @method Vsengine.Scenes.SceneManager#sleep
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|Vsengine.Scene)} key - The Scene to put to sleep.
     ...
     *
     * @method Vsengine.Scenes.SceneManager#wake
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|Vsengine.Scene)} key - The Scene to wake up.
     ...
     *
     * @method Vsengine.Scenes.SceneManager#run
     * @since 3.10.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|Vsengine.Scene)} key - The Scene to run.
     ...
     *
     * @method Vsengine.Scenes.SceneManager#start
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|Vsengine.Scene)} key - The Scene to start.
     ...
     *
     * @method Vsengine.Scenes.SceneManager#stop
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|Vsengine.Scene)} key - The Scene to stop.
     ...
     *
     * @method Vsengine.Scenes.SceneManager#switch
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [from,to]
     *
     * @param {(string|Vsengine.Scene)} from - The Scene to sleep.
     * @param {(string|Vsengine.Scene)} to - The Scene to start.
     ...
     *
     * @method Vsengine.Scenes.SceneManager#getAt
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {T} - [$return]
     ...
     *
     * @return {(Vsengine.Scene|undefined)} The Scene.
     */
     ...
     *
     * @method Vsengine.Scenes.SceneManager#getIndex
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|Vsengine.Scene)} key - The key of the Scene.
     *
     ...
     *
     * @method Vsengine.Scenes.SceneManager#bringToTop
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|Vsengine.Scene)} key - The Scene to move.
     *
     * @return {this} This Scene Manager instance.
     */
     ...
     *
     * @method Vsengine.Scenes.SceneManager#sendToBack
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method Vsengine.Scenes.SceneManager#moveDown
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method Vsengine.Scenes.SceneManager#moveUp
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method Vsengine.Scenes.SceneManager#moveAbove
     * @since 3.2.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [keyA,keyB]
     *
     * @param {(string|Vsengine.Scene)} keyA - The Scene that Scene B will be moved above.
     * @param {(string|Vsengine.Scene)} keyB - The Scene to be moved.
     *
     * @return {this} This Scene Manager instance.
     */
     ...
     *
     * @method Vsengine.Scenes.SceneManager#moveBelow
     * @since 3.2.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [keyA,keyB]
     *
     * @param {(string|Vsengine.Scene)} keyA - The Scene that Scene B will be moved below.
     * @param {(string|Vsengine.Scene)} keyB - The Scene to be moved.
     *
     * @return {this} This Scene Manager instance.
     */
     ...
     *
     * @method Vsengine.Scenes.SceneManager#queueOp
     * @private
     * @since 3.0.0
     *
     * @param {string} op - The operation to perform.
     * @param {(string|Vsengine.Scene)} keyA - Scene A.
     * @param {(any|string|Vsengine.Scene)} [keyB] - Scene B, or a data object.
     ...
     *
     * @method Vsengine.Scenes.SceneManager#swapPosition
     * @since 3.0.0
     *
     * @generic {Vsengine.Scene} T
     * @genericUse {(T|string)} - [keyA,keyB]
     *
     * @param {(string|Vsengine.Scene)} keyA - The first Scene to swap.
     * @param {(string|Vsengine.Scene)} keyB - The second Scene to swap.
     *
     * @return {this} This Scene Manager instance.
     */
     ...
     *
     * @method Vsengine.Scenes.SceneManager#dump
     * @since 3.2.0
     */
    dump: function () {
        var out = [];
     ...
     *
     * This method is called automatically when a Vsengine Game instance is destroyed.
     *
     * @method Vsengine.Scenes.SceneManager#destroy
     * @since 3.0.0
     */
    destroy: function () {
        for (var i = 0; i < this.scenes.length; i++) {
