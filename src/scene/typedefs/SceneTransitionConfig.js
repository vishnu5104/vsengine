/**
 * @typedef {object} Vsengine.Types.Scenes.SceneTransitionConfig
 * @since 3.5.0
 *
 ...
 * @property {Vsengine.Types.Scenes.SceneTransitionOnStartCallback} [onStart] - This callback is invoked when transition starting.
