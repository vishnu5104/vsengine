/**
 * @typedef {object} Vsengine.Types.Scenes.SettingsConfig
 * @since 3.0.0
 *
 ...
 * @property {(false|Vsengine.Types.Loader.FileTypes.PackFileSection)} [pack=false] - Files to be loaded before the Scene begins.
 * @property {?(Vsengine.Types.Cameras.Scene2D.CameraConfig|Vsengine.Types.Cameras.Scene2D.CameraConfig[])} [cameras=null] - An optional Camera configuration object.
