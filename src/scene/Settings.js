...
/**
 * @namespace Vsengine.Scenes.Settings
 */
...
var Settings = {
     ...
     *
     * @function Vsengine.Scenes.Settings.create
     * @since 3.0.0
     *
     * @param {(string|Vsengine.Types.Scenes.SettingsConfig)} config - The Scene configuration object used to create this Scene Settings.
     *
     * @return {Vsengine.Types.Scenes.SettingsObject} The Scene Settings object created as a result of the config and default settings.
     */
