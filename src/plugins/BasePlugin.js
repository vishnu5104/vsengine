...
var BasePlugin = new Class({
    initialize: function BasePlugin(pluginManager) {
         ...
         *
         * @name Vsengine.Plugins.BasePlugin#pluginManager
         ...
         *
         * @name Vsengine.Plugins.BasePlugin#game
         * @type {Vsengine.Game}
         * @protected
         * @since 3.8.0
         */
     ...
     * On a Scene Plugin, this method is never called. Use {@link Vsengine.Plugins.ScenePlugin#boot} instead.
     *
     * @method Vsengine.Plugins.BasePlugin#init
     * @since 3.8.0
     *
     ...
     *
     * @method Vsengine.Plugins.BasePlugin#start
     * @since 3.8.0
     */
    start: function () {
     ...
     * On a Scene Plugin, this method is never called.
     *
     * @method Vsengine.Plugins.BasePlugin#stop
     * @since 3.8.0
     */
    stop: function () {},
     ...
     *
     * @method Vsengine.Plugins.BasePlugin#destroy
     * @since 3.8.0
     */
    destroy: function () {
