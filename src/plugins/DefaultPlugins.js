 ...
 * The Default Plugins.
 *
 * @namespace Vsengine.Plugins.DefaultPlugins
...
var DefaultPlugins = {
    /**
     * These are the Global Managers that are created by the Vsengine.Game instance.
     * They are referenced from Scene.Systems so that plugins can use them.
     *
     * @name Vsengine.Plugins.DefaultPlugins.Global
     * @type {array}
     * @since 3.0.0
     */
    Global: [
     ...
     *
     * @name Vsengine.Plugins.DefaultPlugins.CoreScene
     * @type {array}
     * @since 3.0.0
     */
    CoreScene: [
     ...
     *
     * @name Vsengine.Plugins.DefaultPlugins.DefaultScene
     * @type {array}
     * @since 3.0.0
     */
    DefaultScene: [
