...
/**
 * @classdesc
 * The PluginManager is responsible for installing and adding plugins to Vsengine.
 *
 ...
 *
 * You can add a plugin to Vsengine in three different ways:
 *
 * 1. Preload it
 ...
 *
 * For examples of all of these approaches please see the Vsengine 3 Examples Repo `plugins` folder.
 *
 * For information on creating your own plugin please see the Vsengine 3 Plugin Template.
 *
 * @class PluginManager
 * @memberof Vsengine.Plugins
 * @constructor
 * @since 3.0.0
 *
 * @param {Vsengine.Game} game - The game instance that owns this Plugin Manager.
 */
var PluginManager = new Class({
    ...
    initialize: function PluginManager(game) {
         ...
         *
         * @name Vsengine.Plugins.PluginManager#game
         * @type {Vsengine.Game}
         * @since 3.0.0
         */
        this.game = game;
         ...
         *
         * @name Vsengine.Plugins.PluginManager#plugins
         * @type {Vsengine.Types.Plugins.GlobalPlugin[]}
         * @since 3.8.0
         */
        this.plugins = [];
         ...
         *
         * @name Vsengine.Plugins.PluginManager#scenePlugins
         * @type {string[]}
         * @since 3.8.0
         */
        this.scenePlugins = [];
         ...
         *
         * @name Vsengine.Plugins.PluginManager#_pendingGlobal
         * @private
         * @type {array}
         * @since 3.8.0
         */
         ...
         *
         * @name Vsengine.Plugins.PluginManager#_pendingScene
         * @private
         * @type {array}
         * @since 3.8.0
         */
     ...
     *
     * @method Vsengine.Plugins.PluginManager#boot
     * @protected
     * @since 3.0.0
     */
    boot: function () {
     ...
     *
     * @method Vsengine.Plugins.PluginManager#addToScene
     * @protected
     * @since 3.8.0
     *
     * @param {Vsengine.Scenes.Systems} sys - The Scene Systems class to install all the plugins in to.
     ...
     *
     * @method Vsengine.Plugins.PluginManager#getDefaultScenePlugins
     * @protected
     * @since 3.8.0
     *
     ...
     * ```
     *
     * This method is called automatically by Vsengine if you install your plugins using either the
     * Game Configuration object, or by preloading them via the Loader.
     *
     * @method Vsengine.Plugins.PluginManager#installScenePlugin
     * @since 3.8.0
     *
     ...
     * @param {string} [mapping] - If this plugin is injected into the Vsengine.Scene class, this is the property key to use.
     * @param {Vsengine.Scene} [addToScene] - Optionally automatically add this plugin to the given Scene.
     * @param {boolean} [fromLoader=false] - Is this being called by the Loader?
     */
    installScenePlugin: function (
        key,
        plugin,
        mapping,
        addToScene,
     ...
     *
     * @method Vsengine.Plugins.PluginManager#install
     * @since 3.8.0
     *
     ...
     *
     * @return {?Vsengine.Plugins.BasePlugin} The plugin that was started, or `null` if `start` was false, or game isn't yet booted.
     */
     ...
     *
     * @method Vsengine.Plugins.PluginManager#getIndex
     * @protected
     * @since 3.8.0
     *
     ...
     *
     * @method Vsengine.Plugins.PluginManager#getEntry
     * @protected
     * @since 3.8.0
     *
     * @param {string} key - The unique plugin key.
     *
     * @return {Vsengine.Types.Plugins.GlobalPlugin} The plugin entry.
     */
     ...
     *
     * @method Vsengine.Plugins.PluginManager#isActive
     * @since 3.8.0
     *
     * @param {string} key - The unique plugin key.
     *
     ...
     *
     * @method Vsengine.Plugins.PluginManager#start
     * @since 3.8.0
     *
     ...
     *
     * @return {?Vsengine.Plugins.BasePlugin} The plugin that was started, or `null` if invalid key given or plugin is already stopped.
     */
     ...
     *
     * @method Vsengine.Plugins.PluginManager#createEntry
     * @private
     * @since 3.9.0
     *
     ...
     * @param {string} [runAs] - Run the plugin under a new key. This allows you to run one plugin multiple times.
     *
     * @return {?Vsengine.Plugins.BasePlugin} The plugin that was started, or `null` if invalid key given.
     */
     ...
     *
     * @method Vsengine.Plugins.PluginManager#stop
     * @since 3.8.0
     *
     ...
     *
     * @method Vsengine.Plugins.PluginManager#get
     * @since 3.8.0
     *
     ...
     *
     * @return {?(Vsengine.Plugins.BasePlugin|function)} The plugin, or `null` if no plugin was found matching the key.
     */
     ...
     *
     * @method Vsengine.Plugins.PluginManager#getClass
     * @since 3.8.0
     *
     * @param {string} key - The key of the plugin to get.
     *
     * @return {Vsengine.Plugins.BasePlugin} A Plugin object
     */
     ...
     *
     * @method Vsengine.Plugins.PluginManager#removeGlobalPlugin
     * @since 3.8.0
     *
     ...
     * It is up to you to remove all references to this plugin that you may hold within your game code.
     *
     * @method Vsengine.Plugins.PluginManager#removeScenePlugin
     * @since 3.8.0
     *
     * @param {string} key - The key of the plugin to remove.
     */
     ...
     *
     * @method Vsengine.Plugins.PluginManager#registerGameObject
     * @since 3.8.0
     *
     ...
     *
     * @method Vsengine.Plugins.PluginManager#removeGameObject
     * @since 3.19.0
     *
     ...
     *
     * @method Vsengine.Plugins.PluginManager#registerFileType
     * @since 3.8.0
     *
     * @param {string} key - The key of the Game Object that the given callbacks will create, i.e. `image`, `sprite`.
     * @param {function} callback - The callback to invoke when the Game Object Factory is called.
     * @param {Vsengine.Scene} [addToScene] - Optionally add this file type into the Loader Plugin owned by the given Scene.
     */
     ...
     *
     * @method Vsengine.Plugins.PluginManager#destroy
     * @since 3.8.0
     */
    destroy: function () {
