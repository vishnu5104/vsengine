 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Textures.Texture} texture - The Texture this Frame is a part of.
...
var Frame = new Class({
    initialize: function Frame(
         ...
         *
         * @name Vsengine.Textures.Frame#texture
         ...
         *
         * @name Vsengine.Textures.Frame#name
         * @type {string}
         * @since 3.0.0
         */
        this.name = name;
         ...
         *
         * @name Vsengine.Textures.Frame#source
         ...
         *
         * @name Vsengine.Textures.Frame#sourceIndex
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Textures.Frame#cutX
         * @type {number}
         * @since 3.0.0
         */
        this.cutX;
         ...
         *
         * @name Vsengine.Textures.Frame#cutY
         * @type {number}
         * @since 3.0.0
         */
        this.cutY;
         ...
         *
         * @name Vsengine.Textures.Frame#cutWidth
         * @type {number}
         * @since 3.0.0
         */
        this.cutWidth;
         ...
         *
         * @name Vsengine.Textures.Frame#cutHeight
         * @type {number}
         * @since 3.0.0
         */
        this.cutHeight;
         ...
         *
         * @name Vsengine.Textures.Frame#x
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Textures.Frame#y
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Textures.Frame#width
         * @type {number}
         * @since 3.0.0
         */
        this.width;
         ...
         *
         * @name Vsengine.Textures.Frame#height
         * @type {number}
         * @since 3.0.0
         */
        this.height;
         ...
         *
         * @name Vsengine.Textures.Frame#halfWidth
         * @type {number}
         * @since 3.0.0
         */
        this.halfWidth;
         ...
         * Precalculated for the renderer.
         *
         * @name Vsengine.Textures.Frame#halfHeight
         * @type {number}
         * @since 3.0.0
         */
        this.halfHeight;
         ...
         *
         * @name Vsengine.Textures.Frame#centerX
         * @type {number}
         * @since 3.0.0
         */
        this.centerX;
         ...
         *
         * @name Vsengine.Textures.Frame#centerY
         * @type {number}
         * @since 3.0.0
         */
        this.centerY;
         ...
         *
         * @name Vsengine.Textures.Frame#pivotX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Textures.Frame#pivotY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Textures.Frame#customPivot
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Textures.Frame#rotated
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         * 1 = Round
         *
         * @name Vsengine.Textures.Frame#autoRound
         * @type {number}
         * @default -1
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Textures.Frame#customData
         * @type {object}
         * @since 3.0.0
         */
        this.customData = {};
         ...
         * WebGL UV u0 value.
         *
         * @name Vsengine.Textures.Frame#u0
         * @type {number}
         * @default 0
         * @since 3.11.0
         */
         ...
         * WebGL UV v0 value.
         *
         * @name Vsengine.Textures.Frame#v0
         * @type {number}
         * @default 0
         * @since 3.11.0
         */
         ...
         * WebGL UV u1 value.
         *
         * @name Vsengine.Textures.Frame#u1
         * @type {number}
         * @default 0
         * @since 3.11.0
         */
         ...
         * WebGL UV v1 value.
         *
         * @name Vsengine.Textures.Frame#v1
         * @type {number}
         * @default 0
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.Textures.Frame#data
         * @type {object}
         * @private
         * @since 3.0.0
         */
     ...
     *
     * @method Vsengine.Textures.Frame#setCutPosition
     * @since 3.85.0
     *
     ...
     *
     * @method Vsengine.Textures.Frame#setCutSize
     * @since 3.85.0
     *
     ...
     *
     * @method Vsengine.Textures.Frame#setSize
     * @since 3.7.0
     *
     ...
     *
     * @method Vsengine.Textures.Frame#setTrim
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Textures.Frame#setScale9
     * @since 3.70.0
     *
     ...
     *
     * @method Vsengine.Textures.Frame#setCropUVs
     * @since 3.11.0
     *
     ...
     *
     * @method Vsengine.Textures.Frame#updateCropUVs
     * @since 3.11.0
     *
     * @param {object} crop - The crop data object. This is the `GameObject._crop` property.
     * @param {boolean} flipX - Does the parent Game Object have flipX set?
     ...
     *
     * @method Vsengine.Textures.Frame#setUVs
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Textures.Frame#updateUVs
     * @since 3.0.0
     *
     * @return {this} This Frame object.
     */
     ...
     *
     * @method Vsengine.Textures.Frame#updateUVsInverted
     * @since 3.0.0
     *
     * @return {this} This Frame object.
     */
     ...
     *
     * @method Vsengine.Textures.Frame#clone
     * @since 3.0.0
     *
     * @return {Vsengine.Textures.Frame} A clone of this Frame.
     */
    clone: function () {
     ...
     *
     * @method Vsengine.Textures.Frame#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.texture = null;
     ...
     *
     * @name Vsengine.Textures.Frame#glTexture
     ...
     * before being packed.
     *
     * @name Vsengine.Textures.Frame#realWidth
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     * before being packed.
     *
     * @name Vsengine.Textures.Frame#realHeight
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Textures.Frame#radius
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Textures.Frame#trimmed
     * @type {boolean}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Textures.Frame#scale9
     * @type {boolean}
     * @readonly
     * @since 3.70.0
     */
     ...
     *
     * @name Vsengine.Textures.Frame#is3Slice
     * @type {boolean}
     * @readonly
     * @since 3.70.0
     */
     ...
     *
     * @name Vsengine.Textures.Frame#canvasData
     * @type {object}
     * @readonly
     * @since 3.0.0
     */
