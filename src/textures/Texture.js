...
var Texture = new Class({
    initialize: function Texture(manager, key, source, width, height) {
         ...
         *
         * @name Vsengine.Textures.Texture#manager
         ...
         *
         * @name Vsengine.Textures.Texture#key
         * @type {string}
         * @since 3.0.0
         */
        this.key = key;
         ...
         *
         * @name Vsengine.Textures.Texture#source
         ...
         *
         * @name Vsengine.Textures.Texture#dataSource
         * @type {array}
         * @since 3.0.0
         */
        this.dataSource = [];
         ...
         *
         * @name Vsengine.Textures.Texture#frames
         * @type {object}
         * @since 3.0.0
         */
        this.frames = {};
         ...
         *
         * @name Vsengine.Textures.Texture#customData
         * @type {object}
         * @since 3.0.0
         */
        this.customData = {};
         ...
         *
         * @name Vsengine.Textures.Texture#firstFrame
         * @type {string}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Textures.Texture#frameTotal
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
     ...
     *
     * @method Vsengine.Textures.Texture#add
     * @since 3.0.0
     *
     ...
     *
     * @return {?Vsengine.Textures.Frame} The Frame that was added to this Texture, or `null` if the given name already exists.
     */
     ...
     *
     * @method Vsengine.Textures.Texture#remove
     * @since 3.19.0
     *
     ...
     *
     * @method Vsengine.Textures.Texture#has
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Textures.Texture#get
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Textures.Texture#getTextureSourceIndex
     * @since 3.0.0
     *
     * @param {Vsengine.Textures.TextureSource} source - The TextureSource to check.
     *
     ...
     *
     * @method Vsengine.Textures.Texture#getFramesFromTextureSource
     * @since 3.0.0
     *
     ...
     *
     * @return {Vsengine.Textures.Frame[]} An array of Texture Frames.
     */
     ...
     *
     * @method Vsengine.Textures.Texture#getFrameBounds
     * @since 3.80.0
     *
     * @param {number} [sourceIndex=0] - The index of the TextureSource to get the Frame bounds from.
     *
     * @return {Vsengine.Types.Math.RectangleLike} An object containing the bounds of the Frames using the given Texture Source Index.
     */
     ...
     *
     * @method Vsengine.Textures.Texture#getFrameNames
     * @since 3.0.0
     *
     * @param {boolean} [includeBase=false] - Include the `__BASE` Frame in the output array?
     *
     ...
     *
     * @method Vsengine.Textures.Texture#getSourceImage
     * @since 3.0.0
     *
     * @param {(string|number)} [name] - The string-based name, or integer based index, of the Frame to get from this Texture.
     *
     * @return {(HTMLImageElement|HTMLCanvasElement|Vsengine.GameObjects.RenderTexture)} The DOM Image, Canvas Element or Render Texture.
     */
     ...
     *
     * @method Vsengine.Textures.Texture#getDataSourceImage
     * @since 3.7.0
     *
     * @param {(string|number)} [name] - The string-based name, or integer based index, of the Frame to get from this Texture.
     *
     ...
     *
     * @method Vsengine.Textures.Texture#setDataSource
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Textures.Texture#setFilter
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Textures.Texture#destroy
     * @since 3.0.0
     */
    destroy: function () {
        var i;
