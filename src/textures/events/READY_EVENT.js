 ...
 *
 * When a Vsengine Game instance is booting for the first time, the Texture Manager has to wait on a couple of non-blocking
 ...
 *
 * @event Vsengine.Textures.Events#READY
 * @type {string}
 * @since 3.16.1
 */
