 ...
 *
 * @function Vsengine.Textures.Parsers.SpriteSheetFromAtlas
 * @memberof Vsengine.Textures.Parsers
 * @private
 * @since 3.0.0
 *
 * @param {Vsengine.Textures.Texture} texture - The Texture to add the Frames to.
 * @param {Vsengine.Textures.Frame} frame - The Frame that contains the Sprite Sheet.
