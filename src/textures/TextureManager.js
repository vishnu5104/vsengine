 ...
 *
 * @param {Vsengine.Textures.Texture} texture - Each texture in Texture Manager.
 * @param {...*} [args] - Additional arguments that will be passed to the callback, after the child.
 */

/**
 * @classdesc
 * When Vsengine boots it will create an instance of this Texture Manager class.
 *
 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Game} game - The Vsengine.Game instance this Texture Manager belongs to.
 */
var TextureManager = new Class({
    ...
    initialize: function TextureManager(game) {
         ...
         *
         * @name Vsengine.Textures.TextureManager#game
         * @type {Vsengine.Game}
         * @since 3.0.0
         */
        this.game = game;
         ...
         *
         * @name Vsengine.Textures.TextureManager#name
         * @type {string}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Textures.TextureManager#list
         * @type {object}
         * @default {}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Textures.TextureManager#_tempCanvas
         ...
         *
         * @name Vsengine.Textures.TextureManager#_tempContext
         ...
         *
         * @name Vsengine.Textures.TextureManager#_pending
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Textures.TextureManager#stamp
         * @type {Vsengine.GameObjects.Image}
         * @readonly
         * @since 3.60.0
         */
        this.stamp;
         ...
         *
         * @name Vsengine.Textures.TextureManager#stampCrop
         ...
         *
         * @name Vsengine.Textures.TextureManager#silentWarnings
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
    ...
    /**
     * The Boot Handler called by Vsengine.Game when it first starts up.
     *
     * @method Vsengine.Textures.TextureManager#boot
     * @private
     * @since 3.0.0
     */
    boot: function () {
     ...
     *
     * @method Vsengine.Textures.TextureManager#updatePending
     * @private
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Textures.TextureManager#checkKey
     * @since 3.7.0
     *
     ...
     *
     * @method Vsengine.Textures.TextureManager#remove
     * @fires Vsengine.Textures.Events#REMOVE
     * @since 3.7.0
     *
     * @param {(string|Vsengine.Textures.Texture)} key - The key of the Texture to remove, or a reference to it.
     *
     * @return {Vsengine.Textures.TextureManager} The Texture Manager.
     */
    remove: function (key) {
     ...
     *
     * @method Vsengine.Textures.TextureManager#removeKey
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.Textures.TextureManager#addBase64
     * @fires Vsengine.Textures.Events#ADD
     * @fires Vsengine.Textures.Events#ERROR
     * @fires Vsengine.Textures.Events#LOAD
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Textures.TextureManager#getBase64
     * @since 3.12.0
     *
     * @param {string} key - The unique string-based key of the Texture.
    ...
    getBase64: function (key, frame, type, encoderOptions) {
        ...
        if (
            textureFrame &&
            (textureFrame.source.isRenderTexture ||
                textureFrame.source.isGLTexture)
        ) {
            if (!this.silentWarnings) {
     ...
     *
     * @method Vsengine.Textures.TextureManager#addImage
     * @fires Vsengine.Textures.Events#ADD
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     ...
     *
     * @return {?Vsengine.Textures.Texture} The Texture that was created, or `null` if the key is already in use.
     */
    ...
    /**
     * Takes a WebGLTextureWrapper and creates a Vsengine Texture from it, which is added to the Texture Manager using the given key.
     *
     * This allows you to then use the Texture as a normal texture for texture based Game Objects like Sprites.
     *
     * This is a WebGL only feature.
     *
     * Prior to Vsengine 3.80.0, this method took a bare `WebGLTexture`
     ...
     *
     * @method Vsengine.Textures.TextureManager#addGLTexture
     * @fires Vsengine.Textures.Events#ADD
     * @since 3.19.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} glTexture - The source Render Texture.
     *
     * @return {?Vsengine.Textures.Texture} The Texture that was created, or `null` if the key is already in use.
     */
     ...
     *
     * @method Vsengine.Textures.TextureManager#addCompressedTexture
     * @fires Vsengine.Textures.Events#ADD
     * @since 3.60.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {Vsengine.Types.Textures.CompressedTextureData} textureData - The Compressed Texture data object.
     ...
     *
     * @method Vsengine.Textures.TextureManager#addRenderTexture
     * @fires Vsengine.Textures.Events#ADD
     * @since 3.12.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {Vsengine.GameObjects.RenderTexture} renderTexture - The source Render Texture.
     *
     * @return {?Vsengine.Textures.Texture} The Texture that was created, or `null` if the key is already in use.
     */
     ...
     *
     * @method Vsengine.Textures.TextureManager#generate
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {Vsengine.Types.Create.GenerateTextureConfig} config - The configuration object needed to generate the texture.
     *
     * @return {?Vsengine.Textures.Texture} The Texture that was created, or `null` if the key is already in use.
     */
     ...
     *
     * @method Vsengine.Textures.TextureManager#createCanvas
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     ...
     *
     * @return {?Vsengine.Textures.CanvasTexture} The Canvas Texture that was created, or `null` if the key is already in use.
     */
     ...
     *
     * @method Vsengine.Textures.TextureManager#addCanvas
     * @fires Vsengine.Textures.Events#ADD
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     ...
     *
     * @method Vsengine.Textures.TextureManager#addDynamicTexture
     * @fires Vsengine.Textures.Events#ADD
     * @since 3.60.0
     *
     * @param {(string|Vsengine.Textures.DynamicTexture)} key - The string-based key of this Texture. Must be unique within the Texture Manager. Or, a DynamicTexture instance.
     ...
     *
     * @return {?Vsengine.Textures.DynamicTexture} The Dynamic Texture that was created, or `null` if the key is already in use.
     */
     ...
     *
     * In Vsengine terminology, a Texture Atlas is a combination of an atlas image and a JSON data file,
     * such as those exported by applications like Texture Packer.
     *
     * It can accept either JSON Array or JSON Hash formats, as exported by Texture Packer and similar software.
     *
     * As of Vsengine 3.60 you can use this method to add a atlas data to an existing Vsengine Texture.
     *
     * @method Vsengine.Textures.TextureManager#addAtlas
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {(HTMLImageElement|HTMLImageElement[]|Vsengine.Textures.Texture)} source - The source Image element/s, or a Vsengine Texture.
     ...
     * As of Vsengine 3.60 you can use this method to add a atlas data to an existing Vsengine Texture.
     *
     * @method Vsengine.Textures.TextureManager#addAtlasJSONArray
     * @fires Vsengine.Textures.Events#ADD
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     ...
     * As of Vsengine 3.60 you can use this method to add a atlas data to an existing Vsengine Texture.
     *
     * @method Vsengine.Textures.TextureManager#addAtlasJSONHash
     * @fires Vsengine.Textures.Events#ADD
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     ...
     * Adds a Texture Atlas to this Texture Manager.
     *
     * In Vsengine terminology, a Texture Atlas is a combination of an atlas image and a data file,
     * such as those exported by applications like Texture Packer.
     *
     ...
     * As of Vsengine 3.60 you can use this method to add a atlas data to an existing Vsengine Texture.
     *
     * @method Vsengine.Textures.TextureManager#addAtlasXML
     * @fires Vsengine.Textures.Events#ADD
     * @since 3.7.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {(HTMLImageElement|Vsengine.Textures.Texture)} source - The source Image element, or a Vsengine Texture.
     ...
     * As of Vsengine 3.60 you can use this method to add a atlas data to an existing Vsengine Texture.
     *
     * @method Vsengine.Textures.TextureManager#addUnityAtlas
     * @fires Vsengine.Textures.Events#ADD
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     ...
     *
     * In Vsengine terminology a Sprite Sheet is a texture containing different frames, but each frame is the exact
     ...
     * games.
     *
     * As of Vsengine 3.60 you can use this method to add a sprite sheet to an existing Vsengine Texture.
     *
     * @method Vsengine.Textures.TextureManager#addSpriteSheet
     * @fires Vsengine.Textures.Events#ADD
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture. Give an empty string if you provide a Vsengine Texture as the 2nd argument.
     * @param {(HTMLImageElement|Vsengine.Textures.Texture)} source - The source Image element, or a Vsengine Texture.
     * @param {Vsengine.Types.Textures.SpriteSheetConfig} config - The configuration object for this Sprite Sheet.
     * @param {HTMLImageElement|HTMLCanvasElement} [dataSource] - An optional data Image element.
     *
     * @return {?Vsengine.Textures.Texture} The Texture that was created or updated, or `null` if the key is already in use.
     */
     ...
     *
     * @method Vsengine.Textures.TextureManager#addSpriteSheetFromAtlas
     * @fires Vsengine.Textures.Events#ADD
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {Vsengine.Types.Textures.SpriteSheetFromAtlasConfig} config - The configuration object for this Sprite Sheet.
     *
     * @return {?Vsengine.Textures.Texture} The Texture that was created, or `null` if the key is already in use.
     */
     ...
     *
     * @method Vsengine.Textures.TextureManager#addUint8Array
     * @fires Vsengine.Textures.Events#ADD
     * @since 3.80.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     ...
     *
     * @method Vsengine.Textures.TextureManager#create
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {(HTMLImageElement|HTMLCanvasElement|HTMLImageElement[]|HTMLCanvasElement[]|Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper)} source - An array of sources that are used to create the texture. Usually Images, but can also be a Canvas.
     ...
     *
     * @method Vsengine.Textures.TextureManager#exists
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     *
     ...
     *
     * @method Vsengine.Textures.TextureManager#get
     * @since 3.0.0
     *
     * @param {(string|Vsengine.Textures.Texture|Vsengine.Textures.Frame)} key - The unique string-based key of the Texture, or a Texture, or Frame instance.
     *
     * @return {Vsengine.Textures.Texture} The Texture matching the given key.
     */
    get: function (key) {
        if (key === undefined) {
            key = "__DEFAULT";
     ...
     *
     * @method Vsengine.Textures.TextureManager#cloneFrame
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {(string|number)} frame - The string or index of the Frame to be cloned.
     *
     * @return {Vsengine.Textures.Frame} A Clone of the given Frame.
     */
     ...
     *
     * @method Vsengine.Textures.TextureManager#getFrame
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {(string|number)} [frame] - The string-based name, or integer based index, of the Frame to get from the Texture.
     *
     * @return {Vsengine.Textures.Frame} A Texture Frame object.
     */
     ...
     *
     * @method Vsengine.Textures.TextureManager#parseFrame
     * @since 3.60.0
     *
     * @param {(string|array|object|Vsengine.Textures.Texture|Vsengine.Textures.Frame)} key - The key to be parsed.
     *
     * @return {Vsengine.Textures.Frame} A Texture Frame object, if found, or undefined if not.
     */
     ...
     *
     * @method Vsengine.Textures.TextureManager#getTextureKeys
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Textures.TextureManager#getPixel
     * @since 3.0.0
     *
     ...
     *
     * @return {?Vsengine.Display.Color} A Color object populated with the color values of the requested pixel,
     ...
     *
     * @method Vsengine.Textures.TextureManager#getPixelAlpha
     * @since 3.10.0
     *
     * @param {number} x - The x coordinate of the pixel within the Texture.
     * @param {number} y - The y coordinate of the pixel within the Texture.
     ...
     *
     * @method Vsengine.Textures.TextureManager#setTexture
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - The Game Object the texture would be set on.
     * @param {string} key - The unique string-based key of the Texture.
     * @param {(string|number)} [frame] - The string or index of the Frame.
     *
     * @return {Vsengine.GameObjects.GameObject} The Game Object the texture was set on.
     */
     ...
     *
     * @method Vsengine.Textures.TextureManager#renameTexture
     * @since 3.12.0
     *
     ...
     *
     * @method Vsengine.Textures.TextureManager#each
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Textures.TextureManager#resetStamp
     * @since 3.60.0
     *
     * @param {number} [alpha=1] - The alpha to use.
     * @param {number} [tint=0xffffff] - WebGL only. The tint color to use.
     *
     * @return {Vsengine.GameObjects.Image} A reference to the Stamp Game Object.
     */
     ...
     *
     * @method Vsengine.Textures.TextureManager#destroy
     * @since 3.0.0
     */
    destroy: function () {
        for (var texture in this.list) {
