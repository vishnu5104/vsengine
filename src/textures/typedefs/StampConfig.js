 ...
 *
 * @typedef {object} Vsengine.Types.Textures.StampConfig
 * @since 3.60.0
 *
 ...
 * @property {(string|Vsengine.BlendModes|number)} [blendMode=0] - The blend mode used when drawing the stamp. Defaults to 0 (normal).
