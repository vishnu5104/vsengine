...
var CanvasTexture = new Class({
    ...
    initialize: function CanvasTexture(manager, key, source, width, height) {
         ...
         *
         * @name Vsengine.Textures.CanvasTexture#_source
         ...
         *
         * @name Vsengine.Textures.CanvasTexture#canvas
         * @readonly
         ...
         *
         * @name Vsengine.Textures.CanvasTexture#context
         * @readonly
         ...
         *
         * @name Vsengine.Textures.CanvasTexture#width
         * @readonly
         * @type {number}
         * @since 3.7.0
         */
         ...
         * This property is read-only, if you wish to change it use the `setSize` method.
         *
         * @name Vsengine.Textures.CanvasTexture#height
         * @readonly
         * @type {number}
         * @since 3.7.0
         */
         ...
         *
         * @name Vsengine.Textures.CanvasTexture#imageData
         * @type {ImageData}
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.Textures.CanvasTexture#data
         ...
         *
         * @name Vsengine.Textures.CanvasTexture#pixels
         * @type {Uint32Array}
         * @since 3.13.0
         */
        this.pixels = null;
         ...
         *
         * @name Vsengine.Textures.CanvasTexture#buffer
         * @type {ArrayBuffer}
         * @since 3.13.0
         */
        this.buffer;
     ...
     *
     * @method Vsengine.Textures.CanvasTexture#update
     * @since 3.13.0
     *
     * @return {Vsengine.Textures.CanvasTexture} This CanvasTexture.
     */
    update: function () {
     ...
     *
     * @method Vsengine.Textures.CanvasTexture#draw
     * @since 3.13.0
     *
     ...
     * ImageData buffer and arrays.
     *
     * @method Vsengine.Textures.CanvasTexture#drawFrame
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Textures.CanvasTexture#setPixel
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Textures.CanvasTexture#putData
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Textures.CanvasTexture#getData
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Textures.CanvasTexture#getPixel
     * @since 3.13.0
     *
     * @param {number} x - The x coordinate of the pixel to get. Must lay within the dimensions of this CanvasTexture and be an integer.
     * @param {number} y - The y coordinate of the pixel to get. Must lay within the dimensions of this CanvasTexture and be an integer.
     * @param {Vsengine.Display.Color} [out] - A Color object to store the pixel values in. If not provided a new Color object will be created.
     *
     * @return {Vsengine.Display.Color} An object with the red, green, blue and alpha values set in the r, g, b and a properties.
     */
     ...
     * otherwise this may return out of date color values, or worse - throw a run-time error as it tries to access an array element that doesn't exist.
     *
     * @method Vsengine.Textures.CanvasTexture#getPixels
     * @since 3.16.0
     *
     ...
     *
     * @return {Vsengine.Types.Textures.PixelConfig[][]} A 2d array of Pixel objects.
     */
     ...
     *
     * @method Vsengine.Textures.CanvasTexture#getIndex
     * @since 3.16.0
     *
     * @param {number} x - The x coordinate of the pixel to get. Must lay within the dimensions of this CanvasTexture and be an integer.
     * @param {number} y - The y coordinate of the pixel to get. Must lay within the dimensions of this CanvasTexture and be an integer.
     ...
     *
     * @method Vsengine.Textures.CanvasTexture#refresh
     * @since 3.7.0
     *
     * @return {Vsengine.Textures.CanvasTexture} This CanvasTexture.
     */
     ...
     *
     * @method Vsengine.Textures.CanvasTexture#getCanvas
     * @since 3.7.0
     *
     ...
     *
     * @method Vsengine.Textures.CanvasTexture#getContext
     * @since 3.7.0
     *
     ...
     *
     * @method Vsengine.Textures.CanvasTexture#clear
     * @since 3.7.0
     *
     ...
     * @param {boolean} [update=true] - Update the internal ImageData buffer and arrays.
     *
     * @return {Vsengine.Textures.CanvasTexture} The Canvas Texture.
     */
     ...
     *
     * @method Vsengine.Textures.CanvasTexture#setSize
     * @since 3.7.0
     *
     ...
     *
     * @method Vsengine.Textures.CanvasTexture#destroy
     * @since 3.16.0
     */
    destroy: function () {
