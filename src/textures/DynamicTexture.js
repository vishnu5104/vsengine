 ...
 * ```
 *
 * Because this is a standard Texture within Vsengine, you can add frames to it, meaning you can use it
 ...
 * @extends Vsengine.Textures.Texture
 * @memberof Vsengine.Textures
 * @constructor
 * @since 3.60.0
 *
 * @param {Vsengine.Textures.TextureManager} manager - A reference to the Texture Manager this Texture belongs to.
...
var DynamicTexture = new Class({
    ...
    initialize: function DynamicTexture(manager, key, width, height) {
        if (width === undefined) {
            width = 256;
        }
        if (height === undefined) {
         ...
         *
         * @name Vsengine.Textures.DynamicTexture#type
         * @type {string}
         * @readonly
         * @since 3.60.0
         */
        ...
        var source = isCanvas
            ? CanvasPool.create2D(this, width, height)
            : [this];
         ...
         *
         * @name Vsengine.Textures.DynamicTexture#renderer
         ...
         *
         * @name Vsengine.Textures.DynamicTexture#width
         * @type {number}
         * @since 3.60.0
         */
        this.width = -1;
         ...
         * Treat this property as read-only. Use the `setSize` method to change the size.
         *
         * @name Vsengine.Textures.DynamicTexture#height
         * @type {number}
         * @since 3.60.0
         */
        this.height = -1;
         ...
         *
         * @name Vsengine.Textures.DynamicTexture#isDrawing
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Textures.DynamicTexture#canvas
         ...
         *
         * @name Vsengine.Textures.DynamicTexture#context
         * @readonly
         ...
         *
         * @name Vsengine.Textures.DynamicTexture#dirty
         * @type {boolean}
         * @since 3.12.0
         */
        this.dirty = false;
         ...
         *
         * @name Vsengine.Textures.DynamicTexture#isSpriteTexture
         * @type {boolean}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Textures.DynamicTexture#_eraseMode
         * @type {boolean}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Textures.DynamicTexture#camera
         ...
         *
         * @name Vsengine.Textures.DynamicTexture#renderTarget
         ...
         * This property remains `null` under Canvas.
         *
         * @name Vsengine.Textures.DynamicTexture#pipeline
         * @type {Vsengine.Renderer.WebGL.Pipelines.SinglePipeline}
         * @since 3.60.0
         */
     ...
     *
     * @method Vsengine.Textures.DynamicTexture#setSize
     * @since 3.10.0
     *
     ...
     *
     * @method Vsengine.Textures.DynamicTexture#setFromRenderTarget
     * @since 3.70.0
     *
     ...
     *
     * @method Vsengine.Textures.DynamicTexture#setIsSpriteTexture
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Textures.DynamicTexture#fill
     * @since 3.2.0
     *
     ...
     * @method Vsengine.Textures.DynamicTexture#clear
     * @since 3.2.0
     *
     * @param {number} [x=0] - The left coordinate of the fill rectangle.
     * @param {number} [y=0] - The top coordinate of the fill rectangle.
     ...
     *
     * @method Vsengine.Textures.DynamicTexture#stamp
     * @since 3.60.0
     *
     ...
     * @param {Vsengine.Types.Textures.StampConfig} [config] - The stamp configuration object, allowing you to set the alpha, tint, angle, scale and origin of the stamp.
     *
     * @return {this} This Dynamic Texture instance.
     */
     ...
     *
     * @method Vsengine.Textures.DynamicTexture#erase
     * @since 3.16.0
     *
     ...
     * calling this method, otherwise you will get vertically inverted frames in WebGL.
     *
     * @method Vsengine.Textures.DynamicTexture#draw
     * @since 3.2.0
     *
     ...
     * calling this method, otherwise you will get vertically inverted frames in WebGL.
     *
     * @method Vsengine.Textures.DynamicTexture#drawFrame
     * @since 3.12.0
     *
     * @param {string} key - The key of the texture to be used, as stored in the Texture Manager.
     * @param {(string|number)} [frame] - The name or index of the frame within the Texture. Set to `null` to skip this argument if not required.
     ...
     * calling this method, otherwise you will get vertically inverted frames in WebGL.
     *
     * @method Vsengine.Textures.DynamicTexture#repeat
     * @since 3.60.0
     *
     * @param {string} key - The key of the texture to be used, as stored in the Texture Manager.
     * @param {(string|number)} [frame] - The name or index of the frame within the Texture. Set to `null` to skip this argument if not required.
    ...
    repeat: function (key, frame, x, y, width, height, alpha, tint, skipBatch) {
        ...
        var useCrop = false;
        var cropRect = this.manager.stampCrop.setTo(
            0,
            0,
            frameWidth,
            frameHeight
     ...
     *
     * @method Vsengine.Textures.DynamicTexture#beginDraw
     * @since 3.50.0
     *
     * @return {this} This Dynamic Texture instance.
     */
     ...
     * Game Objects use their own alpha and tint values when being drawn.
     *
     * @method Vsengine.Textures.DynamicTexture#batchDraw
     * @since 3.50.0
     *
     ...
     * before it is drawn.
     *
     * @method Vsengine.Textures.DynamicTexture#batchDrawFrame
     * @since 3.50.0
     *
     * @param {string} key - The key of the texture to be used, as stored in the Texture Manager.
     ...
     * currently open, or not.
     *
     * @method Vsengine.Textures.DynamicTexture#endDraw
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Textures.DynamicTexture#batchList
     * @private
     * @since 3.12.0
     *
    ...
    /**
     * Internal method that handles drawing the contents of a Vsengine Group to this Dynamic Texture.
     *
     * @method Vsengine.Textures.DynamicTexture#batchGroup
     * @private
     * @since 3.12.0
     *
    ...
    /**
     * Internal method that handles drawing a single Vsengine Game Object to this Dynamic Texture.
     *
     * @method Vsengine.Textures.DynamicTexture#batchGameObject
     * @private
     * @since 3.12.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - The Game Object to draw.
     ...
     *
     * @method Vsengine.Textures.DynamicTexture#batchTextureFrameKey
     * @private
     * @since 3.12.0
     *
     * @param {string} key - The key of the texture to be used, as stored in the Texture Manager.
     ...
     *
     * @method Vsengine.Textures.DynamicTexture#batchTextureFrame
     * @private
     * @since 3.12.0
     *
     * @param {Vsengine.Textures.Frame} textureFrame - The Texture Frame to draw.
     * @param {number} [x=0] - The x position to draw the Frame at.
     * @param {number} [y=0] - The y position to draw the Frame at.
     * @param {number} [alpha=1] -  The alpha value. Only used when drawing Texture Frames to this texture. Game Objects use their own alpha.
     * @param {number} [tint=0xffffff] -  The tint color value. Only used when drawing Texture Frames to this texture. Game Objects use their own tint. WebGL only.
     ...
     *
     * @method Vsengine.Textures.DynamicTexture#snapshotArea
     * @since 3.19.0
     *
     ...
     * the larger the resolution this Dynamic Texture has, so please be careful how you employ this in your game.
     *
     * @method Vsengine.Textures.DynamicTexture#snapshot
     * @since 3.19.0
     *
     * @param {Vsengine.Types.Renderer.Snapshot.SnapshotCallback} callback - The Function to invoke after the snapshot image is created.
     * @param {string} [type='image/png'] - The format of the image to create, usually `image/png` or `image/jpeg`.
     ...
     *
     * @method Vsengine.Textures.DynamicTexture#snapshotPixel
     * @since 3.19.0
     *
     ...
     *
     * @method Vsengine.Textures.DynamicTexture#getWebGLTexture
     * @since 3.60.0
     *
     * @return {?Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} The underlying WebGLTextureWrapper, if not running in Canvas mode.
     */
     ...
     *
     * @method Vsengine.Textures.DynamicTexture#renderWebGL
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Textures.DynamicTexture#renderCanvas
     * @since 3.60.0
     *
     * @param {(Vsengine.Renderer.Canvas.CanvasRenderer|Vsengine.Renderer.WebGL.WebGLRenderer)} renderer - The Canvas Renderer which would be rendered to.
     * @param {Vsengine.GameObjects.GameObject} mask - The masked Game Object which would be rendered.
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The Camera to render to.
     */
     ...
     *
     * @method Vsengine.Textures.DynamicTexture#destroy
     * @since 3.60.0
     */
    destroy: function () {
