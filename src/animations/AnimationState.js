 ...
 * for more details.
 *
 * Prior to Vsengine 3.50 this component was called just `Animation` and lived in the
 * `Vsengine.GameObjects.Components` namespace. It was renamed to `AnimationState`
 ...
 * @since 3.0.0
 *
 * @param {Vsengine.GameObjects.GameObject} parent - The Game Object to which this animation component belongs.
 */
var AnimationState = new Class({
    initialize: function AnimationState(parent) {
         ...
         *
         * @name Vsengine.Animations.AnimationState#parent
         ...
         *
         * @name Vsengine.Animations.AnimationState#animationManager
         ...
         *
         * @name Vsengine.Animations.AnimationState#textureManager
         ...
         *
         * @name Vsengine.Animations.AnimationState#anims
         * @type {Vsengine.Structs.Map.<string, Vsengine.Animations.Animation>}
         * @protected
         * @since 3.50.0
         */
        this.anims = null;
         ...
         *
         * @name Vsengine.Animations.AnimationState#isPlaying
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#hasStarted
         * @type {boolean}
         * @default false
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#currentAnim
         * @type {?Vsengine.Animations.Animation}
         * @default null
         * @since 3.0.0
         */
         ...
         * Will by `null` if no animation is yet loaded.
         *
         * @name Vsengine.Animations.AnimationState#currentFrame
         ...
         *
         * @name Vsengine.Animations.AnimationState#nextAnim
         * @type {?(string|Vsengine.Animations.Animation|Vsengine.Types.Animations.PlayAnimationConfig)}
         * @default null
         * @since 3.16.0
         */
        this.nextAnim = null;
         ...
         *
         * @name Vsengine.Animations.AnimationState#nextAnimsQueue
         * @type {array}
         * @since 3.24.0
         */
        this.nextAnimsQueue = [];
         ...
         *
         * Prior to Vsengine 3.50 this property was private and called `_timeScale`.
         *
         * @name Vsengine.Animations.AnimationState#timeScale
         * @type {number}
         * @default 1
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#frameRate
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#duration
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#msPerFrame
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#skipMissedFrames
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#randomFrame
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * Prior to Vsengine 3.50 this property was private and called `_delay`.
         *
         * @name Vsengine.Animations.AnimationState#delay
         * @type {number}
         * @default 0
         * @since 3.50.0
         */
         ...
         *
         * Prior to Vsengine 3.50 this property was private and called `_repeat`.
         *
         * @name Vsengine.Animations.AnimationState#repeat
         * @type {number}
         * @default 0
         * @since 3.50.0
         */
         ...
         *
         * Prior to Vsengine 3.50 this property was private and called `_repeatDelay`.
         *
         * @name Vsengine.Animations.AnimationState#repeatDelay
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * Prior to Vsengine 3.50 this property was private and called `_yoyo`.
         *
         * @name Vsengine.Animations.AnimationState#yoyo
         * @type {boolean}
         * @default false
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#showBeforeDelay
         * @type {boolean}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#showOnStart
         * @type {boolean}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#hideOnComplete
         * @type {boolean}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#forward
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * Prior to Vsengine 3.50 this property was private and called `_reverse`.
         *
         * @name Vsengine.Animations.AnimationState#inReverse
         * @type {boolean}
         * @default false
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#accumulator
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#nextTick
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#delayCounter
         * @type {number}
         * @default 0
         * @since 3.50.0
         */
         ...
         * at run-time.
         *
         * @name Vsengine.Animations.AnimationState#repeatCounter
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#pendingRepeat
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#_paused
         * @type {boolean}
         * @private
         * @default false
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Animations.AnimationState#_wasPlaying
         * @type {boolean}
         * @private
         * @default false
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Animations.AnimationState#_pendingStop
         * @type {number}
         * @private
         * @since 3.4.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationState#_pendingStopValue
         * @type {any}
         * @private
         * @since 3.4.0
         */
     ...
     *
     * @method Vsengine.Animations.AnimationState#chain
     * @since 3.16.0
     *
     * @param {(string|Vsengine.Animations.Animation|Vsengine.Types.Animations.PlayAnimationConfig|string[]|Vsengine.Animations.Animation[]|Vsengine.Types.Animations.PlayAnimationConfig[])} [key] - The string-based key of the animation to play, or an Animation instance, or a `PlayAnimationConfig` object, or an array of them.
     *
     * @return {Vsengine.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
    chain: function (key) {
     ...
     *
     * Prior to Vsengine 3.50 this method was called `getCurrentKey`.
     *
     * @method Vsengine.Animations.AnimationState#getName
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Animations.AnimationState#getFrameName
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Animations.AnimationState#load
     * @protected
     * @since 3.0.0
     *
     * @param {(string|Vsengine.Types.Animations.PlayAnimationConfig)} key - The string-based key of the animation to play, or a `PlayAnimationConfig` object.
     *
     * @return {Vsengine.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
    load: function (key) {
     ...
     *
     * @method Vsengine.Animations.AnimationState#pause
     * @since 3.0.0
     *
     * @param {Vsengine.Animations.AnimationFrame} [atFrame] - An optional frame to set after pausing the animation.
     *
     * @return {Vsengine.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
     ...
     *
     * @method Vsengine.Animations.AnimationState#resume
     * @since 3.0.0
     *
     * @param {Vsengine.Animations.AnimationFrame} [fromFrame] - An optional frame to set before restarting playback.
     *
     * @return {Vsengine.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
     ...
     *
     * Prior to Vsengine 3.50 this method was called 'delayedPlay' and the parameters were in the reverse order.
     *
     * @method Vsengine.Animations.AnimationState#playAfterDelay
     * @fires Vsengine.Animations.Events#ANIMATION_START
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Animations.AnimationState#playAfterRepeat
     * @fires Vsengine.Animations.Events#ANIMATION_START
     * @since 3.50.0
     *
     * @param {(string|Vsengine.Animations.Animation|Vsengine.Types.Animations.PlayAnimationConfig)} key - The string-based key of the animation to play, or an Animation instance, or a `PlayAnimationConfig` object.
     ...
     *
     * Animations in Vsengine can either belong to the global Animation Manager, or specifically to this Sprite.
     *
     ...
     *
     * @method Vsengine.Animations.AnimationState#play
     * @fires Vsengine.Animations.Events#ANIMATION_START
     * @since 3.0.0
     *
     * @param {(string|Vsengine.Animations.Animation|Vsengine.Types.Animations.PlayAnimationConfig)} key - The string-based key of the animation to play, or an Animation instance, or a `PlayAnimationConfig` object.
     ...
     * Also, see the documentation in the Animation Manager for further details on creating animations.
     *
     * @method Vsengine.Animations.AnimationState#playReverse
     * @fires Vsengine.Animations.Events#ANIMATION_START
     * @since 3.12.0
     *
     * @param {(string|Vsengine.Animations.Animation|Vsengine.Types.Animations.PlayAnimationConfig)} key - The string-based key of the animation to play, or an Animation instance, or a `PlayAnimationConfig` object.
     ...
     *
     * @method Vsengine.Animations.AnimationState#startAnimation
     * @fires Vsengine.Animations.Events#ANIMATION_START
     * @since 3.50.0
     *
     * @param {(string|Vsengine.Types.Animations.PlayAnimationConfig)} key - The string-based key of the animation to play, or a `PlayAnimationConfig` object.
    ...
    startAnimation: function (key) {
        ...
        this.repeatCounter =
            this.repeat === -1 ? Number.MAX_VALUE : this.repeat;
     ...
     *
     * @method Vsengine.Animations.AnimationState#handleStart
     * @private
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.Animations.AnimationState#handleRepeat
     * @private
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.Animations.AnimationState#handleStop
     * @private
     * @since 3.50.0
     */
    handleStop: function () {
     ...
     *
     * @method Vsengine.Animations.AnimationState#handleComplete
     * @private
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.Animations.AnimationState#emitEvents
     * @private
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Animations.AnimationState#reverse
     * @since 3.12.0
     *
     * @return {Vsengine.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
     ...
     *
     * @method Vsengine.Animations.AnimationState#getProgress
     * @since 3.4.0
     *
     ...
     * the duration of the animation.
     *
     * @method Vsengine.Animations.AnimationState#setProgress
     * @since 3.4.0
     *
     ...
     *
     * @method Vsengine.Animations.AnimationState#setRepeat
     * @since 3.4.0
     *
     ...
     *
     * @method Vsengine.Animations.AnimationState#globalRemove
     * @since 3.50.0
     *
     * @param {string} [key] - The key of the removed Animation.
     * @param {Vsengine.Animations.Animation} [animation] - The removed Animation.
     */
     ...
     *
     * @method Vsengine.Animations.AnimationState#restart
     * @fires Vsengine.Animations.Events#ANIMATION_RESTART
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Animations.AnimationState#complete
     * @fires Vsengine.Animations.Events#ANIMATION_COMPLETE
     * @since 3.50.0
     *
     * @return {Vsengine.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
     ...
     *
     * @method Vsengine.Animations.AnimationState#stop
     * @fires Vsengine.Animations.Events#ANIMATION_STOP
     * @since 3.0.0
     *
     * @return {Vsengine.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
     ...
     *
     * @method Vsengine.Animations.AnimationState#stopAfterDelay
     * @fires Vsengine.Animations.Events#ANIMATION_STOP
     * @since 3.4.0
     *
     ...
     * when the current one stops.
     *
     * Prior to Vsengine 3.50 this method was called `stopOnRepeat` and had no parameters.
     *
     * @method Vsengine.Animations.AnimationState#stopAfterRepeat
     * @fires Vsengine.Animations.Events#ANIMATION_STOP
     * @since 3.50.0
     *
     ...
     * when the current one stops.
     *
     * @method Vsengine.Animations.AnimationState#stopOnFrame
     * @fires Vsengine.Animations.Events#ANIMATION_STOP
     * @since 3.4.0
     *
     * @param {Vsengine.Animations.AnimationFrame} frame - The frame to check before stopping this animation.
     *
     * @return {Vsengine.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
     ...
     *
     * @method Vsengine.Animations.AnimationState#getTotalFrames
     * @since 3.4.0
     *
     ...
     *
     * @method Vsengine.Animations.AnimationState#update
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Animations.AnimationState#setCurrentFrame
     * @fires Vsengine.Animations.Events#ANIMATION_UPDATE
     * @fires Vsengine.Animations.Events#ANIMATION_STOP
     * @since 3.4.0
     *
     * @param {Vsengine.Animations.AnimationFrame} animationFrame - The animation frame to change to.
     *
     * @return {Vsengine.GameObjects.GameObject} The Game Object this Animation Component belongs to.
     */
     ...
     *
     * @method Vsengine.Animations.AnimationState#nextFrame
     * @since 3.16.0
     *
     * @return {Vsengine.GameObjects.GameObject} The Game Object this Animation Component belongs to.
     */
     ...
     *
     * @method Vsengine.Animations.AnimationState#previousFrame
     * @since 3.16.0
     *
     * @return {Vsengine.GameObjects.GameObject} The Game Object this Animation Component belongs to.
     */
     ...
     *
     * @method Vsengine.Animations.AnimationState#get
     * @since 3.50.0
     *
     * @param {string} key - The key of the Animation to retrieve.
     *
     * @return {Vsengine.Animations.Animation} The Animation, or `null` if the key is invalid.
     */
    get: function (key) {
     ...
     *
     * @method Vsengine.Animations.AnimationState#exists
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Animations.AnimationState#create
     * @since 3.50.0
     *
     * @param {Vsengine.Types.Animations.Animation} config - The configuration settings for the Animation.
     *
     * @return {(Vsengine.Animations.Animation|false)} The Animation that was created, or `false` if the key is already in use.
     */
     ...
     * 5c. The JSON Data type can be either a Hash or Array, Vsengine doesn't mind.
     ...
     *
     * @method Vsengine.Animations.AnimationState#createFromAseprite
     * @since 3.60.0
     *
     ...
     *
     * @return {Vsengine.Animations.Animation[]} An array of Animation instances that were successfully created.
     */
    ...
    /**
     * Generate an array of {@link Vsengine.Types.Animations.AnimationFrame} objects from a texture key and configuration object.
     *
     * Generates objects with string based frame names, as configured by the given {@link Vsengine.Types.Animations.GenerateFrameNames}.
     *
     ...
     *
     * @method Vsengine.Animations.AnimationState#generateFrameNames
     * @since 3.50.0
     *
     * @param {string} key - The key for the texture containing the animation frames.
     * @param {Vsengine.Types.Animations.GenerateFrameNames} [config] - The configuration object for the animation frame names.
     *
     * @return {Vsengine.Types.Animations.AnimationFrame[]} The array of {@link Vsengine.Types.Animations.AnimationFrame} objects.
     */
     ...
     * Generate an array of {@link Vsengine.Types.Animations.AnimationFrame} objects from a texture key and configuration object.
     *
     * Generates objects with numbered frame names, as configured by the given {@link Vsengine.Types.Animations.GenerateFrameNumbers}.
     *
     ...
     *
     * @method Vsengine.Animations.AnimationState#generateFrameNumbers
     * @since 3.50.0
     *
     * @param {string} key - The key for the texture containing the animation frames.
     * @param {Vsengine.Types.Animations.GenerateFrameNumbers} [config] - The configuration object for the animation frames.
     *
     * @return {Vsengine.Types.Animations.AnimationFrame[]} The array of {@link Vsengine.Types.Animations.AnimationFrame} objects.
     */
     ...
     *
     * @method Vsengine.Animations.AnimationState#remove
     * @since 3.50.0
     *
     * @param {string} key - The key of the animation to remove.
     *
     * @return {Vsengine.Animations.Animation} The Animation instance that was removed from this Sprite, if the key was valid.
     */
    remove: function (key) {
     ...
     *
     * @method Vsengine.Animations.AnimationState#destroy
     * @since 3.0.0
     */
    destroy: function () {
     ...
     *
     * @name Vsengine.Animations.AnimationState#isPaused
     * @readonly
     * @type {boolean}
     * @since 3.4.0
     */
