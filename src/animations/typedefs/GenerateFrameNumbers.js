/**
 * @typedef {object} Vsengine.Types.Animations.GenerateFrameNumbers
 * @since 3.0.0
 *
 ...
 * @property {Vsengine.Types.Animations.AnimationFrame[]} [outputArray=[]] - An array to concatenate the output onto.
