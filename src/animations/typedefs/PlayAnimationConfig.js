/**
 * @typedef {object} Vsengine.Types.Animations.PlayAnimationConfig
 * @since 3.50.0
 *
 * @property {(string|Vsengine.Animations.Animation)} key - The string-based key of the animation to play, or an Animation instance.
