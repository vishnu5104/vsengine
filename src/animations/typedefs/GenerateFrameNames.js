/**
 * @typedef {object} Vsengine.Types.Animations.GenerateFrameNames
 * @since 3.0.0
 *
 ...
 * @property {Vsengine.Types.Animations.AnimationFrame[]} [outputArray=[]] - The array to append the created configuration objects to.
