...
var AnimationManager = new Class({
    ...
    initialize: function AnimationManager(game) {
         ...
         *
         * @name Vsengine.Animations.AnimationManager#game
         * @type {Vsengine.Game}
         * @protected
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationManager#textureManager
         ...
         *
         * @name Vsengine.Animations.AnimationManager#globalTimeScale
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationManager#anims
         ...
         *
         * @name Vsengine.Animations.AnimationManager#mixes
         * @type {Vsengine.Structs.Map.<string, Vsengine.Animations.Animation>}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationManager#paused
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.AnimationManager#name
         * @type {string}
         * @since 3.0.0
         */
     ...
     *
     * @method Vsengine.Animations.AnimationManager#boot
     * @listens Vsengine.Core.Events#DESTROY
     * @since 3.0.0
     */
    boot: function () {
     ...
     *
     * @method Vsengine.Animations.AnimationManager#addMix
     * @since 3.50.0
     *
     * @param {(string|Vsengine.Animations.Animation)} animA - The string-based key, or instance of, Animation A.
     * @param {(string|Vsengine.Animations.Animation)} animB - The string-based key, or instance of, Animation B.
     ...
     * new delay.
     *
     * @method Vsengine.Animations.AnimationManager#removeMix
     * @since 3.50.0
     *
     * @param {(string|Vsengine.Animations.Animation)} animA - The string-based key, or instance of, Animation A.
     * @param {(string|Vsengine.Animations.Animation)} [animB] - The string-based key, or instance of, Animation B. If not given, all mixes for Animation A will be removed.
     *
     * @return {this} This Animation Manager.
     */
     ...
     *
     * @method Vsengine.Animations.AnimationManager#getMix
     * @since 3.50.0
     *
     * @param {(string|Vsengine.Animations.Animation)} animA - The string-based key, or instance of, Animation A.
     * @param {(string|Vsengine.Animations.Animation)} animB - The string-based key, or instance of, Animation B.
     ...
     *
     * @method Vsengine.Animations.AnimationManager#add
     * @fires Vsengine.Animations.Events#ADD_ANIMATION
     * @since 3.0.0
     *
     * @param {string} key - The key under which the Animation should be added. The Animation will be updated with it. Must be unique.
     * @param {Vsengine.Animations.Animation} animation - The Animation which should be added to the Animation Manager.
     *
     * @return {this} This Animation Manager.
     */
     ...
     *
     * @method Vsengine.Animations.AnimationManager#exists
     * @since 3.16.0
     *
     ...
     * ```
     *
     * Any animations defined in the JSON will now be available to use in Vsengine and you play them
     * via their Tag name. For example, if you have an animation called 'War Cry' on your Aseprite timeline,
     * you can play it in Vsengine using that Tag name:
     *
     * ```javascript
     ...
     *
     * @method Vsengine.Animations.AnimationManager#createFromAseprite
     * @since 3.50.0
     *
     ...
     * @param {(Vsengine.Animations.AnimationManager|Vsengine.GameObjects.GameObject)} [target] - Create the animations on this target Sprite. If not given, they will be created globally in this Animation Manager.
     *
     ...
     *
     * @method Vsengine.Animations.AnimationManager#create
     * @fires Vsengine.Animations.Events#ADD_ANIMATION
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Animations.AnimationManager#fromJSON
     * @since 3.0.0
     *
     * @param {(string|Vsengine.Types.Animations.JSONAnimations|Vsengine.Types.Animations.JSONAnimation)} data - The JSON object to parse.
     ...
     *
     * @return {Vsengine.Animations.Animation[]} An array containing all of the Animation objects that were created as a result of this call.
     */
     ...
     *
     * @method Vsengine.Animations.AnimationManager#generateFrameNames
     * @since 3.0.0
     *
        ...
        if (!config) {
            ...
            for (i = 0; i < frames.length; i++) {
                ...
                if (texture.has(frame)) {
                    ...
                    console.warn(
                        'Frame "%s" not found in texture "%s"',
                        frame,
                        key
                    );
                }
     ...
     *
     * @method Vsengine.Animations.AnimationManager#generateFrameNumbers
     * @since 3.0.0
     *
     * @param {string} key - The key for the texture containing the animation frames.
     ...
     * Get an Animation.
     *
     * @method Vsengine.Animations.AnimationManager#get
     * @since 3.0.0
     *
     * @param {string} key - The key of the Animation to retrieve.
     *
     * @return {Vsengine.Animations.Animation} The Animation.
     */
    get: function (key) {
     ...
     *
     * @method Vsengine.Animations.AnimationManager#getAnimsFromTexture
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Animations.AnimationManager#pauseAll
     * @fires Vsengine.Animations.Events#PAUSE_ALL
     * @since 3.0.0
     *
     * @return {this} This Animation Manager.
     */
     ...
     *
     * @method Vsengine.Animations.AnimationManager#play
     * @since 3.0.0
     *
     ...
     * @param {Vsengine.GameObjects.GameObject|Vsengine.GameObjects.GameObject[]} children - An array of Game Objects to play the animation on. They must have an Animation Component.
     *
     * @return {this} This Animation Manager.
     */
     ...
     * child 4: 0ms delay
     *
     * @method Vsengine.Animations.AnimationManager#staggerPlay
     * @since 3.0.0
     *
    ...
    staggerPlay: function (key, children, stagger, staggerFirst) {
        ...
        for (var i = 0; i < children.length; i++) {
            var time =
                stagger < 0 ? Math.abs(stagger) * (len - i) : stagger * i;
     ...
     *
     * @method Vsengine.Animations.AnimationManager#remove
     * @fires Vsengine.Animations.Events#REMOVE_ANIMATION
     * @since 3.0.0
     *
     * @param {string} key - The key of the animation to remove.
     *
     * @return {Vsengine.Animations.Animation} The Animation instance that was removed from the Animation Manager.
     */
    remove: function (key) {
     ...
     *
     * @method Vsengine.Animations.AnimationManager#resumeAll
     * @fires Vsengine.Animations.Events#RESUME_ALL
     * @since 3.0.0
     *
     * @return {this} This Animation Manager.
     */
     ...
     *
     * @method Vsengine.Animations.AnimationManager#toJSON
     * @since 3.0.0
     *
     ...
     *
     * @return {Vsengine.Types.Animations.JSONAnimations} The resulting JSONAnimations formatted object.
     */
    toJSON: function (key) {
        var output = {
            anims: [],
     ...
     * This method should not be called directly. It will be called automatically as a response to a `destroy` event from the Vsengine.Game instance.
     *
     * @method Vsengine.Animations.AnimationManager#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.anims.clear();
