 ...
 *
 * @event Vsengine.Animations.Events#ANIMATION_RESTART
 * @type {string}
 * @since 3.50.0
 *
 * @param {Vsengine.Animations.Animation} animation - A reference to the Animation that has restarted.
 * @param {Vsengine.Animations.AnimationFrame} frame - The current Animation Frame of the Animation.
 * @param {Vsengine.GameObjects.Sprite} gameObject - A reference to the Game Object on which the animation restarted.
