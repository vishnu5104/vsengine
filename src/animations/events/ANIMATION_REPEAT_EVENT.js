 ...
 *
 * @event Vsengine.Animations.Events#ANIMATION_REPEAT
 * @type {string}
 * @since 3.50.0
 *
 * @param {Vsengine.Animations.Animation} animation - A reference to the Animation that has repeated.
 * @param {Vsengine.Animations.AnimationFrame} frame - The current Animation Frame of the Animation.
 * @param {Vsengine.GameObjects.Sprite} gameObject - A reference to the Game Object on which the animation repeated.
