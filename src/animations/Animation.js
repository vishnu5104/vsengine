 ...
 *
 * Animations in Vsengine consist of a sequence of `AnimationFrame` objects, which are managed by
 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Animations.AnimationManager} manager - A reference to the global Animation Manager
 * @param {string} key - The unique identifying string for this animation.
 * @param {Vsengine.Types.Animations.Animation} config - The Animation configuration.
 */
var Animation = new Class({
    initialize: function Animation(manager, key, config) {
         ...
         *
         * @name Vsengine.Animations.Animation#manager
         ...
         *
         * @name Vsengine.Animations.Animation#key
         * @type {string}
         * @since 3.0.0
         */
        this.key = key;
         ...
         *
         * @name Vsengine.Animations.Animation#type
         * @type {string}
         * @default frame
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.Animation#frames
         ...
         *
         * @name Vsengine.Animations.Animation#frameRate
         * @type {number}
         * @default 24
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.Animation#duration
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.Animation#msPerFrame
         * @type {number}
         * @since 3.0.0
         */
        this.msPerFrame;
         ...
         *
         * @name Vsengine.Animations.Animation#skipMissedFrames
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.Animation#delay
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.Animation#repeat
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.Animation#repeatDelay
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.Animation#yoyo
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.Animation#showBeforeDelay
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Animations.Animation#showOnStart
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.Animation#hideOnComplete
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Animations.Animation#randomFrame
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Animations.Animation#paused
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
     ...
     *
     * @method Vsengine.Animations.Animation#getTotalFrames
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Animations.Animation#calculateDuration
     * @since 3.50.0
     *
     * @param {Vsengine.Animations.Animation} target - The target to set the values on.
     ...
     *
     * @method Vsengine.Animations.Animation#addFrame
     * @since 3.0.0
     *
     * @param {(string|Vsengine.Types.Animations.AnimationFrame[])} config - Either a string, in which case it will use all frames from a texture with the matching key, or an array of Animation Frame configuration objects.
     *
     ...
     *
     * @method Vsengine.Animations.Animation#addFrameAt
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Animations.Animation#checkFrame
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Animations.Animation#getFirstTick
     * @protected
     * @since 3.0.0
     *
     * @param {Vsengine.Animations.AnimationState} state - The Animation State belonging to the Game Object invoking this call.
     */
    getFirstTick: function (state) {
        //  When is the first update due?
        state.accumulator = 0;

        state.nextTick = state.currentFrame.duration
            ? state.currentFrame.duration
            : state.msPerFrame;
    },
     ...
     *
     * @method Vsengine.Animations.Animation#getFrameAt
     * @since 3.0.0
     *
     * @param {number} index - The index in the AnimationFrame array
     *
     * @return {Vsengine.Animations.AnimationFrame} The frame at the index provided from the animation sequence
     */
     ...
     *
     * @method Vsengine.Animations.Animation#getFrames
     * @since 3.0.0
     *
     * @param {Vsengine.Textures.TextureManager} textureManager - A reference to the global Texture Manager.
     * @param {(string|Vsengine.Types.Animations.AnimationFrame[])} frames - Either a string, in which case it will use all frames from a texture with the matching key, or an array of Animation Frame configuration objects.
     * @param {string} [defaultTextureKey] - The key to use if no key is set in the frame configuration object.
     *
     * @return {Vsengine.Animations.AnimationFrame[]} An array of newly created AnimationFrame instances.
     */
    getFrames: function (
        textureManager,
        frames,
     ...
     *
     * @method Vsengine.Animations.Animation#getNextTick
     * @since 3.0.0
     *
     * @param {Vsengine.Animations.AnimationState} state - The Animation State belonging to the Game Object invoking this call.
     */
     ...
     *
     * @method Vsengine.Animations.Animation#getFrameByProgress
     * @since 3.4.0
     *
     * @param {number} value - A value between 0 and 1.
     *
     * @return {Vsengine.Animations.AnimationFrame} The frame closest to the given progress value.
     */
     ...
     *
     * @method Vsengine.Animations.Animation#nextFrame
     * @since 3.0.0
     *
     * @param {Vsengine.Animations.AnimationState} state - The Animation State to advance.
     */
     ...
     *
     * @method Vsengine.Animations.Animation#handleYoyoFrame
     * @private
     * @since 3.12.0
     *
     * @param {Vsengine.Animations.AnimationState} state - The Animation State to advance.
     ...
     *
     * @method Vsengine.Animations.Animation#getLastFrame
     * @since 3.12.0
     *
     * @return {Vsengine.Animations.AnimationFrame} The last Animation Frame.
     */
     ...
     *
     * @method Vsengine.Animations.Animation#previousFrame
     * @since 3.0.0
     *
     * @param {Vsengine.Animations.AnimationState} state - The Animation State belonging to the Game Object invoking this call.
     */
     ...
     *
     * @method Vsengine.Animations.Animation#updateAndGetNextTick
     * @private
     * @since 3.12.0
     *
     * @param {Vsengine.Animations.AnimationState} state - The Animation State.
     * @param {Vsengine.Animations.AnimationFrame} frame - An Animation frame.
     */
     ...
     *
     * @method Vsengine.Animations.Animation#removeFrame
     * @since 3.0.0
     *
     * @param {Vsengine.Animations.AnimationFrame} frame - The AnimationFrame to be removed.
     *
     * @return {this} This Animation object.
     */
     ...
     *
     * @method Vsengine.Animations.Animation#removeFrameAt
     * @since 3.0.0
     *
     * @param {number} index - The index in the AnimationFrame array
     *
     ...
     *
     * @method Vsengine.Animations.Animation#repeatAnimation
     * @fires Vsengine.Animations.Events#ANIMATION_REPEAT
     * @fires Vsengine.Animations.Events#SPRITE_ANIMATION_REPEAT
     * @fires Vsengine.Animations.Events#SPRITE_ANIMATION_KEY_REPEAT
     * @since 3.0.0
     *
     * @param {Vsengine.Animations.AnimationState} state - The Animation State belonging to the Game Object invoking this call.
     */
     ...
     *
     * @method Vsengine.Animations.Animation#toJSON
     * @since 3.0.0
     *
     * @return {Vsengine.Types.Animations.JSONAnimation} The resulting JSONAnimation formatted object.
     */
    toJSON: function () {
        var output = {
            key: this.key,
     ...
     *
     * @method Vsengine.Animations.Animation#updateFrameSequence
     * @since 3.0.0
     *
     * @return {this} This Animation object.
     */
     ...
     *
     * @method Vsengine.Animations.Animation#pause
     * @since 3.0.0
     *
     * @return {this} This Animation object.
     */
     ...
     *
     * @method Vsengine.Animations.Animation#resume
     * @since 3.0.0
     *
     * @return {this} This Animation object.
     */
     ...
     *
     * @method Vsengine.Animations.Animation#destroy
     * @since 3.0.0
     */
    destroy: function () {
        if (this.manager.off) {
