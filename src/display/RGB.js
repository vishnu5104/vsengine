...
var RGB = new Class({
    initialize: function RGB(red, green, blue) {
         ...
         * Cached RGB values.
         *
         * @name Vsengine.Display.RGB#_rgb
         * @type {number[]}
         * @private
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Display.RGB#onChangeCallback
         * @type {function}
         * @since 3.50.0
         */
         ...
         * Is this color dirty?
         *
         * @name Vsengine.Display.RGB#dirty
         * @type {boolean}
         * @since 3.50.0
         */
        this.dirty = false;
     ...
     *
     * @method Vsengine.Display.RGB#set
     * @since 3.50.0
     *
     * @param {number} [red=0] - The red color value. A number between 0 and 1.
     * @param {number} [green=0] - The green color value. A number between 0 and 1.
     ...
     *
     * @method Vsengine.Display.RGB#equals
     * @since 3.50.0
     *
     ...
     * new RGB values.
     *
     * @method Vsengine.Display.RGB#onChange
     * @since 3.50.0
     */
    onChange: function () {
        this.dirty = true;
     ...
     *
     * @method Vsengine.Display.RGB#destroy
     * @since 3.50.0
     */
    destroy: function () {
