...
/**
 * @namespace Vsengine.Display.Canvas.CanvasInterpolation
 * @since 3.0.0
 */
var CanvasInterpolation = {
     ...
     *
     * @function Vsengine.Display.Canvas.CanvasInterpolation.setCrisp
     * @since 3.0.0
     *
     ...
     *
     * @function Vsengine.Display.Canvas.CanvasInterpolation.setBicubic
     * @since 3.0.0
     *
     * @param {HTMLCanvasElement} canvas - The canvas object to have the style set on.
     *
