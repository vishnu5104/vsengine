...
/**
 * @namespace Vsengine.Display.Canvas.Smoothing
 * @since 3.0.0
 */
var Smoothing = function () {
     ...
     *
     * @function Vsengine.Display.Canvas.Smoothing.getPrefix
     * @since 3.0.0
     *
     ...
     *
     * @function Vsengine.Display.Canvas.Smoothing.enable
     * @since 3.0.0
     *
     ...
     * patchy on earlier browsers, especially on mobile.
     *
     * @function Vsengine.Display.Canvas.Smoothing.disable
     * @since 3.0.0
     *
     ...
     *
     * @function Vsengine.Display.Canvas.Smoothing.isEnabled
     * @since 3.0.0
     *
