...
var BaseShader = new Class({
    initialize: function BaseShader(key, fragmentSrc, vertexSrc, uniforms) {
        ...
        /**
         * The key of this shader, unique within the shader cache of this Vsengine game instance.
         *
         * @name Vsengine.Display.BaseShader#key
         * @type {string}
         * @since 3.17.0
         */
        this.key = key;
         ...
         *
         * @name Vsengine.Display.BaseShader#fragmentSrc
         * @type {string}
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.Display.BaseShader#vertexSrc
         * @type {string}
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.Display.BaseShader#uniforms
         * @type {?any}
         * @since 3.17.0
         */
