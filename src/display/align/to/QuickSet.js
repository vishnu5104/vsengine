 ...
 * The alignment used is based on the `position` argument, which is a `Vsengine.Display.Align` property such as `LEFT_CENTER` or `TOP_RIGHT`.
 *
 * @function Vsengine.Display.Align.To.QuickSet
 * @since 3.22.0
 *
 * @generic {Vsengine.GameObjects.GameObject} G - [child,$return]
 *
 * @param {Vsengine.GameObjects.GameObject} child - The Game Object that will be positioned.
 * @param {Vsengine.GameObjects.GameObject} alignTo - The Game Object to base the alignment position on.
 * @param {number} position - The position to align the Game Object with. This is an align constant, such as `Vsengine.Display.Align.LEFT_CENTER`.
