 ...
 *
 * @function Vsengine.Display.Color.HSVToRGB
 * @since 3.0.0
 *
 ...
 * @param {(Vsengine.Types.Display.ColorObject|Vsengine.Display.Color)} [out] - A Color object to store the results in. If not given a new ColorObject will be created.
 *
 * @return {(Vsengine.Types.Display.ColorObject|Vsengine.Display.Color)} An object with the red, green and blue values set in the r, g and b properties.
 */
