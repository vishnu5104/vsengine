...
/**
 * @namespace Vsengine.Display.Color.Interpolate
 * @memberof Vsengine.Display.Color
 * @since 3.0.0
 */
 ...
 *
 * @function Vsengine.Display.Color.Interpolate.RGBWithRGB
 * @memberof Vsengine.Display.Color.Interpolate
 * @static
 * @since 3.0.0
 *
 ...
 *
 * @return {Vsengine.Types.Display.ColorObject} An object containing the interpolated color values.
 */
 ...
 *
 * @function Vsengine.Display.Color.Interpolate.ColorWithColor
 * @memberof Vsengine.Display.Color.Interpolate
 * @static
 * @since 3.0.0
 *
 * @param {Vsengine.Display.Color} color1 - The first Color object.
 * @param {Vsengine.Display.Color} color2 - The second Color object.
 * @param {number} [length=100] - Distance to interpolate over.
 * @param {number} [index=0] - Index to start from.
 *
 * @return {Vsengine.Types.Display.ColorObject} An object containing the interpolated color values.
 ...
 *
 * @function Vsengine.Display.Color.Interpolate.ColorWithRGB
 * @memberof Vsengine.Display.Color.Interpolate
 * @static
 * @since 3.0.0
 *
