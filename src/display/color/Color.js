...
/**
 * @namespace Vsengine.Display.Color
 */
...
var Color = new Class({
    initialize: function Color(red, green, blue, alpha) {
         ...
         *
         * @name Vsengine.Display.Color#_h
         * @type {number}
         * @default 0
         * @private
         * @since 3.13.0
         ...
         *
         * @name Vsengine.Display.Color#_s
         * @type {number}
         * @default 0
         * @private
         * @since 3.13.0
         ...
         *
         * @name Vsengine.Display.Color#_v
         * @type {number}
         * @default 0
         * @private
         * @since 3.13.0
         ...
         *
         * @name Vsengine.Display.Color#_locked
         * @type {boolean}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.Display.Color#gl
         * @type {number[]}
         * @since 3.0.0
         */
        this.gl = [0, 0, 0, 1];
         ...
         *
         * @name Vsengine.Display.Color#_color
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Display.Color#_color32
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Display.Color#_rgba
         * @type {string}
         * @private
         * @default ''
         * @since 3.0.0
     ...
     *
     * @method Vsengine.Display.Color#transparent
     * @since 3.0.0
     *
     * @return {Vsengine.Display.Color} This Color object.
     */
     ...
     *
     * @method Vsengine.Display.Color#setTo
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Display.Color#setGLTo
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Display.Color#setFromRGB
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Display.InputColorObject} color - An object containing `r`, `g`, `b` and optionally `a` values in the range 0 to 255.
     *
     * @return {Vsengine.Display.Color} This Color object.
     */
     ...
     *
     * @method Vsengine.Display.Color#setFromHSV
     * @since 3.13.0
     *
     ...
     *
     * @method Vsengine.Display.Color#update
     * @private
     * @since 3.0.0
     *
     * @return {Vsengine.Display.Color} This Color object.
     ...
     *
     * @method Vsengine.Display.Color#updateHSV
     * @private
     * @since 3.13.0
     *
     * @return {Vsengine.Display.Color} This Color object.
     ...
     *
     * @method Vsengine.Display.Color#clone
     * @since 3.0.0
     *
     * @return {Vsengine.Display.Color} A new Color object.
     */
    clone: function () {
     ...
     *
     * @method Vsengine.Display.Color#gray
     * @since 3.13.0
     *
     ...
     *
     * @method Vsengine.Display.Color#random
     * @since 3.13.0
     *
     ...
     *
     * @method Vsengine.Display.Color#randomGray
     * @since 3.13.0
     *
     * @param {number} [min=0] - The minimum random color value. Between 0 and 255.
     * @param {number} [max=255] - The maximum random color value. Between 0 and 255.
     ...
     *
     * @method Vsengine.Display.Color#saturate
     * @since 3.13.0
     *
     ...
     * The saturation is the amount of the base color in the hue.
     *
     * @method Vsengine.Display.Color#desaturate
     * @since 3.13.0
     *
     * @param {number} amount - The percentage amount to change this color by. A value between 0 and 100.
     *
     ...
     *
     * @method Vsengine.Display.Color#lighten
     * @since 3.13.0
     *
     * @param {number} amount - The percentage amount to change this color by. A value between 0 and 100.
     *
     ...
     *
     * @method Vsengine.Display.Color#darken
     * @since 3.13.0
     *
     * @param {number} amount - The percentage amount to change this color by. A value between 0 and 100.
     *
     ...
     *
     * @method Vsengine.Display.Color#brighten
     * @since 3.13.0
     *
     * @param {number} amount - The percentage amount to change this color by. A value between 0 and 100.
     *
     ...
     *
     * @name Vsengine.Display.Color#color
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Display.Color#color32
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Display.Color#rgba
     * @type {string}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Display.Color#redGL
     * @type {number}
     * @since 3.0.0
     */
    redGL: {
     ...
     *
     * @name Vsengine.Display.Color#greenGL
     * @type {number}
     * @since 3.0.0
     */
    greenGL: {
     ...
     *
     * @name Vsengine.Display.Color#blueGL
     * @type {number}
     * @since 3.0.0
     */
    blueGL: {
     ...
     *
     * @name Vsengine.Display.Color#alphaGL
     * @type {number}
     * @since 3.0.0
     */
    alphaGL: {
     ...
     *
     * @name Vsengine.Display.Color#red
     * @type {number}
     * @since 3.0.0
     */
    red: {
     ...
     *
     * @name Vsengine.Display.Color#green
     * @type {number}
     * @since 3.0.0
     */
    green: {
     ...
     *
     * @name Vsengine.Display.Color#blue
     * @type {number}
     * @since 3.0.0
     */
    blue: {
     ...
     *
     * @name Vsengine.Display.Color#alpha
     * @type {number}
     * @since 3.0.0
     */
    alpha: {
