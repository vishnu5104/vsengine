...
/**
 * Converts HSL (hue, saturation and lightness) values to a Vsengine Color object.
 *
 * @function Vsengine.Display.Color.HSLToColor
 * @since 3.0.0
 *
 ...
 *
 * @return {Vsengine.Display.Color} A Color object created from the results of the h, s and l values.
 */
