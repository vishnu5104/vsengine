 ...
 *
 * @function Vsengine.Display.Color.ColorSpectrum
 * @since 3.50.0
 *
 ...
 *
 * @return {Vsengine.Types.Display.ColorObject[]} An array containing `limit` parameter number of elements, where each contains a Color Object.
 */
