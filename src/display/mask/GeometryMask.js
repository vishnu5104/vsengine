 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - This parameter is not used.
 * @param {Vsengine.GameObjects.Graphics} graphicsGeometry - The Graphics Game Object to use for the Geometry Mask. Doesn't have to be in the Display List.
 */
var GeometryMask = new Class({
    initialize: function GeometryMask(scene, graphicsGeometry) {
         ...
         *
         * @name Vsengine.Display.Masks.GeometryMask#geometryMask
         ...
         *
         * @name Vsengine.Display.Masks.GeometryMask#invertAlpha
         * @type {boolean}
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Display.Masks.GeometryMask#isStencil
         * @type {boolean}
         * @readonly
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.Display.Masks.GeometryMask#level
         * @type {boolean}
         * @since 3.17.0
         */
        this.level = 0;
     ...
     *
     * @method Vsengine.Display.Masks.GeometryMask#setShape
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.Graphics} graphicsGeometry - The Graphics object which will be used for the Geometry Mask.
     *
     ...
     * This is a WebGL only feature.
     *
     * @method Vsengine.Display.Masks.GeometryMask#setInvertAlpha
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.Display.Masks.GeometryMask#preRenderWebGL
     * @since 3.0.0
     *
     * @param {Vsengine.Renderer.WebGL.WebGLRenderer} renderer - The WebGL Renderer instance to draw to.
     * @param {Vsengine.GameObjects.GameObject} child - The Game Object being rendered.
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The camera the Game Object is being rendered through.
     */
     ...
     *
     * @method Vsengine.Display.Masks.GeometryMask#applyStencil
     * @since 3.17.0
     *
     * @param {Vsengine.Renderer.WebGL.WebGLRenderer} renderer - The WebGL Renderer instance to draw to.
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The camera the Game Object is being rendered through.
     ...
     *
     * @method Vsengine.Display.Masks.GeometryMask#postRenderWebGL
     * @since 3.0.0
     *
     * @param {Vsengine.Renderer.WebGL.WebGLRenderer} renderer - The WebGL Renderer instance to draw flush.
     */
     ...
     *
     * @method Vsengine.Display.Masks.GeometryMask#preRenderCanvas
     * @since 3.0.0
     *
     * @param {Vsengine.Renderer.Canvas.CanvasRenderer} renderer - The Canvas Renderer instance to set the clipping path on.
     * @param {Vsengine.GameObjects.GameObject} mask - The Game Object being rendered.
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The camera the Game Object is being rendered through.
     */
     ...
     *
     * @method Vsengine.Display.Masks.GeometryMask#postRenderCanvas
     * @since 3.0.0
     *
     * @param {Vsengine.Renderer.Canvas.CanvasRenderer} renderer - The Canvas Renderer instance being restored.
     */
     ...
     *
     * @method Vsengine.Display.Masks.GeometryMask#destroy
     * @since 3.7.0
     */
    destroy: function () {
