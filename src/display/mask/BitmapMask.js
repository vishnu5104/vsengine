 ...
 *
 * @class BitmapMask
 * @memberof Vsengine.Display.Masks
 * @constructor
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - The Scene to which this mask is being added.
...
var BitmapMask = new Class({
    initialize: function BitmapMask(scene, maskObject, x, y, texture, frame) {
        if (!maskObject) {
            maskObject = scene.sys.make.image({
                x: x,
                y: y,
                key: texture,
                frame: frame,
         ...
         *
         * @name Vsengine.Display.Masks.BitmapMask#bitmapMask
         * @type {(Vsengine.GameObjects.GameObject|Vsengine.Textures.DynamicTexture)}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Display.Masks.BitmapMask#invertAlpha
         * @type {boolean}
         * @since 3.1.2
         */
         ...
         *
         * @name Vsengine.Display.Masks.BitmapMask#isStencil
         * @type {boolean}
         * @readonly
         * @since 3.17.0
         */
     ...
     *
     * @method Vsengine.Display.Masks.BitmapMask#setBitmap
     * @since 3.0.0
     *
     * @param {(Vsengine.GameObjects.GameObject|Vsengine.Textures.DynamicTexture)} maskObject - The Game Object or Dynamic Texture that will be used as the mask. If a Game Object, it must have a texture, such as a Sprite.
     */
     ...
     *
     * @method Vsengine.Display.Masks.BitmapMask#preRenderWebGL
     * @since 3.0.0
     *
     * @param {(Vsengine.Renderer.Canvas.CanvasRenderer|Vsengine.Renderer.WebGL.WebGLRenderer)} renderer - The WebGL Renderer to prepare.
     * @param {Vsengine.GameObjects.GameObject} maskedObject - The masked Game Object which will be drawn.
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The Camera to render to.
     */
    preRenderWebGL: function (renderer, maskedObject, camera) {
        renderer.pipelines.BITMAPMASK_PIPELINE.beginMask(
            this,
            maskedObject,
            camera
        );
     ...
     *
     * @method Vsengine.Display.Masks.BitmapMask#postRenderWebGL
     * @since 3.0.0
     *
     * @param {(Vsengine.Renderer.Canvas.CanvasRenderer|Vsengine.Renderer.WebGL.WebGLRenderer)} renderer - The WebGL Renderer to clean up.
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The Camera to render to.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} [renderTarget] - Optional WebGL RenderTarget.
     */
    postRenderWebGL: function (renderer, camera, renderTarget) {
        renderer.pipelines.BITMAPMASK_PIPELINE.endMask(
            this,
            camera,
            renderTarget
        );
     ...
     *
     * @method Vsengine.Display.Masks.BitmapMask#preRenderCanvas
     * @since 3.0.0
     *
     ...
     * This is a NOOP method. Bitmap Masks are not supported by the Canvas Renderer.
     *
     * @method Vsengine.Display.Masks.BitmapMask#postRenderCanvas
     * @since 3.0.0
     *
     * @param {(Vsengine.Renderer.Canvas.CanvasRenderer|Vsengine.Renderer.WebGL.WebGLRenderer)} renderer - The Canvas Renderer which would be rendered to.
     */
     ...
     *
     * @method Vsengine.Display.Masks.BitmapMask#destroy
     * @since 3.7.0
     */
    destroy: function () {
 ...
 * render as a normal Game Object and will also serve as a mask.
 *
 * @method Vsengine.GameObjects.GameObjectFactory#bitmapMask
 * @since 3.60.0
 *
 * @param {(Vsengine.GameObjects.GameObject|Vsengine.Textures.DynamicTexture)} [maskObject] - The Game Object or Texture that will be used as the mask. If `null` it will generate an Image Game Object using the rest of the arguments.
 * @param {number} [x] - If creating a Game Object, the horizontal position in the world.
 * @param {number} [y] - If creating a Game Object, the vertical position in the world.
 * @param {(string|Vsengine.Textures.Texture)} [texture] - If creating a Game Object, the key, or instance of the Texture it will use to render with, as stored in the Texture Manager.
 * @param {(string|number|Vsengine.Textures.Frame)} [frame] - If creating a Game Object, an optional frame from the Texture this Game Object is rendering with.
 *
 * @return {Vsengine.Display.Masks.BitmapMask} The Bitmap Mask that was created.
 */
GameObjectFactory.register(
    "bitmapMask",
    function (maskObject, x, y, key, frame) {
