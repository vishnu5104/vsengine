...
/**
 * @namespace Vsengine.Input.InputPluginCache
 */
 ...
 *
 * @function Vsengine.Input.InputPluginCache.register
 * @static
 * @since 3.10.0
 *
 ...
 *
 * @function Vsengine.Input.InputPluginCache.getPlugin
 * @static
 * @since 3.10.0
 *
 * @param {string} key - The key of the input plugin to get.
 *
 * @return {Vsengine.Types.Input.InputPluginContainer} The input plugin object.
 */
 ...
 *
 * @function Vsengine.Input.InputPluginCache.install
 * @static
 * @since 3.10.0
 *
 * @param {Vsengine.Input.InputPlugin} target - The target InputPlugin to install the plugins into.
 */
 ...
 *
 * @function Vsengine.Input.InputPluginCache.remove
 * @static
 * @since 3.10.0
 *
