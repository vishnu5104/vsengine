 ...
 *
 * @class MouseManager
 * @memberof Vsengine.Input.Mouse
 * @constructor
 * @since 3.0.0
 *
 * @param {Vsengine.Input.InputManager} inputManager - A reference to the Input Manager.
 */
var MouseManager = new Class({
    initialize: function MouseManager(inputManager) {
         ...
         *
         * @name Vsengine.Input.Mouse.MouseManager#manager
         ...
         *
         * @name Vsengine.Input.Mouse.MouseManager#preventDefaultDown
         * @type {boolean}
         * @default true
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Input.Mouse.MouseManager#preventDefaultUp
         * @type {boolean}
         * @default true
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Input.Mouse.MouseManager#preventDefaultMove
         * @type {boolean}
         * @default true
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Input.Mouse.MouseManager#preventDefaultWheel
         * @type {boolean}
         * @default true
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Input.Mouse.MouseManager#enabled
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Mouse.MouseManager#target
         * @type {any}
         * @since 3.0.0
         */
        this.target;
         ...
         *
         * @name Vsengine.Input.Mouse.MouseManager#locked
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Mouse.MouseManager#onMouseMove
         * @type {function}
         * @since 3.10.0
         */
         ...
         * Initially empty and bound in the `startListeners` method.
         *
         * @name Vsengine.Input.Mouse.MouseManager#onMouseDown
         * @type {function}
         * @since 3.10.0
         */
         ...
         * Initially empty and bound in the `startListeners` method.
         *
         * @name Vsengine.Input.Mouse.MouseManager#onMouseUp
         * @type {function}
         * @since 3.10.0
         */
        this.onMouseUp = NOOP;
         ...
         * Initially empty and bound in the `startListeners` method.
         *
         * @name Vsengine.Input.Mouse.MouseManager#onMouseDownWindow
         * @type {function}
         * @since 3.17.0
         */
         ...
         * Initially empty and bound in the `startListeners` method.
         *
         * @name Vsengine.Input.Mouse.MouseManager#onMouseUpWindow
         * @type {function}
         * @since 3.17.0
         */
         ...
         * Initially empty and bound in the `startListeners` method.
         *
         * @name Vsengine.Input.Mouse.MouseManager#onMouseOver
         * @type {function}
         * @since 3.16.0
         */
         ...
         * Initially empty and bound in the `startListeners` method.
         *
         * @name Vsengine.Input.Mouse.MouseManager#onMouseOut
         * @type {function}
         * @since 3.16.0
         */
         ...
         * Initially empty and bound in the `startListeners` method.
         *
         * @name Vsengine.Input.Mouse.MouseManager#onMouseWheel
         * @type {function}
         * @since 3.18.0
         */
         ...
         * Initially empty and bound in the `startListeners` method.
         *
         * @name Vsengine.Input.Mouse.MouseManager#pointerLockChange
         * @type {function}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Mouse.MouseManager#isTop
         * @type {boolean}
         * @readonly
         * @since 3.50.0
         */
     ...
     *
     * @method Vsengine.Input.Mouse.MouseManager#boot
     * @private
     * @since 3.0.0
     */
    boot: function () {
     ...
     *
     * @method Vsengine.Input.Mouse.MouseManager#disableContextMenu
     * @since 3.0.0
     *
     ...
     * the error.
     *
     * @method Vsengine.Input.Mouse.MouseManager#requestPointerLock
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Input.Mouse.MouseManager#releasePointerLock
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Input.Mouse.MouseManager#startListeners
     * @since 3.0.0
     */
     ...
     * This is called automatically and does not need to be manually invoked.
     *
     * @method Vsengine.Input.Mouse.MouseManager#stopListeners
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Input.Mouse.MouseManager#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.stopListeners();
