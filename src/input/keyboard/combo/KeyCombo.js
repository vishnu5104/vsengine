 ...
 * @constructor
 * @listens Vsengine.Input.Keyboard.Events#ANY_KEY_DOWN
 * @since 3.0.0
 *
 * @param {Vsengine.Input.Keyboard.KeyboardPlugin} keyboardPlugin - A reference to the Keyboard Plugin.
...
var KeyCombo = new Class({
    initialize: function KeyCombo(keyboardPlugin, keys, config) {
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyCombo#manager
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyCombo#enabled
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyCombo#keyCodes
         * @type {array}
         * @default []
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyCombo#current
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyCombo#index
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyCombo#size
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyCombo#timeLastMatched
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyCombo#matched
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyCombo#timeMatched
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyCombo#resetOnWrongKey
         * @type {boolean}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyCombo#maxKeyDelay
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyCombo#resetOnMatch
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyCombo#deleteOnMatch
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyCombo#onKeyDown
         * @private
         * @type {KeyboardKeydownCallback}
         * @fires Vsengine.Input.Keyboard.Events#COMBO_MATCH
         * @since 3.0.0
         */
     ...
     *
     * @name Vsengine.Input.Keyboard.KeyCombo#progress
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyCombo#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.enabled = false;
