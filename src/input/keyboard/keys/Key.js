 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Input.Keyboard.KeyboardPlugin} plugin - The Keyboard Plugin instance that owns this Key object.
...
var Key = new Class({
    ...
    initialize: function Key(plugin, keyCode) {
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#plugin
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#keyCode
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#originalEvent
         * @type {KeyboardEvent}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#enabled
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#isDown
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#isUp
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#altKey
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#ctrlKey
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#shiftKey
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#metaKey
         * @type {boolean}
         * @default false
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#location
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#timeDown
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#duration
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#timeUp
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#emitOnRepeat
         * @type {boolean}
         * @default false
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#repeats
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#_justDown
         * @type {boolean}
         * @private
         * @default false
         * @since 3.0.0
         ...
         * True if the key has just been pressed (NOTE: requires to be reset, see justDown getter)
         *
         * @name Vsengine.Input.Keyboard.Key#_justUp
         * @type {boolean}
         * @private
         * @default false
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Input.Keyboard.Key#_tick
         * @type {number}
         * @private
         * @since 3.11.0
         */
     ...
     *
     * @method Vsengine.Input.Keyboard.Key#setEmitOnRepeat
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Input.Keyboard.Key#onDown
     * @fires Vsengine.Input.Keyboard.Events#DOWN
     * @since 3.16.0
     *
     ...
     * Called automatically by the Keyboard Plugin.
     *
     * @method Vsengine.Input.Keyboard.Key#onUp
     * @fires Vsengine.Input.Keyboard.Events#UP
     * @since 3.16.0
     *
     * @param {KeyboardEvent} event - The native DOM Keyboard event.
     */
     ...
     *
     * @method Vsengine.Input.Keyboard.Key#reset
     * @since 3.6.0
     *
     * @return {this} This Key instance.
     */
     ...
     *
     * @method Vsengine.Input.Keyboard.Key#getDuration
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.Input.Keyboard.Key#destroy
     * @since 3.16.0
     */
    destroy: function () {
