 ...
 *
 * You can also listen for a specific key being released. See [Keyboard.Events.KEY_UP]{@linkcode Vsengine.Input.Keyboard.Events#event:KEY_UP} for details.
 *
 * Finally, you can create Key objects, which you can also listen for events from. See [Keyboard.Events.UP]{@linkcode Vsengine.Input.Keyboard.Events#event:UP} for details.
 *
 * @event Vsengine.Input.Keyboard.Events#ANY_KEY_UP
 * @type {string}
 * @since 3.0.0
 *
