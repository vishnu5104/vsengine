 ...
 *
 * This event is dispatched by the Keyboard Plugin when a [Key Combo]{@link Vsengine.Input.Keyboard.KeyCombo} is matched.
 *
 ...
 * ```
 *
 * @event Vsengine.Input.Keyboard.Events#COMBO_MATCH
 * @type {string}
 * @since 3.0.0
 *
 * @param {Vsengine.Input.Keyboard.KeyCombo} keycombo - The Key Combo object that was matched.
