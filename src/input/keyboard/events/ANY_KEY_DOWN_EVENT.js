 ...
 *
 * You can also listen for a specific key being pressed. See [Keyboard.Events.KEY_DOWN]{@linkcode Vsengine.Input.Keyboard.Events#event:KEY_DOWN} for details.
 *
 ...
 *
 * @event Vsengine.Input.Keyboard.Events#ANY_KEY_DOWN
 * @type {string}
 * @since 3.0.0
 *
