 ...
 * name with any valid [Key Code string]{@link Vsengine.Input.Keyboard.KeyCodes}. For example, this will listen for the space bar:
 * `this.input.keyboard.on('keydown-SPACE', listener)`.
 *
 * You can also create a generic 'global' listener. See [Keyboard.Events.ANY_KEY_DOWN]{@linkcode Vsengine.Input.Keyboard.Events#event:ANY_KEY_DOWN} for details.
 *
 * Finally, you can create Key objects, which you can also listen for events from. See [Keyboard.Events.DOWN]{@linkcode Vsengine.Input.Keyboard.Events#event:DOWN} for details.
 *
 ...
 *
 * Also, please be aware that some browser extensions can disable or override Vsengine keyboard handling.
 ...
 *
 * @event Vsengine.Input.Keyboard.Events#KEY_DOWN
 * @type {string}
 * @since 3.0.0
 *
