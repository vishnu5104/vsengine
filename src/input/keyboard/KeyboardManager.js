...
var KeyboardManager = new Class({
    initialize: function KeyboardManager(inputManager) {
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyboardManager#manager
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyboardManager#queue
         * @type {KeyboardEvent[]}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyboardManager#preventDefault
         * @type {boolean}
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyboardManager#captures
         * @type {number[]}
         * @since 3.16.0
         */
        this.captures = [];
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyboardManager#enabled
         * @type {boolean}
         * @default false
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyboardManager#target
         * @type {any}
         * @since 3.16.0
         */
        this.target;
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyboardManager#onKeyDown
         * @type {function}
         * @since 3.16.00
         */
        this.onKeyDown = NOOP;
         ...
         * Initially empty and bound in the `startListeners` method.
         *
         * @name Vsengine.Input.Keyboard.KeyboardManager#onKeyUp
         * @type {function}
         * @since 3.16.00
         */
        this.onKeyUp = NOOP;
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardManager#boot
     * @private
     * @since 3.16.0
     */
    boot: function () {
        ...
        this.manager.game.events.on(
            GameEvents.POST_STEP,
            this.postUpdate,
            this
        );
    },
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardManager#startListeners
     * @since 3.16.0
     */
     ...
     * This is called automatically and does not need to be manually invoked.
     *
     * @method Vsengine.Input.Keyboard.KeyboardManager#stopListeners
     * @since 3.16.0
     */
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardManager#postUpdate
     * @private
     * @since 3.16.0
     */
    postUpdate: function () {
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardManager#addCapture
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardManager#removeCapture
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardManager#clearCaptures
     * @since 3.16.0
     */
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardManager#destroy
     * @since 3.16.0
     */
    destroy: function () {
        this.stopListeners();
        ...
        this.manager.game.events.off(
            GameEvents.POST_RENDER,
            this.postUpdate,
            this
        );
