 ...
 *
 * Also please be aware that certain browser extensions can disable or override Vsengine keyboard handling.
 * For example the Chrome extension vimium is known to disable Vsengine from using the D key, while EverNote disables the backtick key.
 * And there are others. So, please check your extensions before opening Vsengine issues about keys that don't work.
 *
 * @class KeyboardPlugin
 * @extends Vsengine.Events.EventEmitter
 * @memberof Vsengine.Input.Keyboard
 * @constructor
 * @since 3.10.0
 *
 * @param {Vsengine.Input.InputPlugin} sceneInputPlugin - A reference to the Scene Input Plugin that the KeyboardPlugin belongs to.
 */
var KeyboardPlugin = new Class({
    ...
    initialize: function KeyboardPlugin(sceneInputPlugin) {
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyboardPlugin#game
         * @type {Vsengine.Game}
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyboardPlugin#scene
         * @type {Vsengine.Scene}
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyboardPlugin#settings
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyboardPlugin#sceneInputPlugin
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyboardPlugin#manager
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyboardPlugin#enabled
         * @type {boolean}
         * @default true
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyboardPlugin#keys
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyboardPlugin#combos
         * @type {Vsengine.Input.Keyboard.KeyCombo[]}
         * @since 3.10.0
         */
        this.combos = [];
         ...
         *
         * @name Vsengine.Input.Keyboard.KeyboardPlugin#prevCode
         * @type {string}
         * @private
         * @since 3.50.0
         */
         ...
         * Internal repeat key flag.
         *
         * @name Vsengine.Input.Keyboard.KeyboardPlugin#prevTime
         * @type {number}
         * @private
         * @since 3.50.0
         */
         ...
         * Internal repeat key flag.
         *
         * @name Vsengine.Input.Keyboard.KeyboardPlugin#prevType
         * @type {string}
         * @private
         * @since 3.50.1
         */
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#boot
     * @private
     * @since 3.10.0
     */
    boot: function () {
     ...
     * Do not invoke it directly.
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#start
     * @private
     * @since 3.10.0
     */
    start: function () {
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#isActive
     * @since 3.10.0
     *
    ...
    /**
     * By default when a key is pressed Vsengine will not stop the event from propagating up to the browser.
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#addCapture
     * @since 3.16.0
     *
     ...
     * You can also provide an array mixing both strings and key code integers.
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#removeCapture
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#getCaptures
     * @since 3.16.0
     *
    ...
    /**
     * Allows Vsengine to prevent any key captures you may have defined from bubbling up the browser.
     * You can use this to re-enable event capturing if you had paused it via `disableGlobalCapture`.
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#enableGlobalCapture
     * @since 3.16.0
     *
     * @return {this} This KeyboardPlugin object.
     */
    ...
    /**
     * Disables Vsengine from preventing any key captures you may have defined, without actually removing them.
     * You can use this to temporarily disable event capturing if, for example, you swap to a DOM element.
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#disableGlobalCapture
     * @since 3.16.0
     *
     * @return {this} This KeyboardPlugin object.
     */
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#clearCaptures
     * @since 3.16.0
     *
     * @return {this} This KeyboardPlugin object.
     */
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#createCursorKeys
     * @since 3.10.0
     *
     * @return {Vsengine.Types.Input.Keyboard.CursorKeys} An object containing the properties: `up`, `down`, `left`, `right`, `space` and `shift`.
     */
     ...
     *
     * ```javascript
     * this.input.keyboard.addKeys({ 'up': Vsengine.Input.Keyboard.KeyCodes.W, 'down': Vsengine.Input.Keyboard.KeyCodes.S });
     * ```
     *
     * would return an object containing the properties (`up` and `down`) mapped to W and S {@link Vsengine.Input.Keyboard.Key} objects.
     *
     ...
     * To use non-alpha numeric keys, use a string, such as 'UP', 'SPACE' or 'LEFT'.
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#addKeys
     * @since 3.10.0
     *
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#addKey
     * @since 3.10.0
     *
     * @param {(Vsengine.Input.Keyboard.Key|string|number)} key - Either a Key object, a string, such as `A` or `SPACE`, or a key code value.
     * @param {boolean} [enableCapture=true] - Automatically call `preventDefault` on the native DOM browser event for the key codes being added.
     * @param {boolean} [emitOnRepeat=false] - Controls if the Key will continuously emit a 'down' event while being held down (true), or emit the event just once (false, the default).
     *
     * @return {Vsengine.Input.Keyboard.Key} The newly created Key object, or a reference to it if it already existed in the keys array.
     */
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#removeKey
     * @since 3.10.0
     *
     * @param {(Vsengine.Input.Keyboard.Key|string|number)} key - Either a Key object, a string, such as `A` or `SPACE`, or a key code value.
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#removeAllKeys
     * @since 3.24.0
     *
     ...
     * ```
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#createCombo
     * @since 3.10.0
     *
     * @param {(string|number[]|object[])} keys - The keys that comprise this combo.
     * @param {Vsengine.Types.Input.Keyboard.KeyComboConfig} [config] - A Key Combo configuration object.
     *
     * @return {Vsengine.Input.Keyboard.KeyCombo} The new KeyCombo object.
     */
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#checkDown
     * @since 3.11.0
     *
     * @param {Vsengine.Input.Keyboard.Key} key - A Key object.
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#update
     * @private
     * @since 3.10.0
     */
    update: function () {
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#resetKeys
     * @since 3.15.0
     *
     * @return {this} This KeyboardPlugin object.
     */
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#shutdown
     * @private
     * @since 3.10.0
     */
    shutdown: function () {
     ...
     *
     * @method Vsengine.Input.Keyboard.KeyboardPlugin#destroy
     * @private
     * @since 3.10.0
     */
    destroy: function () {
     ...
     * Internal time value.
     *
     * @name Vsengine.Input.Keyboard.KeyboardPlugin#time
     * @type {number}
     * @private
     * @since 3.11.0
     */
 ...
 *
 * @name Vsengine.Input.InputPlugin#keyboard
 * @type {?Vsengine.Input.Keyboard.KeyboardPlugin}
 * @since 3.10.0
 */
