...
/**
 * @classdesc
 * A Pointer object encapsulates both mouse and touch input within Vsengine.
 *
 * By default, Vsengine will create 2 pointers for your game to use. If you require more, i.e. for a multi-touch
 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Input.InputManager} manager - A reference to the Input Manager.
...
var Pointer = new Class({
    initialize: function Pointer(manager, id) {
         ...
         *
         * @name Vsengine.Input.Pointer#manager
         ...
         *
         * @name Vsengine.Input.Pointer#id
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#event
         ...
         * In a default set-up this will be the Canvas that Vsengine is rendering to, or the Window element.
         *
         * @name Vsengine.Input.Pointer#downElement
         * @type {any}
         * @readonly
         * @since 3.16.0
         */
         ...
         * In a default set-up this will be the Canvas that Vsengine is rendering to, or the Window element.
         *
         * @name Vsengine.Input.Pointer#upElement
         * @type {any}
         * @readonly
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#camera
         ...
         *
         * @name Vsengine.Input.Pointer#button
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.18.0
         ...
         *
         * @name Vsengine.Input.Pointer#buttons
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#position
         ...
         *
         * @name Vsengine.Input.Pointer#prevPosition
         * @type {Vsengine.Math.Vector2}
         * @readonly
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#midPoint
         * @type {Vsengine.Math.Vector2}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#velocity
         * @type {Vsengine.Math.Vector2}
         * @readonly
         * @since 3.16.0
         */
         ...
         * it changes based on movement alone - a button doesn't have to be pressed first.
         *
         * @name Vsengine.Input.Pointer#angle
         * @type {number}
         * @readonly
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#distance
         * @type {number}
         * @readonly
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#smoothFactor
         * @type {number}
         * @default 0
         * @since 3.16.0
         */
         ...
         * zero.
         *
         * @name Vsengine.Input.Pointer#motionFactor
         * @type {number}
         * @default 0.2
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#worldX
         * @type {number}
         * @default 0
         * @since 3.10.0
         */
         ...
         * the `Pointer.updateWorldPoint` method.
         *
         * @name Vsengine.Input.Pointer#worldY
         * @type {number}
         * @default 0
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#moveTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#downX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#downY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#downTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#upX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#upY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#upTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#primaryDown
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#isDown
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#wasTouch
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#wasCanceled
         * @type {boolean}
         * @default false
         * @since 3.15.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#movementX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#movementY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#identifier
         * @type {number}
         * @since 3.10.0
         */
        this.identifier = 0;
         ...
         *
         * @name Vsengine.Input.Pointer#pointerId
         * @type {number}
         * @since 3.10.0
         */
        this.pointerId = null;
         ...
         *
         * @name Vsengine.Input.Pointer#active
         * @type {boolean}
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#locked
         * @readonly
         * @type {boolean}
         * @since 3.19.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#deltaX
         * @type {number}
         * @default 0
         * @since 3.18.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#deltaY
         * @type {number}
         * @default 0
         * @since 3.18.0
         */
         ...
         *
         * @name Vsengine.Input.Pointer#deltaZ
         * @type {number}
         * @default 0
         * @since 3.18.0
         */
     ...
     *
     * @method Vsengine.Input.Pointer#updateWorldPoint
     * @since 3.19.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#positionToCamera
     * @since 3.0.0
     *
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The Camera to use for the translation.
     * @param {(Vsengine.Math.Vector2|object)} [output] - A Vector2-like object in which to store the translated position.
     *
     * @return {(Vsengine.Math.Vector2|object)} A Vector2 containing the translated coordinates of this Pointer, based on the given camera.
     */
     ...
     *
     * @method Vsengine.Input.Pointer#updateMotion
     * @private
     * @since 3.16.0
     */
     ...
     *
     * @method Vsengine.Input.Pointer#up
     * @private
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#down
     * @private
     * @since 3.0.0
     *
     * @param {MouseEvent} event - The Mouse Event to process.
     ...
     *
     * @method Vsengine.Input.Pointer#move
     * @private
     * @since 3.0.0
     *
     * @param {MouseEvent} event - The Mouse Event to process.
    ...
    move: function (event) {
        ...
        if (this.locked) {
            //  Multiple DOM events may occur within one frame, but only one Vsengine event will fire
            this.movementX =
                event.movementX ||
                event.mozMovementX ||
     ...
     *
     * @method Vsengine.Input.Pointer#wheel
     * @private
     * @since 3.18.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#touchstart
     * @private
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#touchmove
     * @private
     * @since 3.0.0
     *
     * @param {Touch} touch - The Changed Touch from the Touch Event.
     ...
     *
     * @method Vsengine.Input.Pointer#touchend
     * @private
     * @since 3.0.0
     *
     * @param {Touch} touch - The Changed Touch from the Touch Event.
     ...
     *
     * @method Vsengine.Input.Pointer#touchcancel
     * @private
     * @since 3.15.0
     *
     * @param {Touch} touch - The Changed Touch from the Touch Event.
     ...
     *
     * @method Vsengine.Input.Pointer#noButtonDown
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#leftButtonDown
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#rightButtonDown
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#middleButtonDown
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#backButtonDown
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#forwardButtonDown
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#leftButtonReleased
     * @since 3.18.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#rightButtonReleased
     * @since 3.18.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#middleButtonReleased
     * @since 3.18.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#backButtonReleased
     * @since 3.18.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#forwardButtonReleased
     * @since 3.18.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#getDistance
     * @since 3.13.0
     *
     ...
     * the Pointer was when the button was released.
     *
     * @method Vsengine.Input.Pointer#getDistanceX
     * @since 3.16.0
     *
     ...
     * the Pointer was when the button was released.
     *
     * @method Vsengine.Input.Pointer#getDistanceY
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#getDuration
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#getAngle
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#getInterpolatedPosition
     * @since 3.11.0
     *
     ...
     *
     * @method Vsengine.Input.Pointer#reset
     * @since 3.60.0
     */
    reset: function () {
        this.event = null;
     ...
     *
     * @method Vsengine.Input.Pointer#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.camera = null;
     ...
     *
     * @name Vsengine.Input.Pointer#time
     * @type {number}
     * @readonly
     * @since 3.16.0
     */
