/**
 * @typedef {object} Vsengine.Types.Input.InteractiveObject
 * @since 3.0.0
 *
 * @property {Vsengine.GameObjects.GameObject} gameObject - The Game Object to which this Interactive Object is bound.
 ...
 * @property {?Vsengine.GameObjects.GameObject} target - An optional drop target for a draggable Interactive Object.
 * @property {Vsengine.Cameras.Scene2D.Camera} camera - The most recent Camera to be tested against this Interactive Object.
 * @property {any} hitArea - The hit area for this Interactive Object. Typically a geometry shape, like a Rectangle or Circle.
 * @property {Vsengine.Types.Input.HitAreaCallback} hitAreaCallback - The 'contains' check callback that the hit area shape will use for all hit tests.
 * @property {Vsengine.GameObjects.Shape} hitAreaDebug - If this Interactive Object has been enabled for debug, via `InputPlugin.enableDebug` then this property holds its debug shape.
