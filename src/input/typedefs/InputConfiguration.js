/**
 * @typedef {object} Vsengine.Types.Input.InputConfiguration
 * @since 3.0.0
 *
 ...
 * @property {Vsengine.Types.Input.HitAreaCallback} [hitAreaCallback] - The callback that determines if the pointer is within the Hit Area shape or not.
