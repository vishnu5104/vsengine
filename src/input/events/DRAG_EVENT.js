 ...
 *
 * To listen for this event from a _specific_ Game Object, use the [GAMEOBJECT_DRAG]{@linkcode Vsengine.Input.Events#event:GAMEOBJECT_DRAG} event instead.
 *
 * @event Vsengine.Input.Events#DRAG
 * @type {string}
 * @since 3.0.0
 *
