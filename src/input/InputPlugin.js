 ...
 * See the [Input Config object]{@linkcode Vsengine.Types.Core.InputConfig} for more details, including how to deal with Vsengine
 ...
 *
 * If you are using Vsengine within Angular, and use nglf or the router, to make the component in which the Vsengine game resides
 * change state (i.e. appear or disappear) then you'll need to notify the Scale Manager about this, as Angular will mess with
 * the DOM in a way in which Vsengine can't detect directly. Call `this.scale.updateBounds()` as part of your game init in order
 * to refresh the canvas DOM bounds values, which Vsengine uses for input point position calculations.
 *
 * @class InputPlugin
 * @extends Vsengine.Events.EventEmitter
 * @memberof Vsengine.Input
 * @constructor
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - A reference to the Scene that this Input Plugin is responsible for.
 */
var InputPlugin = new Class({
    ...
    initialize: function InputPlugin(scene) {
         ...
         *
         * @name Vsengine.Input.InputPlugin#scene
         * @type {Vsengine.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name Vsengine.Input.InputPlugin#systems
         ...
         *
         * @name Vsengine.Input.InputPlugin#settings
         ...
         *
         * @name Vsengine.Input.InputPlugin#manager
         ...
         *
         * @name Vsengine.Input.InputPlugin#pluginEvents
         ...
         *
         * @name Vsengine.Input.InputPlugin#enabled
         * @type {boolean}
         * @default true
         * @since 3.5.0
         */
         ...
         *
         * @name Vsengine.Input.InputPlugin#displayList
         ...
         *
         * @name Vsengine.Input.InputPlugin#cameras
         ...
         *
         * @name Vsengine.Input.InputPlugin#mouse
         * @type {?Vsengine.Input.Mouse.MouseManager}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.InputPlugin#topOnly
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.InputPlugin#pollRate
         * @type {number}
         * @default -1
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.InputPlugin#_pollTimer
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Input.InputPlugin#_eventContainer
         * @type {Vsengine.Types.Input.EventData}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.Input.InputPlugin#_eventData
         * @type {object}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.Input.InputPlugin#dragDistanceThreshold
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         * [setPollAlways]{@linkcode Vsengine.Input.InputPlugin#setPollAlways} or
         * [setPollRate]{@linkcode Vsengine.Input.InputPlugin#setPollRate}.
         *
         * @name Vsengine.Input.InputPlugin#dragTimeThreshold
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.InputPlugin#_temp
         * @type {array}
         * @private
         * @default []
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Input.InputPlugin#_tempZones
         * @type {array}
         * @private
         * @default []
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Input.InputPlugin#_list
         ...
         *
         * @name Vsengine.Input.InputPlugin#_pendingInsertion
         * @type {Vsengine.GameObjects.GameObject[]}
         * @private
         * @default []
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Input.InputPlugin#_pendingRemoval
         * @type {Vsengine.GameObjects.GameObject[]}
         * @private
         * @default []
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Input.InputPlugin#_draggable
         * @type {Vsengine.GameObjects.GameObject[]}
         * @private
         * @default []
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Input.InputPlugin#_drag
         ...
         *
         * @name Vsengine.Input.InputPlugin#_dragState
         * @type {number[]}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Input.InputPlugin#_over
         * @type {{0:Array,1:Array,2:Array,3:Array,4:Array,5:Array,6:Array,7:Array,8:Array,9:Array,10:Array}}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.InputPlugin#_validTypes
         * @type {string[]}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.InputPlugin#_updatedThisFrame
         * @type {boolean}
         * @private
         * @since 3.18.0
         */
     ...
     *
     * @method Vsengine.Input.InputPlugin#boot
     * @fires Vsengine.Input.Events#BOOT
     * @private
     * @since 3.5.1
     */
    boot: function () {
     ...
     * Do not invoke it directly.
     *
     * @method Vsengine.Input.InputPlugin#start
     * @fires Vsengine.Input.Events#START
     * @private
     * @since 3.5.0
     */
    start: function () {
     ...
     * Game Over handler.
     *
     * @method Vsengine.Input.InputPlugin#onGameOver
     * @fires Vsengine.Input.Events#GAME_OVER
     * @private
     * @since 3.16.2
     */
     ...
     * Game Out handler.
     *
     * @method Vsengine.Input.InputPlugin#onGameOut
     * @fires Vsengine.Input.Events#GAME_OUT
     * @private
     * @since 3.16.2
     */
     ...
     *
     * @method Vsengine.Input.InputPlugin#preUpdate
     * @private
     * @fires Vsengine.Input.Events#PRE_UPDATE
     * @since 3.0.0
     */
    preUpdate: function () {
        //  Registered input plugins listen for this
     ...
     *
     * @method Vsengine.Input.InputPlugin#isActive
     * @since 3.10.0
     *
     ...
     *
     * @method Vsengine.Input.InputPlugin#setCursor
     * @since 3.85.0
     *
     * @param {Vsengine.Types.Input.InteractiveObject} interactiveObject - The Interactive Object that will set the cursor on the canvas.
     */
     ...
     *
     * @method Vsengine.Input.InputPlugin#resetCursor
     * @since 3.85.0
     */
     ...
     *
     * @method Vsengine.Input.InputPlugin#updatePoll
     * @since 3.18.0
     *
     ...
     *
     * @method Vsengine.Input.InputPlugin#update
     * @private
     * @fires Vsengine.Input.Events#UPDATE
     * @since 3.0.0
     *
     * @param {number} type - The type of event to process.
     * @param {Vsengine.Input.Pointer[]} pointers - An array of Pointers on which the event occurred.
     *
     ...
     *
     * @method Vsengine.Input.InputPlugin#clear
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - The Game Object that will have its Interactive Object removed.
     * @param {boolean} [skipQueue=false] - Skip adding this Game Object into the removal queue?
     *
     * @return {Vsengine.GameObjects.GameObject} The Game Object that had its Interactive Object removed.
     */
     ...
     *
     * @method Vsengine.Input.InputPlugin#disable
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - The Game Object to have its input system disabled.
     ...
     *
     * @method Vsengine.Input.InputPlugin#enable
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - The Game Object to be enabled for input.
     * @param {(Vsengine.Types.Input.InputConfiguration|any)} [hitArea] - Either an input configuration object, or a geometric shape that defines the hit area for the Game Object. If not specified a Rectangle will be used.
     * @param {Vsengine.Types.Input.HitAreaCallback} [hitAreaCallback] - The 'contains' function to invoke to check if the pointer is within the hit area.
     ...
     *
     * @method Vsengine.Input.InputPlugin#hitTestPointer
     * @since 3.0.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The Pointer to check against the Game Objects.
     *
     * @return {Vsengine.GameObjects.GameObject[]} An array of all the interactive Game Objects the Pointer was above.
     */
     ...
     *
     * @method Vsengine.Input.InputPlugin#processDownEvents
     * @private
     * @fires Vsengine.Input.Events#GAMEOBJECT_POINTER_DOWN
     * @fires Vsengine.Input.Events#GAMEOBJECT_DOWN
     * @fires Vsengine.Input.Events#POINTER_DOWN
     * @fires Vsengine.Input.Events#POINTER_DOWN_OUTSIDE
     * @since 3.0.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The Pointer being tested.
     *
     ...
     *
     * @method Vsengine.Input.InputPlugin#getDragState
     * @since 3.16.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The Pointer to get the drag state for.
     *
     ...
     * 5 = Pointer actively dragging but has been released, notify draglist
     *
     * @method Vsengine.Input.InputPlugin#setDragState
     * @since 3.16.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The Pointer to set the drag state for.
     ...
     * or time threshold.
     *
     * @method Vsengine.Input.InputPlugin#processDragThresholdEvent
     * @private
     * @since 3.18.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The Pointer to check the drag thresholds on.
    ...
    processDragThresholdEvent: function (pointer, time) {
        ...
        if (
            ...
            timeThreshold > 0 &&
            time >= pointer.downTime + timeThreshold
        ) {
     ...
     *
     * @method Vsengine.Input.InputPlugin#processDragStartList
     * @private
     * @fires Vsengine.Input.Events#DRAG_START
     * @fires Vsengine.Input.Events#GAMEOBJECT_DRAG_START
     * @since 3.18.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The Pointer to process the drag event on.
     *
     ...
     *
     * @method Vsengine.Input.InputPlugin#processDragDownEvent
     * @private
     * @since 3.18.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The Pointer to process the drag event on.
     ...
     *
     * @method Vsengine.Input.InputPlugin#processDragMoveEvent
     * @private
     * @fires Vsengine.Input.Events#DRAG_ENTER
     * @fires Vsengine.Input.Events#DRAG
     * @fires Vsengine.Input.Events#DRAG_LEAVE
     * @fires Vsengine.Input.Events#DRAG_OVER
     * @fires Vsengine.Input.Events#GAMEOBJECT_DRAG_ENTER
     * @fires Vsengine.Input.Events#GAMEOBJECT_DRAG
     * @fires Vsengine.Input.Events#GAMEOBJECT_DRAG_LEAVE
     * @fires Vsengine.Input.Events#GAMEOBJECT_DRAG_OVER
     * @since 3.18.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The Pointer to process the drag event on.
     *
     ...
     * and prepares them all for interaction.
     *
     * @method Vsengine.Input.InputPlugin#processDragUpEvent
     * @fires Vsengine.Input.Events#DRAG_END
     * @fires Vsengine.Input.Events#DROP
     * @fires Vsengine.Input.Events#GAMEOBJECT_DRAG_END
     * @fires Vsengine.Input.Events#GAMEOBJECT_DROP
     * @private
     * @since 3.18.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The Pointer to process the drag event on.
     ...
     *
     * @method Vsengine.Input.InputPlugin#processMoveEvents
     * @private
     * @fires Vsengine.Input.Events#GAMEOBJECT_POINTER_MOVE
     * @fires Vsengine.Input.Events#GAMEOBJECT_MOVE
     * @fires Vsengine.Input.Events#POINTER_MOVE
     * @since 3.0.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The pointer to check for events against.
     *
     * @return {number} The total number of objects interacted with.
     */
     ...
     *
     * @method Vsengine.Input.InputPlugin#processWheelEvent
     * @private
     * @fires Vsengine.Input.Events#GAMEOBJECT_POINTER_WHEEL
     * @fires Vsengine.Input.Events#GAMEOBJECT_WHEEL
     * @fires Vsengine.Input.Events#POINTER_WHEEL
     * @since 3.18.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The pointer to check for events against.
     *
     ...
     *
     * @method Vsengine.Input.InputPlugin#processOverEvents
     * @private
     * @fires Vsengine.Input.Events#GAMEOBJECT_POINTER_OVER
     * @fires Vsengine.Input.Events#GAMEOBJECT_OVER
     * @fires Vsengine.Input.Events#POINTER_OVER
     * @since 3.18.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The pointer to check for events against.
     *
     ...
     *
     * @method Vsengine.Input.InputPlugin#processOutEvents
     * @private
     * @fires Vsengine.Input.Events#GAMEOBJECT_POINTER_OUT
     * @fires Vsengine.Input.Events#GAMEOBJECT_OUT
     * @fires Vsengine.Input.Events#POINTER_OUT
     * @since 3.18.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The pointer to check for events against.
     *
     ...
     *
     * @method Vsengine.Input.InputPlugin#processOverOutEvents
     * @private
     * @fires Vsengine.Input.Events#GAMEOBJECT_POINTER_OVER
     * @fires Vsengine.Input.Events#GAMEOBJECT_OVER
     * @fires Vsengine.Input.Events#POINTER_OVER
     ...
     *
     * @method Vsengine.Input.InputPlugin#processUpEvents
     * @private
     * @fires Vsengine.Input.Events#GAMEOBJECT_POINTER_UP
     * @fires Vsengine.Input.Events#GAMEOBJECT_UP
     * @fires Vsengine.Input.Events#POINTER_UP
     * @fires Vsengine.Input.Events#POINTER_UP_OUTSIDE
     * @since 3.0.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The pointer to check for events against.
     *
     ...
     *
     * @method Vsengine.Input.InputPlugin#forceDownState
     * @fires Vsengine.Input.Events#GAMEOBJECT_POINTER_DOWN
     * @fires Vsengine.Input.Events#GAMEOBJECT_DOWN
     * @since 3.85.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The pointer to use when setting the state.
     * @param {Vsengine.GameObjects.GameObject} gameObject - The Game Object to have its state set.
     */
     ...
     * that is up to you to do before calling this method.
     *
     * @method Vsengine.Input.InputPlugin#forceUpState
     * @fires Vsengine.Input.Events#GAMEOBJECT_POINTER_UP
     * @fires Vsengine.Input.Events#GAMEOBJECT_UP
     * @since 3.85.0
     *
     ...
     * that is up to you to do before calling this method.
     *
     * @method Vsengine.Input.InputPlugin#forceOverState
     * @fires Vsengine.Input.Events#GAMEOBJECT_POINTER_OVER
     * @fires Vsengine.Input.Events#GAMEOBJECT_OVER
     * @since 3.85.0
     *
     ...
     * that is up to you to do before calling this method.
     *
     * @method Vsengine.Input.InputPlugin#forceOutState
     * @fires Vsengine.Input.Events#GAMEOBJECT_POINTER_OUT
     * @fires Vsengine.Input.Events#GAMEOBJECT_OUT
     * @since 3.85.0
     *
     ...
     *
     * @method Vsengine.Input.InputPlugin#forceState
     * @since 3.85.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The pointer to use when setting the state.
     * @param {Vsengine.GameObjects.GameObject} gameObject - The Game Object to have its state set.
     ...
     *
     * @method Vsengine.Input.InputPlugin#queueForInsertion
     * @private
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} child - The Game Object to add.
     *
     ...
     *
     * @method Vsengine.Input.InputPlugin#queueForRemoval
     * @private
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} child - The Game Object to remove.
     *
     * @return {this} This InputPlugin object.
     */
     ...
     *
     * @method Vsengine.Input.InputPlugin#setDraggable
     * @since 3.0.0
     *
     * @param {(Vsengine.GameObjects.GameObject|Vsengine.GameObjects.GameObject[])} gameObjects - An array of Game Objects to change the draggable state on.
     ...
     *
     * @method Vsengine.Input.InputPlugin#makePixelPerfect
     * @since 3.10.0
     *
     ...
     *
     * A hit area is typically one of the geometric shapes Vsengine provides, such as a `Vsengine.Geom.Rectangle`
     * or `Vsengine.Geom.Circle`. However, it can be any object as long as it works with the provided callback.
     *
     * If no hit area is provided a Rectangle is created based on the size of the Game Object, if possible
     * to calculate.
     *
     * The hit area callback is the function that takes an `x` and `y` coordinate and returns a boolean if
     * those values fall within the area of the shape or not. All of the Vsengine geometry objects provide this,
     * such as `Vsengine.Geom.Rectangle.Contains`.
     *
     * A hit area callback can be supplied to the `hitArea` parameter without using the `hitAreaCallback` parameter.
     *
     * @method Vsengine.Input.InputPlugin#setHitArea
     * @since 3.0.0
     *
     * @param {(Vsengine.GameObjects.GameObject|Vsengine.GameObjects.GameObject[])} gameObjects - An array of Game Objects to set the hit area on.
     * @param {(Vsengine.Types.Input.InputConfiguration|Vsengine.Types.Input.HitAreaCallback|any)} [hitArea] - Either an input configuration object, a geometric shape that defines the hit area or a hit area callback. If not specified a Rectangle hit area will be used.
     * @param {Vsengine.Types.Input.HitAreaCallback} [hitAreaCallback] - The 'contains' function to invoke to check if the pointer is within the hit area.
     *
     * @return {this} This InputPlugin object.
     */
    ...
    /**
     * Sets the hit area for an array of Game Objects to be a `Vsengine.Geom.Circle` shape, using
     * the given coordinates and radius to control its position and size.
     *
     * @method Vsengine.Input.InputPlugin#setHitAreaCircle
     * @since 3.0.0
     *
     * @param {(Vsengine.GameObjects.GameObject|Vsengine.GameObjects.GameObject[])} gameObjects - An array of Game Objects to set as having a circle hit area.
     * @param {number} x - The center of the circle.
     * @param {number} y - The center of the circle.
     * @param {number} radius - The radius of the circle.
     * @param {Vsengine.Types.Input.HitAreaCallback} [callback] - The hit area callback. If undefined it uses Circle.Contains.
     *
     * @return {this} This InputPlugin object.
     */
    ...
    /**
     * Sets the hit area for an array of Game Objects to be a `Vsengine.Geom.Ellipse` shape, using
     * the given coordinates and dimensions to control its position and size.
     *
     * @method Vsengine.Input.InputPlugin#setHitAreaEllipse
     * @since 3.0.0
     *
     * @param {(Vsengine.GameObjects.GameObject|Vsengine.GameObjects.GameObject[])} gameObjects - An array of Game Objects to set as having an ellipse hit area.
     * @param {number} x - The center of the ellipse.
     * @param {number} y - The center of the ellipse.
     * @param {number} width - The width of the ellipse.
     * @param {number} height - The height of the ellipse.
     * @param {Vsengine.Types.Input.HitAreaCallback} [callback] - The hit area callback. If undefined it uses Ellipse.Contains.
     *
     * @return {this} This InputPlugin object.
     */
    ...
    /**
     * Sets the hit area for an array of Game Objects to be a `Vsengine.Geom.Rectangle` shape, using
     * the Game Objects texture frame to define the position and size of the hit area.
     *
     * @method Vsengine.Input.InputPlugin#setHitAreaFromTexture
     * @since 3.0.0
     *
     * @param {(Vsengine.GameObjects.GameObject|Vsengine.GameObjects.GameObject[])} gameObjects - An array of Game Objects to set as having an ellipse hit area.
     * @param {Vsengine.Types.Input.HitAreaCallback} [callback] - The hit area callback. If undefined it uses Rectangle.Contains.
     *
     * @return {this} This InputPlugin object.
     */
     ...
     * the given coordinates and dimensions to control its position and size.
     *
     * @method Vsengine.Input.InputPlugin#setHitAreaRectangle
     * @since 3.0.0
     *
     * @param {(Vsengine.GameObjects.GameObject|Vsengine.GameObjects.GameObject[])} gameObjects - An array of Game Objects to set as having a rectangular hit area.
    ...
    /**
     * Sets the hit area for an array of Game Objects to be a `Vsengine.Geom.Triangle` shape, using
     * the given coordinates to control the position of its points.
     *
     * @method Vsengine.Input.InputPlugin#setHitAreaTriangle
     * @since 3.0.0
     *
     * @param {(Vsengine.GameObjects.GameObject|Vsengine.GameObjects.GameObject[])} gameObjects - An array of Game Objects to set as having a  triangular hit area.
     ...
     * @param {Vsengine.Types.Input.HitAreaCallback} [callback] - The hit area callback. If undefined it uses Triangle.Contains.
     *
     * @return {this} This InputPlugin object.
     */
    setHitAreaTriangle: function (
        gameObjects,
        x1,
        y1,
        x2,
     ...
     *
     * Debug Shapes can only be created for Game Objects that are using standard Vsengine Geometry for input,
     ...
     * doesn't extend one of the base Vsengine Geometry objects, as your hit area, then this method will not
     * work.
     *
     * @method Vsengine.Input.InputPlugin#enableDebug
     * @since 3.19.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - The Game Object to create the input debug shape for.
     ...
     *
     * @method Vsengine.Input.InputPlugin#removeDebug
     * @since 3.19.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - The Game Object to remove the input debug shape from.
     *
     * @return {this} This Input Plugin.
     */
     ...
     *
     * @method Vsengine.Input.InputPlugin#setPollAlways
     * @since 3.0.0
     *
     * @return {this} This InputPlugin object.
     */
     ...
     *
     * @method Vsengine.Input.InputPlugin#setPollOnMove
     * @since 3.0.0
     *
     * @return {this} This InputPlugin object.
     */
     ...
     *
     * @method Vsengine.Input.InputPlugin#setPollRate
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Input.InputPlugin#setGlobalTopOnly
     * @since 3.0.0
     *
     ...
     * If set to `false` it will emit events from all Game Objects below a Pointer, not just the top one.
     *
     * @method Vsengine.Input.InputPlugin#setTopOnly
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Input.InputPlugin#sortGameObjects
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject[]} gameObjects - An array of Game Objects to be sorted.
     * @param {Vsengine.Input.Pointer} pointer - The Pointer to check against the Game Objects.
     *
     * @return {Vsengine.GameObjects.GameObject[]} The sorted array of Game Objects.
     */
     ...
     *
     * @method Vsengine.Input.InputPlugin#sortDropZones
     * @since 3.52.0
     *
     * @param {Vsengine.GameObjects.GameObject[]} gameObjects - An array of Game Objects to be sorted.
     *
     ...
     *
     * @method Vsengine.Input.InputPlugin#sortDropZoneHandler
     * @private
     * @since 3.52.0
     *
     * @param {Vsengine.GameObjects.GameObject} childA - The first Game Object to compare.
     * @param {Vsengine.GameObjects.GameObject} childB - The second Game Object to compare.
     *
    ...
    sortDropZoneHandler: function (childA, childB) {
        if (!childA.parentContainer && !childB.parentContainer) {
            ...
            return (
                this.displayList.getIndex(childB) -
     ...
     *
     * @method Vsengine.Input.InputPlugin#stopPropagation
     * @since 3.0.0
     *
     * @return {this} This InputPlugin object.
     */
     ...
     *
     * By default Vsengine creates 2 pointer objects: `mousePointer` and `pointer1`.
     *
     ...
     * via this method.
     *
     * @method Vsengine.Input.InputPlugin#addPointer
     * @since 3.10.0
     *
     * @param {number} [quantity=1] The number of new Pointers to create. A maximum of 10 is allowed in total.
     *
     * @return {Vsengine.Input.Pointer[]} An array containing all of the new Pointer objects that were created.
     */
     ...
     *
     * @method Vsengine.Input.InputPlugin#setDefaultCursor
     * @since 3.10.0
     *
     ...
     *
     * @method Vsengine.Input.InputPlugin#transitionIn
     * @private
     * @since 3.5.0
     */
     ...
     *
     * @method Vsengine.Input.InputPlugin#transitionComplete
     * @private
     * @since 3.5.0
     */
     ...
     *
     * @method Vsengine.Input.InputPlugin#transitionOut
     * @private
     * @since 3.5.0
     */
     ...
     *
     * @method Vsengine.Input.InputPlugin#shutdown
     * @fires Vsengine.Input.Events#SHUTDOWN
     * @private
     * @since 3.0.0
     */
    shutdown: function () {
     ...
     *
     * Use this function if you find that input has been stolen from Vsengine via a 3rd
     * party component, such as Vue, and you need to tell Vsengine to reset the Pointer states.
     *
     * @method Vsengine.Input.InputPlugin#resetPointers
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.Input.InputPlugin#destroy
     * @fires Vsengine.Input.Events#DESTROY
     * @private
     * @since 3.0.0
     */
    destroy: function () {
     ...
     *
     * @name Vsengine.Input.InputPlugin#x
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     * This is only safe to use if your game has just 1 non-transformed camera and doesn't use multi-touch.
     *
     * @name Vsengine.Input.InputPlugin#y
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Input.InputPlugin#isOver
     * @type {boolean}
     * @readonly
     * @since 3.16.0
     */
     ...
     *
     * @name Vsengine.Input.InputPlugin#mousePointer
     * @type {Vsengine.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
    mousePointer: {
     ...
     *
     * @name Vsengine.Input.InputPlugin#activePointer
     * @type {Vsengine.Input.Pointer}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Input.InputPlugin#pointer1
     * @type {Vsengine.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name Vsengine.Input.InputPlugin#pointer2
     * @type {Vsengine.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name Vsengine.Input.InputPlugin#pointer3
     * @type {Vsengine.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name Vsengine.Input.InputPlugin#pointer4
     * @type {Vsengine.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name Vsengine.Input.InputPlugin#pointer5
     * @type {Vsengine.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name Vsengine.Input.InputPlugin#pointer6
     * @type {Vsengine.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name Vsengine.Input.InputPlugin#pointer7
     * @type {Vsengine.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name Vsengine.Input.InputPlugin#pointer8
     * @type {Vsengine.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name Vsengine.Input.InputPlugin#pointer9
     * @type {Vsengine.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name Vsengine.Input.InputPlugin#pointer10
     * @type {Vsengine.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
