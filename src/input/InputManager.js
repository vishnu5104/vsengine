...
/**
 * @classdesc
 * The Input Manager is responsible for handling the pointer related systems in a single Vsengine Game instance.
 *
 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Game} game - The Game instance that owns the Input Manager.
...
var InputManager = new Class({
    initialize: function InputManager(game, config) {
         ...
         *
         * @name Vsengine.Input.InputManager#game
         * @type {Vsengine.Game}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.InputManager#scaleManager
         ...
         *
         * @name Vsengine.Input.InputManager#canvas
         ...
         *
         * @name Vsengine.Input.InputManager#config
         ...
         *
         * @name Vsengine.Input.InputManager#enabled
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.InputManager#events
         ...
         *
         * @name Vsengine.Input.InputManager#isOver
         * @type {boolean}
         * @readonly
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Input.InputManager#defaultCursor
         * @type {string}
         * @since 3.10.0
         */
        this.defaultCursor = "";
         ...
         *
         * @name Vsengine.Input.InputManager#keyboard
         * @type {?Vsengine.Input.Keyboard.KeyboardManager}
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Input.InputManager#mouse
         ...
         *
         * @name Vsengine.Input.InputManager#touch
         * @type {Vsengine.Input.Touch.TouchManager}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.InputManager#pointers
         ...
         *
         * @name Vsengine.Input.InputManager#pointersTotal
         * @type {number}
         * @readonly
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.InputManager#mousePointer
         * @type {?Vsengine.Input.Pointer}
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.InputManager#activePointer
         * @type {Vsengine.Input.Pointer}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.InputManager#globalTopOnly
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.InputManager#time
         * @type {number}
         * @readonly
         * @since 3.16.2
         */
         ...
         *
         * @name Vsengine.Input.InputManager#_tempPoint
         ...
         *
         * @name Vsengine.Input.InputManager#_tempHitTest
         * @type {array}
         * @private
         * @default []
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Input.InputManager#_tempMatrix
         ...
         * A re-cycled matrix used in hit test calculations.
         *
         * @name Vsengine.Input.InputManager#_tempMatrix2
         * @type {Vsengine.GameObjects.Components.TransformMatrix}
         * @private
         * @since 3.12.0
         */
         ...
         *
         * @name Vsengine.Input.InputManager#_tempSkip
         * @type {boolean}
         * @private
         * @since 3.18.0
         */
         ...
         *
         * @name Vsengine.Input.InputManager#mousePointerContainer
         * @type {Vsengine.Input.Pointer[]}
         * @private
         * @since 3.18.0
         */
     ...
     *
     * @method Vsengine.Input.InputManager#boot
     * @protected
     * @fires Vsengine.Input.Events#MANAGER_BOOT
     * @since 3.0.0
     */
    boot: function () {
        var game = this.game;
     ...
     *
     * @method Vsengine.Input.InputManager#setCanvasOver
     ...
     * Internal canvas state change, called automatically by the Mouse Manager.
     *
     * @method Vsengine.Input.InputManager#setCanvasOut
     ...
     *
     * @method Vsengine.Input.InputManager#preRender
     * @private
     * @since 3.18.0
     */
    preRender: function () {
     ...
     *
     * @method Vsengine.Input.InputManager#setDefaultCursor
     * @since 3.10.0
     *
     ...
     * https://developer.mozilla.org/en-US/docs/Web/CSS/cursor
     *
     * @method Vsengine.Input.InputManager#setCursor
     * @private
     * @since 3.10.0
     *
     * @param {Vsengine.Types.Input.InteractiveObject} interactiveObject - The Interactive Object that called this method.
     */
     ...
     *
     * @method Vsengine.Input.InputManager#resetCursor
     * @private
     * @since 3.10.0
     *
     * @param {Vsengine.Types.Input.InteractiveObject} interactiveObject - The Interactive Object that called this method. Pass `null` if you just want to set the force value.
     ...
     * via this method.
     *
     * @method Vsengine.Input.InputManager#addPointer
     * @since 3.10.0
     *
     ...
     *
     * @method Vsengine.Input.InputManager#updateInputPlugins
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Input.InputManager#onTouchStart
     * @private
     * @since 3.18.0
     *
     ...
     *
     * @method Vsengine.Input.InputManager#onTouchMove
     * @private
     * @since 3.18.0
     *
     * @param {TouchEvent} event - The native DOM Touch event.
    ...
    onTouchMove: function (event) {
        ...
        for (var c = 0; c < event.changedTouches.length; c++) {
            ...
            for (var i = 1; i < pointers.length; i++) {
                ...
                if (
                    pointer.active &&
                    pointer.identifier === changedTouch.identifier
                ) {
     ...
     *
     * @method Vsengine.Input.InputManager#onTouchEnd
     * @private
     * @since 3.18.0
     *
     * @param {TouchEvent} event - The native DOM Touch event.
     ...
     *
     * @method Vsengine.Input.InputManager#onTouchCancel
     * @private
     * @since 3.18.0
     *
     * @param {TouchEvent} event - The native DOM Touch event.
     ...
     *
     * @method Vsengine.Input.InputManager#onMouseDown
     * @private
     * @since 3.18.0
     *
     ...
     *
     * @method Vsengine.Input.InputManager#onMouseMove
     * @private
     * @since 3.18.0
     *
     * @param {MouseEvent} event - The native DOM Mouse event.
     ...
     *
     * @method Vsengine.Input.InputManager#onMouseUp
     * @private
     * @since 3.18.0
     *
     * @param {MouseEvent} event - The native DOM Mouse event.
     ...
     *
     * @method Vsengine.Input.InputManager#onMouseWheel
     * @private
     * @since 3.18.0
     *
     ...
     *
     * @method Vsengine.Input.InputManager#onPointerLockChange
     * @fires Vsengine.Input.Events#POINTERLOCK_CHANGE
     * @private
     * @since 3.19.0
     *
     * @param {MouseEvent} event - The native DOM Mouse event.
     ...
     *
     * @method Vsengine.Input.InputManager#inputCandidate
     * @private
     * @since 3.10.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - The Game Object to test.
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The Camera which is being tested against.
     *
     ...
     *
     * @method Vsengine.Input.InputManager#hitTest
     * @since 3.0.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The Pointer to test against.
     ...
     *
     * @method Vsengine.Input.InputManager#pointWithinHitArea
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - The interactive Game Object to check against.
     ...
     *
     * @method Vsengine.Input.InputManager#pointWithinInteractiveObject
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Input.InteractiveObject} object - The Interactive Object to check against.
     * @param {number} x - The translated x coordinate for the hit test.
     * @param {number} y - The translated y coordinate for the hit test.
     *
     * @return {boolean} `true` if the coordinates were inside the Game Objects hit area, otherwise `false`.
     ...
     *
     * @method Vsengine.Input.InputManager#transformPointer
     * @since 3.10.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The Pointer to transform the values for.
     ...
     *
     * @method Vsengine.Input.InputManager#destroy
     * @since 3.0.0
     */
    destroy: function () {
