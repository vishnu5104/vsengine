 ...
 *
 * You can also listen for an UP event from the Gamepad Plugin. See the [BUTTON_UP]{@linkcode Vsengine.Input.Gamepad.Events#event:BUTTON_UP} event for details.
 *
 * @event Vsengine.Input.Gamepad.Events#GAMEPAD_BUTTON_UP
 * @type {string}
 * @since 3.10.0
 *
