 ...
 *
 * You can also listen for a DOWN event from the Gamepad Plugin. See the [BUTTON_DOWN]{@linkcode Vsengine.Input.Gamepad.Events#event:BUTTON_DOWN} event for details.
 *
 * @event Vsengine.Input.Gamepad.Events#GAMEPAD_BUTTON_DOWN
 * @type {string}
 * @since 3.10.0
 *
