...
var GamepadPlugin = new Class({
    ...
    initialize: function GamepadPlugin(sceneInputPlugin) {
         ...
         *
         * @name Vsengine.Input.Gamepad.GamepadPlugin#scene
         * @type {Vsengine.Scene}
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.GamepadPlugin#settings
         ...
         *
         * @name Vsengine.Input.Gamepad.GamepadPlugin#sceneInputPlugin
         ...
         *
         * @name Vsengine.Input.Gamepad.GamepadPlugin#enabled
         * @type {boolean}
         * @default true
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.GamepadPlugin#target
         * @type {any}
         * @since 3.10.0
         */
        this.target;
         ...
         *
         * @name Vsengine.Input.Gamepad.GamepadPlugin#gamepads
         ...
         *
         * @name Vsengine.Input.Gamepad.GamepadPlugin#queue
         * @type {GamepadEvent[]}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.GamepadPlugin#onGamepadHandler
         * @type {function}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.GamepadPlugin#_pad1
         * @type {Vsengine.Input.Gamepad.Gamepad}
         * @private
         * @since 3.10.0
         */
         ...
         * Internal Gamepad reference.
         *
         * @name Vsengine.Input.Gamepad.GamepadPlugin#_pad2
         * @type {Vsengine.Input.Gamepad.Gamepad}
         * @private
         * @since 3.10.0
         */
         ...
         * Internal Gamepad reference.
         *
         * @name Vsengine.Input.Gamepad.GamepadPlugin#_pad3
         * @type {Vsengine.Input.Gamepad.Gamepad}
         * @private
         * @since 3.10.0
         */
         ...
         * Internal Gamepad reference.
         *
         * @name Vsengine.Input.Gamepad.GamepadPlugin#_pad4
         * @type {Vsengine.Input.Gamepad.Gamepad}
         * @private
         * @since 3.10.0
         */
     ...
     *
     * @method Vsengine.Input.Gamepad.GamepadPlugin#boot
     * @private
     * @since 3.10.0
     */
    boot: function () {
     ...
     * Do not invoke it directly.
     *
     * @method Vsengine.Input.Gamepad.GamepadPlugin#start
     * @private
     * @since 3.10.0
     */
    start: function () {
     ...
     *
     * @method Vsengine.Input.Gamepad.GamepadPlugin#isActive
     * @since 3.10.0
     *
     ...
     *
     * @method Vsengine.Input.Gamepad.GamepadPlugin#startListeners
     * @private
     * @since 3.10.0
     */
     ...
     * This is called automatically and does not need to be manually invoked.
     *
     * @method Vsengine.Input.Gamepad.GamepadPlugin#stopListeners
     * @private
     * @since 3.10.0
     */
     ...
     *
     * @method Vsengine.Input.Gamepad.GamepadPlugin#disconnectAll
     * @since 3.10.0
     */
     ...
     *
     * @method Vsengine.Input.Gamepad.GamepadPlugin#refreshPads
     * @private
     * @since 3.10.0
     */
     ...
     *
     * @method Vsengine.Input.Gamepad.GamepadPlugin#getAll
     * @since 3.10.0
     *
     * @return {Vsengine.Input.Gamepad.Gamepad[]} An array of all currently connected Gamepads.
     */
    getAll: function () {
        var out = [];
     ...
     *
     * @method Vsengine.Input.Gamepad.GamepadPlugin#getPad
     * @since 3.10.0
     *
     * @param {number} index - The index of the Gamepad to get.
     *
     * @return {Vsengine.Input.Gamepad.Gamepad} The Gamepad matching the given index, or undefined if none were found.
     */
     ...
     *
     * @method Vsengine.Input.Gamepad.GamepadPlugin#update
     * @private
     * @fires Vsengine.Input.Gamepad.Events#CONNECTED
     * @fires Vsengine.Input.Gamepad.Events#DISCONNECTED
     * @since 3.10.0
     */
    update: function () {
        if (!this.enabled) {
     ...
     *
     * @method Vsengine.Input.Gamepad.GamepadPlugin#shutdown
     * @private
     * @since 3.10.0
     */
    shutdown: function () {
     ...
     *
     * @method Vsengine.Input.Gamepad.GamepadPlugin#destroy
     * @private
     * @since 3.10.0
     */
    destroy: function () {
     ...
     *
     * @name Vsengine.Input.Gamepad.GamepadPlugin#total
     * @type {number}
     * @since 3.10.0
     */
    total: {
     ...
     *
     * @name Vsengine.Input.Gamepad.GamepadPlugin#pad1
     * @type {Vsengine.Input.Gamepad.Gamepad}
     * @since 3.10.0
     */
    pad1: {
     ...
     * is plugged in, but hasn't yet had any buttons pressed on it.
     *
     * @name Vsengine.Input.Gamepad.GamepadPlugin#pad2
     * @type {Vsengine.Input.Gamepad.Gamepad}
     * @since 3.10.0
     */
    pad2: {
     ...
     * is plugged in, but hasn't yet had any buttons pressed on it.
     *
     * @name Vsengine.Input.Gamepad.GamepadPlugin#pad3
     * @type {Vsengine.Input.Gamepad.Gamepad}
     * @since 3.10.0
     */
    pad3: {
     ...
     * is plugged in, but hasn't yet had any buttons pressed on it.
     *
     * @name Vsengine.Input.Gamepad.GamepadPlugin#pad4
     * @type {Vsengine.Input.Gamepad.Gamepad}
     * @since 3.10.0
     */
    pad4: {
 ...
 *
 * @name Vsengine.Input.InputPlugin#gamepad
