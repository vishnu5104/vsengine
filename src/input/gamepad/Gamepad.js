 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Input.Gamepad.GamepadPlugin} manager - A reference to the Gamepad Plugin.
 * @param {Vsengine.Types.Input.Gamepad.Pad} pad - The Gamepad object, as extracted from GamepadEvent.
 */
var Gamepad = new Class({
    ...
    initialize: function Gamepad(manager, pad) {
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#manager
         * @type {Vsengine.Input.Gamepad.GamepadPlugin}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#pad
         * @type {any}
         * @since 3.10.0
         */
        this.pad = pad;
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#id
         * @type {string}
         * @since 3.0.0
         */
        this.id = pad.id;
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#index
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#buttons
         * @type {Vsengine.Input.Gamepad.Button[]}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#axes
         * @type {Vsengine.Input.Gamepad.Axis[]}
         * @since 3.0.0
         */
        this.axes = axes;
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#vibration
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_LCLeft
         * @type {Vsengine.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_LCRight
         * @type {Vsengine.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_LCTop
         * @type {Vsengine.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_LCBottom
         * @type {Vsengine.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_RCLeft
         * @type {Vsengine.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_RCRight
         * @type {Vsengine.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_RCTop
         * @type {Vsengine.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_RCBottom
         * @type {Vsengine.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_FBLeftTop
         * @type {Vsengine.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_FBLeftBottom
         * @type {Vsengine.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_FBRightTop
         * @type {Vsengine.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_FBRightBottom
         * @type {Vsengine.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_HAxisLeft
         * @type {Vsengine.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_VAxisLeft
         * @type {Vsengine.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_HAxisRight
         * @type {Vsengine.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_VAxisRight
         * @type {Vsengine.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#leftStick
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#rightStick
         * @type {Vsengine.Math.Vector2}
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Input.Gamepad.Gamepad#_created
         * @type {number}
         * @private
         * @since 3.50.0
         */
     ...
     *
     * @method Vsengine.Input.Gamepad.Gamepad#getAxisTotal
     * @since 3.10.0
     *
     ...
     *
     * @method Vsengine.Input.Gamepad.Gamepad#getAxisValue
     * @since 3.10.0
     *
     ...
     *
     * @method Vsengine.Input.Gamepad.Gamepad#setAxisThreshold
     * @since 3.10.0
     *
     ...
     *
     * @method Vsengine.Input.Gamepad.Gamepad#getButtonTotal
     * @since 3.10.0
     *
     ...
     *
     * @method Vsengine.Input.Gamepad.Gamepad#getButtonValue
     * @since 3.10.0
     *
     ...
     * The index must be valid within the range of buttons supported by this Gamepad.
     *
     * @method Vsengine.Input.Gamepad.Gamepad#isButtonDown
     * @since 3.10.0
     *
     * @param {number} index - The index of the button to get the value for.
     *
     ...
     *
     * @method Vsengine.Input.Gamepad.Gamepad#update
     * @private
     * @since 3.0.0
     */
    update: function (pad) {
        ...
        if (len >= 2) {
            this.leftStick.set(
                localAxes[0].getValue(),
                localAxes[1].getValue()
            );

            if (len >= 4) {
                this.rightStick.set(
                    localAxes[2].getValue(),
                    localAxes[3].getValue()
                );
            }
        }
    },
     ...
     *
     * @method Vsengine.Input.Gamepad.Gamepad#destroy
     * @since 3.10.0
     */
    destroy: function () {
     ...
     *
     * @name Vsengine.Input.Gamepad.Gamepad#connected
     * @type {boolean}
     * @default true
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Input.Gamepad.Gamepad#timestamp
     * @type {number}
     * @since 3.0.0
     */
    timestamp: {
     ...
     *
     * @name Vsengine.Input.Gamepad.Gamepad#left
     * @type {boolean}
     * @since 3.10.0
     */
    left: {
     ...
     *
     * @name Vsengine.Input.Gamepad.Gamepad#right
     * @type {boolean}
     * @since 3.10.0
     */
    right: {
     ...
     *
     * @name Vsengine.Input.Gamepad.Gamepad#up
     * @type {boolean}
     * @since 3.10.0
     */
    up: {
     ...
     *
     * @name Vsengine.Input.Gamepad.Gamepad#down
     * @type {boolean}
     * @since 3.10.0
     */
    down: {
     ...
     *
     * @name Vsengine.Input.Gamepad.Gamepad#A
     * @type {boolean}
     * @since 3.10.0
     */
    A: {
     ...
     *
     * @name Vsengine.Input.Gamepad.Gamepad#Y
     * @type {boolean}
     * @since 3.10.0
     */
    Y: {
     ...
     *
     * @name Vsengine.Input.Gamepad.Gamepad#X
     * @type {boolean}
     * @since 3.10.0
     */
    X: {
     ...
     *
     * @name Vsengine.Input.Gamepad.Gamepad#B
     * @type {boolean}
     * @since 3.10.0
     */
    B: {
     ...
     *
     * @name Vsengine.Input.Gamepad.Gamepad#L1
     * @type {number}
     * @since 3.10.0
     */
    L1: {
     ...
     *
     * @name Vsengine.Input.Gamepad.Gamepad#L2
     * @type {number}
     * @since 3.10.0
     */
    L2: {
     ...
     *
     * @name Vsengine.Input.Gamepad.Gamepad#R1
     * @type {number}
     * @since 3.10.0
     */
    R1: {
     ...
     *
     * @name Vsengine.Input.Gamepad.Gamepad#R2
     * @type {number}
     * @since 3.10.0
     */
    R2: {
