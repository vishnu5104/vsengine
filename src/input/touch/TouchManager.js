...
var TouchManager = new Class({
    initialize: function TouchManager(inputManager) {
         ...
         *
         * @name Vsengine.Input.Touch.TouchManager#manager
         ...
         *
         * @name Vsengine.Input.Touch.TouchManager#capture
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Touch.TouchManager#enabled
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Input.Touch.TouchManager#target
         * @type {any}
         * @since 3.0.0
         */
        this.target;
         ...
         *
         * @name Vsengine.Input.Touch.TouchManager#onTouchStart
         * @type {function}
         * @since 3.0.0
         */
         ...
         * Initially empty and bound in the `startListeners` method.
         *
         * @name Vsengine.Input.Touch.TouchManager#onTouchStartWindow
         * @type {function}
         * @since 3.17.0
         */
         ...
         * Initially empty and bound in the `startListeners` method.
         *
         * @name Vsengine.Input.Touch.TouchManager#onTouchMove
         * @type {function}
         * @since 3.0.0
         */
         ...
         * Initially empty and bound in the `startListeners` method.
         *
         * @name Vsengine.Input.Touch.TouchManager#onTouchEnd
         * @type {function}
         * @since 3.0.0
         */
         ...
         * Initially empty and bound in the `startListeners` method.
         *
         * @name Vsengine.Input.Touch.TouchManager#onTouchEndWindow
         * @type {function}
         * @since 3.17.0
         */
         ...
         * Initially empty and bound in the `startListeners` method.
         *
         * @name Vsengine.Input.Touch.TouchManager#onTouchCancel
         * @type {function}
         * @since 3.15.0
         */
         ...
         * Initially empty and bound in the `startListeners` method.
         *
         * @name Vsengine.Input.Touch.TouchManager#onTouchCancelWindow
         * @type {function}
         * @since 3.18.0
         */
         ...
         *
         * @name Vsengine.Input.Touch.TouchManager#isTop
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
     ...
     *
     * @method Vsengine.Input.Touch.TouchManager#boot
     * @private
     * @since 3.0.0
     */
    boot: function () {
     ...
     *
     * @method Vsengine.Input.Touch.TouchManager#disableContextMenu
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.Input.Touch.TouchManager#startListeners
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Input.Touch.TouchManager#stopListeners
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Input.Touch.TouchManager#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.stopListeners();
