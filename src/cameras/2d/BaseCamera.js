 ...
 * A Base Camera class.
 *
 * The Camera is the way in which all games are rendered in Vsengine. They provide a view into your game world,
 ...
 *
 * The Base Camera was introduced in Vsengine 3.12. It was split off from the Camera class, to allow
 * you to isolate special effects as needed. Therefore the 'since' values for properties of this class relate
 * to when they were added to the Camera class.
 *
 * @class BaseCamera
 * @memberof Vsengine.Cameras.Scene2D
 * @constructor
 * @since 3.12.0
 *
...
var BaseCamera = new Class({
    ...
    Mixins: [Components.AlphaSingle, Components.Visible],
    ...
    initialize: function BaseCamera(x, y, width, height) {
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#scene
         * @type {Vsengine.Scene}
         * @since 3.0.0
         */
        this.scene;
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#sceneManager
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#scaleManager
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#cameraManager
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#id
         * @type {number}
         * @readonly
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#name
         * @type {string}
         * @default ''
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#roundPixels
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#visible
         * @type {boolean}
         * @default true
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#useBounds
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#worldView
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#dirty
         * @type {boolean}
         * @default true
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#_x
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#_y
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#_width
         * @type {number}
         * @private
         * @since 3.11.0
         */
         ...
         * not restrict where the Camera can scroll to.
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#_height
         * @type {number}
         * @private
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#_bounds
         * @type {Vsengine.Geom.Rectangle}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#_scrollX
         * @type {number}
         * @private
         * @default 0
         * @since 3.11.0
         ...
         * You can set the bounds within which the Camera can scroll via the `setBounds` method.
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#_scrollY
         * @type {number}
         * @private
         * @default 0
         * @since 3.11.0
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#_zoomX
         * @type {number}
         * @private
         * @default 1
         * @since 3.50.0
         ...
         * Be careful to never set this value to zero.
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#_zoomY
         * @type {number}
         * @private
         * @default 1
         * @since 3.50.0
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#_rotation
         * @type {number}
         * @private
         * @default 0
         * @since 3.11.0
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#matrix
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#transparent
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#backgroundColor
         * @type {Vsengine.Display.Color}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#alpha
         * @type {number}
         * @default 1
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#disableCull
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#culledObjects
         ...
         * have been processed.
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#midPoint
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#originX
         * @type {number}
         * @default 0.5
         * @since 3.11.0
         */
         ...
         * See `setOrigin` to set both origins in a single, chainable call.
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#originY
         * @type {number}
         * @default 0.5
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#_customViewport
         * @type {boolean}
         * @private
         * @default false
         * @since 3.12.0
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#mask
         ...
         * to itself.
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#_maskCamera
         * @type {?Vsengine.Cameras.Scene2D.BaseCamera}
         * @private
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#renderList
         * @type {Vsengine.GameObjects.GameObject[]}
         * @since 3.52.0
         */
        this.renderList = [];
         ...
         *
         * @name Vsengine.Cameras.Scene2D.BaseCamera#isSceneCamera
         * @type {boolean}
         * @default true
         * @since 3.60.0
         */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#addToRenderList
     * @since 3.52.0
     *
     * @param {Vsengine.GameObjects.GameObject} child - The Game Object to add to the render list.
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setAlpha
     * @since 3.11.0
     *
     ...
     * A value of 0 would rotate from the top-left of the viewport. A value of 1 from the bottom right.
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setOrigin
     * @since 3.11.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#getScroll
     * @since 3.11.0
     *
     * @param {number} x - The horizontal coordinate to center on.
     * @param {number} y - The vertical coordinate to center on.
     * @param {Vsengine.Math.Vector2} [out] - A Vector2 to store the values in. If not given a new Vector2 is created.
     *
     * @return {Vsengine.Math.Vector2} The scroll coordinates stored in the `x` and `y` properties.
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#centerOnX
     * @since 3.16.0
     *
     * @param {number} x - The horizontal coordinate to center on.
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#centerOnY
     * @since 3.16.0
     *
     * @param {number} y - The vertical coordinate to center on.
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#centerOn
     * @since 3.11.0
     *
     * @param {number} x - The horizontal coordinate to center on.
     * @param {number} y - The vertical coordinate to center on.
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#centerToBounds
     * @since 3.0.0
     *
     * @return {this} This Camera instance.
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#centerToSize
     * @since 3.0.0
     *
     * @return {this} This Camera instance.
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#cull
     * @since 3.0.0
     *
     * @generic {Vsengine.GameObjects.GameObject[]} G - [renderableObjects,$return]
     *
     * @param {Vsengine.GameObjects.GameObject[]} renderableObjects - An array of Game Objects to cull.
     *
     * @return {Vsengine.GameObjects.GameObject[]} An array of Game Objects visible to this Camera.
     */
    cull: function (renderableObjects) {
        ...
        for (var index = 0; index < length; ++index) {
            ...
            var tw =
                (objectX + objectW) * mva + (objectY + objectH) * mvc + mve;
            var th =
                (objectX + objectW) * mvb + (objectY + objectH) * mvd + mvf;
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#getWorldPoint
     * @since 3.0.0
     *
     * @generic {Vsengine.Math.Vector2} O - [output,$return]
     *
     * @param {number} x - The x position to convert to world space.
     * @param {number} y - The y position to convert to world space.
     * @param {(object|Vsengine.Math.Vector2)} [output] - An optional object to store the results in. If not provided a new Vector2 will be created.
     *
     * @return {Vsengine.Math.Vector2} An object holding the converted values in its `x` and `y` properties.
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#ignore
     * @since 3.0.0
     *
     * @param {(Vsengine.GameObjects.GameObject|Vsengine.GameObjects.GameObject[]|Vsengine.GameObjects.Group|Vsengine.GameObjects.Layer|Vsengine.GameObjects.Layer[])} entries - The Game Object, or array of Game Objects, to be ignored by this Camera.
     *
     * @return {this} This Camera instance.
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#clampX
     * @since 3.11.0
     *
     ...
     * Do not call this method if you are not using camera bounds.
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#clampY
     * @since 3.11.0
     *
    ...
    */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#removeBounds
     * @since 3.0.0
     *
     * @return {this} This Camera instance.
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setAngle
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setBackgroundColor
     * @since 3.0.0
     *
     * @param {(string|number|Vsengine.Types.Display.InputColorObject)} [color='rgba(0,0,0,0)'] - The color value. In CSS, hex or numeric color notation.
     *
     * @return {this} This Camera instance.
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setBounds
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#getBounds
     * @since 3.16.0
     *
     * @param {Vsengine.Geom.Rectangle} [out] - An optional Rectangle to store the bounds in. If not given, a new Rectangle will be created.
     *
     * @return {Vsengine.Geom.Rectangle} A rectangle containing the bounds of this Camera.
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setName
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setPosition
     * @since 3.0.0
     *
     ...
     * Rotating a camera does not rotate the viewport itself, it is applied during rendering.
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setRotation
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setRoundPixels
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setScene
     * @since 3.0.0
     *
     * @param {Vsengine.Scene} scene - The Scene the camera is bound to.
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setScroll
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setSize
     * @since 3.0.0
     *
     ...
     * viewport within your game.
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setViewport
     * @since 3.0.0
     *
     * @param {number} x - The top-left x coordinate of the Camera viewport.
     ...
     *
     * As of Vsengine 3.50 you can now set the horizontal and vertical zoom values independently.
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setZoom
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setMask
     * @since 3.17.0
     *
     * @param {(Vsengine.Display.Masks.BitmapMask|Vsengine.Display.Masks.GeometryMask)} mask - The mask this Camera will use when rendering.
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#clearMask
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setVisible
     * @since 3.10.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#toJSON
     * @since 3.0.0
     *
     * @return {Vsengine.Types.Cameras.Scene2D.JSONCamera} A well-formed object suitable for conversion to JSON.
     */
    toJSON: function () {
        var output = {
            name: this.name,
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#update
     * @protected
     * @since 3.0.0
     *
     ...
     * Camera.
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#setIsSceneCamera
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#updateSystem
     * @private
     * @since 3.12.0
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.BaseCamera#destroy
     * @fires Vsengine.Cameras.Scene2D.Events#DESTROY
     * @since 3.0.0
     */
    destroy: function () {
     ...
     * To adjust the position the camera is looking at in the game world, see the `scrollX` value.
     *
     * @name Vsengine.Cameras.Scene2D.BaseCamera#x
     * @type {number}
     * @since 3.0.0
     */
    x: {
     ...
     * To adjust the position the camera is looking at in the game world, see the `scrollY` value.
     *
     * @name Vsengine.Cameras.Scene2D.BaseCamera#y
     * @type {number}
     * @since 3.0.0
     */
    y: {
     ...
     * not restrict where the Camera can scroll to.
     *
     * @name Vsengine.Cameras.Scene2D.BaseCamera#width
     * @type {number}
     * @since 3.0.0
     */
    width: {
     ...
     * not restrict where the Camera can scroll to.
     *
     * @name Vsengine.Cameras.Scene2D.BaseCamera#height
     * @type {number}
     * @since 3.0.0
     */
    height: {
     ...
     * You can set the bounds within which the Camera can scroll via the `setBounds` method.
     *
     * @name Vsengine.Cameras.Scene2D.BaseCamera#scrollX
     * @type {number}
     * @default 0
     * @since 3.0.0
     */
     ...
     * You can set the bounds within which the Camera can scroll via the `setBounds` method.
     *
     * @name Vsengine.Cameras.Scene2D.BaseCamera#scrollY
     * @type {number}
     * @default 0
     * @since 3.0.0
     */
     ...
     * Be careful to never set this value to zero.
     *
     * @name Vsengine.Cameras.Scene2D.BaseCamera#zoom
     * @type {number}
     * @default 1
     * @since 3.0.0
     */
     ...
     * Be careful to never set this value to zero.
     *
     * @name Vsengine.Cameras.Scene2D.BaseCamera#zoomX
     * @type {number}
     * @default 1
     * @since 3.50.0
     */
     ...
     * Be careful to never set this value to zero.
     *
     * @name Vsengine.Cameras.Scene2D.BaseCamera#zoomY
     * @type {number}
     * @default 1
     * @since 3.50.0
     */
     ...
     * rotate the Camera viewport itself, which always remains an axis-aligned rectangle.
     *
     * @name Vsengine.Cameras.Scene2D.BaseCamera#rotation
     * @type {number}
     * @private
     * @default 0
     * @since 3.11.0
     ...
     *
     * @name Vsengine.Cameras.Scene2D.BaseCamera#centerX
     * @type {number}
     * @readonly
     * @since 3.10.0
     */
     ...
     *
     * @name Vsengine.Cameras.Scene2D.BaseCamera#centerY
     * @type {number}
     * @readonly
     * @since 3.10.0
     */
     ...
     * of 400 pixels.
     *
     * @name Vsengine.Cameras.Scene2D.BaseCamera#displayWidth
     * @type {number}
     * @readonly
     * @since 3.11.0
     */
     ...
     * of 300 pixels.
     *
     * @name Vsengine.Cameras.Scene2D.BaseCamera#displayHeight
     * @type {number}
     * @readonly
     * @since 3.11.0
     */
