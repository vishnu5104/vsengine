...
var RotateTo = new Class({
    initialize: function RotateTo(camera) {
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.RotateTo#camera
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.RotateTo#isRunning
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.23.0
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.RotateTo#duration
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.23.0
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.RotateTo#source
         * @type {number}
         * @since 3.23.0
         */
        this.source = 0;
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.RotateTo#current
         * @type {number}
         * @since 3.23.0
         */
        this.current = 0;
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.RotateTo#destination
         * @type {number}
         * @since 3.23.0
         */
        this.destination = 0;
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.RotateTo#ease
         * @type {function}
         * @since 3.23.0
         */
        this.ease;
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.RotateTo#progress
         * @type {number}
         * @since 3.23.0
         */
        this.progress = 0;
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.RotateTo#_elapsed
         * @type {number}
         * @private
         * @since 3.23.0
         */
         ...
         *
         * @param {Vsengine.Cameras.Scene2D.Camera} camera - The camera on which the effect is running.
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.RotateTo#_onUpdate
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.RotateTo#_onUpdateScope
         * @type {any}
         * @private
         * @since 3.23.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.RotateTo#clockwise
         * @type {boolean}
         * @since 3.23.0
         */
        this.clockwise = true;
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.RotateTo#shortestPath
         * @type {boolean}
         * @since 3.23.0
         */
     ...
     * over the duration and with the ease specified.
     *
     * @method Vsengine.Cameras.Scene2D.Effects.RotateTo#start
     * @fires Vsengine.Cameras.Scene2D.Events#ROTATE_START
     * @fires Vsengine.Cameras.Scene2D.Events#ROTATE_COMPLETE
     * @since 3.23.0
     *
     ...
     * @param {(string|function)} [ease='Linear'] - The ease to use for the Rotate. Can be any of the Vsengine Easing constants or a custom function.
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Effects.RotateTo#update
     * @since 3.23.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Effects.RotateTo#effectComplete
     * @since 3.23.0
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Effects.RotateTo#reset
     * @since 3.23.0
     */
    reset: function () {
        this.isRunning = false;
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Effects.RotateTo#destroy
     * @since 3.23.0
     */
    destroy: function () {
        this.reset();
