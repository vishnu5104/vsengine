...
var Pan = new Class({
    initialize: function Pan(camera) {
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.Pan#camera
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.Pan#isRunning
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.11.0
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.Pan#duration
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.11.0
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.Pan#source
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.Pan#current
         * @type {Vsengine.Math.Vector2}
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.Pan#destination
         * @type {Vsengine.Math.Vector2}
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.Pan#ease
         * @type {function}
         * @since 3.11.0
         */
        this.ease;
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.Pan#progress
         * @type {number}
         * @since 3.11.0
         */
        this.progress = 0;
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.Pan#_elapsed
         * @type {number}
         * @private
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.Pan#_onUpdate
         * @type {?Vsengine.Types.Cameras.Scene2D.CameraPanCallback}
         * @private
         * @default null
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Effects.Pan#_onUpdateScope
         * @type {any}
         * @private
         * @since 3.11.0
         */
     ...
     * over the duration and with the ease specified.
     *
     * @method Vsengine.Cameras.Scene2D.Effects.Pan#start
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Effects.Pan#update
     * @since 3.11.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Effects.Pan#effectComplete
     * @fires Vsengine.Cameras.Scene2D.Events#PAN_COMPLETE
     * @since 3.11.0
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Effects.Pan#reset
     * @since 3.11.0
     */
    reset: function () {
        this.isRunning = false;
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Effects.Pan#destroy
     * @since 3.11.0
     */
    destroy: function () {
        this.reset();
