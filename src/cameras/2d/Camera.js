 ...
 * @since 3.0.0
 *
 * @extends Vsengine.Cameras.Scene2D.BaseCamera
...
var Camera = new Class({
    ...
    Mixins: [Components.PostPipeline],
    ...
    initialize: function Camera(x, y, width, height) {
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Camera#inputEnabled
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Camera#fadeEffect
         * @type {Vsengine.Cameras.Scene2D.Effects.Fade}
         * @since 3.5.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Camera#flashEffect
         * @type {Vsengine.Cameras.Scene2D.Effects.Flash}
         * @since 3.5.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Camera#shakeEffect
         * @type {Vsengine.Cameras.Scene2D.Effects.Shake}
         * @since 3.5.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Camera#panEffect
         * @type {Vsengine.Cameras.Scene2D.Effects.Pan}
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Camera#rotateToEffect
         * @type {Vsengine.Cameras.Scene2D.Effects.RotateTo}
         * @since 3.23.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Camera#zoomEffect
         * @type {Vsengine.Cameras.Scene2D.Effects.Zoom}
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Camera#lerp
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Camera#followOffset
         * @type {Vsengine.Math.Vector2}
         * @since 3.9.0
         */
         ...
         * to `null`.
         *
         * @name Vsengine.Cameras.Scene2D.Camera#deadzone
         ...
         *
         * @name Vsengine.Cameras.Scene2D.Camera#_follow
         * @type {?any}
         * @private
         * @default null
         * @since 3.0.0
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Camera#setDeadzone
     * @since 3.11.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Camera#fadeIn
     * @fires Vsengine.Cameras.Scene2D.Events#FADE_IN_START
     * @fires Vsengine.Cameras.Scene2D.Events#FADE_IN_COMPLETE
     * @since 3.3.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Camera#fadeOut
     * @fires Vsengine.Cameras.Scene2D.Events#FADE_OUT_START
     * @fires Vsengine.Cameras.Scene2D.Events#FADE_OUT_COMPLETE
     * @since 3.3.0
     *
     * @param {number} [duration=1000] - The duration of the effect in milliseconds.
     * @param {number} [red=0] - The amount to fade the red channel towards. A value between 0 and 255.
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Camera#fadeFrom
     * @fires Vsengine.Cameras.Scene2D.Events#FADE_IN_START
     * @fires Vsengine.Cameras.Scene2D.Events#FADE_IN_COMPLETE
     * @since 3.5.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Camera#fade
     * @fires Vsengine.Cameras.Scene2D.Events#FADE_OUT_START
     * @fires Vsengine.Cameras.Scene2D.Events#FADE_OUT_COMPLETE
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Camera#flash
     * @fires Vsengine.Cameras.Scene2D.Events#FLASH_START
     * @fires Vsengine.Cameras.Scene2D.Events#FLASH_COMPLETE
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Camera#shake
     * @fires Vsengine.Cameras.Scene2D.Events#SHAKE_START
     * @fires Vsengine.Cameras.Scene2D.Events#SHAKE_COMPLETE
     * @since 3.0.0
     *
     * @param {number} [duration=100] - The duration of the effect in milliseconds.
     * @param {(number|Vsengine.Math.Vector2)} [intensity=0.05] - The intensity of the shake.
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Camera#pan
     * @fires Vsengine.Cameras.Scene2D.Events#PAN_START
     * @fires Vsengine.Cameras.Scene2D.Events#PAN_COMPLETE
     * @since 3.11.0
     *
     ...
     * @param {number} [duration=1000] - The duration of the effect in milliseconds.
     * @param {(string|function)} [ease='Linear'] - The ease to use for the pan. Can be any of the Vsengine Easing constants or a custom function.
     * @param {boolean} [force=false] - Force the pan effect to start immediately, even if already running.
     * @param {Vsengine.Types.Cameras.Scene2D.CameraPanCallback} [callback] - This callback will be invoked every frame for the duration of the effect.
     ...
     * over the duration and with the ease specified.
     *
     * @method Vsengine.Cameras.Scene2D.Camera#rotateTo
     * @since 3.23.0
     *
     ...
     * @param {number} [duration=1000] - The duration of the effect in milliseconds.
     * @param {(string|function)} [ease='Linear'] - The ease to use for the rotation. Can be any of the Vsengine Easing constants or a custom function.
     ...
     * @param {any} [context] - The context in which the callback is invoked. Defaults to the Scene to which the Camera belongs.
     *
     * @return {Vsengine.Cameras.Scene2D.Camera} This Camera instance.
     */
    rotateTo: function (
        radians,
        shortestPath,
        ...
        return this.rotateToEffect.start(
            radians,
            shortestPath,
            duration,
            ease,
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Camera#zoomTo
     * @fires Vsengine.Cameras.Scene2D.Events#ZOOM_START
     * @fires Vsengine.Cameras.Scene2D.Events#ZOOM_COMPLETE
     * @since 3.11.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Camera#preRender
     * @protected
     * @since 3.0.0
     */
    preRender: function () {
     ...
     * Be sure to keep the value between 0 and 1. A value of zero will disable tracking on that axis.
     *
     * @method Vsengine.Cameras.Scene2D.Camera#setLerp
     * @since 3.9.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Camera#setFollowOffset
     * @since 3.9.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Camera#startFollow
     * @since 3.0.0
     *
     * @param {(Vsengine.GameObjects.GameObject|object)} target - The target for the Camera to follow.
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Camera#stopFollow
     * @since 3.0.0
     *
     * @return {this} This Camera instance.
     */
     ...
     * remove the fade.
     *
     * @method Vsengine.Cameras.Scene2D.Camera#resetFX
     * @since 3.0.0
     *
     * @return {this} This Camera instance.
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Camera#update
     * @protected
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.Camera#destroy
