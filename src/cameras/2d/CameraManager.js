 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - The Scene that owns the Camera Manager plugin.
 */
var CameraManager = new Class({
    initialize: function CameraManager(scene) {
         ...
         *
         * @name Vsengine.Cameras.Scene2D.CameraManager#scene
         * @type {Vsengine.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name Vsengine.Cameras.Scene2D.CameraManager#systems
         ...
         *
         * @name Vsengine.Cameras.Scene2D.CameraManager#roundPixels
         * @type {boolean}
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.Cameras.Scene2D.CameraManager#cameras
         ...
         *
         * @name Vsengine.Cameras.Scene2D.CameraManager#main
         * @type {Vsengine.Cameras.Scene2D.Camera}
         * @since 3.0.0
         */
        this.main;
         ...
         *
         * @name Vsengine.Cameras.Scene2D.CameraManager#default
         * @type {Vsengine.Cameras.Scene2D.Camera}
         * @since 3.17.0
         */
        this.default;
     ...
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#boot
     * @private
     * @listens Vsengine.Scenes.Events#DESTROY
     * @since 3.5.1
     */
    boot: function () {
     ...
     * Do not invoke it directly.
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#start
     * @private
     * @listens Vsengine.Scenes.Events#UPDATE
     * @listens Vsengine.Scenes.Events#SHUTDOWN
     * @since 3.5.0
     */
    start: function () {
        if (!this.main) {
     ...
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#add
     * @since 3.0.0
     *
     ...
     *
     * @return {Vsengine.Cameras.Scene2D.Camera} The newly created Camera.
     */
     ...
     *
     * The Camera should either be a `Vsengine.Cameras.Scene2D.Camera` instance, or a class that extends from it.
     *
     * The Camera will have its `roundPixels` property set to whatever `CameraManager.roundPixels` is. You can change
     ...
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#addExisting
     * @since 3.0.0
     *
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The Camera to be added to the Camera Manager.
     * @param {boolean} [makeMain=false] - Set this Camera as being the 'main' camera. This just makes the property `main` a reference to it.
     *
     * @return {?Vsengine.Cameras.Scene2D.Camera} The Camera that was added to the Camera Manager, or `null` if it couldn't be added.
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#getNextID
     * @private
     * @since 3.11.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#getTotal
     * @since 3.11.0
     *
     ...
     *
     * See the `Vsengine.Types.Cameras.Scene2D.CameraConfig` documentation for details of the object structure.
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#fromJSON
     * @since 3.0.0
     *
     * @param {(Vsengine.Types.Cameras.Scene2D.CameraConfig|Vsengine.Types.Cameras.Scene2D.CameraConfig[])} config - A Camera configuration object, or an array of them, to be added to this Camera Manager.
     *
    ...
    fromJSON: function (config) {
        ...
        for (var i = 0; i < config.length; i++) {
            ...
            camera.roundPixels = GetFastValue(
                cameraConfig,
                "roundPixels",
                false
            );
            ...
            var backgroundColor = GetFastValue(
                cameraConfig,
                "backgroundColor",
                false
            );
     ...
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#getCamera
     * @since 3.0.0
     *
     * @param {string} name - The name of the Camera.
     *
     * @return {?Vsengine.Cameras.Scene2D.Camera} The first Camera with a name matching the given string, otherwise `null`.
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#getCamerasBelowPointer
     * @since 3.10.0
     *
     * @param {Vsengine.Input.Pointer} pointer - The Pointer to check against.
     *
     * @return {Vsengine.Cameras.Scene2D.Camera[]} An array of cameras below the Pointer.
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#remove
     * @since 3.0.0
     *
     * @param {(Vsengine.Cameras.Scene2D.Camera|Vsengine.Cameras.Scene2D.Camera[])} camera - The Camera, or an array of Cameras, to be removed from this Camera Manager.
     ...
     * an alpha level > 0.
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#render
     * @protected
     * @since 3.0.0
     *
     * @param {(Vsengine.Renderer.Canvas.CanvasRenderer|Vsengine.Renderer.WebGL.WebGLRenderer)} renderer - The Renderer that will render the children to this camera.
     * @param {Vsengine.GameObjects.DisplayList} displayList - The Display List for the Scene.
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#getVisibleChildren
     * @since 3.50.0
     *
     * @param {Vsengine.GameObjects.GameObject[]} children - An array of Game Objects to be checked against the camera.
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The camera to filter the Game Objects against.
     *
     * @return {Vsengine.GameObjects.GameObject[]} A filtered list of only Game Objects within the Scene that will render against the given Camera.
     */
     ...
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#resetAll
     * @since 3.0.0
     *
     * @return {Vsengine.Cameras.Scene2D.Camera} The freshly created main Camera.
     */
    resetAll: function () {
     ...
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#update
     * @protected
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#onResize
     * @since 3.18.0
     *
    ...
    onResize: function (
        ...
        for (var i = 0; i < this.cameras.length; i++) {
            ...
            if (
                cam._x === 0 &&
                cam._y === 0 &&
                cam._width === previousWidth &&
                cam._height === previousHeight
            ) {
     ...
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#resize
     * @since 3.2.0
     *
     ...
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#shutdown
     * @private
     * @since 3.0.0
     */
    shutdown: function () {
     ...
     *
     * @method Vsengine.Cameras.Scene2D.CameraManager#destroy
     * @private
     * @since 3.0.0
     */
    destroy: function () {
