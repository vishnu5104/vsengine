 ...
 *     up: cursors.up,
 *     down: cursors.down,
 *     zoomIn: this.input.keyboard.addKey(Vsengine.Input.Keyboard.KeyCodes.Q),
 *     zoomOut: this.input.keyboard.addKey(Vsengine.Input.Keyboard.KeyCodes.E),
 *     zoomSpeed: 0.02,
 *     acceleration: 0.06,
 *     drag: 0.0005,
 *     maxSpeed: 1.0
 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Types.Cameras.Controls.SmoothedKeyControlConfig} config - The Smoothed Key Control configuration object.
 */
var SmoothedKeyControl = new Class({
    initialize: function SmoothedKeyControl(config) {
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#camera
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#left
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#right
         * @type {?Vsengine.Input.Keyboard.Key}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#up
         * @type {?Vsengine.Input.Keyboard.Key}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#down
         * @type {?Vsengine.Input.Keyboard.Key}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#zoomIn
         * @type {?Vsengine.Input.Keyboard.Key}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#zoomOut
         * @type {?Vsengine.Input.Keyboard.Key}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#zoomSpeed
         * @type {number}
         * @default 0.01
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#minZoom
         * @type {number}
         * @default 0.001
         * @since 3.53.0
         */
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#maxZoom
         * @type {number}
         * @default 1000
         * @since 3.53.0
         */
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#accelX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#accelY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#dragX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#dragY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#maxSpeedX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#maxSpeedY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#_speedX
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         * Internal property to track the speed of the control.
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#_speedY
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#_zoom
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Cameras.Controls.SmoothedKeyControl#active
         * @type {boolean}
         * @since 3.0.0
         */
     ...
     *
     * @method Vsengine.Cameras.Controls.SmoothedKeyControl#start
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cameras.Controls.SmoothedKeyControl#stop
     * @since 3.0.0
     *
     * @return {this} This Key Control instance.
     */
     ...
     *
     * @method Vsengine.Cameras.Controls.SmoothedKeyControl#setCamera
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cameras.Controls.SmoothedKeyControl#update
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cameras.Controls.SmoothedKeyControl#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.camera = null;
