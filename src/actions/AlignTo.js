 ...
 * of the Vsengine.Display.Align constants, such as `Vsengine.Display.Align.TOP_LEFT`,
 * `Vsengine.Display.Align.TOP_CENTER`, etc.
 *
 * The first item isn't moved. The second item is aligned next to the first,
 * then the third next to the second, and so on.
 *
 * @function Vsengine.Actions.AlignTo
 * @since 3.22.0
 *
 ...
 * @param {number} position - The position to align the items with. This is an align constant, such as `Vsengine.Display.Align.LEFT_CENTER`.
