 ...
 *
 * @function Vsengine.Actions.GetFirst
 * @since 3.0.0
 *
 ...
 *
 * @return {?(object|Vsengine.GameObjects.GameObject)} The first object in the array that matches the comparison object, or `null` if no match was found.
 */
