 ...
 *
 * ```javascript
 * Vsengine.Actions.Spread(itemsArray, 'alpha', 0, 1);
 * ```
 *
 * @function Vsengine.Actions.Spread
 * @since 3.0.0
 *
 ...
 *
 * @return {(array|Vsengine.GameObjects.GameObject[])} The array of Game Objects that were passed to this Action.
 */
var Spread = function (items, property, min, max, inc) {
    ...
    if (items.length === 1) {
        // if only one item put it at the center
        if (inc) {
