/**
 * @typedef {object} Vsengine.Types.Actions.GridAlignConfig
 * @since 3.0.0
 *
 ...
 * @property {number} [position=0] - The alignment position. One of the Vsengine.Display.Align consts such as `TOP_LEFT` or `RIGHT_CENTER`.
