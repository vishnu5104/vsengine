 ...
 *
 * @function Vsengine.Actions.ShiftPosition
 * @since 3.0.0
 *
 * @generic {Vsengine.GameObjects.GameObject[]} G - [items]
 * @generic {Vsengine.Math.Vector2} O - [output,$return]
 *
 * @param {(Vsengine.Types.Math.Vector2Like[]|Vsengine.GameObjects.GameObject[])} items - An array of Game Objects, or objects with public x and y positions. The contents of this array are updated by this Action.
 ...
 * @param {Vsengine.Types.Math.Vector2Like} [output] - An optional Vec2Like object to store the final position in.
 *
 * @return {Vsengine.Types.Math.Vector2Like} The output vector.
 */
