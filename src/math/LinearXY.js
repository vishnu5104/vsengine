 ...
 *
 * @function Vsengine.Math.LinearXY
 * @since 3.60.0
 *
 * @param {Vsengine.Math.Vector2} vector1 - Starting vector
 * @param {Vsengine.Math.Vector2} vector2 - Ending vector
 * @param {number} [t=0] - The percentage between vector1 and vector2 to return, represented as a number between 0 and 1.
 *
 * @return {Vsengine.Math.Vector2} The step t% of the way between vector1 and vector2.
 */
