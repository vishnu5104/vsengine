...
var Set = new Class({
    initialize: function Set(elements) {
         ...
         * @genericUse {T[]} - [$type]
         *
         * @name Vsengine.Structs.Set#entries
         * @type {Array.<*>}
         * @default []
         * @since 3.0.0
         */
     ...
     *
     * @method Vsengine.Structs.Set#set
     * @since 3.0.0
     *
     * @genericUse {T} - [value]
     * @genericUse {Vsengine.Structs.Set.<T>} - [$return]
     *
     * @param {*} value - The value to insert into this Set.
     *
     * @return {Vsengine.Structs.Set} This Set object.
     */
    set: function (value) {
     ...
     *
     * @method Vsengine.Structs.Set#get
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Structs.Set#getArray
     * @since 3.0.0
     *
     * @genericUse {T[]} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.Set#delete
     * @since 3.0.0
     *
     * @genericUse {T} - [value]
     * @genericUse {Vsengine.Structs.Set.<T>} - [$return]
     ...
     *
     * @method Vsengine.Structs.Set#dump
     * @since 3.0.0
     */
    dump: function () {
     ...
     *
     * @method Vsengine.Structs.Set#each
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Structs.Set#iterate
     * @since 3.0.0
     *
     * @genericUse {EachSetCallback.<T>} - [callback]
     * @genericUse {Vsengine.Structs.Set.<T>} - [$return]
    ...
    iterate: function (callback, callbackScope) {
        ...
        if (callbackScope) {
            for (i = 0; i < len; i++) {
                if (
                    callback.call(callbackScope, this.entries[i], i) === false
                ) {
                    break;
                }
            }
     ...
     *
     * @method Vsengine.Structs.Set#iterateLocal
     * @since 3.0.0
     *
     * @genericUse {Vsengine.Structs.Set.<T>} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.Set#clear
     * @since 3.0.0
     *
     * @genericUse {Vsengine.Structs.Set.<T>} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.Set#contains
     * @since 3.0.0
     *
     * @genericUse {T} - [value]
     *
     ...
     *
     * @method Vsengine.Structs.Set#union
     * @since 3.0.0
     *
     * @genericUse {Vsengine.Structs.Set.<T>} - [set,$return]
     *
     * @param {Vsengine.Structs.Set} set - The Set to perform the union with.
     *
     * @return {Vsengine.Structs.Set} A new Set containing all the values in this Set and the Set provided as an argument.
     */
    union: function (set) {
        var newSet = new Set();
     ...
     *
     * @method Vsengine.Structs.Set#intersect
     * @since 3.0.0
     *
     * @genericUse {Vsengine.Structs.Set.<T>} - [set,$return]
     *
     * @param {Vsengine.Structs.Set} set - The Set to intersect this set with.
     *
     * @return {Vsengine.Structs.Set} The result of the intersection, as a new Set.
     */
     ...
     *
     * @method Vsengine.Structs.Set#difference
     * @since 3.0.0
     *
     * @genericUse {Vsengine.Structs.Set.<T>} - [set,$return]
     *
     * @param {Vsengine.Structs.Set} set - The Set to perform the difference with.
     *
     * @return {Vsengine.Structs.Set} A new Set containing all the values in this Set that are not also in the Set provided as an argument to this method.
     */
     ...
     *
     * @name Vsengine.Structs.Set#size
     * @type {number}
     * @since 3.0.0
     */
    size: {
