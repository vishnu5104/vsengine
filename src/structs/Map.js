...
var Map = new Class({
    initialize: function Map(elements) {
         ...
         *
         * @name Vsengine.Structs.Map#entries
         * @type {Object.<string, *>}
         * @default {}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Structs.Map#size
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
     ...
     *
     * @method Vsengine.Structs.Map#setAll
     * @since 3.70.0
     *
     * @generic K
     * @generic V
     ...
     *
     * @method Vsengine.Structs.Map#set
     * @since 3.0.0
     *
     * @genericUse {K} - [key]
     * @genericUse {V} - [value]
     * @genericUse {Vsengine.Structs.Map.<K, V>} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.Map#get
     * @since 3.0.0
     *
     * @genericUse {K} - [key]
     * @genericUse {V} - [$return]
     ...
     *
     * @method Vsengine.Structs.Map#getArray
     * @since 3.0.0
     *
     * @genericUse {V[]} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.Map#has
     * @since 3.0.0
     *
     * @genericUse {K} - [key]
     *
     ...
     *
     * @method Vsengine.Structs.Map#delete
     * @since 3.0.0
     *
     * @genericUse {K} - [key]
     * @genericUse {Vsengine.Structs.Map.<K, V>} - [$return]
     ...
     *
     * @method Vsengine.Structs.Map#clear
     * @since 3.0.0
     *
     * @genericUse {Vsengine.Structs.Map.<K, V>} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.Map#keys
     * @since 3.0.0
     *
     * @genericUse {K[]} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.Map#values
     * @since 3.0.0
     *
     * @genericUse {V[]} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.Map#dump
     * @since 3.0.0
     */
    dump: function () {
        var entries = this.entries;
     ...
     *
     * @method Vsengine.Structs.Map#each
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Structs.Map#contains
     * @since 3.0.0
     *
     * @genericUse {V} - [value]
     *
     ...
     *
     * @method Vsengine.Structs.Map#merge
     * @since 3.0.0
     *
     * @genericUse {Vsengine.Structs.Map.<K, V>} - [map,$return]
     *
     * @param {Vsengine.Structs.Map} map - The Map to merge in to this Map.
