...
var List = new Class({
    initialize: function List(parent) {
         ...
         *
         * @name Vsengine.Structs.List#parent
         * @type {*}
         * @since 3.0.0
         */
        this.parent = parent;
         ...
         * @genericUse {T[]} - [$type]
         *
         * @name Vsengine.Structs.List#list
         * @type {Array.<*>}
         * @default []
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Structs.List#position
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Structs.List#addCallback
         * @type {function}
         * @since 3.4.0
         */
         ...
         *
         * @name Vsengine.Structs.List#removeCallback
         * @type {function}
         * @since 3.4.0
         */
         ...
         *
         * @name Vsengine.Structs.List#_sortKey
         * @type {string}
         * @since 3.4.0
         */
        this._sortKey = "";
     ...
     *
     * @method Vsengine.Structs.List#add
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Structs.List#addAt
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Structs.List#getAt
     * @since 3.0.0
     *
     * @genericUse {T} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.List#getIndex
     * @since 3.0.0
     *
     * @genericUse {T} - [child]
     *
     ...
     *
     * @method Vsengine.Structs.List#sort
     * @since 3.0.0
     *
     ...
     *
     * @return {Vsengine.Structs.List} This List object.
     */
     ...
     *
     * @method Vsengine.Structs.List#getByName
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Structs.List#getRandom
     * @since 3.0.0
     *
     * @genericUse {T | null} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.List#getFirst
     * @since 3.0.0
     *
     * @genericUse {T | null} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.List#getAll
     * @since 3.0.0
     *
     * @genericUse {T[]} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.List#count
     * @since 3.0.0
     *
     * @genericUse {T} - [value]
     *
     ...
     *
     * @method Vsengine.Structs.List#swap
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Structs.List#moveTo
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Structs.List#moveAbove
     * @since 3.55.0
     *
     * @genericUse {T} - [child1,child2]
     *
     ...
     *
     * @method Vsengine.Structs.List#moveBelow
     * @since 3.55.0
     *
     * @genericUse {T} - [child1,child2]
     *
     ...
     *
     * @method Vsengine.Structs.List#remove
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Structs.List#removeAt
     * @since 3.0.0
     *
     * @genericUse {T} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.List#removeBetween
     * @since 3.0.0
     *
     * @genericUse {T[]} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.List#removeAll
     * @since 3.0.0
     *
     * @param {boolean} [skipCallback=false] - Skip calling the List.removeCallback.
     *
     ...
     *
     * @method Vsengine.Structs.List#bringToTop
     * @since 3.0.0
     *
     * @genericUse {T} - [child,$return]
     *
     ...
     *
     * @method Vsengine.Structs.List#sendToBack
     * @since 3.0.0
     *
     * @genericUse {T} - [child,$return]
     *
     ...
     *
     * @method Vsengine.Structs.List#moveUp
     * @since 3.0.0
     *
     * @genericUse {T} - [child,$return]
     *
     ...
     *
     * @method Vsengine.Structs.List#moveDown
     * @since 3.0.0
     *
     * @genericUse {T} - [child,$return]
     *
     ...
     *
     * @method Vsengine.Structs.List#reverse
     * @since 3.0.0
     *
     * @genericUse {Vsengine.Structs.List.<T>} - [$return]
     *
     * @return {Vsengine.Structs.List} This List object.
     */
    reverse: function () {
     ...
     *
     * @method Vsengine.Structs.List#shuffle
     * @since 3.0.0
     *
     * @genericUse {Vsengine.Structs.List.<T>} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.List#replace
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Structs.List#exists
     * @since 3.0.0
     *
     * @genericUse {T} - [child]
     *
     ...
     *
     * @method Vsengine.Structs.List#setAll
     * @since 3.0.0
     *
     * @genericUse {T} - [value]
     *
     ...
     *
     * @method Vsengine.Structs.List#each
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Structs.List#shutdown
     * @since 3.0.0
     */
    shutdown: function () {
        this.removeAll();
     ...
     * Destroys this List.
     *
     * @method Vsengine.Structs.List#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.removeAll();
     ...
     *
     * @name Vsengine.Structs.List#length
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Structs.List#first
     * @genericUse {T} - [$type]
     * @type {*}
     * @readonly
     * @since 3.0.0
     ...
     *
     * @name Vsengine.Structs.List#last
     * @genericUse {T} - [$type]
     * @type {*}
     * @readonly
     * @since 3.0.0
     ...
     *
     * @name Vsengine.Structs.List#next
     * @genericUse {T} - [$type]
     * @type {*}
     * @readonly
     * @since 3.0.0
     ...
     *
     * @name Vsengine.Structs.List#previous
     * @genericUse {T} - [$type]
     * @type {*}
     * @readonly
     * @since 3.0.0
