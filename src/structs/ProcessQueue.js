...
var ProcessQueue = new Class({
    ...
    initialize: function ProcessQueue() {
         ...
         * @genericUse {T[]} - [$type]
         *
         * @name Vsengine.Structs.ProcessQueue#_pending
         * @type {Array.<*>}
         * @private
         * @default []
         * @since 3.0.0
         ...
         * @genericUse {T[]} - [$type]
         *
         * @name Vsengine.Structs.ProcessQueue#_active
         * @type {Array.<*>}
         * @private
         * @default []
         * @since 3.0.0
         ...
         * @genericUse {T[]} - [$type]
         *
         * @name Vsengine.Structs.ProcessQueue#_destroy
         * @type {Array.<*>}
         * @private
         * @default []
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Structs.ProcessQueue#_toProcess
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Structs.ProcessQueue#checkQueue
         * @type {boolean}
         * @since 3.50.0
         */
     ...
     *
     * @method Vsengine.Structs.ProcessQueue#isActive
     * @since 3.60.0
     *
     * @genericUse {T} - [item]
     * @genericUse {Vsengine.Structs.ProcessQueue.<T>} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.ProcessQueue#isPending
     * @since 3.60.0
     *
     * @genericUse {T} - [item]
     * @genericUse {Vsengine.Structs.ProcessQueue.<T>} - [$return]
     ...
     *
     * @method Vsengine.Structs.ProcessQueue#isDestroying
     * @since 3.60.0
     *
     * @genericUse {T} - [item]
     * @genericUse {Vsengine.Structs.ProcessQueue.<T>} - [$return]
     ...
     *
     * @method Vsengine.Structs.ProcessQueue#add
     * @since 3.0.0
     *
     * @genericUse {T} - [item]
     * @genericUse {Vsengine.Structs.ProcessQueue.<T>} - [$return]
     ...
     *
     * @method Vsengine.Structs.ProcessQueue#remove
     * @since 3.0.0
     *
     * @genericUse {T} - [item]
     * @genericUse {Vsengine.Structs.ProcessQueue.<T>} - [$return]
     ...
     *
     * @method Vsengine.Structs.ProcessQueue#removeAll
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.Structs.ProcessQueue#update
     * @since 3.0.0
     *
     * @genericUse {T[]} - [$return]
     *
     ...
     *
     * @method Vsengine.Structs.ProcessQueue#getActive
     * @since 3.0.0
     *
     * @genericUse {T[]} - [$return]
     *
     ...
     *
     * @name Vsengine.Structs.ProcessQueue#length
     * @type {number}
     * @readonly
     * @since 3.20.0
     */
     ...
     *
     * @method Vsengine.Structs.ProcessQueue#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this._toProcess = 0;
