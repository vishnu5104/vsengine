...
var Size = new Class({
    initialize: function Size(width, height, aspectMode, parent) {
         ...
         *
         * @name Vsengine.Structs.Size#_width
         * @type {number}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Structs.Size#_height
         * @type {number}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Structs.Size#_parent
         * @type {any}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Structs.Size#aspectMode
         * @type {number}
         * @readonly
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Structs.Size#aspectRatio
         * @type {number}
         * @readonly
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Structs.Size#minWidth
         * @type {number}
         * @readonly
         * @since 3.16.0
         */
         ...
         * This value is read-only. To change it see the `setMin` method.
         *
         * @name Vsengine.Structs.Size#minHeight
         * @type {number}
         * @readonly
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Structs.Size#maxWidth
         * @type {number}
         * @readonly
         * @since 3.16.0
         */
         ...
         * This value is read-only. To change it see the `setMax` method.
         *
         * @name Vsengine.Structs.Size#maxHeight
         * @type {number}
         * @readonly
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Structs.Size#snapTo
     ...
     *
     * @method Vsengine.Structs.Size#setAspectMode
     * @since 3.16.0
     *
     ...
     * Calling this method automatically recalculates the `width` and the `height`, if required.
     *
     * @method Vsengine.Structs.Size#setSnap
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Structs.Size#setParent
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Structs.Size#setMin
     * @since 3.16.0
     *
     ...
     * _can_ be exceed in some situations.
     *
     * @method Vsengine.Structs.Size#setMax
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Structs.Size#setSize
     * @since 3.16.0
     *
        ...
        switch (this.aspectMode) {
            case Size.NONE:
                ...
                this._height = this.getNewHeight(
                    SnapFloor(height, this.snapTo.y)
                );
                this.aspectRatio =
                    this._height === 0 ? 1 : this._width / this._height;
                break;
     ...
     *
     * @method Vsengine.Structs.Size#setAspectRatio
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Structs.Size#resize
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Structs.Size#getNewWidth
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Structs.Size#getNewHeight
     * @since 3.16.0
     *
     * @param {number} value - The value to clamp and check.
     * @param {boolean} [checkParent=true] - Check the given value against the parent, if set.
     ...
     *
     * @method Vsengine.Structs.Size#constrain
     * @since 3.16.0
     *
     * @param {number} [width=0] - The new width of the Size component.
     ...
     * it cannot exceed that of the parent.
     *
     * @method Vsengine.Structs.Size#fitTo
     * @since 3.16.0
     *
     * @param {number} [width=0] - The new width of the Size component.
     * @param {number} [height] - The new height of the Size component. If not given, it will use the width value.
     ...
     * on the longest axis.
     *
     * @method Vsengine.Structs.Size#envelop
     * @since 3.16.0
     *
     * @param {number} [width=0] - The new width of the Size component.
     * @param {number} [height] - The new height of the Size component. If not given, it will use the width value.
     ...
     *
     * @method Vsengine.Structs.Size#setWidth
     * @since 3.16.0
     *
     * @param {number} width - The new width of the Size component.
     *
     ...
     *
     * @method Vsengine.Structs.Size#setHeight
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Structs.Size#toString
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Structs.Size#setCSS
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.Structs.Size#copy
     * @since 3.16.0
     *
     * @param {Vsengine.Structs.Size} destination - The Size component to copy the values to.
     *
     * @return {Vsengine.Structs.Size} The updated destination Size component.
     */
     ...
     *
     * @method Vsengine.Structs.Size#destroy
     * @since 3.16.0
     */
    destroy: function () {
        this._parent = null;
     ...
     *
     * @name Vsengine.Structs.Size#width
     * @type {number}
     * @since 3.16.0
     */
    width: {
     ...
     *
     * @name Vsengine.Structs.Size#height
     * @type {number}
     * @since 3.16.0
     */
    height: {
 ...
 *
 * @name Vsengine.Structs.Size.NONE
 * @constant
 * @type {number}
 * @since 3.16.0
 */
 ...
 *
 * @name Vsengine.Structs.Size.WIDTH_CONTROLS_HEIGHT
 * @constant
 * @type {number}
 * @since 3.16.0
 */
 ...
 *
 * @name Vsengine.Structs.Size.HEIGHT_CONTROLS_WIDTH
 * @constant
 * @type {number}
 * @since 3.16.0
 */
 ...
 *
 * @name Vsengine.Structs.Size.FIT
 * @constant
 * @type {number}
 * @since 3.16.0
 */
 ...
 *
 * @name Vsengine.Structs.Size.ENVELOP
 * @constant
 * @type {number}
 * @since 3.16.0
 */
