...
/**
 * Called automatically by Vsengine.Game and responsible for creating the console.log debug header.
 *
 * You can customize or disable the header via the Game Config object.
 *
 * @function Vsengine.Core.DebugHeader
 * @since 3.0.0
 *
 * @param {Vsengine.Game} game - The Vsengine.Game instance which will output this debug header.
 */
var DebugHeader = function (game) {
    ...
    if (!game.device.browser.ie) {
        ...
        console.log("Vsengine v" + CONST.VERSION + " / https://phaser.io");
    }
};
