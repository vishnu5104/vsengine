...
/**
 * @classdesc
 * The core runner class that Vsengine uses to handle the game loop. It can use either Request Animation Frame,
 ...
 * this situation, all you can do is use the visibility events the browser, and Vsengine, provide to detect when
 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Game} game - A reference to the Vsengine.Game instance that owns this Time Step.
 * @param {Vsengine.Types.Core.FPSConfig} config
 */
var TimeStep = new Class({
    initialize: function TimeStep(game, config) {
         ...
         *
         * @name Vsengine.Core.TimeStep#game
         * @type {Vsengine.Game}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Core.TimeStep#raf
         * @type {Vsengine.DOM.RequestAnimationFrame}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Core.TimeStep#started
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Core.TimeStep#running
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Core.TimeStep#minFps
         * @type {number}
         * @default 5
         * @since 3.0.0
         */
         ...
         * the control of Vsengine. Instead, it allows you to determine performance issues and if the Time Step
         * is spiraling out of control.
         *
         * @name Vsengine.Core.TimeStep#targetFps
         * @type {number}
         * @default 60
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Core.TimeStep#fpsLimit
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Core.TimeStep#hasFpsLimit
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Core.TimeStep#_limitRate
         * @type {number}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Core.TimeStep#_min
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Core.TimeStep#_target
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Core.TimeStep#actualFps
         * @type {number}
         * @readonly
         * @default 60
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Core.TimeStep#nextFpsUpdate
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Core.TimeStep#framesThisSecond
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Core.TimeStep#callback
         * @type {Vsengine.Types.Core.TimeStepCallback}
         * @default NOOP
         * @since 3.0.0
         */
        this.callback = NOOP;
         ...
         *
         * @name Vsengine.Core.TimeStep#forceSetTimeOut
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Core.TimeStep#time
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Core.TimeStep#startTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Core.TimeStep#lastTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Core.TimeStep#frame
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Core.TimeStep#inFocus
         * @type {boolean}
         * @readonly
         * @default true
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Core.TimeStep#pauseDuration
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.85.0
         ...
         *
         * @name Vsengine.Core.TimeStep#_pauseTime
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Core.TimeStep#_coolDown
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Core.TimeStep#delta
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Core.TimeStep#deltaIndex
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Core.TimeStep#deltaHistory
         * @type {number[]}
         * @since 3.0.0
         */
        this.deltaHistory = [];
         ...
         *
         * @name Vsengine.Core.TimeStep#deltaSmoothingMax
         * @type {number}
         * @default 10
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Core.TimeStep#panicMax
         * @type {number}
         * @default 120
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Core.TimeStep#rawDelta
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Core.TimeStep#now
         * @type {number}
         * @default 0
         * @since 3.18.0
         */
         ...
         * which could cause significant delta spikes or dips. By default it has been enabled in Vsengine 3
         ...
         *
         * @name Vsengine.Core.TimeStep#smoothStep
         * @type {boolean}
         * @since 3.22.0
         */
     ...
     *
     * @method Vsengine.Core.TimeStep#blur
     * @since 3.0.0
     */
    blur: function () {
        this.inFocus = false;
     ...
     *
     * @method Vsengine.Core.TimeStep#focus
     * @since 3.0.0
     */
    focus: function () {
        this.inFocus = true;
     ...
     *
     * @method Vsengine.Core.TimeStep#pause
     * @since 3.0.0
     */
    pause: function () {
     ...
     *
     * @method Vsengine.Core.TimeStep#resume
     * @since 3.0.0
     */
    resume: function () {
        this.resetDelta();
     ...
     *
     * @method Vsengine.Core.TimeStep#resetDelta
     * @since 3.0.0
     */
    resetDelta: function () {
     ...
     *
     * @method Vsengine.Core.TimeStep#start
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Core.TimeStepCallback} callback - The callback to be invoked each time the Time Step steps.
     */
     ...
     *
     * @method Vsengine.Core.TimeStep#smoothDelta
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Core.TimeStep#updateFPS
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Core.TimeStep#stepLimitFPS
     * @since 3.60.0
     *
     * @param {number} time - The timestamp passed in from RequestAnimationFrame or setTimeout.
     */
     ...
     * You generally should never call this method directly.
     *
     * @method Vsengine.Core.TimeStep#step
     * @since 3.0.0
     *
     * @param {number} time - The timestamp passed in from RequestAnimationFrame or setTimeout.
     */
     ...
     *
     * @method Vsengine.Core.TimeStep#tick
     * @since 3.0.0
     */
    tick: function () {
        var now = window.performance.now();
     ...
     *
     * @method Vsengine.Core.TimeStep#sleep
     * @since 3.0.0
     */
    sleep: function () {
        if (this.running) {
     ...
     *
     * @method Vsengine.Core.TimeStep#wake
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Core.TimeStep#getDuration
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.Core.TimeStep#getDurationMS
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.Core.TimeStep#stop
     * @since 3.0.0
     *
     ...
     * any objects.
     *
     * @method Vsengine.Core.TimeStep#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.stop();
