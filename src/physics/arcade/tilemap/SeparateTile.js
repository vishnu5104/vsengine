 ...
 *
 * @function Vsengine.Physics.Arcade.Tilemap.SeparateTile
 * @since 3.0.0
 *
 ...
 * @param {Vsengine.Tilemaps.Tile} tile - The tile to collide against.
 * @param {Vsengine.Geom.Rectangle} tileWorldRect - A rectangle-like object defining the dimensions of the tile.
 * @param {Vsengine.Tilemaps.TilemapLayer} tilemapLayer - The tilemapLayer to collide against.
