 ...
 *
 * @function Vsengine.Physics.Arcade.Tilemap.ProcessTileCallbacks
 * @since 3.0.0
 *
 * @param {Vsengine.Tilemaps.Tile} tile - The Tile to process.
 * @param {Vsengine.GameObjects.Sprite} sprite - The Game Object to process with the Tile.
 *
...
var ProcessTileCallbacks = function (tile, sprite) {
    ...
    if (tile.collisionCallback) {
        return !tile.collisionCallback.call(
