 ...
 *
 * Its dynamic counterpart is {@link Vsengine.Physics.Arcade.Body}.
 *
 * @class StaticBody
 ...
 *
 * @param {Vsengine.Physics.Arcade.World} world - The Arcade Physics simulation this Static Body belongs to.
...
var StaticBody = new Class({
    ...
    initialize: function StaticBody(world, gameObject) {
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#world
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#gameObject
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#isBody
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#debugShowBody
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#debugBodyColor
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#enable
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#isCircle
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
        ...
        /**
         * If this Static Body is circular, this is the radius of the boundary, as set by {@link Vsengine.Physics.Arcade.StaticBody#setCircle}, in pixels.
         * Equal to `halfWidth`.
         *
         * @name Vsengine.Physics.Arcade.StaticBody#radius
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
        ...
        /**
         * The offset set by {@link Vsengine.Physics.Arcade.StaticBody#setCircle} or {@link Vsengine.Physics.Arcade.StaticBody#setSize}.
         *
         * This doesn't affect the Static Body's position, because a Static Body does not follow its Game Object.
         *
         * @name Vsengine.Physics.Arcade.StaticBody#offset
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#position
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         */
        this.position = new Vector2(
            gameObject.x - width * gameObject.originX,
            gameObject.y - height * gameObject.originY
        );
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#width
         * @type {number}
         * @since 3.0.0
         */
        this.width = width;
         ...
         * If the Static Body is circular, this is also the Static Body's diameter.
         *
         * @name Vsengine.Physics.Arcade.StaticBody#height
         * @type {number}
         * @since 3.0.0
         */
        this.height = height;
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#halfWidth
         * @type {number}
         * @since 3.0.0
         */
         ...
         * If the Static Body is circular, this is also the Static Body's radius.
         *
         * @name Vsengine.Physics.Arcade.StaticBody#halfHeight
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#center
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#velocity
         * @type {Vsengine.Math.Vector2}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#allowGravity
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#gravity
         * @type {Vsengine.Math.Vector2}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#bounce
         * @type {Vsengine.Math.Vector2}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#onWorldBounds
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#onCollide
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#onOverlap
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#mass
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#immovable
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#pushable
         * @type {boolean}
         * @default false
         * @since 3.50.0
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#customSeparateX
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#customSeparateY
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#overlapX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#overlapY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#overlapR
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#embedded
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#collideWorldBounds
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#checkCollision
         ...
         * Avoid using it.
         *
         * @name Vsengine.Physics.Arcade.StaticBody#touching
         * @type {Vsengine.Types.Physics.Arcade.ArcadeBodyCollision}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#wasTouching
         * @type {Vsengine.Types.Physics.Arcade.ArcadeBodyCollision}
         * @since 3.0.0
         */
         ...
         * Avoid using it.
         *
         * @name Vsengine.Physics.Arcade.StaticBody#blocked
         * @type {Vsengine.Types.Physics.Arcade.ArcadeBodyCollision}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#physicsType
         * @type {number}
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#collisionCategory
         * @type {number}
         * @since 3.70.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#collisionMask
         * @type {number}
         * @since 3.70.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.StaticBody#_dx
         * @type {number}
         * @private
         * @default 0
         * @since 3.10.0
         ...
         * For a static body this is always zero.
         *
         * @name Vsengine.Physics.Arcade.StaticBody#_dy
         * @type {number}
         * @private
         * @default 0
         * @since 3.10.0
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#setGameObject
     * @since 3.1.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - The new Game Object that will own this Body.
     * @param {boolean} [update=true] - Reposition and resize this Body to match the new Game Object?
     *
     * @return {Vsengine.Physics.Arcade.StaticBody} This Static Body object.
     *
     * @see Vsengine.Physics.Arcade.StaticBody#updateFromGameObject
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#updateFromGameObject
     * @since 3.1.0
     *
     * @return {Vsengine.Physics.Arcade.StaticBody} This Static Body object.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#setOffset
     * @since 3.4.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#setSize
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#setCircle
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#updateCenter
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#reset
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#stop
     * @since 3.0.0
     *
     * @return {Vsengine.Physics.Arcade.StaticBody} This Static Body object.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#getBounds
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Physics.Arcade.ArcadeBodyBounds} obj - The object which will hold the coordinates of the bounds.
     *
     * @return {Vsengine.Types.Physics.Arcade.ArcadeBodyBounds} The same object that was passed with `x`, `y`, `right` and `bottom` values matching the respective values of the StaticBody.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#hitTest
     * @since 3.0.0
     *
    ...
    hitTest: function (x, y) {
        return this.isCircle
            ? CircleContains(this, x, y)
            : RectangleContains(this, x, y);
    },

    /**
     * NOOP
     *
     * @method Vsengine.Physics.Arcade.StaticBody#postUpdate
     * @since 3.12.0
     */
    postUpdate: function () {},
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#deltaAbsX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#deltaAbsY
     * @since 3.0.0
     *
     * @return {number} Always zero for a Static Body.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#deltaX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#deltaY
     * @since 3.0.0
     *
     * @return {number} The change in this StaticBody's velocity from the previous step. Always zero.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#deltaZ
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.enable = false;
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#drawDebug
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.Graphics} graphic - The Graphics object to use for the debug drawing of the StaticBody.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#willDrawDebug
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.StaticBody#setMass
     * @since 3.0.0
     *
     ...
     *
     * @name Vsengine.Physics.Arcade.StaticBody#x
     * @type {number}
     * @since 3.0.0
     */
    x: {
     ...
     *
     * @name Vsengine.Physics.Arcade.StaticBody#y
     * @type {number}
     * @since 3.0.0
     */
    y: {
     ...
     *
     * @name Vsengine.Physics.Arcade.StaticBody#left
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Physics.Arcade.StaticBody#right
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Physics.Arcade.StaticBody#top
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Physics.Arcade.StaticBody#bottom
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
