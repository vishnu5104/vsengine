 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - The Scene that this Plugin belongs to.
 */
var ArcadePhysics = new Class({
    initialize: function ArcadePhysics(scene) {
         ...
         *
         * @name Vsengine.Physics.Arcade.ArcadePhysics#scene
         * @type {Vsengine.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         * The Scene's Systems.
         *
         * @name Vsengine.Physics.Arcade.ArcadePhysics#systems
         ...
         *
         * @name Vsengine.Physics.Arcade.ArcadePhysics#config
         * @type {Vsengine.Types.Physics.Arcade.ArcadeWorldConfig}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.ArcadePhysics#world
         ...
         *
         * @name Vsengine.Physics.Arcade.ArcadePhysics#add
         * @type {Vsengine.Physics.Arcade.Factory}
         * @since 3.0.0
         */
        this.add;
         ...
         *
         * @name Vsengine.Physics.Arcade.World#_category
         * @private
         * @type {number}
         * @since 3.70.0
         */
     ...
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#boot
     * @private
     * @since 3.5.1
     */
    boot: function () {
     ...
     * Do not invoke it directly.
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#start
     * @private
     * @since 3.5.0
     */
    start: function () {
     ...
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#enableUpdate
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#disableUpdate
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#getConfig
     * @since 3.0.0
     *
     * @return {Vsengine.Types.Physics.Arcade.ArcadeWorldConfig} The physics configuration.
     */
    getConfig: function () {
     ...
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#nextCategory
     * @since 3.70.0
     *
    ...
    /**
     * Tests if Game Objects overlap. See {@link Vsengine.Physics.Arcade.World#overlap}
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#overlap
     * @since 3.0.0
     *
     ...
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - An optional callback function that lets you perform additional checks against the two objects if they overlap. If this is set then `collideCallback` will only be called if this callback returns `true`.
     ...
     * require a high level of stability please consider using an alternative physics system, such as Matter.js.
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#collide
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Physics.Arcade.ArcadeColliderType} object1 - The first object or array of objects to check.
     * @param {Vsengine.Types.Physics.Arcade.ArcadeColliderType} [object2] - The second object or array of objects to check, or `undefined`.
     ...
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#collideTiles
    ...
    collideTiles: function (
        ...
        return this.world.collideTiles(
            sprite,
            tiles,
            collideCallback,
            processCallback,
     ...
     * you should filter them before passing them to this method.
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#overlapTiles
    ...
    overlapTiles: function (
        ...
        return this.world.overlapTiles(
            sprite,
            tiles,
            collideCallback,
            processCallback,
     ...
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#pause
     * @since 3.0.0
     *
     * @return {Vsengine.Physics.Arcade.World} The simulation.
     */
    pause: function () {
     ...
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#resume
     * @since 3.0.0
     *
     * @return {Vsengine.Physics.Arcade.World} The simulation.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#accelerateTo
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - Any Game Object with an Arcade Physics body.
     ...
     * Note: The game object doesn't stop moving once it reaches the destination coordinates.
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#accelerateToObject
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - Any Game Object with an Arcade Physics body.
     * @param {Vsengine.GameObjects.GameObject} destination - The Game Object to move towards. Can be any object but must have visible x/y properties.
     * @param {number} [speed=60] - The acceleration (change in speed) in pixels per second squared.
     * @param {number} [xSpeedMax=500] - The maximum x velocity the game object can reach.
     * @param {number} [ySpeedMax=500] - The maximum y velocity the game object can reach.
     *
     ...
     * is returned.
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#closest
     * @since 3.0.0
     *
     * @generic {Vsengine.Physics.Arcade.Body|Vsengine.Physics.Arcade.StaticBody|Vsengine.GameObjects.GameObject} Target
     * @param {Vsengine.Types.Math.Vector2Like} source - Any object with public `x` and `y` properties, such as a Game Object or Geometry object.
     ...
     * is returned.
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#furthest
     * @since 3.0.0
     *
     * @param {any} source - Any object with public `x` and `y` properties, such as a Game Object or Geometry object.
     * @param {(Vsengine.Physics.Arcade.Body[]|Vsengine.Physics.Arcade.StaticBody[]|Vsengine.GameObjects.GameObject[])} [targets] - The targets.
     *
     * @return {?(Vsengine.Physics.Arcade.Body|Vsengine.Physics.Arcade.StaticBody|Vsengine.GameObjects.GameObject)} The target farthest from the given source point.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#moveTo
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - Any Game Object with an Arcade Physics body.
    ...
    moveTo: function (gameObject, x, y, speed, maxTime) {
        ...
        if (maxTime > 0) {
            ...
            speed =
                DistanceBetween(gameObject.x, gameObject.y, x, y) /
                (maxTime / 1000);
        }
     ...
     * Note: Doesn't take into account acceleration, maxVelocity or drag (if you've set drag or acceleration too high this object may not move at all)
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#moveToObject
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - Any Game Object with an Arcade Physics body.
     ...
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#velocityFromAngle
     * @since 3.0.0
     *
     * @param {number} angle - The angle in degrees calculated in clockwise positive direction (down = 90 degrees positive, right = 0 degrees positive, up = 90 degrees negative)
     * @param {number} [speed=60] - The speed it will move, in pixels per second squared.
     * @param {Vsengine.Math.Vector2} [vec2] - The Vector2 in which the x and y properties will be set to the calculated velocity.
     *
     * @return {Vsengine.Math.Vector2} The Vector2 that stores the velocity.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#velocityFromRotation
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#overlapRect
     * @since 3.17.0
     *
     ...
     *
     * @return {(Vsengine.Physics.Arcade.Body[]|Vsengine.Physics.Arcade.StaticBody[])} An array of bodies that overlap with the given area.
     */
     ...
     * otherwise the search is O(N) for Dynamic Bodies.
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#overlapCirc
     * @since 3.21.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#shutdown
     * @since 3.0.0
     */
    shutdown: function () {
        if (!this.world) {
     ...
     *
     * @method Vsengine.Physics.Arcade.ArcadePhysics#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.shutdown();
