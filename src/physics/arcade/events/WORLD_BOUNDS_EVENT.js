 ...
 * it has its [onWorldBounds]{@link Vsengine.Physics.Arcade.Body#onWorldBounds} property set to `true`.
 *
 * It provides an alternative means to handling collide events rather than using the callback approach.
 *
 * Listen to it from a Scene using: `this.physics.world.on('worldbounds', listener)`.
 *
 * @event Vsengine.Physics.Arcade.Events#WORLD_BOUNDS
 * @type {string}
 * @since 3.0.0
 *
 * @param {Vsengine.Physics.Arcade.Body} body - The Arcade Physics Body that hit the world bounds.
