 ...
 *
 * This method is called by `Vsengine.Physics.Arcade.SeparateX` and should not be
 * called directly.
 *
 * @function Vsengine.Physics.Arcade.ProcessX.Set
 * @ignore
 * @since 3.50.0
 *
...
var Set = function (b1, b2, ov) {
    ...
    body1OnLeft =
        Math.abs(body1.right - body2.x) <= Math.abs(body2.right - body1.x);
 ...
 *
 * @function Vsengine.Physics.Arcade.ProcessX.BlockCheck
 * @ignore
 * @since 3.50.0
 *
 * @return {number} The BlockCheck result. 0 = not blocked. 1 = Body 1 blocked. 2 = Body 2 blocked.
 ...
 *
 * @function Vsengine.Physics.Arcade.ProcessX.Check
 * @ignore
 * @since 3.50.0
 *
 ...
 * The main check function. Runs through one of the four possible tests and returns the results.
 *
 * @function Vsengine.Physics.Arcade.ProcessX.Run
 * @ignore
 * @since 3.50.0
 *
 ...
 *
 * @function Vsengine.Physics.Arcade.ProcessX.RunImmovableBody1
 * @ignore
 * @since 3.50.0
 *
...
var RunImmovableBody1 = function (blockedState) {
    ...
    if (body1.moves) {
        var body1Distance = body1.directControl
            ? body1.y - body1.autoFrame.y
            : body1.y - body1.prev.y;
 ...
 *
 * @function Vsengine.Physics.Arcade.ProcessX.RunImmovableBody2
 * @ignore
 * @since 3.50.0
 *
 * @param {number} blockedState - The block state value.
...
var RunImmovableBody2 = function (blockedState) {
    ...
    if (body2.moves) {
        var body2Distance = body2.directControl
            ? body2.y - body2.autoFrame.y
            : body2.y - body2.prev.y;
...
/**
 * @namespace Vsengine.Physics.Arcade.ProcessX
 * @ignore
 */
