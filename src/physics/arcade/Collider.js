 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Physics.Arcade.World} world - The Arcade physics World that will manage the collisions.
...
var Collider = new Class({
    initialize: function Collider(
         ...
         *
         * @name Vsengine.Physics.Arcade.Collider#world
        ...
        /**
         * The name of the collider (unused by Vsengine).
         *
         * @name Vsengine.Physics.Arcade.Collider#name
         * @type {string}
         * @since 3.1.0
         */
        this.name = "";
         ...
         *
         * @name Vsengine.Physics.Arcade.Collider#active
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Collider#overlapOnly
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Collider#object1
         * @type {Vsengine.Types.Physics.Arcade.ArcadeColliderType}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Collider#object2
         * @type {Vsengine.Types.Physics.Arcade.ArcadeColliderType}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Collider#collideCallback
         * @type {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Collider#processCallback
         * @type {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Collider#callbackContext
         * @type {object}
         * @since 3.0.0
         */
     ...
     *
     * Vsengine does not use this value, it's for your own reference.
     *
     * @method Vsengine.Physics.Arcade.Collider#setName
     * @since 3.1.0
     *
     * @param {string} name - The name to assign to the Collider.
     *
     * @return {Vsengine.Physics.Arcade.Collider} This Collider instance.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.Collider#update
     * @since 3.0.0
     */
    update: function () {
     ...
     *
     * @method Vsengine.Physics.Arcade.Collider#destroy
     * @since 3.0.0
     */
    destroy: function () {
