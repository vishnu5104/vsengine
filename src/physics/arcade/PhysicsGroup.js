 ...
 * Groups {@link Vsengine.Physics.Arcade.Group#defaults default values}.
 *
 ...
 *
 * If you wish to create a Group filled with Static Bodies, please see {@link Vsengine.Physics.Arcade.StaticGroup}.
 *
 * @class Group
...
var PhysicsGroup = new Class({
    ...
    initialize: function PhysicsGroup(world, scene, children, config) {
        if (!children && !config) {
            ...
            children.forEach(function (singleConfig) {
                singleConfig.internalCreateCallback =
                    _this.createCallbackHandler;
                singleConfig.internalRemoveCallback =
                    _this.removeCallbackHandler;
         ...
         *
         * @name Vsengine.Physics.Arcade.Group#world
         ...
         *
         * This should be either `Vsengine.Physics.Arcade.Image`, `Vsengine.Physics.Arcade.Sprite`, or a class extending one of those.
         *
         * @name Vsengine.Physics.Arcade.Group#classType
         * @type {function}
         ...
         *
         * @name Vsengine.Physics.Arcade.Group#physicsType
         * @type {number}
         ...
         *
         * @name Vsengine.Physics.Arcade.Group#collisionCategory
         * @type {number}
         * @since 3.70.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Group#collisionMask
         * @type {number}
         * @since 3.70.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Group#defaults
         * @type {Vsengine.Types.Physics.Arcade.PhysicsGroupDefaults}
         * @since 3.0.0
         */
        this.defaults = {
            setCollideWorldBounds: GetFastValue(
                config,
                "collideWorldBounds",
                false
            ),
            setBoundsRectangle: GetFastValue(
                config,
            ...
            setAngularAcceleration: GetFastValue(
                config,
                "angularAcceleration",
                0
            ),
         ...
         *
         * @name Vsengine.Physics.Arcade.Group#type
         * @type {string}
     ...
     *
     * @method Vsengine.Physics.Arcade.Group#createCallbackHandler
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} child - The Game Object being added.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.Group#removeCallbackHandler
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} child - The Game Object being removed.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.Group#setVelocity
     * @since 3.0.0
     *
     ...
     *
     * @return {Vsengine.Physics.Arcade.Group} This Physics Group object.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.Group#setVelocityX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Group#setVelocityY
     * @since 3.0.0
     *
     * @param {number} value - The velocity value.
