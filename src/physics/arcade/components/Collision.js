 ...
 *
 * @namespace Vsengine.Physics.Arcade.Components.Collision
 * @since 3.70.0
 */
var Collision = {
    /**
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Collision#setCollisionCategory
     * @since 3.70.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Collision#willCollideWith
     * @since 3.70.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Collision#addCollidesWith
     * @since 3.70.0
     *
     ...
     * Arcade Physics Body will collide with.
     *
     * @method Vsengine.Physics.Arcade.Components.Collision#removeCollidesWith
     * @since 3.70.0
     *
     * @param {number} category - The collision category to add.
     *
     ...
     * the `resetCollisionCategory` method.
     *
     * @method Vsengine.Physics.Arcade.Components.Collision#setCollidesWith
     * @since 3.70.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Collision#resetCollisionCategory
     * @since 3.70.0
     *
     * @return {this} This Game Object.
     */
