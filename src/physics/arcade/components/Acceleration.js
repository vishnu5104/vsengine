 ...
 *
 * @namespace Vsengine.Physics.Arcade.Components.Acceleration
 * @since 3.0.0
 */
var Acceleration = {
    /**
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Acceleration#setAcceleration
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Acceleration#setAccelerationX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Acceleration#setAccelerationY
     * @since 3.0.0
     *
