 ...
 *
 * @namespace Vsengine.Physics.Arcade.Components.Friction
 * @since 3.0.0
 *
 * @see Vsengine.Physics.Arcade.Body#friction
 */
var Friction = {
    /**
     ...
     * In Arcade Physics, friction is a special case of motion transfer from an "immovable" body to a riding body.
     *
     * @method Vsengine.Physics.Arcade.Components.Friction#setFriction
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Friction#setFrictionX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Friction#setFrictionY
     * @since 3.0.0
     *
