 ...
 *
 * @namespace Vsengine.Physics.Arcade.Components.Enable
 * @since 3.0.0
 */
var Enable = {
    /**
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Enable#setDirectControl
     * @since 3.70.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Enable#enableBody
     * @since 3.0.0
     *
     ...
     * @return {this} This Game Object.
     *
     * @see Vsengine.Physics.Arcade.Body#enable
     * @see Vsengine.Physics.Arcade.StaticBody#enable
     * @see Vsengine.Physics.Arcade.Body#reset
     * @see Vsengine.Physics.Arcade.StaticBody#reset
     * @see Vsengine.GameObjects.GameObject#active
     * @see Vsengine.GameObjects.GameObject#visible
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Enable#disableBody
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Enable#refreshBody
     * @since 3.1.0
     *
     * @return {this} This Game Object.
     *
