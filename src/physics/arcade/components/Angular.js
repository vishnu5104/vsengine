 ...
 *
 * @namespace Vsengine.Physics.Arcade.Components.Angular
 * @since 3.0.0
 */
var Angular = {
    /**
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Angular#setAngularVelocity
     * @since 3.0.0
     *
     ...
     * causing them to visually rotate, even though the body remains axis-aligned.
     *
     * @method Vsengine.Physics.Arcade.Components.Angular#setAngularAcceleration
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Angular#setAngularDrag
     * @since 3.0.0
     *
