 ...
 *
 * @namespace Vsengine.Physics.Arcade.Components.Size
 * @since 3.0.0
 */
var Size = {
    /**
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Size#setOffset
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Size#setSize
     * @since 3.0.0
     * @deprecated
     *
     ...
     * Sets the size of this physics body. Setting the size does not adjust the dimensions of the parent Game Object.
     *
     * @method Vsengine.Physics.Arcade.Components.Size#setBodySize
     * @since 3.24.0
     *
     * @param {number} width - The new width of the physics body, in pixels.
     * @param {number} height - The new height of the physics body, in pixels.
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Size#setCircle
     * @since 3.0.0
     *
