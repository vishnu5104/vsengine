 ...
 *
 * @namespace Vsengine.Physics.Arcade.Components.Gravity
 * @since 3.0.0
 */
var Gravity = {
    /**
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Gravity#setGravity
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Gravity#setGravityX
     * @since 3.0.0
     *
     * @param {number} x - The gravitational force to be applied to the X-axis.
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Gravity#setGravityY
     * @since 3.0.0
     *
