 ...
 *
 * @namespace Vsengine.Physics.Arcade.Components.Bounce
 * @since 3.0.0
 */
var Bounce = {
    /**
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Bounce#setBounce
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Bounce#setBounceX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Bounce#setBounceY
     * @since 3.0.0
     *
     ...
     *
     * Optionally also sets the World Bounce values. If the `Body.worldBounce` is null, it's set to a new Vsengine.Math.Vector2 first.
     *
     * @method Vsengine.Physics.Arcade.Components.Bounce#setCollideWorldBounds
     * @since 3.0.0
     *
