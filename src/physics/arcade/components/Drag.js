 ...
 *
 * @namespace Vsengine.Physics.Arcade.Components.Drag
 * @since 3.0.0
 */
var Drag = {
    /**
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Drag#setDrag
     * @since 3.0.0
     *
     ...
     * Drag is applied only when `acceleration` is zero.
     *
     * @method Vsengine.Physics.Arcade.Components.Drag#setDragX
     * @since 3.0.0
     *
     ...
     * Drag is applied only when `acceleration` is zero.
     *
     * @method Vsengine.Physics.Arcade.Components.Drag#setDragY
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Drag#setDamping
     * @since 3.10.0
     *
