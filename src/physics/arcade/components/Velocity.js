 ...
 *
 * @namespace Vsengine.Physics.Arcade.Components.Velocity
 * @since 3.0.0
 */
var Velocity = {
    /**
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Velocity#setVelocity
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Velocity#setVelocityX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Velocity#setVelocityY
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Velocity#setMaxVelocity
     * @since 3.0.0
     *
