 ...
 *
 * @namespace Vsengine.Physics.Arcade.Components.Debug
 * @since 3.0.0
 */
var Debug = {
    /**
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Debug#setDebug
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Components.Debug#setDebugBodyColor
     * @since 3.0.0
     *
     ...
     *
     * @name Vsengine.Physics.Arcade.Components.Debug#debugShowBody
     * @type {boolean}
     * @since 3.0.0
     */
    debugShowBody: {
     ...
     *
     * @name Vsengine.Physics.Arcade.Components.Debug#debugShowVelocity
     * @type {boolean}
     * @since 3.0.0
     */
    debugShowVelocity: {
     ...
     *
     * @name Vsengine.Physics.Arcade.Components.Debug#debugBodyColor
     * @type {number}
     * @since 3.0.0
     */
    debugBodyColor: {
