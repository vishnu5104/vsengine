 ...
 *
 * @function Vsengine.Physics.Arcade.GetOverlapX
 * @since 3.0.0
 *
 * @param {Vsengine.Physics.Arcade.Body} body1 - The first Body to separate.
 * @param {Vsengine.Physics.Arcade.Body} body2 - The second Body to separate.
...
var GetOverlapX = function (body1, body2, overlapOnly, bias) {
    ...
    if (body1._dx === 0 && body2._dx === 0) {
        ...
        if (
            (overlap > maxOverlap && !overlapOnly) ||
