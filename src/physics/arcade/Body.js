 ...
 *
 * Its static counterpart is {@link Vsengine.Physics.Arcade.StaticBody}.
 *
 * @class Body
 ...
 *
 * @param {Vsengine.Physics.Arcade.World} world - The Arcade Physics simulation this Body belongs to.
 * @param {Vsengine.GameObjects.GameObject} [gameObject] - The Game Object this Body belongs to. As of Vsengine 3.60 this is now optional.
 */
var Body = new Class({
    ...
    initialize: function Body(world, gameObject) {
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#world
         ...
         *
         * As of Vsengine 3.60 this is now optional and can be undefined.
         *
         * @name Vsengine.Physics.Arcade.Body#gameObject
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#isBody
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#transform
         * @type {object}
         * @since 3.4.0
         */
        this.transform = {
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#debugShowBody
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#debugShowVelocity
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#debugBodyColor
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#enable
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#isCircle
         * @type {boolean}
         * @default false
         * @since 3.0.0
         * @see Vsengine.Physics.Arcade.Body#setCircle
         */
        this.isCircle = false;
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#radius
         * @type {number}
         * @default 0
         * @since 3.0.0
         * @see Vsengine.Physics.Arcade.Body#setCircle
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#offset
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         * @see Vsengine.Physics.Arcade.Body#setOffset
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#position
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#prev
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#prevFrame
         * @type {Vsengine.Math.Vector2}
         * @since 3.20.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#allowRotation
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#rotation
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#preRotation
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#width
         * @type {number}
         * @readonly
         * @default 64
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#height
         * @type {number}
         * @readonly
         * @default 64
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#sourceWidth
         * @type {number}
         * @since 3.0.0
         * @see Vsengine.Physics.Arcade.Body#setSize
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#sourceHeight
         * @type {number}
         * @since 3.0.0
         * @see Vsengine.Physics.Arcade.Body#setSize
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#halfWidth
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#halfHeight
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#center
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#velocity
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#newVelocity
         * @type {Vsengine.Math.Vector2}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#deltaMax
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#acceleration
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#allowDrag
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#drag
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#allowGravity
         * @type {boolean}
         * @default true
         * @since 3.0.0
         * @see Vsengine.Physics.Arcade.Body#gravity
         * @see Vsengine.Physics.Arcade.World#gravity
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#gravity
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         * @see Vsengine.Physics.Arcade.World#gravity
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#bounce
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#worldBounce
         * @type {?Vsengine.Math.Vector2}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#customBoundsRectangle
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#onWorldBounds
         * @type {boolean}
         * @default false
         * @since 3.0.0
         * @see Vsengine.Physics.Arcade.World#WORLD_BOUNDS
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#onCollide
         * @type {boolean}
         * @default false
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#onOverlap
         * @type {boolean}
         * @default false
         * @since 3.0.0
         * @see Vsengine.Physics.Arcade.World#OVERLAP
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#maxVelocity
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#maxSpeed
         * @type {number}
         * @default -1
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#friction
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         */
         ...
         * deceleration.
         *
         * @name Vsengine.Physics.Arcade.Body#useDamping
         * @type {boolean}
         * @default false
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#angularVelocity
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#angularAcceleration
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#angularDrag
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#maxAngular
         * @type {number}
         * @default 1000
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#mass
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#angle
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#speed
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#facing
         * @type {number}
         * @since 3.0.0
         *
         * @see Vsengine.Physics.Arcade.FACING_UP
         * @see Vsengine.Physics.Arcade.FACING_DOWN
         * @see Vsengine.Physics.Arcade.FACING_LEFT
         * @see Vsengine.Physics.Arcade.FACING_RIGHT
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#immovable
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#pushable
         * @type {boolean}
         * @default true
         * @since 3.50.0
         * @see Vsengine.GameObjects.Components.Pushable#setPushable
         */
        this.pushable = true;
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#slideFactor
         * @type {Vsengine.Math.Vector2}
         * @since 3.70.0
         * @see Vsengine.GameObjects.Components.Pushable#setSlideFactor
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#moves
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#customSeparateX
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         * Pass your own `collideCallback` to the collider.
         *
         * @name Vsengine.Physics.Arcade.Body#customSeparateY
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#overlapX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#overlapY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#overlapR
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#embedded
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#collideWorldBounds
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#checkCollision
         * @type {Vsengine.Types.Physics.Arcade.ArcadeBodyCollision}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#touching
         * @type {Vsengine.Types.Physics.Arcade.ArcadeBodyCollision}
         * @since 3.0.0
         *
         * @see Vsengine.Physics.Arcade.Body#blocked
         * @see Vsengine.Physics.Arcade.Body#embedded
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#wasTouching
         * @type {Vsengine.Types.Physics.Arcade.ArcadeBodyCollision}
         * @since 3.0.0
         *
         * @see Vsengine.Physics.Arcade.Body#touching
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#blocked
         * @type {Vsengine.Types.Physics.Arcade.ArcadeBodyCollision}
         * @since 3.0.0
         *
         * @see Vsengine.Physics.Arcade.Body#embedded
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#syncBounds
         * @type {boolean}
         * @default false
         * @since 3.0.0
         * @see Vsengine.GameObjects.Components.GetBounds#getBounds
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#physicsType
         * @type {number}
         * @readonly
         * @default Vsengine.Physics.Arcade.DYNAMIC_BODY
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#collisionCategory
         * @type {number}
         * @since 3.70.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#collisionMask
         * @type {number}
         * @since 3.70.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#_sx
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#_sy
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#_dx
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#_dy
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#_tx
         * @type {number}
         * @private
         * @default 0
         * @since 3.22.0
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#_ty
         * @type {number}
         * @private
         * @default 0
         * @since 3.22.0
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#_bounds
         * @type {Vsengine.Geom.Rectangle}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#directControl
         * @type {boolean}
         * @since 3.70.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.Body#autoFrame
         * @type {Vsengine.Math.Vector2}
         * @private
         * @since 3.70.0
         */
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#updateBounds
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#updateCenter
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#updateFromGameObject
     * @since 3.24.0
     */
    updateFromGameObject: function () {
        ...
        this.position.x =
            transform.x +
            transform.scaleX * (this.offset.x - transform.displayOriginX);
        this.position.y =
            transform.y +
            transform.scaleY * (this.offset.y - transform.displayOriginY);
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#resetFlags
     * @since 3.18.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#preUpdate
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#update
     * @fires Vsengine.Physics.Arcade.Events#WORLD_BOUNDS
     * @since 3.0.0
     *
     * @param {number} delta - The delta time, in seconds, elapsed since the last frame.
     */
     ...
     * This method is called every game frame, regardless if the world steps or not.
     *
     * @method Vsengine.Physics.Arcade.Body#postUpdate
     * @since 3.0.0
     */
    postUpdate: function () {
        var pos = this.position;
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setBoundsRectangle
     * @since 3.20
     *
     * @param {?Vsengine.Geom.Rectangle} [bounds] - The new boundary rectangle. Pass `null` to use the World bounds.
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#checkWorldBounds
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setGameObject
     * @since 3.60.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - The Game Object this Body belongs to.
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setSize
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setCircle
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#reset
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#stop
     * @since 3.0.0
     *
     * @return {Vsengine.Physics.Arcade.Body} This Body object.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#getBounds
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Physics.Arcade.ArcadeBodyBounds} obj - An object to copy the values into.
     *
     * @return {Vsengine.Types.Physics.Arcade.ArcadeBodyBounds} - An object with {x, y, right, bottom}.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#hitTest
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#onFloor
     * @since 3.0.0
     * @see Vsengine.Physics.Arcade.Body#blocked
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#onCeiling
     * @since 3.0.0
     * @see Vsengine.Physics.Arcade.Body#blocked
     *
     * @return {boolean} True if touching.
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#onWall
     * @since 3.0.0
     * @see Vsengine.Physics.Arcade.Body#blocked
     *
     * @return {boolean} True if touching.
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#deltaAbsX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#deltaAbsY
     * @since 3.0.0
     *
     * @return {number} The delta value.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#deltaX
     * @since 3.0.0
     *
     * @return {number} The delta value.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#deltaY
     * @since 3.0.0
     *
     * @return {number} The delta value.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#deltaXFinal
     * @since 3.22.0
     *
     ...
     * will represent the delta from the _previous_ game frame.
     *
     * @method Vsengine.Physics.Arcade.Body#deltaYFinal
     * @since 3.22.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#deltaZ
     * @since 3.0.0
     *
     * @return {number} The delta value.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.enable = false;
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#drawDebug
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.Graphics} graphic - The Graphics object to draw on.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#willDrawDebug
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setDirectControl
     * @since 3.70.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setCollideWorldBounds
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setVelocity
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setVelocityX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setVelocityY
     * @since 3.0.0
     *
     * @param {number} value - The velocity, in pixels per second.
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setMaxVelocity
     * @since 3.10.0
     *
     * @param {number} x - The horizontal velocity, in pixels per second.
     * @param {number} [y=x] - The vertical velocity, in pixels per second.
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setMaxVelocityX
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setMaxVelocityY
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setMaxSpeed
     * @since 3.16.0
     *
     ...
     * can combine this with the `setDrag()` method to create deceleration.
     *
     * @method Vsengine.Physics.Arcade.Body#setSlideFactor
     * @since 3.70.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setBounce
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setBounceX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setBounceY
     * @since 3.0.0
     *
     * @param {number} value - The bounce, relative to 1.
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setAcceleration
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setAccelerationX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setAccelerationY
     * @since 3.0.0
     *
     * @param {number} value - The acceleration, in pixels per second squared.
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setAllowDrag
     * @since 3.9.0
     * @see Vsengine.Physics.Arcade.Body#allowDrag
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setAllowGravity
     * @since 3.9.0
     * @see Vsengine.Physics.Arcade.Body#allowGravity
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setAllowRotation
     * @since 3.9.0
     * @see Vsengine.Physics.Arcade.Body#allowRotation
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setDrag
     * @since 3.0.0
     *
     * @param {number} x - The horizontal component, in pixels per second squared.
     * @param {number} [y=x] - The vertical component, in pixels per second squared.
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setDamping
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setDragX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setDragY
     * @since 3.0.0
     *
     * @param {number} value - The drag, in pixels per second squared.
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setGravity
     * @since 3.0.0
     *
     * @param {number} x - The horizontal component, in pixels per second squared.
     * @param {number} [y=x] - The vertical component, in pixels per second squared.
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setGravityX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setGravityY
     * @since 3.0.0
     *
     * @param {number} value - The gravity, in pixels per second squared.
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setFriction
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setFrictionX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setFrictionY
     * @since 3.0.0
     *
     * @param {number} value - The friction value, relative to 1.
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setAngularVelocity
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setAngularAcceleration
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setAngularDrag
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setMass
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setImmovable
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#setEnable
     * @since 3.15.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.Body#processX
     * @since 3.50.0
     *
     ...
     * of the collision step. You should almost never call this directly.
     *
     * @method Vsengine.Physics.Arcade.Body#processY
     * @since 3.50.0
     *
     ...
     *
     * @name Vsengine.Physics.Arcade.Body#x
     * @type {number}
     * @since 3.0.0
     */
    x: {
     ...
     *
     * @name Vsengine.Physics.Arcade.Body#y
     * @type {number}
     * @since 3.0.0
     */
    y: {
     ...
     *
     * @name Vsengine.Physics.Arcade.Body#left
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Physics.Arcade.Body#right
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Physics.Arcade.Body#top
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Physics.Arcade.Body#bottom
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
