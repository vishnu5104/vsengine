 ...
 *
 * An instance of the World belongs to a Vsengine.Scene and is accessed via the property `physics.world`.
 *
 * @class World
 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - The Scene to which this World instance belongs.
 * @param {Vsengine.Types.Physics.Arcade.ArcadeWorldConfig} config - An Arcade Physics Configuration object.
 */
var World = new Class({
    ...
    initialize: function World(scene, config) {
         ...
         *
         * @name Vsengine.Physics.Arcade.World#scene
         * @type {Vsengine.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name Vsengine.Physics.Arcade.World#bodies
         * @type {Vsengine.Structs.Set.<Vsengine.Physics.Arcade.Body>}
         * @since 3.0.0
         */
        this.bodies = new Set();
         ...
         *
         * @name Vsengine.Physics.Arcade.World#staticBodies
         * @type {Vsengine.Structs.Set.<Vsengine.Physics.Arcade.StaticBody>}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#pendingDestroy
         * @type {Vsengine.Structs.Set.<(Vsengine.Physics.Arcade.Body|Vsengine.Physics.Arcade.StaticBody)>}
         * @since 3.1.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#colliders
         * @type {Vsengine.Structs.ProcessQueue.<Vsengine.Physics.Arcade.Collider>}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#gravity
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         */
        this.gravity = new Vector2(
            GetValue(config, "gravity.x", 0),
            GetValue(config, "gravity.y", 0)
        );

        /**
         * A boundary constraining Bodies.
         *
         * @name Vsengine.Physics.Arcade.World#bounds
         ...
         *
         * @name Vsengine.Physics.Arcade.World#checkCollision
         * @type {Vsengine.Types.Physics.Arcade.CheckCollisionObject}
         * @since 3.0.0
         */
        this.checkCollision = {
         ...
         *
         * @name Vsengine.Physics.Arcade.World#fps
         * @readonly
         * @type {number}
         * @default 60
         * @since 3.10.0
         ...
         *
         * @name Vsengine.Physics.Arcade.World#fixedStep
         * @type {boolean}
         * @default true
         * @since 3.23.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#_elapsed
         * @private
         * @type {number}
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#_frameTime
         * @private
         * @type {number}
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#_frameTimeMS
         * @private
         * @type {number}
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#stepsLastFrame
         * @readonly
         * @type {number}
         * @since 3.10.0
         */
         ...
         * - 0.5 = double speed
         *
         * @name Vsengine.Physics.Arcade.World#timeScale
         * @type {number}
         * @default 1
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#OVERLAP_BIAS
         * @type {number}
         * @default 4
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#TILE_BIAS
         * @type {number}
         * @default 16
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#forceX
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#isPaused
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#_total
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Physics.Arcade.World#drawDebug
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#debugGraphic
         * @type {Vsengine.GameObjects.Graphics}
         * @since 3.0.0
         */
        this.debugGraphic;
         ...
         *
         * @name Vsengine.Physics.Arcade.World#defaults
         * @type {Vsengine.Types.Physics.Arcade.ArcadeWorldDefaults}
         * @since 3.0.0
         */
        this.defaults = {
            ...
            staticBodyDebugColor: GetValue(
                config,
                "debugStaticBodyColor",
                0x0000ff
            ),
            velocityDebugColor: GetValue(
                config,
                "debugVelocityColor",
                0x00ff00
            ),
         ...
         *
         * @name Vsengine.Physics.Arcade.World#maxEntries
         * @type {number}
         * @default 16
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#useTree
         * @type {boolean}
         * @default true
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#tree
         * @type {Vsengine.Structs.RTree}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#staticTree
         * @type {Vsengine.Structs.RTree}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#treeMinMax
         * @type {Vsengine.Types.Physics.Arcade.ArcadeWorldTreeMinMax}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#_tempMatrix
         ...
         * A temporary Transform Matrix used by bodies for calculations without them needing their own local copy.
         *
         * @name Vsengine.Physics.Arcade.World#_tempMatrix2
         * @type {Vsengine.GameObjects.Components.TransformMatrix}
         * @private
         * @since 3.12.0
         */
         ...
         *
         * @name Vsengine.Physics.Arcade.World#tileFilterOptions
         * @type {Vsengine.Types.Tilemaps.FilteringOptions}
         * @since 3.60.0
         */
        this.tileFilterOptions = {
            isColliding: true,
            isNotEmpty: true,
     ...
     *
     * @method Vsengine.Physics.Arcade.World#enable
     * @since 3.0.0
     *
     * @param {(Vsengine.GameObjects.GameObject|Vsengine.GameObjects.GameObject[]|Vsengine.GameObjects.Group|Vsengine.GameObjects.Group[])} object - The object, or objects, on which to create the bodies.
     ...
     * method to have their bodies created.
     *
     * @method Vsengine.Physics.Arcade.World#enableBody
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} object - The Game Object on which to create the body.
     * @param {number} [bodyType] - The type of Body to create. Either `DYNAMIC_BODY` or `STATIC_BODY`.
     *
     * @return {Vsengine.GameObjects.GameObject} The Game Object on which the body was created.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.World#add
     * @since 3.10.0
     *
     * @param {(Vsengine.Physics.Arcade.Body|Vsengine.Physics.Arcade.StaticBody)} body - The Body to be added to the simulation.
     *
     * @return {(Vsengine.Physics.Arcade.Body|Vsengine.Physics.Arcade.StaticBody)} The Body that was added to the simulation.
     */
    add: function (body) {
     ...
     *
     * @method Vsengine.Physics.Arcade.World#disable
     * @since 3.0.0
     *
     * @param {(Vsengine.GameObjects.GameObject|Vsengine.GameObjects.GameObject[]|Vsengine.GameObjects.Group|Vsengine.GameObjects.Group[])} object - The object, or objects, on which to disable the bodies.
     */
     ...
     * means you can re-enable it again at any point by passing it to enable `World.enable` or `World.add`.
     *
     * @method Vsengine.Physics.Arcade.World#disableBody
     * @since 3.0.0
     *
     * @param {(Vsengine.Physics.Arcade.Body|Vsengine.Physics.Arcade.StaticBody)} body - The Body to be disabled.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.World#remove
     * @since 3.0.0
     *
     * @param {(Vsengine.Physics.Arcade.Body|Vsengine.Physics.Arcade.StaticBody)} body - The body to be removed from the simulation.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.World#createDebugGraphic
     * @since 3.0.0
     *
     * @return {Vsengine.GameObjects.Graphics} The Graphics object that was created for use by the World.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.World#setBounds
     * @since 3.0.0
     *
     ...
     *
     * @return {Vsengine.Physics.Arcade.World} This World object.
     */
    setBounds: function (
        x,
        y,
     ...
     *
     * @method Vsengine.Physics.Arcade.World#setBoundsCollision
     * @since 3.0.0
     *
     ...
     * checks.
     *
     * @method Vsengine.Physics.Arcade.World#pause
     * @fires Vsengine.Physics.Arcade.Events#PAUSE
     * @since 3.0.0
     *
     * @return {Vsengine.Physics.Arcade.World} This World object.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.World#resume
     * @fires Vsengine.Physics.Arcade.Events#RESUME
     * @since 3.0.0
     *
     * @return {Vsengine.Physics.Arcade.World} This World object.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.World#addCollider
     * @since 3.0.0
     * @see Vsengine.Physics.Arcade.World#collide
     *
     ...
     * as it will be handled for you automatically.
     *
     * @method Vsengine.Physics.Arcade.World#addOverlap
     * @since 3.0.0
     *
     ...
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [collideCallback] - The callback to invoke when the two objects overlap.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - The callback to invoke when the two objects overlap. Must return a boolean.
     * @param {*} [callbackContext] - The scope in which to call the callbacks.
     *
     * @return {Vsengine.Physics.Arcade.Collider} The Collider that was created.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.World#removeCollider
     * @since 3.0.0
     *
     * @param {Vsengine.Physics.Arcade.Collider} collider - The Collider to remove from the simulation.
     *
     * @return {Vsengine.Physics.Arcade.World} This World object.
     */
     ...
     *
     * @method Vsengine.Physics.Arcade.World#setFPS
     * @since 3.10.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.World#update
     * @fires Vsengine.Physics.Arcade.Events#WORLD_STEP
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.World#step
     * @fires Vsengine.Physics.Arcade.Events#WORLD_STEP
     * @since 3.10.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.World#singleStep
     * @fires Vsengine.Physics.Arcade.Events#WORLD_STEP
     * @since 3.70.0
     */
    singleStep: function () {
     ...
     *
     * @method Vsengine.Physics.Arcade.World#postUpdate
     * @since 3.0.0
     */
    postUpdate: function () {
        var i;
     ...
     *
     * @method Vsengine.Physics.Arcade.World#updateMotion
     * @since 3.0.0
     *
     * @param {Vsengine.Physics.Arcade.Body} body - The Body to be updated.
     ...
     *
     * @method Vsengine.Physics.Arcade.World#computeAngularVelocity
     * @since 3.10.0
     *
     * @param {Vsengine.Physics.Arcade.Body} body - The Body to compute the velocity for.
     ...
     *
     * @method Vsengine.Physics.Arcade.World#computeVelocity
     * @since 3.0.0
     *
     * @param {Vsengine.Physics.Arcade.Body} body - The Body to compute the velocity for.
     * @param {number} delta - The delta value to be used in the calculation, in seconds.
     ...
     *
     * @method Vsengine.Physics.Arcade.World#separate
     * @fires Vsengine.Physics.Arcade.Events#COLLIDE
     * @fires Vsengine.Physics.Arcade.Events#OVERLAP
     * @since 3.0.0
     *
     * @param {Vsengine.Physics.Arcade.Body} body1 - The first Body to be separated.
     * @param {Vsengine.Physics.Arcade.Body} body2 - The second Body to be separated.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - The process callback.
    ...
    separate: function (
        ...
        if (
            ...
            processCallback.call(
                callbackContext,
                body1.gameObject || body1,
                body2.gameObject || body2
            ) === false
        ) {
            return result;
        }
     ...
     *
     * @method Vsengine.Physics.Arcade.World#separateCircle
     * @fires Vsengine.Physics.Arcade.Events#COLLIDE
     * @fires Vsengine.Physics.Arcade.Events#OVERLAP
     * @since 3.0.0
     *
    ...
    separateCircle: function (body1, body2, overlapOnly) {
        ...
        if (body1IsCircle !== body2IsCircle) {
            ...
            if (circleY < rectY) {
                if (circleX < rectX) {
                    overlap =
                        DistanceBetween(circleX, circleY, rectX, rectY) -
                        circleRadius;
                } else if (circleX > rectRight) {
                    overlap =
                        DistanceBetween(circleX, circleY, rectRight, rectY) -
                        circleRadius;
                }
            } else if (circleY > rectBottom) {
                if (circleX < rectX) {
                    overlap =
                        DistanceBetween(circleX, circleY, rectX, rectBottom) -
                        circleRadius;
                } else if (circleX > rectRight) {
                    overlap =
                        DistanceBetween(
            ...
            overlap =
                body1.halfWidth +
                body2.halfWidth -
                DistanceBetweenPoints(body1Center, body2Center);
        }
     ...
     *
     * @method Vsengine.Physics.Arcade.World#intersects
     * @since 3.0.0
     *
     * @param {Vsengine.Physics.Arcade.Body} body1 - The first body to check.
     * @param {Vsengine.Physics.Arcade.Body} body2 - The second body to check.
     *
    ...
    intersects: function (body1, body2) {
        ...
        if (!body1.isCircle && !body2.isCircle) {
            ...
            if (body2.isCircle) {
                //  Circle vs. Circle
                return (
                    DistanceBetweenPoints(body1.center, body2.center) <=
     ...
     *
     * @method Vsengine.Physics.Arcade.World#circleBodyIntersects
     * @since 3.0.0
     *
     * @param {Vsengine.Physics.Arcade.Body} circle - The circular body to test.
     * @param {Vsengine.Physics.Arcade.Body} body - The rectangular body to test.
     *
     * @return {boolean} True if the two bodies intersect, otherwise false.
     */
     ...
     *
     * See details in {@link Vsengine.Physics.Arcade.World#collide}.
     *
     * @method Vsengine.Physics.Arcade.World#overlap
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Physics.Arcade.ArcadeColliderType} object1 - The first object or array of objects to check.
     * @param {Vsengine.Types.Physics.Arcade.ArcadeColliderType} [object2] - The second object or array of objects to check, or `undefined`.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [overlapCallback] - An optional callback function that is called if the objects overlap.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - An optional callback function that lets you perform additional checks against the two objects if they overlap. If this is set then `overlapCallback` will only be called if this callback returns `true`.
     ...
     *
     * If you don't require separation then use {@link Vsengine.Physics.Arcade.World#overlap} instead.
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.World#collide
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Physics.Arcade.ArcadeColliderType} object1 - The first object or array of objects to check.
     * @param {Vsengine.Types.Physics.Arcade.ArcadeColliderType} [object2] - The second object or array of objects to check, or `undefined`.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [collideCallback] - An optional callback function that is called if the objects collide.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - An optional callback function that lets you perform additional checks against the two objects if they collide. If this is set then `collideCallback` will only be called if this callback returns `true`.
    ...
    /**
     * Internal helper function. Please use Vsengine.Physics.Arcade.World#collide instead.
     *
     * @method Vsengine.Physics.Arcade.World#collideObjects
     * @private
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Physics.Arcade.ArcadeColliderType} object1 - The first object to check for collision.
    ...
    /**
     * Internal helper function. Please use Vsengine.Physics.Arcade.World#collide and Vsengine.Physics.Arcade.World#overlap instead.
     *
     * @method Vsengine.Physics.Arcade.World#collideHandler
     * @private
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Physics.Arcade.ArcadeColliderType} object1 - The first object or array of objects to check.
    ...
    collideHandler: function (
        ...
        if (object2 === undefined && object1.isParent) {
            return this.collideGroupVsGroup(
                object1,
                object1,
                collideCallback,
                processCallback,
        ...
        if (object1.body || object1.isBody) {
            if (object2.body || object2.isBody) {
                ...
                return this.collideSpriteVsGroup(
                    object1,
                    object2,
                    collideCallback,
                    processCallback,
     ...
     *
     * @method Vsengine.Physics.Arcade.World#canCollide
     * @since 3.70.0
     *
     * @param {Vsengine.Types.Physics.Arcade.ArcadeCollider} body1 - The first body to check.
     * @param {Vsengine.Types.Physics.Arcade.ArcadeCollider} body2 - The second body to check.
     *
     ...
     * Please use Vsengine.Physics.Arcade.World#collide instead.
     *
     * @method Vsengine.Physics.Arcade.World#collideSpriteVsSprite
     * @private
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} sprite1 - The first object to check for collision.
     * @param {Vsengine.GameObjects.GameObject} sprite2 - The second object to check for collision.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [collideCallback] - An optional callback function that is called if the objects collide.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - An optional callback function that lets you perform additional checks against the two objects if they collide. If this is set then `collideCallback` will only be called if this callback returns `true`.
     * @param {any} [callbackContext] - The context in which to run the callbacks.
     * @param {boolean} overlapOnly - Whether this is a collision or overlap check.
     ...
     * Please use Vsengine.Physics.Arcade.World#collide instead.
     *
     * @method Vsengine.Physics.Arcade.World#collideSpriteVsGroup
     * @private
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} sprite - The first object to check for collision.
     * @param {Vsengine.GameObjects.Group} group - The second object to check for collision.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} collideCallback - The callback to invoke when the two objects collide.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} processCallback - The callback to invoke when the two objects collide. Must return a boolean.
     * @param {any} callbackContext - The scope in which to call the callbacks.
     * @param {boolean} overlapOnly - Whether this is a collision or overlap check.
    ...
    collideSpriteVsGroup: function (
        ...
        if (this.useTree || group.physicsType === CONST.STATIC_BODY) {
            ...
            var results =
                group.physicsType === CONST.DYNAMIC_BODY
            ...
            for (i = 0; i < len; i++) {
                ...
                if (
                    bodyA === bodyB ||
                    !bodyB.enable ||
                    bodyB.checkCollision.none ||
                    !group.contains(bodyB.gameObject)
                ) {
     ...
     * Please use Vsengine.Physics.Arcade.World#collide instead.
     *
     * @method Vsengine.Physics.Arcade.World#collideGroupVsTilemapLayer
     * @private
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.Group} group - The first object to check for collision.
     * @param {Vsengine.Tilemaps.TilemapLayer} tilemapLayer - The second object to check for collision.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} collideCallback - An optional callback function that is called if the objects collide.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} processCallback - An optional callback function that lets you perform additional checks against the two objects if they collide. If this is set then `collideCallback` will only be called if this callback returns `true`.
     * @param {any} callbackContext - The context in which to run the callbacks.
     * @param {boolean} overlapOnly - Whether this is a collision or overlap check.
     ...
     *
     * @method Vsengine.Physics.Arcade.World#collideTiles
     * @fires Vsengine.Physics.Arcade.Events#TILE_COLLIDE
     * @since 3.17.0
     *
     * @param {Vsengine.GameObjects.GameObject} sprite - The first object to check for collision.
     * @param {Vsengine.Tilemaps.Tile[]} tiles - An array of Tiles to check for collision against.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [collideCallback] - An optional callback function that is called if the objects collide.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - An optional callback function that lets you perform additional checks against the two objects if they collide. If this is set then `collideCallback` will only be called if this callback returns `true`.
     * @param {any} [callbackContext] - The context in which to run the callbacks.
     *
    ...
    collideTiles: function (
        ...
        if (
            tiles.length === 0 ||
            (sprite.body && !sprite.body.enable) ||
            (sprite.isBody && !sprite.enable)
        ) {
            return false;
        } else {
     ...
     * This method does not factor in the Collision Mask or Category.
     *
     * @method Vsengine.Physics.Arcade.World#overlapTiles
     * @fires Vsengine.Physics.Arcade.Events#TILE_OVERLAP
     * @since 3.17.0
     *
     * @param {Vsengine.GameObjects.GameObject} sprite - The first object to check for collision.
     * @param {Vsengine.Tilemaps.Tile[]} tiles - An array of Tiles to check for collision against.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [collideCallback] - An optional callback function that is called if the objects overlap.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - An optional callback function that lets you perform additional checks against the two objects if they collide. If this is set then `collideCallback` will only be called if this callback returns `true`.
     * @param {any} [callbackContext] - The context in which to run the callbacks.
     *
     * @return {boolean} True if any objects overlap (with `overlapOnly`); or true if any overlapping objects were separated.
     */
    overlapTiles: function (
        sprite,
        tiles,
        collideCallback,
        processCallback,
     ...
     * Please use Vsengine.Physics.Arcade.World#collide instead.
     *
     * @method Vsengine.Physics.Arcade.World#collideSpriteVsTilemapLayer
     * @fires Vsengine.Physics.Arcade.Events#TILE_COLLIDE
     * @fires Vsengine.Physics.Arcade.Events#TILE_OVERLAP
     * @since 3.0.0
     *
    ...
    collideSpriteVsTilemapLayer: function (
        ...
        if (
            ...
            !this.canCollide(body, tilemapLayer)
        ) {
            return false;
        }
        ...
        var mapData = GetTilesWithinWorldXY(
            x,
            y,
            w,
            h,
            options,
            tilemapLayer.scene.cameras.main,
            tilemapLayer.layer
        );
     ...
     * Please use Vsengine.Physics.Arcade.World#collide instead.
     *
     * @method Vsengine.Physics.Arcade.World#collideSpriteVsTilesHandler
     * @fires Vsengine.Physics.Arcade.Events#TILE_COLLIDE
     * @fires Vsengine.Physics.Arcade.Events#TILE_OVERLAP
     * @private
     * @since 3.17.0
     ...
     * @return {boolean} True if any objects overlap (with `overlapOnly`); or true if any overlapping objects were separated.
     */
    collideSpriteVsTilesHandler: function (
        sprite,
        tiles,
        collideCallback,
        processCallback,
        ...
        for (var i = 0; i < tiles.length; i++) {
            ...
            tileWorldRect.right =
                tileWorldRect.left + tile.width * tilemapLayer.scaleX;
            tileWorldRect.bottom =
                tileWorldRect.top + tile.height * tilemapLayer.scaleY;

            if (
                TileIntersectsBody(tileWorldRect, body) &&
                (!processCallback ||
                    processCallback.call(callbackContext, sprite, tile)) &&
     ...
     * Please use Vsengine.Physics.Arcade.World#collide instead.
     *
     * @method Vsengine.Physics.Arcade.World#collideGroupVsGroup
     * @private
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.Group} group1 - The first object to check for collision.
     * @param {Vsengine.GameObjects.Group} group2 - The second object to check for collision.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [collideCallback] - An optional callback function that is called if the objects collide.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - An optional callback function that lets you perform additional checks against the two objects if they collide. If this is set then `collideCallback` will only be called if this callback returns `true`.
     * @param {any} [callbackContext] - The context in which to run the callbacks.
     * @param {boolean} overlapOnly - Whether this is a collision or overlap check.
    ...
    /**
     * Wrap an object's coordinates (or several objects' coordinates) within {@link Vsengine.Physics.Arcade.World#bounds}.
     *
     * If the object is outside any boundary edge (left, top, right, bottom), it will be moved to the same offset from the opposite edge (the interior).
     *
     * @method Vsengine.Physics.Arcade.World#wrap
     * @since 3.3.0
     *
    ...
    /**
     * Wrap each object's coordinates within {@link Vsengine.Physics.Arcade.World#bounds}.
     *
     * @method Vsengine.Physics.Arcade.World#wrapArray
     * @since 3.3.0
     *
    ...
    /**
     * Wrap an object's coordinates within {@link Vsengine.Physics.Arcade.World#bounds}.
     *
     * @method Vsengine.Physics.Arcade.World#wrapObject
     * @since 3.3.0
     *
     ...
     *
     * @method Vsengine.Physics.Arcade.World#shutdown
     * @since 3.0.0
     */
    shutdown: function () {
        this.tree.clear();
     ...
     *
     * @method Vsengine.Physics.Arcade.World#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.shutdown();
