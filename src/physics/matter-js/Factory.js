 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Physics.Matter.World} world - The Matter World which this Factory adds to.
 */
var Factory = new Class({
    initialize: function Factory(world) {
         ...
         *
         * @name Vsengine.Physics.Matter.Factory#world
         ...
         *
         * @name Vsengine.Physics.Matter.Factory#scene
         * @type {Vsengine.Scene}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Matter.Factory#sys
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#rectangle
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#trapezoid
     * @since 3.0.0
     *
     * @param {number} x - The X coordinate of the center of the Body.
     * @param {number} y - The Y coordinate of the center of the Body.
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#circle
     * @since 3.0.0
     *
     * @param {number} x - The X coordinate of the center of the Body.
     * @param {number} y - The Y coordinate of the center of the Body.
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#polygon
     * @since 3.0.0
     *
     * @param {number} x - The X coordinate of the center of the Body.
     * @param {number} y - The Y coordinate of the center of the Body.
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#fromVertices
     * @since 3.0.0
     *
     * @param {number} x - The X coordinate of the center of the Body.
     * @param {number} y - The Y coordinate of the center of the Body.
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#fromPhysicsEditor
     * @since 3.22.0
     *
     ...
     * ```
     *
     * @method Vsengine.Physics.Matter.Factory#fromSVG
     * @since 3.22.0
     *
     ...
     * ```
     *
     * At the time of writing, only the Vsengine Physics Tracer App exports in this format.
     *
     * @method Vsengine.Physics.Matter.Factory#fromJSON
     * @since 3.22.0
     *
     * @param {number} x - The X coordinate of the body.
     * @param {number} y - The Y coordinate of the body.
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#imageStack
     * @since 3.0.0
     *
     ...
     * This function uses the body bounds to prevent overlaps.
     *
     * @method Vsengine.Physics.Matter.Factory#stack
     * @since 3.0.0
     *
     * @param {number} x - The horizontal position of this composite in the world.
     * @param {number} y - The vertical position of this composite in the world.
     ...
     * This function uses the body bounds to prevent overlaps.
     *
     * @method Vsengine.Physics.Matter.Factory#pyramid
     * @since 3.0.0
     *
     * @param {number} x - The horizontal position of this composite in the world.
     * @param {number} y - The vertical position of this composite in the world.
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#chain
     * @since 3.0.0
     *
     ...
     * @param {Vsengine.Types.Physics.Matter.MatterConstraintConfig} [options] - An optional Constraint configuration object that is used to set initial Constraint properties on creation.
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#mesh
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#newtonsCradle
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#car
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#softBody
     * @since 3.0.0
     *
     * @param {number} x - The horizontal position of this composite in the world.
     * @param {number} y - The vertical position of this composite in the world.
     ...
     * @param {Vsengine.Types.Physics.Matter.MatterBodyConfig} [particleOptions] - An optional Body configuration object that is used to set initial Body properties on creation.
     * @param {Vsengine.Types.Physics.Matter.MatterConstraintConfig} [constraintOptions] - An optional Constraint configuration object that is used to set initial Constraint properties on creation.
     *
    ...
    softBody: function (
        ...
        var composite = Composites.softBody(
            x,
            y,
            columns,
            rows,
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#joint
     * @since 3.0.0
     *
     ...
     * For compound bodies, constraints must be applied to the parent body and not one of its parts.
     *
     * @method Vsengine.Physics.Matter.Factory#spring
     * @since 3.0.0
     *
     * @param {MatterJS.BodyType} bodyA - The first possible `Body` that this constraint is attached to.
     * @param {MatterJS.BodyType} bodyB - The second possible `Body` that this constraint is attached to.
     ...
     * For compound bodies, constraints must be applied to the parent body and not one of its parts.
     *
     * @method Vsengine.Physics.Matter.Factory#constraint
     * @since 3.0.0
     *
     * @param {MatterJS.BodyType} bodyA - The first possible `Body` that this constraint is attached to.
     * @param {MatterJS.BodyType} bodyB - The second possible `Body` that this constraint is attached to.
     ...
     * For compound bodies, constraints must be applied to the parent body and not one of its parts.
     *
     * @method Vsengine.Physics.Matter.Factory#worldConstraint
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#mouseSpring
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterConstraintConfig} [options] - An optional Constraint configuration object that is used to set initial Constraint properties on creation.
     *
     ...
     * the `options` object on creation.
     *
     * @method Vsengine.Physics.Matter.Factory#pointerConstraint
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterConstraintConfig} [options] - An optional Constraint configuration object that is used to set initial Constraint properties on creation.
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#image
     * @since 3.0.0
     *
     ...
     * @param {Vsengine.Types.Physics.Matter.MatterBodyConfig} [options] - An optional Body configuration object that is used to set initial Body properties on creation.
     *
     * @return {Vsengine.Physics.Matter.Image} The Matter Image Game Object.
     */
     ...
     * Vsengine.Physics.Matter.TileBody#setFromTileCollision for more information.
     *
     * @method Vsengine.Physics.Matter.Factory#tileBody
     * @since 3.0.0
     *
     * @param {Vsengine.Tilemaps.Tile} tile - The target tile that should have a Matter body.
     * @param {Vsengine.Types.Physics.Matter.MatterTileOptions} [options] - Options to be used when creating the Matter body.
     *
     * @return {Vsengine.Physics.Matter.TileBody} The Matter Tile Body Game Object.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#sprite
     * @since 3.0.0
     *
     * @param {number} x - The horizontal position of this Game Object in the world.
     * @param {number} y - The vertical position of this Game Object in the world.
     ...
     * @param {Vsengine.Types.Physics.Matter.MatterBodyConfig} [options] - An optional Body configuration object that is used to set initial Body properties on creation.
     *
     * @return {Vsengine.Physics.Matter.Sprite} The Matter Sprite Game Object.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#gameObject
     * @since 3.3.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - The Game Object to inject the Matter Components in to.
     * @param {(Vsengine.Types.Physics.Matter.MatterBodyConfig|MatterJS.Body)} [options] - A Matter Body configuration object, or an instance of a Matter Body.
     * @param {boolean} [addToWorld=true] - Add this Matter Body to the World?
     *
     * @return {(Vsengine.Physics.Matter.Image|Vsengine.Physics.Matter.Sprite|Vsengine.GameObjects.GameObject)} The Game Object that had the Matter Components injected into it.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.Factory#destroy
     * @since 3.5.0
     */
    destroy: function () {
        this.world = null;
