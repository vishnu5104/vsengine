 ...
 *
 * @namespace Vsengine.Physics.Matter.Components.SetBody
 * @since 3.0.0
 */
var SetBody = {
    /**
     ...
     *
     * @method Vsengine.Physics.Matter.Components.SetBody#setRectangle
     * @since 3.0.0
     *
     ...
     * plugins, mass, friction, collision categories, etc. So be sure to re-apply these as needed.
     *
     * @method Vsengine.Physics.Matter.Components.SetBody#setCircle
     * @since 3.0.0
     *
     ...
     * plugins, mass, friction, collision categories, etc. So be sure to re-apply these as needed.
     *
     * @method Vsengine.Physics.Matter.Components.SetBody#setPolygon
     * @since 3.0.0
     *
     ...
     * plugins, mass, friction, collision categories, etc. So be sure to re-apply these as needed.
     *
     * @method Vsengine.Physics.Matter.Components.SetBody#setTrapezoid
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Components.SetBody#setExistingBody
     * @since 3.0.0
     *
     ...
     * plugins, mass, friction, collision categories, etc. So be sure to re-apply these as needed.
     *
     * @method Vsengine.Physics.Matter.Components.SetBody#setBody
     * @since 3.0.0
     *
     * @param {(string|Vsengine.Types.Physics.Matter.MatterSetBodyConfig)} config - Either a string, such as `circle`, or a Matter Set Body Configuration object.
     * @param {Vsengine.Types.Physics.Matter.MatterBodyConfig} [options] - An optional Body configuration object that is used to set initial Body properties on creation.
     *
     * @return {this} This Game Object instance.
     */
