 ...
 *
 * @namespace Vsengine.Physics.Matter.Components.Force
 * @since 3.0.0
 */
var Force = {
    //  force = vec2 / point
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Force#applyForce
     * @since 3.0.0
     *
     * @param {Vsengine.Math.Vector2} force - A Vector that specifies the force to apply.
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Force#applyForceFrom
     * @since 3.0.0
     *
     * @param {Vsengine.Math.Vector2} position - The position in which the force comes from.
     * @param {Vsengine.Math.Vector2} force - A Vector that specifies the force to apply.
     *
     * @return {this} This Game Object instance.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Force#thrust
     * @since 3.0.0
     *
     ...
     * Use very small values, such as 0.1, depending on the mass and required speed.
     *
     * @method Vsengine.Physics.Matter.Components.Force#thrustLeft
     * @since 3.0.0
     *
     * @param {number} speed - A speed value to be applied to a directional force.
     *
     ...
     * Use very small values, such as 0.1, depending on the mass and required speed.
     *
     * @method Vsengine.Physics.Matter.Components.Force#thrustRight
     * @since 3.0.0
     *
     * @param {number} speed - A speed value to be applied to a directional force.
     *
     ...
     * Use very small values, such as 0.1, depending on the mass and required speed.
     *
     * @method Vsengine.Physics.Matter.Components.Force#thrustBack
     * @since 3.0.0
     *
     * @param {number} speed - A speed value to be applied to a directional force.
     *
