 ...
 *
 * @namespace Vsengine.Physics.Matter.Components.Sleep
 * @since 3.0.0
 */
var Sleep = {
    /**
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Sleep#setToSleep
     * @since 3.22.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Sleep#setAwake
     * @since 3.22.0
     *
     * @return {this} This Game Object instance.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Sleep#setSleepThreshold
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Sleep#setSleepEvents
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Sleep#setSleepStartEvent
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Sleep#setSleepEndEvent
     * @since 3.0.0
     *
     * @param {boolean} value - `true` to enable the sleep event, or `false` to disable it.
     *
