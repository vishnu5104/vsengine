 ...
 *
 * @namespace Vsengine.Physics.Matter.Components.Velocity
 * @since 3.0.0
 */
var Velocity = {
    /**
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Velocity#setVelocityX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Velocity#setVelocityY
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Velocity#setVelocity
     * @since 3.0.0
     *
     * @param {number} x - The horizontal velocity value.
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Velocity#getVelocity
     * @since 3.60.0
     *
     * @return {Vsengine.Types.Math.Vector2Like} The current linear velocity of the body.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Velocity#setAngularVelocity
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Velocity#getAngularVelocity
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Velocity#setAngularSpeed
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.Components.Velocity#getAngularSpeed
     * @since 3.60.0
     *
     * @return {number} The current angular velocity of the body.
     */
