...
/**
 * @classdesc
 * The Matter World class is responsible for managing one single instance of a Matter Physics World for Vsengine.
 *
 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - The Scene to which this Matter World instance belongs.
 * @param {Vsengine.Types.Physics.Matter.MatterWorldConfig} config - The Matter World configuration object.
 */
var World = new Class({
    ...
    initialize: function World(scene, config) {
         ...
         *
         * @name Vsengine.Physics.Matter.World#scene
         * @type {Vsengine.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name Vsengine.Physics.Matter.World#engine
         ...
         *
         * @name Vsengine.Physics.Matter.World#localWorld
         * @type {MatterJS.World}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Matter.World#walls
         * @type {Vsengine.Types.Physics.Matter.MatterWalls}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Matter.World#enabled
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         * of your game.
         *
         * @name Vsengine.Physics.Matter.World#getDelta
         * @type {function}
         * @since 3.4.0
         */
         ...
         *
         * @name Vsengine.Physics.Matter.World#runner
         * @type {Vsengine.Types.Physics.Matter.MatterRunnerConfig}
         * @since 3.22.0
         */
        this.runner = {
            fps: fps,
         ...
         *
         * @name Vsengine.Physics.Matter.World#autoUpdate
         * @type {boolean}
         * @default true
         * @since 3.4.0
         */
         ...
         *
         * @name Vsengine.Physics.Matter.World#drawDebug
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Matter.World#debugGraphic
         ...
         *
         * @name Vsengine.Physics.Matter.World#debugConfig
         * @type {Vsengine.Types.Physics.Matter.MatterDebugConfig}
         * @since 3.22.0
         */
        this.debugConfig = {
            showAxes: GetFastValue(debugConfig, "showAxes", false),
            showAngleIndicator: GetFastValue(
                debugConfig,
                "showAngleIndicator",
                false
            ),
            ...
            collisionColor: GetFastValue(
                debugConfig,
                "collisionColor",
                0xf5950c
            ),

            showSeparations: GetFastValue(
                debugConfig,
                "showSeparations",
                false
            ),
            separationColor: GetFastValue(
                debugConfig,
                "separationColor",
                0xffa500
            ),
            ...
            showInternalEdges: GetFastValue(
                debugConfig,
                "showInternalEdges",
                false
            ),
            ...
            staticFillColor: GetFastValue(
                debugConfig,
                "staticFillColor",
                0x0d177b
            ),
            staticLineColor: GetFastValue(
                debugConfig,
                "staticLineColor",
                0x1327e4
            ),
            ...
            staticBodySleepOpacity: GetFastValue(
                debugConfig,
                "staticBodySleepOpacity",
                0.7
            ),
            sleepFillColor: GetFastValue(
                debugConfig,
                "sleepFillColor",
                0x464646
            ),
            sleepLineColor: GetFastValue(
                debugConfig,
                "sleepLineColor",
                0x999a99
            ),
            ...
            sensorFillColor: GetFastValue(
                debugConfig,
                "sensorFillColor",
                0x0d177b
            ),
            sensorLineColor: GetFastValue(
                debugConfig,
                "sensorLineColor",
                0x1327e4
            ),
            ...
            jointLineThickness: GetFastValue(
                debugConfig,
                "jointLineThickness",
                2
            ),
        ...
        if (GetFastValue(config, "setBounds", false)) {
            ...
            if (typeof boundsConfig === "boolean") {
                ...
                var width = GetFastValue(
                    boundsConfig,
                    "width",
                    scene.sys.scale.width
                );
                var height = GetFastValue(
                    boundsConfig,
                    "height",
                    scene.sys.scale.height
                );
     ...
     *
     * @method Vsengine.Physics.Matter.World#setCompositeRenderStyle
     * @since 3.22.0
     *
     ...
     *
     * If you are using this on a Vsengine Game Object, such as a Matter Sprite, then pass in the body property
     ...
     *
     * @method Vsengine.Physics.Matter.World#setBodyRenderStyle
     * @since 3.22.0
     *
    ...
    setBodyRenderStyle: function (
        ...
        if (lineColor === undefined || lineColor === null) {
            lineColor = body.isStatic
                ? config.staticLineColor
                : config.lineColor;
        }
     ...
     *
     * If you are using this on a Vsengine Game Object, then pass in the body property
     * to this method, not the Game Object itself.
     *
     * If you wish to skip a parameter, so it retains its current value, pass `false` for it.
     *
     ...
     *
     * @method Vsengine.Physics.Matter.World#setConstraintRenderStyle
     * @since 3.22.0
     *
     ...
     * @return {this} This Matter World instance for method chaining.
     */
    setConstraintRenderStyle: function (
        constraint,
        lineColor,
        lineOpacity,
        lineThickness,
     ...
     * via this class.
     *
     * @method Vsengine.Physics.Matter.World#setEventsProxy
     * @since 3.0.0
     */
            ...
            MatterEvents.on(world, "beforeAdd", function (event) {
                ...
                for (var i = 0; i < objects.length; i++) {
                    ...
                    if (obj.type === "body") {
                        ...
                        _this.setConstraintRenderStyle(
                            obj,
                            render.lineColor,
                            render.lineOpacity,
                            render.lineThickness,
        ...
        MatterEvents.on(engine, "collisionActive", function (event) {
            ...
            if (pairs.length > 0) {
                pairs.map(function (pair) {
                    ...
                    MatterEvents.trigger(bodyA, "onCollideActive", {
                        pair: pair,
                    });
                    MatterEvents.trigger(bodyB, "onCollideActive", {
                        pair: pair,
                    });
     ...
     *
     * @method Vsengine.Physics.Matter.World#setBounds
     * @since 3.0.0
     *
     ...
     *
     * @return {Vsengine.Physics.Matter.World} This Matter World object.
     */
    setBounds: function (
        x,
        y,
     ...
     *
     * @method Vsengine.Physics.Matter.World#updateWall
     * @since 3.0.0
     *
    ...
    /**
     * Creates a Vsengine.GameObjects.Graphics object that is used to render all of the debug bodies and joints to.
     *
     ...
     *
     * @method Vsengine.Physics.Matter.World#createDebugGraphic
     * @since 3.0.0
     *
     * @return {Vsengine.GameObjects.Graphics} The newly created Graphics object.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.World#disableGravity
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.World#setGravity
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.World#create
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.World#add
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.World#remove
     * @since 3.0.0
     *
     * @param {(object|object[])} object - Can be single object, or an array, and can be a body, composite or constraint.
     ...
     * Triggers `beforeRemove` and `afterRemove` events.
     *
     * @method Vsengine.Physics.Matter.World#removeConstraint
     * @since 3.0.0
     *
     ...
     * you should call the `Vsengine.Physics.Matter.World.convertTiles` function directly, passing
     * it an array of the tiles you've added to your map.
     *
     * @method Vsengine.Physics.Matter.World#convertTilemapLayer
     * @since 3.0.0
     *
     * @param {Vsengine.Tilemaps.TilemapLayer} tilemapLayer - An array of tiles.
     * @param {object} [options] - Options to be passed to the MatterTileBody constructor. {@see Vsengine.Physics.Matter.TileBody}
     *
     * @return {this} This Matter World object.
     */
    convertTilemapLayer: function (tilemapLayer, options) {
        var layerData = tilemapLayer.layer;
        var tiles = tilemapLayer.getTilesWithin(
            0,
            0,
            layerData.width,
            layerData.height,
     ...
     *
     * @method Vsengine.Physics.Matter.World#convertTiles
     * @since 3.0.0
     *
     * @param {Vsengine.Tilemaps.Tile[]} tiles - An array of tiles.
     * @param {object} [options] - Options to be passed to the MatterTileBody constructor. {@see Vsengine.Physics.Matter.TileBody}
     *
     * @return {this} This Matter World object.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.World#nextGroup
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.World#nextCategory
     * @since 3.0.0
     *
     * @return {number} Unique category bitfield
     */
     ...
     *
     * @method Vsengine.Physics.Matter.World#pause
     ...
     *
     * @method Vsengine.Physics.Matter.World#resume
     * @fires Vsengine.Physics.Matter.Events#RESUME
     * @since 3.0.0
     *
     * @return {this} This Matter World object.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.World#update
     * @since 3.0.0
     *
    ...
    update: function (time) {
        ...
        if (
            ...
            !runner.timeLastTick ||
            frameDelta >
                Math.max(MatterRunner._maxFrameDelta, runner.maxFrameTime)
        ) {
        ...
        while (
            engineDelta > 0 &&
            runner.timeBuffer >= engineDelta * MatterRunner._timeBufferMargin
        ) {
            // update the engine
            ...
            var elapsedTimeTotal = Common.now() - tickStartTime,
                ...
                elapsedNextEstimate =
                    elapsedTimeTotal +
                    (MatterRunner._elapsedNextEstimate * elapsedTimeUpdates) /
                        updateCount;
            ...
            if (
                ...
                runner.lastUpdatesDeferred = Math.round(
                    Math.max(
                        0,
                        runner.timeBuffer / engineDelta -
                            MatterRunner._timeBufferMargin
                    )
                );
                break;
            }
     ...
     * of your game.
     *
     * @method Vsengine.Physics.Matter.World#step
     * @since 3.4.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.World#update60Hz
     * @since 3.4.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.World#update30Hz
     * @since 3.4.0
     *
     * @return {number} The delta value to be passed to Engine.update.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.World#has
     * @since 3.22.0
     *
     * @param {(MatterJS.Body|Vsengine.GameObjects.GameObject)} body - The Matter Body, or Game Object, to search for within the world.
     *
     ...
     *
     * @method Vsengine.Physics.Matter.World#getAllBodies
     * @since 3.22.0
     *
     * @return {MatterJS.BodyType[]} An array of all the Matter JS Bodies in this World.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.World#getAllConstraints
     * @since 3.22.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.World#getAllComposites
     * @since 3.22.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.World#postUpdate
     * @private
     * @since 3.0.0
     */
    postUpdate: function () {
     ...
     *
     * @method Vsengine.Physics.Matter.World#renderGrid
     * @since 3.22.0
     *
     * @param {MatterJS.Grid} grid - The Matter Grid to be rendered.
     * @param {Vsengine.GameObjects.Graphics} graphics - The Graphics object to render to.
     ...
     * you wish to render the Grid to your own Graphics instance.
     *
     * @method Vsengine.Physics.Matter.World#renderSeparations
     * @since 3.22.0
     *
     ...
     * you wish to render the Grid to your own Graphics instance.
     *
     * @method Vsengine.Physics.Matter.World#renderCollisions
     * @since 3.22.0
     *
     * @param {MatterJS.Pair[]} pairs - An array of Matter Pairs to be rendered.
     * @param {Vsengine.GameObjects.Graphics} graphics - The Graphics object to render to.
        ...
        for (i = 0; i < pairs.length; i++) {
            ...
            if (pair.contactCount > 0) {
                ...
                if (pair.contactCount === 2) {
                    normalPosX =
                        (contacts[0].vertex.x + contacts[1].vertex.x) / 2;
                    normalPosY =
                        (contacts[0].vertex.y + contacts[1].vertex.y) / 2;
                }
     ...
     *
     * @method Vsengine.Physics.Matter.World#renderBodyBounds
     * @since 3.22.0
     *
     ...
     * you wish to render bounds to your own Graphics instance.
     *
     * @method Vsengine.Physics.Matter.World#renderBodyAxes
     * @since 3.22.0
     *
     * @param {array} bodies - An array of bodies from the localWorld.
     * @param {Vsengine.GameObjects.Graphics} graphics - The Graphics object to render to.
     ...
     * you wish to render bounds to your own Graphics instance.
     *
     * @method Vsengine.Physics.Matter.World#renderBodyVelocity
     * @since 3.22.0
     *
     * @param {array} bodies - An array of bodies from the localWorld.
     * @param {Vsengine.GameObjects.Graphics} graphics - The Graphics object to render to.
     ...
     *
     * @method Vsengine.Physics.Matter.World#renderBodies
     * @private
     * @since 3.14.0
     *
     * @param {array} bodies - An array of bodies from the localWorld.
    ...
    renderBodies: function (bodies) {
        ...
        for (var i = 0; i < bodies.length; i++) {
            ...
            if (
                (!showStaticBody && body.isStatic) ||
                (!showBody && !body.isStatic)
            ) {
                continue;
            }
    ...
    /**
     * Renders a single Matter Body to the given Vsengine Graphics Game Object.
     *
     * This method is used internally by the Matter Debug Renderer, but is also exposed publically should
     ...
     *
     * @method Vsengine.Physics.Matter.World#renderBody
     * @since 3.22.0
     *
    ...
    renderBody: function (
        ...
        for (var k = partsLength > 1 ? 1 : 0; k < partsLength; k++) {
            ...
            if (
                !render.visible ||
                opacity === 0 ||
                (part.isSensor && !config.showSensors)
            ) {
                continue;
            }
    ...
    /**
     * Renders the Convex Hull for a single Matter Body to the given Vsengine Graphics Game Object.
     *
     * This method is used internally by the Matter Debug Renderer, but is also exposed publically should
     * you wish to render a Body hull to your own Graphics instance.
     *
     * @method Vsengine.Physics.Matter.World#renderConvexHull
     * @since 3.22.0
     *
     * @param {MatterJS.BodyType} body - The Matter Body to be rendered.
     * @param {Vsengine.GameObjects.Graphics} graphics - The Graphics object to render to.
     ...
     * Called automatically by the `postUpdate` method.
     *
     * @method Vsengine.Physics.Matter.World#renderJoints
     * @private
     * @since 3.14.0
     */
    ...
    /**
     * Renders a single Matter Constraint, such as a Pin or a Spring, to the given Vsengine Graphics Game Object.
     *
     * This method is used internally by the Matter Debug Renderer, but is also exposed publically should
     * you wish to render a Constraint to your own Graphics instance.
     *
     * @method Vsengine.Physics.Matter.World#renderConstraint
     * @since 3.22.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.World#resetCollisionIDs
     * @since 3.17.0
     */
     ...
     *
     * @method Vsengine.Physics.Matter.World#shutdown
     * @since 3.0.0
     */
    shutdown: function () {
     ...
     *
     * @method Vsengine.Physics.Matter.World#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.shutdown();
