...
var BodyBounds = new Class({
    initialize: function BodyBounds() {
         ...
         *
         * @name Vsengine.Physics.Matter.BodyBounds#boundsCenter
         ...
         *
         * @name Vsengine.Physics.Matter.BodyBounds#centerDiff
         * @type {Vsengine.Math.Vector2}
         * @since 3.22.0
         */
     ...
     *
     * @method Vsengine.Physics.Matter.BodyBounds#parseBody
     * @since 3.22.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBody} body - The Body to get the bounds position from.
     *
    ...
    parseBody: function (body) {
        ...
        if (
            !body.hasOwnProperty("bounds") ||
            !body.hasOwnProperty("centerOfMass")
        ) {
            return false;
        }
        ...
        centerDiff.set(
            bodyCenterX - boundsCenter.x,
            bodyCenterY - boundsCenter.y
        );
     ...
     *
     * @method Vsengine.Physics.Matter.BodyBounds#getTopLeft
     * @since 3.22.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBody} body - The Body to get the position from.
     ...
     *
     * @return {(Vsengine.Math.Vector2|false)} A Vector2 containing the coordinates, or `false` if it was unable to parse the body.
     */
     ...
     * This will return the world coordinate based on the bodies _current_ position and bounds.
     *
     * @method Vsengine.Physics.Matter.BodyBounds#getTopCenter
     * @since 3.22.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBody} body - The Body to get the position from.
     * @param {number} [x=0] - Optional horizontal offset to add to the returned coordinates.
     ...
     * This will return the world coordinate based on the bodies _current_ position and bounds.
     *
     * @method Vsengine.Physics.Matter.BodyBounds#getTopRight
     * @since 3.22.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBody} body - The Body to get the position from.
     * @param {number} [x=0] - Optional horizontal offset to add to the returned coordinates.
     ...
     * This will return the world coordinate based on the bodies _current_ position and bounds.
     *
     * @method Vsengine.Physics.Matter.BodyBounds#getLeftCenter
     * @since 3.22.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBody} body - The Body to get the position from.
     * @param {number} [x=0] - Optional horizontal offset to add to the returned coordinates.
     ...
     * This will return the world coordinate based on the bodies _current_ position and bounds.
     *
     * @method Vsengine.Physics.Matter.BodyBounds#getCenter
     * @since 3.22.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBody} body - The Body to get the position from.
     * @param {number} [x=0] - Optional horizontal offset to add to the returned coordinates.
     ...
     * This will return the world coordinate based on the bodies _current_ position and bounds.
     *
     * @method Vsengine.Physics.Matter.BodyBounds#getRightCenter
     * @since 3.22.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBody} body - The Body to get the position from.
     * @param {number} [x=0] - Optional horizontal offset to add to the returned coordinates.
     ...
     * This will return the world coordinate based on the bodies _current_ position and bounds.
     *
     * @method Vsengine.Physics.Matter.BodyBounds#getBottomLeft
     * @since 3.22.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBody} body - The Body to get the position from.
     * @param {number} [x=0] - Optional horizontal offset to add to the returned coordinates.
     ...
     * This will return the world coordinate based on the bodies _current_ position and bounds.
     *
     * @method Vsengine.Physics.Matter.BodyBounds#getBottomCenter
     * @since 3.22.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBody} body - The Body to get the position from.
     * @param {number} [x=0] - Optional horizontal offset to add to the returned coordinates.
     ...
     * This will return the world coordinate based on the bodies _current_ position and bounds.
     *
     * @method Vsengine.Physics.Matter.BodyBounds#getBottomRight
     * @since 3.22.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBody} body - The Body to get the position from.
     * @param {number} [x=0] - Optional horizontal offset to add to the returned coordinates.
