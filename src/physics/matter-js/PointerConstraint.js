 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - A reference to the Scene to which this Pointer Constraint belongs.
 * @param {Vsengine.Physics.Matter.World} world - A reference to the Matter World instance to which this Constraint belongs.
...
var PointerConstraint = new Class({
    initialize: function PointerConstraint(scene, world, options) {
         ...
         *
         * @name Vsengine.Physics.Matter.PointerConstraint#scene
         * @type {Vsengine.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name Vsengine.Physics.Matter.PointerConstraint#world
         ...
         *
         * @name Vsengine.Physics.Matter.PointerConstraint#camera
         ...
         *
         * @name Vsengine.Physics.Matter.PointerConstraint#pointer
         ...
         *
         * @name Vsengine.Physics.Matter.PointerConstraint#active
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Matter.PointerConstraint#position
         ...
         *
         * @name Vsengine.Physics.Matter.PointerConstraint#body
         ...
         *
         * @name Vsengine.Physics.Matter.PointerConstraint#part
         * @type {?MatterJS.BodyType}
         * @since 3.16.2
         */
        this.part = null;
         ...
         *
         * @name Vsengine.Physics.Matter.PointerConstraint#constraint
     ...
     *
     * @method Vsengine.Physics.Matter.PointerConstraint#onDown
     * @since 3.0.0
     *
     * @param {Vsengine.Input.Pointer} pointer - A reference to the Pointer that was pressed.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.PointerConstraint#onUp
     * @since 3.22.0
     *
     * @param {Vsengine.Input.Pointer} pointer - A reference to the Pointer that was pressed.
     */
     ...
     * body.
     *
     * @method Vsengine.Physics.Matter.PointerConstraint#getBody
     * @fires Vsengine.Physics.Matter.Events#DRAG_START
     * @since 3.16.2
     *
     ...
     *
     * @method Vsengine.Physics.Matter.PointerConstraint#hitTestBody
     * @since 3.16.2
     *
     * @param {MatterJS.BodyType} body - The Matter Body to check.
     * @param {Vsengine.Math.Vector2} position - A translated hit test position.
     *
     ...
     *
     * @method Vsengine.Physics.Matter.PointerConstraint#update
     * @fires Vsengine.Physics.Matter.Events#DRAG
     * @since 3.0.0
     */
    update: function () {
     ...
     *
     * @method Vsengine.Physics.Matter.PointerConstraint#stopDrag
     * @fires Vsengine.Physics.Matter.Events#DRAG_END
     * @since 3.16.2
     */
    stopDrag: function () {
        var body = this.body;
     ...
     *
     * @method Vsengine.Physics.Matter.PointerConstraint#destroy
     * @since 3.0.0
     */
    destroy: function () {
