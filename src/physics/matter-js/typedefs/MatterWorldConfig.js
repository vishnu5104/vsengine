/**
 * @typedef {object} Vsengine.Types.Physics.Matter.MatterWorldConfig
 * @since 3.0.0
 *
 * @property {Vsengine.Types.Math.Vector2Like} [gravity] - Sets {@link Vsengine.Physics.Matter.World#gravity}.
 ...
 * @property {(boolean|Vsengine.Types.Physics.Matter.MatterDebugConfig)} [debug=false] - Controls the Matter Debug Rendering options. If a boolean it will use the default values, otherwise, specify a Debug Config object.
 * @property {Vsengine.Types.Physics.Matter.MatterRunnerConfig} [runner] - Sets the Matter Runner options.
 */
