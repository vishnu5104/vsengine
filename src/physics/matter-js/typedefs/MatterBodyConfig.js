/**
 * @typedef {object} Vsengine.Types.Physics.Matter.MatterBodyConfig
 * @since 3.22.0
 *
 * @property {string} [label='Body'] - An arbitrary string-based name to help identify this body.
 * @property {(string|Vsengine.Types.Physics.Matter.MatterSetBodyConfig)} [shape=null] - Set this Game Object to create and use a new Body based on the configuration object given.
 ...
 * @property {Vsengine.Types.Math.Vector2Like[]} [vertices=null] - An array of `Vector` objects that specify the convex hull of the rigid body. These should be provided about the origin `(0, 0)`.
 * @property {Vsengine.Types.Math.Vector2Like} [position] - A `Vector` that specifies the current world-space position of the body.
 * @property {Vsengine.Types.Math.Vector2Like} [force] - A `Vector` that specifies the force to apply in the current step. It is zeroed after every `Body.update`. See also `Body.applyForce`.
 ...
 * @property {Vsengine.Types.Physics.Matter.MatterCollisionFilter} [collisionFilter] - An `Object` that specifies the collision filtering properties of this body.
 ...
 * @property {(number|number[]|Vsengine.Types.Physics.Matter.MatterChamferConfig)} [chamfer=null] - A number, or array of numbers, to chamfer the vertices of the body, or a full Chamfer configuration object.
 ...
 * @property {Vsengine.Types.Math.Vector2Like} [scale] - A `Vector` that specifies the initial scale of the body.
 * @property {Vsengine.Types.Math.Vector2Like} [gravityScale] - A `Vector` that scales the influence of World gravity when applied to this body.
 ...
 * @property {Vsengine.Types.Physics.Matter.MatterBodyRenderConfig} [render] - The Debug Render configuration object for this body.
