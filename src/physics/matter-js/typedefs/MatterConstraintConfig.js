/**
 * @typedef {object} Vsengine.Types.Physics.Matter.MatterConstraintConfig
 * @since 3.22.0
 *
 ...
 * @property {Vsengine.Types.Math.Vector2Like} [pointA] - A `Vector` that specifies the offset of the constraint from center of the `constraint.bodyA` if defined, otherwise a world-space position.
 * @property {Vsengine.Types.Math.Vector2Like} [pointB] - A `Vector` that specifies the offset of the constraint from center of the `constraint.bodyB` if defined, otherwise a world-space position.
 ...
 * @property {Vsengine.Types.Physics.Matter.MatterConstraintRenderConfig} [render] - The Debug Render configuration object for this constraint.
 */
