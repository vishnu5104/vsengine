 ...
 *
 * @param {Vsengine.Physics.Matter.World} world - The Matter world instance this body belongs to.
...
var MatterTileBody = new Class({
    ...
    initialize: function MatterTileBody(world, tile, options) {
         ...
         *
         * @name Vsengine.Physics.Matter.TileBody#tile
         ...
         *
         * @name Vsengine.Physics.Matter.TileBody#world
     ...
     *
     * @method Vsengine.Physics.Matter.TileBody#setFromTileRectangle
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBodyTileOptions} [options] - Options to be used when creating the Matter body. See MatterJS.Body for a list of what Matter accepts.
     *
     * @return {Vsengine.Physics.Matter.TileBody} This TileBody object.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.TileBody#setFromTileCollision
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBodyTileOptions} [options] - Options to be used when creating the Matter body. See MatterJS.Body for a list of what Matter accepts.
     *
     ...
     * exists.
     *
     * @method Vsengine.Physics.Matter.TileBody#setBody
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.TileBody#removeBody
     * @since 3.0.0
     *
     * @return {Vsengine.Physics.Matter.TileBody} This TileBody object.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.TileBody#destroy
     * @since 3.0.0
     *
     * @return {Vsengine.Physics.Matter.TileBody} This TileBody object.
     */
