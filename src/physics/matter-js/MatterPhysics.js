...
/**
 * @classdesc
 * The Vsengine Matter plugin provides the ability to use the Matter JS Physics Engine within your Vsengine games.
 *
 * Unlike Arcade Physics, the other physics system provided with Vsengine, Matter JS is a full-body physics system.
 * It features:
 *
 * * Rigid bodies
 * * Compound bodies
 ...
 * Vsengine Game Config, or Vsengine Scene Config. Here is a basic example:
 *
 * ```js
 * physics: {
 *     default: 'matter',
 ...
 * ```
 *
 * This class acts as an interface between a Vsengine Scene and a single instance of the Matter Engine.
 *
 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - The Vsengine Scene that owns this Matter Physics instance.
 */
var MatterPhysics = new Class({
    initialize: function MatterPhysics(scene) {
        /**
         * The Vsengine Scene that owns this Matter Physics instance
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#scene
         * @type {Vsengine.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#systems
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#config
         * @type {Vsengine.Types.Physics.Matter.MatterWorldConfig}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#world
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#add
         * @type {Vsengine.Physics.Matter.Factory}
         * @since 3.0.0
         */
        this.add;
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#bodyBounds
         * @type {Vsengine.Physics.Matter.BodyBounds}
         * @since 3.22.0
         */
        this.bodyBounds;
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#body
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#composite
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#collision
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#detector
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#pair
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#pairs
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#query
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#resolver
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#constraint
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#bodies
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#composites
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#axes
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#bounds
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#svg
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#vector
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#vertices
         ...
         * A `Matter.Body` maintains a set of vertices to represent the shape of the object (its convex hull).
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#verts
         * @type {MatterJS.VerticesFactory}
         * @since 3.14.0
         */
        this.verts = Vertices;
         ...
         *
         * @name Vsengine.Physics.Matter.MatterPhysics#_tempVec2
        ...
        Resolver._restingThreshTangent = GetValue(
            this.config,
            "restingThreshTangent",
            6
        );
        Resolver._positionDampen = GetValue(this.config, "positionDampen", 0.9);
        Resolver._positionWarming = GetValue(
            this.config,
            "positionWarming",
            0.8
        );
        Resolver._frictionNormalMultiplier = GetValue(
            this.config,
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#boot
     * @private
     * @since 3.5.1
     */
    boot: function () {
     ...
     * Do not invoke it directly.
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#start
     * @private
     * @since 3.5.0
     */
    start: function () {
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#getConfig
     * @since 3.0.0
     *
     * @return {Vsengine.Types.Physics.Matter.MatterWorldConfig} The Matter World Config.
     */
    getConfig: function () {
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#pause
     * @fires Vsengine.Physics.Matter.Events#PAUSE
     * @since 3.0.0
     *
     * @return {Vsengine.Physics.Matter.World} The Matter World object.
     */
    pause: function () {
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#resume
     * @since 3.0.0
     *
     * @return {Vsengine.Physics.Matter.World} The Matter World object.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#set60Hz
     * @since 3.4.0
     *
     ...
     * If you have set a custom `getDelta` function then this will override it.
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#set30Hz
     * @since 3.4.0
     *
     * @return {this} This Matter Physics instance.
     */
     ...
     * of your game.
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#step
     * @since 3.4.0
     *
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#containsPoint
     * @since 3.22.0
     *
     * @param {(Vsengine.Types.Physics.Matter.MatterBody|Vsengine.Types.Physics.Matter.MatterBody[])} body - The body, or an array of bodies, to check against the point.
     ...
     * transform them before passing them.
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#intersectPoint
     * @since 3.22.0
     *
     * @param {number} x - The horizontal coordinate of the point.
     * @param {number} y - The vertical coordinate of the point.
     * @param {Vsengine.Types.Physics.Matter.MatterBody[]} [bodies] - An array of bodies to check. If not provided it will search all bodies in the world.
     *
     * @return {Vsengine.Types.Physics.Matter.MatterBody[]} An array of bodies which contain the given point.
     */
     ...
     * If no bodies are provided it will search all bodies in the Matter World, including within Composites.
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#intersectRect
     * @since 3.22.0
     *
     ...
     * @param {Vsengine.Types.Physics.Matter.MatterBody[]} [bodies] - An array of bodies to check. If not provided it will search all bodies in the world.
     *
     * @return {Vsengine.Types.Physics.Matter.MatterBody[]} An array of bodies that intersect with the given area.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#intersectRay
     * @since 3.22.0
     *
     ...
     * @param {Vsengine.Types.Physics.Matter.MatterBody[]} [bodies] - An array of bodies to check. If not provided it will search all bodies in the world.
     *
     * @return {Vsengine.Types.Physics.Matter.MatterBody[]} An array of bodies whos vertices intersect with the ray segment.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#intersectBody
     * @since 3.22.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBody} body - The target body.
     * @param {Vsengine.Types.Physics.Matter.MatterBody[]} [bodies] - An array of bodies to check the target body against. If not provided it will search all bodies in the world.
     *
     * @return {Vsengine.Types.Physics.Matter.MatterBody[]} An array of bodies whos vertices intersect with target body.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#overlap
     * @since 3.22.0
     *
     * @param {(Vsengine.Types.Physics.Matter.MatterBody|Vsengine.Types.Physics.Matter.MatterBody[])} target - The target body, or array of target bodies, to check.
     * @param {Vsengine.Types.Physics.Matter.MatterBody[]} [bodies] - The second body, or array of bodies, to check. If falsey it will check against all bodies in the world.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [overlapCallback] - An optional callback function that is called if the bodies overlap.
     * @param {Vsengine.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - An optional callback function that lets you perform additional checks against the two bodies if they overlap. If this is set then `overlapCallback` will only be invoked if this callback returns `true`.
    ...
    overlap: function (
        ...
        for (var i = 0; i < target.length; i++) {
            ...
            for (var c = 0; c < collisions.length; c++) {
                ...
                var bodyB =
                    info.bodyA.id === entry.id ? info.bodyB : info.bodyA;

                if (
                    !processCallback ||
                    processCallback.call(callbackContext, entry, bodyB, info)
                ) {
                    match = true;
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#setCollisionCategory
     * @since 3.22.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBody[]} bodies - An array of bodies to update. If falsey it will use all bodies in the world.
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#setCollisionGroup
     * @since 3.22.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBody[]} bodies - An array of bodies to update. If falsey it will use all bodies in the world.
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#setCollidesWith
     * @since 3.22.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBody[]} bodies - An array of bodies to update. If falsey it will use all bodies in the world.
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#getMatterBodies
     * @since 3.22.0
     *
    ...
    getMatterBodies: function (bodies) {
        ...
        for (var i = 0; i < bodies.length; i++) {
            var body = bodies[i].hasOwnProperty("body")
                ? bodies[i].body
                : bodies[i];
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#setVelocity
     * @since 3.22.0
     *
     * @param {(Vsengine.Types.Physics.Matter.MatterBody|Vsengine.Types.Physics.Matter.MatterBody[])} bodies - Either a single Body, or an array of bodies to update. If falsey it will use all bodies in the world.
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#setVelocityX
     * @since 3.22.0
     *
     * @param {(Vsengine.Types.Physics.Matter.MatterBody|Vsengine.Types.Physics.Matter.MatterBody[])} bodies - Either a single Body, or an array of bodies to update. If falsey it will use all bodies in the world.
     * @param {number} x - The horizontal linear velocity value.
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#setVelocityY
     * @since 3.22.0
     *
     * @param {(Vsengine.Types.Physics.Matter.MatterBody|Vsengine.Types.Physics.Matter.MatterBody[])} bodies - Either a single Body, or an array of bodies to update. If falsey it will use all bodies in the world.
     * @param {number} y - The vertical linear velocity value.
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#setAngularVelocity
     * @since 3.22.0
     *
     * @param {(Vsengine.Types.Physics.Matter.MatterBody|Vsengine.Types.Physics.Matter.MatterBody[])} bodies - Either a single Body, or an array of bodies to update. If falsey it will use all bodies in the world.
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#applyForce
     * @since 3.22.0
     *
     * @param {(Vsengine.Types.Physics.Matter.MatterBody|Vsengine.Types.Physics.Matter.MatterBody[])} bodies - Either a single Body, or an array of bodies to update. If falsey it will use all bodies in the world.
     * @param {Vsengine.Types.Math.Vector2Like} force - A Vector that specifies the force to apply.
     *
     * @return {this} This Matter Physics instance.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#applyForceFromPosition
     * @since 3.22.0
     *
     * @param {(Vsengine.Types.Physics.Matter.MatterBody|Vsengine.Types.Physics.Matter.MatterBody[])} bodies - Either a single Body, or an array of bodies to update. If falsey it will use all bodies in the world.
     * @param {Vsengine.Types.Math.Vector2Like} position - A Vector that specifies the world-space position to apply the force at.
     ...
     * Use very small speed values, such as 0.1, depending on the mass and required velocity.
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#applyForceFromAngle
     * @since 3.22.0
     *
     * @param {(Vsengine.Types.Physics.Matter.MatterBody|Vsengine.Types.Physics.Matter.MatterBody[])} bodies - Either a single Body, or an array of bodies to update. If falsey it will use all bodies in the world.
     * @param {number} speed - A speed value to be applied to a directional force.
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#getConstraintLength
     * @since 3.22.0
     *
     ...
     *
     * ```javascript
     * this.matter.alignBody(body, 400, 600, Vsengine.Display.Align.BOTTOM_CENTER);
     * ```
     *
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#alignBody
     * @since 3.22.0
     *
     * @param {Vsengine.Types.Physics.Matter.MatterBody} body - The Body to align.
     * @param {number} x - The horizontal position to align the body to.
     * @param {number} y - The vertical position to align the body to.
     * @param {number} align - One of the `Vsengine.Display.Align` constants, such as `Vsengine.Display.Align.TOP_LEFT`.
     *
     * @return {this} This Matter Physics instance.
     */
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#shutdown
     * @private
     * @since 3.0.0
     */
    shutdown: function () {
     ...
     *
     * @method Vsengine.Physics.Matter.MatterPhysics#destroy
     * @private
     * @since 3.0.0
     */
    destroy: function () {
