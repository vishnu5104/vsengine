...
(function () {
    ...
    Body.create = function (options) {
        var defaults = {
            ...
            wrapBounds: null,
            angle: 0,
            vertices: null, // Vsengine change: no point calling fromPath if they pass in vertices anyway
            position: { x: 0, y: 0 },
            force: { x: 0, y: 0 },
            torque: 0,
            ...
            render: {
                ...
                fillColor: null, // custom Vsengine property
                fillOpacity: null, // custom Vsengine property
                lineColor: null, // custom Vsengine property
                lineOpacity: null, // custom Vsengine property
                lineThickness: null, // custom Vsengine property
            },
            gameObject: null, // custom Vsengine property
            scale: { x: 1, y: 1 }, // custom Vsengine property
            centerOfMass: { x: 0, y: 0 }, // custom Vsengine property (float, 0 - 1)
            centerOffset: { x: 0, y: 0 }, // custom Vsengine property (pixel values)
            gravityScale: { x: 1, y: 1 }, // custom Vsengine property
            ignoreGravity: false, // custom Vsengine property
            ignorePointer: false, // custom Vsengine property
            onCollideCallback: null, // custom Vsengine property
            onCollideEndCallback: null, // custom Vsengine property
            onCollideActiveCallback: null, // custom Vsengine property
            onCollideWith: {}, // custom Vsengine property
        };
    ...
    /**
     * A reference to the Vsengine Game Object this body belongs to, if any.
     *
     * @property gameObject
     ...
     * Used by Vsengine for texture aligment.
     *
    ...
    /**
     * Will this Body ignore Vsengine Pointer input events?
     *
