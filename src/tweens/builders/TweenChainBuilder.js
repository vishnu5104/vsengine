 ...
 *
 * @function Vsengine.Tweens.Builders.TweenChainBuilder
 * @since 3.60.0
 *
 * @param {Vsengine.Tweens.TweenManager} parent - The owner of the new Tween.
 * @param {Vsengine.Types.Tweens.TweenChainBuilderConfig|object} config - Configuration for the new Tween.
 *
 * @return {Vsengine.Tweens.TweenChain} The new Tween Chain.
 */
