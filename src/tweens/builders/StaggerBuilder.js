 ...
 * ```
 *
 * @function Vsengine.Tweens.Builders.StaggerBuilder
 * @since 3.19.0
 *
 ...
 * @param {Vsengine.Types.Tweens.StaggerConfig} [config] - A Stagger Configuration object.
 *
