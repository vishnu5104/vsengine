 ...
 *
 * @function Vsengine.Tweens.Builders.GetProps
 * @since 3.0.0
 *
 * @param {Vsengine.Types.Tweens.TweenBuilderConfig} config - The configuration object of the Tween to get the properties from.
 *
