 ...
 *
 * @function Vsengine.Tweens.Builders.NumberTweenBuilder
 * @since 3.0.0
 *
 * @param {Vsengine.Tweens.TweenManager} parent - The owner of the new Tween.
 * @param {Vsengine.Types.Tweens.NumberTweenBuilderConfig} config - Configuration for the new Tween.
...
var NumberTweenBuilder = function (parent, config, defaults) {
    ...
    var tweenData = tween.add(
        ...
        ops.getActive,
        GetEaseFunction(
            GetValue(config, "ease", ease),
            GetValue(config, "easeParams", easeParams)
        ),
