/**
 * @typedef {object} Vsengine.Types.Tweens.TweenPropConfig
 * @since 3.18.0
 *
 * @property {(number|number[]|string|Vsengine.Types.Tweens.GetEndCallback|Vsengine.Types.Tweens.TweenPropConfig)} [value] - What the property will be at the END of the Tween.
 * @property {Vsengine.Types.Tweens.GetActiveCallback} [getActive] - What the property will be set to immediately when this tween becomes active.
 * @property {Vsengine.Types.Tweens.GetEndCallback} [getEnd] - What the property will be at the END of the Tween.
 * @property {Vsengine.Types.Tweens.GetStartCallback} [getStart] - What the property will be at the START of the Tween.
