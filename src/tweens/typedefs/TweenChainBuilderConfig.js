/**
 * @typedef {object} Vsengine.Types.Tweens.TweenChainBuilderConfig
 * @extends object
 * @since 3.60.0
 *
 ...
 * @property {Vsengine.Types.Tweens.TweenBuilderConfig[]} [tweens] - The tweens to chain together.
 * @property {any} [callbackScope] - The scope (or context) for all of the callbacks. The default scope is the chain.
 * @property {Vsengine.Types.Tweens.TweenOnCompleteCallback} [onComplete] - A function to call when the chain completes.
 * @property {array} [onCompleteParams] - Additional parameters to pass to `onComplete`.
 * @property {Vsengine.Types.Tweens.TweenOnLoopCallback} [onLoop] - A function to call each time the chain loops.
 * @property {array} [onLoopParams] - Additional parameters to pass to `onLoop`.
 * @property {Vsengine.Types.Tweens.TweenOnStartCallback} [onStart] - A function to call when the chain starts playback, after any delays have expired.
 * @property {array} [onStartParams] - Additional parameters to pass to `onStart`.
 * @property {Vsengine.Types.Tweens.TweenOnStopCallback} [onStop] - A function to call when the chain is stopped.
 * @property {array} [onStopParams] - Additional parameters to pass to `onStop`.
 * @property {Vsengine.Types.Tweens.TweenOnActiveCallback} [onActive] - A function to call when the chain becomes active within the Tween Manager.
 * @property {array} [onActiveParams] - Additional parameters to pass to `onActive`.
 * @property {Vsengine.Types.Tweens.TweenOnPauseCallback} [onPause] - A function to call when the chain is paused.
 * @property {array} [onPauseParams] - Additional parameters to pass to `onPause`.
 * @property {Vsengine.Types.Tweens.TweenOnResumeCallback} [onResume] - A function to call when the chain is resumed after being paused.
