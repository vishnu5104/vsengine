/**
 * @typedef {object} Vsengine.Types.Tweens.NumberTweenBuilderConfig
 * @since 3.18.0
 *
 ...
 * @property {Vsengine.Types.Tweens.TweenOnCompleteCallback} [onComplete] - A function to call when the counter completes.
 * @property {array} [onCompleteParams] - Additional parameters to pass to `onComplete`.
 * @property {Vsengine.Types.Tweens.TweenOnLoopCallback} [onLoop] - A function to call each time the counter loops.
 * @property {array} [onLoopParams] - Additional parameters to pass to `onLoop`.
 * @property {Vsengine.Types.Tweens.TweenOnRepeatCallback} [onRepeat] - A function to call each time the counter repeats.
 * @property {array} [onRepeatParams] - Additional parameters to pass to `onRepeat`.
 * @property {Vsengine.Types.Tweens.TweenOnStartCallback} [onStart] - A function to call when the counter starts.
 * @property {array} [onStartParams] - Additional parameters to pass to `onStart`.
 * @property {Vsengine.Types.Tweens.TweenOnStopCallback} [onStop] - A function to call when the counter is stopped.
 * @property {array} [onStopParams] - Additional parameters to pass to `onStop`.
 * @property {Vsengine.Types.Tweens.TweenOnUpdateCallback} [onUpdate] - A function to call each time the counter steps.
 * @property {array} [onUpdateParams] - Additional parameters to pass to `onUpdate`.
 * @property {Vsengine.Types.Tweens.TweenOnYoyoCallback} [onYoyo] - A function to call each time the counter yoyos.
 * @property {array} [onYoyoParams] - Additional parameters to pass to `onYoyo`.
 * @property {Vsengine.Types.Tweens.TweenOnPauseCallback} [onPause] - A function to call when the counter is paused.
 * @property {array} [onPauseParams] - Additional parameters to pass to `onPause`.
 * @property {Vsengine.Types.Tweens.TweenOnResumeCallback} [onResume] - A function to call when the counter is resumed after being paused.
