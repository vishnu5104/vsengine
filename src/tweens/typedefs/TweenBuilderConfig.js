/**
 * @typedef {object} Vsengine.Types.Tweens.TweenBuilderConfig
 * @extends object
 * @since 3.18.0
 *
 ...
 * @property {Object.<string,(number|string|Vsengine.Types.Tweens.GetEndCallback|Vsengine.Types.Tweens.TweenPropConfig)>} [props] - The properties to tween.
 ...
 * @property {Vsengine.Types.Tweens.TweenOnRepeatCallback} [onRepeat] - A function to call each time a property tween repeats. Called once per property per target.
 ...
 * @property {Vsengine.Types.Tweens.TweenOnYoyoCallback} [onYoyo] - A function to call each time a property tween yoyos. Called once per property per target.
 ...
 * @property {Vsengine.Types.Tweens.TweenOnPauseCallback} [onPause] - A function to call when the tween is paused.
 * @property {array} [onPauseParams] - Additional parameters to pass to `onPause`.
 * @property {Vsengine.Types.Tweens.TweenOnResumeCallback} [onResume] - A function to call when the tween is resumed after being paused.
