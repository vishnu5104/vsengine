/**
 * @typedef {object} Vsengine.Types.Tweens.TweenDataConfig
 * @since 3.0.0
 *
 ...
 * @property {?Vsengine.Types.Tweens.GetActiveCallback} getActiveValue - If not null, is invoked _immediately_ as soon as the TweenData is running, and is set on the target property.
 * @property {Vsengine.Types.Tweens.GetEndCallback} getEndValue - The returned value sets what the property will be at the END of the Tween.
 * @property {Vsengine.Types.Tweens.GetStartCallback} getStartValue - The returned value sets what the property will be at the START of the Tween.
 ...
 * @property {Vsengine.Types.Tweens.TweenDataGenConfig} [gen] - LoadValue generation functions.
 * @property {Vsengine.Tweens.StateType} [state=0] - TWEEN_CONST.CREATED
 */
