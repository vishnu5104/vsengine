...
var TweenFrameData = new Class({
    ...
    initialize: function TweenFrameData(
        tween,
        targetIndex,
        texture,
        frame,
         ...
         *
         * @name Vsengine.Tweens.TweenFrameData#key
         * @type {string}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.TweenFrameData#startTexture
         * @type {string}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.TweenFrameData#endTexture
         * @type {string}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.TweenFrameData#startFrame
         * @type {(string|number)}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.TweenFrameData#endFrame
         * @type {(string|number)}
         * @since 3.60.0
         */
        this.endFrame = frame;
         ...
         *
         * @name Vsengine.Tweens.TweenFrameData#yoyo
         * @type {boolean}
         * @since 3.60.0
         */
     ...
     *
     * @method Vsengine.Tweens.TweenFrameData#reset
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.TweenFrameData#update
     ...
     *
     * @method Vsengine.Tweens.TweenFrameData#dispatchEvent
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.TweenFrameData#destroy
     * @since 3.60.0
     */
    destroy: function () {
