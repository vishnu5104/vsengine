...
var BaseTweenData = new Class({
    initialize: function BaseTweenData(
        tween,
        targetIndex,
        delay,
        duration,
         ...
         *
         * @name Vsengine.Tweens.BaseTweenData#tween
         ...
         *
         * @name Vsengine.Tweens.BaseTweenData#targetIndex
         * @type {number}
         * @since 3.60.0
         */
         ...
         * for yoyo or repeats.
         *
         * @name Vsengine.Tweens.BaseTweenData#duration
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.BaseTweenData#totalDuration
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.BaseTweenData#delay
         * @type {number}
         * @since 3.60.0
         */
        this.delay = 0;
         ...
         *
         * @name Vsengine.Tweens.BaseTweenData#getDelay
         * @type {function}
         * @since 3.60.0
         */
        this.getDelay = delay;
         ...
         *
         * @name Vsengine.Tweens.BaseTweenData#yoyo
         * @type {boolean}
         * @since 3.60.0
         */
        this.yoyo = yoyo;
         ...
         *
         * @name Vsengine.Tweens.BaseTweenData#hold
         * @type {number}
         * @since 3.60.0
         */
        this.hold = hold;
         ...
         *
         * @name Vsengine.Tweens.BaseTweenData#repeat
         * @type {number}
         * @since 3.60.0
         */
        this.repeat = repeat;
         ...
         *
         * @name Vsengine.Tweens.BaseTweenData#repeatDelay
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.BaseTweenData#repeatCounter
         * @type {number}
         * @since 3.60.0
         */
         ...
         * has a function matching this name, like most Vsengine GameObjects do.
         *
         * @name Vsengine.Tweens.BaseTweenData#flipX
         * @type {boolean}
         * @since 3.60.0
         */
        this.flipX = flipX;
         ...
         * has a function matching this name, like most Vsengine GameObjects do.
         *
         * @name Vsengine.Tweens.BaseTweenData#flipY
         * @type {boolean}
         * @since 3.60.0
         */
        this.flipY = flipY;
         ...
         *
         * @name Vsengine.Tweens.BaseTweenData#progress
         * @type {number}
         * @since 3.60.0
         */
        this.progress = 0;
         ...
         *
         * @name Vsengine.Tweens.BaseTweenData#elapsed
         * @type {number}
         * @since 3.60.0
         */
        this.elapsed = 0;
         ...
         *
         * @name Vsengine.Tweens.BaseTweenData#state
         ...
         *
         * @name Vsengine.Tweens.BaseTweenData#isCountdown
         * @type {boolean}
         * @since 3.60.0
         */
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#getTarget
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#setTargetValue
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#setCreatedState
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#setDelayState
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#setPendingRenderState
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#setPlayingForwardState
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#setPlayingBackwardState
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#setHoldState
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#setRepeatState
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#setCompleteState
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#isCreated
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#isDelayed
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#isPendingRender
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#isPlayingForward
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#isPlayingBackward
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#isHolding
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#isRepeating
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#isComplete
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#setStateFromEnd
     * @fires Vsengine.Tweens.Events#TWEEN_REPEAT
     * @fires Vsengine.Tweens.Events#TWEEN_YOYO
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#setStateFromStart
     * @fires Vsengine.Tweens.Events#TWEEN_REPEAT
     * @since 3.60.0
     *
     * @param {number} diff - Any extra time that needs to be accounted for in the elapsed and progress values.
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#reset
     * @since 3.60.0
     */
    reset: function () {
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#onRepeat
     * @fires Vsengine.Tweens.Events#TWEEN_REPEAT
     * @fires Vsengine.Tweens.Events#TWEEN_YOYO
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.BaseTweenData#destroy
     * @since 3.60.0
     */
    destroy: function () {
        this.tween = null;
