 ...
 *
 * Prior to Vsengine 3.60 the TweenData was just an object, but was refactored to a class,
 * to make it responsible for its own state and updating.
 *
 * @class TweenData
 * @memberof Vsengine.Tweens
 * @extends Vsengine.Tweens.BaseTweenData
 * @constructor
 * @since 3.60.0
 *
 * @param {Vsengine.Tweens.Tween} tween - The tween this TweenData instance belongs to.
...
var TweenData = new Class({
    ...
    initialize: function TweenData(
         ...
         *
         * @name Vsengine.Tweens.TweenData#key
         * @type {string}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.TweenData#getActiveValue
         * @type {?Vsengine.Types.Tweens.GetActiveCallback}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.TweenData#getEndValue
         * @type {Vsengine.Types.Tweens.GetEndCallback}
         * @since 3.60.0
         */
         ...
         * start delay, or if the tween is reset, or is set to repeat.
         *
         * @name Vsengine.Tweens.TweenData#getStartValue
         * @type {Vsengine.Types.Tweens.GetStartCallback}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.TweenData#ease
         * @type {function}
         * @since 3.60.0
         */
        this.ease = ease;
         ...
         *
         * @name Vsengine.Tweens.TweenData#start
         * @type {number}
         * @since 3.60.0
         */
        this.start = 0;
         ...
         *
         * @name Vsengine.Tweens.TweenData#previous
         * @type {number}
         * @since 3.60.0
         */
        this.previous = 0;
         ...
         *
         * @name Vsengine.Tweens.TweenData#current
         * @type {number}
         * @since 3.60.0
         */
        this.current = 0;
         ...
         *
         * @name Vsengine.Tweens.TweenData#end
         * @type {number}
         * @since 3.60.0
         */
        this.end = 0;
         ...
         *
         * @name Vsengine.Tweens.TweenData#interpolation
         * @type {?function}
         * @default null
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.TweenData#interpolationData
         * @type {?number[]}
         * @since 3.60.0
         */
     ...
     *
     * @method Vsengine.Tweens.TweenData#reset
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.TweenData#update
     * @fires Vsengine.Tweens.Events#TWEEN_UPDATE
     * @fires Vsengine.Tweens.Events#TWEEN_REPEAT
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.TweenData#dispatchEvent
     * @since 3.60.0
     *
    ...
    dispatchEvent: function (event, callback) {
        ...
        if (!tween.isSeeking) {
            ...
            if (handler) {
                handler.func.apply(
                    tween.callbackScope,
                    [tween, target, key, current, previous].concat(
                        handler.params
                    )
                );
            }
     ...
     *
     * @method Vsengine.Tweens.TweenData#destroy
     * @since 3.60.0
     */
    destroy: function () {
