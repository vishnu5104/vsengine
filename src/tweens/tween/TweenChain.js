 ...
 * @since 3.60.0
 *
 * @param {(Vsengine.Tweens.TweenManager|Vsengine.Tweens.TweenChain)} parent - A reference to the Tween Manager, or TweenChain, that owns this TweenChain.
 */
var TweenChain = new Class({
    Extends: BaseTween,

    initialize: function TweenChain(parent) {
        BaseTween.call(this, parent);

        /**
         * A reference to the Tween that this TweenChain is currently playing.
         *
         * @name Vsengine.Tweens.TweenChain#currentTween
         ...
         *
         * @name Vsengine.Tweens.TweenChain#currentIndex
         * @type {number}
         * @since 3.60.0
         */
        this.currentIndex = 0;
     ...
     *
     * @method Vsengine.Tweens.TweenChain#init
     ...
     * Please note that Tweens will not manipulate any target property that begins with an underscore.
     *
     * @method Vsengine.Tweens.TweenChain#add
     * @since 3.60.0
     *
     * @param {Vsengine.Types.Tweens.TweenBuilderConfig[]|object[]} tweens - An array of Tween configuration objects for the Tweens in this chain.
     *
     * @return {this} This TweenChain instance.
     */
    add: function (tweens) {
     ...
     *
     * @method Vsengine.Tweens.TweenChain#remove
     * @since 3.60.0
     * @override
     *
     ...
     *
     * @method Vsengine.Tweens.TweenChain#hasTarget
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.TweenChain#restart
     * @since 3.60.0
     *
     * @return {this} This TweenChain instance.
     */
     ...
     *
     * @method Vsengine.Tweens.TweenChain#reset
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.TweenChain#makeActive
     * @since 3.60.0
     * @override
     *
     ...
     *
     * @method Vsengine.Tweens.TweenChain#nextState
     ...
     *
     * @method Vsengine.Tweens.TweenChain#play
     * @since 3.60.0
     *
     * @return {this} This TweenChain instance.
     */
     ...
     *
     * @method Vsengine.Tweens.TweenChain#resetTweens
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.Tweens.TweenChain#update
     * @fires Vsengine.Tweens.Events#TWEEN_COMPLETE
     * @fires Vsengine.Tweens.Events#TWEEN_LOOP
     ...
     *
     * @method Vsengine.Tweens.TweenChain#nextTween
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.TweenChain#setCurrentTween
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.TweenChain#dispatchEvent
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.TweenChain#destroy
     * @since 3.60.0
     */
    destroy: function () {
 ...
 *
 * @method Vsengine.GameObjects.GameObjectFactory#tweenchain
 * @since 3.60.0
 *
 * @param {Vsengine.Types.Tweens.TweenBuilderConfig|object} config - The TweenChain configuration.
 *
 * @return {Vsengine.Tweens.TweenChain} The TweenChain that was created.
 */
 ...
 * Note: This method will only be available if Tweens have been built into Vsengine.
 *
 * @method Vsengine.GameObjects.GameObjectCreator#tweenchain
 * @since 3.60.0
 *
 * @param {Vsengine.Types.Tweens.TweenBuilderConfig|object} config - The TweenChain configuration.
 *
