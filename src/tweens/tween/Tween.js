 ...
 * @extends Vsengine.Tweens.BaseTween
 * @constructor
 * @since 3.0.0
 *
 * @param {Vsengine.Tweens.TweenManager} parent - A reference to the Tween Manager that owns this Tween.
 * @param {object[]} targets - An array of targets to be tweened.
 */
var Tween = new Class({
    Extends: BaseTween,

    initialize: function Tween(parent, targets) {
         ...
         *
         * @name Vsengine.Tweens.Tween#targets
         * @type {object[]}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tweens.Tween#totalTargets
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tweens.Tween#isSeeking
         * @type {boolean}
         * @readonly
         * @since 3.19.0
         */
         ...
         *
         * @name Vsengine.Tweens.Tween#isInfinite
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.Tween#elapsed
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.Tween#totalElapsed
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.Tween#duration
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.Tween#progress
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.Tween#totalDuration
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.Tween#totalProgress
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
     ...
     * yourself.
     *
     * @method Vsengine.Tweens.Tween#add
     * @since 3.60.0
     *
     ...
     * @param {Vsengine.Types.Tweens.GetEndCallback} getEnd - What the property will be at the END of the Tween.
     * @param {Vsengine.Types.Tweens.GetStartCallback} getStart - What the property will be at the START of the Tween.
     * @param {?Vsengine.Types.Tweens.GetActiveCallback} getActive - If not null, is invoked _immediately_ as soon as the TweenData is running, and is set on the target property.
     ...
     *
     * @return {Vsengine.Tweens.TweenData} The TweenData instance that was added.
     */
    add: function (
        targetIndex,
        key,
     ...
     * yourself.
     *
     * @method Vsengine.Tweens.Tween#addFrame
     * @since 3.60.0
     *
     * @param {number} targetIndex - The target index within the Tween targets array.
     ...
     * @param {boolean} flipY - Should toggleFlipY be called when yoyo or repeat happens?
     *
     * @return {Vsengine.Tweens.TweenFrameData} The TweenFrameData instance that was added.
     */
    addFrame: function (
        targetIndex,
        texture,
     ...
     *
     * @method Vsengine.Tweens.Tween#getValue
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tweens.Tween#hasTarget
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tweens.Tween#updateTo
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tweens.Tween#restart
     * @since 3.0.0
     *
     * @return {this} This Tween instance.
     */
     ...
     *
     * @method Vsengine.Tweens.Tween#nextState
     * @fires Vsengine.Tweens.Events#TWEEN_COMPLETE
     * @fires Vsengine.Tweens.Events#TWEEN_LOOP
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tweens.Tween#onCompleteHandler
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.Tweens.Tween#play
     * @since 3.0.0
     *
     * @return {this} This Tween instance.
     */
     ...
     *
     * Prior to Vsengine 3.60 this value was given as a number between 0 and 1 and didn't
     ...
     *
     * @method Vsengine.Tweens.Tween#seek
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tweens.Tween#initTweenData
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.Tween#reset
     ...
     *
     * @method Vsengine.Tweens.Tween#update
     * @fires Vsengine.Tweens.Events#TWEEN_COMPLETE
     * @fires Vsengine.Tweens.Events#TWEEN_LOOP
     * @fires Vsengine.Tweens.Events#TWEEN_START
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tweens.Tween#forward
     * @since 3.60.0
     *
     ...
     * If the Tween is paused or has already finished, calling this will have no effect.
     *
     * @method Vsengine.Tweens.Tween#rewind
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.Tween#dispatchEvent
     * @since 3.60.0
     *
     * @param {Vsengine.Types.Tweens.Event} event - The Event to be dispatched.
     * @param {Vsengine.Types.Tweens.TweenCallbackTypes} [callback] - The name of the callback to be invoked. Can be `null` or `undefined` to skip invocation.
     */
     ...
     *
     * @method Vsengine.Tweens.Tween#destroy
     * @since 3.60.0
     */
    destroy: function () {
 ...
 *
 * Note: This method will only be available if Tweens have been built into Vsengine.
 *
 * @method Vsengine.GameObjects.GameObjectFactory#tween
 * @since 3.0.0
 *
 ...
 *
 * @return {Vsengine.Tweens.Tween} The Tween that was created.
 */
 ...
 * Note: This method will only be available if Tweens have been built into Vsengine.
 *
 * @method Vsengine.GameObjects.GameObjectCreator#tween
 * @since 3.0.0
 *
 * @param {Vsengine.Types.Tweens.TweenBuilderConfig|Vsengine.Types.Tweens.TweenChainBuilderConfig|Vsengine.Tweens.Tween|Vsengine.Tweens.TweenChain} config - A Tween Configuration object, or a Tween or TweenChain instance.
 *
