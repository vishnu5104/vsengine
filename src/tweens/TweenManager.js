 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - The Scene which owns this Tween Manager.
 */
var TweenManager = new Class({
    initialize: function TweenManager(scene) {
         ...
         *
         * @name Vsengine.Tweens.TweenManager#scene
         * @type {Vsengine.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name Vsengine.Tweens.TweenManager#events
         ...
         *
         * @name Vsengine.Tweens.TweenManager#timeScale
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tweens.TweenManager#paused
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.TweenManager#processing
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.TweenManager#tweens
         * @type {Vsengine.Tweens.Tween[]}
         * @since 3.60.0
         */
        this.tweens = [];
         ...
         *
         * @name Vsengine.Tweens.TweenManager#time
         * @type {number}
         * @since 3.60.0
         */
        this.time = 0;
         ...
         *
         * @name Vsengine.Tweens.TweenManager#startTime
         * @type {number}
         * @since 3.60.0
         */
        this.startTime = 0;
         ...
         *
         * @name Vsengine.Tweens.TweenManager#nextTime
         * @type {number}
         * @since 3.60.0
         */
        this.nextTime = 0;
         ...
         *
         * @name Vsengine.Tweens.TweenManager#prevTime
         * @type {number}
         * @since 3.60.0
         */
        this.prevTime = 0;
         ...
         *
         * @name Vsengine.Tweens.TweenManager#maxLag
         * @type {number}
         * @default 500
         * @since 3.60.0
         */
         ...
         * See the `TweenManager.setLagSmooth` method for further details.
         *
         * @name Vsengine.Tweens.TweenManager#lagSkip
         * @type {number}
         * @default 33
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Tweens.TweenManager#gap
         * @type {number}
         * @since 3.60.0
         */
        this.gap = 1000 / 240;
     ...
     *
     * @method Vsengine.Tweens.TweenManager#boot
     * @private
     * @since 3.5.1
     */
    boot: function () {
     ...
     * Do not invoke it directly.
     *
     * @method Vsengine.Tweens.TweenManager#start
     * @private
     * @since 3.5.0
     */
    start: function () {
     ...
     *
     * @method Vsengine.Tweens.TweenManager#create
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Tweens.TweenBuilderConfig|Vsengine.Types.Tweens.TweenBuilderConfig[]|object|object[]} config - A Tween Configuration object. Or an array of Tween Configuration objects.
     *
     * @return {Vsengine.Tweens.Tween|Vsengine.Tweens.Tween[]} The created Tween, or an array of Tweens if an array of tween configs was provided.
     */
     ...
     * If you wish to chain Tweens together for sequential playback, see the `TweenManager.chain` method.
     *
     * @method Vsengine.Tweens.TweenManager#add
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Tweens.TweenBuilderConfig|Vsengine.Types.Tweens.TweenChainBuilderConfig|Vsengine.Tweens.Tween|Vsengine.Tweens.TweenChain} config - A Tween Configuration object, or a Tween or TweenChain instance.
     *
     * @return {Vsengine.Tweens.Tween} The created Tween.
     */
    add: function (config) {
        var tween = config;
     ...
     * If you wish to chain Tweens together for sequential playback, see the `TweenManager.chain` method.
     *
     * @method Vsengine.Tweens.TweenManager#addMultiple
     * @since 3.60.0
     *
     * @param {Vsengine.Types.Tweens.TweenBuilderConfig[]|object[]} configs - An array of Tween Configuration objects.
     *
     * @return {Vsengine.Tweens.Tween[]} An array of created Tweens.
     */
     ...
     *
     * @method Vsengine.Tweens.TweenManager#chain
     * @since 3.60.0
     *
     * @param {Vsengine.Types.Tweens.TweenChainBuilderConfig|object} tweens - A Tween Chain configuration object.
     *
     * @return {Vsengine.Tweens.TweenChain} The Tween Chain instance.
     */
     ...
     *
     * @method Vsengine.Tweens.TweenManager#getChainedTweens
     * @since 3.60.0
     *
     * @param {Vsengine.Tweens.Tween} tween - The Tween to return the chain from.
     *
     * @return {Vsengine.Tweens.Tween[]} An array of the chained tweens, or an empty array if there aren't any.
     */
     ...
     *
     * @method Vsengine.Tweens.TweenManager#has
     * @since 3.60.0
     *
     * @param {Vsengine.Tweens.Tween} tween - The Tween instance to check.
     *
     ...
     * Playback will start immediately unless the tween has been configured to be paused.
     *
     * @method Vsengine.Tweens.TweenManager#existing
     * @since 3.0.0
     *
     * @param {Vsengine.Tweens.Tween} tween - The Tween to add.
     *
     ...
     * Please note that a Tween will not manipulate any target property that begins with an underscore.
     *
     * @method Vsengine.Tweens.TweenManager#addCounter
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Tweens.NumberTweenBuilderConfig} config - The configuration object for the Number Tween.
     *
     * @return {Vsengine.Tweens.Tween} The created Number Tween.
     */
     ...
     * ```
     *
     * @method Vsengine.Tweens.TweenManager#stagger
     * @since 3.19.0
     *
     ...
     * @param {Vsengine.Types.Tweens.StaggerConfig} config - The configuration object for the Stagger function.
     *
     ...
     *
     * @method Vsengine.Tweens.TweenManager#setLagSmooth
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.TweenManager#setFps
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Tweens.TweenManager#getDelta
     * @since 3.60.0
     *
     ...
     * paused.
     *
     * @method Vsengine.Tweens.TweenManager#tick
     * @since 3.60.0
     *
     * @return {this} This Tween Manager instance.
     */
     ...
     * been paused.
     *
     * @method Vsengine.Tweens.TweenManager#update
     * @since 3.0.0
     */
    update: function () {
        if (!this.paused) {
     ...
     *
     * @method Vsengine.Tweens.TweenManager#step
     * @since 3.60.0
     *
     * @param {boolean} [tick=false] - Is this a manual tick, or an automated tick?
     */
     ...
     *
     * @method Vsengine.Tweens.TweenManager#remove
     * @since 3.17.0
     *
     * @param {Vsengine.Tweens.Tween} tween - The Tween to be removed.
     *
     * @return {this} This Tween Manager instance.
     */
     ...
     *
     * @method Vsengine.Tweens.TweenManager#reset
     * @since 3.60.0
     *
     * @param {Vsengine.Tweens.Tween} tween - The Tween to be reset.
     *
     * @return {this} This Tween Manager instance.
     */
     ...
     *
     * @method Vsengine.Tweens.TweenManager#makeActive
     * @since 3.0.0
     *
     * @param {Vsengine.Tweens.Tween} tween - The Tween to check.
     *
     * @return {this} This Tween Manager instance.
     */
     ...
     *
     * @method Vsengine.Tweens.TweenManager#each
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tweens.TweenManager#getTweens
     * @since 3.0.0
     *
     * @return {Vsengine.Tweens.Tween[]} A new array containing references to all Tweens.
     */
    getTweens: function () {
     ...
     * upon it.
     *
     * @method Vsengine.Tweens.TweenManager#getTweensOf
     * @since 3.0.0
     *
     * @param {(object|object[])} target - The target to look for. Provide an array to look for multiple targets.
     *
     * @return {Vsengine.Tweens.Tween[]} A new array containing all Tweens which affect the given target(s).
     */
     ...
     *
     * @method Vsengine.Tweens.TweenManager#getGlobalTimeScale
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tweens.TweenManager#setGlobalTimeScale
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tweens.TweenManager#isTweening
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tweens.TweenManager#killAll
     * @since 3.0.0
     *
     * @return {this} This Tween Manager instance.
     */
     ...
     *
     * @method Vsengine.Tweens.TweenManager#killTweensOf
     * @since 3.0.0
     *
     ...
     *
     * As of Vsengine 3.60 you can also toggle the boolean property `TweenManager.paused`.
     *
     * @method Vsengine.Tweens.TweenManager#pauseAll
     * @since 3.0.0
     *
     * @return {this} This Tween Manager instance.
     */
     ...
     * As of Vsengine 3.60 you can also toggle the boolean property `TweenManager.paused`.
     *
     * @method Vsengine.Tweens.TweenManager#resumeAll
     * @since 3.0.0
     *
     * @return {this} This Tween Manager instance.
     */
     ...
     *
     * @method Vsengine.Tweens.TweenManager#shutdown
     * @since 3.0.0
     */
    shutdown: function () {
        this.killAll();
     ...
     *
     * @method Vsengine.Tweens.TweenManager#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.shutdown();
