 ...
 *
 * @event Vsengine.GameObjects.Events#VIDEO_TEXTURE
 * @type {string}
 * @since 3.60.0
 *
 * @param {Vsengine.GameObjects.Video} video - The Video Game Object that emitted the event.
 * @param {Vsengine.Textures.Texture} texture - The Texture that was created.
 */
