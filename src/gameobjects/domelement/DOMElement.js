 ...
 * ```
 *
 * You must also have a parent container for Vsengine. This is specified by the `parent` property in the
 * game config.
 *
 * When these two things are added, Vsengine will automatically create a DOM Container div that is positioned
 ...
 * Element that you wish to be placed under the control of Vsengine. For example:
 *
 * ```javascript
 * this.add.dom(x, y, 'div', 'background-color: lime; width: 220px; height: 100px; font: 48px Arial', 'Vsengine');
 * ```
 *
 ...
 * it will create a lime colored div that is 220px by 100px in size with the text Vsengine in it, in an Arial font.
 *
 ...
 *
 * DOM Game Objects can be added to a Vsengine Container, however you should only nest them **one level deep**.
 ...
 *
 * DOM Elements are a powerful way to align native HTML with your Vsengine Game Objects. For example, you can insert
...
var DOMElement = new Class({
    ...
    initialize: function DOMElement(scene, x, y, element, style, innerText) {
         ...
         *
         * @name Vsengine.GameObjects.DOMElement#parent
         * @type {Element}
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.GameObjects.DOMElement#cache
         * @type {Vsengine.Cache.BaseCache}
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.GameObjects.DOMElement#node
         * @type {Element}
         * @since 3.17.0
         */
        this.node;
         ...
         *
         * @name Vsengine.GameObjects.DOMElement#transformOnly
         * @type {boolean}
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.GameObjects.DOMElement#skewX
         * @type {number}
         * @since 3.17.0
         */
        this.skewX = 0;
         ...
         * https://developer.mozilla.org/en-US/docs/Web/CSS/transform
         *
         * @name Vsengine.GameObjects.DOMElement#skewY
         * @type {number}
         * @since 3.17.0
         */
        this.skewY = 0;
         ...
         *
         * @name Vsengine.GameObjects.DOMElement#rotate3d
         * @type {Vsengine.Math.Vector4}
         * @since 3.17.0
         */
         ...
         * https://developer.mozilla.org/en-US/docs/Web/CSS/transform-function/rotate3d
         *
         * @name Vsengine.GameObjects.DOMElement#rotate3dAngle
         * @type {string}
         * @since 3.17.0
         */
         ...
         * internal Vsengine input handling, such as dragging, so only change this if you
         * understand the implications.
         *
         * @name Vsengine.GameObjects.DOMElement#pointerEvents
         * @type {string}
         * @since 3.55.0
         */
         ...
         *
         * @name Vsengine.GameObjects.DOMElement#width
         * @type {number}
         * @readonly
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.GameObjects.DOMElement#height
         * @type {number}
         * @readonly
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.GameObjects.DOMElement#displayWidth
         * @type {number}
         * @readonly
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.GameObjects.DOMElement#displayHeight
         * @type {number}
         * @readonly
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.GameObjects.DOMElement#handler
         * @type {number}
         * @private
         * @since 3.17.0
         */
     ...
     *
     * @method Vsengine.GameObjects.DOMElement#handleSceneEvent
     * @private
     * @since 3.22.0
     *
     * @param {Vsengine.Scenes.Systems} sys - The Scene Systems.
     */
     ...
     *
     * @method Vsengine.GameObjects.DOMElement#setSkew
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.GameObjects.DOMElement#setPerspective
     * @since 3.17.0
     *
     ...
     * **Changing this value changes it globally for all DOM Elements, as they all share the same parent container.**
     *
     * @name Vsengine.GameObjects.DOMElement#perspective
     * @type {number}
     * @since 3.17.0
     */
    perspective: {
     ...
     * ```
     *
     * @method Vsengine.GameObjects.DOMElement#addListener
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.GameObjects.DOMElement#removeListener
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.GameObjects.DOMElement#dispatchNativeEvent
     * @private
     * @since 3.17.0
     *
     ...
     *
     * ```javascript
     * this.add.dom().createElement('div', 'background-color: lime; width: 220px; height: 100px; font: 48px Arial', 'Vsengine');
     * ```
     *
     ...
     * };
     *
     * this.add.dom().createElement('div', style, 'Vsengine');
     * ```
     *
     ...
     *
     * @method Vsengine.GameObjects.DOMElement#createElement
     * @since 3.17.0
     *
     ...
     *
     * ```javascript
     * this.add.dom().setElement(h1, 'background-color: lime; width: 220px; height: 100px; font: 48px Arial', 'Vsengine');
     * ```
     *
     * And using a style object:
     *
     ...
     * };
     *
     * this.add.dom().setElement(h1, style, 'Vsengine');
     * ```
     *
     * @method Vsengine.GameObjects.DOMElement#setElement
     * @since 3.17.0
     *
     ...
     * Any event listeners you may have previously created will need to be re-created after this call.
     *
     * @method Vsengine.GameObjects.DOMElement#createFromCache
     * @since 3.17.0
     *
     ...
     * Any event listeners you may have previously created will need to be re-created after this call.
     *
     * @method Vsengine.GameObjects.DOMElement#createFromHTML
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.GameObjects.DOMElement#removeElement
     * @since 3.17.0
     *
     * @return {this} This DOM Element instance.
     */
     ...
     *
     * @method Vsengine.GameObjects.DOMElement#updateSize
     * @since 3.17.0
     *
     * @return {this} This DOM Element instance.
     */
     ...
     *
     * @method Vsengine.GameObjects.DOMElement#getChildByProperty
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.GameObjects.DOMElement#getChildByID
     * @since 3.17.0
     *
     ...
     * Be aware that class and id names are case-sensitive.
     *
     * @method Vsengine.GameObjects.DOMElement#getChildByName
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.GameObjects.DOMElement#setClassName
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.GameObjects.DOMElement#setText
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.GameObjects.DOMElement#setHTML
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.GameObjects.DOMElement#preRender
     * @private
     * @since 3.60.0
     */
    preRender: function () {
     ...
     *
     * @method Vsengine.GameObjects.DOMElement#willRender
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.GameObjects.DOMElement#preDestroy
     * @private
     * @since 3.17.0
     */
    preDestroy: function () {
