 ...
 *
 * @method Vsengine.GameObjects.DOMElement#renderWebGL
 * @since 3.17.0
 * @private
 *
 * @param {Vsengine.Renderer.WebGL.WebGLRenderer} renderer - A reference to the current active renderer.
 * @param {Vsengine.GameObjects.DOMElement} src - The Game Object being rendered in this call.
...
var DOMElementCSSRenderer = function (renderer, src, camera, parentMatrix) {
    ...
    if (
        ...
        (src.parentContainer && !src.parentContainer.willRender())
    ) {
        style.display = "none";
