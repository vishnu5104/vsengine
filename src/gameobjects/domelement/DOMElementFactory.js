 ...
 * ```
 *
 * When this is added, Vsengine will automatically create a DOM Container div that is positioned over the top
 ...
 *
 * Note: This method will only be available if the DOM Element Game Object has been built into Vsengine.
 *
 * @method Vsengine.GameObjects.GameObjectFactory#dom
 * @since 3.17.0
 *
 ...
 *
 * @return {Vsengine.GameObjects.DOMElement} The Game Object that was created.
 */
GameObjectFactory.register("dom", function (x, y, element, style, innerText) {
    var gameObject = new DOMElement(
        this.scene,
        x,
        y,
        element,
