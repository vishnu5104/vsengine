 ...
 *
 * @param {Vsengine.GameObjects.Light} light - The Light.
 */
...
var LightsManager = new Class({
    initialize: function LightsManager() {
         ...
         *
         * @name Vsengine.GameObjects.LightsManager#lights
         * @type {Vsengine.GameObjects.Light[]}
         * @default []
         * @since 3.0.0
         */
        this.lights = [];
         ...
         * The ambient color.
         *
         * @name Vsengine.GameObjects.LightsManager#ambientColor
         ...
         *
         * @name Vsengine.GameObjects.LightsManager#active
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.LightsManager#maxLights
         * @type {number}
         * @readonly
         * @since 3.15.0
         */
         ...
         *
         * @name Vsengine.GameObjects.LightsManager#visibleLights
         * @type {number}
         * @readonly
         * @since 3.50.0
         */
     ...
     *
     * Note: This method will only be available if the Point Light Game Object has been built into Vsengine.
     *
     ...
     *
     * @method Vsengine.GameObjects.LightsManager#addPointLight
     * @since 3.50.0
     *
     ...
     *
     * @return {Vsengine.GameObjects.PointLight} The Game Object that was created.
     */
     ...
     *
     * @method Vsengine.GameObjects.LightsManager#enable
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.LightsManager#disable
     * @since 3.0.0
     *
     * @return {this} This Lights Manager instance.
     */
     ...
     *
     * @method Vsengine.GameObjects.LightsManager#getLights
     * @since 3.50.0
     *
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The Camera to cull Lights for.
     *
     * @return {Vsengine.GameObjects.Light[]} The culled Lights.
     */
    getLights: function (camera) {
        ...
        for (var i = 0; i < lights.length; i++) {
            ...
            if (
                light.willRender(camera) &&
                CircleToRectangle(light, worldView)
            ) {
                visibleLights.push({
                    light: light,
     ...
     *
     * @method Vsengine.GameObjects.LightsManager#setAmbientColor
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.LightsManager#getMaxVisibleLights
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.LightsManager#getLightCount
     * @since 3.0.0
     *
     ...
     * Add a Light.
     *
     * @method Vsengine.GameObjects.LightsManager#addLight
     * @since 3.0.0
     *
     ...
     *
     * @return {Vsengine.GameObjects.Light} The Light that was added.
     */
     ...
     * Remove a Light.
     *
     * @method Vsengine.GameObjects.LightsManager#removeLight
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.Light} light - The Light to remove.
     *
     * @return {this} This Lights Manager instance.
     */
     ...
     * culled Lights.
     *
     * @method Vsengine.GameObjects.LightsManager#shutdown
     * @since 3.0.0
     */
    shutdown: function () {
     ...
     *
     * Cleans up all references by calling {@link Vsengine.GameObjects.LightsManager#shutdown}.
     *
     * @method Vsengine.GameObjects.LightsManager#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.shutdown();
