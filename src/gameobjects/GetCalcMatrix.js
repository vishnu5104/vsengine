 ...
 * Object is rendered.
 *
 * @function Vsengine.GameObjects.GetCalcMatrix
 * @memberof Vsengine.GameObjects
 * @since 3.50.0
 *
 * @param {Vsengine.GameObjects.GameObject} src - The Game Object to calculate the transform matrix for.
 * @param {Vsengine.Cameras.Scene2D.Camera} camera - The camera being used to render the Game Object.
 * @param {Vsengine.GameObjects.Components.TransformMatrix} [parentMatrix] - The transform matrix of the parent container, if any.
 *
 * @return {Vsengine.Types.GameObjects.GetCalcMatrixResults} The results object containing the updated transform matrices.
 */
