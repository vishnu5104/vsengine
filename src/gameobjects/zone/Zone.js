...
var Zone = new Class({
    ...
    initialize: function Zone(scene, x, y, width, height) {
         ...
         *
         * @name Vsengine.GameObjects.Zone#width
         * @type {number}
         * @since 3.0.0
         */
        this.width = width;
         ...
         *
         * @name Vsengine.GameObjects.Zone#height
         * @type {number}
         * @since 3.0.0
         */
        this.height = height;
         ...
         *
         * @name Vsengine.GameObjects.Zone#blendMode
         * @type {number}
         * @since 3.0.0
         */
     ...
     *
     * @name Vsengine.GameObjects.Zone#displayWidth
     * @type {number}
     * @since 3.0.0
     */
    displayWidth: {
     ...
     * This value takes into account the scale factor.
     *
     * @name Vsengine.GameObjects.Zone#displayHeight
     * @type {number}
     * @since 3.0.0
     */
    displayHeight: {
     ...
     *
     * @method Vsengine.GameObjects.Zone#setSize
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Zone#setDisplaySize
     * @since 3.0.0
     *
     * @param {number} width - The width of this Game Object.
     * @param {number} height - The height of this Game Object.
     ...
     *
     * @method Vsengine.GameObjects.Zone#setCircleDropZone
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Zone#setRectangleDropZone
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Zone#setDropZone
     * @since 3.0.0
     *
     * @param {object} [hitArea] - A Geometry shape instance, such as Vsengine.Geom.Ellipse, or your own custom shape. If not given it will try to create a Rectangle based on the size of this zone.
     * @param {Vsengine.Types.Input.HitAreaCallback} [hitAreaCallback] - A function that will return `true` if the given x/y coords it is sent are within the shape. If you provide a shape you must also provide a callback.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Zone#setAlpha
     * @private
     * @since 3.11.0
     */
    setAlpha: function () {},
     ...
     * Calling this method will do nothing. It is intentionally empty.
     *
     * @method Vsengine.GameObjects.Zone#setBlendMode
     * @private
     * @since 3.16.2
     */
     ...
     *
     * @method Vsengine.GameObjects.Zone#renderCanvas
     * @private
     * @since 3.53.0
     *
     ...
     * A Zone does not render.
     *
     * @method Vsengine.GameObjects.Zone#renderWebGL
     * @private
     * @since 3.53.0
     *
