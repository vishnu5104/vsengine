 ...
 * @extends Vsengine.GameObjects.Particles.EmitterOp
...
var EmitterColorOp = new Class({
    ...
    initialize: function EmitterColorOp(key) {
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterColorOp#r
         * @type {number[]}
         * @since 3.60.0
         */
        this.r = [];
         ...
         * Populated during the `setMethods` method.
         *
         * @name Vsengine.GameObjects.Particles.EmitterColorOp#g
         * @type {number[]}
         * @since 3.60.0
         */
        this.g = [];
         ...
         * Populated during the `setMethods` method.
         *
         * @name Vsengine.GameObjects.Particles.EmitterColorOp#b
         * @type {number[]}
         * @since 3.60.0
         */
        this.b = [];
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterColorOp#getMethod
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterColorOp#setMethods
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterColorOp#setEase
     * @since 3.60.0
     *
     ...
     *
     * It prepares the particle for easing by {@link Vsengine.GameObjects.Particles.EmitterColorOp#easeValueUpdate}.
     *
     * @method Vsengine.GameObjects.Particles.EmitterColorOp#easedValueEmit
     * @since 3.60.0
     *
     * @param {Vsengine.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The name of the property.
     *
     * @return {number} {@link Vsengine.GameObjects.Particles.EmitterColorOp#start}, as the new value of the property.
     */
     ...
     * {@link Vsengine.GameObjects.Particles.EmitterColorOp#start} and {@link Vsengine.GameObjects.Particles.EmitterColorOp#end}
     * range.
     *
     * @method Vsengine.GameObjects.Particles.EmitterColorOp#easeValueUpdate
     * @since 3.60.0
     *
     * @param {Vsengine.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The name of the property.
