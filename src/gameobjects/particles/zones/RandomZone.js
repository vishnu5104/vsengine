 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Types.GameObjects.Particles.RandomZoneSource} source - An object instance with a `getRandomPoint(point)` method.
 */
var RandomZone = new Class({
    initialize: function RandomZone(source) {
        /**
         * An object instance with a `getRandomPoint(point)` method.
         *
         * @name Vsengine.GameObjects.Particles.Zones.RandomZone#source
         * @type {Vsengine.Types.GameObjects.Particles.RandomZoneSource}
         * @since 3.0.0
         */
        this.source = source;
         ...
         *
         * @name Vsengine.GameObjects.Particles.Zones.RandomZone#_tempVec
         ...
         *
         * @name Vsengine.GameObjects.Particles.Zones.RandomZone#total
         * @type {number}
         * @since 3.60.0
         */
        this.total = -1;
     ...
     *
     * @method Vsengine.GameObjects.Particles.Zones.RandomZone#getPoint
     * @since 3.0.0
     *
