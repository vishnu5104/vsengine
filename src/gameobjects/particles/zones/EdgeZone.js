 ...
 *
 * @class EdgeZone
 * @memberof Vsengine.GameObjects.Particles.Zones
 * @constructor
 * @since 3.0.0
 *
 * @param {Vsengine.Types.GameObjects.Particles.EdgeZoneSource} source - An object instance with a `getPoints(quantity, stepRate)` method returning an array of points.
...
var EdgeZone = new Class({
    initialize: function EdgeZone(
         ...
         *
         * @name Vsengine.GameObjects.Particles.Zones.EdgeZone#source
         * @type {Vsengine.Types.GameObjects.Particles.EdgeZoneSource|Vsengine.Types.GameObjects.Particles.RandomZoneSource}
         * @since 3.0.0
         */
        this.source = source;
         ...
         *
         * @name Vsengine.GameObjects.Particles.Zones.EdgeZone#points
         * @type {Vsengine.Geom.Point[]}
         * @default []
         * @since 3.0.0
         */
        this.points = [];
         ...
         *
         * @name Vsengine.GameObjects.Particles.Zones.EdgeZone#quantity
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Zones.EdgeZone#stepRate
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Zones.EdgeZone#yoyo
         * @type {boolean}
         * @since 3.0.0
         */
        this.yoyo = yoyo;
         ...
         *
         * @name Vsengine.GameObjects.Particles.Zones.EdgeZone#counter
         * @type {number}
         * @default -1
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Zones.EdgeZone#seamless
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Zones.EdgeZone#_length
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.GameObjects.Particles.Zones.EdgeZone#_direction
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.GameObjects.Particles.Zones.EdgeZone#total
         * @type {number}
         * @since 3.60.0
         */
        this.total = total;
    ...
    /**
     * Update the {@link Vsengine.GameObjects.Particles.Zones.EdgeZone#points} from the EdgeZone's
     * {@link Vsengine.GameObjects.Particles.Zones.EdgeZone#source}.
     *
     * Also updates internal properties.
     *
     * @method Vsengine.GameObjects.Particles.Zones.EdgeZone#updateSource
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.Zones.EdgeZone#changeSource
     * @since 3.0.0
     *
     * @param {Vsengine.Types.GameObjects.Particles.EdgeZoneSource} source - An object instance with a `getPoints(quantity, stepRate)` method returning an array of points.
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.Zones.EdgeZone#getPoint
     * @since 3.0.0
     *
