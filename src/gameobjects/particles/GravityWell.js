 ...
 * @since 3.0.0
 *
 * @param {(number|Vsengine.Types.GameObjects.Particles.GravityWellConfig)} [x=0] - The x coordinate of the Gravity Well, in world space.
...
var GravityWell = new Class({
    ...
    initialize: function GravityWell(x, y, power, epsilon, gravity) {
         ...
         *
         * @name Vsengine.GameObjects.Particles.GravityWell#_gravity
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.GravityWell#_power
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name Vsengine.GameObjects.Particles.GravityWell#_epsilon
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
     ...
     *
     * @method Vsengine.GameObjects.Particles.GravityWell#update
     * @since 3.0.0
     *
     ...
     * Defaults to 100.
     *
     * @name Vsengine.GameObjects.Particles.GravityWell#epsilon
     * @type {number}
     * @since 3.0.0
     */
    epsilon: {
     ...
     * Defaults to 0.
     *
     * @name Vsengine.GameObjects.Particles.GravityWell#power
     * @type {number}
     * @since 3.0.0
     */
    power: {
     ...
     * Defaults to 50.
     *
     * @name Vsengine.GameObjects.Particles.GravityWell#gravity
     * @type {number}
     * @since 3.0.0
     */
    gravity: {
