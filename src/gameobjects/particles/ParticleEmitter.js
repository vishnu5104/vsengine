...
/**
 * @classdesc
 * A Particle Emitter is a special kind of Game Object that controls a pool of {@link Vsengine.GameObjects.Particles.Particle Particles}.
 *
 ...
 * ## v3.55 Differences
 *
 * Prior to v3.60 Vsengine used a `ParticleEmitterManager`. This was removed in v3.60
 ...
 * @memberof Vsengine.GameObjects.Particles
 * @constructor
 * @since 3.60.0
 *
 * @extends Vsengine.GameObjects.Components.AlphaSingle
 ...
 * @param {Vsengine.Types.GameObjects.Particles.ParticleEmitterConfig} [config] - Settings for this emitter.
 */
var ParticleEmitter = new Class({
    ...
    initialize: function ParticleEmitter(scene, x, y, texture, config) {
        GameObject.call(this, scene, "ParticleEmitter");

        /**
         * The Particle Class which will be emitted by this Emitter.
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#particleClass
         * @type {function}
         * @default Vsengine.GameObjects.Particles.Particle
         * @since 3.0.0
         * @see Vsengine.Types.GameObjects.Particles.ParticleClassConstructor
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#config
         * @type {Vsengine.Types.GameObjects.Particles.ParticleEmitterConfig}
         * @since 3.85.0
         */
        this.config = null;
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#ops
         * @type {Vsengine.Types.GameObjects.Particles.ParticleEmitterOps}
         * @since 3.60.0
         */
        this.ops = {
         ...
         * using {@link Vsengine.GameObjects.Particles.ParticleEmitter#speed} as the value. If set to false then this acts as a point Emitter.
         * A point emitter will emit particles only in the direction derived from the speedX and speedY values.
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#radial
         * @type {boolean}
         * @default true
         * @since 3.0.0
         * @see Vsengine.GameObjects.Particles.ParticleEmitter#setRadial
         */
        this.radial = true;
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#gravityX
         * @type {number}
         * @default 0
         * @since 3.0.0
         * @see Vsengine.GameObjects.Particles.ParticleEmitter#setGravity
         */
        this.gravityX = 0;
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#gravityY
         * @type {number}
         * @default 0
         * @since 3.0.0
         * @see Vsengine.GameObjects.Particles.ParticleEmitter#setGravity
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#acceleration
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#moveTo
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#emitCallback
         * @type {?Vsengine.Types.GameObjects.Particles.ParticleEmitterCallback}
         * @default null
         * @since 3.0.0
         */
        ...
        /**
         * The calling context for {@link Vsengine.GameObjects.Particles.ParticleEmitter#emitCallback}.
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#emitCallbackScope
         * @type {?*}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#deathCallback
         * @type {?Vsengine.Types.GameObjects.Particles.ParticleDeathCallback}
         * @default null
         * @since 3.0.0
         */
        ...
        /**
         * The calling context for {@link Vsengine.GameObjects.Particles.ParticleEmitter#deathCallback}.
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#deathCallbackScope
         * @type {?*}
         * @default null
         * @since 3.0.0
         */
         ...
         * 0 means unlimited.
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#maxParticles
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         * 0 means no limits.
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#maxAliveParticles
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#stopAfter
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#duration
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         * Calling {@link Vsengine.GameObjects.Particles.ParticleEmitter#flow} also puts the emitter in flow mode (frequency >= 0).
         * Calling {@link Vsengine.GameObjects.Particles.ParticleEmitter#explode} also puts the emitter in explode mode (frequency = -1).
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#frequency
         * @type {number}
         * @default 0
         * @since 3.0.0
         * @see Vsengine.GameObjects.Particles.ParticleEmitter#setFrequency
         */
        this.frequency = 0;
         ...
         *
         * Controlled by {@link Vsengine.GameObjects.Particles.ParticleEmitter#start} and {@link Vsengine.GameObjects.Particles.ParticleEmitter#stop}.
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#emitting
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#particleBringToTop
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#timeScale
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * Prior to Vsengine v3.60 an Emitter could only have one single Emission Zone.
         * In 3.60 they can now have an array of Emission Zones.
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#emitZones
         * @type {Vsengine.Types.GameObjects.Particles.EmitZoneObject[]}
         * @since 3.60.0
         * @see Vsengine.GameObjects.Particles.ParticleEmitter#setEmitZone
         */
        this.emitZones = [];
         ...
         *
         * Prior to Vsengine v3.60 an Emitter could only have one single Death Zone.
         * In 3.60 they can now have an array of Death Zones.
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#deathZones
         * @type {Vsengine.GameObjects.Particles.Zones.DeathZone[]}
         * @since 3.60.0
         * @see Vsengine.GameObjects.Particles.ParticleEmitter#setDeathZone
         */
        this.deathZones = [];
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#viewBounds
         * @type {?Vsengine.Geom.Rectangle}
         * @default null
         * @since 3.60.0
         * @see Vsengine.GameObjects.Particles.ParticleEmitter#setViewBounds
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#follow
         * @type {?Vsengine.Types.Math.Vector2Like}
         * @default null
         * @since 3.0.0
         * @see Vsengine.GameObjects.Particles.ParticleEmitter#startFollow
         * @see Vsengine.GameObjects.Particles.ParticleEmitter#stopFollow
         */
        this.follow = null;

        /**
         * The offset of the particle origin from the {@link Vsengine.GameObjects.Particles.ParticleEmitter#follow} target.
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#followOffset
        ...
        /**
         * Whether the emitter's {@link Vsengine.GameObjects.Particles.ParticleEmitter#visible} state will track
         * the {@link Vsengine.GameObjects.Particles.ParticleEmitter#follow} target's visibility state.
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#trackVisible
         * @type {boolean}
         * @default false
         * @since 3.0.0
         * @see Vsengine.GameObjects.Particles.ParticleEmitter#startFollow
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#frames
        ...
        /**
         * Whether texture {@link Vsengine.GameObjects.Particles.ParticleEmitter#frames} are selected at random.
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#randomFrame
         * @type {boolean}
         * @default true
         * @since 3.0.0
         * @see Vsengine.GameObjects.Particles.ParticleEmitter#setEmitterFrame
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#frameQuantity
         * @type {number}
         * @default 1
         * @since 3.0.0
         * @see Vsengine.GameObjects.Particles.ParticleEmitter#setEmitterFrame
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#anims
         * @type {string[]}
         * @since 3.60.0
         */
        this.anims = [];
        ...
        /**
         * Whether animations {@link Vsengine.GameObjects.Particles.ParticleEmitter#anims} are selected at random.
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#randomAnim
         * @type {boolean}
         * @default true
         * @since 3.60.0
         * @see Vsengine.GameObjects.Particles.ParticleEmitter#setAnim
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#animQuantity
         * @type {number}
         * @default 1
         * @since 3.60.0
         * @see Vsengine.GameObjects.Particles.ParticleEmitter#setAnim
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#dead
         * @type {Vsengine.GameObjects.Particles.Particle[]}
         * @private
         * @since 3.0.0
         */
        this.dead = [];
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#alive
         * @type {Vsengine.GameObjects.Particles.Particle[]}
         * @private
         * @since 3.0.0
         */
         ...
         * 1 - frameCounter - Counts up to {@link Vsengine.GameObjects.Particles.ParticleEmitter#frameQuantity}.
         ...
         * 8 - currentFrame - The current texture frame, as an index of {@link Vsengine.GameObjects.Particles.ParticleEmitter#frames}.
         * 9 - currentAnim - The current animation, as an index of {@link Vsengine.GameObjects.Particles.ParticleEmitter#anims}.
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#counters
         * @type {Float32Array}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#skipping
         * @type {boolean}
         * @default true
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#worldMatrix
         * @type {Vsengine.GameObjects.Components.TransformMatrix}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#sortProperty
         * @type {string}
         * @since 3.60.0
         */
        this.sortProperty = "";
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#sortOrderAsc
         * @type {boolean}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#sortCallback
         * @type {?Vsengine.Types.GameObjects.Particles.ParticleSortCallback}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#processors
         * @type {Vsengine.Structs.List.<Vsengine.GameObjects.Particles.ParticleProcessor>}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleEmitter#tintFill
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#setConfig
     * @since 3.60.0
     *
     * @param {Vsengine.Types.GameObjects.Particles.ParticleEmitterConfig} config - Settings for this emitter.
     *
    ...
    setConfig: function (config) {
        ...
        if (HasValue(config, "followOffset")) {
            this.followOffset.setFromObject(
                GetFastValue(config, "followOffset", 0)
            );
        }
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#updateConfig
     * @since 3.85.0
     *
     * @param {Vsengine.Types.GameObjects.Particles.ParticleEmitterConfig} config - Settings for this emitter.
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#toJSON
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#resetCounters
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#startFollow
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Math.Vector2Like} target - The Object to follow.
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#stopFollow
     * @since 3.0.0
     *
     * @return {this} This Particle Emitter.
     */
    ...
    /**
     * Chooses a texture frame from {@link Vsengine.GameObjects.Particles.ParticleEmitter#frames}.
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#getFrame
     * @since 3.0.0
     *
     * @return {Vsengine.Textures.Frame} The texture frame.
     */
    getFrame: function () {
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#setEmitterFrame
     * @since 3.0.0
     *
     * @param {(array|string|number|Vsengine.Types.GameObjects.Particles.ParticleEmitterFrameConfig)} frames - One or more texture frames, or a configuration object.
    ...
    setEmitterFrame: function (frames, pickRandom, quantity) {
        ...
        if (Array.isArray(frames)) {
            ...
            this.frameQuantity = GetFastValue(
                frameConfig,
                "quantity",
                quantity
            );
    ...
    /**
     * Chooses an animation from {@link Vsengine.GameObjects.Particles.ParticleEmitter#anims}, if populated.
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#getAnim
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#setAnim
     * @since 3.60.0
     *
     * @param {(string|string[]|Vsengine.Types.GameObjects.Particles.ParticleEmitterAnimConfig)} anims - One or more animations, or a configuration object.
    ...
    /**
     * Turns {@link Vsengine.GameObjects.Particles.ParticleEmitter#radial} particle movement on or off.
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#setRadial
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#addParticleBounds
     * @since 3.60.0
     *
     * @param {(number|Vsengine.Types.GameObjects.Particles.ParticleEmitterBounds|Vsengine.Types.GameObjects.Particles.ParticleEmitterBoundsAlt)} x - The x-coordinate of the left edge of the boundary, or an object representing a rectangle.
     ...
     *
     * @return {Vsengine.GameObjects.Particles.ParticleBounds} The Particle Bounds processor.
     */
    addParticleBounds: function (
        x,
        y,
        width,
        height,
        ...
        return this.addParticleProcessor(
            new ParticleBounds(
                x,
                y,
                width,
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#setParticleSpeed
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#setParticleScale
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#setParticleGravity
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#setParticleAlpha
     * @since 3.60.0
     *
     * @param {(Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType|Vsengine.Types.GameObjects.Particles.EmitterOpOnUpdateType)} value - A value between 0 (transparent) and 1 (opaque).
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#setParticleTint
     * @since 3.60.0
     * @webglOnly
     *
     * @param {(Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType|Vsengine.Types.GameObjects.Particles.EmitterOpOnUpdateType)} value - A value between 0 and 0xffffff.
     *
     * @return {this} This Particle Emitter.
     */
    ...
    /**
     * Sets the angle of a {@link Vsengine.GameObjects.Particles.ParticleEmitter#radial} particle stream.
     *
     * The value is given in degrees using Vsengine's right-handed coordinate system.
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#setEmitterAngle
     * @since 3.0.0
     *
     * @param {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType} value - The angle of the initial velocity of emitted particles, in degrees.
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#setParticleLifespan
     * @since 3.60.0
     *
     * @param {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType} value - The lifespan of a particle, in ms.
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#setQuantity
     * @since 3.0.0
     *
     * @param {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType} quantity - The number of particles to release at each flow cycle or explosion.
     *
     * @return {this} This Particle Emitter.
     */
    ...
    /**
     * Sets the emitter's {@link Vsengine.GameObjects.Particles.ParticleEmitter#frequency}
     * and {@link Vsengine.GameObjects.Particles.ParticleEmitter#quantity}.
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#setFrequency
     * @since 3.0.0
     *
     ...
     * Any valid object from the `Vsengine.Geometry` namespace is allowed, as long as
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#addDeathZone
     * @since 3.60.0
     *
     * @param {Vsengine.Types.GameObjects.Particles.DeathZoneObject|Vsengine.Types.GameObjects.Particles.DeathZoneObject[]} config - A Death Zone configuration object, a Death Zone instance, a valid Geometry object or an array of them.
     *
     * @return {Vsengine.GameObjects.Particles.Zones.DeathZone[]} An array of the Death Zones that were added to this Emitter.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#removeDeathZone
     * @since 3.60.0
     *
     * @param {Vsengine.GameObjects.Particles.Zones.DeathZone} zone - The Death Zone that should be removed from this Emitter.
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#clearDeathZones
     * @since 3.70.0
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * An {@link Vsengine.Types.GameObjects.Particles.ParticleEmitterEdgeZoneConfig EdgeZone} places particles on its edges.
     * Its {@link Vsengine.Types.GameObjects.Particles.EdgeZoneSource source} can be a Curve, Path, Circle, Ellipse, Line, Polygon, Rectangle, or Triangle;
     * or any object with a suitable {@link Vsengine.Types.GameObjects.Particles.EdgeZoneSourceCallback getPoints} method.
     *
     * A {@link Vsengine.Types.GameObjects.Particles.ParticleEmitterRandomZoneConfig RandomZone} places the particles randomly within its interior.
     * Its {@link RandomZoneSource source} can be a Circle, Ellipse, Line, Polygon, Rectangle, or Triangle; or any object with a suitable {@link Vsengine.Types.GameObjects.Particles.RandomZoneSourceCallback getRandomPoint} method.
     *
     * An Emission Zone can only exist once within this Emitter.
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#addEmitZone
     * @since 3.60.0
     *
     * @param {Vsengine.Types.GameObjects.Particles.EmitZoneData|Vsengine.Types.GameObjects.Particles.EmitZoneData[]} zone - An Emission Zone configuration object, a RandomZone or EdgeZone instance, or an array of them.
     *
     * @return {Vsengine.Types.GameObjects.Particles.EmitZoneObject[]} An array of the Emission Zones that were added to this Emitter.
     */
        ...
        for (var i = 0; i < config.length; i++) {
            ...
            if (zone instanceof RandomZone || zone instanceof EdgeZone) {
                ...
                if (source) {
                    ...
                    if (
                        type === "random" &&
                        typeof source.getRandomPoint === "function"
                    ) {
                        ...
                        type === "edge" &&
                        typeof source.getPoints === "function"
                    ) {
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#removeEmitZone
     * @since 3.60.0
     *
     * @param {Vsengine.GameObjects.Particles.Zones.EdgeZone|Vsengine.GameObjects.Particles.Zones.RandomZone} zone - The Emission Zone that should be removed from this Emitter.
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#clearEmitZones
     * @since 3.70.0
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#getEmitZone
     * @since 3.60.0
     *
     * @param {Vsengine.GameObjects.Particles.Particle} particle - The particle to set the emission zone for.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#getDeathZone
     * @fires Vsengine.GameObjects.Particles.Events#DEATH_ZONE
     * @since 3.60.0
     *
     * @param {Vsengine.GameObjects.Particles.Particle} particle - The particle to test against the Death Zones.
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#setEmitZone
     * @since 3.0.0
     *
     * @param {number|Vsengine.GameObjects.Particles.Zones.EdgeZone|Vsengine.GameObjects.Particles.Zones.RandomZone} zone - The Emit Zone to set as the active zone.
     *
     * @return {this} This Particle Emitter.
     */
     ...
     * property is set.
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#addParticleProcessor
     * @since 3.60.0
     *
     * @generic {Vsengine.GameObjects.Particles.ParticleProcessor} T
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#removeParticleProcessor
     * @since 3.60.0
     *
     * @generic {Vsengine.GameObjects.Particles.ParticleProcessor} T
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#getProcessors
     * @since 3.60.0
     *
     * @return {Vsengine.GameObjects.Particles.ParticleProcessor[]} - An array of active Particle Processors.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#createGravityWell
     * @since 3.60.0
     *
     * @param {Vsengine.Types.GameObjects.Particles.GravityWellConfig} config - Configuration settings for the Gravity Well to create.
     *
     * @return {Vsengine.GameObjects.Particles.GravityWell} The Gravity Well that was created.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#reserve
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#getAliveParticleCount
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#getDeadParticleCount
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#getParticleCount
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#atLimit
     * @since 3.0.0
     *
    ...
    atLimit: function () {
        ...
        return (
            this.maxAliveParticles > 0 &&
            this.getAliveParticleCount() >= this.maxAliveParticles
        );
    },
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#onParticleEmit
     * @since 3.0.0
     *
     * @param {Vsengine.Types.GameObjects.Particles.ParticleEmitterCallback} callback - The function.
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#onParticleDeath
     * @since 3.0.0
     *
     * @param {Vsengine.Types.GameObjects.Particles.ParticleDeathCallback} callback - The function.
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#killAll
     * @since 3.0.0
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#forEachAlive
     * @since 3.0.0
     *
     * @param {Vsengine.Types.GameObjects.Particles.ParticleEmitterCallback} callback - The function.
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#forEachDead
     * @since 3.0.0
     *
     * @param {Vsengine.Types.GameObjects.Particles.ParticleEmitterCallback} callback - The function.
     * @param {*} context - The functions calling context.
    ...
    /**
     * Turns {@link Vsengine.GameObjects.Particles.ParticleEmitter#on} the emitter and resets the flow counter.
     *
     * If this emitter is in flow mode (frequency >= 0; the default), the particle flow will start (or restart).
     *
     * If this emitter is in explode mode (frequency = -1), nothing will happen.
     * Use {@link Vsengine.GameObjects.Particles.ParticleEmitter#explode} or {@link Vsengine.GameObjects.Particles.ParticleEmitter#flow} instead.
     *
     * Calling this method will emit the `START` event.
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#start
     * @fires Vsengine.GameObjects.Particles.Events#START
     * @since 3.0.0
     *
    ...
    /**
     * Turns {@link Vsengine.GameObjects.Particles.ParticleEmitter#emitting off} the emitter and
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#stop
     * @fires Vsengine.GameObjects.Particles.Events#STOP
     * @since 3.11.0
     *
    ...
    /**
     * {@link Vsengine.GameObjects.Particles.ParticleEmitter#active Deactivates} the emitter.
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#pause
     * @since 3.0.0
     *
     * @return {this} This Particle Emitter.
     */
    ...
    /**
     * {@link Vsengine.GameObjects.Particles.ParticleEmitter#active Activates} the emitter.
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#resume
     * @since 3.0.0
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#setSortProperty
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#setSortCallback
     * @since 3.60.0
     *
     * @param {Vsengine.Types.GameObjects.Particles.ParticleSortCallback} [callback] - The callback to invoke when the particles are sorted. Leave undefined to reset to the default.
     *
     * @return {this} This Particle Emitter.
     */
    ...
    /**
     * Sorts active particles with {@link Vsengine.GameObjects.Particles.ParticleEmitter#depthSortCallback}.
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#depthSort
     * @since 3.0.0
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#depthSortCallback
     * @since 3.0.0
     *
     ...
     *
     * To resume a flow at the current frequency and quantity, use {@link Vsengine.GameObjects.Particles.ParticleEmitter#start} instead.
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#flow
     * @fires Vsengine.GameObjects.Particles.Events#START
     * @since 3.0.0
     *
     * @param {number} frequency - The time interval (>= 0) of each flow cycle, in ms.
     * @param {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType} [count=1] - The number of particles to emit at each flow cycle.
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#explode
     * @fires Vsengine.GameObjects.Particles.Events#EXPLODE
     * @since 3.0.0
     *
     ...
     *
     * @return {(Vsengine.GameObjects.Particles.Particle|undefined)} The most recently emitted Particle, or `undefined` if the emitter is at its limit.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#emitParticleAt
     * @since 3.0.0
     *
     * @param {number} [x=this.x] - The x coordinate to emit the Particles from.
     * @param {number} [y=this.x] - The y coordinate to emit the Particles from.
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#emitParticle
     * @since 3.0.0
     *
     * @param {number} [count=this.quantity] - The number of Particles to emit.
     * @param {number} [x=this.x] - The x coordinate to emit the Particles from.
     ...
     * @return {(Vsengine.GameObjects.Particles.Particle|undefined)} The most recently emitted Particle, or `undefined` if the emitter is at its limit.
     *
     * @see Vsengine.GameObjects.Particles.Particle#fire
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#fastForward
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#preUpdate
     * @fires Vsengine.GameObjects.Particles.Events#COMPLETE
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#overlap
     * @since 3.60.0
     *
     * @param {(Vsengine.Geom.Rectangle|Vsengine.Physics.Arcade.Body)} target - A Rectangle or Arcade Physics Body to check for intersection against all alive particles.
     *
     * @return {Vsengine.GameObjects.Particles.Particle[]} An array of Particles that overlap with the given target.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#getBounds
     * @since 3.60.0
     *
     ...
     * @param {number} [delta] - The amount of delta to use for each step. Defaults to 1000 / 60.
     * @param {Vsengine.Geom.Rectangle} [output] - The Rectangle to store the results in. If not given a new one will be created.
     *
     * @return {Vsengine.Geom.Rectangle} A Rectangle containing the calculated bounds of this Emitter.
     */
     ...
     * thinking it works the same way as Vsengine v3.55.
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#createEmitter
     * @since 3.60.0
     */
     ...
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#particleX
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType|Vsengine.Types.GameObjects.Particles.EmitterOpOnUpdateType}
     * @since 3.60.0
     */
    particleX: {
        get: function () {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#particleY
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType|Vsengine.Types.GameObjects.Particles.EmitterOpOnUpdateType}
     * @since 3.60.0
     */
    particleY: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#accelerationX
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    accelerationX: {
        get: function () {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#accelerationY
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    accelerationY: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#maxVelocityX
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     * @default 10000
     */
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#maxVelocityY
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     * @default 10000
     */
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#speed
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    speed: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#speedX
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    speedX: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#speedY
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    speedY: {
    ...
    /**
     * The x coordinate emitted particles move toward, when {@link Vsengine.GameObjects.Particles.ParticleEmitter#moveTo} is true.
     *
     * Accessing this property should typically return a number.
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#moveToX
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    moveToX: {
    ...
    /**
     * The y coordinate emitted particles move toward, when {@link Vsengine.GameObjects.Particles.ParticleEmitter#moveTo} is true.
     *
     * Accessing this property should typically return a number.
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#moveToY
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    moveToY: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#bounce
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    bounce: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#particleScaleX
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    particleScaleX: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#particleScaleY
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    particleScaleY: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#particleColor
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    particleColor: {
     ...
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#colorEase
     * @type {string}
     * @since 3.60.0
     */
    colorEase: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#particleTint
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    particleTint: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#particleAlpha
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    particleAlpha: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#lifespan
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    lifespan: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#particleAngle
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    particleAngle: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#particleRotate
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    particleRotate: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#quantity
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @see Vsengine.GameObjects.Particles.ParticleEmitter#setFrequency
     * @see Vsengine.GameObjects.Particles.ParticleEmitter#setQuantity
     * @since 3.60.0
     */
    quantity: {
        get: function () {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#delay
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    delay: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#hold
     * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    hold: {
     ...
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#flowCounter
     * @type {number}
     * @since 3.60.0
     */
    flowCounter: {
     ...
     * Treat this property as read-only.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#frameCounter
     * @type {number}
     * @since 3.60.0
     */
    frameCounter: {
     ...
     * Treat this property as read-only.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#animCounter
     * @type {number}
     * @since 3.60.0
     */
    animCounter: {
     ...
     * Treat this property as read-only.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#elapsed
     * @type {number}
     * @since 3.60.0
     */
    elapsed: {
     ...
     * Treat this property as read-only.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#stopCounter
     * @type {number}
     * @since 3.60.0
     */
    stopCounter: {
     ...
     * Treat this property as read-only.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#completeFlag
     * @type {boolean}
     * @since 3.60.0
     */
    completeFlag: {
     ...
     * Treat this property as read-only.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#zoneIndex
     * @type {number}
     * @since 3.60.0
     */
    zoneIndex: {
     ...
     * Treat this property as read-only.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#zoneTotal
     * @type {number}
     * @since 3.60.0
     */
    zoneTotal: {
     ...
     * Treat this property as read-only.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#currentFrame
     * @type {number}
     * @since 3.60.0
     */
    currentFrame: {
     ...
     * Treat this property as read-only.
     *
     * @name Vsengine.GameObjects.Particles.ParticleEmitter#currentAnim
     * @type {number}
     * @since 3.60.0
     */
    currentAnim: {
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleEmitter#preDestroy
     * @since 3.60.0
     */
    preDestroy: function () {
        this.texture = null;
