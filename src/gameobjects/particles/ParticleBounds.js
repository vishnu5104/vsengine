 ...
 * @extends Vsengine.GameObjects.Particles.ParticleProcessor
...
var ParticleBounds = new Class({
    ...
    initialize: function ParticleBounds(
        x,
        y,
        width,
        height,
         ...
         * the boundary.
         *
         * @name Vsengine.GameObjects.Particles.ParticleBounds#bounds
        ...
        /**
         * Whether particles interact with the left edge of the emitter {@link Vsengine.GameObjects.Particles.ParticleEmitter#bounds}.
         *
         * @name Vsengine.GameObjects.Particles.ParticleBounds#collideLeft
         * @type {boolean}
         * @default true
         * @since 3.60.0
         */
        ...
        /**
         * Whether particles interact with the right edge of the emitter {@link Vsengine.GameObjects.Particles.ParticleBounds#bounds}.
         *
         * @name Vsengine.GameObjects.Particles.ParticleBounds#collideRight
         * @type {boolean}
         * @default true
         * @since 3.60.0
         */
        ...
        /**
         * Whether particles interact with the top edge of the emitter {@link Vsengine.GameObjects.Particles.ParticleBounds#bounds}.
         *
         * @name Vsengine.GameObjects.Particles.ParticleBounds#collideTop
         * @type {boolean}
         * @default true
         * @since 3.60.0
         */
        ...
        /**
         * Whether particles interact with the bottom edge of the emitter {@link Vsengine.GameObjects.Particles.ParticleBounds#bounds}.
         *
         * @name Vsengine.GameObjects.Particles.ParticleBounds#collideBottom
         * @type {boolean}
         * @default true
         * @since 3.60.0
         */
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleBounds#update
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.Particles.Particle} particle - The Particle to update.
     */
