 ...
 *
 * @method Vsengine.GameObjects.GameObjectCreator#particles
 * @since 3.0.0
 *
 * @param {Vsengine.Types.GameObjects.Particles.ParticleEmitterCreatorConfig} config - The configuration object this Game Object will use to create itself.
