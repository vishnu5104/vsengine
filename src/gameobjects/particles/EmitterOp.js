 ...
 * @param {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType|Vsengine.Types.GameObjects.Particles.EmitterOpOnUpdateType} defaultValue - The default value of the property.
 * @param {boolean} [emitOnly=false] - Whether the property can only be modified when a Particle is emitted.
 */
var EmitterOp = new Class({
    initialize: function EmitterOp(key, defaultValue, emitOnly) {
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#propertyKey
         * @type {string}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#propertyValue
         ...
         * configuration object.
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#defaultValue
         * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitType|Vsengine.Types.GameObjects.Particles.EmitterOpOnUpdateType}
         * @since 3.0.0
         */
        ...
        /**
         * The number of steps for stepped easing between {@link Vsengine.GameObjects.Particles.EmitterOp#start} and
         * {@link Vsengine.GameObjects.Particles.EmitterOp#end} values, per emit.
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#steps
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#counter
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#yoyo
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#direction
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#start
         * @type {number|number[]}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#current
         * @type {number}
         * @since 3.60.0
         */
        this.current = 0;
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#end
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#ease
         * @type {?function}
         * @since 3.0.0
         */
        this.ease = null;
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#interpolation
         * @type {?function}
         * @since 3.60.0
         */
         ...
         *
         * Set to `true` to allow only {@link Vsengine.GameObjects.Particles.EmitterOp#onEmit} callbacks to be set and
         * affect this property.
         *
         * Set to `false` to allow both {@link Vsengine.GameObjects.Particles.EmitterOp#onEmit} and
         * {@link Vsengine.GameObjects.Particles.EmitterOp#onUpdate} callbacks to be set and affect this property.
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#emitOnly
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#onEmit
         * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitCallback}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#onUpdate
         * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnUpdateCallback}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#active
         * @type {boolean}
         * @since 3.60.0
         */
        this.active = true;
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#method
         * @type {number}
         * @since 3.60.0
         */
        this.method = 0;
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#_onEmit
         * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnEmitCallback}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.EmitterOp#_onUpdate
         * @type {Vsengine.Types.GameObjects.Particles.EmitterOpOnUpdateCallback}
         * @private
         * @since 3.60.0
         */
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#loadConfig
     * @since 3.0.0
     *
     * @param {Vsengine.Types.GameObjects.Particles.ParticleEmitterConfig} [config] - Settings for the Particle Emitter that owns this property.
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#toJSON
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#onChange
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#getMethod
     * @since 3.60.0
     *
    ...
    /**
     * Update the {@link Vsengine.GameObjects.Particles.EmitterOp#onEmit} and
     * {@link Vsengine.GameObjects.Particles.EmitterOp#onUpdate} callbacks based on the method returned
     * from `getMethod`. The method is stored in the `EmitterOp.method` property
     * and is a number between 0 and 9 inclusively.
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#setMethods
     * @since 3.0.0
     *
     * @return {this} This Emitter Op object.
     */
    setMethods: function () {
        ...
        switch (this.method) {
            ...
            case 5:
                ...
                onEmit =
                    this.has(value, "random") && value.random
            ...
            case 6:
                ...
                this.end = value.max;
                onEmit =
                    this.has(value, "int") && value.int
                        ? this.randomRangedIntEmit
                        : this.randomRangedValueEmit;
                current = this.start;
                break;
            ...
            //  Custom onEmit and/or onUpdate callbacks
            case 8:
                this._onEmit = this.has(value, "onEmit")
                    ? value.onEmit
                    : this.defaultEmit;
                this._onUpdate = this.has(value, "onUpdate")
                    ? value.onUpdate
                    : this.defaultUpdate;
                onEmit = this.proxyEmit;
            ...
            case 9:
                ...
                this.interpolation = GetInterpolationFunction(
                    value.interpolation
                );
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#has
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#hasBoth
     * @since 3.0.0
     *
     * @param {object} object - The object to check.
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#hasEither
     * @since 3.0.0
     *
     * @param {object} object - The object to check.
     * @param {string} key1 - The key of the first property to check the object for.
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#defaultEmit
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The name of the property.
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#defaultUpdate
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The name of the property.
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#proxyEmit
     * @since 3.60.0
     *
     * @param {Vsengine.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The name of the property.
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#proxyUpdate
     * @since 3.60.0
     *
     * @param {Vsengine.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The name of the property.
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#staticValueEmit
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#staticValueUpdate
     * @since 3.0.0
     *
     * @return {number} The current value of the property.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#randomStaticValueEmit
     * @since 3.0.0
     *
     * @return {number} The new value of the property.
     */
    ...
    /**
     * An `onEmit` callback that returns a value between the {@link Vsengine.GameObjects.Particles.EmitterOp#start} and
     * {@link Vsengine.GameObjects.Particles.EmitterOp#end} range.
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#randomRangedValueEmit
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.Particles.Particle} particle - The particle.
     ...
     * {@link Vsengine.GameObjects.Particles.EmitterOp#end} range.
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#randomRangedIntEmit
     * @since 3.60.0
     *
     * @param {Vsengine.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The key of the property.
     ...
     * {@link Vsengine.GameObjects.Particles.EmitterOp#start} and {@link Vsengine.GameObjects.Particles.EmitterOp#end}
     * range.
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#steppedEmit
     * @since 3.0.0
     *
     * @return {number} The new value of the property.
     */
     ...
     *
     * It prepares the particle for easing by {@link Vsengine.GameObjects.Particles.EmitterOp#easeValueUpdate}.
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#easedValueEmit
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The name of the property.
     *
     * @return {number} {@link Vsengine.GameObjects.Particles.EmitterOp#start}, as the new value of the property.
     */
     ...
     * range.
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#easeValueUpdate
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The name of the property.
     ...
     *
     * @method Vsengine.GameObjects.Particles.EmitterOp#destroy
     * @since 3.60.0
     */
    destroy: function () {
