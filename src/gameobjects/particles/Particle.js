 ...
 * @since 3.0.0
 *
 * @param {Vsengine.GameObjects.Particles.ParticleEmitter} emitter - The Emitter to which this Particle belongs.
 */
var Particle = new Class({
    initialize: function Particle(emitter) {
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#emitter
         * @type {Vsengine.GameObjects.Particles.ParticleEmitter}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#texture
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#frame
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#x
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#y
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#worldPosition
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#velocityX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#velocityY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#accelerationX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#accelerationY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#maxVelocityX
         * @type {number}
         * @default 10000
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#maxVelocityY
         * @type {number}
         * @default 10000
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#bounce
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#scaleX
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#scaleY
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#alpha
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#angle
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#rotation
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#tint
         * @type {number}
         * @webglOnly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#life
         * @type {number}
         * @default 1000
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#lifeCurrent
         * @type {number}
         * @default 1000
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#delayCurrent
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#holdCurrent
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#lifeT
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#data
         * @type {Vsengine.Types.GameObjects.Particles.ParticleData}
         * @since 3.0.0
         */
        this.data = {
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#isCropped
         * @type {boolean}
         * @private
         * @readonly
         * @since 3.60.0
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#scene
         * @type {Vsengine.Scene}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#anims
         * @type {Vsengine.Animations.AnimationState}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Particles.Particle#bounds
     ...
     *
     * @method Vsengine.GameObjects.Particles.Particle#emit
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.Particle#isAlive
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.Particle#kill
     * @since 3.60.0
     */
    kill: function () {
        this.lifeCurrent = 0;
     ...
     *
     * @method Vsengine.GameObjects.Particles.Particle#setPosition
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.Particle#fire
     * @since 3.0.0
     *
    ...
    fire: function (x, y) {
        ...
        this.scaleY = ops.scaleY.active
            ? ops.scaleY.onEmit(this, "scaleY")
            : this.scaleX;
        ...
        if (emitter.acceleration) {
            this.accelerationX = ops.accelerationX.onEmit(
                this,
                "accelerationX"
            );
            this.accelerationY = ops.accelerationY.onEmit(
                this,
                "accelerationY"
            );
        }
     ...
     *
     * @method Vsengine.GameObjects.Particles.Particle#update
     * @since 3.0.0
     *
     * @param {number} delta - The delta time in ms.
     * @param {number} step - The delta value divided by 1000.
     * @param {Vsengine.GameObjects.Particles.ParticleProcessor[]} processors - An array of all active Particle Processors.
     *
    ...
    update: function (delta, step, processors) {
        ...
        this.alpha = Clamp(
            ops.alpha.onUpdate(this, "alpha", t, this.alpha),
            0,
            1
        );
     ...
     *
     * @method Vsengine.GameObjects.Particles.Particle#computeVelocity
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.Particles.ParticleEmitter} emitter - The Emitter that is updating this Particle.
     * @param {number} delta - The delta time in ms.
     * @param {number} step - The delta value divided by 1000.
     * @param {Vsengine.GameObjects.Particles.ParticleProcessor[]} processors - An array of all active Particle Processors.
    ...
    computeVelocity: function (emitter, delta, step, processors, t) {
        ...
        var ax = ops.accelerationX.onUpdate(
            this,
            "accelerationX",
            t,
            this.accelerationX
        );
        var ay = ops.accelerationY.onUpdate(
            this,
            "accelerationY",
            t,
            this.accelerationY
        ...
        var mx = ops.maxVelocityX.onUpdate(
            this,
            "maxVelocityX",
            t,
            this.maxVelocityX
        );
        var my = ops.maxVelocityY.onUpdate(
            this,
            "maxVelocityY",
            t,
            this.maxVelocityY
     ...
     *
     * @method Vsengine.GameObjects.Particles.Particle#setSizeToFrame
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.Particle#getBounds
     * @since 3.60.0
     *
     * @param {Vsengine.GameObjects.Components.TransformMatrix} [matrix] - Optional transform matrix to apply to this particle.
     *
     * @return {Vsengine.Geom.Rectangle} A Rectangle containing the transformed bounds of this particle.
     */
     ...
     *
     * @method Vsengine.GameObjects.Particles.Particle#destroy
     * @since 3.60.0
     */
    destroy: function () {
        this.anims.destroy();
