...
var ParticleProcessor = new Class({
    initialize: function ParticleProcessor(x, y, active) {
        if (x === undefined) {
            x = 0;
        }
        if (y === undefined) {
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleProcessor#manager
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleProcessor#x
         * @type {number}
         * @since 3.60.0
         */
        this.x = x;
         ...
         *
         * @name Vsengine.GameObjects.Particles.ParticleProcessor#y
         * @type {number}
         * @since 3.60.0
         */
        this.y = y;
         ...
         * its parent Emitter.
         *
         * @name Vsengine.GameObjects.Particles.ParticleProcessor#active
         * @type {boolean}
         * @since 3.60.0
         */
        this.active = active;
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleProcessor#update
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Particles.ParticleProcessor#destroy
     * @since 3.60.0
     */
    destroy: function () {
        this.emitter = null;
