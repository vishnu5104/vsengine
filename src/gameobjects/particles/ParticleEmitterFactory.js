 ...
 *
 * Prior to Vsengine v3.60 this function would create a `ParticleEmitterManager`. These were removed
 ...
 *
 * Note: This method will only be available if the Particles Game Object has been built into Vsengine.
 *
 * @method Vsengine.GameObjects.GameObjectFactory#particles
 * @since 3.60.0
 *
 ...
 * @param {Vsengine.Types.GameObjects.Particles.ParticleEmitterConfig} [config] - Configuration settings for the Particle Emitter.
 *
 * @return {Vsengine.GameObjects.Particles.ParticleEmitter} The Game Object that was created.
 */
GameObjectFactory.register("particles", function (x, y, texture, config) {
    if (x !== undefined && typeof x === "string") {
        console.warn(
            "ParticleEmitterManager was removed in Vsengine 3.60. See documentation for details"
        );
    }

    return this.displayList.add(
        new ParticleEmitter(this.scene, x, y, texture, config)
    );
});
