 ...
 *
 * Note: This method will only be available if the IsoTriangle Game Object has been built into Vsengine.
 *
 ...
 * down or not.
 *
 * @method Vsengine.GameObjects.GameObjectFactory#isotriangle
 * @since 3.13.0
 *
 ...
 *
 * @return {Vsengine.GameObjects.IsoTriangle} The Game Object that was created.
 */
GameObjectFactory.register(
    "isotriangle",
    function (x, y, size, height, reversed, fillTop, fillLeft, fillRight) {
