 ...
 *
 * @class IsoTriangle
 * @extends Vsengine.GameObjects.Shape
...
var IsoTriangle = new Class({
    ...
    initialize: function IsoTriangle(
        scene,
        x,
        y,
        size,
         ...
         *
         * @name Vsengine.GameObjects.IsoTriangle#projection
         * @type {number}
         * @default 4
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.IsoTriangle#fillTop
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.IsoTriangle#fillLeft
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.IsoTriangle#fillRight
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.IsoTriangle#showTop
         * @type {boolean}
         * @default true
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.IsoTriangle#showLeft
         * @type {boolean}
         * @default true
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.IsoTriangle#showRight
         * @type {boolean}
         * @default true
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.IsoTriangle#isReversed
         * @type {boolean}
         * @default false
         * @since 3.13.0
         */
     ...
     *
     * @method Vsengine.GameObjects.IsoTriangle#setProjection
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method Vsengine.GameObjects.IsoTriangle#setReversed
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method Vsengine.GameObjects.IsoTriangle#setFaces
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method Vsengine.GameObjects.IsoTriangle#setFillStyle
     * @since 3.13.0
     *
