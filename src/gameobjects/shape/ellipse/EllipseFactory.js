 ...
 *
 * Note: This method will only be available if the Ellipse Game Object has been built into Vsengine.
 *
 ...
 * jagged, shapes.
 *
 * @method Vsengine.GameObjects.GameObjectFactory#ellipse
 * @since 3.13.0
 *
 ...
 *
 * @return {Vsengine.GameObjects.Ellipse} The Game Object that was created.
 */
GameObjectFactory.register(
    "ellipse",
    function (x, y, width, height, fillColor, fillAlpha) {
        return this.displayList.add(
            new Ellipse(this.scene, x, y, width, height, fillColor, fillAlpha)
        );
    }
);
