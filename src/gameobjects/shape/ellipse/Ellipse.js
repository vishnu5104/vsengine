...
var Ellipse = new Class({
    ...
    initialize: function Ellipse(
        ...
        Shape.call(
            ...
            scene,
            "Ellipse",
            new GeomEllipse(width / 2, height / 2, width, height)
        );
         ...
         *
         * @name Vsengine.GameObjects.Ellipse#_smoothness
         * @type {number}
         * @private
         * @since 3.13.0
         */
     ...
     *
     * @name Vsengine.GameObjects.Ellipse#smoothness
     * @type {number}
     * @default 64
     * @since 3.13.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Ellipse#setSize
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method Vsengine.GameObjects.Ellipse#setSmoothness
     * @since 3.13.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Ellipse#updateData
     * @private
     * @since 3.13.0
     *
     * @return {this} This Game Object instance.
