...
var Arc = new Class({
    ...
    initialize: function Arc(
         ...
         *
         * @name Vsengine.GameObjects.Arc#_startAngle
         * @type {number}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Arc#_endAngle
         * @type {number}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Arc#_anticlockwise
         * @type {boolean}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Arc#_iterations
         * @type {number}
         * @default 0.01
         * @private
         * @since 3.13.0
     ...
     *
     * @name Vsengine.GameObjects.Arc#iterations
     * @type {number}
     * @default 0.01
     * @since 3.13.0
     */
     ...
     *
     * @name Vsengine.GameObjects.Arc#radius
     * @type {number}
     * @since 3.13.0
     */
    radius: {
     ...
     *
     * @name Vsengine.GameObjects.Arc#startAngle
     * @type {number}
     * @since 3.13.0
     */
    startAngle: {
     ...
     *
     * @name Vsengine.GameObjects.Arc#endAngle
     * @type {number}
     * @since 3.13.0
     */
    endAngle: {
     ...
     *
     * @name Vsengine.GameObjects.Arc#anticlockwise
     * @type {boolean}
     * @since 3.13.0
     */
    anticlockwise: {
     ...
     *
     * @method Vsengine.GameObjects.Arc#setRadius
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method Vsengine.GameObjects.Arc#setIterations
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method Vsengine.GameObjects.Arc#setStartAngle
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method Vsengine.GameObjects.Arc#setEndAngle
     * @since 3.13.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Arc#updateData
     * @private
     * @since 3.13.0
     *
     * @return {this} This Game Object instance.
