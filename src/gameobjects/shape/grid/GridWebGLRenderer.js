 ...
 *
 * @method Vsengine.GameObjects.Grid#renderWebGL
 * @since 3.13.0
 * @private
 *
 * @param {Vsengine.Renderer.WebGL.WebGLRenderer} renderer - A reference to the current active WebGL renderer.
 * @param {Vsengine.GameObjects.Grid} src - The Game Object being rendered in this call.
...
var GridWebGLRenderer = function (renderer, src, camera, parentMatrix) {
    ...
    if (showCells && src.fillAlpha > 0) {
        ...
        fillTintColor = Utils.getTintAppendFloatAlpha(
            src.fillColor,
            src.fillAlpha * alpha
        );
    ...
    if (showOutline && src.outlineFillAlpha > 0) {
        ...
        var color = Utils.getTintAppendFloatAlpha(
            src.outlineFillColor,
            src.outlineFillAlpha * alpha
        );
