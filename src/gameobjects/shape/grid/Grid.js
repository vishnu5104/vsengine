...
var Grid = new Class({
    ...
    initialize: function Grid(
         ...
         *
         * @name Vsengine.GameObjects.Grid#cellWidth
         * @type {number}
         * @since 3.13.0
         */
         ...
         * Must be a positive value.
         *
         * @name Vsengine.GameObjects.Grid#cellHeight
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Grid#showCells
         * @type {boolean}
         * @since 3.13.0
         */
        this.showCells = true;
         ...
         *
         * @name Vsengine.GameObjects.Grid#outlineFillColor
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Grid#outlineFillAlpha
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Grid#showOutline
         * @type {boolean}
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Grid#showAltCells
         * @type {boolean}
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Grid#altFillColor
         * @type {number}
         * @since 3.13.0
         */
        this.altFillColor;
         ...
         *
         * @name Vsengine.GameObjects.Grid#altFillAlpha
         * @type {number}
         * @since 3.13.0
         */
        this.altFillAlpha;
     ...
     *
     * @method Vsengine.GameObjects.Grid#setFillStyle
     * @since 3.13.0
     *
     * @param {number} [fillColor] - The color the grid cells will be filled with, i.e. 0xff0000 for red.
     ...
     * This call can be chained.
     *
     * @method Vsengine.GameObjects.Grid#setAltFillStyle
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method Vsengine.GameObjects.Grid#setOutlineStyle
     * @since 3.13.0
     *
