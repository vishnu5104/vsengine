 ...
 *
 * Note: This method will only be available if the IsoBox Game Object has been built into Vsengine.
 *
 ...
 *
 * @method Vsengine.GameObjects.GameObjectFactory#isobox
 * @since 3.13.0
 *
 ...
 *
 * @return {Vsengine.GameObjects.IsoBox} The Game Object that was created.
 */
GameObjectFactory.register(
    "isobox",
    function (x, y, size, height, fillTop, fillLeft, fillRight) {
