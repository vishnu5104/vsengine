...
var IsoBox = new Class({
    ...
    initialize: function IsoBox(
         ...
         *
         * @name Vsengine.GameObjects.IsoBox#projection
         * @type {number}
         * @default 4
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.IsoBox#fillTop
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.IsoBox#fillLeft
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.IsoBox#fillRight
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.IsoBox#showTop
         * @type {boolean}
         * @default true
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.IsoBox#showLeft
         * @type {boolean}
         * @default true
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.IsoBox#showRight
         * @type {boolean}
         * @default true
         * @since 3.13.0
         */
     ...
     *
     * @method Vsengine.GameObjects.IsoBox#setProjection
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method Vsengine.GameObjects.IsoBox#setFaces
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method Vsengine.GameObjects.IsoBox#setFillStyle
     * @since 3.13.0
     *
