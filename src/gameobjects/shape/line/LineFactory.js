 ...
 *
 * Note: This method will only be available if the Line Game Object has been built into Vsengine.
 *
 ...
 *
 * @method Vsengine.GameObjects.GameObjectFactory#line
 * @since 3.13.0
 *
 ...
 *
 * @return {Vsengine.GameObjects.Line} The Game Object that was created.
 */
GameObjectFactory.register(
    "line",
    function (x, y, x1, y1, x2, y2, strokeColor, strokeAlpha) {
