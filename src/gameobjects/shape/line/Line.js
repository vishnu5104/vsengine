...
var Line = new Class({
    ...
    initialize: function Line(
         ...
         *
         * @name Vsengine.GameObjects.Line#lineWidth
         * @type {number}
         * @since 3.13.0
         */
        this.lineWidth = 1;
         ...
         *
         * @name Vsengine.GameObjects.Line#_startWidth
         * @type {number}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Line#_endWidth
         * @type {number}
         * @private
         * @since 3.13.0
         */
     ...
     *
     * @method Vsengine.GameObjects.Line#setLineWidth
     * @since 3.13.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Line#setTo
     * @since 3.13.0
     *
     * @param {number} [x1=0] - The horizontal position of the start of the line.
     * @param {number} [y1=0] - The vertical position of the start of the line.
