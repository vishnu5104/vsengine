 ...
 *
 * Note: This method will only be available if the Triangle Game Object has been built into Vsengine.
 *
 ...
 *
 * @method Vsengine.GameObjects.GameObjectFactory#triangle
 * @since 3.13.0
 *
 ...
 *
 * @return {Vsengine.GameObjects.Triangle} The Game Object that was created.
 */
GameObjectFactory.register(
    "triangle",
    function (x, y, x1, y1, x2, y2, x3, y3, fillColor, fillAlpha) {
