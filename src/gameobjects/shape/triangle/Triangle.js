...
var Triangle = new Class({
    ...
    initialize: function Triangle(
        ...
        Shape.call(
            ...
            scene,
            "Triangle",
            new GeomTriangle(x1, y1, x2, y2, x3, y3)
        );
     ...
     *
     * @method Vsengine.GameObjects.Triangle#setTo
     * @since 3.13.0
     *
     * @param {number} [x1=0] - The horizontal position of the first point in the triangle.
     ...
     *
     * @method Vsengine.GameObjects.Triangle#updateData
     * @private
     * @since 3.13.0
     *
     * @return {this} This Game Object instance.
