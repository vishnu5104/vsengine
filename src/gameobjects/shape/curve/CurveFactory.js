 ...
 *
 * Note: This method will only be available if the Curve Game Object has been built into Vsengine.
 *
 ...
 *
 * To render a Curve Shape you must first create a `Vsengine.Curves.Curve` object, then pass it to
 ...
 * jagged, shapes.
 *
 * @method Vsengine.GameObjects.GameObjectFactory#curve
 * @since 3.13.0
 *
 * @param {number} [x=0] - The horizontal position of this Game Object in the world.
 * @param {number} [y=0] - The vertical position of this Game Object in the world.
 * @param {Vsengine.Curves.Curve} [curve] - The Curve object to use to create the Shape.
 ...
 *
 * @return {Vsengine.GameObjects.Curve} The Game Object that was created.
 */
GameObjectFactory.register(
    "curve",
    function (x, y, curve, fillColor, fillAlpha) {
        return this.displayList.add(
            new Curve(this.scene, x, y, curve, fillColor, fillAlpha)
        );
    }
);
