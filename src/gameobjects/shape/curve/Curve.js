...
var Curve = new Class({
    ...
    initialize: function Curve(scene, x, y, curve, fillColor, fillAlpha) {
         ...
         *
         * @name Vsengine.GameObjects.Curve#_smoothness
         * @type {number}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Curve#_curveBounds
     ...
     *
     * @name Vsengine.GameObjects.Curve#smoothness
     * @type {number}
     * @default 32
     * @since 3.13.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Curve#setSmoothness
     * @since 3.13.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Curve#updateData
     * @private
     * @since 3.13.0
     *
     * @return {this} This Game Object instance.
