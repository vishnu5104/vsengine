...
var Shape = new Class({
    ...
    initialize: function Shape(scene, type, data) {
         ...
         *
         * @name Vsengine.GameObjects.Shape#geom
         * @type {any}
         * @readonly
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Shape#pathData
         * @type {number[]}
         * @readonly
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Shape#pathIndexes
         * @type {number[]}
         * @readonly
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Shape#fillColor
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Shape#fillAlpha
         * @type {number}
         * @since 3.13.0
         */
        this.fillAlpha = 1;
         ...
         *
         * @name Vsengine.GameObjects.Shape#strokeColor
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Shape#strokeAlpha
         * @type {number}
         * @since 3.13.0
         */
        this.strokeAlpha = 1;
         ...
         *
         * @name Vsengine.GameObjects.Shape#lineWidth
         * @type {number}
         * @since 3.13.0
         */
        this.lineWidth = 1;
         ...
         *
         * @name Vsengine.GameObjects.Shape#isFilled
         * @type {boolean}
         * @since 3.13.0
         */
        this.isFilled = false;
         ...
         *
         * @name Vsengine.GameObjects.Shape#isStroked
         * @type {boolean}
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Shape#closePath
         * @type {boolean}
         * @since 3.13.0
         */
        this.closePath = true;
         ...
         *
         * @name Vsengine.GameObjects.Shape#_tempLine
         * @type {Vsengine.Geom.Line}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Shape#width
         * @type {number}
         * @since 3.13.0
         */
        this.width = 0;
         ...
         *
         * @name Vsengine.GameObjects.Shape#height
         * @type {number}
         * @since 3.0.0
         */
        this.height = 0;
     ...
     *
     * @method Vsengine.GameObjects.Shape#setFillStyle
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method Vsengine.GameObjects.Shape#setStrokeStyle
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method Vsengine.GameObjects.Shape#setClosePath
     * @since 3.13.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Shape#setSize
     * @private
     * @since 3.13.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Shape#setDisplaySize
     * @since 3.53.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Shape#preDestroy
     * @protected
     * @since 3.13.0
     */
    preDestroy: function () {
     ...
     *
     * @name Vsengine.GameObjects.Shape#displayWidth
     * @type {number}
     * @since 3.13.0
     */
    displayWidth: {
     ...
     * Setting this value will adjust the Game Object's scale property.
     *
     * @name Vsengine.GameObjects.Shape#displayHeight
     * @type {number}
     * @since 3.13.0
     */
    displayHeight: {
