 ...
 *
 * Note: This method will only be available if the Rectangle Game Object has been built into Vsengine.
 *
 ...
 *
 * @method Vsengine.GameObjects.GameObjectFactory#rectangle
 * @since 3.13.0
 *
 ...
 *
 * @return {Vsengine.GameObjects.Rectangle} The Game Object that was created.
 */
GameObjectFactory.register(
    "rectangle",
    function (x, y, width, height, fillColor, fillAlpha) {
        return this.displayList.add(
            new Rectangle(this.scene, x, y, width, height, fillColor, fillAlpha)
        );
    }
);
