...
var Star = new Class({
    ...
    initialize: function Star(
         ...
         *
         * @name Vsengine.GameObjects.Star#_points
         * @type {number}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Star#_innerRadius
         * @type {number}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Star#_outerRadius
         * @type {number}
         * @private
         * @since 3.13.0
         */
     ...
     *
     * @method Vsengine.GameObjects.Star#setPoints
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method Vsengine.GameObjects.Star#setInnerRadius
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method Vsengine.GameObjects.Star#setOuterRadius
     * @since 3.13.0
     *
     ...
     *
     * @name Vsengine.GameObjects.Star#points
     * @type {number}
     * @default 5
     * @since 3.13.0
     */
     ...
     *
     * @name Vsengine.GameObjects.Star#innerRadius
     * @type {number}
     * @default 32
     * @since 3.13.0
     */
     ...
     *
     * @name Vsengine.GameObjects.Star#outerRadius
     * @type {number}
     * @default 64
     * @since 3.13.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Star#updateData
     * @private
     * @since 3.13.0
     *
     * @return {this} This Game Object instance.
