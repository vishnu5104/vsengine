 ...
 *
 * Note: This method will only be available if the Star Game Object has been built into Vsengine.
 *
 ...
 *
 * @method Vsengine.GameObjects.GameObjectFactory#star
 * @since 3.13.0
 *
 ...
 *
 * @return {Vsengine.GameObjects.Star} The Game Object that was created.
 */
GameObjectFactory.register(
    "star",
    function (x, y, points, innerRadius, outerRadius, fillColor, fillAlpha) {
