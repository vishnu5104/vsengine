 ...
 *
 * Note: This method will only be available if the Polygon Game Object has been built into Vsengine.
 *
 ...
 *
 * @method Vsengine.GameObjects.GameObjectFactory#polygon
 * @since 3.13.0
 *
 ...
 *
 * @return {Vsengine.GameObjects.Polygon} The Game Object that was created.
 */
GameObjectFactory.register(
    "polygon",
    function (x, y, points, fillColor, fillAlpha) {
        return this.displayList.add(
            new Polygon(this.scene, x, y, points, fillColor, fillAlpha)
        );
    }
);
