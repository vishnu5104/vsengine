 ...
 * - An array of Point or Vector2 objects: `[new Vsengine.Math.Vector2(x1, y1), ...]`
 ...
 * If this is the case, please use the function `Vsengine.Geom.Polygon.GetAABB(polygon.geom)` instead and then
...
var Polygon = new Class({
     ...
     *
     * @method Vsengine.GameObjects.Polygon#smooth
     * @since 3.13.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Polygon#setTo
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Polygon#updateData
     * @private
     * @since 3.13.0
     *
     * @return {this} This Game Object instance.
