 ...
 * be pre-loaded. Vsengine does not do this for you, so you will require the use of a 3rd party font loader,
 * or have the fonts ready available in the CSS on the page in which your Vsengine game resides.
 *
 ...
 * @extends Vsengine.GameObjects.Components.Crop
 ...
 * @param {Vsengine.Types.GameObjects.Text.TextStyle} style - The text style configuration object.
 *
...
var Text = new Class({
    ...
    initialize: function Text(scene, x, y, text, style) {
         ...
         *
         * @name Vsengine.GameObjects.Text#renderer
         ...
         *
         * @name Vsengine.GameObjects.Text#canvas
         ...
         *
         * @name Vsengine.GameObjects.Text#context
         ...
         *
         * @name Vsengine.GameObjects.Text#style
         * @type {Vsengine.GameObjects.TextStyle}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Text#autoRound
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Text#splitRegExp
         * @type {object}
         * @since 3.0.0
         */
        this.splitRegExp = /(?:\r\n|\r|\n)/;
         ...
         * The text to display.
         *
         * @name Vsengine.GameObjects.Text#_text
         * @type {string}
         * @private
         * @since 3.12.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Text#padding
         * @type {Vsengine.Types.GameObjects.Text.TextPadding}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Text#width
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Text#height
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Text#lineSpacing
         * @type {number}
         * @since 3.13.0
         */
        this.lineSpacing = 0;
         ...
         * be sure to call `updateText` after, or you won't see the change reflected in the Text object.
         *
         * @name Vsengine.GameObjects.Text#letterSpacing
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Text#_crop
         * @type {object}
         * @private
         * @since 3.12.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Text#_textureKey
         * @type {string}
         * @private
         * @since 3.80.0
         */
        ...
        this.texture = scene.sys.textures.addCanvas(
            this._textureKey,
            this.canvas
        );
     ...
     *
     * @method Vsengine.GameObjects.Text#initRTL
     * @since 3.0.0
     */
    initRTL: function () {
        if (!this.style.rtl) {
     ...
     * bounds.
     *
     * @method Vsengine.GameObjects.Text#runWordWrap
     * @since 3.0.0
     *
    ...
    runWordWrap: function (text) {
        ...
        if (style.wordWrapCallback) {
            var wrappedLines = style.wordWrapCallback.call(
                style.wordWrapCallbackScope,
                text,
                this
            );
            ...
            if (style.wordWrapUseAdvanced) {
                return this.advancedWordWrap(
                    text,
                    this.context,
                    this.style.wordWrapWidth
                );
            } else {
                return this.basicWordWrap(
                    text,
                    this.context,
                    this.style.wordWrapWidth
                );
     ...
     * single character.
     *
     * @method Vsengine.GameObjects.Text#advancedWordWrap
     * @since 3.0.0
     *
     * @param {string} text - The text to perform word wrap detection against.
     ...
     *
     * @method Vsengine.GameObjects.Text#basicWordWrap
     * @since 3.0.0
     *
     * @param {string} text - The text to perform word wrap detection against.
     * @param {CanvasRenderingContext2D} context - The Canvas Rendering Context.
     ...
     *
     * @method Vsengine.GameObjects.Text#getWrappedText
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setText
     * @since 3.0.0
     *
     ...
     * An array of strings will be joined with `\n` line breaks.
     *
     * @method Vsengine.GameObjects.Text#appendText
     * @since 3.60.0
     *
     ...
     * });
     *
     * @method Vsengine.GameObjects.Text#setStyle
     * @since 3.0.0
     *
     ...
     * ```
     *
     * @method Vsengine.GameObjects.Text#setFont
     * @since 3.0.0
     *
     ...
     * ```
     *
     * @method Vsengine.GameObjects.Text#setFontFamily
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setFontSize
     * @since 3.0.0
     *
     ...
     * Set the font style.
     *
     * @method Vsengine.GameObjects.Text#setFontStyle
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setFixedSize
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setBackgroundColor
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setFill
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setColor
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setStroke
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setShadow
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setShadowOffset
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setShadowColor
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setShadowBlur
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setShadowStroke
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setShadowFill
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setWordWrapWidth
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setWordWrapCallback
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setAlign
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setResolution
     * @since 3.12.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setLineSpacing
     * @since 3.13.0
     *
     ...
     *
     * Please understand that enabling this feature will cause Vsengine to render each character in this Text object
     ...
     *
     * @method Vsengine.GameObjects.Text#setLetterSpacing
     * @since 3.70.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setPadding
     * @since 3.0.0
     *
     * @param {(number|Vsengine.Types.GameObjects.Text.TextPadding)} left - The left padding value, or a padding config object.
     ...
     *
     * @method Vsengine.GameObjects.Text#setMaxLines
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#setRTL
     * @since 3.70.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Text#updateText
     * @since 3.0.0
     *
     * @return {this} This Text object.
     */
    updateText: function () {
        ...
        for (var i = 0; i < textSize.lines; i++) {
            ...
            if (style.rtl) {
                linePositionX =
                    w - linePositionX - padding.left - padding.right;
            } else if (style.align === "right") {
                ...
                if (
                    textSize.lineWidths[i] / textSize.width >=
                    minimumLengthToApplyJustification
                ) {
                    ...
                    extraSpace +=
                        (lines[i].length - trimmedLine.length) * spaceSize;

                    var extraSpaceCharacters = Math.floor(
                        extraSpace / spaceSize
                    );
                    var idx = 0;
            ...
            if (style.color) {
                ...
                if (letterSpacing !== 0) {
                    ...
                    for (var l = 0; l < line.length; l++) {
                        ...
                        charPositionX +=
                            context.measureText(line[l]).width + letterSpacing;
                    }
                } else {
     ...
     *
     * @method Vsengine.GameObjects.Text#getTextMetrics
     * @since 3.0.0
     *
     * @return {Vsengine.Types.GameObjects.Text.TextMetrics} The text metrics.
     */
     ...
     *
     * @name Vsengine.GameObjects.Text#text
     * @type {string}
     * @since 3.0.0
     */
    text: {
     ...
     *
     * @method Vsengine.GameObjects.Text#toJSON
     * @since 3.0.0
     *
     * @return {Vsengine.Types.GameObjects.JSONGameObject} A JSON representation of the Text object.
     */
    toJSON: function () {
     ...
     *
     * @method Vsengine.GameObjects.Text#preDestroy
     * @protected
     * @since 3.0.0
     */
    preDestroy: function () {
     ...
     *
     * @name Vsengine.GameObjects.Text#originX
     * @type {number}
     * @default 0
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.GameObjects.Text#originY
     * @type {number}
     * @default 0
     * @since 3.0.0
     */
