 ...
 * @since 3.0.0
 *
 * @param {Vsengine.GameObjects.Text} text - The Text object that this TextStyle is styling.
 * @param {Vsengine.Types.GameObjects.Text.TextStyle} style - The style settings to set.
 */
var TextStyle = new Class({
    initialize: function TextStyle(text, style) {
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#parent
         * @type {Vsengine.GameObjects.Text}
         * @since 3.0.0
         */
        this.parent = text;
         ...
         * The font family.
         *
         * @name Vsengine.GameObjects.TextStyle#fontFamily
         * @type {string}
         * @default 'Courier'
         * @since 3.0.0
         */
         ...
         * The font size.
         *
         * @name Vsengine.GameObjects.TextStyle#fontSize
         * @type {(string|number)}
         * @default '16px'
         * @since 3.0.0
         */
         ...
         * The font style.
         *
         * @name Vsengine.GameObjects.TextStyle#fontStyle
         * @type {string}
         * @since 3.0.0
         */
        this.fontStyle;
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#backgroundColor
         * @type {string}
         * @since 3.0.0
         */
         ...
         * The text fill color.
         *
         * @name Vsengine.GameObjects.TextStyle#color
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#stroke
         * @type {(string|CanvasGradient|CanvasPattern)}
         * @default '#fff'
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#strokeThickness
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#shadowOffsetX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#shadowOffsetY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         * The shadow color.
         *
         * @name Vsengine.GameObjects.TextStyle#shadowColor
         * @type {string}
         * @default '#000'
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#shadowBlur
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#shadowStroke
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#shadowFill
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         * The text alignment.
         *
         * @name Vsengine.GameObjects.TextStyle#align
         * @type {string}
         * @default 'left'
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#maxLines
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#fixedWidth
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#fixedHeight
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#resolution
         * @type {number}
         * @default 0
         * @since 3.12.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#rtl
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#testString
         * @type {string}
         * @default '|MÉqgy'
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#baselineX
         * @type {number}
         * @default 1.2
         * @since 3.3.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#baselineY
         * @type {number}
         * @default 1.4
         * @since 3.3.0
         */
         ...
         * re-wrap, use {@link Vsengine.GameObjects.TextStyle#setWordWrapWidth}.
         *
         * @name Vsengine.GameObjects.TextStyle#wordWrapWidth
         * @type {number | null}
         * @default null
         * @since 3.24.0
         */
         ...
         * {@link Vsengine.GameObjects.TextStyle#setWordWrapCallback}.
         *
         * @name Vsengine.GameObjects.TextStyle#wordWrapCallback
         ...
         * {@link Vsengine.GameObjects.TextStyle#setWordWrapCallback}.
         *
         * @name Vsengine.GameObjects.TextStyle#wordWrapCallbackScope
         * @type {object | null}
         * @default null
         * @since 3.24.0
         */
         ...
         * advanced setting and re-wrap, use {@link Vsengine.GameObjects.TextStyle#setWordWrapWidth}.
         *
         * @name Vsengine.GameObjects.TextStyle#wordWrapUseAdvanced
         * @type {boolean}
         * @default false
         * @since 3.24.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TextStyle#_font
         * @type {string}
         * @private
         * @since 3.0.0
         */
     ...
     * });
     *
     * @method Vsengine.GameObjects.TextStyle#setStyle
     * @since 3.0.0
     *
     * @param {Vsengine.Types.GameObjects.Text.TextStyle} style - The style settings to set.
     ...
     *
     * @return {Vsengine.GameObjects.Text} The parent Text object.
     */
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#syncFont
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#syncStyle
     * @since 3.0.0
     *
     * @param {HTMLCanvasElement} canvas - The Canvas Element.
     * @param {CanvasRenderingContext2D} context - The Canvas Rendering Context.
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#syncShadow
     * @since 3.0.0
     *
     * @param {CanvasRenderingContext2D} context - The Canvas Rendering Context.
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#update
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setFont
     * @since 3.0.0
     *
     ...
     * Set the font family.
     *
     * @method Vsengine.GameObjects.TextStyle#setFontFamily
     * @since 3.0.0
     *
     ...
     * Set the font style.
     *
     * @method Vsengine.GameObjects.TextStyle#setFontStyle
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setFontSize
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setTestString
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setFixedSize
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setBackgroundColor
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setFill
     * @since 3.0.0
     *
     ...
     * Set the text fill color.
     *
     * @method Vsengine.GameObjects.TextStyle#setColor
     * @since 3.0.0
     *
     * @param {(string|CanvasGradient|CanvasPattern)} color - The text fill color.
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setResolution
     * @since 3.12.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setStroke
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setShadow
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setShadowOffset
     * @since 3.0.0
     *
     * @param {number} [x=0] - The horizontal shadow offset.
     * @param {number} [y=0] - The vertical shadow offset.
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setShadowColor
     * @since 3.0.0
     *
     * @param {string} [color='#000'] - The shadow color.
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setShadowBlur
     * @since 3.0.0
     *
     * @param {number} [blur=0] - The shadow blur radius.
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setShadowStroke
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setShadowFill
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setWordWrapWidth
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setWordWrapCallback
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setAlign
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#setMaxLines
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#getTextMetrics
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#toJSON
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TextStyle#destroy
     * @since 3.0.0
     */
    destroy: function () {
