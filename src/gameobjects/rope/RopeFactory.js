 ...
 *
 * Note: This method will only be available if the Rope Game Object and WebGL support have been built into Vsengine.
 *
 * @method Vsengine.GameObjects.GameObjectFactory#rope
 * @webglOnly
 * @since 3.23.0
 *
 ...
 * @param {Vsengine.Types.Math.Vector2Like[]} [points] - An array containing the vertices data for this Rope. If none is provided a simple quad is created. See `setPoints` to set this post-creation.
 ...
 *
 * @return {Vsengine.GameObjects.Rope} The Game Object that was created.
 */
if (typeof WEBGL_RENDERER) {
    GameObjectFactory.register(
        "rope",
        function (x, y, texture, frame, points, horizontal, colors, alphas) {
