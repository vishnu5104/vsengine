 ...
 * @param {(number|Vsengine.Types.Math.Vector2Like[])} [points=2] - An array containing the vertices data for this Rope, or a number that indicates how many segments to split the texture frame into. If none is provided a simple quad is created. See `setPoints` to set this post-creation.
...
var Rope = new Class({
    ...
    initialize: function Rope(
         ...
         *
         * @name Vsengine.GameObjects.Rope#anims
         ...
         *
         * @name Vsengine.GameObjects.Rope#points
         ...
         *
         * @name Vsengine.GameObjects.Rope#vertices
         * @type {Float32Array}
         * @since 3.23.0
         */
        this.vertices;
         ...
         *
         * @name Vsengine.GameObjects.Rope#uv
         * @type {Float32Array}
         * @since 3.23.0
         */
        this.uv;
         ...
         *
         * @name Vsengine.GameObjects.Rope#colors
         * @type {Uint32Array}
         * @since 3.23.0
         */
        this.colors;
         ...
         *
         * @name Vsengine.GameObjects.Rope#alphas
         * @type {Float32Array}
         * @since 3.23.0
         */
        this.alphas;
         ...
         *
         * @name Vsengine.GameObjects.Rope#tintFill
         * @type {boolean}
         * @since 3.23.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Rope#dirty
         * @type {boolean}
         * @since 3.23.0
         */
        this.dirty = false;
         ...
         *
         * @name Vsengine.GameObjects.Rope#horizontal
         * @type {boolean}
         * @readonly
         * @since 3.23.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Rope#_flipX
         * @type {boolean}
         * @default false
         * @private
         * @since 3.23.0
         ...
         * If this Game Object has a physics body, it will not change the body. This is a rendering toggle only.
         *
         * @name Vsengine.GameObjects.Rope#_flipY
         * @type {boolean}
         * @default false
         * @private
         * @since 3.23.0
         ...
         *
         * @name Vsengine.GameObjects.Rope#_perp
         ...
         *
         * @name Vsengine.GameObjects.Rope#debugCallback
         * @type {function}
         * @since 3.23.0
         */
         ...
         * been called.
         *
         * @name Vsengine.GameObjects.Rope#debugGraphic
     ...
     *
     * @method Vsengine.GameObjects.Rope#preUpdate
     * @protected
     * @since 3.23.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Rope#play
     * @since 3.23.0
     *
     ...
     * array directly.
     *
     * @method Vsengine.GameObjects.Rope#setDirty
     * @since 3.23.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Rope#setHorizontal
     * @since 3.23.0
     *
     * @param {(number|Vsengine.Types.Math.Vector2Like[])} [points] - An array containing the vertices data for this Rope, or a number that indicates how many segments to split the texture frame into. If none is provided the current points length is used.
     ...
     * values will be reset to thoes values given as parameters.
     *
     * @method Vsengine.GameObjects.Rope#setVertical
     * @since 3.23.0
     *
     * @param {(number|Vsengine.Types.Math.Vector2Like[])} [points] - An array containing the vertices data for this Rope, or a number that indicates how many segments to split the texture frame into. If none is provided the current points length is used.
     * @param {(number|number[])} [colors] - Either a single color value, or an array of values.
     ...
     *
     * @method Vsengine.GameObjects.Rope#setTintFill
     * @webglOnly
     * @since 3.23.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Rope#setAlphas
     * @since 3.23.0
     *
     ...
     * vertices in the Rope.
     *
     * @method Vsengine.GameObjects.Rope#setColors
     * @since 3.23.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Rope#setPoints
     * @since 3.23.0
     *
     * @param {(number|Vsengine.Types.Math.Vector2Like[])} [points=2] - An array containing the vertices data for this Rope, or a number that indicates how many segments to split the texture frame into. If none is provided a simple quad is created.
     * @param {(number|number[])} [colors] - Either a single color value, or an array of values.
     * @param {(number|number[])} [alphas] - Either a single alpha value, or an array of values.
     *
     * @return {this} This Game Object instance.
     ...
     *
     * @method Vsengine.GameObjects.Rope#updateUVs
     * @since 3.23.0
     *
     * @return {this} This Game Object instance.
     */
     ...
     *
     * @method Vsengine.GameObjects.Rope#resizeArrays
     * @since 3.23.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Rope#updateVertices
     * @since 3.23.0
     *
     * @return {this} This Game Object instance.
     */
     ...
     * with no arguments.
     *
     * @method Vsengine.GameObjects.Rope#setDebug
     * @since 3.23.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Rope#renderDebugVerts
     * @since 3.23.0
     *
     * @param {Vsengine.GameObjects.Rope} src - The Rope object being rendered.
     ...
     *
     * @method Vsengine.GameObjects.Rope#preDestroy
     * @private
     * @since 3.23.0
     */
    preDestroy: function () {
     ...
     * If this Game Object has a physics body, it will not change the body. This is a rendering toggle only.
     *
     * @name Vsengine.GameObjects.Rope#flipX
     * @type {boolean}
     * @default false
     * @since 3.23.0
     */
     ...
     * If this Game Object has a physics body, it will not change the body. This is a rendering toggle only.
     *
     * @name Vsengine.GameObjects.Rope#flipY
     * @type {boolean}
     * @default false
     * @since 3.23.0
     */
