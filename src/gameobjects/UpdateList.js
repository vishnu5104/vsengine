 ...
 *
 * Some or all of these Game Objects may also be part of the Scene's [Display List]{@link Vsengine.GameObjects.DisplayList}, for Rendering.
 *
 * @class UpdateList
 * @extends Vsengine.Structs.ProcessQueue.<Vsengine.GameObjects.GameObject>
 * @memberof Vsengine.GameObjects
 * @constructor
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - The Scene that the Update List belongs to.
 */
var UpdateList = new Class({
    ...
    initialize: function UpdateList(scene) {
         ...
         *
         * @name Vsengine.GameObjects.UpdateList#scene
         * @type {Vsengine.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         * The Scene's Systems.
         *
         * @name Vsengine.GameObjects.UpdateList#systems
         ...
         *
         * @name Vsengine.GameObjects.UpdateList#_pending
         * @type {Array.<*>}
         * @private
         * @default []
         * @since 3.20.0
         ...
         *
         * @name Vsengine.GameObjects.UpdateList#_active
         * @type {Array.<*>}
         * @private
         * @default []
         * @since 3.20.0
         ...
         *
         * @name Vsengine.GameObjects.UpdateList#_destroy
         * @type {Array.<*>}
         * @private
         * @default []
         * @since 3.20.0
         ...
         *
         * @name Vsengine.GameObjects.UpdateList#_toProcess
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
     ...
     *
     * @method Vsengine.GameObjects.UpdateList#boot
     * @private
     * @since 3.5.1
     */
    boot: function () {
     ...
     * Do not invoke it directly.
     *
     * @method Vsengine.GameObjects.UpdateList#start
     * @private
     * @since 3.5.0
     */
    start: function () {
     ...
     *
     * @method Vsengine.GameObjects.UpdateList#sceneUpdate
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.UpdateList#shutdown
     * @since 3.0.0
     */
    shutdown: function () {
     ...
     *
     * @method Vsengine.GameObjects.UpdateList#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.shutdown();
     ...
     *
     * @method Vsengine.GameObjects.UpdateList#add
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.UpdateList#remove
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.UpdateList#removeAll
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.UpdateList#update
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.UpdateList#getActive
     * @since 3.0.0
     *
     * @return {Array.<*>} A list of active items.
     */
     ...
     *
     * @name Vsengine.GameObjects.UpdateList#length
     * @type {number}
     * @readonly
     * @since 3.20.0
     */
