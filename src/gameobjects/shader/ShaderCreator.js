 ...
 *
 * @method Vsengine.GameObjects.GameObjectCreator#shader
 * @since 3.17.0
 *
 * @param {Vsengine.Types.GameObjects.Shader.ShaderConfig} config - The configuration object this Game Object will use to create itself.
