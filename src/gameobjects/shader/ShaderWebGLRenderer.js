 ...
 *
 * @method Vsengine.GameObjects.Shader#renderWebGL
 * @since 3.17.0
 * @private
 *
 * @param {Vsengine.Renderer.WebGL.WebGLRenderer} renderer - A reference to the current active WebGL renderer.
 * @param {Vsengine.GameObjects.Shader} src - The Game Object being rendered in this call.
...
var ShaderWebGLRenderer = function (renderer, src, camera, parentMatrix) {
    ...
    if (src.renderToTexture) {
        ...
        if (
            renderer.width !== src._rendererWidth ||
            renderer.height !== src._rendererHeight
        ) {
