 ...
 *
 * It works by taking a reference to a `Vsengine.Display.BaseShader` instance, as found in the Shader Cache. These can
 ...
 * ```
 *
 * Please see the Vsengine 3 Examples GitHub repo for examples of loading and creating shaders dynamically.
 *
...
var Shader = new Class({
    ...
    initialize: function Shader(
         ...
         *
         * @name Vsengine.GameObjects.Shader#blendMode
         * @type {number}
         * @private
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Shader#shader
         * @type {Vsengine.Display.BaseShader}
         * @since 3.17.0
         */
        this.shader;
         ...
         *
         * @name Vsengine.GameObjects.Shader#renderer
         ...
         *
         * @name Vsengine.GameObjects.Shader#gl
         ...
         *
         * @name Vsengine.GameObjects.Shader#vertexData
         * @type {ArrayBuffer}
         * @since 3.17.0
         */
        this.vertexData = new ArrayBuffer(
            6 * (Float32Array.BYTES_PER_ELEMENT * 2)
        );

        /**
         * The WebGL vertex buffer object this shader uses.
         *
         * @name Vsengine.GameObjects.Shader#vertexBuffer
         ...
         *
         * @name Vsengine.GameObjects.Shader#_deferSetShader
         ...
         *
         * @name Vsengine.GameObjects.Shader#_deferProjOrtho
         ...
         *
         * @name Vsengine.GameObjects.Shader#program
         ...
         *
         * @name Vsengine.GameObjects.Shader#bytes
         * @type {Uint8Array}
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Shader#vertexViewF32
         * @type {Float32Array}
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Shader#_tempMatrix1
         * @private
         ...
         * A temporary Transform Matrix, re-used internally during batching.
         *
         * @name Vsengine.GameObjects.Shader#_tempMatrix2
         * @private
         * @type {Vsengine.GameObjects.Components.TransformMatrix}
         * @since 3.17.0
         */
         ...
         * A temporary Transform Matrix, re-used internally during batching.
         *
         * @name Vsengine.GameObjects.Shader#_tempMatrix3
         * @private
         * @type {Vsengine.GameObjects.Components.TransformMatrix}
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Shader#viewMatrix
         * @type {Float32Array}
         * @readonly
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Shader#projectionMatrix
         * @type {Float32Array}
         * @readonly
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Shader#uniforms
         * @type {any}
         * @since 3.17.0
         */
        this.uniforms = {};
         ...
         *
         * @name Vsengine.GameObjects.Shader#pointer
         ...
         *
         * @name Vsengine.GameObjects.Shader#_rendererWidth
         * @type {number}
         * @private
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Shader#_rendererHeight
         * @type {number}
         * @private
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Shader#_textureCount
         * @type {number}
         * @private
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Shader#framebuffer
         ...
         * This property is only set if you have called `Shader.setRenderToTexture`.
         *
         * @name Vsengine.GameObjects.Shader#glTexture
         ...
         *
         * @name Vsengine.GameObjects.Shader#renderToTexture
         * @type {boolean}
         * @readonly
         * @since 3.19.0
         */
        ...
        /**
         * A reference to the Vsengine.Textures.Texture that has been stored in the Texture Manager for this Shader.
         *
         * This property is only set if you have called `Shader.setRenderToTexture` with a key, otherwise it is `null`.
         *
         * @name Vsengine.GameObjects.Shader#texture
     ...
     *
     * @method Vsengine.GameObjects.Shader#willRender
     * @since 3.0.0
     *
     ...
     * are populated.
     *
     * Additionally, you can provide a key to this method. Doing so will create a Vsengine Texture
     ...
     *
     * You can access the Vsengine Texture that is created via the `Shader.texture` property.
     *
     * By default it will create a single base texture. You can add frames to the texture
     * by using the `Texture.add` method. After doing this, you can then allow Game Objects
     * to use a specific frame from a Render Texture.
     *
     * @method Vsengine.GameObjects.Shader#setRenderToTexture
     * @since 3.19.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Shader#setShader
     * @since 3.17.0
     *
     * @param {(string|Vsengine.Display.BaseShader)} key - The key of the shader to use from the shader cache, or a BaseShader instance.
     * @param {string[]} [textures] - Optional array of texture keys to bind to the iChannel0...3 uniforms. The textures must already exist in the Texture Manager.
    ...
    setShader: function (key, textures, textureData) {
        ...
        var program = renderer.createProgram(
            this.shader.vertexSrc,
            this.shader.fragmentSrc
        );

        //  The default uniforms available within the vertex shader
        gl.uniformMatrix4fv(
            gl.getUniformLocation(program.webGLProgram, "uViewMatrix"),
            false,
            this.viewMatrix
        );
        gl.uniformMatrix4fv(
            gl.getUniformLocation(program.webGLProgram, "uProjectionMatrix"),
            false,
            this.projectionMatrix
        );
        gl.uniform2f(
            gl.getUniformLocation(program.webGLProgram, "uResolution"),
            this.width,
            this.height
        );
        ...
        var defaultUniforms = {
            ...
            mouse: {
                type: "2f",
                value: { x: this.width / 2, y: this.height / 2 },
            },
            date: {
                type: "4fv",
                value: [
    ...
    /**
     * Binds a Vsengine Pointer object to this Shader.
     *
     ...
     *
     * @method Vsengine.GameObjects.Shader#setPointer
     * @since 3.17.0
     *
     * @param {Vsengine.Input.Pointer} [pointer] - The Pointer to bind to this shader.
     *
     * @return {this} This Shader instance.
     */
     ...
     *
     * @method Vsengine.GameObjects.Shader#projOrtho
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Shader#initUniforms
     * @private
     * @since 3.17.0
     */
    initUniforms: function () {
        ...
        for (var key in this.uniforms) {
            ...
            uniform.uniformLocation = this.renderer.createUniformLocation(
                program,
                key
            );
     ...
     *
     * @method Vsengine.GameObjects.Shader#setSampler2DBuffer
     * @since 3.19.0
     *
     * @param {string} uniformKey - The key of the sampler2D uniform to be updated, i.e. `iChannel0`.
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - A texture reference.
     ...
     *
     * @method Vsengine.GameObjects.Shader#setSampler2D
     * @since 3.17.0
     *
     * @param {string} uniformKey - The key of the sampler2D uniform to be updated, i.e. `iChannel0`.
     ...
     *
     * @method Vsengine.GameObjects.Shader#setUniform
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Shader#getUniform
     * @since 3.17.0
     *
     ...
     * from a texture, only the full image. Also, lots of shaders expect textures to be power-of-two sized.
     *
     * @method Vsengine.GameObjects.Shader#setChannel0
     * @since 3.17.0
     *
     * @param {string} textureKey - The key of the texture, as stored in the Texture Manager. Must already be loaded.
     * @param {any} [textureData] - Additional texture data.
     ...
     * from a texture, only the full image. Also, lots of shaders expect textures to be power-of-two sized.
     *
     * @method Vsengine.GameObjects.Shader#setChannel1
     * @since 3.17.0
     *
     * @param {string} textureKey - The key of the texture, as stored in the Texture Manager. Must already be loaded.
     * @param {any} [textureData] - Additional texture data.
     ...
     * from a texture, only the full image. Also, lots of shaders expect textures to be power-of-two sized.
     *
     * @method Vsengine.GameObjects.Shader#setChannel2
     * @since 3.17.0
     *
     * @param {string} textureKey - The key of the texture, as stored in the Texture Manager. Must already be loaded.
     * @param {any} [textureData] - Additional texture data.
     ...
     * from a texture, only the full image. Also, lots of shaders expect textures to be power-of-two sized.
     *
     * @method Vsengine.GameObjects.Shader#setChannel3
     * @since 3.17.0
     *
     * @param {string} textureKey - The key of the texture, as stored in the Texture Manager. Must already be loaded.
     * @param {any} [textureData] - Additional texture data.
     ...
     *
     * @method Vsengine.GameObjects.Shader#initSampler2D
     * @private
     * @since 3.17.0
     *
    ...
    initSampler2D: function (uniform) {
        ...
        if (data && !uniform.value.isRenderTexture) {
            ...
            var magFilter =
                gl[GetFastValue(data, "magFilter", "linear").toUpperCase()];
            var minFilter =
                gl[GetFastValue(data, "minFilter", "linear").toUpperCase()];
     ...
     *
     * @method Vsengine.GameObjects.Shader#syncUniforms
     * @private
     * @since 3.17.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Shader#load
     * @since 3.17.0
     *
     * @param {Vsengine.GameObjects.Components.TransformMatrix} [matrix2D] - The transform matrix to use during rendering.
     */
     ...
     *
     * @method Vsengine.GameObjects.Shader#flush
     * @since 3.17.0
     */
    flush: function () {
        //  Bind
     ...
     *
     * @method Vsengine.GameObjects.Shader#setAlpha
     * @private
     * @since 3.17.0
     */
    setAlpha: function () {},
     ...
     * Calling this method will do nothing. It is intentionally empty.
     *
     * @method Vsengine.GameObjects.Shader#setBlendMode
     * @private
     * @since 3.17.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Shader#onContextRestored
     * @since 3.80.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Shader#preDestroy
     * @protected
     * @since 3.17.0
     */
    preDestroy: function () {
