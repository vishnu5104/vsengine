 ...
 *
 * @param {Vsengine.Scene} scene - The Scene to which this Game Object belongs. It can only belong to one Scene at any given time.
...
var BitmapText = new Class({
    ...
    initialize: function BitmapText(scene, x, y, font, text, size, align) {
         ...
         *
         * @name Vsengine.GameObjects.BitmapText#font
         * @type {string}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.BitmapText#fontData
         * @type {Vsengine.Types.GameObjects.BitmapText.BitmapFontData}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.BitmapText#_text
         * @type {string}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.BitmapText#_fontSize
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.BitmapText#_letterSpacing
         * @type {number}
         * @private
         * @since 3.4.0
         */
         ...
         * Can be a negative or positive number.
         *
         * @name Vsengine.GameObjects.BitmapText#_lineSpacing
         * @type {number}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.BitmapText#_align
         * @type {number}
         * @private
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.GameObjects.BitmapText#_bounds
         * @type {Vsengine.Types.GameObjects.BitmapText.BitmapTextSize}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.BitmapText#_dirty
         * @type {boolean}
         * @private
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.GameObjects.BitmapText#_maxWidth
         * @type {number}
         * @private
         * @since 3.21.0
         */
         ...
         *
         * @name Vsengine.GameObjects.BitmapText#wordWrapCharCode
         * @type {number}
         * @since 3.21.0
         */
         ...
         *
         * @name Vsengine.GameObjects.BitmapText#charColors
         * @type {array}
         * @private
         * @since 3.50.0
         */
         ...
         *
         * You can set this directly, or use `Vsengine.GameObjects.BitmapText#setDropShadow`.
         *
         * @name Vsengine.GameObjects.BitmapText#dropShadowX
         * @type {number}
         * @since 3.50.0
         */
        this.dropShadowX = 0;
         ...
         * You can set this directly, or use `Vsengine.GameObjects.BitmapText#setDropShadow`.
         *
         * @name Vsengine.GameObjects.BitmapText#dropShadowY
         * @type {number}
         * @since 3.50.0
         */
        this.dropShadowY = 0;
         ...
         * You can set this directly, or use `Vsengine.GameObjects.BitmapText#setDropShadow`.
         *
         * @name Vsengine.GameObjects.BitmapText#dropShadowColor
         * @type {number}
         * @since 3.50.0
         */
         ...
         * You can set this directly, or use `Vsengine.GameObjects.BitmapText#setDropShadow`.
         *
         * @name Vsengine.GameObjects.BitmapText#dropShadowAlpha
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.BitmapText#fromAtlas
         * @type {boolean}
         * @since 3.54.0
         * @readonly
         */
     ...
     *
     * @method Vsengine.GameObjects.BitmapText#setLeftAlign
     * @since 3.11.0
     *
     ...
     * This only has any effect if this BitmapText contains more than one line of text.
     *
     * @method Vsengine.GameObjects.BitmapText#setCenterAlign
     * @since 3.11.0
     *
     * @return {this} This BitmapText Object.
     */
     ...
     * This only has any effect if this BitmapText contains more than one line of text.
     *
     * @method Vsengine.GameObjects.BitmapText#setRightAlign
     * @since 3.11.0
     *
     * @return {this} This BitmapText Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.BitmapText#setFontSize
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.BitmapText#setLetterSpacing
     * @since 3.4.0
     *
     ...
     *
     * @method Vsengine.GameObjects.BitmapText#setLineSpacing
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.BitmapText#setText
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.BitmapText#setDropShadow
     * @webglOnly
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.BitmapText#setCharacterTint
     * @webglOnly
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.BitmapText#setWordTint
     * @webglOnly
     * @since 3.50.0
     *
    ...
    setWordTint: function (
        ...
        for (var i = 0; i < words.length; i++) {
            ...
            if (
                (wordIsNumber && i === word) ||
                (!wordIsNumber && lineword.word === word)
            ) {
     ...
     *
     * @method Vsengine.GameObjects.BitmapText#getTextBounds
     * @since 3.0.0
     *
     * @param {boolean} [round=false] - Whether to round the results up to the nearest integer.
     *
     * @return {Vsengine.Types.GameObjects.BitmapText.BitmapTextSize} An object that describes the size of this Bitmap Text.
     */
    getTextBounds: function (round) {
        ...
        if (
            this._dirty ||
            round ||
            this.scaleX !== bounds.scaleX ||
            this.scaleY !== bounds.scaleY
        ) {
     ...
     *
     * @method Vsengine.GameObjects.BitmapText#getCharacterAt
     * @since 3.50.0
     *
     * @param {number} x - The x position to check.
     * @param {number} y - The y position to check.
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera which is being tested against. If not given will use the Scene default camera.
     *
     * @return {Vsengine.Types.GameObjects.BitmapText.BitmapTextCharacter} The character object at the given position, or `null`.
     */
     ...
     *
     * @method Vsengine.GameObjects.BitmapText#updateDisplayOrigin
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.BitmapText#setFont
     * @since 3.11.0
     *
     * @param {string} font - The key of the font to use from the Bitmap Font cache.
     ...
     *
     * @method Vsengine.GameObjects.BitmapText#setMaxWidth
     * @since 3.21.0
     *
     ...
     * The alignment position is based on the longest line of text.
     *
     * @name Vsengine.GameObjects.BitmapText#align
     * @type {number}
     * @since 3.11.0
     */
    align: {
     ...
     *
     * @name Vsengine.GameObjects.BitmapText#text
     * @type {string}
     * @since 3.0.0
     */
    text: {
     ...
     *
     * @name Vsengine.GameObjects.BitmapText#fontSize
     * @type {number}
     * @since 3.0.0
     */
    fontSize: {
     ...
     *
     * @name Vsengine.GameObjects.BitmapText#letterSpacing
     * @type {number}
     * @since 3.0.0
     */
    letterSpacing: {
     ...
     *
     * @name Vsengine.GameObjects.BitmapText#lineSpacing
     * @type {number}
     * @since 3.60.0
     */
    lineSpacing: {
     ...
     * Disable maxWidth by setting the value to 0.
     *
     * @name Vsengine.GameObjects.BitmapText#maxWidth
     * @type {number}
     * @since 3.21.0
     */
    maxWidth: {
     ...
     *
     * @name Vsengine.GameObjects.BitmapText#width
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     * This property is read-only.
     *
     * @name Vsengine.GameObjects.BitmapText#height
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     * This property is read-only.
     *
     * @name Vsengine.GameObjects.BitmapText#displayWidth
     * @type {number}
     * @readonly
     * @since 3.60.0
     */
     ...
     * This property is read-only.
     *
     * @name Vsengine.GameObjects.BitmapText#displayHeight
     * @type {number}
     * @readonly
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.GameObjects.BitmapText#toJSON
     * @since 3.0.0
     *
     * @return {Vsengine.Types.GameObjects.BitmapText.JSONBitmapText} A JSON representation of this Bitmap Text.
     */
    toJSON: function () {
     ...
     *
     * @method Vsengine.GameObjects.BitmapText#preDestroy
     * @protected
     * @since 3.50.0
     */
    preDestroy: function () {
 ...
 *
 * @name Vsengine.GameObjects.BitmapText.ALIGN_LEFT
 * @type {number}
 * @since 3.11.0
 */
 ...
 *
 * @name Vsengine.GameObjects.BitmapText.ALIGN_CENTER
 * @type {number}
 * @since 3.11.0
 */
 ...
 *
 * @name Vsengine.GameObjects.BitmapText.ALIGN_RIGHT
 * @type {number}
 * @since 3.11.0
 */
 ...
 *
 * @method Vsengine.GameObjects.BitmapText.ParseFromAtlas
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - The Scene to parse the Bitmap Font for.
 ...
 *
 * @method Vsengine.GameObjects.BitmapText.ParseXMLBitmapFont
 * @since 3.17.0
 *
 * @param {XMLDocument} xml - The XML Document to parse the font from.
 * @param {Vsengine.Textures.Frame} frame - The texture frame to take into account when creating the uv data.
 ...
 *
 * @return {Vsengine.Types.GameObjects.BitmapText.BitmapFontData} The parsed Bitmap Font data.
 */
