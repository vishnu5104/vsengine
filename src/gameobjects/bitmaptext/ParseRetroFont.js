 ...
 *
 * @function Vsengine.GameObjects.RetroFont.Parse
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - A reference to the Vsengine Scene.
 * @param {Vsengine.Types.GameObjects.BitmapText.RetroFontConfig} config - The font configuration object.
 *
 * @return {Vsengine.Types.GameObjects.BitmapText.BitmapFontData} A parsed Bitmap Font data entry for the Bitmap Font cache.
 */
