 ...
 * @private
 *
 * @param {(Vsengine.GameObjects.DynamicBitmapText|Vsengine.GameObjects.BitmapText)} src - The BitmapText to calculate the bounds values for.
 ...
 *
 * @return {Vsengine.Types.GameObjects.BitmapText.BitmapTextSize} The calculated bounds values of the BitmapText.
 */
