 ...
 * @private
 *
 * @param {Vsengine.Renderer.WebGL.WebGLPipeline} pipeline - The WebGLPipeline. Must have a `batchQuad` method.
 * @param {Vsengine.GameObjects.BitmapText} src - The BitmapText Game Object.
 * @param {Vsengine.Types.GameObjects.BitmapText.BitmapTextCharacter} char - The character to render.
 * @param {Vsengine.Types.GameObjects.BitmapText.BitmapFontCharacterData} glyph - The character glyph.
 * @param {number} offsetX - The x offset.
 * @param {number} offsetY - The y offset.
 * @param {Vsengine.GameObjects.Components.TransformMatrix} calcMatrix - The transform matrix.
 ...
 * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - The texture.
 * @param {number} textureUnit - The texture unit.
 */
var BatchChar = function (
    pipeline,
    src,
    char,
    glyph,
