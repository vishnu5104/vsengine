 ...
 * @extends Vsengine.GameObjects.BitmapText
...
var DynamicBitmapText = new Class({
    ...
    initialize: function DynamicBitmapText(
        scene,
        x,
        y,
        font,
         ...
         *
         * @name Vsengine.GameObjects.DynamicBitmapText#scrollX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.DynamicBitmapText#scrollY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.DynamicBitmapText#cropWidth
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.DynamicBitmapText#cropHeight
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.DynamicBitmapText#displayCallback
         * @type {Vsengine.Types.GameObjects.BitmapText.DisplayCallback}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.DynamicBitmapText#callbackData
         * @type {Vsengine.Types.GameObjects.BitmapText.DisplayCallbackConfig}
         * @since 3.11.0
         */
        this.callbackData = {
            parent: this,
     ...
     *
     * @method Vsengine.GameObjects.DynamicBitmapText#setSize
     * @since 3.0.0
     *
     ...
     *
     * The callback receives a {@link Vsengine.Types.GameObjects.BitmapText.DisplayCallbackConfig} object that contains information about the character that's
     ...
     *
     * @method Vsengine.GameObjects.DynamicBitmapText#setDisplayCallback
     * @since 3.0.0
     *
     * @param {Vsengine.Types.GameObjects.BitmapText.DisplayCallback} callback - The display callback to set.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.DynamicBitmapText#setScrollX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.DynamicBitmapText#setScrollY
     * @since 3.0.0
     *
