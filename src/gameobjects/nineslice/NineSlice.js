 ...
 *
 * As of Vsengine 3.60 this Game Object is WebGL only.
 *
 * As of Vsengine 3.70 this Game Object can now populate its values automatically
...
var NineSlice = new Class({
    ...
    initialize: function NineSlice(
         ...
         *
         * @name Vsengine.GameObjects.NineSlice#_width
         * @private
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.NineSlice#_height
         * @private
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.NineSlice#_originX
         * @private
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.NineSlice#_originY
         * @private
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.NineSlice#_sizeComponent
         * @private
         * @type {boolean}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.NineSlice#vertices
         ...
         *
         * @name Vsengine.GameObjects.NineSlice#leftWidth
         * @type {number}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.NineSlice#rightWidth
         * @type {number}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.NineSlice#topHeight
         * @type {number}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.NineSlice#bottomHeight
         * @type {number}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.NineSlice#tint
         * @type {number}
         * @default 0xffffff
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.NineSlice#tintFill
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.NineSlice#is3Slice
         * @type {boolean}
         * @since 3.60.0
         */
     ...
     *
     * @method Vsengine.GameObjects.NineSlice#setSlices
     * @since 3.60.0
     *
     * @param {number} [width=256] - The width of the Nine Slice Game Object. You can adjust the width post-creation.
     * @param {number} [height=256] - The height of the Nine Slice Game Object. If this is a 3 slice object the height will be fixed to the height of the texture and cannot be changed.
     ...
     *
     * @method Vsengine.GameObjects.NineSlice#updateUVs
     * @since 3.60.0
     */
    updateUVs: function () {
     ...
     * after creation.
     *
     * @method Vsengine.GameObjects.NineSlice#updateVertices
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.GameObjects.NineSlice#updateQuad
     * @since 3.60.0
     *
     ...
     * is left public should an extended class require it.
     *
     * @method Vsengine.GameObjects.NineSlice#updateQuadUVs
     * @since 3.60.0
     *
     * @param {number} offset - The offset in the vertices array of the quad to update.
     ...
     *
     * @method Vsengine.GameObjects.NineSlice#clearTint
     * @webglOnly
     * @since 3.60.0
     *
     * @return {this} This Game Object instance.
     ...
     *
     * @method Vsengine.GameObjects.NineSlice#setTint
     * @webglOnly
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.NineSlice#setTintFill
     * @webglOnly
     * @since 3.60.0
     *
     * @param {number} [color=0xffffff] - The tint being applied to the entire Game Object.
     ...
     *
     * @name Vsengine.GameObjects.NineSlice#isTinted
     * @type {boolean}
     * @webglOnly
     * @readonly
     * @since 3.60.0
     ...
     *
     * @name Vsengine.GameObjects.NineSlice#width
     * @type {number}
     * @since 3.60.0
     */
    width: {
     ...
     *
     * @name Vsengine.GameObjects.NineSlice#height
     * @type {number}
     * @since 3.60.0
     */
    height: {
        ...
        set: function (value) {
            if (!this.is3Slice) {
                this._height = Math.max(
                    value,
                    this.topHeight + this.bottomHeight
                );
     ...
     *
     * @name Vsengine.GameObjects.NineSlice#displayWidth
     * @type {number}
     * @since 3.60.0
     */
    displayWidth: {
     ...
     * Setting this value will adjust the Game Object's scale property.
     *
     * @name Vsengine.GameObjects.NineSlice#displayHeight
     * @type {number}
     * @since 3.60.0
     */
    displayHeight: {
     ...
     *
     * @method Vsengine.GameObjects.NineSlice#setSize
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.NineSlice#setDisplaySize
     * @since 3.60.0
     *
     * @param {number} width - The width of this Game Object.
     * @param {number} height - The height of this Game Object.
     ...
     *
     * @name Vsengine.GameObjects.NineSlice#originX
     * @type {number}
     * @since 3.60.0
     */
    originX: {
     ...
     *
     * @name Vsengine.GameObjects.NineSlice#originY
     * @type {number}
     * @since 3.60.0
     */
    originY: {
     ...
     *
     * @method Vsengine.GameObjects.NineSlice#setOrigin
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.NineSlice#setSizeToFrame
     * @since 3.60.0
     *
     * @return {this} This Game Object instance.
     */
     ...
     *
     * @method Vsengine.GameObjects.NineSlice#preDestroy
     * @private
     * @since 3.60.0
     */
    preDestroy: function () {
