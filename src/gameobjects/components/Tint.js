 ...
 *
 * @namespace Vsengine.GameObjects.Components.Tint
 * @webglOnly
 * @since 3.0.0
 */
...
var Tint = {
     ...
     *
     * @name Vsengine.GameObjects.Components.Tint#tintTopLeft
     * @type {number}
     * @default 0xffffff
     * @since 3.0.0
     */
     ...
     * The value should be set as a hex number, i.e. 0xff0000 for red, or 0xff00ff for purple.
     *
     * @name Vsengine.GameObjects.Components.Tint#tintTopRight
     * @type {number}
     * @default 0xffffff
     * @since 3.0.0
     */
     ...
     * The value should be set as a hex number, i.e. 0xff0000 for red, or 0xff00ff for purple.
     *
     * @name Vsengine.GameObjects.Components.Tint#tintBottomLeft
     * @type {number}
     * @default 0xffffff
     * @since 3.0.0
     */
     ...
     * The value should be set as a hex number, i.e. 0xff0000 for red, or 0xff00ff for purple.
     *
     * @name Vsengine.GameObjects.Components.Tint#tintBottomRight
     * @type {number}
     * @default 0xffffff
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.GameObjects.Components.Tint#tintFill
     * @type {boolean}
     * @default false
     * @since 3.11.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.Tint#clearTint
     * @webglOnly
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Components.Tint#setTint
     * @webglOnly
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Components.Tint#setTintFill
     * @webglOnly
     * @since 3.11.0
     *
     ...
     *
     * @name Vsengine.GameObjects.Components.Tint#tint
     * @type {number}
     * @webglOnly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.GameObjects.Components.Tint#isTinted
     * @type {boolean}
     * @webglOnly
     * @readonly
     * @since 3.11.0
