 ...
 *
 * @namespace Vsengine.GameObjects.Components.Pipeline
 * @webglOnly
 * @since 3.0.0
 */
...
var Pipeline = {
     ...
     *
     * @name Vsengine.GameObjects.Components.Pipeline#defaultPipeline
     ...
     *
     * @name Vsengine.GameObjects.Components.Pipeline#pipeline
     * @type {Vsengine.Renderer.WebGL.WebGLPipeline}
     * @default null
     * @webglOnly
     * @since 3.0.0
     ...
     *
     * @name Vsengine.GameObjects.Components.Pipeline#pipelineData
     * @type {object}
     * @webglOnly
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.Pipeline#initPipeline
     * @webglOnly
     * @since 3.0.0
     *
     * @param {(string|Vsengine.Renderer.WebGL.WebGLPipeline)} [pipeline] - Either the string-based name of the pipeline, or a pipeline instance to set.
     *
     ...
     *
     * @method Vsengine.GameObjects.Components.Pipeline#setPipeline
     * @webglOnly
     * @since 3.0.0
     *
     * @param {(string|Vsengine.Renderer.WebGL.WebGLPipeline)} pipeline - Either the string-based name of the pipeline, or a pipeline instance to set.
     ...
     *
     * @method Vsengine.GameObjects.Components.Pipeline#setPipelineData
     * @webglOnly
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Components.Pipeline#resetPipeline
     * @webglOnly
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Components.Pipeline#getPipelineName
     * @webglOnly
     * @since 3.0.0
     *
