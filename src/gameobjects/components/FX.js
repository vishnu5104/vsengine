 ...
 * @webglOnly
 *
 * @param {Vsengine.GameObjects.GameObject} gameObject - A reference to the Game Object that owns this FX Component.
 * @param {boolean} isPost - Is this a Pre or Post FX Component?
 */
var FX = new Class({
    initialize: function FX(gameObject, isPost) {
        /**
         * A reference to the Game Object that owns this FX Component.
         *
         * @name Vsengine.GameObjects.Components.FX#gameObject
         ...
         *
         * @name Vsengine.GameObjects.Components.FX#isPost
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Components.FX#enabled
         * @type {boolean}
         * @since 3.60.0
         */
        this.enabled = false;
         ...
         *
         * @name Vsengine.GameObjects.Components.FX#list
         ...
         *
         * @name Vsengine.GameObjects.Components.FX#padding
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
     ...
     * You do not need to set this if you're only using Post FX.
     *
     * @method Vsengine.GameObjects.Components.FX#setPadding
     * @webglOnly
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#onFXCopy
     * @since 3.60.0
     *
     * @param {Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline} pipeline - The PreFX Pipeline that invoked this callback.
     */
    onFXCopy: function () {},
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#onFX
     * @since 3.60.0
     *
     * @param {Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline} pipeline - The PreFX Pipeline that invoked this callback.
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#enable
     * @since 3.60.0
     *
     * @param {number} [padding=0] - The amount of padding to add to this Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#clear
     * @since 3.60.0
     *
     * @return {this} This Game Object instance.
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#remove
     * @since 3.60.0
     *
     * @generic {Vsengine.FX.Controller} T
     * @genericUse {T} - [fx]
     *
     * @param {Vsengine.FX.Controller} fx - The FX Controller to remove from this FX Component.
     *
     * @return {this} This Game Object instance.
     */
    remove: function (fx) {
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#disable
     * @since 3.60.0
     *
     ...
     * `clear` first.
     *
     * @method Vsengine.GameObjects.Components.FX#add
     * @since 3.60.0
     *
     * @generic {Vsengine.FX.Controller} T
     * @genericUse {T} - [fx]
     *
     * @param {Vsengine.FX.Controller} fx - The FX Controller to add to this FX Component.
     * @param {object} [config] - Optional configuration object that is passed to the pipeline during instantiation.
     *
     * @return {Vsengine.FX.Controller} The FX Controller.
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#addGlow
     * @since 3.60.0
     *
     ...
     *
     * @return {Vsengine.FX.Glow} The Glow FX Controller.
     */
    addGlow: function (
        color,
        outerStrength,
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#addShadow
     * @since 3.60.0
     *
     ...
     *
     * @return {Vsengine.FX.Shadow} The Shadow FX Controller.
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#addPixelate
     * @since 3.60.0
     *
     * @param {number} [amount=1] - The amount of pixelation to apply.
     *
     * @return {Vsengine.FX.Pixelate} The Pixelate FX Controller.
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#addVignette
     * @since 3.60.0
     *
     ...
     *
     * @return {Vsengine.FX.Vignette} The Vignette FX Controller.
     */
     ...
     * material properties.
     *
     * @method Vsengine.GameObjects.Components.FX#addShine
     * @since 3.60.0
     *
     ...
     *
     * @return {Vsengine.FX.Shine} The Shine FX Controller.
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#addBlur
     * @since 3.60.0
     *
     ...
     *
     * @return {Vsengine.FX.Blur} The Blur FX Controller.
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#addGradient
     * @since 3.60.0
     *
     ...
     *
     * @return {Vsengine.FX.Gradient} The Gradient FX Controller.
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#addBloom
     * @since 3.60.0
     *
     ...
     *
     * @return {Vsengine.FX.Bloom} The Bloom FX Controller.
     */
    addBloom: function (
        color,
        offsetX,
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#addColorMatrix
     * @since 3.60.0
     *
     * @return {Vsengine.FX.ColorMatrix} The ColorMatrix FX Controller.
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#addCircle
     * @since 3.60.0
     *
     ...
     *
     * @return {Vsengine.FX.Circle} The Circle FX Controller.
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#addBarrel
     * @since 3.60.0
     *
     ...
     *
     * @return {Vsengine.FX.Barrel} The Barrel FX Controller.
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#addDisplacement
     * @since 3.60.0
     *
     ...
     *
     * @return {Vsengine.FX.Displacement} The Displacement FX Controller.
     */
    addDisplacement: function (texture, x, y) {
        return this.add(
            new Effects.Displacement(this.gameObject, texture, x, y)
        );
    },
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#addWipe
     * @since 3.60.0
     *
     ...
     *
     * @return {Vsengine.FX.Wipe} The Wipe FX Controller.
     */
     ...
     * It is up to you to set the `progress` value yourself, i.e. via a Tween, in order to transition the effect.
     *
     * @method Vsengine.GameObjects.Components.FX#addReveal
     * @since 3.60.0
     *
     * @param {number} [wipeWidth=0.1] - The width of the wipe effect. This value is normalized in the range 0 to 1.
     * @param {number} [direction=0] - The direction of the wipe effect. Either 0 or 1. Set in conjunction with the axis property.
     ...
     * See also Tilt Shift.
     *
     * @method Vsengine.GameObjects.Components.FX#addBokeh
     * @since 3.60.0
     *
     ...
     *
     * @return {Vsengine.FX.Bokeh} The Bokeh FX Controller.
     */
     ...
     * See also Bokeh.
     *
     * @method Vsengine.GameObjects.Components.FX#addTiltShift
     * @since 3.60.0
     *
     * @param {number} [radius=0.5] - The radius of the bokeh effect.
     * @param {number} [amount=1] - The amount of the bokeh effect.
     ...
     *
     * @return {Vsengine.FX.Bokeh} The Bokeh TiltShift FX Controller.
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.FX#destroy
     * @since 3.60.0
     */
    destroy: function () {
        this.clear();
