 ...
 *
 * @namespace Vsengine.GameObjects.Components.PathFollower
 * @since 3.17.0
 */
...
var PathFollower = {
     ...
     *
     * @name Vsengine.GameObjects.Components.PathFollower#path
     * @type {Vsengine.Curves.Path}
     * @since 3.0.0
     */
    path: null,
     ...
     *
     * @name Vsengine.GameObjects.Components.PathFollower#rotateToPath
     * @type {boolean}
     * @default false
     * @since 3.0.0
     */
    ...
    /**
     * If the PathFollower is rotating to match the Path (@see Vsengine.GameObjects.PathFollower#rotateToPath)
     * this value is added to the rotation value. This allows you to rotate objects to a path but control
     * the angle of the rotation as well.
     *
     * @name Vsengine.GameObjects.PathFollower#pathRotationOffset
     * @type {number}
     * @default 0
     * @since 3.0.0
     */
     ...
     * Path coordinates.
     *
     * @name Vsengine.GameObjects.PathFollower#pathOffset
     ...
     *
     * @name Vsengine.GameObjects.PathFollower#pathVector
     * @type {Vsengine.Math.Vector2}
     * @since 3.0.0
     */
    pathVector: null,
     ...
     *
     * @name Vsengine.GameObjects.PathFollower#pathDelta
     * @type {Vsengine.Math.Vector2}
     * @since 3.23.0
     */
    pathDelta: null,
     ...
     *
     * @name Vsengine.GameObjects.PathFollower#pathTween
     ...
     *
     * @name Vsengine.GameObjects.PathFollower#pathConfig
     * @type {?Vsengine.Types.GameObjects.PathFollower.PathConfig}
     * @default null
     * @since 3.0.0
     */
    pathConfig: null,
     ...
     *
     * @name Vsengine.GameObjects.PathFollower#_prevDirection
     * @type {number}
     * @private
     * @since 3.0.0
     */
     ...
     *
     * Optionally accepts {@link Vsengine.Types.GameObjects.PathFollower.PathConfig} settings.
     *
     * @method Vsengine.GameObjects.Components.PathFollower#setPath
     * @since 3.0.0
     *
     * @param {Vsengine.Curves.Path} path - The Path this PathFollower is following. It can only follow one Path at a time.
     * @param {(number|Vsengine.Types.GameObjects.PathFollower.PathConfig|Vsengine.Types.Tweens.NumberTweenBuilderConfig)} [config] - Settings for the PathFollower.
     *
     ...
     *
     * @method Vsengine.GameObjects.Components.PathFollower#setRotateToPath
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Components.PathFollower#isFollowing
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Components.PathFollower#startFollow
     * @since 3.3.0
     *
     * @param {(number|Vsengine.Types.GameObjects.PathFollower.PathConfig|Vsengine.Types.Tweens.NumberTweenBuilderConfig)} [config={}] - The duration of the follow, or a PathFollower config object.
    ...
    startFollow: function (config, startAt) {
        ...
        if (seek) {
            config.onStart = function (tween) {
                ...
                tweenData.current =
                    tweenData.start + (tweenData.end - tweenData.start) * v;
        ...
        if (this.rotateToPath) {
            ...
            this.rotation =
                Math.atan2(nextPoint.y - this.y, nextPoint.x - this.x) +
                DegToRad(this.pathRotationOffset);
        }
     ...
     *
     * @method Vsengine.GameObjects.Components.PathFollower#pauseFollow
     * @since 3.3.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.PathFollower#resumeFollow
     * @since 3.3.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.PathFollower#stopFollow
     * @since 3.3.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Components.PathFollower#pathUpdate
     * @since 3.17.0
     */
    pathUpdate: function () {
        var tween = this.pathTween;
        ...
        if (tween && tween.data) {
            ...
            if (tweenData.state === TWEEN_CONST.COMPLETE) {
                ...
                tweenData.state !== TWEEN_CONST.PLAYING_BACKWARD
            ) {
