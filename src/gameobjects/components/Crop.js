 ...
 *
 * @namespace Vsengine.GameObjects.Components.Crop
 * @since 3.12.0
 */
...
var Crop = {
     ...
     *
     * @name Vsengine.GameObjects.Components.Crop#texture
     ...
     *
     * @name Vsengine.GameObjects.Components.Crop#frame
     ...
     *
     * @name Vsengine.GameObjects.Components.Crop#isCropped
     * @type {boolean}
     * @since 3.11.0
     */
    isCropped: false,
     ...
     *
     * @method Vsengine.GameObjects.Components.Crop#setCrop
     * @since 3.11.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Components.Crop#resetCropObject
     * @private
     * @since 3.12.0
     *
