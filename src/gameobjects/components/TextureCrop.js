 ...
 *
 * @namespace Vsengine.GameObjects.Components.TextureCrop
 * @since 3.0.0
 */
...
var TextureCrop = {
     ...
     *
     * @name Vsengine.GameObjects.Components.TextureCrop#texture
     ...
     *
     * @name Vsengine.GameObjects.Components.TextureCrop#frame
     ...
     *
     * @name Vsengine.GameObjects.Components.TextureCrop#isCropped
     * @type {boolean}
     * @since 3.11.0
     */
    isCropped: false,
     ...
     *
     * @method Vsengine.GameObjects.Components.TextureCrop#setCrop
     * @since 3.11.0
     *
     * @param {(number|Vsengine.Geom.Rectangle)} [x] - The x coordinate to start the crop from. Cannot be negative or exceed the Frame width. Or a Vsengine.Geom.Rectangle object, in which case the rest of the arguments are ignored.
     ...
     *
     * @method Vsengine.GameObjects.Components.TextureCrop#setTexture
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Components.TextureCrop#setFrame
     * @since 3.0.0
     *
     * @param {(string|number|Vsengine.Textures.Frame)} frame - The name or index of the frame within the Texture, or a Frame instance.
     ...
     *
     * @method Vsengine.GameObjects.Components.TextureCrop#resetCropObject
     * @private
     * @since 3.12.0
     *
