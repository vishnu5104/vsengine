 ...
 *
 * @function Vsengine.GameObjects.BuildGameObjectAnimation
 * @since 3.0.0
 *
 * @param {Vsengine.GameObjects.Sprite} sprite - The sprite to add an Animation component to.
 * @param {object} config - The animation config.
 *
 * @return {Vsengine.GameObjects.Sprite} The updated Sprite.
 */
var BuildGameObjectAnimation = function (sprite, config) {
    ...
    if (typeof animConfig === "string") {
        ...
        if (key) {
            var startFrame = GetAdvancedValue(
                animConfig,
                "startFrame",
                undefined
            );
