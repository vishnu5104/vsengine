 ...
 *
 * @method Vsengine.GameObjects.PointLight#renderWebGL
 * @since 3.50.0
 * @private
 *
 * @param {Vsengine.Renderer.WebGL.WebGLRenderer} renderer - A reference to the current active WebGL renderer.
 * @param {Vsengine.GameObjects.PointLight} src - The Game Object being rendered in this call.
