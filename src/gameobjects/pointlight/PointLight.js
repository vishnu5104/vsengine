 ...
 *
 * @param {Vsengine.Scene} scene - The Scene to which this Point Light belongs. A Point Light can only belong to one Scene at a time.
...
var PointLight = new Class({
    ...
    initialize: function PointLight(
        scene,
        x,
        y,
        color,
         ...
         *
         * @name Vsengine.GameObjects.PointLight#color
         ...
         *
         * @name Vsengine.GameObjects.PointLight#intensity
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.PointLight#attenuation
         * @type {number}
         * @since 3.50.0
         */
     ...
     *
     * @name Vsengine.GameObjects.PointLight#radius
     * @type {number}
     * @since 3.50.0
     */
    radius: {
