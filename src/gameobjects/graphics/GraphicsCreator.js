 ...
 *
 * @method Vsengine.GameObjects.GameObjectCreator#graphics
 * @since 3.0.0
 *
 * @param {Vsengine.Types.GameObjects.Graphics.Options} [config] - The configuration object this Game Object will use to create itself.
