 ...
 *
 * @method Vsengine.GameObjects.Graphics#renderCanvas
 * @since 3.0.0
 * @private
 *
 * @param {Vsengine.Renderer.Canvas.CanvasRenderer} renderer - A reference to the current active Canvas renderer.
 * @param {Vsengine.GameObjects.Graphics} src - The Game Object being rendered in this call.
 ...
 */
var GraphicsCanvasRenderer = function (
    renderer,
    src,
    camera,
    parentMatrix,
