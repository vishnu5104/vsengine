 ...
 * performance by calling {@link Vsengine.GameObjects.Graphics#generateTexture}. This will 'bake' the Graphics object into
 ...
 *
 * @param {Vsengine.Scene} scene - The Scene to which this Graphics object belongs.
 * @param {Vsengine.Types.GameObjects.Graphics.Options} [options] - Options that set the position and default style of this Graphics object.
 */
var Graphics = new Class({
    ...
    initialize: function Graphics(scene, options) {
         ...
         *
         * @name Vsengine.GameObjects.Graphics#displayOriginX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Graphics#displayOriginY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Graphics#commandBuffer
         * @type {array}
         * @default []
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Graphics#defaultFillColor
         * @type {number}
         * @readonly
         * @default -1
         * @since 3.0.0
         ...
         * Set this value with `setDefaultStyles()`.
         *
         * @name Vsengine.GameObjects.Graphics#defaultFillAlpha
         * @type {number}
         * @readonly
         * @default 1
         * @since 3.0.0
         ...
         * Set this value with `setDefaultStyles()`.
         *
         * @name Vsengine.GameObjects.Graphics#defaultStrokeWidth
         * @type {number}
         * @readonly
         * @default 1
         * @since 3.0.0
         ...
         * Set this value with `setDefaultStyles()`.
         *
         * @name Vsengine.GameObjects.Graphics#defaultStrokeColor
         * @type {number}
         * @readonly
         * @default -1
         * @since 3.0.0
         ...
         * Set this value with `setDefaultStyles()`.
         *
         * @name Vsengine.GameObjects.Graphics#defaultStrokeAlpha
         * @type {number}
         * @readonly
         * @default 1
         * @since 3.0.0
         ...
         *
         * @name Vsengine.GameObjects.Graphics#_lineWidth
         * @type {number}
         * @private
         * @since 3.0.0
         */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#setDefaultStyles
     * @since 3.0.0
     *
     * @param {Vsengine.Types.GameObjects.Graphics.Styles} options - The styles to set as defaults.
     *
     ...
     *
     * @method Vsengine.GameObjects.Graphics#lineStyle
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Graphics#fillStyle
     * @since 3.0.0
     *
     ...
     * entity at this time.
     *
     * @method Vsengine.GameObjects.Graphics#fillGradientStyle
     * @webglOnly
     * @since 3.12.0
     *
     ...
     * entity at this time.
     *
     * @method Vsengine.GameObjects.Graphics#lineGradientStyle
     * @webglOnly
     * @since 3.12.0
     *
     * @param {number} lineWidth - The stroke width.
     ...
     *
     * @method Vsengine.GameObjects.Graphics#beginPath
     * @since 3.0.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#closePath
     * @since 3.0.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#fillPath
     * @since 3.0.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#fill
     * @since 3.16.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#strokePath
     * @since 3.0.0
     *
     * @return {this} This Game Object.
     */
     ...
     * It was added to match the CanvasRenderingContext 2D API.
     *
     * @method Vsengine.GameObjects.Graphics#stroke
     * @since 3.16.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#fillCircleShape
     * @since 3.0.0
     *
     * @param {Vsengine.Geom.Circle} circle - The circle to fill.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#strokeCircleShape
     * @since 3.0.0
     *
     * @param {Vsengine.Geom.Circle} circle - The circle to stroke.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#fillCircle
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Graphics#strokeCircle
     * @since 3.0.0
     *
     * @param {number} x - The x coordinate of the center of the circle.
     * @param {number} y - The y coordinate of the center of the circle.
     ...
     *
     * @method Vsengine.GameObjects.Graphics#fillRectShape
     * @since 3.0.0
     *
     * @param {Vsengine.Geom.Rectangle} rect - The rectangle to fill.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#strokeRectShape
     * @since 3.0.0
     *
     * @param {Vsengine.Geom.Rectangle} rect - The rectangle to stroke.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#fillRect
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Graphics#strokeRect
     * @since 3.0.0
     *
     * @param {number} x - The x coordinate of the top-left of the rectangle.
     * @param {number} y - The y coordinate of the top-left of the rectangle.
     ...
     *
     * @method Vsengine.GameObjects.Graphics#fillRoundedRect
     * @since 3.11.0
     *
     * @param {number} x - The x coordinate of the top-left of the rectangle.
     * @param {number} y - The y coordinate of the top-left of the rectangle.
     * @param {number} width - The width of the rectangle.
     * @param {number} height - The height of the rectangle.
     * @param {(Vsengine.Types.GameObjects.Graphics.RoundedRectRadius|number)} [radius=20] - The corner radius; It can also be an object to specify different radius for corners.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#strokeRoundedRect
     * @since 3.11.0
     *
     * @param {number} x - The x coordinate of the top-left of the rectangle.
     * @param {number} y - The y coordinate of the top-left of the rectangle.
     * @param {number} width - The width of the rectangle.
     * @param {number} height - The height of the rectangle.
     * @param {(Vsengine.Types.GameObjects.Graphics.RoundedRectRadius|number)} [radius=20] - The corner radius; It can also be an object to specify different radii for corners.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#fillPointShape
     * @since 3.0.0
     *
     * @param {(Vsengine.Geom.Point|Vsengine.Math.Vector2|object)} point - The point to fill.
     ...
     * Draws a square at the given position, 1 pixel in size by default.
     *
     * @method Vsengine.GameObjects.Graphics#fillPoint
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Graphics#fillTriangleShape
     * @since 3.0.0
     *
     * @param {Vsengine.Geom.Triangle} triangle - The triangle to fill.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#strokeTriangleShape
     * @since 3.0.0
     *
     * @param {Vsengine.Geom.Triangle} triangle - The triangle to stroke.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#fillTriangle
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Graphics#strokeTriangle
     * @since 3.0.0
     *
     * @param {number} x0 - The x coordinate of the first point.
     * @param {number} y0 - The y coordinate of the first point.
     ...
     * Draw the given line.
     *
     * @method Vsengine.GameObjects.Graphics#strokeLineShape
     * @since 3.0.0
     *
     * @param {Vsengine.Geom.Line} line - The line to stroke.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#lineBetween
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Graphics#lineTo
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Graphics#moveTo
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Graphics#strokePoints
     * @since 3.0.0
     *
     * @param {(array|Vsengine.Geom.Point[])} points - The points to stroke.
     ...
     *
     * @method Vsengine.GameObjects.Graphics#fillPoints
     * @since 3.0.0
     *
     * @param {(array|Vsengine.Geom.Point[])} points - The points to fill.
     * @param {boolean} [closeShape=false] - When `true`, the shape is closed by joining the last point to the first point.
     * @param {boolean} [closePath=false] - When `true`, the path is closed before being stroked.
     ...
     *
     * @method Vsengine.GameObjects.Graphics#strokeEllipseShape
     * @since 3.0.0
     *
     * @param {Vsengine.Geom.Ellipse} ellipse - The ellipse to stroke.
     ...
     *
     * @method Vsengine.GameObjects.Graphics#strokeEllipse
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Graphics#fillEllipseShape
     * @since 3.0.0
     *
     * @param {Vsengine.Geom.Ellipse} ellipse - The ellipse to fill.
     * @param {number} [smoothness=32] - The number of points to draw the ellipse with.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#fillEllipse
     * @since 3.0.0
     *
     * @param {number} x - The x coordinate of the center of the ellipse.
     * @param {number} y - The y coordinate of the center of the ellipse.
     ...
     *
     * Call {@link Vsengine.GameObjects.Graphics#fillPath} or {@link Vsengine.GameObjects.Graphics#strokePath} after calling
     * this method to draw the arc.
     *
     * @method Vsengine.GameObjects.Graphics#arc
     * @since 3.0.0
     *
     * @param {number} x - The x coordinate of the center of the circle.
     * @param {number} y - The y coordinate of the center of the circle.
     ...
     *
     * @method Vsengine.GameObjects.Graphics#slice
     * @since 3.4.0
     *
     ...
     *
     * The most recently saved state can then be restored with {@link Vsengine.GameObjects.Graphics#restore}.
     *
     * @method Vsengine.GameObjects.Graphics#save
     * @since 3.0.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * Use {@link Vsengine.GameObjects.Graphics#save} to save the current state, and call this afterwards to restore that state.
     *
     * If there is no saved state, this command does nothing.
     *
     * @method Vsengine.GameObjects.Graphics#restore
     * @since 3.0.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#translateCanvas
     * @since 3.0.0
     *
     ...
     * only of the objects drawn by it after calling this method.
     *
     * @method Vsengine.GameObjects.Graphics#scaleCanvas
     * @since 3.0.0
     *
     ...
     * only of the objects drawn by it after calling this method.
     *
     * @method Vsengine.GameObjects.Graphics#rotateCanvas
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Graphics#clear
     * @since 3.0.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Graphics#generateTexture
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Graphics#preDestroy
     * @protected
     * @since 3.9.0
     */
    preDestroy: function () {
 ...
 *
 * @name Vsengine.GameObjects.Graphics.TargetCamera
