 ...
 * @since 3.0.0
 *
 * @extends Vsengine.GameObjects.Components.PathFollower
 *
 * @param {Vsengine.Scene} scene - The Scene to which this PathFollower belongs.
...
var PathFollower = new Class({
     ...
     *
     * @method Vsengine.GameObjects.PathFollower#preUpdate
     * @protected
     * @since 3.0.0
     *
