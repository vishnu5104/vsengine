 ...
 *
 * Note: This method will only be available if the PathFollower Game Object has been built into Vsengine.
 *
 * @method Vsengine.GameObjects.GameObjectFactory#follower
 * @since 3.0.0
 *
 * @param {Vsengine.Curves.Path} path - The Path this PathFollower is connected to.
 ...
 *
 * @return {Vsengine.GameObjects.PathFollower} The Game Object that was created.
 */
