 ...
 * @param {Vsengine.GameObjects.GameObject[]} [children] - An optional array of Game Objects to add to this Layer.
 */
var Layer = new Class({
    Extends: List,
    ...
    initialize: function Layer(scene, children) {
         ...
         *
         * @name Vsengine.GameObjects.Layer#scene
         * @type {Vsengine.Scene}
         * @since 3.50.0
         */
        this.scene = scene;
         ...
         *
         * @name Vsengine.GameObjects.Layer#displayList
         ...
         *
         * @name Vsengine.GameObjects.Layer#type
         * @type {string}
         * @since 3.50.0
         */
        this.type = "Layer";
         ...
         *
         * @name Vsengine.GameObjects.Layer#state
         * @type {(number|string)}
         * @since 3.50.0
         */
        this.state = 0;
         ...
         *
         * @name Vsengine.GameObjects.Layer#parentContainer
         ...
         *
         * @name Vsengine.GameObjects.Layer#name
         * @type {string}
         * @default ''
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Layer#active
         * @type {boolean}
         * @default true
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Layer#tabIndex
         * @type {number}
         * @default -1
         * @since 3.51.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Layer#data
         ...
         *
         * @name Vsengine.GameObjects.Layer#renderFlags
         * @type {number}
         * @default 15
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Layer#cameraFilter
         * @type {number}
         * @default 0
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Layer#input
         ...
         *
         * @name Vsengine.GameObjects.Layer#body
         ...
         *
         * @name Vsengine.GameObjects.Layer#ignoreDestroy
         * @type {boolean}
         * @default false
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Layer#systems
         ...
         *
         * @name Vsengine.GameObjects.Layer#events
         ...
         *
         * @name Vsengine.GameObjects.Layer#sortChildrenFlag
         * @type {boolean}
         * @default false
         * @since 3.50.0
         */
     ...
     *
     * @method Vsengine.GameObjects.Layer#setActive
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Layer#setName
     * @since 3.50.0
     *
     ...
     * If you need to store complex data about your Game Object, look at using the Data Component instead.
     *
     * @method Vsengine.GameObjects.Layer#setState
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Layer#setDataEnabled
     * @since 3.50.0
     ...
     *
     * @method Vsengine.GameObjects.Layer#setData
     * @since 3.50.0
     *
     ...
     * When the value is first set, a `setdata` event is emitted from this Game Object.
     *
     * @method Vsengine.GameObjects.Layer#incData
     * @since 3.50.0
     *
     ...
     * When the value is first set, a `setdata` event is emitted from this Game Object.
     *
     * @method Vsengine.GameObjects.Layer#toggleData
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Layer#getData
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Layer#setInteractive
     * @since 3.51.0
     *
     * @return {this} This GameObject.
     */
     ...
     * the Layer has the same shape as a Game Object.
     *
     * @method Vsengine.GameObjects.Layer#disableInteractive
     * @since 3.51.0
     *
     * @return {this} This GameObject.
     */
     ...
     * the Layer has the same shape as a Game Object.
     *
     * @method Vsengine.GameObjects.Layer#removeInteractive
     * @since 3.51.0
     *
     * @return {this} This GameObject.
     */
     ...
     *
     * @method Vsengine.GameObjects.Layer#addedToScene
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Layer#removedFromScene
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Layer#update
     * @since 3.50.0
     *
     * @param {...*} [args] - args
     */
     ...
     *
     * @method Vsengine.GameObjects.Layer#toJSON
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Layer#willRender
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Layer#getIndexList
     * @since 3.51.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Layer#addChildCallback
     * @private
     ...
     *
     * @method Vsengine.GameObjects.Layer#removeChildCallback
     * @private
     ...
     *
     * @method Vsengine.GameObjects.Layer#queueDepthSort
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Layer#depthSort
     * @since 3.50.0
     */
    depthSort: function () {
     ...
     *
     * @method Vsengine.GameObjects.Layer#sortByDepth
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Layer#getChildren
     * @since 3.50.0
     *
     * @return {Vsengine.GameObjects.GameObject[]} An array of Game Objects within this Layer.
     */
     ...
     *
     * You can query which list it is on by looking at the `Vsengine.GameObjects.Layer#displayList` property.
     *
     * If a Layer isn't on any display list, it will not be rendered. If you just wish to temporarily
     * disable it from rendering, consider using the `setVisible` method, instead.
     *
     * @method Vsengine.GameObjects.Layer#addToDisplayList
     * @fires Vsengine.Scenes.Events#ADDED_TO_SCENE
     * @fires Vsengine.GameObjects.Events#ADDED_TO_SCENE
     * @since 3.60.0
     *
     ...
     * disable it from rendering, consider using the `setVisible` method, instead.
     *
     * @method Vsengine.GameObjects.Layer#removeFromDisplayList
     * @fires Vsengine.Scenes.Events#REMOVED_FROM_SCENE
     * @fires Vsengine.GameObjects.Events#REMOVED_FROM_SCENE
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Layer#destroy
     ...
     *
     * @method Vsengine.GameObjects.Layer#eventNames
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Layer#listeners
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Layer#listenerCount
     * @since 3.50.0
     *
     * @param {(string|symbol)} event - The event name.
     *
     ...
     *
     * @method Vsengine.GameObjects.Layer#emit
     * @since 3.50.0
     *
     * @param {(string|symbol)} event - The event name.
     ...
     *
     * @method Vsengine.GameObjects.Layer#on
     * @since 3.50.0
     *
     * @param {(string|symbol)} event - The event name.
     ...
     * Add a listener for a given event.
     *
     * @method Vsengine.GameObjects.Layer#addListener
     * @since 3.50.0
     *
     * @param {(string|symbol)} event - The event name.
     * @param {function} fn - The listener function.
     ...
     *
     * @method Vsengine.GameObjects.Layer#once
     * @since 3.50.0
     *
     * @param {(string|symbol)} event - The event name.
     * @param {function} fn - The listener function.
     ...
     *
     * @method Vsengine.GameObjects.Layer#removeListener
     * @since 3.50.0
     *
     * @param {(string|symbol)} event - The event name.
     ...
     * Remove the listeners of a given event.
     *
     * @method Vsengine.GameObjects.Layer#off
     * @since 3.50.0
     *
     * @param {(string|symbol)} event - The event name.
     * @param {function} [fn] - Only remove the listeners that match this function.
     ...
     *
     * @method Vsengine.GameObjects.Layer#removeAllListeners
     * @since 3.50.0
     *
     * @param {(string|symbol)} [event] - The event name.
     *
