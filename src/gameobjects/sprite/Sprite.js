...
var Sprite = new Class({
    ...
    initialize: function Sprite(scene, x, y, texture, frame) {
         ...
         *
         * @name Vsengine.GameObjects.Sprite#_crop
         * @type {object}
         * @private
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Sprite#anims
     ...
     *
     * @method Vsengine.GameObjects.Sprite#preUpdate
     * @protected
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Sprite#play
     ...
     * Also, see the documentation in the Animation Manager for further details on creating animations.
     *
     * @method Vsengine.GameObjects.Sprite#playReverse
     * @fires Vsengine.Animations.Events#ANIMATION_START
     * @since 3.50.0
     *
     * @param {(string|Vsengine.Animations.Animation|Vsengine.Types.Animations.PlayAnimationConfig)} key - The string-based key of the animation to play, or an Animation instance, or a `PlayAnimationConfig` object.
     ...
     * search the global Animation Manager and look for it there.
     *
     * Prior to Vsengine 3.50 this method was called 'delayedPlay'.
     *
     * @method Vsengine.GameObjects.Sprite#playAfterDelay
     * @fires Vsengine.Animations.Events#ANIMATION_START
     * @since 3.50.0
     *
     * @param {(string|Vsengine.Animations.Animation|Vsengine.Types.Animations.PlayAnimationConfig)} key - The string-based key of the animation to play, or an Animation instance, or a `PlayAnimationConfig` object.
     ...
     * search the global Animation Manager and look for it there.
     *
     * @method Vsengine.GameObjects.Sprite#playAfterRepeat
     * @fires Vsengine.Animations.Events#ANIMATION_START
     * @since 3.50.0
     *
     * @param {(string|Vsengine.Animations.Animation|Vsengine.Types.Animations.PlayAnimationConfig)} key - The string-based key of the animation to play, or an Animation instance, or a `PlayAnimationConfig` object.
     ...
     * search the global Animation Manager and look for it there.
     *
     * @method Vsengine.GameObjects.Sprite#chain
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Sprite#stop
     ...
     *
     * @method Vsengine.GameObjects.Sprite#stopAfterDelay
     * @fires Vsengine.Animations.Events#ANIMATION_STOP
     * @since 3.50.0
     *
     ...
     * when the current one stops.
     *
     * @method Vsengine.GameObjects.Sprite#stopAfterRepeat
     * @fires Vsengine.Animations.Events#ANIMATION_STOP
     * @since 3.50.0
     *
     ...
     * when the current one stops.
     *
     * @method Vsengine.GameObjects.Sprite#stopOnFrame
     * @fires Vsengine.Animations.Events#ANIMATION_STOP
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Sprite#toJSON
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Sprite#preDestroy
     * @private
     * @since 3.14.0
     */
    preDestroy: function () {
