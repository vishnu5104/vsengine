 ...
 * achieve special effects in your games. Note that rendering still takes place using Vsengine's
...
var Mesh = new Class({
    ...
    initialize: function Mesh(
         ...
         *
         * @name Vsengine.GameObjects.Mesh#faces
         * @type {Vsengine.Geom.Mesh.Face[]}
         * @since 3.50.0
         */
        this.faces = [];
         ...
         *
         * @name Vsengine.GameObjects.Mesh#vertices
         * @type {Vsengine.Geom.Mesh.Vertex[]}
         * @since 3.50.0
         */
        this.vertices = [];
         ...
         *
         * @name Vsengine.GameObjects.Mesh#tintFill
         * @type {boolean}
         * @default false
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Mesh#debugCallback
         * @type {function}
         * @since 3.50.0
         */
         ...
         * been called.
         *
         * @name Vsengine.GameObjects.Mesh#debugGraphic
         ...
         *
         * @name Vsengine.GameObjects.Mesh#hideCCW
         * @type {boolean}
         * @since 3.50.0
         */
        this.hideCCW = true;
         ...
         *
         * @name Vsengine.GameObjects.Mesh#modelPosition
         ...
         * Changing this property will impact all vertices being rendered by this Mesh.
         *
         * @name Vsengine.GameObjects.Mesh#modelScale
         * @type {Vsengine.Math.Vector3}
         * @since 3.50.0
         */
         ...
         * degrees you can use `modelRotation.x = Vsengine.Math.DegToRad(90)`.
         *
         ...
         * Changing this property will impact all vertices being rendered by this Mesh.
         *
         * @name Vsengine.GameObjects.Mesh#modelRotation
         * @type {Vsengine.Math.Vector3}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Mesh#dirtyCache
         * @type {number[]}
         * @private
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Mesh#transformMatrix
         ...
         *
         * @name Vsengine.GameObjects.Mesh#viewPosition
         * @type {Vsengine.Math.Vector3}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Mesh#viewMatrix
         * @type {Vsengine.Math.Matrix4}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Mesh#projectionMatrix
         * @type {Vsengine.Math.Matrix4}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Mesh#totalRendered
         * @type {number}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Mesh#totalFrame
         * @type {number}
         * @private
         * @since 3.50.0
         */
         ...
         * need it.
         *
         * @name Vsengine.GameObjects.Mesh#ignoreDirtyCache
         * @type {boolean}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Mesh#fov
         * @type {number}
         * @readonly
         * @since 3.60.0
         */
     ...
     *
     * @method Vsengine.GameObjects.Mesh#panX
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Mesh#panY
     * @since 3.50.0
     *
     * @param {number} v - The amount to pan by.
     */
     ...
     *
     * @method Vsengine.GameObjects.Mesh#panZ
     * @since 3.50.0
     *
     * @param {number} v - The amount to pan by.
     */
     ...
     * See also `setOrtho`.
     *
     * @method Vsengine.GameObjects.Mesh#setPerspective
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Mesh#setOrtho
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Mesh#clear
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Mesh#addVerticesFromObj
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Mesh#sortByDepth
     * @since 3.50.0
     *
     * @param {Vsengine.Geom.Mesh.Face} faceA - The first Face.
     * @param {Vsengine.Geom.Mesh.Face} faceB - The second Face.
     *
     ...
     *
     * @method Vsengine.GameObjects.Mesh#depthSort
     * @since 3.50.0
     *
     * @return {this} This Mesh Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Mesh#addVertex
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Mesh#addFace
     * @since 3.50.0
     *
     * @param {Vsengine.Geom.Mesh.Vertex} vertex1 - The first vertex of the Face.
     * @param {Vsengine.Geom.Mesh.Vertex} vertex2 - The second vertex of the Face.
     * @param {Vsengine.Geom.Mesh.Vertex} vertex3 - The third vertex of the Face.
     *
     * @return {this} This Mesh Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Mesh#addVertices
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Mesh#getFaceCount
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Mesh#getVertexCount
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Mesh#getFace
     * @since 3.50.0
     *
     * @param {number} index - The index of the Face to get.
     *
     * @return {Vsengine.Geom.Mesh.Face} The Face at the given index, or `undefined` if index out of range.
     */
     ...
     *
     * @method Vsengine.GameObjects.Mesh#hasFaceAt
     * @since 3.60.0
     *
     * @param {number} x - The x position to check against.
     * @param {number} y - The y position to check against.
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The camera to pass the coordinates through. If not give, the default Scene Camera is used.
     *
     ...
     *
     * @method Vsengine.GameObjects.Mesh#getFaceAt
     * @since 3.50.0
     *
     * @param {number} x - The x position to check against.
     * @param {number} y - The y position to check against.
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The camera to pass the coordinates through. If not give, the default Scene Camera is used.
     *
     * @return {Vsengine.Geom.Mesh.Face[]} An array of Face objects that intersect with the given point, ordered by depth.
     */
     ...
     * with no arguments.
     *
     * @method Vsengine.GameObjects.Mesh#setDebug
     * @since 3.50.0
     *
     * @param {Vsengine.GameObjects.Graphics} [graphic] - The Graphic instance to render to if using the built-in callback.
     ...
     *
     * @method Vsengine.GameObjects.Mesh#isDirty
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Mesh#preUpdate
     * @protected
     * @since 3.50.0
     *
    ...
    preUpdate: function () {
        ...
        for (var i = 0; i < faces.length; i++) {
            faces[i].transformCoordinatesLocal(
                transformMatrix,
                width,
                height,
                z
     ...
     *
     * @method Vsengine.GameObjects.Mesh#renderDebug
     * @since 3.50.0
     *
     * @param {Vsengine.GameObjects.Mesh} src - The Mesh object being rendered.
     * @param {Vsengine.Geom.Mesh.Face[]} faces - An array of Faces.
     */
     ...
     *
     * @method Vsengine.GameObjects.Mesh#preDestroy
     * @private
     * @since 3.50.0
     */
    preDestroy: function () {
     ...
     *
     * @method Vsengine.GameObjects.Mesh#clearTint
     * @webglOnly
     * @since 3.60.0
     *
     * @return {this} This Game Object instance.
     ...
     *
     * @method Vsengine.GameObjects.Mesh#setInteractive
     * @since 3.60.0
     *
     * @param {(Vsengine.Types.Input.InputConfiguration)} [config] - An input configuration object but it will ignore hitArea, hitAreaCallback and pixelPerfect with associated alphaTolerance properties.
     *
     ...
     *
     * @method Vsengine.GameObjects.Mesh#setTint
     * @webglOnly
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Mesh#uvScroll
     * @webglOnly
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Mesh#uvScale
     * @webglOnly
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Mesh#tint
     * @type {number}
     * @webglOnly
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Mesh#rotateX
     * @type {number}
     * @since 3.60.0
     */
    rotateX: {
     ...
     *
     * @method Vsengine.GameObjects.Mesh#rotateY
     * @type {number}
     * @since 3.60.0
     */
    rotateY: {
     ...
     *
     * @method Vsengine.GameObjects.Mesh#rotateZ
     * @type {number}
     * @since 3.60.0
     */
    rotateZ: {
