...
var GameObjectCreator = new Class({
    initialize: function GameObjectCreator(scene) {
         ...
         *
         * @name Vsengine.GameObjects.GameObjectCreator#scene
         * @type {Vsengine.Scene}
         * @protected
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.GameObjectCreator#systems
         ...
         *
         * @name Vsengine.GameObjects.GameObjectCreator#events
         ...
         *
         * @name Vsengine.GameObjects.GameObjectCreator#displayList
         ...
         *
         * @name Vsengine.GameObjects.GameObjectCreator#updateList
     ...
     *
     * @method Vsengine.GameObjects.GameObjectCreator#boot
     * @private
     * @since 3.5.1
     */
    boot: function () {
     ...
     * Do not invoke it directly.
     *
     * @method Vsengine.GameObjects.GameObjectCreator#start
     * @private
     * @since 3.5.0
     */
    start: function () {
     ...
     *
     * @method Vsengine.GameObjects.GameObjectCreator#shutdown
     * @private
     * @since 3.0.0
     */
    shutdown: function () {
     ...
     *
     * @method Vsengine.GameObjects.GameObjectCreator#destroy
     * @private
     * @since 3.0.0
     */
    destroy: function () {
 ...
 * to be called when you invoke Vsengine.Scene.make[ factoryType ] method.
 *
 * @method Vsengine.GameObjects.GameObjectCreator.register
 * @static
 * @since 3.0.0
 *
 * @param {string} factoryType - The key of the factory that you will use to call to Vsengine.Scene.make[ factoryType ] method.
 * @param {function} factoryFunction - The constructor function to be called when you invoke to the Vsengine.Scene.make method.
 */
 ...
 *
 * @method Vsengine.GameObjects.GameObjectCreator.remove
 * @static
 * @since 3.0.0
 *
