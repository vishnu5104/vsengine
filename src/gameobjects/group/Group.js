 ...
 * @param {Vsengine.Types.GameObjects.Group.GroupConfig|Vsengine.Types.GameObjects.Group.GroupCreateConfig} [config] - Settings for this group. If `key` is set, Vsengine.GameObjects.Group#createMultiple is also called with these settings.
 *
 * @see Vsengine.Physics.Arcade.Group
 * @see Vsengine.Physics.Arcade.StaticGroup
 */
var Group = new Class({
    ...
    initialize: function Group(scene, children, config) {
         ...
         *
         * @name Vsengine.GameObjects.Group#scene
         * @type {Vsengine.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name Vsengine.GameObjects.Group#children
         * @type {Vsengine.Structs.Set.<Vsengine.GameObjects.GameObject>}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Group#isParent
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Group#type
         * @type {string}
         * @default 'Group'
         * @since 3.21.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Group#classType
         * @type {function}
         * @since 3.0.0
         * @default Vsengine.GameObjects.Sprite
         * @see Vsengine.Types.GameObjects.Group.GroupClassTypeConstructor
         */
         ...
         *
         * @name Vsengine.GameObjects.Group#name
         * @type {string}
         * @default ''
         * @since 3.18.0
         */
        ...
        /**
         * Whether this group runs its {@link Vsengine.GameObjects.Group#preUpdate} method (which may update any members).
         *
         * @name Vsengine.GameObjects.Group#active
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Group#maxSize
         * @type {number}
         * @since 3.0.0
         * @default -1
         */
         ...
         *
         * This is used in {@link Vsengine.GameObjects.Group#create}
         * but not in {@link Vsengine.GameObjects.Group#createMultiple}.
         *
         * @name Vsengine.GameObjects.Group#defaultKey
         * @type {string}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Group#defaultFrame
         * @type {(string|number)}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Group#runChildUpdate
         * @type {boolean}
         * @default false
         * @since 3.0.0
         * @see Vsengine.GameObjects.Group#preUpdate
         */
         ...
         *
         * @name Vsengine.GameObjects.Group#createCallback
         * @type {?Vsengine.Types.GameObjects.Group.GroupCallback}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Group#removeCallback
         * @type {?Vsengine.Types.GameObjects.Group.GroupCallback}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Group#createMultipleCallback
         * @type {?Vsengine.Types.GameObjects.Group.GroupMultipleCreateCallback}
         * @since 3.0.0
         */
        this.createMultipleCallback = GetFastValue(
            config,
         ...
         *
         * @name Vsengine.GameObjects.Group#internalCreateCallback
         * @type {?Vsengine.Types.GameObjects.Group.GroupCallback}
         * @private
         * @since 3.22.0
         */
        this.internalCreateCallback = GetFastValue(
            config,
         ...
         * For internal use only by a Group, or any class that extends it.
         *
         * @name Vsengine.GameObjects.Group#internalRemoveCallback
         * @type {?Vsengine.Types.GameObjects.Group.GroupCallback}
         * @private
         * @since 3.22.0
         */
        this.internalRemoveCallback = GetFastValue(
            config,
    ...
    /**
     * Creates a new Game Object and adds it to this group, unless the group {@link Vsengine.GameObjects.Group#isFull is full}.
     *
     * Calls {@link Vsengine.GameObjects.Group#createCallback}.
     *
     * @method Vsengine.GameObjects.Group#create
     * @since 3.0.0
     *
     ...
     * @param {boolean} [visible=true] - The {@link Vsengine.GameObjects.Components.Visible#visible} state of the new Game Object.
     * @param {boolean} [active=true] - The {@link Vsengine.GameObjects.GameObject#active} state of the new Game Object.
     *
     ...
     *
     * If the group becomes {@link Vsengine.GameObjects.Group#isFull}, no further Game Objects are created.
     *
     * Calls {@link Vsengine.GameObjects.Group#createMultipleCallback} and {@link Vsengine.GameObjects.Group#createCallback}.
     *
     * @method Vsengine.GameObjects.Group#createMultiple
     * @since 3.0.0
     *
     * @param {Vsengine.Types.GameObjects.Group.GroupCreateConfig|Vsengine.Types.GameObjects.Group.GroupCreateConfig[]} config - Creation settings. This can be a single configuration object or an array of such objects, which will be applied in turn.
     *
    ...
    /**
     * A helper for {@link Vsengine.GameObjects.Group#createMultiple}.
     *
     * @method Vsengine.GameObjects.Group#createFromConfig
     * @since 3.0.0
     *
     * @param {Vsengine.Types.GameObjects.Group.GroupCreateConfig} options - Creation settings.
     *
     * @return {any[]} The newly created Game Objects.
     */
    createFromConfig: function (options) {
        ...
        if (HasValue(options, "setScrollFactor")) {
            ...
            var scrollFactorY = GetValue(
                options,
                "setScrollFactor.y",
                scrollFactorX
            );
            var stepScrollFactorX = GetValue(
                options,
                "setScrollFactor.stepX",
                0
            );
            var stepScrollFactorY = GetValue(
                options,
                "setScrollFactor.stepY",
                0
            );

            Actions.SetScrollFactor(
                entries,
                scrollFactorX,
                scrollFactorY,
                stepScrollFactorX,
    ...
    /**
     * Updates any group members, if {@link Vsengine.GameObjects.Group#runChildUpdate} is enabled.
     *
     * @method Vsengine.GameObjects.Group#preUpdate
     * @since 3.0.0
     *
     ...
     * Calls {@link Vsengine.GameObjects.Group#createCallback}.
     *
     * @method Vsengine.GameObjects.Group#add
     * @since 3.0.0
     *
     ...
     * Calls {@link Vsengine.GameObjects.Group#createCallback}.
     *
     * @method Vsengine.GameObjects.Group#addMultiple
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject[]} children - The Game Objects to add.
     ...
     *
     * Calls {@link Vsengine.GameObjects.Group#removeCallback}.
     *
     * @method Vsengine.GameObjects.Group#remove
     * @since 3.0.0
     *
     ...
     *
     * Does not call {@link Vsengine.GameObjects.Group#removeCallback}.
     *
     * @method Vsengine.GameObjects.Group#clear
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#contains
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} child - A Game Object.
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#getChildren
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#getLength
     * @since 3.0.0
     *
     * @return {number}
     */
     ...
     * the first 50.
     *
     * @method Vsengine.GameObjects.Group#getMatching
     * @since 3.50.0
     *
    ...
    /**
     * Scans the Group, from top to bottom, for the first member that has an {@link Vsengine.GameObjects.GameObject#active} state matching the argument,
     * assigns `x` and `y`, and returns the member.
     *
     * If no matching member is found and `createIfNull` is true and the group isn't full then it will create a new Game Object using `x`, `y`, `key`, `frame`, and `visible`.
     * Unless a new member is created, `key`, `frame`, and `visible` are ignored.
     *
     * @method Vsengine.GameObjects.Group#getFirst
     * @since 3.0.0
     *
     * @param {boolean} [state=false] - The {@link Vsengine.GameObjects.GameObject#active} value to match.
     ...
     * @param {boolean} [visible=true] - The {@link Vsengine.GameObjects.Components.Visible#visible} state of a new Game Object (if one is created).
     *
    ...
    /**
     * Scans the Group, from top to bottom, for the nth member that has an {@link Vsengine.GameObjects.GameObject#active} state matching the argument,
     * assigns `x` and `y`, and returns the member.
     *
     * If no matching member is found and `createIfNull` is true and the group isn't full then it will create a new Game Object using `x`, `y`, `key`, `frame`, and `visible`.
     * Unless a new member is created, `key`, `frame`, and `visible` are ignored.
     *
     * @method Vsengine.GameObjects.Group#getFirstNth
     * @since 3.6.0
     *
    ...
    /**
     * Scans the Group for the last member that has an {@link Vsengine.GameObjects.GameObject#active} state matching the argument,
     * assigns `x` and `y`, and returns the member.
     *
     * If no matching member is found and `createIfNull` is true and the group isn't full then it will create a new Game Object using `x`, `y`, `key`, `frame`, and `visible`.
     * Unless a new member is created, `key`, `frame`, and `visible` are ignored.
     *
     * @method Vsengine.GameObjects.Group#getLast
     * @since 3.6.0
     *
     * @param {boolean} [state=false] - The {@link Vsengine.GameObjects.GameObject#active} value to match.
     * @param {boolean} [createIfNull=false] - Create a new Game Object if no matching members are found, using the following arguments.
    ...
    /**
     * Scans the Group for the last nth member that has an {@link Vsengine.GameObjects.GameObject#active} state matching the argument,
     * assigns `x` and `y`, and returns the member.
     *
     * If no matching member is found and `createIfNull` is true and the group isn't full then it will create a new Game Object using `x`, `y`, `key`, `frame`, and `visible`.
     * Unless a new member is created, `key`, `frame`, and `visible` are ignored.
     *
     * @method Vsengine.GameObjects.Group#getLastNth
     * @since 3.6.0
     *
     * @param {number} nth - The nth matching Group member to search for.
     * @param {boolean} [state=false] - The {@link Vsengine.GameObjects.GameObject#active} value to match.
     ...
     * Unless a new member is created, `key`, `frame`, and `visible` are ignored.
     *
     * @method Vsengine.GameObjects.Group#getHandler
     * @private
     * @since 3.6.0
     *
    ...
    /**
     * Scans the group for the first member that has an {@link Vsengine.GameObjects.GameObject#active} state set to `false`,
     * assigns `x` and `y`, and returns the member.
     *
     ...
     * Unless a new member is created, `key`, `frame`, and `visible` are ignored.
     *
     * @method Vsengine.GameObjects.Group#get
     * @since 3.0.0
     *
     * @param {number} [x] - The horizontal position of the Game Object in the world.
     * @param {number} [y] - The vertical position of the Game Object in the world.
    ...
    /**
     * Scans the group for the first member that has an {@link Vsengine.GameObjects.GameObject#active} state set to `true`,
     * assigns `x` and `y`, and returns the member.
     *
     * If no active member is found and `createIfNull` is `true` and the group isn't full then it will create a new one using `x`, `y`, `key`, `frame`, and `visible`.
     * Unless a new member is created, `key`, `frame`, and `visible` are ignored.
     *
     * @method Vsengine.GameObjects.Group#getFirstAlive
     * @since 3.0.0
     *
     * @param {boolean} [createIfNull=false] - Create a new Game Object if no matching members are found, using the following arguments.
     * @param {number} [x] - The horizontal position of the Game Object in the world.
     ...
     * Unless a new member is created, `key`, `frame`, and `visible` are ignored.
     *
     * @method Vsengine.GameObjects.Group#getFirstDead
     * @since 3.0.0
     *
     * @param {boolean} [createIfNull=false] - Create a new Game Object if no matching members are found, using the following arguments.
     * @param {number} [x] - The horizontal position of the Game Object in the world.
    ...
    /**
     * {@link Vsengine.GameObjects.Components.Animation#play Plays} an animation for all members of this group.
     *
     * @method Vsengine.GameObjects.Group#playAnimation
     * @since 3.0.0
     *
    ...
    /**
     * Whether this group's size at its {@link Vsengine.GameObjects.Group#maxSize maximum}.
     *
     * @method Vsengine.GameObjects.Group#isFull
     * @since 3.0.0
     *
     * @return {boolean} True if the number of members equals {@link Vsengine.GameObjects.Group#maxSize}.
     */
    isFull: function () {
        if (this.maxSize === -1) {
            return false;
     ...
     *
     * @method Vsengine.GameObjects.Group#countActive
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#getTotalUsed
     * @since 3.0.0
     *
    ...
    /**
     * The difference of {@link Vsengine.GameObjects.Group#maxSize} and the number of active group members.
     *
     * This represents the number of group members that could be created or reactivated before reaching the size limit.
     *
     * @method Vsengine.GameObjects.Group#getTotalFree
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#setActive
     * @since 3.24.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#setName
     * @since 3.24.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#propertyValueSet
     * @since 3.21.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#propertyValueInc
     * @since 3.21.0
     *
     * @param {string} key - The property to be updated.
     * @param {number} value - The amount to set the property to.
     ...
     *
     * @method Vsengine.GameObjects.Group#setX
     * @since 3.21.0
     *
     * @param {number} value - The amount to set the property to.
     * @param {number} [step=0] - This is added to the `value` amount, multiplied by the iteration counter.
     ...
     *
     * @method Vsengine.GameObjects.Group#setY
     * @since 3.21.0
     *
     * @param {number} value - The amount to set the property to.
     * @param {number} [step=0] - This is added to the `value` amount, multiplied by the iteration counter.
     ...
     *
     * @method Vsengine.GameObjects.Group#setXY
     * @since 3.21.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#incX
     * @since 3.21.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#incY
     * @since 3.21.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#incXY
     * @since 3.21.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#shiftPosition
     * @since 3.21.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#angle
     * @since 3.21.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#rotate
     * @since 3.21.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#rotateAround
     * @since 3.21.0
     *
     * @param {Vsengine.Types.Math.Vector2Like} point - Any object with public `x` and `y` properties.
     ...
     *
     * @method Vsengine.GameObjects.Group#rotateAroundDistance
     * @since 3.21.0
     *
     * @param {Vsengine.Types.Math.Vector2Like} point - Any object with public `x` and `y` properties.
     * @param {number} angle - The angle to rotate by, in radians.
     ...
     *
     * @method Vsengine.GameObjects.Group#setAlpha
     * @since 3.21.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#setTint
     * @since 3.21.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#setOrigin
     * @since 3.21.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#scaleX
     * @since 3.21.0
     *
     * @param {number} value - The amount to set the property to.
     * @param {number} [step=0] - This is added to the `value` amount, multiplied by the iteration counter.
     ...
     *
     * @method Vsengine.GameObjects.Group#scaleY
     * @since 3.21.0
     *
     * @param {number} value - The amount to set the property to.
     * @param {number} [step=0] - This is added to the `value` amount, multiplied by the iteration counter.
     ...
     *
     * @method Vsengine.GameObjects.Group#scaleXY
     * @since 3.21.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#setDepth
     * @since 3.0.0
     *
     * @param {number} value - The amount to set the property to.
     * @param {number} [step=0] - This is added to the `value` amount, multiplied by the iteration counter.
     ...
     *
     * @method Vsengine.GameObjects.Group#setBlendMode
     * @since 3.21.0
     *
     * @param {number} value - The amount to set the property to.
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#setHitArea
     * @since 3.21.0
     *
     * @param {*} hitArea - Either an input configuration object, or a geometric shape that defines the hit area for the Game Object. If not specified a Rectangle will be used.
     * @param {Vsengine.Types.Input.HitAreaCallback} hitAreaCallback - A callback to be invoked when the Game Object is interacted with. If you provide a shape you must also provide a callback.
     *
     * @return {this} This Group object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Group#shuffle
     * @since 3.21.0
     *
     * @return {this} This Group object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Group#kill
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - A member of this group.
     */
     ...
     *
     * @method Vsengine.GameObjects.Group#killAndHide
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - A member of this group.
     */
     ...
     *
     * @method Vsengine.GameObjects.Group#setVisible
     * @since 3.21.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Group#toggleVisible
     * @since 3.0.0
     *
     * @return {this} This Group object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Group#destroy
     * @since 3.0.0
     *
     * @param {boolean} [destroyChildren=false] - Also {@link Vsengine.GameObjects.GameObject#destroy} each Group member.
     * @param {boolean} [removeFromScene=false] - Optionally remove each Group member from the Scene.
     */
