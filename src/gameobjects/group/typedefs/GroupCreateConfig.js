 ...
 *
 * `key` is required. {@link Vsengine.GameObjects.Group#defaultKey} is not used.
 *
 * @typedef {object} Vsengine.Types.GameObjects.Group.GroupCreateConfig
 * @since 3.0.0
 *
 ...
 * @property {?Vsengine.Types.Input.HitAreaCallback} [hitAreaCallback] - A callback to be invoked when the Game Object is interacted with.
 * @property {?(false|Vsengine.Types.Actions.GridAlignConfig)} [gridAlign=false] - Align the new Game Objects in a grid using these settings.
 *
 * @see Vsengine.Actions.GridAlign
 * @see Vsengine.Actions.SetAlpha
 * @see Vsengine.Actions.SetHitArea
 * @see Vsengine.Actions.SetRotation
 * @see Vsengine.Actions.SetScale
 * @see Vsengine.Actions.SetXY
 * @see Vsengine.Actions.SetDepth
 * @see Vsengine.Actions.SetScrollFactor
 * @see Vsengine.GameObjects.Group#createFromConfig
 * @see Vsengine.Utils.Array.Range
 */
