 ...
 *
 * Note: This method will only be available if the Plane Game Object has been built into Vsengine.
 *
 * @method Vsengine.GameObjects.GameObjectFactory#plane
 * @since 3.60.0
 *
 ...
 *
 * @return {Vsengine.GameObjects.Plane} The Plane Game Object that was created.
 */
GameObjectFactory.register(
    "plane",
    function (x, y, texture, frame, width, height, tile) {
        return this.displayList.add(
            new Plane(this.scene, x, y, texture, frame, width, height, tile)
        );
    }
);
