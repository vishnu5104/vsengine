 ...
 *
 * @class Plane
 * @extends Vsengine.GameObjects.Mesh
 * @memberof Vsengine.GameObjects
 * @constructor
 * @since 3.60.0
 *
 * @param {Vsengine.Scene} scene - The Scene to which this Plane belongs. A Plane can only belong to one Scene at a time.
 ...
 * @param {string|Vsengine.Textures.Texture} [texture] - The key, or instance of the Texture this Plane will use to render with, as stored in the Texture Manager.
...
var Plane = new Class({
    ...
    initialize: function Plane(
         ...
         *
         * @name Vsengine.GameObjects.Plane#anims
         ...
         *
         * @name Vsengine.GameObjects.Plane#gridWidth
         * @type {number}
         * @readonly
         * @since 3.60.0
         */
         ...
         * This value is read-only. To adjust it, see the `setGridSize` method.
         *
         * @name Vsengine.GameObjects.Plane#gridHeight
         * @type {number}
         * @readonly
         * @since 3.60.0
         */
         ...
         * This value is read-only. To adjust it, see the `setGridSize` method.
         *
         * @name Vsengine.GameObjects.Plane#isTiled
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Plane#_checkerboard
         * @type {?WebGLTexture}
         * @private
         * @since 3.60.0
         */
     ...
     *
     * @name Vsengine.GameObjects.Plane#originX
     * @type {number}
     * @readonly
     * @override
     * @since 3.70.0
     ...
     * Do not change this value. It has no effect other than to break things.
     *
     * @name Vsengine.GameObjects.Plane#originY
     * @type {number}
     * @readonly
     * @override
     * @since 3.70.0
     ...
     *
     * @method Vsengine.GameObjects.Plane#preDestroy
     * @since 3.60.0
     *
     * @param {number} [width=8] - The width of this Plane, in cells, not pixels.
     * @param {number} [height=8] - The height of this Plane, in cells, not pixels.
     ...
     * if required.
     *
     * @method Vsengine.GameObjects.Plane#setSizeToFrame
     * @since 3.60.0
     * @override
     *
     ...
     *
     * @method Vsengine.GameObjects.Plane#setViewHeight
     * @since 3.60.0
     *
     ...
     * your game.
     *
     * @method Vsengine.GameObjects.Plane#createCheckerboard
     * @since 3.60.0
     *
    ...
    createCheckerboard: function (color1, color2, alpha1, alpha2, height) {
        ...
        var texture = this.scene.sys.textures.addUint8Array(
            UUID(),
     ...
     *
     * @method Vsengine.GameObjects.Plane#removeCheckerboard
     * @since 3.60.0
     */
     ...
     *
     * Animations in Vsengine can either belong to the global Animation Manager, or specifically to this Plane.
     *
     ...
     *
     * @method Vsengine.GameObjects.Plane#play
     ...
     *
     * Animations in Vsengine can either belong to the global Animation Manager, or specifically to a Game Object.
     *
     * The benefit of a global animation is that multiple Game Objects can all play the same animation, without
     * having to duplicate the data. You can just create it once and then play it on any animating Game Object.
     *
     ...
     * Also, see the documentation in the Animation Manager for further details on creating animations.
     *
     * @method Vsengine.GameObjects.Plane#playReverse
     * @fires Vsengine.Animations.Events#ANIMATION_START
     * @since 3.60.0
     *
     * @param {(string|Vsengine.Animations.Animation|Vsengine.Types.Animations.PlayAnimationConfig)} key - The string-based key of the animation to play, or an Animation instance, or a `PlayAnimationConfig` object.
     ...
     * search the global Animation Manager and look for it there.
     *
     * @method Vsengine.GameObjects.Plane#playAfterDelay
     * @fires Vsengine.Animations.Events#ANIMATION_START
     * @since 3.60.0
     *
     * @param {(string|Vsengine.Animations.Animation|Vsengine.Types.Animations.PlayAnimationConfig)} key - The string-based key of the animation to play, or an Animation instance, or a `PlayAnimationConfig` object.
     ...
     * search the global Animation Manager and look for it there.
     *
     * @method Vsengine.GameObjects.Plane#playAfterRepeat
     * @fires Vsengine.Animations.Events#ANIMATION_START
     * @since 3.60.0
     *
     * @param {(string|Vsengine.Animations.Animation|Vsengine.Types.Animations.PlayAnimationConfig)} key - The string-based key of the animation to play, or an Animation instance, or a `PlayAnimationConfig` object.
     ...
     *
     * @method Vsengine.GameObjects.Plane#stop
     ...
     *
     * @method Vsengine.GameObjects.Plane#stopAfterDelay
     * @fires Vsengine.Animations.Events#ANIMATION_STOP
     * @since 3.60.0
     *
     ...
     * when the current one stops.
     *
     * @method Vsengine.GameObjects.Plane#stopAfterRepeat
     * @fires Vsengine.Animations.Events#ANIMATION_STOP
     * @since 3.60.0
     *
     ...
     * when the current one stops.
     *
     * @method Vsengine.GameObjects.Plane#stopOnFrame
     * @fires Vsengine.Animations.Events#ANIMATION_STOP
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Plane#preUpdate
     * @protected
     * @since 3.60.0
     *
