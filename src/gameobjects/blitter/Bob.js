 ...
 * @since 3.0.0
 *
 * @param {Vsengine.GameObjects.Blitter} blitter - The parent Blitter object is responsible for updating this Bob.
...
var Bob = new Class({
    initialize: function Bob(blitter, x, y, frame, visible) {
         ...
         *
         * @name Vsengine.GameObjects.Bob#parent
         * @type {Vsengine.GameObjects.Blitter}
         * @since 3.0.0
         */
        this.parent = blitter;
         ...
         *
         * @name Vsengine.GameObjects.Bob#x
         * @type {number}
         * @since 3.0.0
         */
        this.x = x;
         ...
         *
         * @name Vsengine.GameObjects.Bob#y
         * @type {number}
         * @since 3.0.0
         */
        this.y = y;
         ...
         *
         * @name Vsengine.GameObjects.Bob#frame
         ...
         *
         * @name Vsengine.GameObjects.Bob#data
         * @type {object}
         * @default {}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Bob#tint
         * @type {number}
         * @default 0xffffff
         * @since 3.20.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Bob#_visible
         * @type {boolean}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Bob#_alpha
         * @type {number}
         * @private
         * @default 1
         * @since 3.0.0
         ...
         *
         * @name Vsengine.GameObjects.Bob#flipX
         * @type {boolean}
         * @since 3.0.0
         */
        this.flipX = false;
         ...
         * Flipping always takes place from the middle of the texture.
         *
         * @name Vsengine.GameObjects.Bob#flipY
         * @type {boolean}
         * @since 3.0.0
         */
        this.flipY = false;
         ...
         *
         * @name Vsengine.GameObjects.Bob#hasTransformComponent
         * @type {boolean}
         * @private
         * @readonly
         * @since 3.60.0
     ...
     *
     * @method Vsengine.GameObjects.Bob#setFrame
     * @since 3.0.0
     *
     * @param {(string|number|Vsengine.Textures.Frame)} [frame] - The frame to be used during rendering.
     *
     ...
     *
     * @method Vsengine.GameObjects.Bob#resetFlip
     * @since 3.0.0
     *
     * @return {this} This Bob Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Bob#reset
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Bob#setPosition
     * @since 3.20.0
     *
     * @param {number} x - The x position of the Bob. Bob coordinate are relative to the position of the Blitter object.
     * @param {number} y - The y position of the Bob. Bob coordinate are relative to the position of the Blitter object.
     ...
     *
     * @method Vsengine.GameObjects.Bob#setFlipX
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Bob#setFlipY
     * @since 3.0.0
     *
     * @param {boolean} value - The flipped state. `false` for no flip, or `true` to be flipped.
     *
     ...
     *
     * @method Vsengine.GameObjects.Bob#setFlip
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Bob#setVisible
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Bob#setAlpha
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Bob#setTint
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Bob#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.parent.dirty = true;
     ...
     * An invisible Bob will skip rendering.
     *
     * @name Vsengine.GameObjects.Bob#visible
     * @type {boolean}
     * @since 3.0.0
     */
    visible: {
     ...
     * A Bob with alpha 0 will skip rendering.
     *
     * @name Vsengine.GameObjects.Bob#alpha
     * @type {number}
     * @since 3.0.0
     */
    alpha: {
