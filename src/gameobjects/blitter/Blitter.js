 ...
 *
 * @param {Vsengine.GameObjects.Bob} bob - The Bob that was created by the Blitter.
...
var Blitter = new Class({
    ...
    initialize: function Blitter(scene, x, y, texture, frame) {
         ...
         *
         * @name Vsengine.GameObjects.Blitter#children
         * @type {Vsengine.Structs.List.<Vsengine.GameObjects.Bob>}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Blitter#renderList
         * @type {Vsengine.GameObjects.Bob[]}
         * @default []
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Blitter#dirty
         * @type {boolean}
         * @since 3.0.0
         */
        this.dirty = false;
     ...
     *
     * @method Vsengine.GameObjects.Blitter#create
     * @since 3.0.0
     *
     * @param {number} x - The x position of the Bob. Bob coordinate are relative to the position of the Blitter object.
     * @param {number} y - The y position of the Bob. Bob coordinate are relative to the position of the Blitter object.
     * @param {(string|number|Vsengine.Textures.Frame)} [frame] - The Frame the Bob will use. It _must_ be part of the Texture the parent Blitter object is using.
     ...
     *
     * @return {Vsengine.GameObjects.Bob} The newly created Bob object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Blitter#createFromCallback
     * @since 3.0.0
     *
     ...
     * @param {(string|number|Vsengine.Textures.Frame|string[]|number[]|Vsengine.Textures.Frame[])} [frame] - The Frame the Bobs will use. It must be part of the Blitter Texture.
     * @param {boolean} [visible=true] - Should the created Bob render or not?
     *
     * @return {Vsengine.GameObjects.Bob[]} An array of Bob objects that were created.
     */
     ...
     *
     * @method Vsengine.GameObjects.Blitter#createMultiple
     * @since 3.0.0
     *
     * @param {number} quantity - The quantity of Bob objects to create.
     * @param {(string|number|Vsengine.Textures.Frame|string[]|number[]|Vsengine.Textures.Frame[])} [frame] - The Frame the Bobs will use. It must be part of the Blitter Texture.
     ...
     *
     * @method Vsengine.GameObjects.Blitter#childCanRender
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.Bob} child - The Bob to check for rendering.
     *
     ...
     *
     * @method Vsengine.GameObjects.Blitter#getRenderList
     * @since 3.0.0
     *
     * @return {Vsengine.GameObjects.Bob[]} An array of Bob objects that will be rendered this frame.
     */
     ...
     *
     * @method Vsengine.GameObjects.Blitter#clear
     * @since 3.0.0
     */
    clear: function () {
     ...
     *
     * @method Vsengine.GameObjects.Blitter#preDestroy
     * @protected
     * @since 3.9.0
     */
    preDestroy: function () {
