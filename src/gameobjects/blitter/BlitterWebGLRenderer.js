 ...
 *
 * @method Vsengine.GameObjects.Blitter#renderWebGL
 * @since 3.0.0
 * @private
 *
 * @param {Vsengine.Renderer.WebGL.WebGLRenderer} renderer - A reference to the current active WebGL renderer.
 * @param {Vsengine.GameObjects.Blitter} src - The Game Object being rendered in this call.
