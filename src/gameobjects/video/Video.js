 ...
 *
 * You can optionally 'preload' the video into the Vsengine Video Cache:
 *
 * ```javascript
 * preload () {
 ...
 * ```
 *
 * The 3rd parameter in the load call tells Vsengine that the video doesn't contain any audio tracks. Video without
 ...
 * @extends Vsengine.GameObjects.Components.ComputedSize
...
var Video = new Class({
    ...
    initialize: function Video(scene, x, y, key) {
         ...
         *
         * @name Vsengine.GameObjects.Video#video
        ...
        /**
         * The Vsengine Texture this Game Object is using to render the video to.
         *
         * Will be `undefined` until a video is loaded for playback.
         *
         * @name Vsengine.GameObjects.Video#videoTexture
         ...
         * Will be `undefined` until a video is loaded for playback.
         *
         * @name Vsengine.GameObjects.Video#videoTextureSource
         * @type {?Vsengine.Textures.TextureSource}
         * @since 3.20.0
         */
        this.videoTextureSource;

        /**
         * A Vsengine `CanvasTexture` instance that holds the most recent snapshot taken from the video.
         *
         ...
         *
         * @name Vsengine.GameObjects.Video#snapshotTexture
         * @type {?Vsengine.Textures.CanvasTexture}
         * @since 3.20.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#flipY
         * @type {boolean}
         * @since 3.20.0
         */
        this.flipY = false;
         ...
         *
         * @name Vsengine.GameObjects.Video#_key
         * @type {string}
         * @private
         * @since 3.20.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#touchLocked
         * @type {boolean}
         * @readonly
         * @since 3.20.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#playWhenUnlocked
         * @type {boolean}
         * @since 3.20.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#frameReady
         * @type {boolean}
         * @since 3.60.0
         */
         ...
         *
         * Listen for the Vsengine Event `VIDEO_STALLED` to be notified and inspect the event
         ...
         *
         * @name Vsengine.GameObjects.Video#isStalled
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#failedPlayAttempts
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#metadata
         ...
         *
         * @name Vsengine.GameObjects.Video#retry
         * @type {number}
         * @since 3.20.0
         */
        this.retry = 0;
         ...
         *
         * @name Vsengine.GameObjects.Video#retryInterval
         * @type {number}
         * @since 3.20.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#_systemMuted
         * @type {boolean}
         * @private
         * @since 3.20.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#_codeMuted
         * @type {boolean}
         * @private
         * @since 3.20.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#_systemPaused
         * @type {boolean}
         * @private
         * @since 3.20.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#_codePaused
         * @type {boolean}
         * @private
         * @since 3.20.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#_callbacks
         * @type {any}
         * @private
         * @since 3.20.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#_loadCallbackHandler
         * @type {function}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#_metadataCallbackHandler
         * @type {function}
         * @private
         * @since 3.80.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#_crop
         * @type {object}
         * @private
         * @since 3.20.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#markers
         * @type {any}
         * @since 3.20.0
         */
        this.markers = {};
         ...
         * The in marker.
         *
         * @name Vsengine.GameObjects.Video#_markerIn
         * @type {number}
         * @private
         * @since 3.20.0
         */
         ...
         * The out marker.
         *
         * @name Vsengine.GameObjects.Video#_markerOut
         * @type {number}
         * @private
         * @since 3.20.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#_playingMarker
         * @type {boolean}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#_lastUpdate
         * @type {number}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#cacheKey
         * @type {string}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#isSeeking
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#_playCalled
         * @type {boolean}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#_getFrame
         * @type {boolean}
         * @private
         * @since 3.85.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#_rfvCallbackId
         * @type {number}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Video#_device
         * @type {string[]}
         * @private
         * @since 3.60.0
         */
     ...
     *
     * @method Vsengine.GameObjects.Video#load
     * @since 3.60.0
     *
     ...
     * go through the unlock process again.
     *
     * @method Vsengine.GameObjects.Video#changeSource
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#getVideoKey
     * @since 3.20.0
     *
     ...
     * go through the unlock process again.
     *
     * @method Vsengine.GameObjects.Video#loadURL
     * @since 3.60.0
     *
     * @param {(string|string[]|Vsengine.Types.Loader.FileTypes.VideoFileURLConfig|Vsengine.Types.Loader.FileTypes.VideoFileURLConfig[])} [urls] - The absolute or relative URL to load the video files from.
     ...
     *
     * @method Vsengine.GameObjects.Video#loadMediaStream
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#loadHandler
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#requestVideoFrame
     * @fires Vsengine.GameObjects.Events#VIDEO_CREATED
     * @fires Vsengine.GameObjects.Events#VIDEO_LOOP
     * @fires Vsengine.GameObjects.Events#VIDEO_COMPLETE
     * @fires Vsengine.GameObjects.Events#VIDEO_PLAY
     * @fires Vsengine.GameObjects.Events#VIDEO_TEXTURE
     * @since 3.60.0
     *
    ...
    requestVideoFrame: function (now, metadata) {
        ...
        if (newVideo) {
            ...
            if (!texture) {
                texture = this.scene.sys.textures.create(
                    this._key,
                    video,
                    width,
                    height
        ...
        if (this._getFrame) {
            ...
            this._rfvCallbackId = this.video.requestVideoFrameCallback(
                this.requestVideoFrame.bind(this)
            );
        }
    },
     ...
     *
     * @method Vsengine.GameObjects.Video#play
     * @since 3.20.0
     *
     * @param {boolean} [loop=false] - Should the video loop automatically when it reaches the end? Please note that not all browsers support _seamless_ video looping for all encoding formats.
     * @param {number} [markerIn] - Optional in marker time, in seconds, for playback of a sequence of the video.
    ...
    play: function (loop, markerIn, markerOut) {
        ...
        if (!this._playCalled) {
            ...
            this._rfvCallbackId = video.requestVideoFrameCallback(
                this.requestVideoFrame.bind(this)
            );
     ...
     * If the video is already playing, or has been queued to play with `changeSource` then this method just returns.
     *
     * @method Vsengine.GameObjects.Video#getFirstFrame
     * @since 3.85.0
     *
     * @return {this} This Video Game Object for method chaining.
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#addLoadEventHandlers
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#removeLoadEventHandlers
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#addEventHandlers
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#removeEventHandlers
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#createPlayPromise
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#addMarker
     * @since 3.20.0
     *
     ...
     * See https://github.com/w3c/media-and-entertainment/issues/4 for more details about this issue.
     *
     * @method Vsengine.GameObjects.Video#playMarker
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#removeMarker
     * @since 3.20.0
     *
     ...
     * multiple times will overwrite the previous snapshot with the most recent one.
     *
     * @method Vsengine.GameObjects.Video#snapshotArea
     * @since 3.20.0
     *
    ...
    snapshotArea: function (x, y, srcWidth, srcHeight, destWidth, destHeight) {
        ...
        if (!snap) {
            snap = this.scene.sys.textures.createCanvas(
                UUID(),
                destWidth,
                destHeight
            );
     ...
     *
     * @method Vsengine.GameObjects.Video#saveSnapshotTexture
     * @since 3.20.0
     *
     * @param {string} key - The unique key to store the texture as within the global Texture Manager.
     *
     * @return {Vsengine.Textures.CanvasTexture} The Texture that was saved.
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#playSuccess
     * @fires Vsengine.GameObjects.Events#VIDEO_UNLOCKED
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#playError
     * @fires Vsengine.GameObjects.Events#VIDEO_ERROR
     * @fires Vsengine.GameObjects.Events#VIDEO_UNSUPPORTED
     * @fires Vsengine.GameObjects.Events#VIDEO_LOCKED
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#legacyPlayHandler
     * @since 3.60.0
     */
     ...
     * Called when the video emits a `playing` event.
     *
     * @method Vsengine.GameObjects.Video#playingHandler
     * @fires Vsengine.GameObjects.Events#VIDEO_PLAYING
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#loadErrorHandler
     * @fires Vsengine.GameObjects.Events#VIDEO_ERROR
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#metadataHandler
     * @fires Vsengine.GameObjects.Events#VIDEO_METADATA
     * @since 3.80.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#setSizeToFrame
     * @since 3.0.0
     *
     * @param {Vsengine.Textures.Frame|boolean} [frame] - The frame to base the size of this Game Object on.
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#stalledHandler
     * @fires Vsengine.GameObjects.Events#VIDEO_STALLED
     * @since 3.60.0
     *
     * @param {Event} event - The error Event.
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#completeHandler
     * @fires Vsengine.GameObjects.Events#VIDEO_COMPLETE
     * @since 3.20.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#preUpdate
     * @private
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#seekTo
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#getCurrentTime
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#setCurrentTime
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#seekingHandler
     * @fires Vsengine.GameObjects.Events#VIDEO_SEEKING
     * @private
     * @since 3.20.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#seekedHandler
     * @fires Vsengine.GameObjects.Events#VIDEO_SEEKED
     * @private
     * @since 3.20.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#getProgress
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#getDuration
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#setMute
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#isMuted
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#globalMute
     * @private
     * @since 3.20.0
     *
     * @param {(Vsengine.Sound.WebAudioSoundManager|Vsengine.Sound.HTML5AudioSoundManager)} soundManager - A reference to the Sound Manager that emitted the event.
     ...
     *
     * @method Vsengine.GameObjects.Video#globalPause
     * @private
     * @since 3.20.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#globalResume
     * @private
     * @since 3.20.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#setPaused
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#pause
     * @since 3.60.0
     *
     * @return {this} This Video Game Object for method chaining.
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#resume
     * @since 3.60.0
     *
     * @return {this} This Video Game Object for method chaining.
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#getVolume
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#setVolume
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#getPlaybackRate
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#setPlaybackRate
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#getLoop
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#setLoop
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#isPlaying
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#isPaused
     * @since 3.20.0
     *
    ...
    isPaused: function () {
        return (
            (this.video && this._playCalled && this.video.paused) ||
            this._codePaused ||
            this._systemPaused
        );
    },
     ...
     *
     * @method Vsengine.GameObjects.Video#saveTexture
     * @since 3.20.0
     *
     * @param {string} key - The unique key to store the texture as within the global Texture Manager.
     ...
     *
     * @method Vsengine.GameObjects.Video#stop
     * @fires Vsengine.GameObjects.Events#VIDEO_STOP
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Video#removeVideoElement
     * @since 3.20.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Video#preDestroy
     * @private
     * @since 3.21.0
     */
    preDestroy: function () {
