 ...
 *
 * Note: This method will only be available if the Render Texture Game Object has been built into Vsengine.
 *
 ...
 *
 * @method Vsengine.GameObjects.GameObjectCreator#renderTexture
 * @since 3.2.0
 *
 * @param {Vsengine.Types.GameObjects.RenderTexture.RenderTextureConfig} config - The configuration object this Game Object will use to create itself.
 * @param {boolean} [addToScene] - Add this Game Object to the Scene after creating it? If set this argument overrides the `add` property in the config object.
 *
 * @return {Vsengine.GameObjects.RenderTexture} The Game Object that was created.
 */
