 ...
 *
 * In versions of Vsengine before 3.60 a Render Texture was the only way you could create a texture
...
var RenderTexture = new Class({
    ...
    initialize: function RenderTexture(scene, x, y, width, height) {
         ...
         *
         * @name Vsengine.GameObjects.RenderTexture#camera
         ...
         *
         * @name Vsengine.GameObjects.RenderTexture#_saved
         * @type {boolean}
         * @private
         * @since 3.12.0
         */
     ...
     *
     * @method Vsengine.GameObjects.RenderTexture#setSize
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.RenderTexture#resize
     * @since 3.10.0
     *
     ...
     *
     * @method Vsengine.GameObjects.RenderTexture#saveTexture
     * @since 3.12.0
     *
     * @param {string} key - The unique key to store the texture as within the global Texture Manager.
     *
     * @return {Vsengine.Textures.DynamicTexture} The Texture that was saved.
     */
     ...
     *
     * @method Vsengine.GameObjects.RenderTexture#fill
     * @since 3.2.0
     *
     ...
     *
     * @method Vsengine.GameObjects.RenderTexture#clear
     * @since 3.2.0
     *
     * @return {this} This Render Texture instance.
     */
     ...
     *
     * @method Vsengine.GameObjects.RenderTexture#stamp
     * @since 3.60.0
     *
     ...
     * separate calls.
     *
     * @method Vsengine.GameObjects.RenderTexture#erase
     * @since 3.16.0
     *
     ...
     * separate calls.
     *
     * @method Vsengine.GameObjects.RenderTexture#draw
     * @since 3.2.0
     *
     ...
     *
     * @method Vsengine.GameObjects.RenderTexture#drawFrame
     * @since 3.12.0
     *
     * @param {string} key - The key of the texture to be used, as stored in the Texture Manager.
     * @param {(string|number)} [frame] - The name or index of the frame within the Texture. Set to `null` to skip this argument if not required.
     ...
     *
     * @method Vsengine.GameObjects.RenderTexture#repeat
     * @since 3.60.0
     *
     * @param {string} key - The key of the texture to be used, as stored in the Texture Manager.
     * @param {(string|number)} [frame] - The name or index of the frame within the Texture. Set to `null` to skip this argument if not required.
     ...
     *
     * @method Vsengine.GameObjects.RenderTexture#beginDraw
     * @since 3.50.0
     *
     * @return {this} This Render Texture instance.
     */
     ...
     * Game Objects use their own alpha and tint values when being drawn.
     *
     * @method Vsengine.GameObjects.RenderTexture#batchDraw
     * @since 3.50.0
     *
     ...
     * before it is drawn.
     *
     * @method Vsengine.GameObjects.RenderTexture#batchDrawFrame
     * @since 3.50.0
     *
     * @param {string} key - The key of the texture to be used, as stored in the Texture Manager.
     ...
     * currently open, or not.
     *
     * @method Vsengine.GameObjects.RenderTexture#endDraw
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.RenderTexture#snapshotArea
     * @since 3.19.0
     *
     ...
     * the larger the resolution this Render Texture has, so please be careful how you employ this in your game.
     *
     * @method Vsengine.GameObjects.RenderTexture#snapshot
     * @since 3.19.0
     *
     * @param {Vsengine.Types.Renderer.Snapshot.SnapshotCallback} callback - The Function to invoke after the snapshot image is created.
     * @param {string} [type='image/png'] - The format of the image to create, usually `image/png` or `image/jpeg`.
     ...
     *
     * @method Vsengine.GameObjects.RenderTexture#snapshotPixel
     * @since 3.19.0
     *
     ...
     *
     * @method Vsengine.GameObjects.RenderTexture#preDestroy
     * @protected
     * @since 3.9.0
     */
    preDestroy: function () {
