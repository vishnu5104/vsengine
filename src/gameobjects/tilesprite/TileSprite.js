...
var TileSprite = new Class({
    ...
    initialize: function TileSprite(
        scene,
        x,
        y,
        width,
         ...
         *
         * @name Vsengine.GameObjects.TileSprite#_tilePosition
         ...
         *
         * @name Vsengine.GameObjects.TileSprite#_tileScale
         * @type {Vsengine.Math.Vector2}
         * @private
         * @since 3.12.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TileSprite#dirty
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TileSprite#renderer
         ...
         *
         * @name Vsengine.GameObjects.TileSprite#canvas
         ...
         * Only used in Canvas mode.
         *
         * @name Vsengine.GameObjects.TileSprite#context
         ...
         *
         * @name Vsengine.GameObjects.TileSprite#displayTexture
         * @type {Vsengine.Textures.Texture|Vsengine.Textures.CanvasTexture}
         * @private
         * @since 3.12.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TileSprite#displayFrame
         ...
         *
         * @name Vsengine.GameObjects.TileSprite#_crop
         * @type {object}
         * @private
         * @since 3.12.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TileSprite#_textureKey
         * @type {string}
         * @private
         * @since 3.80.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TileSprite#texture
         * @type {Vsengine.Textures.Texture|Vsengine.Textures.CanvasTexture}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TileSprite#frame
         * @type {Vsengine.Textures.Frame}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TileSprite#potWidth
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TileSprite#potHeight
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TileSprite#fillCanvas
         * @type {HTMLCanvasElement}
         * @since 3.12.0
         */
        this.fillCanvas = CanvasPool.create2D(
            this,
            this.potWidth,
            this.potHeight
        );
         ...
         *
         * @name Vsengine.GameObjects.TileSprite#fillContext
         * @type {CanvasRenderingContext2D}
         * @since 3.12.0
         */
         ...
         *
         * @name Vsengine.GameObjects.TileSprite#fillPattern
         * @type {?(Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper|CanvasPattern)}
         * @since 3.12.0
         */
     ...
     *
     * @method Vsengine.GameObjects.TileSprite#setTexture
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TileSprite#setFrame
     * @since 3.0.0
     *
     * @param {(string|number)} frame - The name or index of the frame within the Texture.
     *
    ...
    /**
     * Sets {@link Vsengine.GameObjects.TileSprite#tilePositionX} and {@link Vsengine.GameObjects.TileSprite#tilePositionY}.
     *
     * @method Vsengine.GameObjects.TileSprite#setTilePosition
     * @since 3.3.0
     *
    ...
    /**
     * Sets {@link Vsengine.GameObjects.TileSprite#tileScaleX} and {@link Vsengine.GameObjects.TileSprite#tileScaleY}.
     *
     * @method Vsengine.GameObjects.TileSprite#setTileScale
     * @since 3.12.0
     *
     ...
     *
     * @method Vsengine.GameObjects.TileSprite#updateTileTexture
     * @private
     * @since 3.0.0
     */
    updateTileTexture: function () {
        ...
        if (this.renderer && this.renderer.gl) {
            this.fillPattern = this.renderer.canvasToTexture(
                canvas,
                this.fillPattern
            );

            if (typeof WEBGL_DEBUG) {
                this.fillPattern.spectorMetadata = {
                    textureKey: "TileSprite Game Object",
                };
            }
        } else {
     ...
     *
     * @method Vsengine.GameObjects.TileSprite#updateCanvas
     * @private
     * @since 3.12.0
     */
     ...
     *
     * @method Vsengine.GameObjects.TileSprite#preDestroy
     * @protected
     * @since 3.9.0
     */
    preDestroy: function () {
     ...
     *
     * @name Vsengine.GameObjects.TileSprite#tilePositionX
     * @type {number}
     * @default 0
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.GameObjects.TileSprite#tilePositionY
     * @type {number}
     * @default 0
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.GameObjects.TileSprite#tileScaleX
     * @type {number}
     * @default 1
     * @since 3.11.0
     */
     ...
     *
     * @name Vsengine.GameObjects.TileSprite#tileScaleY
     * @type {number}
     * @default 1
     * @since 3.11.0
     */
