/**
 * @typedef {object} Vsengine.Types.GameObjects.TileSprite.TileSpriteConfig
 ...
 * @property {(number|string|Vsengine.Textures.Frame)} [frame=''] - An optional frame from the Texture this Tile Sprite is rendering with.
 */
