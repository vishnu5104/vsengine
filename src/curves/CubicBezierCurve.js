 ...
 * @since 3.0.0
 *
 * @param {(Vsengine.Math.Vector2|Vsengine.Math.Vector2[])} p0 - Start point, or an array of point pairs.
 * @param {Vsengine.Math.Vector2} p1 - Control Point 1.
 * @param {Vsengine.Math.Vector2} p2 - Control Point 2.
 * @param {Vsengine.Math.Vector2} p3 - End Point.
 */
var CubicBezierCurve = new Class({
    ...
    initialize: function CubicBezierCurve(p0, p1, p2, p3) {
         ...
         *
         * @name Vsengine.Curves.CubicBezier#p0
         ...
         *
         * @name Vsengine.Curves.CubicBezier#p1
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         */
        this.p1 = p1;
         ...
         *
         * @name Vsengine.Curves.CubicBezier#p2
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         */
        this.p2 = p2;
         ...
         *
         * @name Vsengine.Curves.CubicBezier#p3
         * @type {Vsengine.Math.Vector2}
         * @since 3.0.0
         */
        this.p3 = p3;
     ...
     *
     * @method Vsengine.Curves.CubicBezier#getStartPoint
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.CubicBezier#getResolution
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.CubicBezier#getPoint
     * @since 3.0.0
     *
     * @generic {Vsengine.Math.Vector2} O - [out,$return]
     *
     ...
     *
     * @method Vsengine.Curves.CubicBezier#draw
     * @since 3.0.0
     *
     * @generic {Vsengine.GameObjects.Graphics} G - [graphics,$return]
     *
     * @param {Vsengine.GameObjects.Graphics} graphics - The graphics object this curve should be drawn to.
     ...
     *
     * @return {Vsengine.GameObjects.Graphics} The graphics object this curve was drawn to. Useful for method chaining.
     */
     ...
     *
     * @method Vsengine.Curves.CubicBezier#toJSON
     * @since 3.0.0
     *
 ...
 *
 * @function Vsengine.Curves.CubicBezier.fromJSON
 * @since 3.0.0
 *
 * @param {Vsengine.Types.Curves.JSONCurve} data - The JSON object containing this curve data.
 *
 * @return {Vsengine.Curves.CubicBezier} The curve generated from the JSON object.
 */
