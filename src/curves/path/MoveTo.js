...
var MoveTo = new Class({
    initialize: function MoveTo(x, y) {
         ...
         *
         * @name Vsengine.Curves.MoveTo#active
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Curves.MoveTo#p0
     ...
     *
     * @method Vsengine.Curves.MoveTo#getPoint
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.MoveTo#getPointAt
     * @since 3.0.0
     *
     * @generic {Vsengine.Math.Vector2} O - [out,$return]
     *
     * @param {number} u - The position in the path to retrieve, between 0 and 1. Not used.
     * @param {Vsengine.Math.Vector2} [out] - An optional vector in which to store the point.
     *
     * @return {Vsengine.Math.Vector2} The modified `out` vector, or a new `Vector2` if none was provided.
     */
     ...
     *
     * @method Vsengine.Curves.MoveTo#getResolution
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.MoveTo#getLength
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.MoveTo#toJSON
     * @since 3.0.0
     *
     * @return {Vsengine.Types.Curves.JSONCurve} A primitive object with the curve's type and only point.
     */
    toJSON: function () {
        return {
            type: "MoveTo",
