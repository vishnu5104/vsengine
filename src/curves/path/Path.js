 ...
 * @since 3.0.0
 *
 * @param {number} [x=0] - The X coordinate of the Path's starting point or a {@link Vsengine.Types.Curves.JSONPath}.
...
var Path = new Class({
    initialize: function Path(x, y) {
         ...
         *
         * @name Vsengine.Curves.Path#name
         * @type {string}
         * @default ''
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Curves.Path#defaultDivisions
         * @type {number}
         * @default 12
         * @since 3.70.0
         */
         ...
         *
         * @name Vsengine.Curves.Path#curves
         * @type {Vsengine.Curves.Curve[]}
         * @default []
         * @since 3.0.0
         */
        this.curves = [];
         ...
         *
         * @name Vsengine.Curves.Path#cacheLengths
         * @type {number[]}
         * @default []
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Curves.Path#autoClose
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Curves.Path#startPoint
         ...
         *
         * @name Vsengine.Curves.Path#_tmpVec2A
         * @type {Vsengine.Math.Vector2}
         * @private
         * @since 3.0.0
         */
         ...
         * A temporary vector used to avoid object creation when adding a Curve to the Path.
         *
         * @name Vsengine.Curves.Path#_tmpVec2B
         * @type {Vsengine.Math.Vector2}
         * @private
         * @since 3.0.0
         */
     ...
     *
     * @method Vsengine.Curves.Path#add
     * @since 3.0.0
     *
     * @param {Vsengine.Curves.Curve} curve - The Curve to append.
     *
     ...
     *
     * @method Vsengine.Curves.Path#circleTo
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Path#closePath
     * @since 3.0.0
     *
     * @return {this} This Path object.
     */
     ...
     *
     * @method Vsengine.Curves.Path#cubicBezierTo
     * @since 3.0.0
     *
     * @param {(number|Vsengine.Math.Vector2)} x - The x coordinate of the end point. Or, if a Vector2, the p1 value.
     * @param {(number|Vsengine.Math.Vector2)} y - The y coordinate of the end point. Or, if a Vector2, the p2 value.
     * @param {(number|Vsengine.Math.Vector2)} control1X - The x coordinate of the first control point. Or, if a Vector2, the p3 value.
     ...
     *
     * @method Vsengine.Curves.Path#quadraticBezierTo
     * @since 3.2.0
     *
     * @param {(number|Vsengine.Math.Vector2[])} x - The X coordinate of the second control point or, if it's a `Vector2`, the first control point.
     ...
     *
     * @method Vsengine.Curves.Path#draw
     * @since 3.0.0
     *
     * @generic {Vsengine.GameObjects.Graphics} G - [out,$return]
     *
     * @param {Vsengine.GameObjects.Graphics} graphics - The Graphics Game Object to draw to.
     ...
     *
     * @return {Vsengine.GameObjects.Graphics} The Graphics object which was drawn to.
     */
     ...
     *
     * @method Vsengine.Curves.Path#ellipseTo
     * @since 3.0.0
     *
     ...
     *
     * The provided object should be a {@link Vsengine.Types.Curves.JSONPath}, as returned by {@link #toJSON}. Providing a malformed object may cause errors.
     *
     * @method Vsengine.Curves.Path#fromJSON
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Curves.JSONPath} data - The JSON object containing the Path data.
     *
     * @return {this} This Path object.
     */
     ...
     *
     * @method Vsengine.Curves.Path#getBounds
     * @since 3.0.0
     *
     * @generic {Vsengine.Math.Vector2} O - [out,$return]
     *
     * @param {Vsengine.Geom.Rectangle} [out] - The Rectangle to store the bounds in.
     ...
     *
     * @return {Vsengine.Geom.Rectangle} The modified `out` Rectangle, or a new Rectangle if none was provided.
     */
     ...
     *
     * @method Vsengine.Curves.Path#getCurveLengths
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Path#getCurveAt
     * @since 3.60.0
     *
     * @param {number} t - The normalized location on the Path, between 0 and 1.
     *
     * @return {?Vsengine.Curves.Curve} The Curve that is part of this Path at a given location, or `null` if no curve was found.
     */
     ...
     *
     * @method Vsengine.Curves.Path#getEndPoint
     * @since 3.0.0
     *
     * @generic {Vsengine.Math.Vector2} O - [out,$return]
     *
     * @param {Vsengine.Math.Vector2} [out] - The object to store the point in.
     *
     * @return {Vsengine.Math.Vector2} The modified `out` object, or a new Vector2 if none was provided.
     */
     ...
     *
     * @method Vsengine.Curves.Path#getLength
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Path#getPoint
     * @since 3.0.0
     *
     * @generic {Vsengine.Math.Vector2} O - [out,$return]
     *
     * @param {number} t - The location of the point to return, between 0 and 1.
     * @param {Vsengine.Math.Vector2} [out] - The object in which to store the calculated point.
     *
     * @return {?Vsengine.Math.Vector2} The modified `out` object, or a new `Vector2` if none was provided.
     */
     ...
     *
     * @method Vsengine.Curves.Path#getPoints
     * @since 3.0.0
     *
     ...
     *
     * @return {Vsengine.Math.Vector2[]} An array of Vector2 objects that containing the points along the Path.
     */
     ...
     *
     * @method Vsengine.Curves.Path#getRandomPoint
     * @since 3.0.0
     *
     * @generic {Vsengine.Math.Vector2} O - [out,$return]
     *
     * @param {Vsengine.Math.Vector2} [out] - `Vector2` instance that should be used for storing the result. If `undefined` a new `Vector2` will be created.
     *
     * @return {Vsengine.Math.Vector2} The modified `out` object, or a new `Vector2` if none was provided.
     */
     ...
     *
     * @method Vsengine.Curves.Path#getSpacedPoints
     * @since 3.0.0
     *
     * @param {number} [divisions=40] - The amount of points to divide this Path into.
     *
     * @return {Vsengine.Math.Vector2[]} A list of the points this path was subdivided into.
     */
     ...
     *
     * @method Vsengine.Curves.Path#getStartPoint
     * @since 3.0.0
     *
     * @generic {Vsengine.Math.Vector2} O - [out,$return]
     *
     ...
     *
     * @method Vsengine.Curves.Path#getTangent
     * @since 3.23.0
     *
     * @generic {Vsengine.Math.Vector2} O - [out,$return]
     *
     ...
     *
     * @return {Vsengine.Math.Vector2} Vector approximating the tangent line at the point t (delta +/- 0.0001)
     */
     ...
     *
     * @method Vsengine.Curves.Path#lineTo
     * @since 3.0.0
     *
     * @param {(number|Vsengine.Math.Vector2|Vsengine.Types.Math.Vector2Like)} x - The X coordinate of the line's end point, or a `Vector2` / `Vector2Like` containing the entire end point.
    ...
    lineTo: function (x, y) {
        ...
        return this.add(
            new LineCurve([end.x, end.y, this._tmpVec2B.x, this._tmpVec2B.y])
        );
    },
     ...
     *
     * @method Vsengine.Curves.Path#splineTo
     * @since 3.0.0
     *
     * @param {Vsengine.Math.Vector2[]} points - The points the newly created spline curve should consist of.
     *
     * @return {this} This Path object.
     */
     ...
     *
     * @method Vsengine.Curves.Path#moveTo
     * @since 3.0.0
     *
     * @param {(number|Vsengine.Math.Vector2|Vsengine.Types.Math.Vector2Like)} x - The X coordinate of the position to move the path's end point to, or a `Vector2` / `Vector2Like` containing the entire new end point.
     ...
     *
     * @method Vsengine.Curves.Path#toJSON
     * @since 3.0.0
     *
     * @return {Vsengine.Types.Curves.JSONPath} The JSON object containing this path's data.
     */
    toJSON: function () {
        var out = [];
     ...
     *
     * @method Vsengine.Curves.Path#updateArcLengths
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Curves.Path#destroy
     * @since 3.0.0
     */
    destroy: function () {
 ...
 *
 * @method Vsengine.GameObjects.GameObjectFactory#path
 * @since 3.0.0
 *
 * @param {number} x - The horizontal position of this Path.
 * @param {number} y - The vertical position of this Path.
 *
 * @return {Vsengine.Curves.Path} The Path Object that was created.
 */
