 ...
 * @since 3.0.0
 *
 * @param {(number|Vsengine.Types.Curves.EllipseCurveConfig)} [x=0] - The x coordinate of the ellipse, or an Ellipse Curve configuration object.
...
var EllipseCurve = new Class({
    ...
    initialize: function EllipseCurve(
         ...
         *
         * @name Vsengine.Curves.Ellipse#p0
         ...
         *
         * @name Vsengine.Curves.Ellipse#_xRadius
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Curves.Ellipse#_yRadius
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Curves.Ellipse#_startAngle
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Curves.Ellipse#_endAngle
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Curves.Ellipse#_clockwise
         * @type {boolean}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Curves.Ellipse#_rotation
         * @type {number}
         * @private
         * @since 3.0.0
         */
     ...
     *
     * @method Vsengine.Curves.Ellipse#getStartPoint
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Ellipse#getResolution
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Ellipse#getPoint
     * @since 3.0.0
     *
     * @generic {Vsengine.Math.Vector2} O - [out,$return]
     *
     ...
     *
     * @method Vsengine.Curves.Ellipse#setXRadius
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Ellipse#setYRadius
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Ellipse#setWidth
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Ellipse#setHeight
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Ellipse#setStartAngle
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Ellipse#setEndAngle
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Ellipse#setClockwise
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Ellipse#setRotation
     * @since 3.0.0
     *
     ...
     *
     * @name Vsengine.Curves.Ellipse#x
     * @type {number}
     * @since 3.0.0
     */
    x: {
     ...
     *
     * @name Vsengine.Curves.Ellipse#y
     * @type {number}
     * @since 3.0.0
     */
    y: {
     ...
     * The horizontal radius of the ellipse.
     *
     * @name Vsengine.Curves.Ellipse#xRadius
     * @type {number}
     * @since 3.0.0
     */
    xRadius: {
     ...
     * The vertical radius of the ellipse.
     *
     * @name Vsengine.Curves.Ellipse#yRadius
     * @type {number}
     * @since 3.0.0
     */
    yRadius: {
     ...
     *
     * @name Vsengine.Curves.Ellipse#startAngle
     * @type {number}
     * @since 3.0.0
     */
    startAngle: {
     ...
     *
     * @name Vsengine.Curves.Ellipse#endAngle
     * @type {number}
     * @since 3.0.0
     */
    endAngle: {
     ...
     *
     * @name Vsengine.Curves.Ellipse#clockwise
     * @type {boolean}
     * @since 3.0.0
     */
    clockwise: {
     ...
     *
     * @name Vsengine.Curves.Ellipse#angle
     * @type {number}
     * @since 3.14.0
     */
    angle: {
     ...
     *
     * @name Vsengine.Curves.Ellipse#rotation
     * @type {number}
     * @since 3.0.0
     */
    rotation: {
     ...
     *
     * @method Vsengine.Curves.Ellipse#toJSON
     * @since 3.0.0
     *
     * @return {Vsengine.Types.Curves.JSONEllipseCurve} The JSON object containing this curve data.
     */
    toJSON: function () {
        return {
            type: this.type,
 ...
 *
 * @function Vsengine.Curves.Ellipse.fromJSON
 * @since 3.0.0
 *
 * @param {Vsengine.Types.Curves.JSONEllipseCurve} data - The JSON object containing this curve data.
 *
 * @return {Vsengine.Curves.Ellipse} The ellipse curve constructed from the configuration object.
 */
