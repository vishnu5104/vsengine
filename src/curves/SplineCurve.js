 ...
 * @since 3.0.0
 *
 * @param {(Vsengine.Math.Vector2[]|number[]|number[][])} [points] - The points that configure the curve.
 */
var SplineCurve = new Class({
    ...
    initialize: function SplineCurve(points) {
         ...
         *
         * @name Vsengine.Curves.Spline#points
     ...
     *
     * @method Vsengine.Curves.Spline#addPoints
     * @since 3.0.0
     *
     * @param {(Vsengine.Math.Vector2[]|number[]|number[][])} points - The points that configure the curve.
     *
     ...
     *
     * @method Vsengine.Curves.Spline#addPoint
     * @since 3.0.0
     *
     * @param {number} x - The x coordinate of this curve
     * @param {number} y - The y coordinate of this curve
     *
     * @return {Vsengine.Math.Vector2} The new Vector2 added to the curve
     */
     ...
     *
     * @method Vsengine.Curves.Spline#getStartPoint
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Spline#getResolution
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Spline#getPoint
     * @since 3.0.0
     *
     * @generic {Vsengine.Math.Vector2} O - [out,$return]
     *
     ...
     *
     * @method Vsengine.Curves.Spline#toJSON
     * @since 3.0.0
     *
 ...
 *
 * @function Vsengine.Curves.Spline.fromJSON
 * @since 3.0.0
 *
 * @param {Vsengine.Types.Curves.JSONCurve} data - The JSON object containing this curve data.
 *
 * @return {Vsengine.Curves.Spline} The spline curve created.
 */
