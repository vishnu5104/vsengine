...
var Curve = new Class({
    initialize: function Curve(type) {
         ...
         *
         * @name Vsengine.Curves.Curve#type
         * @type {string}
         * @since 3.0.0
         */
        this.type = type;
         ...
         *
         * @name Vsengine.Curves.Curve#defaultDivisions
         * @type {number}
         * @default 5
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Curves.Curve#arcLengthDivisions
         * @type {number}
         * @default 100
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Curves.Curve#cacheArcLengths
         * @type {number[]}
         * @default []
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Curves.Curve#needsUpdate
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Curves.Curve#active
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Curves.Curve#_tmpVec2A
         ...
         * A temporary calculation Vector.
         *
         * @name Vsengine.Curves.Curve#_tmpVec2B
         * @type {Vsengine.Math.Vector2}
         * @private
         * @since 3.0.0
         */
     ...
     *
     * @method Vsengine.Curves.Curve#draw
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Curve#getBounds
     * @since 3.0.0
     *
     * @param {Vsengine.Geom.Rectangle} [out] - The Rectangle to store the bounds in. If falsey a new object will be created.
     ...
     *
     * @method Vsengine.Curves.Curve#getDistancePoints
     * @since 3.0.0
     *
     * @param {number} distance - The distance, in pixels, between each point along the curve.
     *
     * @return {Vsengine.Geom.Point[]} An Array of Point objects.
     */
     ...
     *
     * @method Vsengine.Curves.Curve#getEndPoint
     * @since 3.0.0
     *
     * @param {Vsengine.Math.Vector2} [out] - Optional Vector object to store the result in.
     *
     * @return {Vsengine.Math.Vector2} Vector2 containing the coordinates of the curves end point.
     */
     ...
     *
     * @method Vsengine.Curves.Curve#getLength
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Curve#getLengths
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Curve#getPointAt
     * @since 3.0.0
     *
     * @generic {Vsengine.Math.Vector2} O - [out,$return]
     *
     * @param {number} u - The relative position, [0..1].
     * @param {Vsengine.Math.Vector2} [out] - A point to store the result in.
     *
     * @return {Vsengine.Math.Vector2} The point.
     */
     ...
     *
     * @method Vsengine.Curves.Curve#getPoints
     * @since 3.0.0
     *
     * @generic {Vsengine.Math.Vector2[]} O - [out,$return]
     *
     ...
     * @param {(array|Vsengine.Math.Vector2[])} [out] - An optional array to store the points in.
     *
     * @return {(array|Vsengine.Math.Vector2[])} An array of Points from the curve.
     */
     ...
     *
     * @method Vsengine.Curves.Curve#getRandomPoint
     * @since 3.0.0
     *
     * @generic {Vsengine.Math.Vector2} O - [out,$return]
     *
     * @param {Vsengine.Math.Vector2} [out] - A point object to store the result in.
     *
     * @return {Vsengine.Math.Vector2} The point.
     */
     ...
     * `1 + divisions` points will be returned.
     *
     * @method Vsengine.Curves.Curve#getSpacedPoints
     * @since 3.0.0
     *
     ...
     * @param {(array|Vsengine.Math.Vector2[])} [out] - An optional array to store the points in.
     *
     * @return {Vsengine.Math.Vector2[]} An array of points.
     */
     ...
     *
     * @method Vsengine.Curves.Curve#getStartPoint
     * @since 3.0.0
     *
     * @generic {Vsengine.Math.Vector2} O - [out,$return]
     *
     ...
     *
     * @method Vsengine.Curves.Curve#getTangent
     * @since 3.0.0
     *
     * @generic {Vsengine.Math.Vector2} O - [out,$return]
     *
     ...
     *
     * @method Vsengine.Curves.Curve#getTangentAt
     * @since 3.0.0
     *
     * @generic {Vsengine.Math.Vector2} O - [out,$return]
     *
     ...
     *
     * @method Vsengine.Curves.Curve#getTFromDistance
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Curve#getUtoTmapping
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Curves.Curve#updateArcLengths
     * @since 3.0.0
     *
     * @see Vsengine.Curves.Curve#getLengths()
     */
