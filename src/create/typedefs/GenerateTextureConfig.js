/**
 * @callback Vsengine.Types.Create.GenerateTextureCallback
 * @since 3.0.0
 *
...
/**
 * @typedef {object} Vsengine.Types.Create.GenerateTextureConfig
 * @since 3.0.0
 *
 ...
 * @property {Vsengine.Types.Create.Palette} [palette=Arne16] - The indexed palette that the data cell values map to.
 ...
 * @property {Vsengine.Types.Create.GenerateTextureCallback} [preRender] - A callback to send the canvas to prior to the texture being drawn.
 * @property {Vsengine.Types.Create.GenerateTextureCallback} [postRender] - A callback to send the canvas to after the texture has been drawn.
 */
