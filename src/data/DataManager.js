 ...
 *
 * @class DataManager
 * @memberof Vsengine.Data
 * @constructor
 * @since 3.0.0
 *
 * @param {object} parent - The object that this DataManager belongs to.
 * @param {Vsengine.Events.EventEmitter} [eventEmitter] - The DataManager's event emitter.
 */
var DataManager = new Class({
    initialize: function DataManager(parent, eventEmitter) {
         ...
         *
         * @name Vsengine.Data.DataManager#parent
         * @type {*}
         * @since 3.0.0
         */
        this.parent = parent;
         ...
         *
         * @name Vsengine.Data.DataManager#events
         ...
         * The data list.
         *
         * @name Vsengine.Data.DataManager#list
         * @type {Object.<string, *>}
         * @default {}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Data.DataManager#values
         * @type {Object.<string, *>}
         * @default {}
         * @since 3.10.0
         */
         ...
         *
         * @name Vsengine.Data.DataManager#_frozen
         * @type {boolean}
         * @private
         * @default false
         * @since 3.0.0
     ...
     *
     * @method Vsengine.Data.DataManager#get
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Data.DataManager#getAll
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Data.DataManager#query
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Data.DataManager#set
     * @fires Vsengine.Data.Events#SET_DATA
     * @fires Vsengine.Data.Events#CHANGE_DATA
     * @fires Vsengine.Data.Events#CHANGE_DATA_KEY
     * @since 3.0.0
     *
     * @generic {any} T
     ...
     * When the value is first set, a `setdata` event is emitted.
     *
     * @method Vsengine.Data.DataManager#inc
     * @fires Vsengine.Data.Events#SET_DATA
     * @fires Vsengine.Data.Events#CHANGE_DATA
     * @fires Vsengine.Data.Events#CHANGE_DATA_KEY
     * @since 3.23.0
     ...
     * When the value is first set, a `setdata` event is emitted.
     *
     * @method Vsengine.Data.DataManager#toggle
     * @fires Vsengine.Data.Events#SET_DATA
     * @fires Vsengine.Data.Events#CHANGE_DATA
     * @fires Vsengine.Data.Events#CHANGE_DATA_KEY
     * @since 3.23.0
     ...
     *
     * @method Vsengine.Data.DataManager#setValue
     * @fires Vsengine.Data.Events#SET_DATA
     * @fires Vsengine.Data.Events#CHANGE_DATA
     * @fires Vsengine.Data.Events#CHANGE_DATA_KEY
     * @private
     ...
     *
     * @method Vsengine.Data.DataManager#each
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Data.DataManager#merge
     * @fires Vsengine.Data.Events#SET_DATA
     * @fires Vsengine.Data.Events#CHANGE_DATA
     * @fires Vsengine.Data.Events#CHANGE_DATA_KEY
     * @since 3.0.0
     ...
     * ```
     *
     * @method Vsengine.Data.DataManager#remove
     * @fires Vsengine.Data.Events#REMOVE_DATA
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Data.DataManager#removeValue
     * @private
     * @fires Vsengine.Data.Events#REMOVE_DATA
     * @since 3.10.0
     *
     ...
     *
     * @method Vsengine.Data.DataManager#pop
     * @fires Vsengine.Data.Events#REMOVE_DATA
     * @since 3.0.0
     *
     ...
     * This means the keys `gold` and `Gold` are treated as two unique values within the Data Manager.
     *
     * @method Vsengine.Data.DataManager#has
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Data.DataManager#setFreeze
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Data.DataManager#reset
     * @since 3.0.0
     *
     * @return {this} This Data Manager instance.
     */
     ...
     *
     * @method Vsengine.Data.DataManager#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.reset();
     ...
     *
     * @name Vsengine.Data.DataManager#freeze
     * @type {boolean}
     * @since 3.0.0
     */
    freeze: {
     ...
     *
     * @name Vsengine.Data.DataManager#count
     * @type {number}
     * @since 3.0.0
     */
    count: {
