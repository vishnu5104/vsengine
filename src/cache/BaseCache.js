...
var BaseCache = new Class({
    initialize: function BaseCache() {
         ...
         *
         * @name Vsengine.Cache.BaseCache#entries
         * @type {Vsengine.Structs.Map.<String, *>}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Cache.BaseCache#events
     ...
     *
     * @method Vsengine.Cache.BaseCache#add
     * @fires Vsengine.Cache.Events#ADD
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cache.BaseCache#has
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cache.BaseCache#exists
     * @since 3.7.0
     *
     * @param {string} key - The unique key of the item to be checked in this cache.
     *
     ...
     *
     * @method Vsengine.Cache.BaseCache#get
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cache.BaseCache#remove
     * @fires Vsengine.Cache.Events#REMOVE
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Cache.BaseCache#getKeys
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.Cache.BaseCache#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.entries.clear();
