 ...
 *
 * @class FXPipeline
 * @extends Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline
...
var FXPipeline = new Class({
    ...
    initialize: function FXPipeline(config) {
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FXPipeline#glow
         * @type {Vsengine.Renderer.WebGL.Pipelines.FX.GlowFXPipeline}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FXPipeline#shadow
         * @type {Vsengine.Renderer.WebGL.Pipelines.FX.ShadowFXPipeline}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FXPipeline#pixelate
         * @type {Vsengine.Renderer.WebGL.Pipelines.FX.PixelateFXPipeline}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FXPipeline#vignette
         * @type {Vsengine.Renderer.WebGL.Pipelines.FX.VignetteFXPipeline}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FXPipeline#shine
         * @type {Vsengine.Renderer.WebGL.Pipelines.FX.ShineFXPipeline}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FXPipeline#gradient
         * @type {Vsengine.Renderer.WebGL.Pipelines.FX.GradientFXPipeline}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FXPipeline#circle
         * @type {Vsengine.Renderer.WebGL.Pipelines.FX.CircleFXPipeline}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FXPipeline#barrel
         * @type {Vsengine.Renderer.WebGL.Pipelines.FX.BarrelFXPipeline}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FXPipeline#wipe
         * @type {Vsengine.Renderer.WebGL.Pipelines.FX.WipeFXPipeline}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FXPipeline#bokeh
         * @type {Vsengine.Renderer.WebGL.Pipelines.FX.BokehFXPipeline}
         * @since 3.60.0
         */
         ...
         * This array is intentionally sparse. Do not adjust.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FXPipeline#fxHandlers
         * @type {function[]}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FXPipeline#source
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FXPipeline#target
         * @type {Vsengine.Renderer.WebGL.RenderTarget}
         * @since 3.60.0
         */
        this.target;
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FXPipeline#swap
         * @type {Vsengine.Renderer.WebGL.RenderTarget}
         * @since 3.60.0
         */
        this.swap;
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#onDraw
     * @since 3.60.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} target1 - The source Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} target2 - The target Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} target3 - The swap Render Target.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#runDraw
     * @since 3.60.0
     */
    runDraw: function () {
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#onGlow
     * @since 3.60.0
     *
     * @param {Vsengine.FX.Glow} config - The Glow FX controller.
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#onShadow
     * @since 3.60.0
     *
     * @param {Vsengine.FX.Shadow} config - The Shadow FX controller.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#onPixelate
     * @since 3.60.0
     *
     * @param {Vsengine.FX.Pixelate} config - The Pixelate FX controller.
     * @param {number} width - The width of the target.
     * @param {number} height - The height of the target.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#onVignette
     * @since 3.60.0
     *
     * @param {Vsengine.FX.Vignette} config - The Vignette FX controller.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#onShine
     * @since 3.60.0
     *
     * @param {Vsengine.FX.Shine} config - The Shine FX controller.
     * @param {number} width - The width of the target.
     * @param {number} height - The height of the target.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#onBlur
     * @since 3.60.0
     *
     * @param {Vsengine.FX.Blur} config - The Blur FX controller.
     * @param {number} width - The width of the target.
     * @param {number} height - The height of the target.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#onGradient
     * @since 3.60.0
     *
     * @param {Vsengine.FX.Gradient} config - The Gradient FX controller.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#onBloom
     * @since 3.60.0
     *
     * @param {Vsengine.FX.Bloom} config - The Bloom FX controller.
     * @param {number} width - The width of the target.
     * @param {number} height - The height of the target.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#onColorMatrix
     * @since 3.60.0
     *
     * @param {Vsengine.FX.ColorMatrix} config - The ColorMatrix FX controller.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#onCircle
     * @since 3.60.0
     *
     * @param {Vsengine.FX.Circle} config - The Circle FX controller.
     * @param {number} width - The width of the target.
     * @param {number} height - The height of the target.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#onBarrel
     * @since 3.60.0
     *
     * @param {Vsengine.FX.Barrel} config - The Barrel FX controller.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#onDisplacement
     * @since 3.60.0
     *
     * @param {Vsengine.FX.Displacement} config - The Displacement FX controller.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#onWipe
     * @since 3.60.0
     *
     * @param {Vsengine.FX.Wipe} config - The Wipe FX controller.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#onBokeh
     * @since 3.60.0
     *
     * @param {Vsengine.FX.Bokeh} config - The Bokeh FX controller.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.FXPipeline#destroy
     * @since 3.60.0
     *
