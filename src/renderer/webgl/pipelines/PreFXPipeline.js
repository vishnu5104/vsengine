 ...
 *
 * @class PreFXPipeline
 * @extends Vsengine.Renderer.WebGL.WebGLPipeline
 * @memberof Vsengine.Renderer.WebGL.Pipelines
 * @constructor
 * @since 3.60.0
 *
 * @param {Vsengine.Types.Renderer.WebGL.WebGLPipelineConfig} config - The configuration options for this pipeline.
 */
var PreFXPipeline = new Class({
    Extends: MultiPipeline,

    initialize: function PreFXPipeline(config) {
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#drawSpriteShader
         ...
         * This property is set during the `boot` method.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#copyShader
         * @type {Vsengine.Renderer.WebGL.WebGLShader}
         * @default null
         * @since 3.60.0
         */
         ...
         * This property is set during the `boot` method.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#gameShader
         * @type {Vsengine.Renderer.WebGL.WebGLShader}
         * @default null
         * @since 3.60.0
         */
         ...
         * This property is set during the `boot` method.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#colorMatrixShader
         * @type {Vsengine.Renderer.WebGL.WebGLShader}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#quadVertexData
         * @type {ArrayBuffer}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#quadVertexBuffer
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#quadVertexViewF32
         * @type {Float32Array}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#spriteBounds
         ...
         * A temporary Rectangle object re-used internally during sprite drawing.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#targetBounds
         * @type {Vsengine.Geom.Rectangle}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#fsTarget
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#tempSprite
         * @type {Vsengine.GameObjects.Sprite}
         * @private
         * @since 3.60.0
         */
        this.tempSprite;
    ...
    boot: function () {
        ...
        this.fsTarget = new RenderTarget(
            renderer,
            renderer.width,
            renderer.height,
            1,
        ...
        this.quadVertexBuffer = renderer.createVertexBuffer(
            data,
            this.gl.STATIC_DRAW
        );
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#onResize
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#batchQuad
     * @since 3.60.0
     *
    ...
    batchQuad: function (
        ...
        var targetBounds = this.targetBounds.setTo(
            0,
            0,
            target.width,
            target.height
        ...
        gl.bindFramebuffer(
            gl.FRAMEBUFFER,
            fsTarget.framebuffer.webGLFramebuffer
        );
        gl.framebufferTexture2D(
            gl.FRAMEBUFFER,
            gl.COLOR_ATTACHMENT0,
            gl.TEXTURE_2D,
            fsTarget.texture.webGLTexture,
            0
        );
        ...
        this.onDraw(
            target,
            this.manager.getSwapRenderTarget(),
            this.manager.getAltSwapRenderTarget()
        );
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#onDrawSprite
     * @since 3.60.0
     *
     * @param {Vsengine.GameObjects.Sprite} gameObject - The Sprite being drawn.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} target - The Render Target the Sprite will be drawn to.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#onCopySprite
     * @since 3.60.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source - The source Render Target being copied from.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} target - The target Render Target that will be copied to.
     * @param {Vsengine.GameObjects.Sprite} gameObject - The Sprite being copied.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#copySprite
     * @since 3.60.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source - The source Render Target being copied from.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} target - The target Render Target that will be copied to.
     ...
     * @param {Vsengine.Display.ColorMatrix} [colorMatrix] - Optional ColorMatrix to use when copying the Sprite.
     * @param {Vsengine.Renderer.WebGL.WebGLShader} [shader] - The shader to use to copy the target. Defaults to the `copyShader`.
     */
    copySprite: function (
        source,
        target,
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#copy
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#blendFrames
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#blendFramesAdditive
     * @since 3.60.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source1 - The first source Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source2 - The second source Render Target.
    ...
    blendFramesAdditive: function (
        ...
        this.manager.blendFramesAdditive(
            source1,
            source2,
            target,
            strength,
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#drawToGame
     * @since 3.60.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source - The Render Target to draw to the game.
     */
     ...
     * This method should be the final thing called in your pipeline.
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#copyToGame
     * @since 3.60.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source - The Render Target to copy to the game.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#bindAndDraw
     * @since 3.60.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source - The Render Target to draw to the game.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#onDraw
     * @since 3.60.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} target - The Render Target to draw to the game.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} [swapTarget] - The Swap Render Target, useful for double-buffer effects.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} [altSwapTarget] - The Swap Render Target, useful for double-buffer effects.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#setUVs
     * @since 3.60.0
     *
     ...
     * Be sure to call `resetUVs` once you have finished manipulating the UV coordinates.
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#setTargetUVs
     * @since 3.60.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} target - The target Render Target.
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#resetUVs
     * @since 3.60.0
     */
    resetUVs: function () {
        this.setUVs(0, 0, 0, 1, 1, 1, 1, 0);
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PreFXPipeline#destroy
