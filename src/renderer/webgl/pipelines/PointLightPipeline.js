...
var PointLightPipeline = new Class({
    ...
    initialize: function PointLightPipeline(config) {
        config.vertShader = GetFastValue(
            config,
            "vertShader",
            PointLightShaderSourceVS
        );
        config.fragShader = GetFastValue(
            config,
            "fragShader",
            PointLightShaderSourceFS
        );
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PointLightPipeline#batchPointLight
     * @since 3.50.0
     *
     * @param {Vsengine.GameObjects.PointLight} light - The Point Light Game Object.
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The camera rendering the Point Light.
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.PointLightPipeline#batchLightVert
     * @since 3.50.0
     *
