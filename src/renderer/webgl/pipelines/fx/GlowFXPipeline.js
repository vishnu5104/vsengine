...
var GlowFXPipeline = new Class({
    ...
    initialize: function GlowFXPipeline(game, config) {
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FX.GlowFXPipeline#outerStrength
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FX.GlowFXPipeline#innerStrength
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FX.GlowFXPipeline#knockout
         * @type {number}
         * @since 3.60.0
         */
        this.knockout = false;
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FX.GlowFXPipeline#glcolor
         * @type {number[]}
         * @since 3.60.0
         */
