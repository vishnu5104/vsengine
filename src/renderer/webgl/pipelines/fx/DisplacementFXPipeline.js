...
var DisplacementFXPipeline = new Class({
    ...
    initialize: function DisplacementFXPipeline(game) {
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FX.DisplacementFXPipeline#x
         * @type {number}
         * @since 3.60.0
         */
        this.x = 0.005;
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FX.DisplacementFXPipeline#y
         * @type {number}
         * @since 3.60.0
         */
        this.y = 0.005;
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.FX.DisplacementFXPipeline#glTexture
