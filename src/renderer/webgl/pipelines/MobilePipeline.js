...
/**
 * @classdesc
 * The Mobile Pipeline is the core 2D texture rendering pipeline used by Vsengine in WebGL
...
var MobilePipeline = new Class({
    ...
    initialize: function MobilePipeline(config) {
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.MobilePipeline#boot
     * @since 3.60.0
     */
    boot: function () {
