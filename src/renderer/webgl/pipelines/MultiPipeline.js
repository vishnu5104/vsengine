...
/**
 * @classdesc
 * The Multi Pipeline is the core 2D texture rendering pipeline used by Vsengine in WebGL.
 ...
 *
 * Prior to Vsengine v3.50 this pipeline was called the `TextureTintPipeline`.
 *
 * In previous versions of Vsengine only one single texture unit was supported at any one time.
...
var MultiPipeline = new Class({
    ...
    initialize: function MultiPipeline(config) {
        ...
        var fragmentShaderSource = GetFastValue(
            config,
            "fragShader",
            ShaderSourceFS
        );

        config.fragShader = Utils.parseFragmentShaderMaxTextures(
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#_tempMatrix1
         * @private
         ...
         * A temporary Transform Matrix, re-used internally during batching.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#_tempMatrix2
         * @private
         * @type {Vsengine.GameObjects.Components.TransformMatrix}
         * @since 3.11.0
         */
         ...
         * A temporary Transform Matrix, re-used internally during batching.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#_tempMatrix3
         * @private
         * @type {Vsengine.GameObjects.Components.TransformMatrix}
         * @since 3.11.0
         */
         ...
         * Shape Game Objects.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#calcMatrix
         * @type {Vsengine.GameObjects.Components.TransformMatrix}
         * @since 3.55.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#tempTriangle
         * @type {array}
         * @private
         * @since 3.55.0
         */
         ...
         * Cached stroke tint.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#strokeTint
         * @type {object}
         * @private
         * @since 3.55.0
         */
         ...
         * Cached fill tint.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#fillTint
         * @type {object}
         * @private
         * @since 3.55.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#currentFrame
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#firstQuad
         * @type {number[]}
         * @private
         * @since 3.55.0
         */
         ...
         * Internal path quad cache.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#prevQuad
         * @type {number[]}
         * @private
         * @since 3.55.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#polygonCache
         * @type {array}
         * @private
         * @since 3.55.0
         */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#boot
     * @since 3.50.0
     */
    boot: function () {
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#batchSprite
     * @since 3.0.0
     *
     * @param {(Vsengine.GameObjects.Image|Vsengine.GameObjects.Sprite)} gameObject - The texture based Game Object to add to the batch.
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The Camera to use for the rendering transform.
     * @param {Vsengine.GameObjects.Components.TransformMatrix} [parentTransformMatrix] - The transform matrix of the parent container, if set.
     */
    batchSprite: function (gameObject, camera, parentTransformMatrix) {
        ...
        if (gameObject.isCropped) {
            ...
            if (
                crop.flipX !== gameObject.flipX ||
                crop.flipY !== gameObject.flipY
            ) {
        ...
        var tintTL = getTint(
            gameObject.tintTopLeft,
            cameraAlpha * gameObject._alphaTL
        );
        var tintTR = getTint(
            gameObject.tintTopRight,
            cameraAlpha * gameObject._alphaTR
        );
        var tintBL = getTint(
            gameObject.tintBottomLeft,
            cameraAlpha * gameObject._alphaBL
        );
        var tintBR = getTint(
            gameObject.tintBottomRight,
            cameraAlpha * gameObject._alphaBR
        );
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#batchTexture
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - Source GameObject.
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - Texture associated with the quad.
     ...
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - Current used camera.
     * @param {Vsengine.GameObjects.Components.TransformMatrix} parentTransformMatrix - Parent container.
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#batchTextureFrame
     * @since 3.12.0
     *
     * @param {Vsengine.Textures.Frame} frame - The Texture Frame to be rendered.
     ...
     * @param {Vsengine.GameObjects.Components.TransformMatrix} transformMatrix - The Transform Matrix to use for the texture.
     * @param {Vsengine.GameObjects.Components.TransformMatrix} [parentTransformMatrix] - A parent Transform Matrix.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#batchFillRect
     * @since 3.55.0
     *
     ...
     * @param {Vsengine.GameObjects.Components.TransformMatrix} currentMatrix - The current transform.
     * @param {Vsengine.GameObjects.Components.TransformMatrix} parentMatrix - The parent transform.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#batchFillTriangle
     * @since 3.55.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#batchStrokeTriangle
     * @since 3.55.0
     *
     * @param {number} x0 - Point 0 x coordinate.
     * @param {number} y0 - Point 0 y coordinate.
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#batchFillPath
     * @since 3.55.0
     *
     * @param {Vsengine.Types.Math.Vector2Like[]} path - Collection of points that represent the path.
     * @param {Vsengine.GameObjects.Components.TransformMatrix} currentMatrix - The current transform.
     * @param {Vsengine.GameObjects.Components.TransformMatrix} parentMatrix - The parent transform.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#batchStrokePath
     * @since 3.55.0
     *
     * @param {Vsengine.Types.Math.Vector2Like[]} path - Collection of points that represent the path.
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#batchLine
     * @since 3.55.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.MultiPipeline#destroy
