...
var UtilityPipeline = new Class({
    ...
    initialize: function UtilityPipeline(config) {
         ...
         * isn't provided.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#colorMatrix
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#copyShader
         ...
         * This property is set during the `boot` method.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#addShader
         * @type {Vsengine.Renderer.WebGL.WebGLShader}
         * @since 3.50.0
         */
        this.addShader;
         ...
         * This property is set during the `boot` method.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#linearShader
         * @type {Vsengine.Renderer.WebGL.WebGLShader}
         * @since 3.50.0
         */
        this.linearShader;
         ...
         * This property is set during the `boot` method.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#colorMatrixShader
         * @type {Vsengine.Renderer.WebGL.WebGLShader}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#fullFrame1
         ...
         * However, be aware that these targets are shared between all post fx pipelines.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#fullFrame2
         * @type {Vsengine.Renderer.WebGL.RenderTarget}
         * @since 3.50.0
         */
        this.fullFrame2;
         ...
         * However, be aware that these targets are shared between all post fx pipelines.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#halfFrame1
         * @type {Vsengine.Renderer.WebGL.RenderTarget}
         * @since 3.50.0
         */
        this.halfFrame1;
         ...
         * However, be aware that these targets are shared between all post fx pipelines.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#halfFrame2
         * @type {Vsengine.Renderer.WebGL.RenderTarget}
         * @since 3.50.0
         */
        this.halfFrame2;
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#copyFrame
     * @since 3.50.0
     *
     ...
     * You can optionally set the brightness factor of the copy.
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#blitFrame
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} target - The target Render Target.
     ...
     * place.
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#copyFrameRect
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} target - The target Render Target.
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#copyToGame
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#drawFrame
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} [target] - The target Render Target.
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#blendFrames
     * @since 3.50.0
     *
     ...
     * @param {boolean} [clearAlpha=true] - Clear the alpha channel when running `gl.clear` on the target?
     * @param {Vsengine.Renderer.WebGL.WebGLShader} [blendShader] - The shader to use during the blend copy.
     */
    blendFrames: function (
        source1,
        source2,
        target,
        strength,
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#blendFramesAdditive
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source1 - The first source Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source2 - The second source Render Target.
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#clearFrame
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#setUVs
     * @since 3.50.0
     *
     ...
     * Be sure to call `resetUVs` once you have finished manipulating the UV coordinates.
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#setTargetUVs
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} target - The target Render Target.
     ...
     * Be sure to call `resetUVs` once you have finished manipulating the UV coordinates.
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#flipX
     * @since 3.50.0
     */
    flipX: function () {
     ...
     * Be sure to call `resetUVs` once you have finished manipulating the UV coordinates.
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#flipY
     * @since 3.50.0
     */
    flipY: function () {
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline#resetUVs
     * @since 3.50.0
     */
    resetUVs: function () {
