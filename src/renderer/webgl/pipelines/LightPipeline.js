 ...
 *
 * Prior to Vsengine v3.50 this pipeline was called the `ForwardDiffuseLightPipeline`.
 *
 ...
 *
 * @class LightPipeline
 * @extends Vsengine.Renderer.WebGL.Pipelines.MultiPipeline
...
var LightPipeline = new Class({
    ...
    initialize: function LightPipeline(config) {
        var fragShader = GetFastValue(
            config,
            "fragShader",
            LightShaderSourceFS
        );

        config.fragShader = fragShader.replace(
            "%LIGHT_COUNT%",
            config.game.renderer.config.maxLights
        );
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.LightPipeline#inverseRotationMatrix
         * @type {Float32Array}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.LightPipeline#currentNormalMap;
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.LightPipeline#lightsActive
         * @type {boolean}
         * @readonly
         * @since 3.53.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.LightPipeline#tempVec2
         ...
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.LightPipeline#_tempMatrix
         ...
         * A temporary Transform Matrix used for parent Container calculations without them needing their own local copy.
         *
         * @name Vsengine.Renderer.WebGL.Pipelines.LightPipeline#_tempMatrix2
         * @type {Vsengine.GameObjects.Components.TransformMatrix}
         * @private
         * @since 3.60.0
         */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.LightPipeline#boot
     * @since 3.11.0
     */
    boot: function () {
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.LightPipeline#onRender
     * @ignore
     * @since 3.0.0
     *
    ...
    onRender: function (scene, camera) {
        ...
        this.set3f(
            "uAmbientLightColor",
            lightManager.ambientColor.r,
            lightManager.ambientColor.g,
        ...
        for (i = 0; i < lightsCount; i++) {
            ...
            this.set2f(
                lightName + "position",
                tempVec2.x - camera.scrollX * light.scrollFactorX * camera.zoom,
                height -
                    (tempVec2.y -
                        camera.scrollY * light.scrollFactorY * camera.zoom)
            );
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.LightPipeline#setNormalMapRotation
     * @since 3.16.0
     *
    ...
    setNormalMapRotation: function (rotation) {
        if (
            rotation !== this.currentNormalMapRotation ||
            this.vertexCount === 0
        ) {
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.LightPipeline#setTexture2D
     * @ignore
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} [texture] - Texture that will be assigned to the current batch. If not given uses blankTexture.
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.LightPipeline#setGameObject
     * @ignore
     * @since 3.50.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - The Game Object being rendered or added to the batch.
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#isNewNormalMap
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - The diffuse texture.
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} normalMap - The normal map texture.
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.LightPipeline#getNormalMap
     * @since 3.50.0
     *
     * @param {Vsengine.GameObjects.GameObject} [gameObject] - The Game Object to get the normal map from.
     *
     * @return {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} The normal map texture.
     */
    getNormalMap: function (gameObject) {
        ...
        if (!gameObject) {
            ...
            normalMap =
                gameObject.displayTexture.dataSource[
                    gameObject.displayFrame.sourceIndex
                ];
        } else if (gameObject.texture) {
            normalMap =
                gameObject.texture.dataSource[gameObject.frame.sourceIndex];
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.LightPipeline#batchSprite
     * @since 3.50.0
     *
    ...
    batchSprite: function (gameObject, camera, parentTransformMatrix) {
        if (this.lightsActive) {
            MultiPipeline.prototype.batchSprite.call(
                this,
                gameObject,
                camera,
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.LightPipeline#batchTexture
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.Pipelines.LightPipeline#batchTextureFrame
     * @since 3.50.0
     *
