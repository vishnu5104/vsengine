 ...
 *
 * @param {Vsengine.Renderer.WebGL.WebGLRenderer} renderer - The WebGL Renderer which owns the context.
 */
 ...
 * any context change that happens for WebGL rendering inside of Vsengine. This means
 * if raw webgl functions are called outside the WebGLRenderer of the Vsengine WebGL
 ...
 * @memberof Vsengine.Renderer.WebGL
 * @constructor
 * @since 3.0.0
 *
 * @param {Vsengine.Game} game - The Game instance which owns this WebGL Renderer.
 */
var WebGLRenderer = new Class({
    ...
    initialize: function WebGLRenderer(game) {
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#config
         * @type {object}
         * @since 3.0.0
         */
        this.config = {
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#game
         * @type {Vsengine.Game}
         * @since 3.0.0
         */
        this.game = game;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#type
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * Prior to Vsengine v3.50.0 this was just a plain JavaScript object, not a class.
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#pipelines
         * @type {Vsengine.Renderer.WebGL.PipelineManager}
         * @since 3.50.0
         */
        this.pipelines = null;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#width
         * @type {number}
         * @since 3.0.0
         */
        this.width = 0;
         ...
         * This is populated in the onResize event handler.
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#height
         * @type {number}
         * @since 3.0.0
         */
        this.height = 0;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#canvas
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#blendModes
         * @type {array}
         * @default []
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#contextLost
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#snapshotState
         * @type {Vsengine.Types.Renderer.Snapshot.SnapshotState}
         * @since 3.0.0
         */
        this.snapshotState = {
            x: 0,
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#maxTextures
         * @type {number}
         * @since 3.50.0
         */
        this.maxTextures = 0;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#textureIndexes
         * @type {array}
         * @since 3.50.0
         */
        this.textureIndexes;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#glBufferWrappers
         * @type {Vsengine.Renderer.WebGL.Wrappers.WebGLBufferWrapper[]}
         * @since 3.80.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#glProgramWrappers
         * @type {Vsengine.Renderer.WebGL.Wrappers.WebGLProgramWrapper[]}
         * @since 3.80.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#glTextureWrappers
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#glFramebufferWrappers
         * @type {Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper[]}
         * @since 3.80.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#glAttribLocationWrappers
         * @type {Vsengine.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper[]}
         * @since 3.80.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#glUniformLocationWrappers
         * @type {Vsengine.Renderer.WebGL.Wrappers.WebGLUniformLocationWrapper[]}
         * @since 3.80.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#currentFramebuffer
         * @type {Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#fboStack
         * @type {Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper[]}
         * @since 3.50.0
         */
        this.fboStack = [];
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#currentProgram
         * @type {Vsengine.Renderer.WebGL.Wrappers.WebGLProgramWrapper}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#currentBlendMode
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#currentScissorEnabled
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#currentScissor
         * @type {Uint32Array}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#scissorStack
         * @type {Uint32Array}
         * @since 3.0.0
         */
        this.scissorStack = [];
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#contextLostHandler
         * @type {function}
         * @since 3.19.0
         */
         ...
         * This should not be changed and is set in the init method.
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#contextRestoredHandler
         * @type {function}
         * @since 3.19.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#previousContextLostHandler
         * @type {function}
         * @since 3.19.0
         */
         ...
         * This is set when `setContextHandlers` is called.
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#previousContextRestoredHandler
         * @type {function}
         * @since 3.19.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#gl
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#supportedExtensions
         * @type {string[]}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#instancedArraysExtension
         ...
         * a reference to the glExtension for it.
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#vaoExtension
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#extensions
         * @type {object}
         * @default {}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#glFormats
         * @type {array}
         * @since 3.2.0
         */
        this.glFormats;
         ...
         *
         * Support for using compressed texture formats was added in Vsengine version 3.60.
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#compression
         * @type {Vsengine.Types.Renderer.WebGL.WebGLTextureCompression}
         * @since 3.8.0
         */
        this.compression;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#drawingBufferHeight
         * @type {number}
         * @readonly
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#blankTexture
         * @type {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper}
         * @readonly
         * @since 3.12.0
         */
         ...
         * This is set in the `boot` method.
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#normalTexture
         * @type {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper}
         * @readonly
         * @since 3.80.0
         */
         ...
         * This is set in the `boot` method.
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#whiteTexture
         * @type {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#maskCount
         * @type {number}
         * @since 3.17.0
         */
        this.maskCount = 0;
         ...
         * The mask stack.
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#maskStack
         * @type {Vsengine.Display.Masks.GeometryMask[]}
         * @since 3.17.0
         */
        this.maskStack = [];
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#currentMask
         * @type {any}
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#currentCameraMask
         * @type {any}
         * @since 3.17.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#glFuncMap
         * @type {any}
         * @since 3.17.0
         */
        this.glFuncMap = null;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#currentType
         * @type {string}
         * @since 3.19.0
         */
        this.currentType = "";
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#newType
         * @type {boolean}
         * @since 3.19.0
         */
        this.newType = false;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#nextTypeMatch
         * @type {boolean}
         * @since 3.19.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#finalType
         * @type {boolean}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#mipmapFilter
         * @type {GLenum}
         * @since 3.21.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#defaultScissor
         * @type {number[]}
         * @private
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#isBooted
         * @type {boolean}
         * @since 3.50.0
         */
        this.isBooted = false;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#renderTarget
         * @type {Vsengine.Renderer.WebGL.RenderTarget}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#projectionMatrix
         * @type {Vsengine.Math.Matrix4}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#projectionWidth
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#projectionHeight
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#maskSource
         * @type {Vsengine.Renderer.WebGL.RenderTarget}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#maskTarget
         * @type {Vsengine.Renderer.WebGL.RenderTarget}
         * @since 3.60.0
         */
         ...
         *
         * Only available in the Vsengine Debug build.
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#spector
         * @type {function}
         * @since 3.60.0
         */
        this.spector = null;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLRenderer#_debugCapture
         * @type {boolean}
         * @private
         * @since 3.60.0
         */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#init
     * @since 3.0.0
     *
    ...
    init: function (config) {
        ...
        var setupExtensions = function () {
            ...
            _this.instancedArraysExtension =
                exts.indexOf(angleString) > -1
                    ? gl.getExtension(angleString)
                    : null;

            var vaoString = "OES_vertex_array_object";

            _this.vaoExtension =
                exts.indexOf(vaoString) > -1
                    ? gl.getExtension(vaoString)
                    : null;
        };
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#boot
     * @private
     * @since 3.11.0
     */
    boot: function () {
        ...
        this.maskSource = new RenderTarget(
            this,
            width,
            height,
            1,
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#setContextHandlers
     * @since 3.85.0
     *
    ...
    setContextHandlers: function (contextLost, contextRestored) {
        if (this.previousContextLostHandler) {
            this.canvas.removeEventListener(
                "webglcontextlost",
                this.previousContextLostHandler,
                false
            );
        }
        if (this.previousContextRestoredHandler) {
            this.canvas.removeEventListener(
                "webglcontextlost",
                this.previousContextRestoredHandler,
                false
            );
        }
        ...
        if (typeof contextRestored === "function") {
            ...
            this.contextRestoredHandler =
                this.dispatchContextRestored.bind(this);
        }
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#dispatchContextLost
     * @since 3.85.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#dispatchContextRestored
     * @since 3.85.0
     *
    ...
    dispatchContextRestored: function (event) {
        ...
        if (gl.isContextLost()) {
            if (console) {
                console.log(
                    "WebGL Context restored, but context is still lost"
                );
            }
        ...
        // Apply resize.
        this.resize(
            this.game.scale.baseSize.width,
            this.game.scale.baseSize.height
        );
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#createTemporaryTextures
     * @since 3.60.0
     */
    ...
    /**
     * This method is only available in the Debug Build of Vsengine, or a build with the
     * `WEBGL_DEBUG` flag set in the Webpack Config.
     *
     * Vsengine v3.60 Debug has a build of Spector.js embedded in it, which is a WebGL inspector
     * that allows for live inspection of your WebGL calls. Although it's easy to add the Spector
     * extension to a desktop browsr, by embedding it in Vsengine we can make it available in mobile
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#captureFrame
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#captureNextFrame
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#getFps
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#log
     * @since 3.60.0
     *
     ...
     * See https://github.com/BabylonJS/Spector.js for more details.
     *
     * This method will start a capture on the Vsengine canvas. The capture will stop once it reaches
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#startCapture
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#stopCapture
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#onCapture
     * @private
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#onResize
     * @since 3.16.0
     *
     * @param {Vsengine.Structs.Size} gameSize - The default Game Size object. This is the un-modified game dimensions.
     * @param {Vsengine.Structs.Size} baseSize - The base Size object. The game dimensions. The canvas width / height values match this.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#beginCapture
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#endCapture
     * @since 3.50.0
     *
     * @return {Vsengine.Renderer.WebGL.RenderTarget} A reference to the WebGL Renderer Render Target.
     */
    endCapture: function () {
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#resize
     * @fires Vsengine.Renderer.Events#RESIZE
     * @since 3.0.0
     *
     ...
     * which formats it supports, see the `Vsengine.Renderer.WebGL.WebGLRenderer#compression` property instead.
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#getCompressedTextures
     * @since 3.60.0
     *
     * @return {Vsengine.Types.Renderer.WebGL.WebGLTextureCompression} The compression object.
     */
    getCompressedTextures: function () {
        ...
        var hasExt = function (gl, format) {
            var results =
                gl.getExtension(extString + format) ||
                gl.getExtension(wkExtString + format) ||
                gl.getExtension(extEXTString + format);
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#getCompressedTextureName
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#supportsCompressedTexture
     * @since 3.60.0
     *
     * @param {string} baseFormat - The Base Format to check.
     * @param {GLenum} [format] - An optional GLenum format to check within the base format.
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#getAspectRatio
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#setProjectionMatrix
     * @since 3.50.0
     *
    ...
    setProjectionMatrix: function (width, height) {
        if (
            width !== this.projectionWidth ||
            height !== this.projectionHeight
        ) {
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#resetProjectionMatrix
     * @since 3.50.0
     *
     * @return {this} This WebGLRenderer instance.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#hasExtension
     * @since 3.0.0
     *
    ...
    hasExtension: function (extensionName) {
        return this.supportedExtensions
            ? this.supportedExtensions.indexOf(extensionName)
            : false;
    },
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#getExtension
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#flush
     * @since 3.0.0
     */
    flush: function () {
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#pushScissor
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#setScissor
     * @since 3.0.0
     *
     * @param {number} x - The x position of the scissor.
     * @param {number} y - The y position of the scissor.
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#resetScissor
     * @since 3.50.0
     */
    resetScissor: function () {
        ...
        if (current) {
            ...
            if (width > 0 && height > 0) {
                gl.scissor(
                    x,
                    this.drawingBufferHeight - y - height,
                    width,
                    height
                );
            }
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#popScissor
     * @since 3.0.0
     */
    popScissor: function () {
        var scissorStack = this.scissorStack;
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#hasActiveStencilMask
     * @since 3.17.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#resetViewport
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#setBlendMode
     * @since 3.0.0
     *
    ...
    setBlendMode: function (blendModeId, force) {
        ...
        if (
            force ||
            (blendModeId !== CONST.BlendModes.SKIP_CHECK &&
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#addBlendMode
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#updateBlendMode
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#removeBlendMode
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#pushFramebuffer
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper} framebuffer - The framebuffer that needs to be bound.
     ...
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} [texture=null] - Bind the given frame buffer texture?
     * @param {boolean} [clear=false] - Clear the frame buffer after binding?
     *
     * @return {this} This WebGLRenderer instance.
     */
    pushFramebuffer: function (
        framebuffer,
        updateScissor,
        setViewport,
        texture,
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#setFramebuffer
     * @since 3.0.0
     *
     * @param {(Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper|null)} framebuffer - The framebuffer that needs to be bound, or `null` to bind back to the default framebuffer.
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#popFramebuffer
     * @since 3.50.0
     *
     * @param {boolean} [updateScissor=false] - If a framebuffer is given, set the gl scissor to match the frame buffer size? Or, if `null` given, pop the scissor from the stack.
     * @param {boolean} [setViewport=true] - Should the WebGL viewport be set?
     *
     * @return {Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper} The Framebuffer that was set, or `null` if there aren't any more in the stack.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#restoreFramebuffer
     * @since 3.60.0
     *
     * @param {boolean} [updateScissor=false] - If a framebuffer is given, set the gl scissor to match the frame buffer size? Or, if `null` given, pop the scissor from the stack.
     * @param {boolean} [setViewport=true] - Should the WebGL viewport be set?
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#setProgram
     * @since 3.0.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLProgramWrapper} program - The program that needs to be bound.
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#resetProgram
     * @since 3.50.0
     *
     * @return {this} This WebGLRenderer instance.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#createTextureFromSource
     * @since 3.0.0
     *
     ...
     *
     * @return {?Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} The WebGLTextureWrapper that was created, or `null` if it couldn't be created.
     */
    createTextureFromSource: function (
        source,
        width,
        height,
        scaleMode,
        ...
        if (scaleMode === CONST.ScaleModes.LINEAR && this.config.antialias) {
            ...
            var isMip =
                (!isCompressed && pow) ||
                (isCompressed && source.mipmaps.length > 1);
            ...
            minFilter =
                this.mipmapFilter && isMip ? this.mipmapFilter : gl.LINEAR;
            magFilter = gl.LINEAR;
        }
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#createTexture2D
     * @since 3.0.0
     *
     ...
     *
     * @return {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} The WebGLTextureWrapper that was created.
     */
    createTexture2D: function (
        ...
        var texture = new WebGLTextureWrapper(
            this.gl,
            mipLevel,
            minFilter,
            magFilter,
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#createFramebuffer
     * @since 3.0.0
     *
     ...
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} renderTexture - The color texture where the color pixels are written.
     * @param {boolean} [addDepthStencilBuffer=false] - Create a Renderbuffer for the depth stencil?
     *
     * @return {Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper} Wrapped framebuffer which is safe to use with the renderer.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#beginBitmapMask
     * @since 3.60.0
     *
     * @param {Vsengine.Display.Masks.BitmapMask} mask - The BitmapMask instance that called beginMask.
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The camera rendering the current mask.
     */
     ...
     * The framebuffer for the masked object is also bound for further use.
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#drawBitmapMask
     * @since 3.60.0
     *
     * @param {Vsengine.Display.Masks.BitmapMask} mask - The BitmapMask instance that called beginMask.
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The camera rendering the current mask.
     * @param {Vsengine.Renderer.WebGL.Pipelines.BitmapMaskPipeline} bitmapMaskPipeline - The BitmapMask Pipeline instance that is requesting the draw.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#createProgram
     * @since 3.0.0
     *
     ...
     *
     * @return {Vsengine.Renderer.WebGL.Wrappers.WebGLProgramWrapper} The wrapped, linked WebGLProgram created from the given shader source.
     */
    createProgram: function (vertexShader, fragmentShader) {
        var wrapper = new WebGLProgramWrapper(
            this.gl,
            vertexShader,
            fragmentShader
        );
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#createVertexBuffer
     * @since 3.0.0
     *
     ...
     *
     * @return {Vsengine.Renderer.WebGL.Wrappers.WebGLBufferWrapper} Wrapped vertex buffer
     */
    createVertexBuffer: function (initialDataOrSize, bufferUsage) {
        var gl = this.gl;
        var vertexBuffer = new WebGLBufferWrapper(
            gl,
            initialDataOrSize,
            gl.ARRAY_BUFFER,
            bufferUsage
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#createAttribLocation
     * @since 3.80.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLProgramWrapper} program - The WebGLProgramWrapper instance.
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#createUniformLocation
     * @since 3.80.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLProgramWrapper} program - The WebGLProgramWrapper instance.
     ...
     * Wrapper for creating a vertex buffer.
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#createIndexBuffer
     * @since 3.0.0
     *
     * @param {ArrayBuffer} initialDataOrSize - Either ArrayBuffer or an integer indicating the size of the vbo.
     * @param {number} bufferUsage - How the buffer is used. gl.DYNAMIC_DRAW, gl.STATIC_DRAW or gl.STREAM_DRAW.
     *
     * @return {Vsengine.Renderer.WebGL.Wrappers.WebGLBufferWrapper} Wrapped index buffer
     */
    createIndexBuffer: function (initialDataOrSize, bufferUsage) {
        var gl = this.gl;
        var indexBuffer = new WebGLBufferWrapper(
            gl,
            initialDataOrSize,
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#deleteTexture
     * @since 3.0.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - The WebGL Texture to be deleted.
     *
     * @return {this} This WebGLRenderer instance.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#deleteFramebuffer
     * @since 3.0.0
     *
     * @param {(Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper|null)} framebuffer - The Framebuffer to be deleted.
     *
     * @return {this} This WebGLRenderer instance.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#deleteProgram
     * @since 3.0.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLProgramWrapper} program - The shader program to be deleted.
     *
     * @return {this} This WebGLRenderer instance.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#deleteAttribLocation
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper} attrib - The attrib location to be deleted.
     * @since 3.80.0
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#deleteUniformLocation
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLUniformLocationWrapper} uniform - The uniform location to be deleted.
     * @since 3.80.0
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#deleteBuffer
     * @since 3.0.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLBufferWrapper} vertexBuffer - The WebGLBuffer to be deleted.
     *
     * @return {this} This WebGLRenderer instance.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#preRenderCamera
     * @since 3.0.0
     *
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The Camera to pre-render.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#getCurrentStencilMask
     * @private
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#postRenderCamera
     * @since 3.0.0
     *
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The Camera to post-render.
     */
    postRenderCamera: function (camera) {
        ...
        if (
            flashEffect.isRunning ||
            fadeEffect.isRunning ||
            fadeEffect.isComplete
        ) {
            var pipeline = this.pipelines.setMulti();
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#preRender
     * @fires Vsengine.Renderer.Events#PRE_RENDER_CLEAR
     * @fires Vsengine.Renderer.Events#PRE_RENDER
     * @since 3.0.0
     */
    preRender: function () {
        if (this.contextLost) {
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#render
     * @fires Vsengine.Renderer.Events#RENDER
     * @since 3.0.0
     *
     * @param {Vsengine.Scene} scene - The Scene to render.
     * @param {Vsengine.GameObjects.GameObject[]} children - An array of filtered Game Objects that can be rendered by the given Camera.
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The Scene Camera to render with.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#postRender
     * @fires Vsengine.Renderer.Events#POST_RENDER
     * @since 3.0.0
     */
    postRender: function () {
        if (this.contextLost) {
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#clearStencilMask
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#restoreStencilMask
     * @since 3.60.0
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#snapshot
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Renderer.Snapshot.SnapshotCallback} callback - The Function to invoke after the snapshot image is created.
     ...
     * which gets more expensive the larger the canvas size gets, so please be careful how you employ this in your game.
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#snapshotArea
     * @since 3.16.0
     *
     ...
     * using less memory.
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#snapshotPixel
     * @since 3.16.0
     *
     ...
     * @param {Vsengine.Types.Renderer.Snapshot.SnapshotCallback} callback - The Function to invoke after the snapshot pixel data is extracted.
     *
     * @return {this} This WebGL Renderer.
     */
     ...
     * which gets more expensive the larger the canvas size gets, so please be careful how you employ this in your game.
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#snapshotFramebuffer
     * @since 3.19.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper} framebuffer - The framebuffer to grab from.
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#canvasToTexture
     * @since 3.0.0
     *
     * @param {HTMLCanvasElement} srcCanvas - The Canvas to create the WebGL Texture from
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} [dstTexture] - The destination WebGLTextureWrapper to set.
     ...
     *
     * @return {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} The newly created, or updated, WebGLTextureWrapper.
     */
    canvasToTexture: function (srcCanvas, dstTexture, noRepeat, flipY) {
        ...
        if (this.config.antialias) {
            minFilter =
                pow && this.mipmapFilter ? this.mipmapFilter : gl.LINEAR;
            magFilter = gl.LINEAR;
        }
     ...
     * Creates a new WebGL Texture based on the given Canvas Element.
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#createCanvasTexture
     * @since 3.20.0
     *
     * @param {HTMLCanvasElement} srcCanvas - The Canvas to create the WebGL Texture from.
     * @param {boolean} [noRepeat=false] - Should this canvas be allowed to set `REPEAT` (such as for Text objects?)
     * @param {boolean} [flipY=false] - Should the WebGL Texture set `UNPACK_MULTIPLY_FLIP_Y`?
     *
     * @return {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} The newly created WebGLTextureWrapper.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#updateCanvasTexture
     * @since 3.20.0
     *
     * @param {HTMLCanvasElement} srcCanvas - The Canvas to update the WebGL Texture from.
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} dstTexture - The destination WebGLTextureWrapper to update.
     * @param {boolean} [flipY=false] - Should the WebGL Texture set `UNPACK_MULTIPLY_FLIP_Y`?
     * @param {boolean} [noRepeat=false] - Should this canvas be allowed to set `REPEAT` (such as for Text objects?)
     *
     * @return {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} The updated WebGLTextureWrapper. This is the same wrapper object as `dstTexture`.
     */
     ...
     * If the `dstTexture` parameter is given, the WebGL Texture is updated, rather than created fresh.
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#videoToTexture
     * @since 3.85.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#createVideoTexture
     * @since 3.20.0
     *
     * @param {HTMLVideoElement} srcVideo - The Video to create the WebGL Texture from
     * @param {boolean} [noRepeat=false] - Should this canvas be allowed to set `REPEAT`?
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#updateVideoTexture
     * @since 3.20.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#createUint8ArrayTexture
     * @since 3.80.0
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#setTextureFilter
     * @since 3.0.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - The texture to set the filter for.
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#getMaxTextureSize
     * @since 3.8.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLRenderer#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.canvas.removeEventListener(
