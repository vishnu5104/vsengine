...
/**
 * @classdesc
 * The `WebGLPipeline` is a base class used by all of the core Vsengine pipelines.
 *
 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Types.Renderer.WebGL.WebGLPipelineConfig} config - The configuration object for this WebGL Pipeline.
 */
var WebGLPipeline = new Class({
    ...
    initialize: function WebGLPipeline(config) {
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#name
         * @type {string}
         * @since 3.0.0
         */
        ...
        /**
         * The Vsengine Game instance to which this pipeline is bound.
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#game
         * @type {Vsengine.Game}
         * @since 3.0.0
         */
        this.game = game;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#renderer
         * @type {Vsengine.Renderer.WebGL.WebGLRenderer}
         * @since 3.0.0
         */
         ...
         * to the manager.
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#manager
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#gl
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#view
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#width
         * @type {number}
         * @since 3.0.0
         */
        this.width = 0;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#height
         * @type {number}
         * @since 3.0.0
         */
        this.height = 0;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#vertexCount
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#vertexCapacity
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#vertexData
         * @type {ArrayBuffer}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#vertexBuffer
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#activeBuffer
         * @type {Vsengine.Renderer.WebGL.Wrappers.WebGLBufferWrapper}
         * @since 3.60.0
         */
        this.activeBuffer;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#topology
         * @type {GLenum}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#bytes
         * @type {Uint8Array}
         * @since 3.0.0
         */
        this.bytes;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#vertexViewF32
         * @type {Float32Array}
         * @since 3.0.0
         */
        this.vertexViewF32;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#vertexViewU32
         * @type {Uint32Array}
         * @since 3.0.0
         */
        this.vertexViewU32;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#active
         * @type {boolean}
         * @since 3.10.0
         */
        this.active = true;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#forceZero
         * @type {boolean}
         * @since 3.50.0
         */
         ...
         * fully ready.
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#hasBooted
         * @type {boolean}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#isPostFX
         * @type {boolean}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#isPreFX
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#renderTargets
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#currentRenderTarget
         * @type {Vsengine.Renderer.WebGL.RenderTarget}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#shaders
         * @type {Vsengine.Renderer.WebGL.WebGLShader[]}
         * @since 3.50.0
         */
        this.shaders = [];
         ...
         * an array look-up.
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#currentShader
         * @type {Vsengine.Renderer.WebGL.WebGLShader}
         * @since 3.50.0
         */
        this.currentShader;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#projectionMatrix
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#projectionWidth
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#projectionHeight
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#config
         * @type {Vsengine.Types.Renderer.WebGL.WebGLPipelineConfig}
         * @since 3.50.0
         */
        this.config = config;

        /**
         * Has the GL Context been reset to the Vsengine defaults since the last time
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#glReset
         * @type {boolean}
         * @since 3.53.0
         */
        this.glReset = false;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#batch
         * @type {Vsengine.Types.Renderer.WebGL.WebGLPipelineBatchEntry[]}
         * @since 3.60.0
         */
        this.batch = [];
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#currentBatch
         * @type {?Vsengine.Types.Renderer.WebGL.WebGLPipelineBatchEntry}
         * @since 3.60.0
         */
         ...
         * Treat this value as read-only.
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#currentTexture
         ...
         * Treat this value as read-only.
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#currentUnit
         * @type {number}
         * @since 3.50.0
         */
        this.currentUnit = 0;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#activeTextures
         * @type {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper[]}
         * @since 3.60.0
         */
        this.activeTextures = [];
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLPipeline#resizeUniform
         * @type {string}
         * @since 3.80.0
         */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#boot
     * @fires Vsengine.Renderer.WebGL.Pipelines.Events#BOOT
     * @since 3.11.0
     */
    boot: function () {
        var i;
        ...
        if (typeof targets === "number") {
            ...
            for (i = 0; i < targets; i++) {
                renderTargets.push(
                    new RenderTarget(renderer, width, height, 1, 0, true)
                );
            }
        ...
        var batchSize = GetFastValue(
            config,
            "batchSize",
            renderer.config.batchSize
        );
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#onBoot
     * @since 3.50.0
     */
    onBoot: function () {},
     ...
     * changes size.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#onResize
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#setShader
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.WebGLShader} shader - The shader to set as being current.
     * @param {boolean} [setAttributes=false] - Should the vertex attribute pointers be set?
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLBufferWrapper} [vertexBuffer] - The vertex buffer to be set before the shader is bound. Defaults to the one owned by this pipeline.
     *
    ...
    setShader: function (shader, setAttributes, vertexBuffer) {
        ...
        if (
            ...
            renderer.currentProgram !== this.currentShader.program
        ) {
            this.flush();
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#getShaderByName
     * @since 3.50.0
     *
     * @param {string} name - The index of the shader to set.
     *
     * @return {Vsengine.Renderer.WebGL.WebGLShader} The WebGLShader instance, if found.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#setShadersFromConfig
     * @since 3.50.0
     *
     * @param {Vsengine.Types.Renderer.WebGL.WebGLPipelineConfig} config - The configuration object for this WebGL Pipeline.
     *
        ...
        if (len === 0) {
            ...
            for (i = 0; i < len; i++) {
                ...
                if (typeof shaderEntry === "string") {
                    ...
                    fragShader = Utils.parseFragmentShaderMaxTextures(
                        shaderEntry,
                        renderer.maxTextures
                    );
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#createBatch
     * @since 3.60.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - The texture assigned to this batch entry.
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#addTextureToBatch
     * @since 3.60.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - The texture assigned to this batch entry.
     */
     ...
     * advanced.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#pushBatch
     * @since 3.60.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - The texture assigned to this batch entry.
     *
    ...
    pushBatch: function (texture) {
        ...
        if (
            !this.currentBatch ||
            (this.forceZero && texture !== this.currentTexture)
        ) {
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#setGameObject
     * @since 3.50.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - The Game Object being rendered or added to the batch.
     * @param {Vsengine.Textures.Frame} [frame] - Optional frame to use. Can override that of the Game Object.
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#shouldFlush
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#vertexAvailable
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#resize
     * @fires Vsengine.Renderer.WebGL.Pipelines.Events#RESIZE
     * @since 3.0.0
     *
     * @param {number} width - The new width of this WebGL Pipeline.
     * @param {number} height - The new height of this WebGL Pipeline.
     ...
     * This method is called automatically by the renderer during its resize handler.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#setProjectionMatrix
     * @since 3.50.0
     *
     * @param {number} width - The new width of this WebGL Pipeline.
     * @param {number} height - The new height of this WebGL Pipeline.
     ...
     * them back again.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#flipProjectionMatrix
     * @since 3.60.0
     *
     ...
     * pipeline is set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#updateProjectionMatrix
     * @since 3.50.0
     */
    updateProjectionMatrix: function () {
        if (this.projectionMatrix) {
            ...
            if (
                this.projectionWidth !== globalWidth ||
                this.projectionHeight !== globalHeight
            ) {
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#bind
     * @fires Vsengine.Renderer.WebGL.Pipelines.Events#BIND
     * @since 3.0.0
     *
     * @param {Vsengine.Renderer.WebGL.WebGLShader} [currentShader] - The shader to set as being current.
     *
     * @return {this} This WebGLPipeline instance.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#rebind
     * @fires Vsengine.Renderer.WebGL.Pipelines.Events#REBIND
     * @since 3.0.0
     *
     * @param {Vsengine.Renderer.WebGL.WebGLShader} [currentShader] - The shader to set as being current.
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#restoreContext
     * @since 3.80.0
     */
     ...
     * binds itself if not.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#setVertexBuffer
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLBufferWrapper} [buffer] - The Vertex Buffer to be bound. Defaults to the one owned by this pipeline.
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#preBatch
     * @since 3.50.0
     *
     * @param {(Vsengine.GameObjects.GameObject|Vsengine.Cameras.Scene2D.Camera)} [gameObject] - The Game Object or Camera that invoked this pipeline, if any.
     *
     * @return {this} This WebGLPipeline instance.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#postBatch
     * @since 3.50.0
     *
     * @param {(Vsengine.GameObjects.GameObject|Vsengine.Cameras.Scene2D.Camera)} [gameObject] - The Game Object or Camera that invoked this pipeline, if any.
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#onDraw
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} renderTarget - The Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} [swapTarget] - A Swap Render Target, useful for double-buffer effects. Only set by SpriteFX Pipelines.
     */
    onDraw: function () {},
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#unbind
     * @since 3.50.0
     */
    unbind: function () {
        if (this.currentRenderTarget) {
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#flush
     * @fires Vsengine.Renderer.WebGL.Pipelines.Events#BEFORE_FLUSH
     * @fires Vsengine.Renderer.WebGL.Pipelines.Events#AFTER_FLUSH
     * @since 3.0.0
     *
            ...
            if (this.active) {
                ...
                if (vertexCount === this.vertexCapacity) {
                    ...
                    gl.bufferSubData(
                        gl.ARRAY_BUFFER,
                        0,
                        this.bytes.subarray(0, vertexCount * vertexSize)
                    );
                }
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#onActive
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.WebGLShader} currentShader - The shader that was set as current.
     */
    onActive: function () {},
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#onBind
     * @since 3.50.0
     *
     * @param {Vsengine.GameObjects.GameObject} [gameObject] - The Game Object that invoked this pipeline, if any.
     */
    onBind: function () {},
     ...
     * and then returing to Vsengine again.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#onRebind
     * @since 3.50.0
     */
    onRebind: function () {},
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#onBatch
     * @since 3.50.0
     *
     * @param {Vsengine.GameObjects.GameObject} [gameObject] - The Game Object that invoked this pipeline, if any.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#onPreBatch
     * @since 3.50.0
     *
     * @param {Vsengine.GameObjects.GameObject} [gameObject] - The Game Object that invoked this pipeline, if any.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#onPostBatch
     * @since 3.50.0
     *
     * @param {Vsengine.GameObjects.GameObject} [gameObject] - The Game Object that invoked this pipeline, if any.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#onPreRender
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#onRender
     * @since 3.50.0
     *
     * @param {Vsengine.Scene} scene - The Scene being rendered.
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The Scene Camera being rendered with.
     */
    onRender: function () {},
     ...
     * been rendered.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#onPostRender
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#onBeforeFlush
     * @since 3.50.0
     *
     * @param {boolean} [isPostFlush=false] - Was this flush invoked as part of a post-process, or not?
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#onAfterFlush
     * @since 3.50.0
     *
     * @param {boolean} [isPostFlush=false] - Was this flush invoked as part of a post-process, or not?
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#batchVert
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#batchQuad
     * @since 3.50.0
     *
     * @param {(Vsengine.GameObjects.GameObject|null)} gameObject - The Game Object, if any, drawing this quad.
     ...
     * @param {(number|boolean)} tintEffect - The tint effect for the shader to use.
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} [texture] - Texture that will be assigned to the current batch if a flush occurs.
     ...
     * ```
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#batchTri
     * @since 3.50.0
     *
     * @param {(Vsengine.GameObjects.GameObject|null)} gameObject - The Game Object, if any, drawing this quad.
     * @param {number} x1 - The bottom-left x position.
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#drawFillRect
     * @since 3.50.0
     *
     ...
     * the unit id.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#setTexture2D
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} [texture] - Texture that will be assigned to the current batch. If not given uses `whiteTexture`.
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#bindTexture
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLTextureWrapper} [target] - Texture to activate and bind.
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#bindRenderTarget
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} [target] - The Render Target to activate and bind.
     * @param {number} [unit=0] - The WebGL texture ID to activate. Defaults to `gl.TEXTURE0`.
     *
     * @return {this} This WebGL Pipeline instance.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#setTime
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {Vsengine.Renderer.WebGL.WebGLShader} [shader] - The shader to set the value on. If not given, the `currentShader` is used.
     *
     * @return {this} This WebGLPipeline instance.
     */
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#setBoolean
     * @since 3.60.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#set1f
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#set2f
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#set3f
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#set4f
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#set1fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#set2fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#set3fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#set4fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#set1iv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#set2iv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#set3iv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#set4iv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#set1i
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#set2i
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#set3i
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#set4i
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number} x - X component of the uniform.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#setMatrix2fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#setMatrix3fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {boolean} transpose - Whether to transpose the matrix. Should be `false`.
     ...
     * being set.
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#setMatrix4fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {boolean} transpose - Whether to transpose the matrix. Should be `false`.
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLPipeline#destroy
     * @fires Vsengine.Renderer.WebGL.Pipelines.Events#DESTROY
     * @since 3.0.0
     *
     * @return {this} This WebGLPipeline instance.
     */
