/**
 * @typedef {object} Vsengine.Types.Renderer.WebGL.WebGLPipelineAttributeConfig
 * @since 3.50.0
 *
 ...
 * @property {Vsengine.Types.Renderer.WebGL.WebGLConst} type - The data type of the attribute, one of the `WEBGL_CONST` values, i.e. `WEBGL_CONST.FLOAT`, `WEBGL_CONST.UNSIGNED_BYTE`, etc.
