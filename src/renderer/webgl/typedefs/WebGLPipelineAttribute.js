/**
 * @typedef {object} Vsengine.Types.Renderer.WebGL.WebGLPipelineAttribute
 * @since 3.50.0
 *
 ...
 * @property {(number|Vsengine.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper)} location - You should set this to `-1` by default. The pipeline will set it on boot.
 */
