 ...
 * @since 3.50.0
 *
 * @param {Vsengine.Renderer.WebGL.WebGLPipeline} pipeline - The WebGLPipeline to which this Shader belongs.
 ...
 * @param {Vsengine.Types.Renderer.WebGL.WebGLPipelineAttributeConfig[]} attributes - An array of attributes.
 */
var WebGLShader = new Class({
    initialize: function WebGLShader(
        pipeline,
        name,
        vertexShader,
        fragmentShader,
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLShader#pipeline
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLShader#name
         * @type {string}
         * @since 3.50.0
         */
        this.name = name;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLShader#renderer
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLShader#gl
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLShader#fragSrc
         * @type {string}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLShader#vertSrc
         * @type {string}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLShader#program
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLShader#attributes
         * @type {Vsengine.Types.Renderer.WebGL.WebGLPipelineAttribute[]}
         * @since 3.50.0
         */
        this.attributes;
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLShader#vertexComponentCount
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLShader#vertexSize
         * @type {number}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.WebGLShader#uniforms
         * @type {Vsengine.Types.Renderer.WebGL.WebGLPipelineUniformsConfig}
         * @since 3.50.0
         */
        this.uniforms = {};
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#createAttributes
     * @since 3.50.0
     *
     * @param {Vsengine.Types.Renderer.WebGL.WebGLPipelineAttributeConfig[]} attributes - An array of attributes configs.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#bind
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#rebind
     * @since 3.50.0
     *
     * @return {this} This WebGLShader instance.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#setAttribPointers
     * @since 3.50.0
     *
    ...
    setAttribPointers: function (reset) {
        ...
        for (var i = 0; i < attributes.length; i++) {
            ...
            if (reset) {
                ...
                var attribLocation = this.renderer.createAttribLocation(
                    program,
                    element.name
                );
                ...
                !enabled &&
                location !== -1 &&
                location.webGLAttribLocation > -1
            ) {
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#createUniforms
     * @since 3.50.0
     *
     * @return {this} This WebGLShader instance.
     */
            ...
            if (info) {
                ...
                if (struct > 0) {
                    ...
                    if (!uniforms.hasOwnProperty(name)) {
                        location = this.renderer.createUniformLocation(
                            program,
                            name
                        );
     ...
     * re-populate them.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#syncUniforms
     * @since 3.80.0
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#hasUniform
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#resetUniform
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#setUniform1
     * @since 3.50.0
     *
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#setUniform2
     * @since 3.50.0
     *
     * @param {function} setter - The GL function to call.
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#setUniform3
     * @since 3.50.0
     *
     * @param {function} setter - The GL function to call.
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#setUniform4
     * @since 3.50.0
     *
     * @param {function} setter - The GL function to call.
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#setBoolean
     * @since 3.60.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#set1f
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#set2f
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#set3f
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#set4f
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#set1fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#set2fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#set3fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#set4fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#set1iv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#set2iv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#set3iv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#set4iv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#set1i
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#set2i
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#set3i
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#set4i
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number} x - X component of the uniform
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#setMatrix2fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#setMatrix3fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {boolean} transpose - Whether to transpose the matrix. Should be `false`.
     ...
     * one within the pipeline it belongs to.
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#setMatrix4fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#createProgram
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.WebGLShader#destroy
     * @since 3.50.0
     */
    destroy: function () {
        var renderer = this.renderer;
