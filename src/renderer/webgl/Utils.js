...
/**
 * @namespace Vsengine.Renderer.WebGL.Utils
 * @since 3.0.0
 */
module.exports = {
    /**
     ...
     *
     * @function Vsengine.Renderer.WebGL.Utils.getTintFromFloats
     * @since 3.0.0
     *
     ...
     *
     * @function Vsengine.Renderer.WebGL.Utils.getTintAppendFloatAlpha
     * @since 3.0.0
     *
     ...
     * swizzled Uint32
     *
     * @function Vsengine.Renderer.WebGL.Utils.getTintAppendFloatAlphaAndSwap
     * @since 3.0.0
     *
     * @param {number} rgb - Uint24 representing RGB components
     * @param {number} a - Float32 representing Alpha component
     ...
     *
     * @function Vsengine.Renderer.WebGL.Utils.getFloatsFromUintRGB
     * @since 3.0.0
     *
     ...
     *
     * @function Vsengine.Renderer.WebGL.Utils.checkShaderMax
     * @since 3.50.0
     *
     ...
     *
     * @function Vsengine.Renderer.WebGL.Utils.parseFragmentShaderMaxTextures
     * @since 3.50.0
     *
     ...
     */
    parseFragmentShaderMaxTextures: function (
     ...
     *
     * @function Vsengine.Renderer.WebGL.Utils.setGlowQuality
     * @since 3.60.0
     *
     * @param {string} shader - The Fragment Shader source code to operate on.
     * @param {Vsengine.Game} game - The Vsengine Game instance.
