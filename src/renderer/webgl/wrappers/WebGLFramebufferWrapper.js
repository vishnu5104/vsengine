...
var WebGLFramebufferWrapper = new Class({
    initialize: function WebGLFramebufferWrapper(
        gl,
        width,
        height,
        renderTexture,
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper#webGLFramebuffer
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper#gl
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper#width
         * @type {number}
         * @since 3.80.0
         */
        this.width = width;
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper#height
         * @type {number}
         * @since 3.80.0
         */
        this.height = height;
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper#renderTexture
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper#addDepthStencilBuffer
         * @type {boolean}
         * @default false
         * @since 3.80.0
         */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper#createResource
     * @since 3.80.0
     */
    createResource: function () {
        ...
        if (complete !== gl.FRAMEBUFFER_COMPLETE) {
            throw new Error(
                "Framebuffer status: " + (errors[complete] || complete)
            );
        }
     ...
     *
     * @method Vsengine.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper#destroy
     * @since 3.80.0
     */
    destroy: function () {
        ...
        if (!gl.isContextLost()) {
            ...
            var colorAttachment = gl.getFramebufferAttachmentParameter(
                gl.FRAMEBUFFER,
                gl.COLOR_ATTACHMENT0,
            ...
            var depthStencilAttachment = gl.getFramebufferAttachmentParameter(
                gl.FRAMEBUFFER,
                gl.DEPTH_STENCIL_ATTACHMENT,
                gl.FRAMEBUFFER_ATTACHMENT_OBJECT_NAME
            );
