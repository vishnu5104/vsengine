...
var WebGLProgramWrapper = new Class({
    initialize: function WebGLProgramWrapper(gl, vertexSource, fragmentSource) {
        /**
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLProgramWrapper#webGLProgram
         * @type {?WebGLProgram}
         * @default null
         * @since 3.80.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLProgramWrapper#gl
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLProgramWrapper#vertexSource
         * @type {string}
         * @since 3.80.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLProgramWrapper#fragmentSource
         * @type {string}
         * @since 3.80.0
         */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Wrappers.WebGLProgramWrapper#createResource
     ...
     *
     * @method Vsengine.Renderer.WebGL.Wrappers.WebGLProgramWrapper#destroy
     * @since 3.80.0
     */
    destroy: function () {
