...
var WebGLAttribLocationWrapper = new Class({
    initialize: function WebGLAttribLocationWrapper(gl, program, name) {
        /**
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper#webGLAttribLocation
         * @type {GLint}
         * @default -1
         * @since 3.80.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper#gl
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper#program
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper#name
         * @type {string}
         * @since 3.80.0
         */
        this.name = name;
     ...
     *
     * @method Vsengine.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper#createResource
     * @since 3.80.0
     */
    createResource: function () {
        ...
        this.webGLAttribLocation = gl.getAttribLocation(
     ...
     *
     * @method Vsengine.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper#destroy
     * @since 3.80.0
     */
    destroy: function () {
        this.gl = null;
