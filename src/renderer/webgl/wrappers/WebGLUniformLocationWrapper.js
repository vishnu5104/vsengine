 ...
 * @param {Vsengine.Renderer.WebGL.Wrappers.WebGLProgramWrapper} program - The WebGLProgram that this location refers to. This must be created first.
...
var WebGLUniformLocationWrapper = new Class({
    initialize: function WebGLUniformLocationWrapper(gl, program, name) {
        /**
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLUniformLocationWrapper#webGLUniformLocation
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLUniformLocationWrapper#gl
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLUniformLocationWrapper#program
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLUniformLocationWrapper#name
         * @type {string}
         * @since 3.80.0
         */
        this.name = name;
     ...
     *
     * @method Vsengine.Renderer.WebGL.Wrappers.WebGLUniformLocationWrapper#createResource
     * @since 3.80.0
     */
    createResource: function () {
        ...
        this.webGLUniformLocation = gl.getUniformLocation(
     ...
     *
     * @method Vsengine.Renderer.WebGL.Wrappers.WebGLUniformLocationWrapper#destroy
     * @since 3.80.0
     */
    destroy: function () {
        this.gl = null;
