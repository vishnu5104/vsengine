...
var WebGLBufferWrapper = new Class({
    initialize: function WebGLBufferWrapper(
        gl,
        initialDataOrSize,
        bufferType,
        bufferUsage
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLBufferWrapper#webGLBuffer
         * @type {?WebGLBuffer}
         * @default null
         * @since 3.80.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLBufferWrapper#gl
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLBufferWrapper#initialDataOrSize
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLBufferWrapper#bufferType
         * @type {GLenum}
         * @since 3.80.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.Wrappers.WebGLBufferWrapper#bufferUsage
         * @type {GLenum}
         * @since 3.80.0
         */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Wrappers.WebGLBufferWrapper#createResource
     * @since 3.80.0
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.Wrappers.WebGLBufferWrapper#destroy
     * @since 3.80.0
     */
    destroy: function () {
        var gl = this.gl;
