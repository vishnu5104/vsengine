 ...
 * @since 3.50.0
 *
 * @param {Vsengine.Renderer.WebGL.WebGLRenderer} renderer - A reference to the WebGLRenderer.
...
var RenderTarget = new Class({
    initialize: function RenderTarget(
         ...
         *
         * @name Vsengine.Renderer.WebGL.RenderTarget#renderer
         ...
         *
         * @name Vsengine.Renderer.WebGL.RenderTarget#framebuffer
         ...
         * This is created in the `RenderTarget.resize` method.
         *
         * @name Vsengine.Renderer.WebGL.RenderTarget#texture
         ...
         *
         * @name Vsengine.Renderer.WebGL.RenderTarget#width
         * @type {number}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.RenderTarget#height
         * @type {number}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.RenderTarget#scale
         * @type {number}
         * @since 3.50.0
         */
        this.scale = scale;
         ...
         *
         * @name Vsengine.Renderer.WebGL.RenderTarget#minFilter
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.RenderTarget#autoClear
         * @type {boolean}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.RenderTarget#autoResize
         * @type {boolean}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.RenderTarget#hasDepthBuffer
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.RenderTarget#forceClamp
         * @type {boolean}
         * @since 3.60.0
         */
     ...
     *
     * @method Vsengine.Renderer.WebGL.RenderTarget#setAutoResize
     * @since 3.50.0
     *
     ...
     *
     * Previous to Vsengine v3.85 this method would only run if `autoResize` was `true`,
     * it will now run regardless.
     *
     * @method Vsengine.Renderer.WebGL.RenderTarget#resize
     * @since 3.50.0
     *
    ...
    resize: function (width, height) {
        if (this.willResize(width, height)) {
            ...
            this.texture = renderer.createTextureFromSource(
                null,
                width,
                height,
                this.minFilter,
     ...
     *
     * @method Vsengine.Renderer.WebGL.RenderTarget#willResize
     * @since 3.70.0
     *
     * @param {number} width - The new width of this Render Target.
     * @param {number} height - The new height of this Render Target.
     ...
     *
     * @method Vsengine.Renderer.WebGL.RenderTarget#bind
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.RenderTarget#adjustViewport
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.RenderTarget#clear
     * @since 3.50.0
     */
     ...
     *
     * @name Vsengine.Renderer.WebGL.RenderTarget#unbind
     * @since 3.50.0
     *
     ...
     *
     * @name Vsengine.Renderer.WebGL.RenderTarget#destroy
     * @since 3.50.0
     */
    destroy: function () {
        var renderer = this.renderer;
