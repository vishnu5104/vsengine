 ...
 * of WebGL Pipelines and Post FX Pipelines in Vsengine 3.
 *
 ...
 *
 * By default, there are 9 pipelines installed into the Pipeline Manager when Vsengine boots:
 *
 ...
 * @since 3.50.0
 *
 * @param {Vsengine.Renderer.WebGL.WebGLRenderer} renderer - A reference to the WebGL Renderer that owns this Pipeline Manager.
 */
var PipelineManager = new Class({
    initialize: function PipelineManager(renderer) {
         ...
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#game
         * @type {Vsengine.Game}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#renderer
         ...
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#classes
         * @type {Vsengine.Structs.Map.<string, Class>}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#postPipelineClasses
         * @type {Vsengine.Structs.Map.<string, Class>}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#pipelines
         * @type {Vsengine.Structs.Map.<string, Vsengine.Renderer.WebGL.WebGLPipeline>}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#postPipelineInstances
         * @type {Vsengine.Renderer.WebGL.Pipelines.PostFXPipeline[]}
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#default
         * @type {Vsengine.Renderer.WebGL.WebGLPipeline}
         * @default null
         * @since 3.60.0
         */
        this.default = null;
         ...
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#current
         * @type {Vsengine.Renderer.WebGL.WebGLPipeline}
         * @default null
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#previous
         * @type {Vsengine.Renderer.WebGL.WebGLPipeline}
         * @default null
         * @since 3.50.0
         */
         ...
         *
         * This is the default Vsengine 3 pipeline and is used by the WebGL Renderer to manage
         * camera effects and more. This property is set during the `boot` method.
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#MULTI_PIPELINE
         * @type {Vsengine.Renderer.WebGL.Pipelines.MultiPipeline}
         * @default null
         * @since 3.50.0
         */
         ...
         *
         * This is the default Vsengine 3 mask pipeline and is used Game Objects using
         * a Bitmap Mask. This property is set during the `boot` method.
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#BITMAPMASK_PIPELINE
         * @type {Vsengine.Renderer.WebGL.Pipelines.BitmapMaskPipeline}
         * @default null
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#UTILITY_PIPELINE
         * @type {Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline}
         * @default null
         * @since 3.50.0
         */
         ...
         *
         * This is the default Vsengine 3 mobile pipeline and is used by the WebGL Renderer to manage
         * camera effects and more on mobile devices. This property is set during the `boot` method.
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#MOBILE_PIPELINE
         * @type {Vsengine.Renderer.WebGL.Pipelines.MobilePipeline}
         * @default null
         * @since 3.60.0
         */
         ...
         *
         * This is the default Vsengine 3 FX pipeline and is used by the WebGL Renderer to manage
         * Game Objects with special effects enabled. This property is set during the `boot` method.
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#FX_PIPELINE
         * @type {Vsengine.Renderer.WebGL.Pipelines.FXPipeline}
         * @default null
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#fullFrame1
         ...
         * However, be aware that these targets are shared between all post fx pipelines.
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#fullFrame2
         * @type {Vsengine.Renderer.WebGL.RenderTarget}
         * @default null
         * @since 3.50.0
         */
         ...
         * However, be aware that these targets are shared between all post fx pipelines.
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#halfFrame1
         * @type {Vsengine.Renderer.WebGL.RenderTarget}
         * @default null
         * @since 3.50.0
         */
         ...
         * However, be aware that these targets are shared between all post fx pipelines.
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#halfFrame2
         * @type {Vsengine.Renderer.WebGL.RenderTarget}
         * @default null
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#renderTargets
         * @type {Vsengine.Renderer.WebGL.RenderTarget[]}
         * @since 3.60.0
         */
        this.renderTargets = [];
         ...
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#maxDimension
         * @type {number}
         * @since 3.60.0
         */
        this.maxDimension = 0;
         ...
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#frameInc
         * @type {number}
         * @since 3.60.0
         */
        this.frameInc = 32;
         ...
         *
         * @name Vsengine.Renderer.WebGL.PipelineManager#targetIndex
         * @type {number}
         * @since 3.60.0
         */
        this.targetIndex = 0;
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#boot
     * @since 3.50.0
     *
     * @param {Vsengine.Types.Core.PipelineConfig} pipelineConfig - The pipeline configuration object as set in the Game Config.
    ...
    boot: function (pipelineConfig, defaultPipeline, autoMobilePipeline) {
        ...
        this.frameInc = Math.floor(
            GetFastValue(pipelineConfig, "frameInc", 32)
        );
        ...
        if (!disablePreFX) {
            ...
            for (var i = 1; i < qty; i++) {
                ...
                targets.push(
                    new RenderTarget(renderer, targetWidth, targetWidth)
                );
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#setDefaultPipeline
     * @since 3.60.0
     *
     * @param {(string|Vsengine.Renderer.WebGL.WebGLPipeline)} pipeline - Either the string-based name of the pipeline to get, or a pipeline instance to look-up.
     *
     * @return {Vsengine.Renderer.WebGL.WebGLPipeline} The pipeline instance that was set as default, or `undefined` if not found.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#add
     * @since 3.50.0
     *
     * @param {string} name - A unique string-based key for the pipeline within the manager.
     * @param {Vsengine.Renderer.WebGL.WebGLPipeline} pipeline - A pipeline _instance_ which must extend `WebGLPipeline`.
     *
     * @return {Vsengine.Renderer.WebGL.WebGLPipeline} The pipeline instance that was passed.
     */
    add: function (name, pipeline) {
        if (pipeline.isPostFX) {
            console.warn(
                name + " is a Post Pipeline. Use `addPostPipeline` instead"
            );
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#addPostPipeline
     * @since 3.50.0
     *
     * @param {string} name - A unique string-based key for the pipeline within the manager.
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#flush
     * @since 3.50.0
     */
    flush: function () {
        if (this.current) {
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#has
     * @since 3.50.0
     *
     * @param {(string|Vsengine.Renderer.WebGL.WebGLPipeline)} pipeline - Either the string-based name of the pipeline to get, or a pipeline instance to look-up.
     *
     ...
     * If no instance, or matching name, exists in this manager, it returns `undefined`.
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#get
     * @since 3.50.0
     *
     * @param {(string|Vsengine.Renderer.WebGL.WebGLPipeline)} pipeline - Either the string-based name of the pipeline to get, or a pipeline instance to look-up.
     *
     * @return {Vsengine.Renderer.WebGL.WebGLPipeline} The pipeline instance, or `undefined` if not found.
     */
     ...
     * If no instance, or matching name, exists in this manager, it returns `undefined`.
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#getPostPipeline
     * @since 3.50.0
     *
     * @param {(string|function|Vsengine.Renderer.WebGL.Pipelines.PostFXPipeline)} pipeline - Either the string-based name of the pipeline to get, or a pipeline instance, or class to look-up.
     * @param {Vsengine.GameObjects.GameObject} [gameObject] - If this post pipeline is being installed into a Game Object or Camera, this is a reference to it.
     * @param {object} [config] - Optional pipeline data object that is set in to the `postPipelineData` property of this Game Object.
     *
     * @return {Vsengine.Renderer.WebGL.Pipelines.PostFXPipeline} The pipeline instance, or `undefined` if not found.
     */
     ...
     * this manager.
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#removePostPipeline
     * @since 3.80.0
     *
     * @param {Vsengine.Renderer.WebGL.Pipelines.PostFXPipeline} pipeline - The pipeline instance to be removed.
     */
     ...
     * this manager.
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#remove
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#set
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.WebGLPipeline} pipeline - The pipeline instance to be set as current.
     ...
     *
     * @return {Vsengine.Renderer.WebGL.WebGLPipeline} The pipeline that was set, or undefined if it couldn't be set.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#preBatch
     * @since 3.50.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - The Game Object about to be batched.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#postBatch
     * @since 3.50.0
     *
     * @param {Vsengine.GameObjects.GameObject} gameObject - The Game Object that was just added to the batch.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#preBatchCamera
     * @since 3.50.0
     *
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The Camera about to be rendered.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#postBatchCamera
     * @since 3.50.0
     *
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The Camera that was just rendered.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#isCurrent
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.WebGLPipeline} pipeline - The pipeline instance to be checked.
     * @param {Vsengine.Renderer.WebGL.WebGLShader} [currentShader] - The shader to set as being current.
     *
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#copyFrame
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} [target] - The target Render Target.
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#copyToGame
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source - The Render Target to draw from.
     */
     ...
     * The copy itself is handled by the Utility Pipeline.
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#drawFrame
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} [target] - The target Render Target.
     * @param {boolean} [clearAlpha=true] - Clear the alpha channel when running `gl.clear` on the target?
     * @param {Vsengine.Display.ColorMatrix} [colorMatrix] - The Color Matrix to use when performing the draw.
     *
     * @return {this} This Pipeline Manager instance.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#blendFrames
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source1 - The first source Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source2 - The second source Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} [target] - The target Render Target.
     ...
     * The draw itself is handled by the Utility Pipeline.
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#blendFramesAdditive
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source1 - The first source Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source2 - The second source Render Target.
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#clearFrame
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} target - The Render Target to clear.
     * @param {boolean} [clearAlpha=true] - Clear the alpha channel when running `gl.clear` on the target?
     *
     * @return {this} This Pipeline Manager instance.
     */
     ...
     * You can optionally set the brightness factor of the copy.
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#blitFrame
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} target - The target Render Target.
     ...
     * place.
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#copyFrameRect
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {Vsengine.Renderer.WebGL.RenderTarget} target - The target Render Target.
    ...
    copyFrameRect: function (
        ...
        this.UTILITY_PIPELINE.copyFrameRect(
            source,
            target,
            x,
            y,
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#forceZero
     * @since 3.50.0
     *
     ...
     *
     * This is the default Vsengine 3 rendering pipeline.
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#setMulti
     * @since 3.50.0
     *
     * @return {Vsengine.Renderer.WebGL.Pipelines.MultiPipeline} The Multi Pipeline instance.
     */
    setMulti: function () {
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#setUtility
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.WebGLShader} [currentShader] - The shader to set as being current.
     *
     * @return {Vsengine.Renderer.WebGL.Pipelines.UtilityPipeline} The Utility Pipeline instance.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#setFX
     * @since 3.60.0
     *
     * @return {Vsengine.Renderer.WebGL.Pipelines.FXPipeline} The FX Pipeline instance.
     */
    setFX: function () {
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#restoreContext
     * @since 3.80.0
     */
    ...
    /**
     * Use this to reset the gl context to the state that Vsengine requires to continue rendering.
     *
     * Calling this will:
     *
     ...
     * rendering control to Vsengine again.
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#rebind
     * @since 3.50.0
     *
     * @param {Vsengine.Renderer.WebGL.WebGLPipeline} [pipeline] - The pipeline instance to be rebound. If not given, the previous pipeline will be bound.
     */
     ...
     * you wish to return control to Vsengine again.
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#clear
     * @since 3.50.0
     */
    clear: function () {
        var renderer = this.renderer;
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#getRenderTarget
     * @since 3.60.0
     *
     * @param {number} size - The maximum dimension required.
     *
     * @return {Vsengine.Renderer.WebGL.RenderTarget} A Render Target large enough to fit the sprite.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#getSwapRenderTarget
     * @since 3.60.0
     *
     * @return {Vsengine.Renderer.WebGL.RenderTarget} The Render Target swap frame.
     */
     ...
     * useful for double-buffer style effects such as blurs.
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#getAltSwapRenderTarget
     * @since 3.60.0
     *
     * @return {Vsengine.Renderer.WebGL.RenderTarget} The Render Target swap frame.
     */
     ...
     *
     * @method Vsengine.Renderer.WebGL.PipelineManager#destroy
     * @since 3.50.0
     */
    destroy: function () {
        this.flush();
