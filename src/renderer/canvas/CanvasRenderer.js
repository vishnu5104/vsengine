 ...
 * @memberof Vsengine.Renderer.Canvas
 * @constructor
 * @since 3.0.0
 *
 * @param {Vsengine.Game} game - The Vsengine Game instance that owns this renderer.
 */
var CanvasRenderer = new Class({
    ...
    initialize: function CanvasRenderer(game) {
         ...
         *
         * @name Vsengine.Renderer.Canvas.CanvasRenderer#config
         * @type {object}
         * @since 3.0.0
         */
        this.config = {
        ...
        /**
         * The Vsengine Game instance that owns this renderer.
         *
         * @name Vsengine.Renderer.Canvas.CanvasRenderer#game
         * @type {Vsengine.Game}
         * @since 3.0.0
         */
        this.game = game;
         ...
         *
         * @name Vsengine.Renderer.Canvas.CanvasRenderer#type
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.Canvas.CanvasRenderer#drawCount
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.Canvas.CanvasRenderer#width
         * @type {number}
         * @since 3.0.0
         */
        this.width = 0;
         ...
         *
         * @name Vsengine.Renderer.Canvas.CanvasRenderer#height
         * @type {number}
         * @since 3.0.0
         */
        this.height = 0;
         ...
         *
         * @name Vsengine.Renderer.Canvas.CanvasRenderer#gameCanvas
         ...
         *
         * @name Vsengine.Renderer.Canvas.CanvasRenderer#gameContext
         * @type {CanvasRenderingContext2D}
         * @since 3.0.0
         */
        this.gameContext = gameConfig.context
            ? gameConfig.context
            : this.gameCanvas.getContext("2d", contextOptions);

        /**
         * The canvas context currently used by the CanvasRenderer for all rendering operations.
         *
         * @name Vsengine.Renderer.Canvas.CanvasRenderer#currentContext
         * @type {CanvasRenderingContext2D}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.Canvas.CanvasRenderer#antialias
         * @type {boolean}
         * @since 3.20.0
         */
         ...
         *
         * This object maps the {@link Vsengine.BlendModes} to canvas compositing operations.
         *
         * @name Vsengine.Renderer.Canvas.CanvasRenderer#blendModes
         * @type {array}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Renderer.Canvas.CanvasRenderer#snapshotState
         ...
         *
         * @name Vsengine.Renderer.Canvas.CanvasRenderer#_tempMatrix1
         * @private
         ...
         * A temporary Transform Matrix, re-used internally during batching.
         *
         * @name Vsengine.Renderer.Canvas.CanvasRenderer#_tempMatrix2
         * @private
         * @type {Vsengine.GameObjects.Components.TransformMatrix}
         * @since 3.11.0
         */
         ...
         * A temporary Transform Matrix, re-used internally during batching.
         *
         * @name Vsengine.Renderer.Canvas.CanvasRenderer#_tempMatrix3
         * @private
         * @type {Vsengine.GameObjects.Components.TransformMatrix}
         * @since 3.11.0
         */
         ...
         *
         * @name Vsengine.Renderer.Canvas.CanvasRenderer#isBooted
         * @type {boolean}
         * @since 3.50.0
         */
        this.isBooted = false;
     ...
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#init
     * @since 3.0.0
     */
    init: function () {
     ...
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#boot
     * @private
     * @since 3.50.0
     */
    boot: function () {
     ...
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#onResize
     * @since 3.16.0
     *
     * @param {Vsengine.Structs.Size} gameSize - The default Game Size object. This is the un-modified game dimensions.
     * @param {Vsengine.Structs.Size} baseSize - The base Size object. The game dimensions multiplied by the resolution. The canvas width / height values match this.
     */
     ...
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#resize
     ...
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#resetTransform
     * @since 3.0.0
     */
     ...
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#setBlendMode
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#setContext
     * @since 3.12.0
     *
     ...
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#setAlpha
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#preRender
     ...
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#render
     ...
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#postRender
     ...
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#snapshotCanvas
     * @since 3.19.0
     *
     ...
     * more expensive the larger the canvas size gets, so please be careful how you employ this in your game.
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#snapshot
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Renderer.Snapshot.SnapshotCallback} callback - The Function to invoke after the snapshot image is created.
     * @param {string} [type='image/png'] - The format of the image to create, usually `image/png` or `image/jpeg`.
     ...
     * more expensive the larger the canvas size gets, so please be careful how you employ this in your game.
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#snapshotArea
     * @since 3.16.0
     *
     ...
     * using less memory.
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#snapshotPixel
     * @since 3.16.0
     *
     ...
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#batchSprite
     * @since 3.12.0
     *
     * @param {Vsengine.GameObjects.GameObject} sprite - The texture based Game Object to draw.
     * @param {Vsengine.Textures.Frame} frame - The frame to draw, doesn't have to be that owned by the Game Object.
     ...
     *
     * @method Vsengine.Renderer.Canvas.CanvasRenderer#destroy
     * @since 3.0.0
     */
    destroy: function () {
