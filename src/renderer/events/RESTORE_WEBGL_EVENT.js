 ...
 * `webglcontextrestored`. Vsengine uses this to re-create necessary resources.
 * Please wait for Vsengine to dispatch the `RESTORE_WEBGL` event before
 * re-creating any resources of your own.
 *
 * @event Vsengine.Renderer.Events#RESTORE_WEBGL
 * @type {string}
 * @since 3.80.0
 *
 * @param {Vsengine.Renderer.WebGL.WebGLRenderer} renderer - the renderer that owns the WebGL context
 */
