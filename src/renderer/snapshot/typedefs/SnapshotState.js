/**
 * @typedef {object} Vsengine.Types.Renderer.Snapshot.SnapshotState
 * @since 3.16.1
 *
 * @property {Vsengine.Types.Renderer.Snapshot.SnapshotCallback} callback - The function to call after the snapshot is taken.
