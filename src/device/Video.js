...
/**
 * Determines the video support of the browser running this Vsengine Game instance.
 *
 ...
 *
 * In Vsengine 3.20 the properties were renamed to drop the 'Video' suffix.
 *
 * @typedef {object} Vsengine.Device.Video
 * @since 3.0.0
 *
