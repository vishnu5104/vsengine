 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Types.Time.TimerEventConfig} config - The configuration for the Timer Event, including its delay and callback.
 */
var TimerEvent = new Class({
    initialize: function TimerEvent(config) {
         ...
         *
         * @name Vsengine.Time.TimerEvent#delay
         * @type {number}
         * @default 0
         * @readonly
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Time.TimerEvent#repeat
         * @type {number}
         * @default 0
         * @readonly
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Time.TimerEvent#repeatCount
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Time.TimerEvent#loop
         * @type {boolean}
         * @default false
         * @readonly
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Time.TimerEvent#callback
         * @type {function}
         * @since 3.0.0
         */
        this.callback;
         ...
         *
         * @name Vsengine.Time.TimerEvent#callbackScope
         * @type {object}
         * @since 3.0.0
         */
        this.callbackScope;
         ...
         *
         * @name Vsengine.Time.TimerEvent#args
         * @type {array}
         * @since 3.0.0
         */
        this.args;
         ...
         *
         * @name Vsengine.Time.TimerEvent#timeScale
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Time.TimerEvent#startAt
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Time.TimerEvent#elapsed
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Time.TimerEvent#paused
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Time.TimerEvent#hasDispatched
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
     ...
     *
     * @method Vsengine.Time.TimerEvent#reset
     * @since 3.0.0
     *
     * @param {Vsengine.Types.Time.TimerEventConfig} config - The new state for the Timer Event.
     *
     * @return {Vsengine.Time.TimerEvent} This TimerEvent object.
     */
     ...
     *
     * @method Vsengine.Time.TimerEvent#getProgress
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Time.TimerEvent#getOverallProgress
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Time.TimerEvent#getRepeatCount
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Time.TimerEvent#getElapsed
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Time.TimerEvent#getElapsedSeconds
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Time.TimerEvent#getRemaining
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Time.TimerEvent#getRemainingSeconds
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Time.TimerEvent#getOverallRemaining
     * @since 3.50.0
     *
     * @return {number} The time interval in milliseconds.
     */
     ...
     *
     * @method Vsengine.Time.TimerEvent#getOverallRemainingSeconds
     * @since 3.50.0
     *
     * @return {number} The time interval in seconds.
     */
     ...
     *
     * @method Vsengine.Time.TimerEvent#remove
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Time.TimerEvent#destroy
     * @since 3.0.0
     */
    destroy: function () {
