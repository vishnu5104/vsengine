 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - The Scene which owns this Clock.
 */
var Clock = new Class({
    initialize: function Clock(scene) {
         ...
         *
         * @name Vsengine.Time.Clock#scene
         * @type {Vsengine.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name Vsengine.Time.Clock#systems
         ...
         *
         * @name Vsengine.Time.Clock#startTime
         * @type {number}
         * @since 3.60.0
         */
        this.startTime = 0;
         ...
         *
         * @name Vsengine.Time.Clock#timeScale
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Time.Clock#paused
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Time.Clock#_active
         * @type {Vsengine.Time.TimerEvent[]}
         * @private
         * @default []
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Time.Clock#_pendingInsertion
         * @type {Vsengine.Time.TimerEvent[]}
         * @private
         * @default []
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Time.Clock#_pendingRemoval
         * @type {Vsengine.Time.TimerEvent[]}
         * @private
         * @default []
         * @since 3.0.0
     ...
     *
     * @method Vsengine.Time.Clock#boot
     * @private
     * @since 3.5.1
     */
    boot: function () {
     ...
     * Do not invoke it directly.
     *
     * @method Vsengine.Time.Clock#start
     * @private
     * @since 3.5.0
     */
    start: function () {
     ...
     *
     * @method Vsengine.Time.Clock#addEvent
     * @since 3.0.0
     *
     * @param {(Vsengine.Time.TimerEvent | Vsengine.Types.Time.TimerEventConfig)} config - The configuration for the Timer Event, or an existing Timer Event object.
     *
     * @return {Vsengine.Time.TimerEvent} The Timer Event which was created, or passed in.
     */
     ...
     *
     * @method Vsengine.Time.Clock#delayedCall
     * @since 3.0.0
     *
     ...
     *
     * @return {Vsengine.Time.TimerEvent} The Timer Event which was created.
     */
     ...
     *
     * @method Vsengine.Time.Clock#clearPendingEvents
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Time.Clock#removeEvent
     * @since 3.50.0
     *
     * @param {(Vsengine.Time.TimerEvent | Vsengine.Time.TimerEvent[])} events - The Timer Event, or an array of Timer Events, to remove from this Clock.
     *
     * @return {this} - This Clock instance.
     */
     ...
     *
     * @method Vsengine.Time.Clock#removeAllEvents
     * @since 3.0.0
     *
     * @return {this} - This Clock instance.
     */
     ...
     *
     * @method Vsengine.Time.Clock#preUpdate
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Time.Clock#update
     * @since 3.0.0
     *
     * @param {number} time - The current time. Either a High Resolution Timer value if it comes from Request Animation Frame, or Date.now if using SetTimeout.
     * @param {number} delta - The delta time in ms since the last frame. This is a smoothed and capped value based on the FPS rate.
     ...
     *
     * @method Vsengine.Time.Clock#shutdown
     * @private
     * @since 3.0.0
     */
    shutdown: function () {
     ...
     *
     * @method Vsengine.Time.Clock#destroy
     * @private
     * @since 3.0.0
     */
    destroy: function () {
