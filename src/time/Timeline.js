 ...
 * {@link Vsengine.Types.Time.TimelineEventConfig} typedef for more details.
 *
 * @class Timeline
 * @extends Vsengine.Events.EventEmitter
 * @memberof Vsengine.Time
 * @constructor
 * @since 3.60.0
 *
 * @param {Vsengine.Scene} scene - The Scene which owns this Timeline.
 * @param {Vsengine.Types.Time.TimelineEventConfig|Vsengine.Types.Time.TimelineEventConfig[]} [config] - The configuration object for this Timeline Event, or an array of them.
 */
var Timeline = new Class({
    ...
    initialize: function Timeline(scene, config) {
         ...
         *
         * @name Vsengine.Time.Timeline#scene
         * @type {Vsengine.Scene}
         * @since 3.60.0
         */
        this.scene = scene;
         ...
         *
         * @name Vsengine.Time.Timeline#systems
         ...
         *
         * @name Vsengine.Time.Timeline#elapsed
         * @type {number}
         * @since 3.60.0
         */
        this.elapsed = 0;
         ...
         *
         * @name Vsengine.Time.Timeline#timeScale
         * @type {number}
         * @default
         * @since 3.85.0
         */
         ...
         *
         * @name Vsengine.Time.Timeline#paused
         * @type {boolean}
         * @default true
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Time.Timeline#complete
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         * Treat this as read-only.
         *
         * @name Vsengine.Time.Timeline#totalComplete
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name Vsengine.Time.Timeline#loop
         * @type {number}
         * @since 3.80.0
         */
        this.loop = 0;
         ...
         *
         * @name Vsengine.Time.Timeline#iteration
         * @type {number}
         * @since 3.80.0
         */
        this.iteration = 0;
         ...
         *
         * @name Vsengine.Time.Timeline#events
         * @type {Vsengine.Types.Time.TimelineEvent[]}
         * @since 3.60.0
         */
        this.events = [];
     ...
     *
     * @method Vsengine.Time.Timeline#preUpdate
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Time.Timeline#update
     * @fires Vsengine.Time.Events#COMPLETE
     * @since 3.60.0
     *
     * @param {number} time - The current time. Either a High Resolution Timer value if it comes from Request Animation Frame, or Date.now if using SetTimeout.
     * @param {number} delta - The delta time in ms since the last frame. This is a smoothed and capped value based on the FPS rate.
     ...
     *
     * @method Vsengine.Time.Timeline#play
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Time.Timeline#pause
     * @since 3.60.0
     *
     * @return {this} This Timeline instance.
     */
     ...
     *
     * @method Vsengine.Time.Timeline#repeat
     * @since 3.80.0
     *
     ...
     *
     * @method Vsengine.Time.Timeline#resume
     * @since 3.60.0
     *
     * @return {this} This Timeline instance.
     */
     ...
     *
     * @method Vsengine.Time.Timeline#stop
     * @since 3.60.0
     *
     * @return {this} This Timeline instance.
     */
     ...
     *
     * @method Vsengine.Time.Timeline#reset
     * @since 3.60.0
     *
     ...
     * ```
     *
     * @method Vsengine.Time.Timeline#add
     * @since 3.60.0
     *
     * @param {Vsengine.Types.Time.TimelineEventConfig|Vsengine.Types.Time.TimelineEventConfig[]} config - The configuration object for this Timeline Event, or an array of them.
     *
     ...
     *
     * @method Vsengine.Time.Timeline#clear
     * @since 3.60.0
     *
     * @return {this} This Timeline instance.
     */
     ...
     *
     * @method Vsengine.Time.Timeline#isPlaying
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Time.Timeline#getProgress
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Time.Timeline#destroy
     * @since 3.60.0
     */
    destroy: function () {
        var eventEmitter = this.systems.events;
 ...
 * {@link Vsengine.Types.Time.TimelineEventConfig} typedef for more details.
 *
 * @method Vsengine.GameObjects.GameObjectFactory#timeline
 * @since 3.60.0
 *
 * @param {Vsengine.Types.Time.TimelineEventConfig|Vsengine.Types.Time.TimelineEventConfig[]} config - The configuration object for this Timeline Event, or an array of them.
 *
 * @return {Vsengine.Time.Timeline} The Timeline that was created.
 */
