 ...
 *
 * @function Vsengine.Geom.Rectangle.MarchingAnts
 * @since 3.0.0
 *
 * @generic {Vsengine.Geom.Point[]} O - [out,$return]
 *
 * @param {Vsengine.Geom.Rectangle} rect - The Rectangle to get the perimeter points from.
 ...
 * @param {(array|Vsengine.Geom.Point[])} [out] - An array in which the perimeter points will be stored. If not given, a new array instance is created.
 *
 * @return {(array|Vsengine.Geom.Point[])} An array containing the perimeter points from the Rectangle.
 */
