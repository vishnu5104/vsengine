 ...
 *
 * @function Vsengine.Geom.Rectangle.Inflate
 * @since 3.0.0
 *
 * @generic {Vsengine.Geom.Rectangle} O - [rect,$return]
 *
 * @param {Vsengine.Geom.Rectangle} rect - The Rectangle to inflate.
 ...
 *
 * @return {Vsengine.Geom.Rectangle} The inflated Rectangle.
 */
