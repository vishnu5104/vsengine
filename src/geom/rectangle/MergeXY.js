 ...
 *
 * @function Vsengine.Geom.Rectangle.MergeXY
 * @since 3.0.0
 *
 * @generic {Vsengine.Geom.Rectangle} O - [target,$return]
 *
 * @param {Vsengine.Geom.Rectangle} target - The Rectangle which should be merged and modified.
 ...
 *
 * @return {Vsengine.Geom.Rectangle} The modified `target` Rectangle.
 */
