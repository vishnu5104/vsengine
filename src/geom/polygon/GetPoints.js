 ...
 *
 * @function Vsengine.Geom.Polygon.GetPoints
 * @since 3.12.0
 *
 * @param {Vsengine.Geom.Polygon} polygon - The Polygon to get the points from.
 ...
 *
 * @return {Vsengine.Geom.Point[]} An array of Point objects pertaining to the points around the perimeter of the Polygon.
 */
var GetPoints = function (polygon, quantity, stepRate, out) {
    ...
    for (var i = 0; i < quantity; i++) {
        ...
        for (var j = 0; j < points.length; j++) {
            ...
            if (
                position < accumulatedPerimeter ||
                position > accumulatedPerimeter + length
            ) {
