 ...
 *
 * @function Vsengine.Geom.Polygon.Smooth
 * @since 3.13.0
 *
 * @generic {Vsengine.Geom.Polygon} O - [polygon,$return]
 *
 * @param {Vsengine.Geom.Polygon} polygon - The polygon to be smoothed. The polygon will be modified in-place and returned.
 *
