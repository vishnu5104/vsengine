 ...
 *
 * @function Vsengine.Geom.Point.GetCentroid
 * @since 3.0.0
 *
 * @generic {Vsengine.Geom.Point} O - [out,$return]
 *
 * @param {Vsengine.Types.Math.Vector2Like[]} points - An array of Vector2Like objects to get the geometric center of.
 * @param {Vsengine.Geom.Point} [out] - A Point object to store the output coordinates in. If not given, a new Point instance is created.
 *
 * @return {Vsengine.Geom.Point} A Point object representing the geometric center of the given points.
 */
