...
var Vertex = new Class({
    ...
    initialize: function Vertex(x, y, z, u, v, color, alpha, nx, ny, nz) {
         ...
         *
         * @name Vsengine.Geom.Mesh.Vertex#vx
         * @type {number}
         * @since 3.50.0
         */
        this.vx = 0;
         ...
         *
         * @name Vsengine.Geom.Mesh.Vertex#vy
         * @type {number}
         * @since 3.50.0
         */
        this.vy = 0;
         ...
         *
         * @name Vsengine.Geom.Mesh.Vertex#vz
         * @type {number}
         * @since 3.50.0
         */
        this.vz = 0;
         ...
         *
         * @name Vsengine.Geom.Mesh.Vertex#nx
         * @type {number}
         * @since 3.50.0
         */
        this.nx = nx;
         ...
         *
         * @name Vsengine.Geom.Mesh.Vertex#ny
         * @type {number}
         * @since 3.50.0
         */
        this.ny = ny;
         ...
         *
         * @name Vsengine.Geom.Mesh.Vertex#nz
         * @type {number}
         * @since 3.50.0
         */
        this.nz = nz;
         ...
         *
         * @name Vsengine.Geom.Mesh.Vertex#u
         * @type {number}
         * @since 3.50.0
         */
        this.u = u;
         ...
         *
         * @name Vsengine.Geom.Mesh.Vertex#v
         * @type {number}
         * @since 3.50.0
         */
        this.v = v;
         ...
         *
         * @name Vsengine.Geom.Mesh.Vertex#color
         * @type {number}
         * @since 3.50.0
         */
        this.color = color;
         ...
         *
         * @name Vsengine.Geom.Mesh.Vertex#alpha
         * @type {number}
         * @since 3.50.0
         */
        this.alpha = alpha;
         ...
         *
         * @name Vsengine.Geom.Mesh.Vertex#tx
         * @type {number}
         * @since 3.50.0
         */
        this.tx = 0;
         ...
         *
         * @name Vsengine.Geom.Mesh.Vertex#ty
         * @type {number}
         * @since 3.50.0
         */
        this.ty = 0;
         ...
         *
         * @name Vsengine.Geom.Mesh.Vertex#ta
         * @type {number}
         * @since 3.50.0
         */
        this.ta = 0;
         ...
         *
         * @name Vsengine.Geom.Mesh.Vertex#tu
         * @type {number}
         * @since 3.60.0
         */
        this.tu = u;
         ...
         *
         * @name Vsengine.Geom.Mesh.Vertex#tv
         * @type {number}
         * @since 3.60.0
         */
        this.tv = v;
     ...
     *
     * @method Vsengine.Geom.Mesh.Vertex#setUVs
     * @since 3.50.0
     *
     * @param {number} u - The UV u coordinate of the vertex.
     * @param {number} v - The UV v coordinate of the vertex.
     ...
     * are updated.
     *
     * @method Vsengine.Geom.Mesh.Vertex#scrollUV
     * @since 3.60.0
     *
     ...
     * are updated.
     *
     * @method Vsengine.Geom.Mesh.Vertex#scaleUV
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Geom.Mesh.Vertex#transformCoordinatesLocal
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Geom.Mesh.Vertex#resize
     * @since 3.60.0
     *
     * @param {number} x - The x position of the vertex.
     * @param {number} y - The y position of the vertex.
     ...
     *
     * @method Vsengine.Geom.Mesh.Vertex#update
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Geom.Mesh.Vertex#load
     * @since 3.50.0
     *
