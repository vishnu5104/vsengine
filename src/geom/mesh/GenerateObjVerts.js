 ...
 *
 * ```javascript
 * var data = Vsengine.Geom.Mesh.ParseObj(rawData, flipUV);
 *
 ...
 *
 * @function Vsengine.Geom.Mesh.GenerateObjVerts
 * @since 3.50.0
 *
 * @param {Vsengine.Types.Geom.Mesh.OBJData} data - The parsed OBJ model data.
 * @param {Vsengine.GameObjects.Mesh} [mesh] - An optional Mesh Game Object. If given, the generated Faces will be automatically added to this Mesh. Set to `null` to skip.
 ...
 *
 * @return {Vsengine.Types.Geom.Mesh.GenerateVertsResult} The parsed Face and Vertex objects.
 */
var GenerateObjVerts = function (
    data,
    mesh,
    scale,
    x,
