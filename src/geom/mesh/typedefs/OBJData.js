/**
 * @typedef {object} Vsengine.Types.Geom.Mesh.OBJData
 * @since 3.50.0
 *
 ...
 * @property {Vsengine.Types.Geom.Mesh.OBJModel[]} models - An array of parsed models extracted from the OBJ file.
 */
