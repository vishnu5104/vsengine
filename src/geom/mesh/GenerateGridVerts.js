 ...
 *
 * @function Vsengine.Geom.Mesh.GenerateGridVerts
 * @since 3.50.0
 *
 * @param {Vsengine.Types.Geom.Mesh.GenerateGridConfig} config - A Grid configuration object.
 *
 * @return {Vsengine.Types.Geom.Mesh.GenerateGridVertsResult} A Grid Result object, containing the generated vertices and indicies.
 */
var GenerateGridVerts = function (config) {
    ...
    var isOrtho = GetFastValue(
        config,
        "isOrtho",
        mesh ? mesh.dirtyCache[11] : false
    );
