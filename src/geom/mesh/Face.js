...
var Face = new Class({
    initialize: function Face(vertex1, vertex2, vertex3) {
         ...
         *
         * @name Vsengine.Geom.Mesh.Face#vertex1
         ...
         *
         * @name Vsengine.Geom.Mesh.Face#vertex2
         * @type {Vsengine.Geom.Mesh.Vertex}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Geom.Mesh.Face#vertex3
         * @type {Vsengine.Geom.Mesh.Vertex}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Geom.Mesh.Face#bounds
         ...
         *
         * @name Vsengine.Geom.Mesh.Face#_inCenter
     ...
     *
     * @method Vsengine.Geom.Mesh.Face#getInCenter
     * @since 3.50.0
     *
     * @param {boolean} [local=true] Return the in center from the un-transformed vertex positions (`true`), or transformed? (`false`)
     *
     * @return {Vsengine.Math.Vector2} A Vector2 containing the in center position of this Face.
     */
     ...
     *
     * @method Vsengine.Geom.Mesh.Face#contains
     * @since 3.50.0
     *
     * @param {number} x - The horizontal position to check.
     * @param {number} y - The vertical position to check.
     * @param {Vsengine.GameObjects.Components.TransformMatrix} [calcMatrix] - Optional transform matrix to apply to the vertices before comparison.
     *
     ...
     *
     * @method Vsengine.Geom.Mesh.Face#isCounterClockwise
     * @since 3.50.0
     *
    ...
    isCounterClockwise: function (z) {
        ...
        var d =
            (v2.vx - v1.vx) * (v3.vy - v1.vy) -
            (v2.vy - v1.vy) * (v3.vx - v1.vx);
     ...
     *
     * @method Vsengine.Geom.Mesh.Face#load
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Geom.Mesh.Face#transformCoordinatesLocal
     * @since 3.50.0
     *
     * @param {Vsengine.Math.Matrix4} transformMatrix - The transform matrix to apply to this vertex.
     ...
     */
    transformCoordinatesLocal: function (
        transformMatrix,
        width,
        height,
        cameraZ
    ) {
        this.vertex1.transformCoordinatesLocal(
            transformMatrix,
            width,
            height,
            cameraZ
        );
        this.vertex2.transformCoordinatesLocal(
            transformMatrix,
            width,
            height,
            cameraZ
     ...
     *
     * @method Vsengine.Geom.Mesh.Face#updateBounds
     * @since 3.50.0
     *
     * @return {this} This Face instance.
     */
     ...
     * rectangle.
     *
     * @method Vsengine.Geom.Mesh.Face#isInView
     * @since 3.50.0
     *
     * @param {Vsengine.Cameras.Scene2D.Camera} camera - The Camera to check against.
     ...
     * are updated.
     *
     * @method Vsengine.Geom.Mesh.Face#scrollUV
     * @since 3.60.0
     *
     ...
     * are updated.
     *
     * @method Vsengine.Geom.Mesh.Face#scaleUV
     * @since 3.60.0
     *
     ...
     *
     * @method Vsengine.Geom.Mesh.Face#setColor
     * @since 3.60.0
     *
     ...
     * with the new translated values, updating their `tx`, `ty` and `ta` properties.
     *
     * @method Vsengine.Geom.Mesh.Face#update
     * @since 3.60.0
     *
     * @param {number} alpha - The alpha of the parent object.
     * @param {number} a - The parent transform matrix data a component.
     ...
     *
     * @method Vsengine.Geom.Mesh.Face#translate
     * @since 3.50.0
     *
     ...
     *
     * @name Vsengine.Geom.Mesh.Face#x
     * @type {number}
     * @since 3.50.0
     */
    x: {
     ...
     *
     * @name Vsengine.Geom.Mesh.Face#y
     * @type {number}
     * @since 3.50.0
     */
    y: {
     ...
     *
     * @name Vsengine.Geom.Mesh.Face#alpha
     * @type {number}
     * @since 3.50.0
     */
    alpha: {
     ...
     *
     * @name Vsengine.Geom.Mesh.Face#depth
     * @type {number}
     * @readonly
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.Geom.Mesh.Face#destroy
     * @since 3.50.0
     */
    destroy: function () {
        this.vertex1 = null;
