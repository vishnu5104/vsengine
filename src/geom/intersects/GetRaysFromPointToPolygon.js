 ...
 *
 * @function Vsengine.Geom.Intersects.GetRaysFromPointToPolygon
 * @since 3.50.0
 *
 * @param {number} x - The x coordinate to project the rays from.
 * @param {number} y - The y coordinate to project the rays from.
 * @param {Vsengine.Geom.Polygon | Vsengine.Geom.Polygon[]} polygons - A single polygon, or array of polygons, to check against the rays.
 *
 * @return {Vsengine.Math.Vector4[]} An array containing all intersections in Vector4s.
 */
