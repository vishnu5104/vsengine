 ...
 *
 * @function Vsengine.Geom.Intersects.LineToCircle
 * @since 3.0.0
 *
 * @param {Vsengine.Geom.Line} line - The line segment to check.
 * @param {Vsengine.Geom.Circle} circle - The circle to check against the line.
 * @param {(Vsengine.Geom.Point|any)} [nearest] - An optional Point-like object. If given the closest point on the Line where the circle intersects will be stored in this object.
 *
