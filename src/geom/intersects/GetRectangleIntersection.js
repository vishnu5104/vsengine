 ...
 *
 * @function Vsengine.Geom.Intersects.GetRectangleIntersection
 * @since 3.0.0
 *
 * @generic {Vsengine.Geom.Rectangle} O - [output,$return]
 *
 * @param {Vsengine.Geom.Rectangle} rectA - The first Rectangle object.
 * @param {Vsengine.Geom.Rectangle} rectB - The second Rectangle object.
 * @param {Vsengine.Geom.Rectangle} [output] - Optional Rectangle object. If given, the intersection data will be loaded into it (in case of no intersection, it will be left unchanged). Otherwise, new Rectangle object will be created and returned with either intersection data or empty (all values set to zero), if there is no intersection.
 *
 * @return {Vsengine.Geom.Rectangle} A rectangle object with intersection data.
 */
