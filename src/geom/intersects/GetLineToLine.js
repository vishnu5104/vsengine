 ...
 *
 * @function Vsengine.Geom.Intersects.GetLineToLine
 * @since 3.50.0
 *
 * @param {Vsengine.Geom.Line} line1 - The first line segment, or a ray, to check.
 * @param {Vsengine.Geom.Line} line2 - The second line segment to check.
