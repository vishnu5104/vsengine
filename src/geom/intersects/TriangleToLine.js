 ...
 *
 * @function Vsengine.Geom.Intersects.TriangleToLine
 * @since 3.0.0
 *
 * @param {Vsengine.Geom.Triangle} triangle - The Triangle to check with.
 * @param {Vsengine.Geom.Line} line - The Line to check with.
 *
...
var TriangleToLine = function (triangle, line) {
    ...
    if (
        triangle.contains(line.x1, line.y1) ||
        triangle.contains(line.x2, line.y2)
    ) {
        return true;
    }
