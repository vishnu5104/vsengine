 ...
 *
 * @function Vsengine.Geom.Intersects.GetRectangleToRectangle
 * @since 3.0.0
 *
 * @param {Vsengine.Geom.Rectangle} rectA - The first Rectangle to check for intersection.
 * @param {Vsengine.Geom.Rectangle} rectB - The second Rectangle to check for intersection.
