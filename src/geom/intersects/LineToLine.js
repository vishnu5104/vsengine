 ...
 *
 * @function Vsengine.Geom.Intersects.LineToLine
 * @since 3.0.0
 *
 * @param {Vsengine.Geom.Line} line1 - The first Line to check.
 * @param {Vsengine.Geom.Line} line2 - The second Line to check.
 * @param {Vsengine.Types.Math.Vector2Like} [out] - An optional point-like object in which to store the coordinates of intersection, if needed.
 *
