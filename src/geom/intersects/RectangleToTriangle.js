 ...
 *
 * @function Vsengine.Geom.Intersects.RectangleToTriangle
 * @since 3.0.0
 *
 * @param {Vsengine.Geom.Rectangle} rect - Rectangle object to test.
 * @param {Vsengine.Geom.Triangle} triangle - Triangle object to test.
 *
...
var RectangleToTriangle = function (rect, triangle) {
    ...
    if (
        LineToLine(triA, rectA) ||
        LineToLine(triA, rectB) ||
        LineToLine(triA, rectC) ||
        LineToLine(triA, rectD)
    ) {
        return true;
    }

    if (
        LineToLine(triB, rectA) ||
        LineToLine(triB, rectB) ||
        LineToLine(triB, rectC) ||
        LineToLine(triB, rectD)
    ) {
        return true;
    }

    if (
        LineToLine(triC, rectA) ||
        LineToLine(triC, rectB) ||
        LineToLine(triC, rectC) ||
        LineToLine(triC, rectD)
    ) {
        return true;
    }
