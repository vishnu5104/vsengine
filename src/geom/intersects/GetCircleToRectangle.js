 ...
 *
 * @function Vsengine.Geom.Intersects.GetCircleToRectangle
 * @since 3.0.0
 *
 * @param {Vsengine.Geom.Circle} circle - The circle to be checked.
 * @param {Vsengine.Geom.Rectangle} rect - The rectangle to be checked.
