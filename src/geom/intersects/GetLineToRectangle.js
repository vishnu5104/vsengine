 ...
 *
 * @function Vsengine.Geom.Intersects.GetLineToRectangle
 * @since 3.0.0
 *
 * @param {Vsengine.Geom.Line} line - The Line to check for intersection.
 * @param {(Vsengine.Geom.Rectangle|object)} rect - The Rectangle to check for intersection.
