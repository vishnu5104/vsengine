 ...
 *
 * @function Vsengine.Geom.Intersects.GetTriangleToCircle
 * @since 3.0.0
 *
 * @param {Vsengine.Geom.Triangle} triangle - The Triangle to check for intersection.
 * @param {Vsengine.Geom.Circle} circle - The Circle to check for intersection.
