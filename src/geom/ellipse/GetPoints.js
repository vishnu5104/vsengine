 ...
 *
 * @function Vsengine.Geom.Ellipse.GetPoints
 * @since 3.0.0
 *
 * @generic {Vsengine.Geom.Point[]} O - [out,$return]
 *
 * @param {Vsengine.Geom.Ellipse} ellipse - The Ellipse to get the points from.
 ...
 * @param {(array|Vsengine.Geom.Point[])} [out] - An array to insert the points in to. If not provided a new array will be created.
 *
