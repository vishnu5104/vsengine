 ...
 *
 * ```javascript
 * const line = new Vsengine.Geom.Line(100, 300, 700, 300);
 * const points = Vsengine.Geom.Line.GetEasedPoints(line, 'sine.out', 32)
 * ```
 *
 ...
 *
 * @function Vsengine.Geom.Line.GetEasedPoints
 * @since 3.23.0
 *
 * @generic {Vsengine.Geom.Point[]} O - [out,$return]
 *
 * @param {Vsengine.Geom.Line} line - The Line object.
 ...
 *
 * @return {Vsengine.Geom.Point[]} An array of Geom.Points containing the coordinates of the points on the line.
 */
var GetEasedPoints = function (
    line,
    ease,
    quantity,
    collinearThreshold,
