 ...
 *
 * @function Vsengine.Geom.Line.BresenhamPoints
 * @since 3.0.0
 *
 * @param {Vsengine.Geom.Line} line - The line.
 * @param {number} [stepRate=1] - The optional step rate for the points on the line.
 * @param {Vsengine.Types.Math.Vector2Like[]} [results] - An optional array to push the resulting coordinates into.
 *
 * @return {Vsengine.Types.Math.Vector2Like[]} The array of coordinates on the line.
 */
