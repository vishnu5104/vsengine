 ...
 *
 * @function Vsengine.Geom.Line.GetShortestDistance
 * @since 3.16.0
 *
 * @param {Vsengine.Geom.Line} line - The line to get the distance from.
 * @param {Vsengine.Types.Math.Vector2Like} point - The point to get the shortest distance to.
 *
