 ...
 *
 * @function Vsengine.Geom.Circle.Equals
 * @since 3.0.0
 *
 * @param {Vsengine.Geom.Circle} circle - The first Circle to compare.
 * @param {Vsengine.Geom.Circle} toCompare - The second Circle to compare.
 *
