 ...
 *
 * @function Vsengine.Geom.Triangle.InCenter
 * @since 3.0.0
 *
 * @generic {Vsengine.Geom.Point} O - [out,$return]
 *
 * @param {Vsengine.Geom.Triangle} triangle - The Triangle to find the incenter of.
 * @param {Vsengine.Geom.Point} [out] - An optional Point in which to store the coordinates.
 *
 * @return {Vsengine.Geom.Point} Point (x, y) of the center pixel of the triangle.
 */
