 ...
 *
 * @function Vsengine.Geom.Triangle.BuildFromPolygon
 * @since 3.0.0
 *
 * @generic {Vsengine.Geom.Triangle[]} O - [out,$return]
 *
 ...
 * @param {(array|Vsengine.Geom.Triangle[])} [out] - An array to store the resulting Triangle instances in. If not provided, a new array is created.
 *
 * @return {(array|Vsengine.Geom.Triangle[])} An array of Triangle instances, where each triangle is based on the decomposed vertices data.
 */
