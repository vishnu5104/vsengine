 ...
 *
 * @function Vsengine.Geom.Triangle.Equals
 * @since 3.0.0
 *
 * @param {Vsengine.Geom.Triangle} triangle - The first triangle to check.
 * @param {Vsengine.Geom.Triangle} toCompare - The second triangle to check.
 *
