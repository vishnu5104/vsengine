 ...
 *
 * @function Vsengine.Geom.Triangle.ContainsArray
 * @since 3.0.0
 *
 * @param {Vsengine.Geom.Triangle} triangle - The triangle that the points are being checked in.
 * @param {Vsengine.Geom.Point[]} points - An array of point-like objects (objects that have an `x` and `y` property)
 ...
 *
 * @return {Vsengine.Geom.Point[]} An array containing all the points from `points` that are within the triangle, if an array was provided as `out`, points will be appended to that array and it will also be returned here.
 */
