 ...
 *
 * @function Vsengine.Geom.Triangle.CircumCircle
 * @since 3.0.0
 *
 * @generic {Vsengine.Geom.Circle} O - [out,$return]
 *
 * @param {Vsengine.Geom.Triangle} triangle - The Triangle to use as input.
 * @param {Vsengine.Geom.Circle} [out] - An optional Circle to store the result in.
 *
 * @return {Vsengine.Geom.Circle} The updated `out` Circle, or a new Circle if none was provided.
 */
