 ...
 *
 * @function Vsengine.Geom.Triangle.CircumCenter
 * @since 3.0.0
 *
 * @generic {Vsengine.Math.Vector2} O - [out,$return]
 *
 * @param {Vsengine.Geom.Triangle} triangle - The Triangle to get the circumcenter of.
 * @param {Vsengine.Math.Vector2} [out] - The Vector2 object to store the position in. If not given, a new Vector2 instance is created.
 *
 * @return {Vsengine.Math.Vector2} A Vector2 object holding the coordinates of the circumcenter of the Triangle.
 */
