 ...
 *
 * @function Vsengine.Geom.Triangle.Centroid
 * @since 3.0.0
 *
 * @generic {Vsengine.Geom.Point} O - [out,$return]
 *
 * @param {Vsengine.Geom.Triangle} triangle - The Triangle to use.
 * @param {(Vsengine.Geom.Point|object)} [out] - An object to store the coordinates in.
 *
 * @return {(Vsengine.Geom.Point|object)} The `out` object with modified `x` and `y` properties, or a new Point if none was provided.
 */
