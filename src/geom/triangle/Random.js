 ...
 *
 * @function Vsengine.Geom.Triangle.Random
 * @since 3.0.0
 *
 * @generic {Vsengine.Geom.Point} O - [out,$return]
 *
 * @param {Vsengine.Geom.Triangle} triangle - The Triangle to get a random point from.
 * @param {Vsengine.Geom.Point} [out] - The Point object to store the position in. If not given, a new Point instance is created.
 *
 * @return {Vsengine.Geom.Point} A Point object holding the coordinates of a random position within the Triangle.
 */
