 ...
 *
 * @function Vsengine.Geom.Triangle.GetPoints
 * @since 3.0.0
 *
 * @generic {Vsengine.Geom.Point} O - [out,$return]
 *
 * @param {Vsengine.Geom.Triangle} triangle - The Triangle to get the points from.
 ...
 * @param {(array|Vsengine.Geom.Point[])} [out] - An array to which the points should be appended.
 *
 * @return {(array|Vsengine.Geom.Point[])} The modified `out` array, or a new array if none was provided.
 */
