 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Types.Tilemaps.LayerDataConfig} [config] - The Layer Data configuration object.
 */
var LayerData = new Class({
    initialize: function LayerData(config) {
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#name
         * @type {string}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#id
         * @type {number}
         * @since 3.70.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#x
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#y
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#width
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#height
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#tileWidth
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#tileHeight
         * @type {number}
         * @since 3.0.0
         */
         ...
         * The base tile width.
         *
         * @name Vsengine.Tilemaps.LayerData#baseTileWidth
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#baseTileHeight
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#orientation
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#widthInPixels
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#heightInPixels
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#alpha
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#visible
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#properties
         * @type {object[]}
         * @since 3.0.0
         */
         ...
         * Tile ID index map.
         *
         * @name Vsengine.Tilemaps.LayerData#indexes
         * @type {array}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#collideIndexes
         * @type {array}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#callbacks
         * @type {array}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#bodies
         * @type {array}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#data
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#tilemapLayer
         ...
         *
         * @name Vsengine.Tilemaps.LayerData#hexSideLength
         * @type {number}
         * @since 3.50.0
         */
         ...
         * Only used for hexagonal orientation Tilemaps.
         *
         * @name Vsengine.Tilemaps.LayerData#staggerAxis
         * @type {string}
         * @since 3.60.0
         */
         ...
         * Only used for hexagonal orientation Tilemaps.
         *
         * @name Vsengine.Tilemaps.LayerData#staggerIndex
         * @type {string}
         * @since 3.60.0
         */
