 ...
 * @param {Vsengine.Tilemaps.Tilemap} tilemap - The Tilemap this layer is a part of.
...
var TilemapLayer = new Class({
    ...
    initialize: function TilemapLayer(
        scene,
        tilemap,
        layerIndex,
        tileset,
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#isTilemap
         * @type {boolean}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#tilemap
         * @type {Vsengine.Tilemaps.Tilemap}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#layerIndex
         * @type {number}
         * @since 3.50.0
         */
         ...
         * tilemap layer.
         *
         * @name Vsengine.Tilemaps.TilemapLayer#layer
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#tileset
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#tilesDrawn
         * @type {number}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#tilesTotal
         * @type {number}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#culledTiles
         * @type {Vsengine.Tilemaps.Tile[]}
         * @since 3.50.0
         */
        this.culledTiles = [];
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#skipCull
         * @type {boolean}
         * @since 3.50.0
         */
        this.skipCull = false;
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#cullPaddingX
         * @type {number}
         * @default 1
         * @since 3.50.0
         */
         ...
         * See the method `setCullPadding` for more details.
         *
         * @name Vsengine.Tilemaps.TilemapLayer#cullPaddingY
         * @type {number}
         * @default 1
         * @since 3.50.0
         */
         ...
         *
         * 1. The Vsengine.Tilemaps.LayerData object for this Layer
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#cullCallback
         * @type {function}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#_renderOrder
         * @type {number}
         * @default 0
         * @private
         * @since 3.50.0
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#gidMap
         * @type {Vsengine.Tilemaps.Tileset[]}
         * @since 3.50.0
         */
        this.gidMap = [];
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#tempVec
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#collisionCategory
         * @type {number}
         * @since 3.70.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#collisionMask
         * @type {number}
         * @since 3.70.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#originX
         * @type {number}
         * @default 0
         * @readOnly
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#originY
         * @type {number}
         * @default 0
         * @readOnly
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#displayOriginX
         * @type {number}
         * @default 0
         * @readOnly
         * @since 3.0.0
         ...
         *
         * @name Vsengine.Tilemaps.TilemapLayer#displayOriginY
         * @type {number}
         * @default 0
         * @readOnly
         * @since 3.0.0
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#setTilesets
     * @private
     * @since 3.50.0
     *
     * @param {(string|string[]|Vsengine.Tilemaps.Tileset|Vsengine.Tilemaps.Tileset[])} tileset - The tileset, or an array of tilesets, used to render this layer. Can be a string or a Tileset object.
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#setRenderOrder
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#calculateFacesAt
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#calculateFacesWithin
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#createFromTiles
     * @since 3.50.0
     *
     ...
     * @param {Vsengine.Types.GameObjects.Sprite.SpriteConfig} [spriteConfig] - The config object to pass into the Sprite creator (i.e.
     * scene.make.sprite).
     * @param {Vsengine.Scene} [scene] - The Scene to create the Sprites within.
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use when determining the world XY
     *
     * @return {Vsengine.GameObjects.Sprite[]} An array of the Sprites that were created.
     */
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#cull
     * @since 3.50.0
     *
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to run the cull check against.
     *
     * @return {Vsengine.Tilemaps.Tile[]} An array of Tile objects to render.
     */
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#copy
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#fill
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#filterTiles
     * @since 3.50.0
     *
     ...
     * the top-left.
     *
     * @method Vsengine.Tilemaps.TilemapLayer#findByIndex
     * @since 3.50.0
     *
     ...
     *
     * @return {Vsengine.Tilemaps.Tile} The first matching Tile object.
     */
    findByIndex: function (findIndex, skip, reverse) {
        return TilemapComponents.FindByIndex(
            findIndex,
            skip,
            reverse,
            this.layer
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#findTile
     * @since 3.50.0
     *
     ...
     * @param {Vsengine.Types.Tilemaps.FilteringOptions} [filteringOptions] - Optional filters to apply when getting the tiles.
     *
     * @return {?Vsengine.Tilemaps.Tile} The first Tile found at the given location.
     */
    findTile: function (
        callback,
        context,
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#forEachTile
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#setTint
     * @webglOnly
     * @since 3.60.0
     *
     ...
     * If a tile already has a tint set then calling this method will override that.
     *
     * @method Vsengine.Tilemaps.TilemapLayer#setTintFill
     * @webglOnly
     * @since 3.70.0
     *
     * @param {number} [tint=0xffffff] - The tint color being applied to each tile within the region. Given as a hex value, i.e. `0xff0000` for red. Set to white (`0xffffff`) to reset the tint.
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#getTileAt
     * @since 3.50.0
     *
     ...
     *
     * @return {Vsengine.Tilemaps.Tile} The Tile at the given coordinates or null if no tile was found or the coordinates were invalid.
     */
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#getTileAtWorldXY
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#getIsoTileAtWorldXY
     * @since 3.60.0
     *
     * @param {number} worldX - X position to get the tile from (given in pixels)
     * @param {number} worldY - Y position to get the tile from (given in pixels)
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#getTilesWithin
     * @since 3.50.0
     *
     * @param {number} [tileX] - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} [tileY] - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     * @param {Vsengine.Types.Tilemaps.FilteringOptions} [filteringOptions] - Optional filters to apply when getting the tiles.
     *
     * @return {Vsengine.Tilemaps.Tile[]} An array of Tile objects found within the area.
     */
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#getTilesWithinShape
     * @since 3.50.0
     *
     ...
     *
     * @return {Vsengine.Tilemaps.Tile[]} An array of Tile objects found within the shape.
     */
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#getTilesWithinWorldXY
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#hasTileAt
     * @since 3.50.0
     *
     ...
     * false if there is no tile or if the tile at that location has an index of -1.
     *
     * @method Vsengine.Tilemaps.TilemapLayer#hasTileAtWorldXY
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#putTileAt
     * @since 3.50.0
     *
     ...
     * @param {boolean} [recalculateFaces=true] - `true` if the faces data should be recalculated.
     *
     * @return {Vsengine.Tilemaps.Tile} The Tile object that was inserted at the given coordinates.
     */
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#putTileAtWorldXY
     * @since 3.50.0
     *
     * @param {(number|Vsengine.Tilemaps.Tile)} tile - The index of this tile to set or a Tile object.
     * @param {number} worldX - The x coordinate, in pixels.
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#putTilesAt
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#randomize
     * @since 3.50.0
     *
     * @param {number} [tileX] - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} [tileY] - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#removeTileAt
     * @since 3.50.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     ...
     * @param {boolean} [recalculateFaces=true] - `true` if the faces data should be recalculated.
     *
     * @return {Vsengine.Tilemaps.Tile} A Tile object.
     */
     ...
     * collision information.
     *
     * @method Vsengine.Tilemaps.TilemapLayer#removeTileAtWorldXY
     * @since 3.50.0
     *
     * @param {number} worldX - The x coordinate, in pixels.
     * @param {number} worldY - The y coordinate, in pixels.
     ...
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     *
     * @return {Vsengine.Tilemaps.Tile} The Tile object that was removed from the given location.
     */
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#renderDebug
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#replaceByIndex
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#setSkipCull
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#setCullPadding
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#setCollision
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#setCollisionBetween
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#setCollisionByProperty
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#setCollisionByExclusion
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#setCollisionFromCollisionGroup
     * @since 3.50.0
     *
     * @param {boolean} [collides=true] - If true it will enable collision. If false it will clear collision.
     * @param {boolean} [recalculateFaces=true] - Whether or not to recalculate the tile faces after the update.
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#setTileIndexCallback
     * @since 3.50.0
     *
     ...
     * remove it.
     *
     * @method Vsengine.Tilemaps.TilemapLayer#setTileLocationCallback
     * @since 3.50.0
     *
     * @param {number} [tileX] - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} [tileY] - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     * information.
     *
     * @method Vsengine.Tilemaps.TilemapLayer#shuffle
     * @since 3.50.0
     *
     * @param {number} [tileX] - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} [tileY] - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     * information.
     *
     * @method Vsengine.Tilemaps.TilemapLayer#swapByIndex
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#tileToWorldX
     * @since 3.50.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     ...
     * layers position, scale and scroll.
     *
     * @method Vsengine.Tilemaps.TilemapLayer#tileToWorldY
     * @since 3.50.0
     *
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     ...
     * `point` object.
     *
     * @method Vsengine.Tilemaps.TilemapLayer#tileToWorldXY
     * @since 3.50.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     ...
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     *
     * @return {Vsengine.Math.Vector2} A Vector2 containing the world coordinates of the Tile.
     */
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#getTileCorners
     * @since 3.60.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#weightedRandomize
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#worldToTileX
     * @since 3.50.0
     *
     ...
     * should use the `worldToTileXY` method.
     *
     * @method Vsengine.Tilemaps.TilemapLayer#worldToTileY
     * @since 3.50.0
     *
     ...
     * `point` object.
     *
     * @method Vsengine.Tilemaps.TilemapLayer#worldToTileXY
     * @since 3.50.0
     *
     * @param {number} worldX - The x coordinate to be converted, in pixels, not tiles.
     * @param {number} worldY - The y coordinate to be converted, in pixels, not tiles.
     ...
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     *
     * @return {Vsengine.Math.Vector2} A Vector2 containing the tile coordinates of the world values.
     */
     ...
     *
     * @method Vsengine.Tilemaps.TilemapLayer#destroy
     * @since 3.50.0
     *
