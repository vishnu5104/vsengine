 ...
 *
 * @function Vsengine.Tilemaps.Parsers.Impact.ParseWeltmeister
 * @since 3.0.0
 *
 ...
 *
 * @return {?Vsengine.Tilemaps.MapData} The created MapData object, or `null` if the data can't be parsed.
 */
