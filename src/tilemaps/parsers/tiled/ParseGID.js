 ...
 *
 * @function Vsengine.Tilemaps.Parsers.Tiled.ParseGID
 * @since 3.0.0
 *
 * @param {number} gid - A Tiled GID.
 *
 * @return {Vsengine.Types.Tilemaps.GIDData} The GID Data.
 */
var ParseGID = function (gid) {
    ...
    gid =
        gid & ~(FLIPPED_HORIZONTAL | FLIPPED_VERTICAL | FLIPPED_ANTI_DIAGONAL);

    // Parse the flip flags into something Vsengine can use
    var rotation = 0;
    var flipped = false;
