...
var Tileset = new Class({
    initialize: function Tileset(
         ...
         *
         * @name Vsengine.Tilemaps.Tileset#name
         * @type {string}
         * @since 3.0.0
         */
        this.name = name;
         ...
         *
         * @name Vsengine.Tilemaps.Tileset#firstgid
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tileset#tileWidth
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tileset#tileHeight
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tileset#tileMargin
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tileset#tileSpacing
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         * Tileset editor.
         *
         * @name Vsengine.Tilemaps.Tileset#tileProperties
         * @type {object}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tileset#tileData
         * @type {object}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tileset#tileOffset
         ...
         *
         * @name Vsengine.Tilemaps.Tileset#image
         ...
         *
         * @name Vsengine.Tilemaps.Tileset#glTexture
         ...
         *
         * @name Vsengine.Tilemaps.Tileset#rows
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tileset#columns
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tileset#total
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tileset#texCoordinates
         * @type {object[]}
         * @readonly
         * @since 3.0.0
         */
     ...
     *
     * @method Vsengine.Tilemaps.Tileset#getTileProperties
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tileset#getTileData
     * @since 3.0.0
     *
     * @param {number} tileIndex - The unique id of the tile across all tilesets in the map.
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tileset#getTileCollisionGroup
     * @since 3.0.0
     *
     * @param {number} tileIndex - The unique id of the tile across all tilesets in the map.
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tileset#containsTileIndex
     * @since 3.0.0
     *
     * @param {number} tileIndex - The unique id of the tile across all tilesets in the map.
     *
    ...
    containsTileIndex: function (tileIndex) {
        return (
            tileIndex >= this.firstgid && tileIndex < this.firstgid + this.total
        );
    },
     ...
     *
     * @method Vsengine.Tilemaps.Tileset#getTileTextureCoordinates
     * @since 3.0.0
     *
     * @param {number} tileIndex - The unique id of the tile across all tilesets in the map.
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tileset#setImage
     * @since 3.0.0
     *
     * @param {Vsengine.Textures.Texture} texture - The image that contains the tiles.
     *
     * @return {Vsengine.Tilemaps.Tileset} This Tileset object.
     */
     ...
     *
     * @method Vsengine.Tilemaps.Tileset#setTileSize
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tileset#setSpacing
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tileset#updateTileData
     * @since 3.0.0
     *
