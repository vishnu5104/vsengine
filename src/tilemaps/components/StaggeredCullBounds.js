 ...
 *
 * @function Vsengine.Tilemaps.Components.StaggeredCullBounds
 * @since 3.50.0
 *
...
var StaggeredCullBounds = function (layer, camera) {
    ...
    var boundsTop =
        SnapFloor(camera.worldView.y - tilemapLayer.y, tileH / 2, 0, true) -
        tilemapLayer.cullPaddingY;
    var boundsBottom =
        SnapCeil(camera.worldView.bottom - tilemapLayer.y, tileH / 2, 0, true) +
        tilemapLayer.cullPaddingY;
