 ...
 *
 * @function Vsengine.Tilemaps.Components.CheckIsoBounds
 * @since 3.50.0
 *
 * @param {number} tileX - The x coordinate, in tiles, not pixels.
 * @param {number} tileY - The y coordinate, in tiles, not pixels.
 * @param {Vsengine.Tilemaps.LayerData} layer - The Tilemap Layer to check against.
...
var CheckIsoBounds = function (tileX, tileY, layer, camera) {
    ...
    var pos = tilemapLayer.tilemap.tileToWorldXY(
        tileX,
        tileY,
        point,
        camera,
    ...
    return (
        pos.x >
            camera.worldView.x +
                tilemapLayer.scaleX * layer.tileWidth * (-cullPaddingX - 0.5) &&
        pos.x <
        ...
        pos.y <
            camera.worldView.bottom +
                tilemapLayer.scaleY * layer.tileHeight * (cullPaddingY - 0.5)
    );
};
