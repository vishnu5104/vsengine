 ...
 *
 * @param {Vsengine.Tilemaps.Tile} value - The Tile.
 * @param {number} index - The index of the tile.
 * @param {Vsengine.Tilemaps.Tile[]} array - An array of Tile objects.
 *
 ...
 *
 * @function Vsengine.Tilemaps.Components.FindTile
 * @since 3.0.0
 *
 ...
 *
 * @return {?Vsengine.Tilemaps.Tile} A Tile that matches the search, or null if no Tile found
 */
var FindTile = function (
    callback,
    context,
    tileX,
    tileY,
