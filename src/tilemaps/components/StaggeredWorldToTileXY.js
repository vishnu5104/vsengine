 ...
 * `point` object.
 *
 * @function Vsengine.Tilemaps.Components.StaggeredWorldToTileXY
 * @since 3.50.0
 *
 ...
 *
 * @return {Vsengine.Math.Vector2} The XY location in tile units.
 */
var StaggeredWorldToTileXY = function (
    worldX,
    worldY,
    snapToFloor,
    point,
