 ...
 *
 * @function Vsengine.Tilemaps.Components.RenderDebug
 * @since 3.0.0
 *
 * @param {Vsengine.GameObjects.Graphics} graphics - The target Graphics object to draw upon.
 * @param {Vsengine.Types.Tilemaps.DebugStyleOptions} styleConfig - An object specifying the colors to use for the debug drawing.
...
var RenderDebug = function (graphics, styleConfig, layer) {
    ...
    var tileColor =
        styleConfig.tileColor !== undefined
            ? styleConfig.tileColor
            : defaultTileColor;
    var collidingTileColor =
        styleConfig.collidingTileColor !== undefined
            ? styleConfig.collidingTileColor
            : defaultCollidingTileColor;
    var faceColor =
        styleConfig.faceColor !== undefined
