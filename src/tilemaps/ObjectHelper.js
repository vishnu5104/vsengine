 ...
 * @since 3.60.0
 *
 * @param {Vsengine.Tilemaps.Tileset[]} tilesets - The backing tileset data.
 */
var ObjectHelper = new Class({
    initialize: function ObjectHelper(tilesets) {
         ...
         * The Tile GIDs array.
         *
         * @name Vsengine.Tilemaps.ObjectHelper#gids
         * @type {array}
         * @since 3.60.0
         */
        this.gids = [];
         ...
         * The Tile GIDs array.
         *
         * @name Vsengine.Tilemaps.ObjectHelper#_gids
         * @type {array}
         * @private
         * @since 3.60.0
         */
     ...
     *
     * @name Vsengine.Tilemaps.ObjectHelper#enabled
     * @type {boolean}
     * @since 3.60.0
     */
    enabled: {
     ...
     *
     * @method Vsengine.Tilemaps.ObjectHelper#getTypeIncludingTile
     * @since 3.60.0
     *
     * @param {Vsengine.Types.Tilemaps.TiledObject} obj - The Tiled object to investigate.
     *
     ...
     *
     * @method Vsengine.Tilemaps.ObjectHelper#setTextureAndFrame
     * @since 3.60.0
     *
     * @param {Vsengine.GameObjects.GameObject} sprite - The Game Object to modify.
     * @param {string|Vsengine.Textures.Texture} [key] - The texture key to set (or else the `obj.gid`'s tile is used if available).
     * @param {string|number|Vsengine.Textures.Frame} [frame] - The frames key to set (or else the `obj.gid`'s tile is used if available).
     * @param {Vsengine.Types.Tilemaps.TiledObject} [obj] - The Tiled object for fallback.
     */
     ...
     *
     * @method Vsengine.Tilemaps.ObjectHelper#setPropertiesFromTiledObject
     * @since 3.60.0
     *
     * @param {Vsengine.GameObjects.GameObject} sprite
     * @param {Vsengine.Types.Tilemaps.TiledObject} obj
     */
     ...
     *
     * @method Vsengine.Tilemaps.ObjectHelper#setFromJSON
     * @since 3.60.0
     * @private
     *
     * @param {Vsengine.GameObjects.GameObject} sprite - The object for which to populate `data`.
