/**
 * @typedef {object} Vsengine.Types.Tilemaps.LayerDataConfig
 * @since 3.0.0
 *
 ...
 * @property {Vsengine.Tilemaps.TilemapLayer} [tilemapLayer] - A reference to the Tilemap layer that owns this data.
 */
