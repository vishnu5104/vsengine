/**
 * @typedef {object} Vsengine.Types.Tilemaps.MapDataConfig
 * @since 3.0.0
 *
 * @property {string} [name] - The key in the Vsengine cache that corresponds to the loaded tilemap data.
 ...
 * @property {(string|Vsengine.Tilemaps.Orientation)} [orientation] - The orientation of the map data (i.e. orthogonal, isometric, hexagonal), default 'orthogonal'.
 ...
 * @property {Vsengine.Tilemaps.LayerData[]} [layers] - The layers of the tilemap.
 ...
 * @property {Vsengine.Tilemaps.Tileset[]} [tilesets] - The tilesets the map uses.
