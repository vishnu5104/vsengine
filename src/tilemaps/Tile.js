 ...
 *
 * @param {Vsengine.Tilemaps.LayerData} layer - The LayerData object in the Tilemap that this tile belongs to.
...
var Tile = new Class({
    ...
    initialize: function Tile(
         ...
         *
         * @name Vsengine.Tilemaps.Tile#layer
         ...
         *
         * @name Vsengine.Tilemaps.Tile#index
         * @type {number}
         * @since 3.0.0
         */
        this.index = index;
         ...
         *
         * @name Vsengine.Tilemaps.Tile#width
         * @type {number}
         * @since 3.0.0
         */
        this.width = width;
         ...
         *
         * @name Vsengine.Tilemaps.Tile#height
         * @type {number}
         * @since 3.0.0
         */
        this.height = height;
         ...
         *
         * @name Vsengine.Tilemaps.Tile#right
         * @type {number}
         * @since 3.50.0
         */
        this.right;
         ...
         * Set in the `updatePixelXY` method.
         *
         * @name Vsengine.Tilemaps.Tile#bottom
         * @type {number}
         * @since 3.50.0
         */
        this.bottom;
         ...
         *
         * @name Vsengine.Tilemaps.Tile#baseWidth
         * @type {number}
         * @since 3.0.0
         */
         ...
         * within one map, but they are still placed at intervals of the base tile size.
         *
         * @name Vsengine.Tilemaps.Tile#baseHeight
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tile#pixelX
         * @type {number}
         * @since 3.0.0
         */
        this.pixelX = 0;
         ...
         * scroll, layer scale or layer position.
         *
         * @name Vsengine.Tilemaps.Tile#pixelY
         * @type {number}
         * @since 3.0.0
         */
        this.pixelY = 0;
         ...
         *
         * @name Vsengine.Tilemaps.Tile#properties
         * @type {any}
         * @since 3.0.0
         */
        this.properties = {};
         ...
         *
         * @name Vsengine.Tilemaps.Tile#rotation
         * @type {number}
         * @since 3.0.0
         */
        this.rotation = 0;
         ...
         * in your own checks.
         *
         * @name Vsengine.Tilemaps.Tile#collideLeft
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         * in your own checks.
         *
         * @name Vsengine.Tilemaps.Tile#collideRight
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         * in your own checks.
         *
         * @name Vsengine.Tilemaps.Tile#collideUp
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         * in your own checks.
         *
         * @name Vsengine.Tilemaps.Tile#collideDown
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tile#faceLeft
         * @type {boolean}
         * @since 3.0.0
         */
        this.faceLeft = false;
         ...
         *
         * @name Vsengine.Tilemaps.Tile#faceRight
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tile#faceTop
         * @type {boolean}
         * @since 3.0.0
         */
        this.faceTop = false;
         ...
         *
         * @name Vsengine.Tilemaps.Tile#faceBottom
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tile#collisionCallback
         * @type {function}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tile#collisionCallbackContext
         * @type {object}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tile#tint
         * @type {number}
         * @default
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tile#tintFill
         * @type {boolean}
         * @default
         * @since 3.70.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tile#physics
         * @type {object}
         * @since 3.0.0
         */
        this.physics = {};
     ...
     *
     * @method Vsengine.Tilemaps.Tile#containsPoint
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tile#copy
     * @since 3.0.0
     *
     * @param {Vsengine.Tilemaps.Tile} tile - The tile to copy from.
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tile#getCollisionGroup
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tile#getTileData
     * @since 3.0.0
     *
     ...
     * scale and scroll.
     *
     * @method Vsengine.Tilemaps.Tile#getLeft
     * @since 3.0.0
     *
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use to perform the check.
     *
     ...
     * scale and scroll.
     *
     * @method Vsengine.Tilemaps.Tile#getRight
     * @since 3.0.0
     *
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use to perform the check.
     *
     ...
     * scale and scroll.
     *
     * @method Vsengine.Tilemaps.Tile#getTop
     * @since 3.0.0
     *
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use to perform the check.
     *
     ...
     * @method Vsengine.Tilemaps.Tile#getBottom
     * @since 3.0.0
     *
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use to perform the check.
     *
     ...
     * scale and scroll.
     *
     * @method Vsengine.Tilemaps.Tile#getBounds
     * @since 3.0.0
     *
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use to perform the check.
     * @param {Vsengine.Geom.Rectangle} [output] - Optional Rectangle object to store the results in.
     *
     * @return {(Vsengine.Geom.Rectangle|object)} The bounds of this Tile.
     */
     ...
     * scale and scroll.
     *
     * @method Vsengine.Tilemaps.Tile#getCenterX
     * @since 3.0.0
     *
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use to perform the check.
     *
     ...
     * scale and scroll.
     *
     * @method Vsengine.Tilemaps.Tile#getCenterY
     * @since 3.0.0
     *
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use to perform the check.
     *
     ...
     * layer position.
     *
     * @method Vsengine.Tilemaps.Tile#intersects
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tile#isInteresting
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tile#resetCollision
     * @since 3.0.0
     *
     ...
     * Reset faces.
     *
     * @method Vsengine.Tilemaps.Tile#resetFaces
     * @since 3.0.0
     *
     * @return {this} This Tile object instance.
     */
     ...
     *
     * @method Vsengine.Tilemaps.Tile#setCollision
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tile#setCollisionCallback
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tile#setSize
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tile#updatePixelXY
     * @since 3.0.0
     *
     * @return {this} This Tile object instance.
     */
    updatePixelXY: function () {
        ...
        if (orientation === CONST.ORTHOGONAL) {
            ...
            //  bottom left, while the Vsengine renderer assumes the origin is the top left. The y
     ...
     * Clean up memory.
     *
     * @method Vsengine.Tilemaps.Tile#destroy
     * @since 3.0.0
     */
    destroy: function () {
        this.collisionCallback = undefined;
     ...
     *
     * @name Vsengine.Tilemaps.Tile#canCollide
     * @type {boolean}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Tilemaps.Tile#collides
     * @type {boolean}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Tilemaps.Tile#hasInterestingFace
     * @type {boolean}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name Vsengine.Tilemaps.Tile#tileset
     ...
     *
     * @name Vsengine.Tilemaps.Tile#tilemapLayer
     * @type {?Vsengine.Tilemaps.TilemapLayer}
     * @readonly
     * @since 3.0.0
     */
    tilemapLayer: {
     ...
     *
     * @name Vsengine.Tilemaps.Tile#tilemap
