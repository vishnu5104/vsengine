...
var ImageCollection = new Class({
    initialize: function ImageCollection(
         ...
         *
         * @name Vsengine.Tilemaps.ImageCollection#name
         * @type {string}
         * @since 3.0.0
         */
        this.name = name;
         ...
         *
         * @name Vsengine.Tilemaps.ImageCollection#firstgid
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.ImageCollection#imageWidth
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.ImageCollection#imageHeight
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.ImageCollection#imageMarge
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         * Use `setSpacing` to change.
         *
         * @name Vsengine.Tilemaps.ImageCollection#imageSpacing
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.ImageCollection#properties
         * @type {object}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.ImageCollection#images
         * @type {array}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.ImageCollection#total
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
     ...
     *
     * @method Vsengine.Tilemaps.ImageCollection#containsImageIndex
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.ImageCollection#addImage
     * @since 3.0.0
     *
     ...
     *
     * @return {Vsengine.Tilemaps.ImageCollection} This ImageCollection object.
     */
