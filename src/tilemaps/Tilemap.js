 ...
 *
 * @param {Vsengine.GameObjects.GameObject} value - An object found in the filtered area.
 * @param {number} index - The index of the object within the array.
 * @param {Vsengine.GameObjects.GameObject[]} array - An array of all the objects found.
 *
 ...
 *
 * @param {Vsengine.GameObjects.GameObject} value - An object found.
 * @param {number} index - The index of the object within the array.
 * @param {Vsengine.GameObjects.GameObject[]} array - An array of all the objects found.
 *
 ...
 *
 * As of Vsengine 3.50.0 the Tilemap API now supports the following types of map:
 *
 * 1) Orthogonal
 * 2) Isometric
 * 3) Hexagonal
 ...
 *
 * As of Vsengine 3.21.0, if your tilemap includes layer groups (a feature of Tiled 1.2.0+) these
 ...
 * 'ParentGroup/Layer 1'.
 *
 * The Vsengine Tiled Parser does **not** support the 'Collection of Images' feature for a Tileset.
 ...
 * @since 3.0.0
 *
 * @param {Vsengine.Scene} scene - The Scene to which this Tilemap belongs.
 * @param {Vsengine.Tilemaps.MapData} mapData - A MapData instance containing Tilemap data.
 */
var Tilemap = new Class({
    initialize: function Tilemap(scene, mapData) {
        /**
         * @name Vsengine.Tilemaps.Tilemap#scene
         * @type {Vsengine.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         * width.
         *
         * @name Vsengine.Tilemaps.Tilemap#tileWidth
         * @type {number}
         * @since 3.0.0
         */
         ...
         * tile height.
         *
         * @name Vsengine.Tilemaps.Tilemap#tileHeight
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#width
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#height
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#orientation
         * @type {string}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#renderOrder
         * @type {string}
         * @since 3.12.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#format
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#version
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#properties
         * @type {object|object[]}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#widthInPixels
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#heightInPixels
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#imageCollections
         * @type {Vsengine.Tilemaps.ImageCollection[]}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#images
         * @type {array}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#layers
         * @type {Vsengine.Tilemaps.LayerData[]}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#tiles
         * @type {array}
         * @since 3.60.0
         * @see Vsengine.Tilemaps.Parsers.Tiled.BuildTilesetIndex
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#tilesets
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#objects
         * @type {Vsengine.Tilemaps.ObjectLayer[]}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#currentLayerIndex
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#hexSideLength
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.Tilemaps.Tilemap#_convert
         * @private
         * @type {object}
         * @since 3.50.0
         */
        this._convert = {
            WorldToTileXY:
                TilemapComponents.GetWorldToTileXYFunction(orientation),
            WorldToTileX:
                TilemapComponents.GetWorldToTileXFunction(orientation),
            WorldToTileY:
                TilemapComponents.GetWorldToTileYFunction(orientation),
            TileToWorldXY:
                TilemapComponents.GetTileToWorldXYFunction(orientation),
            TileToWorldX:
                TilemapComponents.GetTileToWorldXFunction(orientation),
            TileToWorldY:
                TilemapComponents.GetTileToWorldYFunction(orientation),
            GetTileCorners:
                TilemapComponents.GetTileCornersFunction(orientation),
        };
    },
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#setRenderOrder
     * @since 3.12.0
     *
     ...
     * editor.
     *
     * @method Vsengine.Tilemaps.Tilemap#addTilesetImage
     * @since 3.0.0
     *
     * @param {string} tilesetName - The name of the tileset as specified in the map data.
     * @param {string} [key] - The key of the Vsengine.Cache image used for this tileset. If
     ...
     *
     * @return {?Vsengine.Tilemaps.Tileset} Returns the Tileset object that was created or updated, or null if it
     * failed.
     */
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#copy
     * @since 3.0.0
     *
     ...
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?Vsengine.Tilemaps.Tilemap} Returns this, or null if the layer given was invalid.
     */
    copy: function (
        srcTileX,
        srcTileY,
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#createBlankLayer
     * @since 3.0.0
     *
     * @param {string} name - The name of this layer. Must be unique within the map.
     * @param {(string|string[]|Vsengine.Tilemaps.Tileset|Vsengine.Tilemaps.Tileset[])} tileset - The tileset, or an array of tilesets, used to render this layer. Can be a string or a Tileset object.
     ...
     *
     * @return {?Vsengine.Tilemaps.TilemapLayer} Returns the new layer that was created, or `null` if it failed.
     */
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#createLayer
     * @since 3.0.0
     *
     ...
     *
     * @return {?Vsengine.Tilemaps.TilemapLayer} Returns the new layer was created, or null if it failed.
     */
    createLayer: function (layerID, tileset, x, y) {
        ...
        if (index === null) {
            ...
            if (typeof layerID === "string") {
                console.warn(
                    "Valid tilelayer names: %o",
                    this.getTileLayerNames()
                );
            }
     ...
     * convert the matching results into Vsengine Game Objects (by default, Sprites)
     *
     ...
     *
     * By default this method will convert Objects into {@link Vsengine.GameObjects.Sprite} instances, but you can override
     ...
     * any class type here, but it _must_ extend {@link Vsengine.GameObjects.GameObject} as its base class.
     ...
     * class must have {@link Vsengine.GameObjects.Components.Transform#setPosition setPosition} and
     * {@link Vsengine.GameObjects.Components.Texture#setTexture setTexture} methods.
     *
     ...
     * - on the Game Object's {@link Vsengine.GameObjects.GameObject#data data store} otherwise.
     *
     ...
     *   {
     *     type: 'endzone',
     *     classType: Vsengine.GameObjects.Zone
     *   }
     * ]);
     * ```
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#createFromObjects
     * @since 3.0.0
     *
     * @param {string} objectLayerName - The name of the Tiled object layer to create the Game Objects from.
     * @param {Vsengine.Types.Tilemaps.CreateFromObjectLayerConfig|Vsengine.Types.Tilemaps.CreateFromObjectLayerConfig[]} config - A CreateFromObjects configuration object, or an array of them.
     ...
     *
     * @return {Vsengine.GameObjects.GameObject[]} An array containing the Game Objects that were created. Empty if invalid object layer, or no matching id/gid/name was found.
     */
    createFromObjects: function (objectLayerName, config, useTileset) {
        ...
        if (!objectLayer) {
            console.warn(
                "createFromObjects: Invalid objectLayerName given: " +
                    objectLayerName
            );
        ...
        var objectHelper = new ObjectHelper(
            useTileset ? this.tilesets : undefined
        );
        ...
        for (var c = 0; c < config.length; c++) {
            ...
            objectHelper.enabled = !GetFastValue(
                singleConfig,
                "ignoreTileset",
                null
            );
            ...
            for (var s = 0; s < objects.length; s++) {
                ...
                if (
                    ...
                    (type !== null &&
                        objectHelper.getTypeIncludingTile(obj) === type)
                ) {
                    toConvert.push(obj);
                }
            }
     ...
     *
     * The following features were added in Vsengine v3.80:
     *
     * By default, Vsengine Sprites have their origin set to 0.5 x 0.5. If you don't specify a new
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#createFromTiles
     * @since 3.0.0
     *
     ...
     * @param {Vsengine.Types.GameObjects.Sprite.SpriteConfig} [spriteConfig] - The config object to pass into the Sprite creator (i.e. scene.make.sprite).
     * @param {Vsengine.Scene} [scene] - The Scene to create the Sprites within.
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?Vsengine.GameObjects.Sprite[]} Returns an array of Tiles, or null if the layer given was invalid.
     */
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#fill
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#filterObjects
     * @since 3.0.0
     *
     * @param {(Vsengine.Tilemaps.ObjectLayer|string)} objectLayer - The name of an object layer (from Tiled) or an ObjectLayer instance.
     ...
     *
     * @return {?Vsengine.Types.Tilemaps.TiledObject[]} An array of object that match the search, or null if the objectLayer given was invalid.
     */
     ...
     * If no layer specified, the map's current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#filterTiles
     * @since 3.0.0
     *
     ...
     * @param {number} [width] - How many tiles wide from the `tileX` index the area will be.
     * @param {number} [height] - How many tiles tall from the `tileY` index the area will be.
     * @param {Vsengine.Types.Tilemaps.FilteringOptions} [filteringOptions] - Optional filters to apply when getting the tiles.
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?Vsengine.Tilemaps.Tile[]} Returns an array of Tiles, or null if the layer given was invalid.
     */
     ...
     * If no layer specified, the map's current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#findByIndex
     * @since 3.0.0
     *
     ...
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?Vsengine.Tilemaps.Tile} Returns a Tiles, or null if the layer given was invalid.
     */
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#findObject
     * @since 3.0.0
     *
     * @param {(Vsengine.Tilemaps.ObjectLayer|string)} objectLayer - The name of an object layer (from Tiled) or an ObjectLayer instance.
     ...
     * @param {object} [context] - The context under which the callback should be run.
     *
     * @return {?Vsengine.Types.Tilemaps.TiledObject} An object that matches the search, or null if no object found.
     */
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#findTile
     * @since 3.0.0
     *
     ...
     * @param {number} [height] - How many tiles tall from the `tileY` index the area will be.
     * @param {Vsengine.Types.Tilemaps.FilteringOptions} [filteringOptions] - Optional filters to apply when getting the tiles.
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The Tile layer to run the search on. If not provided will use the current layer.
     *
     * @return {?Vsengine.Tilemaps.Tile} Returns a Tiles, or null if the layer given was invalid.
     */
    findTile: function (
     ...
     * If no layer specified, the map's current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#forEachTile
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#getImageIndex
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#getImageLayerNames
     * @since 3.21.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#getIndex
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#getLayer
     * @since 3.0.0
     *
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The name of the layer from Tiled, the index of the layer in the map or Tilemap Layer. If not given will default to the maps current layer index.
     *
     * @return {?Vsengine.Tilemaps.LayerData} The corresponding `LayerData` within `this.layers`, or null.
     */
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#getObjectLayer
     * @since 3.0.0
     *
     * @param {string} [name] - The name of the object layer from Tiled.
     *
     * @return {?Vsengine.Tilemaps.ObjectLayer} The corresponding `ObjectLayer` within `this.objects`, or null.
     */
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#getObjectLayerNames
     * @since 3.21.0
     *
     ...
     * `layer` is given.
     *
     * @method Vsengine.Tilemaps.Tilemap#getLayerIndex
     * @since 3.0.0
     *
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The name of the layer from Tiled, the index of the layer in the map or a Tilemap Layer. If not given will default to the map's current layer index.
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#getLayerIndexByName
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#getTileAt
     * @since 3.0.0
     *
     ...
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?Vsengine.Tilemaps.Tile} Returns a Tile, or null if the layer given was invalid.
     */
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#getTileAtWorldXY
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#getTileLayerNames
     * @since 3.21.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#getTilesWithin
     * @since 3.0.0
     *
     * @param {number} [tileX] - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} [tileY] - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#getTilesWithinShape
     * @since 3.0.0
     *
     * @param {(Vsengine.Geom.Circle|Vsengine.Geom.Line|Vsengine.Geom.Rectangle|Vsengine.Geom.Triangle)} shape - A shape in world (pixel) coordinates
     * @param {Vsengine.Types.Tilemaps.FilteringOptions} [filteringOptions] - Optional filters to apply when getting the tiles.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#getTilesWithinWorldXY
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#getTileset
     * @since 3.14.0
     *
     * @param {string} name - The name of the Tileset to get.
     *
     * @return {?Vsengine.Tilemaps.Tileset} The Tileset, or `null` if no matching named tileset was found.
     */
     ...
     * invalid `name` is given.
     *
     * @method Vsengine.Tilemaps.Tilemap#getTilesetIndex
     * @since 3.0.0
     *
     * @param {string} name - The name of the Tileset to get.
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#hasTileAt
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#hasTileAtWorldXY
     * @since 3.0.0
     *
     ...
     *
     * @name Vsengine.Tilemaps.Tilemap#layer
     * @type {Vsengine.Tilemaps.LayerData}
     * @since 3.0.0
     */
    layer: {
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#putTileAt
     * @since 3.0.0
     *
     * @param {(number|Vsengine.Tilemaps.Tile)} tile - The index of this tile to set or a Tile object.
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     * @param {boolean} [recalculateFaces] - `true` if the faces data should be recalculated.
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?Vsengine.Tilemaps.Tile} Returns a Tile, or null if the layer given was invalid or the coordinates were out of bounds.
     */
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#putTileAtWorldXY
     * @since 3.0.0
     *
     * @param {(number|Vsengine.Tilemaps.Tile)} tile - The index of this tile to set or a Tile object.
     * @param {number} worldX - The x coordinate, in pixels.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#putTilesAt
     * @since 3.0.0
     *
     * @param {(number[]|number[][]|Vsengine.Tilemaps.Tile[]|Vsengine.Tilemaps.Tile[][])} tile - A row (array) or grid (2D array) of Tiles or tile indexes to place.
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     * @param {boolean} [recalculateFaces] - `true` if the faces data should be recalculated.
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#randomize
     * @since 3.0.0
     *
     * @param {number} [tileX] - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} [tileY] - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#calculateFacesAt
     * @since 3.0.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#calculateFacesWithin
     * @since 3.0.0
     *
     * @param {number} [tileX] - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} [tileY] - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#removeLayer
     * @since 3.17.0
     *
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The tile layer to be removed.
     *
     * @return {?Vsengine.Tilemaps.Tilemap} Returns this, or null if the layer given was invalid.
     */
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#destroyLayer
     * @since 3.17.0
     *
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The tile layer to be destroyed.
     *
     * @return {?Vsengine.Tilemaps.Tilemap} Returns this, or null if the layer given was invalid.
     */
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#removeAllLayers
     * @since 3.0.0
     *
     * @return {this} This Tilemap object.
     */
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#removeTile
     * @since 3.17.0
     *
     * @param {(Vsengine.Tilemaps.Tile|Vsengine.Tilemaps.Tile[])} tiles - The Tile to remove, or an array of Tiles.
     ...
     * @param {boolean} [recalculateFaces=true] - `true` if the faces data should be recalculated.
     *
     * @return {Vsengine.Tilemaps.Tile[]} Returns an array of Tiles that were removed.
     */
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#removeTileAt
     * @since 3.0.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     ...
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?Vsengine.Tilemaps.Tile} Returns the Tile that was removed, or null if the layer given was invalid.
     */
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#removeTileAtWorldXY
     * @since 3.0.0
     *
     * @param {number} worldX - The x coordinate, in pixels.
     * @param {number} worldY - The y coordinate, in pixels.
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#renderDebug
     * @since 3.0.0
     *
     * @param {Vsengine.GameObjects.Graphics} graphics - The target Graphics object to draw upon.
     * @param {Vsengine.Types.Tilemaps.StyleConfig} [styleConfig] - An object specifying the colors to use for the debug drawing.
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?Vsengine.Tilemaps.Tilemap} Return this Tilemap object, or null if the layer given was invalid.
     */
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#renderDebugFull
     * @since 3.17.0
     *
     * @param {Vsengine.GameObjects.Graphics} graphics - The target Graphics object to draw upon.
     * @param {Vsengine.Types.Tilemaps.StyleConfig} [styleConfig] - An object specifying the colors to use for the debug drawing.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#replaceByIndex
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#setCollision
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#setCollisionBetween
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#setCollisionByProperty
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#setCollisionByExclusion
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#setCollisionFromCollisionGroup
     * @since 3.0.0
     *
     * @param {boolean} [collides] - If true it will enable collision. If false it will clear collision.
     * @param {boolean} [recalculateFaces] - Whether or not to recalculate the tile faces after the update.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#setTileIndexCallback
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#setTileLocationCallback
     * @since 3.0.0
     *
     * @param {number} tileX - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} tileY - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#setLayer
     * @since 3.0.0
     *
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The name of the layer from Tiled, the index of the layer in the map or a TilemapLayer. If not given will default to the maps current layer index.
     *
     * @return {this} This Tilemap object.
     */
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#setBaseTileSize
     * @since 3.0.0
     *
     ...
     * tiles the layer has.
     *
     * @method Vsengine.Tilemaps.Tilemap#setLayerTileSize
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#shuffle
     * @since 3.0.0
     *
     * @param {number} [tileX] - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} [tileY] - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#swapByIndex
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#tileToWorldX
     * @since 3.0.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#tileToWorldY
     * @since 3.0.0
     *
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#tileToWorldXY
     * @since 3.0.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     * @param {Vsengine.Math.Vector2} [vec2] - A Vector2 to store the coordinates in. If not given a new Vector2 is created.
     * @param {Vsengine.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?Vsengine.Math.Vector2} Returns a Vector2, or null if the layer given was invalid.
     */
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#getTileCorners
     * @since 3.60.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     ...
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?Vsengine.Math.Vector2[]} Returns an array of Vector2s, or null if the layer given was invalid.
     */
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#weightedRandomize
     * @since 3.0.0
     *
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#worldToTileX
     * @since 3.0.0
     *
     ...
     * should use the `worldToTileXY` method.
     *
     * @method Vsengine.Tilemaps.Tilemap#worldToTileY
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method Vsengine.Tilemaps.Tilemap#worldToTileXY
     * @since 3.0.0
     *
     * @param {number} worldX - The x coordinate to be converted, in pixels, not tiles.
     * @param {number} worldY - The y coordinate to be converted, in pixels, not tiles.
     ...
     * @param {(string|number|Vsengine.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?Vsengine.Math.Vector2} Returns a vec2, or null if the layer given was invalid.
     */
     ...
     *
     * @method Vsengine.Tilemaps.Tilemap#destroy
     * @since 3.0.0
     */
    destroy: function () {
