...
/**
 * @typedef {object} Vsengine.Loader.FileTypes.SpineFileConfig
 *
 ...
 *
 * These are created when you use the Vsengine.Loader.LoaderPlugin#spine method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see Vsengine.Loader.LoaderPlugin#spine.
 *
 * @class SpineFile
 ...
 * @param {(string|Vsengine.Loader.FileTypes.SpineFileConfig)} key - The key to use for this file, or a file configuration object.
...
var SpineFile = new Class({
     ...
     *
     * @method Vsengine.Loader.FileTypes.SpineFile#onFileComplete
     * @since 3.19.0
     *
     ...
     *
     * @method Vsengine.Loader.FileTypes.SpineFile#addToCache
     * @since 3.19.0
     */
    addToCache: function () {
