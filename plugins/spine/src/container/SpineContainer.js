 ...
 * Although Vsengine will not prevent you from adding other types, they will not render and are likely to throw runtime errors.
 *
...
var SpineContainer = new Class({
    ...
    Mixins: [SpineContainerRender],

    initialize: function SpineContainer(scene, plugin, x, y, children) {
