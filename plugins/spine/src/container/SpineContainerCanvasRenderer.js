 ...
 *
 * @method Vsengine.GameObjects.Container#renderCanvas
 * @since 3.4.0
 * @private
 *
 * @param {Vsengine.Renderer.Canvas.CanvasRenderer} renderer - A reference to the current active Canvas renderer.
 * @param {Vsengine.GameObjects.Container} container - The Game Object being rendered in this call.
 ...
 */
var SpineContainerCanvasRenderer = function (
    renderer,
    container,
    camera,
    parentMatrix
    ...
    for (var i = 0; i < children.length; i++) {
        ...
        if (
            ...
            child.blendMode !== renderer.currentBlendMode
        ) {
        ...
        //  Set parent values
        child.setScrollFactor(
            childScrollFactorX * scrollFactorX,
            childScrollFactorY * scrollFactorY
        );
