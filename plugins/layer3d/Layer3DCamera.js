...
var Layer3DCamera = new Class({
    initialize: function Layer3DCamera(layer, fov, x, y, z, near, far) {
        /**
         ...
         *
         * @name Vsengine.GameObjects.Layer3DCamera#layer
         * @type {Vsengine.GameObjects.Layer3D}
         * @since 3.50.0
         */
        this.layer = layer;
         ...
         *
         * @name Vsengine.GameObjects.Layer3DCamera#input
         ...
         *
         * @name Vsengine.GameObjects.Layer3DCamera#dirtyView
         * @type {boolean}
         * @since 3.50.0
         */
        this.dirtyView = true;
         ...
         *
         * @name Vsengine.GameObjects.Layer3DCamera#dirtyProjection
         * @type {boolean}
         * @since 3.50.0
         */
         ...
         * Internal fov value.
         *
         * @name Vsengine.GameObjects.Layer3DCamera#_fov
         * @type {number}
         * @private
         * @since 3.50.0
         */
         ...
         * Internal near value.
         *
         * @name Vsengine.GameObjects.Layer3DCamera#_near
         * @type {number}
         * @private
         * @since 3.50.0
         */
         ...
         * Internal far value.
         *
         * @name Vsengine.GameObjects.Layer3DCamera#_far
         * @type {number}
         * @private
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Layer3DCamera#aspectRatio
         * @type {number}
         * @since 3.50.0
         */
        this.aspectRatio = 1;
         ...
         *
         * @name Vsengine.GameObjects.Layer3DCamera#position
         ...
         *
         * @name Vsengine.GameObjects.Layer3DCamera#rotation
         * @type {Vsengine.Math.Vector3}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Layer3DCamera#forward
         ...
         * Calculated and updated automatically when the view matrix changes.
         *
         * @name Vsengine.GameObjects.Layer3DCamera#up
         * @type {Vsengine.Math.Vector4}
         * @since 3.50.0
         */
        this.up = new Vector4();
         ...
         * Calculated and updated automatically when the view matrix changes.
         *
         * @name Vsengine.GameObjects.Layer3DCamera#right
         * @type {Vsengine.Math.Vector4}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Layer3DCamera#matrix
         ...
         * Calculated and updated automatically when the camera is dirty.
         *
         * @name Vsengine.GameObjects.Layer3DCamera#viewMatrix
         * @type {Vsengine.Math.Matrix4}
         * @since 3.50.0
         */
         ...
         * Calculated and updated automatically when the camera is dirty.
         *
         * @name Vsengine.GameObjects.Layer3DCamera#projectionMatrix
         * @type {Vsengine.Math.Matrix4}
         * @since 3.50.0
         */
         ...
         * Calculated and updated automatically when the camera is dirty.
         *
         * @name Vsengine.GameObjects.Layer3DCamera#viewProjectionMatrix
         * @type {Vsengine.Math.Matrix4}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Layer3DCamera#mode
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Layer3DCamera#rotateSpeed
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Layer3DCamera#panSpeed
         * @type {number}
         * @since 3.50.0
         */
        this.panSpeed = 4;
         ...
         *
         * @name Vsengine.GameObjects.Layer3DCamera#zoomSpeed
         * @type {number}
         * @since 3.50.0
         */
        this.zoomSpeed = 3;
    ...
    enableZoom: function (zoomSpeed) {
        ...
        this.input.on(
            INPUT_EVENTS.POINTER_WHEEL,
            this.pointerWheelHandler,
            this
        );
    },
    ...
    pointerMoveHandler: function (pointer) {
        if (pointer.isDown) {
            ...
            if (pointer.event.shiftKey && this.allowPan) {
                ...
                if (!this.lockXAxis) {
                    this.rotationX -=
                        pointer.velocity.y * (this.rotateSpeed / height);
                }

                if (!this.lockYAxis) {
                    this.rotationY -=
                        pointer.velocity.x * (this.rotateSpeed / width);
                }
            }
        }
    },
     ...
     *
     * @method Vsengine.GameObjects.Layer3DCamera#panX
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Layer3DCamera#panY
     * @since 3.50.0
     *
     * @param {number} v - The amount to pan by.
     */
     ...
     *
     * @method Vsengine.GameObjects.Layer3DCamera#panZ
     * @since 3.50.0
     *
     * @param {number} v - The amount to pan by.
     */
     ...
     *
     * @method Vsengine.GameObjects.Layer3DCamera#update
     * @since 3.50.0
     */
    update: function () {
        if (this.dirtyView) {
        ...
        if (this.dirtyView || this.dirtyProjection) {
            this.projectionMatrix.multiplyToMat4(
                this.viewMatrix,
     ...
     *
     * @method Vsengine.GameObjects.Layer3DCamera#updateViewMatrix
     * @since 3.50.0
     */
    updateViewMatrix: function () {
        ...
        if (this.mode === Layer3DCamera.MODE_FREE) {
            matView.fromRotationXYTranslation(
                this.rotation,
                this.position,
                true
            );
     ...
     *
     * @method Vsengine.GameObjects.Layer3DCamera#updateProjectionMatrix
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Layer3DCamera#updateDirection
     * @since 3.50.0
     */
     ...
     *
     * @name Vsengine.GameObjects.Layer3DCamera#fov
     * @type {number}
     * @since 3.50.0
     */
    fov: {
     ...
     *
     * @name Vsengine.GameObjects.Layer3DCamera#near
     * @type {number}
     * @since 3.50.0
     */
    near: {
     ...
     *
     * @name Vsengine.GameObjects.Layer3DCamera#far
     * @type {number}
     * @since 3.50.0
     */
    far: {
     ...
     *
     * @name Vsengine.GameObjects.Layer3DCamera#x
     * @type {number}
     * @since 3.50.0
     */
    x: {
     ...
     *
     * @name Vsengine.GameObjects.Layer3DCamera#y
     * @type {number}
     * @since 3.50.0
     */
    y: {
     ...
     *
     * @name Vsengine.GameObjects.Layer3DCamera#z
     * @type {number}
     * @since 3.50.0
     */
    z: {
     ...
     *
     * @name Vsengine.GameObjects.Layer3DCamera#rotationX
     * @type {number}
     * @since 3.50.0
     */
    rotationX: {
     ...
     *
     * @name Vsengine.GameObjects.Layer3DCamera#rotationY
     * @type {number}
     * @since 3.50.0
     */
    rotationY: {
     ...
     *
     * @name Vsengine.GameObjects.Layer3DCamera#rotationZ
     * @type {number}
     * @since 3.50.0
     */
    rotationZ: {
     ...
     *
     * @method Vsengine.GameObjects.Layer3DCamera#destroy
     * @since 3.50.0
     */
    destroy: function () {
        this.layer = null;
