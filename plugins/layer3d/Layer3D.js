...
var Layer3D = new Class({
    ...
    initialize: function Layer3D(scene, x, y) {
         ...
         *
         * @name Vsengine.GameObjects.Layer3D#camera
         * @type {Vsengine.GameObjects.Layer3DCamera}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Layer3D#light
         * @type {Vsengine.GameObjects.Layer3DLight}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Layer3D#fogColor
         ...
         *
         * @name Vsengine.GameObjects.Layer3D#fogNear
         * @type {number}
         * @since 3.50.0
         */
        this.fogNear = 0;
         ...
         *
         * @name Vsengine.GameObjects.Layer3D#fogFar
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name Vsengine.GameObjects.Layer3D#models
         * @type {Vsengine.Geom.Mesh.Model[]}
         * @since 3.50.0
         */
        this.models = [];
         ...
         *
         * @name Vsengine.GameObjects.Layer3D#_prevWidth
         * @type {number}
         * @private
         * @since 3.50.0
         */
         ...
         * Internal cached value.
         *
         * @name Vsengine.GameObjects.Layer3D#_prevHeight
         * @type {number}
         * @private
         * @since 3.50.0
         */
     ...
     *
     * @method Vsengine.GameObjects.Layer3D#clearModels
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Layer3D#addModel
     * @since 3.50.0
     *
     * @param {number} verticesCount - The total number of vertices this model can contain.
     * @param {string|Vsengine.Textures.Texture} [texture] - The key, or instance of the Texture this model will use to render with, as stored in the Texture Manager.
     ...
     *
     * @return {Vsengine.Geom.Mesh.Model} The model instance that was created.
     */
     ...
     *
     * @method Vsengine.GameObjects.Layer3D#addModelFromOBJ
     * @since 3.50.0
     *
     ...
     *
     * @return {Vsengine.Geom.Mesh.Model|Vsengine.Geom.Mesh.Model[]} The Model instance that was created. If the OBJ contained multiple models then an array of Model instances is returned.
     */
    addModelFromOBJ: function (
        key,
        texture,
        frame,
        scale,
     ...
     *
     * ```javascript
     * const data = Vsengine.Geom.Mesh.ParseObj(rawData, flipUV);
     *
     ...
     * use them to offset the base values.
     *
     * @method Vsengine.GameObjects.Layer3D#addModelFromData
     * @since 3.50.0
     *
     ...
     * @param {number} [originZ=0] - The z origin of the model vertices during creation.
     *
     * @return {Vsengine.Geom.Mesh.Model|Vsengine.Geom.Mesh.Model[]} The Model instance that was created. If the data contained multiple models then an array of Model instances is returned.
     */
    addModelFromData: function (
        data,
        texture,
        frame,
        scale,
     ...
     *
     * @method Vsengine.GameObjects.Layer3D#addModelFromVertices
     * @since 3.50.0
     *
     ...
     * @param {string|Vsengine.Textures.Texture} [texture] - The key, or instance of the Texture the model will use to render with, as stored in the Texture Manager.
     * @param {string|integer} [frame] - An optional frame from the Texture the model is rendering with.
     *
     * @return {Vsengine.Geom.Mesh.Model} The Model instance that was created.
     */
    addModelFromVertices: function (
        vertices,
        uvs,
        normals,
        indicies,
     ...
     *
     * @method Vsengine.GameObjects.Layer3D#setFog
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Layer3D#disableFog
     * @since 3.50.0
     *
     * @return {this} This Layer3D Game Object.
     */
     ...
     *
     * @method Vsengine.GameObjects.Layer3D#preUpdate
     * @protected
     * @since 3.50.0
     *
     ...
     *
     * @method Vsengine.GameObjects.Layer3D#resetDirtyFlags
     * @protected
     * @since 3.50.0
     */
     ...
     *
     * @method Vsengine.GameObjects.Layer3D#preDestroy
     * @private
     * @since 3.50.0
     */
    preDestroy: function () {
